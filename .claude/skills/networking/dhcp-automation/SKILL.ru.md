...
version: "1.0"
language: ru
original: dhcp-automation
---

# Dhcp Automation

> Automation with DHCP. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dhcp-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dhcp Automation
...
## Ресурсы
- Оригинальный навык: `networking/dhcp-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
