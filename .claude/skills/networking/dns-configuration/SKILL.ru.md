...
> Config with DNS. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Configuration
...
## Ресурсы
- Оригинальный навык: `networking/dns-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
