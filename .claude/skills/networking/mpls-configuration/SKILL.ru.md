...
version: "1.0"
language: ru
original: mpls-configuration
---

# Mpls Configuration

> Config with MPLS. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mpls-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Mpls Configuration
...
## Ресурсы
- Оригинальный навык: `networking/mpls-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
