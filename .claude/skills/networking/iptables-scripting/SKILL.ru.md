...
category: networking
tags: [iptables-scripting, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: iptables-scripting
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `iptables-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iptables Scripting
...
## Ресурсы
- Оригинальный навык: `networking/iptables-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
