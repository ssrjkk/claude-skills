...
version: "1.0"
language: ru
original: socat-scripting
---

# Socat Scripting

> Scripting with socat. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `socat-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Socat Scripting
...
## Ресурсы
- Оригинальный навык: `networking/socat-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
