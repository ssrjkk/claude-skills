...
version: "1.0"
language: ru
original: tcpdump-configuration
---

# Tcpdump Configuration

> Config with tcpdump. advanced config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcpdump-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tcpdump Configuration
...
## Ресурсы
- Оригинальный навык: `networking/tcpdump-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
