...
category: networking
tags: [netcat-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: netcat-security
---

# Netcat Security

> Security with netcat. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netcat-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Netcat Security
...
## Ресурсы
- Оригинальный навык: `networking/netcat-security/SKILL.md`
- Категория: Сети
- Язык: Русский
