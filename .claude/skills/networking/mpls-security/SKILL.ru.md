...
category: networking
tags: [mpls-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mpls-security
---

# Mpls Security

> Security with MPLS. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mpls-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Mpls Security
...
## Ресурсы
- Оригинальный навык: `networking/mpls-security/SKILL.md`
- Категория: Сети
- Язык: Русский
