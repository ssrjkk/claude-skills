...
version: "1.0"
language: ru
original: sd-wan-design
---

# Sd Wan Design

> Design with SD-WAN. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sd-wan-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Sd Wan Design
...
## Ресурсы
- Оригинальный навык: `networking/sd-wan-design/SKILL.md`
- Категория: Сети
- Язык: Русский
