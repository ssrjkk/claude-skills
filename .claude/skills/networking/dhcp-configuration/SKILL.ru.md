...
category: networking
tags: [dhcp-configuration, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Config with DHCP. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dhcp-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dhcp Configuration
...
## Ресурсы
- Оригинальный навык: `networking/dhcp-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
