...
version: "1.0"
language: ru
original: nat-configuration
---

# Nat Configuration

> Config with NAT. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nat-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nat Configuration
...
## Ресурсы
- Оригинальный навык: `networking/nat-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
