...
version: "1.0"
language: ru
original: sd-wan-basics
---

# Sd Wan Basics

> Basics with SD-WAN. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sd-wan-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Sd Wan Basics
...
## Ресурсы
- Оригинальный навык: `networking/sd-wan-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
