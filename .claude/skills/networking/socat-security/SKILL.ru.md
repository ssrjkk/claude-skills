...
version: "1.0"
language: ru
original: socat-security
---

# Socat Security

> Security with socat. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `socat-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Socat Security
...
## Ресурсы
- Оригинальный навык: `networking/socat-security/SKILL.md`
- Категория: Сети
- Язык: Русский
