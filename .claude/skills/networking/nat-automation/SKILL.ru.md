...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nat-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nat Automation
...
## Ресурсы
- Оригинальный навык: `networking/nat-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
