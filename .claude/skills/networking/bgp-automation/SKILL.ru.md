...
category: networking
tags: [bgp-automation, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bgp-automation
---

# Bgp Automation

> Automation with BGP. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bgp-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Bgp Automation
...
## Ресурсы
- Оригинальный навык: `networking/bgp-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
