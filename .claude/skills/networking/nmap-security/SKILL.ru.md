...
category: networking
tags: [nmap-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-security
---

# Nmap Security

> Security with Nmap. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nmap Security
...
## Ресурсы
- Оригинальный навык: `networking/nmap-security/SKILL.md`
- Категория: Сети
- Язык: Русский
