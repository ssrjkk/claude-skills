...
category: networking
tags: [nmap-performance, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-performance
---

# Nmap Performance

> Performance with Nmap. benchmarking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-performance`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nmap Performance
...
## Ресурсы
- Оригинальный навык: `networking/nmap-performance/SKILL.md`
- Категория: Сети
- Язык: Русский
