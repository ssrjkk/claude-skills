...
version: "1.0"
language: ru
original: tcpdump-security
---

# Tcpdump Security

> Security with tcpdump. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcpdump-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tcpdump Security
...
## Ресурсы
- Оригинальный навык: `networking/tcpdump-security/SKILL.md`
- Категория: Сети
- Язык: Русский
