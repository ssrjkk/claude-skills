...
category: networking
tags: [nmap-basics, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-basics
---

# Nmap Basics

> Basics with Nmap. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nmap Basics
...
## Ресурсы
- Оригинальный навык: `networking/nmap-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
