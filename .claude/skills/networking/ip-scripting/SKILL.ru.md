...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ip-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Ip Scripting
...
## Ресурсы
- Оригинальный навык: `networking/ip-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
