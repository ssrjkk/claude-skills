...
## Быстрый старт
Этот навык на русском языке. Оригинал: `iptables-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iptables Basics
...
## Ресурсы
- Оригинальный навык: `networking/iptables-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
