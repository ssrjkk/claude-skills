...
version: "1.0"
language: ru
original: wireshark-configuration
---

# Wireshark Configuration

> Config with Wireshark. advanced config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Wireshark Configuration
...
## Ресурсы
- Оригинальный навык: `networking/wireshark-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
