...
category: networking
tags: [dhcp-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dhcp-security
---

# Dhcp Security

> Security with DHCP. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dhcp-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dhcp Security
...
## Ресурсы
- Оригинальный навык: `networking/dhcp-security/SKILL.md`
- Категория: Сети
- Язык: Русский
