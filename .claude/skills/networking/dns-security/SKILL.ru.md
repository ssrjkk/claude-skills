...
version: "1.0"
language: ru
original: dns-security
---

# Dns Security

> Security with DNS. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Security
...
## Ресурсы
- Оригинальный навык: `networking/dns-security/SKILL.md`
- Категория: Сети
- Язык: Русский
