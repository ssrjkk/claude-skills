...
version: "1.0"
language: ru
original: http-security
---

# Http Security

> Security with HTTP. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `http-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Http Security
...
## Ресурсы
- Оригинальный навык: `networking/http-security/SKILL.md`
- Категория: Сети
- Язык: Русский
