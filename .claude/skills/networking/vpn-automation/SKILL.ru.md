...
version: "1.0"
language: ru
original: vpn-automation
---

# Vpn Automation

> Automation with VPN. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vpn-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Vpn Automation
...
## Ресурсы
- Оригинальный навык: `networking/vpn-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
