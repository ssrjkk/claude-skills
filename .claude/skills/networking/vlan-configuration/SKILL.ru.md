...
> Config with VLAN. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vlan-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Vlan Configuration
...
## Ресурсы
- Оригинальный навык: `networking/vlan-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
