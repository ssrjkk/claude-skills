...
version: "1.0"
language: ru
original: curl-basics
---

# Curl Basics

> Basics with curl. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `curl-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Curl Basics
...
## Ресурсы
- Оригинальный навык: `networking/curl-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
