...
version: "1.0"
language: ru
original: tls-ssl-basics
---

# Tls Ssl Basics

> Basics with TLS/SSL. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tls-ssl-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tls Ssl Basics
...
## Ресурсы
- Оригинальный навык: `networking/tls-ssl-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
