...
category: networking
tags: [mpls-design, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mpls-design
---

# Mpls Design

> Design with MPLS. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mpls-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Mpls Design
...
## Ресурсы
- Оригинальный навык: `networking/mpls-design/SKILL.md`
- Категория: Сети
- Язык: Русский
