...
category: networking
tags: [wireshark-scripting, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wireshark-scripting
---

# Wireshark Scripting

> Scripting with Wireshark. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Wireshark Scripting
...
## Ресурсы
- Оригинальный навык: `networking/wireshark-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
