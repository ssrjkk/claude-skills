...
category: networking
tags: [curl-scripting, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: curl-scripting
---

# Curl Scripting

> Scripting with curl. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `curl-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Curl Scripting
...
## Ресурсы
- Оригинальный навык: `networking/curl-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
