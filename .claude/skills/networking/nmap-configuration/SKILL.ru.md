...
version: "1.0"
language: ru
original: nmap-configuration
---

# Nmap Configuration

> Config with Nmap. advanced config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nmap Configuration
...
## Ресурсы
- Оригинальный навык: `networking/nmap-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
