...
category: networking
tags: [vlan-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vlan-security
---

# Vlan Security

> Security with VLAN. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vlan-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Vlan Security
...
## Ресурсы
- Оригинальный навык: `networking/vlan-security/SKILL.md`
- Категория: Сети
- Язык: Русский
