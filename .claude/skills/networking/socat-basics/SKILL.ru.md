...
version: "1.0"
language: ru
original: socat-basics
---

# Socat Basics

> Basics with socat. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `socat-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Socat Basics
...
## Ресурсы
- Оригинальный навык: `networking/socat-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
