...
> Design with DNS. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Design
...
## Ресурсы
- Оригинальный навык: `networking/dns-design/SKILL.md`
- Категория: Сети
- Язык: Русский
