...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ping-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Ping Basics
...
## Ресурсы
- Оригинальный навык: `networking/ping-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
