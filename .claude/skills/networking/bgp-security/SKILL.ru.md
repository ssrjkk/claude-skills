...
version: "1.0"
language: ru
original: bgp-security
---

# Bgp Security

> Security with BGP. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bgp-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Bgp Security
...
## Ресурсы
- Оригинальный навык: `networking/bgp-security/SKILL.md`
- Категория: Сети
- Язык: Русский
