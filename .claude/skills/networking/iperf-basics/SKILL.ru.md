...
category: networking
tags: [iperf-basics, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: iperf-basics
---

# Iperf Basics

> Basics with iperf. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iperf-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iperf Basics
...
## Ресурсы
- Оригинальный навык: `networking/iperf-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
