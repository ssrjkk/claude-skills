...
version: "1.0"
language: ru
original: socat-performance
---

# Socat Performance

> Performance with socat. benchmarking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `socat-performance`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Socat Performance
...
## Ресурсы
- Оригинальный навык: `networking/socat-performance/SKILL.md`
- Категория: Сети
- Язык: Русский
