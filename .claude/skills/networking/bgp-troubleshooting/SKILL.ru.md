...
version: "1.0"
language: ru
original: bgp-troubleshooting
---

# Bgp Troubleshooting

> Troubleshooting with BGP. diagnostics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bgp-troubleshooting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Bgp Troubleshooting
...
## Ресурсы
- Оригинальный навык: `networking/bgp-troubleshooting/SKILL.md`
- Категория: Сети
- Язык: Русский
