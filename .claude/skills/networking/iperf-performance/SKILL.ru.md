...
version: "1.0"
language: ru
original: iperf-performance
---

# Iperf Performance

> Performance with iperf. benchmarking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iperf-performance`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iperf Performance
...
## Ресурсы
- Оригинальный навык: `networking/iperf-performance/SKILL.md`
- Категория: Сети
- Язык: Русский
