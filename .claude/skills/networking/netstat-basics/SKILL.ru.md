...
version: "1.0"
language: ru
original: netstat-basics
---

# Netstat Basics

> Basics with netstat/ss. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netstat-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Netstat Basics
...
## Ресурсы
- Оригинальный навык: `networking/netstat-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
