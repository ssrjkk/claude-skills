...
version: "1.0"
language: ru
original: dns-automation
---

# Dns Automation

> Automation with DNS. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Automation
...
## Ресурсы
- Оригинальный навык: `networking/dns-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
