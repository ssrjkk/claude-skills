...
> Design with NAT. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nat-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nat Design
...
## Ресурсы
- Оригинальный навык: `networking/nat-design/SKILL.md`
- Категория: Сети
- Язык: Русский
