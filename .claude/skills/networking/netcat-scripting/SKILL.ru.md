...
version: "1.0"
language: ru
original: netcat-scripting
---

# Netcat Scripting

> Scripting with netcat. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netcat-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Netcat Scripting
...
## Ресурсы
- Оригинальный навык: `networking/netcat-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
