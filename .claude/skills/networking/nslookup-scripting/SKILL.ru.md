...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nslookup-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nslookup Scripting
...
## Ресурсы
- Оригинальный навык: `networking/nslookup-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
