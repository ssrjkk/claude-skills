...
version: "1.0"
language: ru
original: wireshark-security
---

# Wireshark Security

> Security with Wireshark. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Wireshark Security
...
## Ресурсы
- Оригинальный навык: `networking/wireshark-security/SKILL.md`
- Категория: Сети
- Язык: Русский
