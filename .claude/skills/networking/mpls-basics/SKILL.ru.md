...
version: "1.0"
language: ru
original: mpls-basics
---

# Mpls Basics

> Basics with MPLS. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mpls-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Mpls Basics
...
## Ресурсы
- Оригинальный навык: `networking/mpls-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
