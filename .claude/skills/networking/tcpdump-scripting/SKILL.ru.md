...
version: "1.0"
language: ru
original: tcpdump-scripting
---

# Tcpdump Scripting

> Scripting with tcpdump. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcpdump-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tcpdump Scripting
...
## Ресурсы
- Оригинальный навык: `networking/tcpdump-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
