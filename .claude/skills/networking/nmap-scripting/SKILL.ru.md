...
category: networking
tags: [nmap-scripting, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-scripting
---

# Nmap Scripting

> Scripting with Nmap. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nmap Scripting
...
## Ресурсы
- Оригинальный навык: `networking/nmap-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
