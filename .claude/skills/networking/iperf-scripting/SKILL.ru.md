...
category: networking
tags: [iperf-scripting, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: iperf-scripting
---

# Iperf Scripting

> Scripting with iperf. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iperf-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iperf Scripting
...
## Ресурсы
- Оригинальный навык: `networking/iperf-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
