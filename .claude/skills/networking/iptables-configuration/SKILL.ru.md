...
version: "1.0"
language: ru
original: iptables-configuration
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `iptables-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iptables Configuration
...
## Ресурсы
- Оригинальный навык: `networking/iptables-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
