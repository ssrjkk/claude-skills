...
category: networking
tags: [sd-wan-security, networking, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sd-wan-security
---

# Sd Wan Security

> Security with SD-WAN. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sd-wan-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Sd Wan Security
...
## Ресурсы
- Оригинальный навык: `networking/sd-wan-security/SKILL.md`
- Категория: Сети
- Язык: Русский
