...
version: "1.0"
language: ru
original: netstat-scripting
---

# Netstat Scripting

> Scripting with netstat/ss. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netstat-scripting`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Netstat Scripting
...
## Ресурсы
- Оригинальный навык: `networking/netstat-scripting/SKILL.md`
- Категория: Сети
- Язык: Русский
