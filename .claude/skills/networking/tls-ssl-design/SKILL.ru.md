...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tls-ssl-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tls Ssl Design
...
## Ресурсы
- Оригинальный навык: `networking/tls-ssl-design/SKILL.md`
- Категория: Сети
- Язык: Русский
