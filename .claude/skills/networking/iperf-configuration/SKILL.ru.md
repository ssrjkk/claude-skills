...
version: "1.0"
language: ru
original: iperf-configuration
---

# Iperf Configuration

> Config with iperf. advanced config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iperf-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Iperf Configuration
...
## Ресурсы
- Оригинальный навык: `networking/iperf-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
