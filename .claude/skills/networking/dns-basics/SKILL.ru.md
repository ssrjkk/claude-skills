...
> Basics with DNS. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Basics
...
## Ресурсы
- Оригинальный навык: `networking/dns-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
