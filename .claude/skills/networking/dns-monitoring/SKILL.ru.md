...
version: "1.0"
language: ru
original: dns-monitoring
---

# Dns Monitoring

> Monitoring with DNS. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dns-monitoring`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Dns Monitoring
...
## Ресурсы
- Оригинальный навык: `networking/dns-monitoring/SKILL.md`
- Категория: Сети
- Язык: Русский
