...
> Config with VPN. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vpn-configuration`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Vpn Configuration
...
## Ресурсы
- Оригинальный навык: `networking/vpn-configuration/SKILL.md`
- Категория: Сети
- Язык: Русский
