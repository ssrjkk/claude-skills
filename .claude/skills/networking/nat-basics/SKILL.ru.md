...
> Basics with NAT. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nat-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nat Basics
...
## Ресурсы
- Оригинальный навык: `networking/nat-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
