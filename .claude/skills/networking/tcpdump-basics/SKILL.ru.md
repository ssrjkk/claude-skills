...
version: "1.0"
language: ru
original: tcpdump-basics
---

# Tcpdump Basics

> Basics with tcpdump. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcpdump-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tcpdump Basics
...
## Ресурсы
- Оригинальный навык: `networking/tcpdump-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
