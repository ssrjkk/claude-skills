...
version: "1.0"
language: ru
original: http-basics
---

# Http Basics

> Basics with HTTP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `http-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Http Basics
...
## Ресурсы
- Оригинальный навык: `networking/http-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
