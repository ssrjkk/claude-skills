...
version: "1.0"
language: ru
original: vlan-automation
---

# Vlan Automation

> Automation with VLAN. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vlan-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Vlan Automation
...
## Ресурсы
- Оригинальный навык: `networking/vlan-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
