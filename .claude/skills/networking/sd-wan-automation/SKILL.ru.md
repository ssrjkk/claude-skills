...
version: "1.0"
language: ru
original: sd-wan-automation
---

# Sd Wan Automation

> Automation with SD-WAN. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sd-wan-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Sd Wan Automation
...
## Ресурсы
- Оригинальный навык: `networking/sd-wan-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
