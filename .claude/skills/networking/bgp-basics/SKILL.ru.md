...
> Basics with BGP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bgp-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Bgp Basics
...
## Ресурсы
- Оригинальный навык: `networking/bgp-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
