...
version: "1.0"
language: ru
original: netcat-basics
---

# Netcat Basics

> Basics with netcat. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netcat-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Netcat Basics
...
## Ресурсы
- Оригинальный навык: `networking/netcat-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
