...
version: "1.0"
language: ru
original: nat-security
---

# Nat Security

> Security with NAT. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nat-security`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Nat Security
...
## Ресурсы
- Оригинальный навык: `networking/nat-security/SKILL.md`
- Категория: Сети
- Язык: Русский
