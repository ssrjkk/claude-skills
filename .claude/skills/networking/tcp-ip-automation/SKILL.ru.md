...
version: "1.0"
language: ru
original: tcp-ip-automation
---

# Tcp Ip Automation

> Automation with TCP/IP. network automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcp-ip-automation`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Tcp Ip Automation
...
## Ресурсы
- Оригинальный навык: `networking/tcp-ip-automation/SKILL.md`
- Категория: Сети
- Язык: Русский
