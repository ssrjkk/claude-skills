...
> Design with BGP. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bgp-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Bgp Design
...
## Ресурсы
- Оригинальный навык: `networking/bgp-design/SKILL.md`
- Категория: Сети
- Язык: Русский
