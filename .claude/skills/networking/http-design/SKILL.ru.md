...
version: "1.0"
language: ru
original: http-design
---

# Http Design

> Design with HTTP. network design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `http-design`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Http Design
...
## Ресурсы
- Оригинальный навык: `networking/http-design/SKILL.md`
- Категория: Сети
- Язык: Русский
