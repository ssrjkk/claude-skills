...
version: "1.0"
language: ru
original: wireshark-basics
---

# Wireshark Basics

> Basics with Wireshark. basic usage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-basics`.

## Когда использовать
- Работа с Сети
- Выполнение задач, связанных с Wireshark Basics
...
## Ресурсы
- Оригинальный навык: `networking/wireshark-basics/SKILL.md`
- Категория: Сети
- Язык: Русский
