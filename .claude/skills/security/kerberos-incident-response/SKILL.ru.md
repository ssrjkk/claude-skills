...
version: "1.0"
language: ru
original: kerberos-incident-response
---

# Kerberos Incident Response

> Incident Response with Kerberos. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kerberos-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Kerberos Incident Response
...
## Ресурсы
- Оригинальный навык: `security/kerberos-incident-response/SKILL.md`
