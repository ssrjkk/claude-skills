...
category: security
tags: [owasp-best-practices, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: owasp-best-practices
---

# Owasp Best Practices

> Best Practices with OWASP. best practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-best-practices`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Best Practices
...
## Ресурсы
- Оригинальный навык: `security/owasp-best-practices/SKILL.md`
