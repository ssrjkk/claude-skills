...
version: "1.0"
language: ru
original: iso27001-incident-response
---

# Iso27001 Incident Response

> Incident Response with ISO 27001. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iso27001-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Iso27001 Incident Response
...
## Ресурсы
- Оригинальный навык: `security/iso27001-incident-response/SKILL.md`
