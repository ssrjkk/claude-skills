...
> Audit with GDPR. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gdpr-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gdpr Audit
...
## Ресурсы
- Оригинальный навык: `security/gdpr-audit/SKILL.md`
