...
category: security
tags: [trivy-automation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-automation
---

# Trivy Automation

> Automation with Trivy. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Automation
...
## Ресурсы
- Оригинальный навык: `security/trivy-automation/SKILL.md`
