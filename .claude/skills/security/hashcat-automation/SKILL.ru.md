...
version: "1.0"
language: ru
original: hashcat-automation
---

# Hashcat Automation

> Automation with Hashcat. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hashcat-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hashcat Automation
...
## Ресурсы
- Оригинальный навык: `security/hashcat-automation/SKILL.md`
