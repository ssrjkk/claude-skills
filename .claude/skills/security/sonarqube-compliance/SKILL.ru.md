...
category: security
tags: [sonarqube-compliance, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sonarqube-compliance
---

# Sonarqube Compliance

> Compliance with SonarQube. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sonarqube-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sonarqube Compliance
...
## Ресурсы
- Оригинальный навык: `security/sonarqube-compliance/SKILL.md`
