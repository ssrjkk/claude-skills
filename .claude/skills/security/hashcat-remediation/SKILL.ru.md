...
version: "1.0"
language: ru
original: hashcat-remediation
---

# Hashcat Remediation

> Remediation with Hashcat. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hashcat-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hashcat Remediation
...
## Ресурсы
- Оригинальный навык: `security/hashcat-remediation/SKILL.md`
