...
category: security
tags: [falco-api, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-api`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Api
...
## Ресурсы
- Оригинальный навык: security/falco-api/SKILL.md
