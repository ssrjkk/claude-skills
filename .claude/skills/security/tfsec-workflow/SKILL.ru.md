...
version: "1.0"
language: ru
original: tfsec-workflow
---

# Tfsec Workflow

> Workflow for Tfsec: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: tfsec-workflow.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tfsec Workflow
...
## Ресурсы
- security/tfsec-workflow/SKILL.md
