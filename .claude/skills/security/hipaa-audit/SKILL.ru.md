...
version: "1.0"
language: ru
original: hipaa-audit
---

# Hipaa Audit

> Audit with HIPAA. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hipaa-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hipaa Audit
...
## Ресурсы
- Оригинальный навык: `security/hipaa-audit/SKILL.md`
