...
version: "1.0"
language: ru
original: hydra-setup
---

# Hydra Setup

> Setup with Hydra. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hydra-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hydra Setup
...
## Ресурсы
- Оригинальный навык: `security/hydra-setup/SKILL.md`
