...
version: "1.0"
language: ru
original: iso27001-monitoring
---

# Iso27001 Monitoring

> Monitoring with ISO 27001. security monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iso27001-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Iso27001 Monitoring
...
## Ресурсы
- Оригинальный навык: `security/iso27001-monitoring/SKILL.md`
