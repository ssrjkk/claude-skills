...
category: security
tags: [soc2-audit, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: soc2-audit
...
> Audit with SOC 2. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Audit
...
## Ресурсы
- Оригинальный навык: `security/soc2-audit/SKILL.md`
