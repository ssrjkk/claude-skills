...
> Audit with NIST. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Audit
...
## Ресурсы
- Оригинальный навык: `security/nist-audit/SKILL.md`
