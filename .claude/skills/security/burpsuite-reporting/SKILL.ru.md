...
version: "1.0"
language: ru
original: burpsuite-reporting
---

# Burpsuite Reporting

> Reporting with Burp Suite. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Reporting
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-reporting/SKILL.md`
