...
version: "1.0"
language: ru
original: john-automation
---

# John Automation

> Automation with John the Ripper. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Automation
...
## Ресурсы
- Оригинальный навык: `security/john-automation/SKILL.md`
