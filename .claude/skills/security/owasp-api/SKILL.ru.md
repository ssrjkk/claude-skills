...
category: security
tags: [owasp-api, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: owasp-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-api`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Api
...
## Ресурсы
- Оригинальный навык: security/owasp-api/SKILL.md
