...
version: "1.0"
language: ru
original: sqlmap-automation
---

# Sqlmap Automation

> Automation with SQLmap. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlmap-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sqlmap Automation
...
## Ресурсы
- Оригинальный навык: `security/sqlmap-automation/SKILL.md`
