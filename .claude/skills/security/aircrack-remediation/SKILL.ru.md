...
category: security
tags: [aircrack-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aircrack-remediation
---

# Aircrack Remediation

> Remediation with Aircrack-ng. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aircrack-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aircrack Remediation
...
## Ресурсы
- Оригинальный навык: `security/aircrack-remediation/SKILL.md`
