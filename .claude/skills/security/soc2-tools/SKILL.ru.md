...
category: security
tags: [soc2-tools, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: soc2-tools
...
> Tools with SOC 2. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Tools
...
## Ресурсы
- Оригинальный навык: `security/soc2-tools/SKILL.md`
