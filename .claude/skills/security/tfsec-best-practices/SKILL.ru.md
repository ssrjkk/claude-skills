...
version: "1.0"
language: ru
original: tfsec-best-practices
---

# Tfsec Best Practices

> Best Practices for Tfsec: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: tfsec-best-practices.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tfsec Best Practices
...
## Ресурсы
- security/tfsec-best-practices/SKILL.md
