...
## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-deployment`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Deployment
...
## Ресурсы
- Оригинальный навык: security/saml-deployment/SKILL.md
