...
version: "1.0"
language: ru
original: nmap-analysis
---

# Nmap Analysis

> Analysis with Nmap. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nmap Analysis
...
## Ресурсы
- Оригинальный навык: `security/nmap-analysis/SKILL.md`
