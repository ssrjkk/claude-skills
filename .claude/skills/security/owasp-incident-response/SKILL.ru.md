...
version: "1.0"
language: ru
original: owasp-incident-response
---

# Owasp Incident Response

> Incident Response with OWASP. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Incident Response
...
## Ресурсы
- Оригинальный навык: `security/owasp-incident-response/SKILL.md`
