...
version: "1.0"
language: ru
original: pki-incident-response
---

# Pki Incident Response

> Incident Response with PKI. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pki-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pki Incident Response
...
## Ресурсы
- Оригинальный навык: `security/pki-incident-response/SKILL.md`
