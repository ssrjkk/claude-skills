...
version: "1.0"
language: ru
original: aws-kms-quickstart
---

# Aws Kms Quickstart

> Quickstart for Aws-Kms: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `aws-kms-quickstart`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aws Kms Quickstart
...
## Ресурсы
- Оригинал: security/aws-kms-quickstart/SKILL.md
