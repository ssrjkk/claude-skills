...
version: "1.0"
language: ru
original: kerberos-basics
---

# Kerberos Basics

> Basics with Kerberos. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kerberos-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Kerberos Basics
...
## Ресурсы
- Оригинальный навык: `security/kerberos-basics/SKILL.md`
