...
> Scans dependencies, containers, and IaC for vulnerabilities with Snyk in CI/CD pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk
...
## Ресурсы
- Оригинальный навык: `security/snyk/SKILL.md`
