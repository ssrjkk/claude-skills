...
category: security
tags: [soc2-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: soc2-basics
---

# Soc2 Basics

> Basics with SOC 2. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Basics
...
## Ресурсы
- Оригинальный навык: `security/soc2-basics/SKILL.md`
