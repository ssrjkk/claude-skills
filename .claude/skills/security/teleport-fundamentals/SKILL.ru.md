...
version: "1.0"
language: ru
original: teleport-fundamentals
---

# Teleport Fundamentals

> Fundamentals for Teleport: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `teleport-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Teleport Fundamentals
...
## Ресурсы
- Оригинал: security/teleport-fundamentals/SKILL.md
