...
version: "1.0"
language: ru
original: velociraptor-configuration
---

# Velociraptor Configuration

> Configuration for Velociraptor: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: velociraptor-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Velociraptor Configuration
...
## Ресурсы
- security/velociraptor-configuration/SKILL.md
