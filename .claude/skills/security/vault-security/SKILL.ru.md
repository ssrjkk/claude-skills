...
category: security
tags: [vault-security, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vault-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vault-security`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Vault Security
...
## Ресурсы
- Оригинальный навык: security/vault-security/SKILL.md
