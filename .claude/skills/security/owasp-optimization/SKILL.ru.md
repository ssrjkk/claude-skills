...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-optimization`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Optimization
...
## Ресурсы
- Оригинальный навык: security/owasp-optimization/SKILL.md
