...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Advanced
...
## Ресурсы
- Оригинальный навык: security/snyk-advanced/SKILL.md
