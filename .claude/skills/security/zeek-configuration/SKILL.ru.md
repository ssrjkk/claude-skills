...
version: "1.0"
language: ru
original: zeek-configuration
---

# Zeek Configuration

> Configuration for Zeek: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: zeek-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zeek Configuration
...
## Ресурсы
- security/zeek-configuration/SKILL.md
