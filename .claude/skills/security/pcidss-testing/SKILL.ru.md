...
version: "1.0"
language: ru
original: pcidss-testing
---

# Pcidss Testing

> Testing with PCI DSS. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pcidss-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pcidss Testing
...
## Ресурсы
- Оригинальный навык: `security/pcidss-testing/SKILL.md`
