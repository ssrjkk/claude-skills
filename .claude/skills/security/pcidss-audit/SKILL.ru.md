...
version: "1.0"
language: ru
original: pcidss-audit
---

# Pcidss Audit

> Audit with PCI DSS. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pcidss-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pcidss Audit
...
## Ресурсы
- Оригинальный навык: `security/pcidss-audit/SKILL.md`
