...
version: "1.0"
language: ru
original: nessus-scanning
---

# Nessus Scanning

> Scanning with Nessus. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Scanning
...
## Ресурсы
- Оригинальный навык: `security/nessus-scanning/SKILL.md`
