...
version: "1.0"
language: ru
original: iso27001-testing
---

# Iso27001 Testing

> Testing with ISO 27001. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iso27001-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Iso27001 Testing
...
## Ресурсы
- Оригинальный навык: `security/iso27001-testing/SKILL.md`
