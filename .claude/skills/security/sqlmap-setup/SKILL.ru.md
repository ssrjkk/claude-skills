...
category: security
tags: [sqlmap-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlmap-setup
---

# Sqlmap Setup

> Setup with SQLmap. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlmap-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sqlmap Setup
...
## Ресурсы
- Оригинальный навык: `security/sqlmap-setup/SKILL.md`
