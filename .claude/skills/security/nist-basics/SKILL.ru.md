...
category: security
tags: [nist-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nist-basics
---

# Nist Basics

> Basics with NIST. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Basics
...
## Ресурсы
- Оригинальный навык: `security/nist-basics/SKILL.md`
