...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jwt-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Jwt Monitoring
...
## Ресурсы
- Оригинальный навык: security/jwt-monitoring/SKILL.md
