...
version: "1.0"
language: ru
original: openvas-scanning
---

# Openvas Scanning

> Scanning with OpenVAS. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Scanning
...
## Ресурсы
- Оригинальный навык: `security/openvas-scanning/SKILL.md`
