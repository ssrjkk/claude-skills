...
version: "1.0"
language: ru
original: wireshark-setup
---

# Wireshark Setup

> Setup with Wireshark. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Wireshark Setup
...
## Ресурсы
- Оригинальный навык: `security/wireshark-setup/SKILL.md`
