...
version: "1.0"
language: ru
original: openid-tools
---

# Openid Tools

> Tools with OpenID Connect. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Tools
...
## Ресурсы
- Оригинальный навык: `security/openid-tools/SKILL.md`
