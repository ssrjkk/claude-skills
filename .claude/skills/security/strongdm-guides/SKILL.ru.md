...
version: "1.0"
language: ru
original: strongdm-guides
---

# Strongdm Guides

> Guides for Strongdm: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `strongdm-guides`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Strongdm Guides
...
## Ресурсы
- Оригинал: security/strongdm-guides/SKILL.md
