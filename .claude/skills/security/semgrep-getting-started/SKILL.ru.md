...
version: "1.0"
language: ru
original: semgrep-getting-started
---

# Semgrep Getting Started

> Getting Started for Semgrep: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: semgrep-getting-started.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Semgrep Getting Started
...
## Ресурсы
- security/semgrep-getting-started/SKILL.md
