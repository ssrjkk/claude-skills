...
category: security
tags: [strongdm-examples, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strongdm-examples
---

# Strongdm Examples

> Examples for Strongdm: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `strongdm-examples`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Strongdm Examples
...
## Ресурсы
- Оригинал: security/strongdm-examples/SKILL.md
