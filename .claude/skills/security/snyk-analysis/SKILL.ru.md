...
version: "1.0"
language: ru
original: snyk-analysis
---

# Snyk Analysis

> Analysis with Snyk. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Analysis
...
## Ресурсы
- Оригинальный навык: `security/snyk-analysis/SKILL.md`
