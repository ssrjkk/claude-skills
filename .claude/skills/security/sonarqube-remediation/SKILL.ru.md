...
category: security
tags: [sonarqube-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sonarqube-remediation
---

# Sonarqube Remediation

> Remediation with SonarQube. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sonarqube-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sonarqube Remediation
...
## Ресурсы
- Оригинальный навык: `security/sonarqube-remediation/SKILL.md`
