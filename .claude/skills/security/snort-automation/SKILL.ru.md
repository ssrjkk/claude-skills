...
version: "1.0"
language: ru
original: snort-automation
---

# Snort Automation

> Automation for Snort: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: snort-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snort Automation
...
## Ресурсы
- security/snort-automation/SKILL.md
