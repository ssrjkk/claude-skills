...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gpg-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gpg Monitoring
...
## Ресурсы
- Оригинальный навык: security/gpg-monitoring/SKILL.md
