...
version: "1.0"
language: ru
original: conjur-quickstart
---

# Conjur Quickstart

> Quickstart for Conjur: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `conjur-quickstart`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Conjur Quickstart
...
## Ресурсы
- Оригинал: security/conjur-quickstart/SKILL.md
