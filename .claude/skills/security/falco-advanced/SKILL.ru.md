...
category: security
tags: [falco-advanced, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Advanced
...
## Ресурсы
- Оригинальный навык: security/falco-advanced/SKILL.md
