...
category: security
tags: [trivy-security, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-security`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Security
...
## Ресурсы
- Оригинальный навык: security/trivy-security/SKILL.md
