...
version: "1.0"
language: ru
original: pomerium-fundamentals
---

# Pomerium Fundamentals

> Fundamentals for Pomerium: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pomerium-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pomerium Fundamentals
...
## Ресурсы
- Оригинал: security/pomerium-fundamentals/SKILL.md
