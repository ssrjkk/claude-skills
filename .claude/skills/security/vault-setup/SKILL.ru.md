...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vault-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Vault Setup
...
## Ресурсы
- Оригинальный навык: security/vault-setup/SKILL.md
