...
## Быстрый старт
Этот навык на русском языке. Оригинал: `aircrack-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aircrack Setup
...
## Ресурсы
- Оригинальный навык: `security/aircrack-setup/SKILL.md`
