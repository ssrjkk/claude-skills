...
version: "1.0"
language: ru
original: owasp-audit
---

# Owasp Audit

> Audit with OWASP. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Audit
...
## Ресурсы
- Оригинальный навык: `security/owasp-audit/SKILL.md`
