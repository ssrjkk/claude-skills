...
category: security
tags: [saml-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saml-basics
---

# Saml Basics

> Basics with SAML. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Basics
...
## Ресурсы
- Оригинальный навык: `security/saml-basics/SKILL.md`
