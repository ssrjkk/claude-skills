...
version: "1.0"
language: ru
original: metasploit-automation
---

# Metasploit Automation

> Automation with Metasploit. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Automation
...
## Ресурсы
- Оригинальный навык: `security/metasploit-automation/SKILL.md`
