...
version: "1.0"
language: ru
original: suricata-production
---

# Suricata Production

> Production for Suricata: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: suricata-production.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Suricata Production
...
## Ресурсы
- security/suricata-production/SKILL.md
