...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-optimization`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Optimization
...
## Ресурсы
- Оригинальный навык: security/snyk-optimization/SKILL.md
