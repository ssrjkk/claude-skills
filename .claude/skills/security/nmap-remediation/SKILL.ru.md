...
version: "1.0"
language: ru
original: nmap-remediation
---

# Nmap Remediation

> Remediation with Nmap. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nmap Remediation
...
## Ресурсы
- Оригинальный навык: `security/nmap-remediation/SKILL.md`
