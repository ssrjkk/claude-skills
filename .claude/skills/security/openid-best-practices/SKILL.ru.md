...
category: security
tags: [openid-best-practices, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openid-best-practices
---

# Openid Best Practices

> Best Practices with OpenID Connect. best practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-best-practices`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Best Practices
...
## Ресурсы
- Оригинальный навык: `security/openid-best-practices/SKILL.md`
