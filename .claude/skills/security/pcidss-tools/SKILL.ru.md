...
version: "1.0"
language: ru
original: pcidss-tools
---

# Pcidss Tools

> Tools with PCI DSS. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pcidss-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pcidss Tools
...
## Ресурсы
- Оригинальный навык: `security/pcidss-tools/SKILL.md`
