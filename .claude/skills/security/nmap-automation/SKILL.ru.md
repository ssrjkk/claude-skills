...
category: security
tags: [nmap-automation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-automation
---

# Nmap Automation

> Automation with Nmap. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nmap Automation
...
## Ресурсы
- Оригинальный навык: `security/nmap-automation/SKILL.md`
