...
version: "1.0"
language: ru
original: tfsec-automation
---

# Tfsec Automation

> Automation for Tfsec: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: tfsec-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tfsec Automation
...
## Ресурсы
- security/tfsec-automation/SKILL.md
