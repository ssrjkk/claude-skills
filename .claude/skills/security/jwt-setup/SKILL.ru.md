...
category: security
tags: [jwt-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jwt-setup
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jwt-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Jwt Setup
...
## Ресурсы
- Оригинальный навык: security/jwt-setup/SKILL.md
