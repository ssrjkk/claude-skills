...
category: security
tags: [saml-audit, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saml-audit
...
> Audit with SAML. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Audit
...
## Ресурсы
- Оригинальный навык: `security/saml-audit/SKILL.md`
