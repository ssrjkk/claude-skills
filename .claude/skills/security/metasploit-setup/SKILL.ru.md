...
version: "1.0"
language: ru
original: metasploit-setup
---

# Metasploit Setup

> Setup with Metasploit. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Setup
...
## Ресурсы
- Оригинальный навык: `security/metasploit-setup/SKILL.md`
