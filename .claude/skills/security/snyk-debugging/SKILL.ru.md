...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-debugging`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Debugging
...
## Ресурсы
- Оригинальный навык: security/snyk-debugging/SKILL.md
