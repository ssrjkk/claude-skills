...
version: "1.0"
language: ru
original: openvas-reporting
---

# Openvas Reporting

> Reporting with OpenVAS. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Reporting
...
## Ресурсы
- Оригинальный навык: `security/openvas-reporting/SKILL.md`
