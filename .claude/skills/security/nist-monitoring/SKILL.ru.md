...
category: security
tags: [nist-monitoring, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nist-monitoring
---

# Nist Monitoring

> Monitoring with NIST. security monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Monitoring
...
## Ресурсы
- Оригинальный навык: `security/nist-monitoring/SKILL.md`
