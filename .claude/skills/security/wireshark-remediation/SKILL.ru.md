...
version: "1.0"
language: ru
original: wireshark-remediation
---

# Wireshark Remediation

> Remediation with Wireshark. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Wireshark Remediation
...
## Ресурсы
- Оригинальный навык: `security/wireshark-remediation/SKILL.md`
