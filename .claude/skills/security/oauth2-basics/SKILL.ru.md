...
version: "1.0"
language: ru
original: oauth2-basics
---

# Oauth2 Basics

> Basics with OAuth 2.0. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth2-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth2 Basics
...
## Ресурсы
- Оригинальный навык: `security/oauth2-basics/SKILL.md`
