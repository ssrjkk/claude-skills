...
version: "1.0"
language: ru
original: burpsuite-scanning
---

# Burpsuite Scanning

> Scanning with Burp Suite. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Scanning
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-scanning/SKILL.md`
