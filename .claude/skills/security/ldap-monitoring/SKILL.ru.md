...
version: "1.0"
language: ru
original: ldap-monitoring
---

# Ldap Monitoring

> Monitoring with LDAP. security monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ldap-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Ldap Monitoring
...
## Ресурсы
- Оригинальный навык: `security/ldap-monitoring/SKILL.md`
