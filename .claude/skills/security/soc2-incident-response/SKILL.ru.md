...
version: "1.0"
language: ru
original: soc2-incident-response
---

# Soc2 Incident Response

> Incident Response with SOC 2. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Incident Response
...
## Ресурсы
- Оригинальный навык: `security/soc2-incident-response/SKILL.md`
