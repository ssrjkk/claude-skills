...
> Tools with SAML. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Tools
...
## Ресурсы
- Оригинальный навык: `security/saml-tools/SKILL.md`
