...
> Tools with LDAP. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ldap-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Ldap Tools
...
## Ресурсы
- Оригинальный навык: `security/ldap-tools/SKILL.md`
