...
version: "1.0"
language: ru
original: gdpr-basics
---

# Gdpr Basics

> Basics with GDPR. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gdpr-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gdpr Basics
...
## Ресурсы
- Оригинальный навык: `security/gdpr-basics/SKILL.md`
