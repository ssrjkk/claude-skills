...
> Setup with ZAP. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Setup
...
## Ресурсы
- Оригинальный навык: `security/zap-setup/SKILL.md`
