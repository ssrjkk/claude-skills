...
## Быстрый старт
Этот навык на русском языке. Оригинал: `aircrack-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aircrack Compliance
...
## Ресурсы
- Оригинальный навык: `security/aircrack-compliance/SKILL.md`
