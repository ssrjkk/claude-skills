...
category: security
tags: [openid-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openid-basics
---

# Openid Basics

> Basics with OpenID Connect. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Basics
...
## Ресурсы
- Оригинальный навык: `security/openid-basics/SKILL.md`
