...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Testing
...
## Ресурсы
- Оригинальный навык: security/snyk-testing/SKILL.md
