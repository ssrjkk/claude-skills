...
category: security
tags: [falco-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Basics
...
## Ресурсы
- Оригинальный навык: security/falco-basics/SKILL.md
