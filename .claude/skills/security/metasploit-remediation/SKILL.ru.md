...
category: security
tags: [metasploit-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: metasploit-remediation
---

# Metasploit Remediation

> Remediation with Metasploit. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Remediation
...
## Ресурсы
- Оригинальный навык: `security/metasploit-remediation/SKILL.md`
