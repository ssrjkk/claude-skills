...
category: security
tags: [conjur-guides, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: conjur-guides
---

# Conjur Guides

> Guides for Conjur: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `conjur-guides`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Conjur Guides
...
## Ресурсы
- Оригинал: security/conjur-guides/SKILL.md
