...
category: security
tags: [nist-tools, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nist-tools
...
> Tools with NIST. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Tools
...
## Ресурсы
- Оригинальный навык: `security/nist-tools/SKILL.md`
