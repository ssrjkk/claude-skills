...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-deployment`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Deployment
...
## Ресурсы
- Оригинальный навык: security/owasp-deployment/SKILL.md
