...
version: "1.0"
language: ru
original: metasploit-compliance
---

# Metasploit Compliance

> Compliance with Metasploit. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Compliance
...
## Ресурсы
- Оригинальный навык: `security/metasploit-compliance/SKILL.md`
