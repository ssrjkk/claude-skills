...
version: "1.0"
language: ru
original: kerberos-audit
---

# Kerberos Audit

> Audit with Kerberos. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kerberos-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Kerberos Audit
...
## Ресурсы
- Оригинальный навык: `security/kerberos-audit/SKILL.md`
