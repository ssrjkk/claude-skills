...
category: security
tags: [saml-advanced, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saml-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Advanced
...
## Ресурсы
- Оригинальный навык: security/saml-advanced/SKILL.md
