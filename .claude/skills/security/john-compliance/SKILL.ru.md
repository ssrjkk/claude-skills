...
version: "1.0"
language: ru
original: john-compliance
---

# John Compliance

> Compliance with John the Ripper. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Compliance
...
## Ресурсы
- Оригинальный навык: `security/john-compliance/SKILL.md`
