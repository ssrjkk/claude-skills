...
version: "1.0"
language: ru
original: openid-audit
---

# Openid Audit

> Audit with OpenID Connect. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Audit
...
## Ресурсы
- Оригинальный навык: `security/openid-audit/SKILL.md`
