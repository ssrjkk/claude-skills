...
version: "1.0"
language: ru
original: owasp-basics
---

# Owasp Basics

> Basics with OWASP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Basics
...
## Ресурсы
- Оригинальный навык: `security/owasp-basics/SKILL.md`
