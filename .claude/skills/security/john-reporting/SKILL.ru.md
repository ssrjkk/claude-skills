...
category: security
tags: [john-reporting, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: john-reporting
---

# John Reporting

> Reporting with John the Ripper. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Reporting
...
## Ресурсы
- Оригинальный навык: `security/john-reporting/SKILL.md`
