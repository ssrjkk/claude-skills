...
category: security
tags: [trivy-analysis, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-analysis
---

# Trivy Analysis

> Analysis with Trivy. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Analysis
...
## Ресурсы
- Оригинальный навык: `security/trivy-analysis/SKILL.md`
