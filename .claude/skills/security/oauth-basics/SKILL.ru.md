...
category: security
tags: [oauth-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oauth-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth Basics
...
## Ресурсы
- Оригинальный навык: security/oauth-basics/SKILL.md
