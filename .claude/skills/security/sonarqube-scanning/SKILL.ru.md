...
category: security
tags: [sonarqube-scanning, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sonarqube-scanning
---

# Sonarqube Scanning

> Scanning with SonarQube. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sonarqube-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sonarqube Scanning
...
## Ресурсы
- Оригинальный навык: `security/sonarqube-scanning/SKILL.md`
