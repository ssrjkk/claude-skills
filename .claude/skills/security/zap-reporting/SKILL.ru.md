...
version: "1.0"
language: ru
original: zap-reporting
---

# Zap Reporting

> Reporting with ZAP. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Reporting
...
## Ресурсы
- Оригинальный навык: `security/zap-reporting/SKILL.md`
