...
## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-optimization`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Optimization
...
## Ресурсы
- Оригинальный навык: security/saml-optimization/SKILL.md
