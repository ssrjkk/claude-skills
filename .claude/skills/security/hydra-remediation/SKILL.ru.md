...
version: "1.0"
language: ru
original: hydra-remediation
---

# Hydra Remediation

> Remediation with Hydra. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hydra-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hydra Remediation
...
## Ресурсы
- Оригинальный навык: `security/hydra-remediation/SKILL.md`
