...
category: security
tags: [owasp-monitoring, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: owasp-monitoring
---

# Owasp Monitoring

> Monitoring with OWASP. security monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Monitoring
...
## Ресурсы
- Оригинальный навык: `security/owasp-monitoring/SKILL.md`
