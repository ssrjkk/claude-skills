...
category: security
tags: [trivy-optimization, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-optimization`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Optimization
...
## Ресурсы
- Оригинальный навык: security/trivy-optimization/SKILL.md
