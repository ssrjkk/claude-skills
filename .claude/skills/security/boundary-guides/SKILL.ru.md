...
version: "1.0"
language: ru
original: boundary-guides
---

# Boundary Guides

> Guides for Boundary: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `boundary-guides`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Boundary Guides
...
## Ресурсы
- Оригинал: security/boundary-guides/SKILL.md
