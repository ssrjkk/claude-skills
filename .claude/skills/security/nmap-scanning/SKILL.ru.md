...
version: "1.0"
language: ru
original: nmap-scanning
---

# Nmap Scanning

> Scanning with Nmap. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nmap Scanning
...
## Ресурсы
- Оригинальный навык: `security/nmap-scanning/SKILL.md`
