...
category: security
tags: [trivy-advanced, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Advanced
...
## Ресурсы
- Оригинальный навык: security/trivy-advanced/SKILL.md
