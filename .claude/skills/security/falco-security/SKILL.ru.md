...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-security`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Security
...
## Ресурсы
- Оригинальный навык: security/falco-security/SKILL.md
