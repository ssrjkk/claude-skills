...
version: "1.0"
language: ru
original: tfsec-configuration
---

# Tfsec Configuration

> Configuration for Tfsec: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: tfsec-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tfsec Configuration
...
## Ресурсы
- security/tfsec-configuration/SKILL.md
