...
version: "1.0"
language: ru
original: aws-kms-fundamentals
---

# Aws Kms Fundamentals

> Fundamentals for Aws-Kms: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `aws-kms-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aws Kms Fundamentals
...
## Ресурсы
- Оригинал: security/aws-kms-fundamentals/SKILL.md
