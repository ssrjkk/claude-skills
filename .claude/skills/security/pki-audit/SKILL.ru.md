...
> Audit with PKI. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pki-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pki Audit
...
## Ресурсы
- Оригинальный навык: `security/pki-audit/SKILL.md`
