...
category: security
tags: [nmap-compliance, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nmap-compliance
---

# Nmap Compliance

> Compliance with Nmap. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nmap-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nmap Compliance
...
## Ресурсы
- Оригинальный навык: `security/nmap-compliance/SKILL.md`
