...
category: security
tags: [burpsuite-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: burpsuite-setup
---

# Burpsuite Setup

> Setup with Burp Suite. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Setup
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-setup/SKILL.md`
