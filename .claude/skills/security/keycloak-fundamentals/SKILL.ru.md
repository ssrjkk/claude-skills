...
version: "1.0"
language: ru
original: keycloak-fundamentals
---

# Keycloak Fundamentals

> Fundamentals for Keycloak: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `keycloak-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Keycloak Fundamentals
...
## Ресурсы
- Оригинал: security/keycloak-fundamentals/SKILL.md
