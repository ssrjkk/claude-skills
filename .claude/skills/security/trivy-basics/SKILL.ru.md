...
category: security
tags: [trivy-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Basics
...
## Ресурсы
- Оригинальный навык: security/trivy-basics/SKILL.md
