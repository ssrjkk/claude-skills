...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Monitoring
...
## Ресурсы
- Оригинальный навык: security/falco-monitoring/SKILL.md
