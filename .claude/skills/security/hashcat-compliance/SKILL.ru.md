...
category: security
tags: [hashcat-compliance, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hashcat-compliance
---

# Hashcat Compliance

> Compliance with Hashcat. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hashcat-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hashcat Compliance
...
## Ресурсы
- Оригинальный навык: `security/hashcat-compliance/SKILL.md`
