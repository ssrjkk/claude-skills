...
version: "1.0"
language: ru
original: zap-scanning
---

# Zap Scanning

> Scanning with ZAP. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Scanning
...
## Ресурсы
- Оригинальный навык: `security/zap-scanning/SKILL.md`
