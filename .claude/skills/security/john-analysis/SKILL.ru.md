...
category: security
tags: [john-analysis, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: john-analysis
---

# John Analysis

> Analysis with John the Ripper. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Analysis
...
## Ресурсы
- Оригинальный навык: `security/john-analysis/SKILL.md`
