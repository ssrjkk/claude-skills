...
version: "1.0"
language: ru
original: crowdstrike-production
---

# Crowdstrike Production

> Production for Crowdstrike: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: crowdstrike-production.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Crowdstrike Production
...
## Ресурсы
- security/crowdstrike-production/SKILL.md
