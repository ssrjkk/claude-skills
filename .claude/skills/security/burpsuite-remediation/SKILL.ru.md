...
category: security
tags: [burpsuite-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: burpsuite-remediation
---

# Burpsuite Remediation

> Remediation with Burp Suite. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Remediation
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-remediation/SKILL.md`
