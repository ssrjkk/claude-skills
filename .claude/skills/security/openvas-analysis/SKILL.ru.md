...
version: "1.0"
language: ru
original: openvas-analysis
---

# Openvas Analysis

> Analysis with OpenVAS. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Analysis
...
## Ресурсы
- Оригинальный навык: `security/openvas-analysis/SKILL.md`
