...
version: "1.0"
language: ru
original: nist-best-practices
---

# Nist Best Practices

> Best Practices with NIST. best practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-best-practices`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Best Practices
...
## Ресурсы
- Оригинальный навык: `security/nist-best-practices/SKILL.md`
