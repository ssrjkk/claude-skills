...
version: "1.0"
language: ru
original: cyberark-guides
---

# Cyberark Guides

> Guides for Cyberark: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cyberark-guides`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Cyberark Guides
...
## Ресурсы
- Оригинал: security/cyberark-guides/SKILL.md
