...
category: security
tags: [ldap-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ldap-basics
---

# Ldap Basics

> Basics with LDAP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ldap-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Ldap Basics
...
## Ресурсы
- Оригинальный навык: `security/ldap-basics/SKILL.md`
