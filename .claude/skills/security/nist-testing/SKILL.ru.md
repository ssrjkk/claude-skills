...
version: "1.0"
language: ru
original: nist-testing
---

# Nist Testing

> Testing with NIST. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nist-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nist Testing
...
## Ресурсы
- Оригинальный навык: `security/nist-testing/SKILL.md`
