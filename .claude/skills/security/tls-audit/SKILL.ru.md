...
category: security
tags: [tls-audit, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tls-audit
...
> Audit with TLS/SSL. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tls-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tls Audit
...
## Ресурсы
- Оригинальный навык: `security/tls-audit/SKILL.md`
