...
version: "1.0"
language: ru
original: boundary-fundamentals
---

# Boundary Fundamentals

> Fundamentals for Boundary: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `boundary-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Boundary Fundamentals
...
## Ресурсы
- Оригинал: security/boundary-fundamentals/SKILL.md
