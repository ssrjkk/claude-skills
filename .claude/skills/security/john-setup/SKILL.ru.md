...
> Setup with John the Ripper. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Setup
...
## Ресурсы
- Оригинальный навык: `security/john-setup/SKILL.md`
