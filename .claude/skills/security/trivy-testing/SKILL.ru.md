...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Testing
...
## Ресурсы
- Оригинальный навык: security/trivy-testing/SKILL.md
