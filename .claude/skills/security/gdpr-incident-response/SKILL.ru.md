...
version: "1.0"
language: ru
original: gdpr-incident-response
---

# Gdpr Incident Response

> Incident Response with GDPR. incident response.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gdpr-incident-response`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gdpr Incident Response
...
## Ресурсы
- Оригинальный навык: `security/gdpr-incident-response/SKILL.md`
