...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gpg-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gpg Advanced
...
## Ресурсы
- Оригинальный навык: security/gpg-advanced/SKILL.md
