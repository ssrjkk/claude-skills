...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Monitoring
...
## Ресурсы
- Оригинальный навык: security/trivy-monitoring/SKILL.md
