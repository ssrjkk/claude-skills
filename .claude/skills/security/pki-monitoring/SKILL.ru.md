...
version: "1.0"
language: ru
original: pki-monitoring
---

# Pki Monitoring

> Monitoring with PKI. security monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pki-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pki Monitoring
...
## Ресурсы
- Оригинальный навык: `security/pki-monitoring/SKILL.md`
