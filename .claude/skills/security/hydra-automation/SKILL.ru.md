...
version: "1.0"
language: ru
original: hydra-automation
---

# Hydra Automation

> Automation with Hydra. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hydra-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hydra Automation
...
## Ресурсы
- Оригинальный навык: `security/hydra-automation/SKILL.md`
