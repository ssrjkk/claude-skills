...
category: security
tags: [sonarqube-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sonarqube-setup
---

# Sonarqube Setup

> Setup with SonarQube. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sonarqube-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sonarqube Setup
...
## Ресурсы
- Оригинальный навык: `security/sonarqube-setup/SKILL.md`
