...
category: security
tags: [conjur-fundamentals, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: conjur-fundamentals
---

# Conjur Fundamentals

> Fundamentals for Conjur: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `conjur-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Conjur Fundamentals
...
## Ресурсы
- Оригинал: security/conjur-fundamentals/SKILL.md
