...
version: "1.0"
language: ru
original: openid-testing
---

# Openid Testing

> Testing with OpenID Connect. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Testing
...
## Ресурсы
- Оригинальный навык: `security/openid-testing/SKILL.md`
