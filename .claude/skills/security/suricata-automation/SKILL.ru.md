...
version: "1.0"
language: ru
original: suricata-automation
---

# Suricata Automation

> Automation for Suricata: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: suricata-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Suricata Automation
...
## Ресурсы
- security/suricata-automation/SKILL.md
