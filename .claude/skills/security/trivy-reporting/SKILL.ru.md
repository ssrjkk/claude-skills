...
version: "1.0"
language: ru
original: trivy-reporting
---

# Trivy Reporting

> Reporting with Trivy. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Reporting
...
## Ресурсы
- Оригинальный навык: `security/trivy-reporting/SKILL.md`
