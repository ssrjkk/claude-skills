...
version: "1.0"
language: ru
original: gitleaks-configuration
---

# Gitleaks Configuration

> Configuration for Gitleaks: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: gitleaks-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gitleaks Configuration
...
## Ресурсы
- security/gitleaks-configuration/SKILL.md
