...
category: security
tags: [nessus-automation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nessus-automation
---

# Nessus Automation

> Automation with Nessus. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Automation
...
## Ресурсы
- Оригинальный навык: `security/nessus-automation/SKILL.md`
