...
version: "1.0"
language: ru
original: checkov-automation
---

# Checkov Automation

> Automation for Checkov: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: checkov-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Checkov Automation
...
## Ресурсы
- security/checkov-automation/SKILL.md
