...
version: "1.0"
language: ru
original: kerberos-tools
---

# Kerberos Tools

> Tools with Kerberos. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kerberos-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Kerberos Tools
...
## Ресурсы
- Оригинальный навык: `security/kerberos-tools/SKILL.md`
