...
version: "1.0"
language: ru
original: john-remediation
---

# John Remediation

> Remediation with John the Ripper. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `john-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Remediation
...
## Ресурсы
- Оригинальный навык: `security/john-remediation/SKILL.md`
