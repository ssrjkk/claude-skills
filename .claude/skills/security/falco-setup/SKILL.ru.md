...
category: security
tags: [falco-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Setup
...
## Ресурсы
- Оригинальный навык: security/falco-setup/SKILL.md
