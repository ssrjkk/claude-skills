...
version: "1.0"
language: ru
original: openvas-compliance
---

# Openvas Compliance

> Compliance with OpenVAS. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Compliance
...
## Ресурсы
- Оригинальный навык: `security/openvas-compliance/SKILL.md`
