...
version: "1.0"
language: ru
original: snyk-scanning
---

# Snyk Scanning

> Scanning with Snyk. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Scanning
...
## Ресурсы
- Оригинальный навык: `security/snyk-scanning/SKILL.md`
