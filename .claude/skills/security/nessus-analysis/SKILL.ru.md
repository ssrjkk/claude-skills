...
version: "1.0"
language: ru
original: nessus-analysis
---

# Nessus Analysis

> Analysis with Nessus. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Analysis
...
## Ресурсы
- Оригинальный навык: `security/nessus-analysis/SKILL.md`
