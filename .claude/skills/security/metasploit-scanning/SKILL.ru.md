...
category: security
tags: [metasploit-scanning, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: metasploit-scanning
---

# Metasploit Scanning

> Scanning with Metasploit. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Scanning
...
## Ресурсы
- Оригинальный навык: `security/metasploit-scanning/SKILL.md`
