...
version: "1.0"
language: ru
original: nessus-compliance
---

# Nessus Compliance

> Compliance with Nessus. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Compliance
...
## Ресурсы
- Оригинальный навык: `security/nessus-compliance/SKILL.md`
