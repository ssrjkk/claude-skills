...
version: "1.0"
language: ru
original: authentik-fundamentals
---

# Authentik Fundamentals

> Fundamentals for Authentik: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `authentik-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Authentik Fundamentals
...
## Ресурсы
- Оригинал: security/authentik-fundamentals/SKILL.md
