...
version: "1.0"
language: ru
original: sonarqube-automation
---

# Sonarqube Automation

> Automation with SonarQube. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sonarqube-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sonarqube Automation
...
## Ресурсы
- Оригинальный навык: `security/sonarqube-automation/SKILL.md`
