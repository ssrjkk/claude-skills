...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vault-deployment`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Vault Deployment
...
## Ресурсы
- Оригинальный навык: security/vault-deployment/SKILL.md
