...
version: "1.0"
language: ru
original: sentinelone-best-practices
---

# Sentinelone Best Practices

> Best Practices for Sentinelone: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: sentinelone-best-practices.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sentinelone Best Practices
...
## Ресурсы
- security/sentinelone-best-practices/SKILL.md
