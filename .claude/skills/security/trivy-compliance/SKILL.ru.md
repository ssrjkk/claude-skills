...
category: security
tags: [trivy-compliance, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-compliance
---

# Trivy Compliance

> Compliance with Trivy. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Compliance
...
## Ресурсы
- Оригинальный навык: `security/trivy-compliance/SKILL.md`
