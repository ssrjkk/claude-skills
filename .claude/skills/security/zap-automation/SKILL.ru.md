...
version: "1.0"
language: ru
original: zap-automation
---

# Zap Automation

> Automation with ZAP. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Automation
...
## Ресурсы
- Оригинальный навык: `security/zap-automation/SKILL.md`
