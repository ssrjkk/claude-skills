...
category: security
tags: [oauth-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth Setup
...
## Ресурсы
- Оригинальный навык: security/oauth-setup/SKILL.md
