...
category: security
tags: [metasploit-analysis, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: metasploit-analysis
---

# Metasploit Analysis

> Analysis with Metasploit. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Analysis
...
## Ресурсы
- Оригинальный навык: `security/metasploit-analysis/SKILL.md`
