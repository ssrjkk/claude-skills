...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-debugging`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Debugging
...
## Ресурсы
- Оригинальный навык: security/trivy-debugging/SKILL.md
