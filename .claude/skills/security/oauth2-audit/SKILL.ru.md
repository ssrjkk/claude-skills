...
category: security
tags: [oauth2-audit, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oauth2-audit
---

# Oauth2 Audit

> Audit with OAuth 2.0. security audit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth2-audit`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth2 Audit
...
## Ресурсы
- Оригинальный навык: `security/oauth2-audit/SKILL.md`
