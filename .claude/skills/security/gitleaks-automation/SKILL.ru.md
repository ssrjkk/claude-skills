...
version: "1.0"
language: ru
original: gitleaks-automation
---

# Gitleaks Automation

> Automation for Gitleaks: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: gitleaks-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gitleaks Automation
...
## Ресурсы
- security/gitleaks-automation/SKILL.md
