...
category: security
tags: [openvas-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openvas-setup
---

# Openvas Setup

> Setup with OpenVAS. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Setup
...
## Ресурсы
- Оригинальный навык: `security/openvas-setup/SKILL.md`
