...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-optimization`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Optimization
...
## Ресурсы
- Оригинальный навык: security/falco-optimization/SKILL.md
