...
version: "1.0"
language: ru
original: gitleaks-best-practices
---

# Gitleaks Best Practices

> Best Practices for Gitleaks: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: gitleaks-best-practices.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gitleaks Best Practices
...
## Ресурсы
- security/gitleaks-best-practices/SKILL.md
