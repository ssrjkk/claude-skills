...
version: "1.0"
language: ru
original: cyberark-examples
---

# Cyberark Examples

> Examples for Cyberark: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cyberark-examples`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Cyberark Examples
...
## Ресурсы
- Оригинал: security/cyberark-examples/SKILL.md
