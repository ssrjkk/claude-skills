...
category: security
tags: [falco-testing, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Testing
...
## Ресурсы
- Оригинальный навык: security/falco-testing/SKILL.md
