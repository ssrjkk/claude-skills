...
version: "1.0"
language: ru
original: trivy-remediation
---

# Trivy Remediation

> Remediation with Trivy. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Remediation
...
## Ресурсы
- Оригинальный навык: `security/trivy-remediation/SKILL.md`
