...
version: "1.0"
language: ru
original: sqlmap-compliance
---

# Sqlmap Compliance

> Compliance with SQLmap. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlmap-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sqlmap Compliance
...
## Ресурсы
- Оригинальный навык: `security/sqlmap-compliance/SKILL.md`
