...
> Setup with Snyk. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Setup
...
## Ресурсы
- Оригинальный навык: `security/snyk-setup/SKILL.md`
