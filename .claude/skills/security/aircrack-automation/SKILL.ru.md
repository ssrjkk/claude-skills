...
category: security
tags: [aircrack-automation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aircrack-automation
---

# Aircrack Automation

> Automation with Aircrack-ng. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aircrack-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Aircrack Automation
...
## Ресурсы
- Оригинальный навык: `security/aircrack-automation/SKILL.md`
