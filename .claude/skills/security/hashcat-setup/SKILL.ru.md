...
version: "1.0"
language: ru
original: hashcat-setup
---

# Hashcat Setup

> Setup with Hashcat. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hashcat-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hashcat Setup
...
## Ресурсы
- Оригинальный навык: `security/hashcat-setup/SKILL.md`
