...
version: "1.0"
language: ru
original: oauth2-testing
---

# Oauth2 Testing

> Testing with OAuth 2.0. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth2-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth2 Testing
...
## Ресурсы
- Оригинальный навык: `security/oauth2-testing/SKILL.md`
