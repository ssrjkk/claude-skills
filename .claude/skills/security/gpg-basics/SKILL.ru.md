...
category: security
tags: [gpg-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gpg-basics
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gpg-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gpg Basics
...
## Ресурсы
- Оригинальный навык: security/gpg-basics/SKILL.md
