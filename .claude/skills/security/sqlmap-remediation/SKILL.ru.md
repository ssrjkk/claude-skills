...
version: "1.0"
language: ru
original: sqlmap-remediation
---

# Sqlmap Remediation

> Remediation with SQLmap. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlmap-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sqlmap Remediation
...
## Ресурсы
- Оригинальный навык: `security/sqlmap-remediation/SKILL.md`
