...
version: "1.0"
language: ru
original: wazuh-best-practices
---

# Wazuh Best Practices

> Best Practices for Wazuh: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: wazuh-best-practices.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Wazuh Best Practices
...
## Ресурсы
- security/wazuh-best-practices/SKILL.md
