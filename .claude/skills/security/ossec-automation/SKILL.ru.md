...
version: "1.0"
language: ru
original: ossec-automation
---

# Ossec Automation

> Automation for Ossec: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: ossec-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Ossec Automation
...
## Ресурсы
- security/ossec-automation/SKILL.md
