...
version: "1.0"
language: ru
original: checkov-configuration
---

# Checkov Configuration

> Configuration for Checkov: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: checkov-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Checkov Configuration
...
## Ресурсы
- security/checkov-configuration/SKILL.md
