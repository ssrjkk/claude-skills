...
category: security
tags: [falco-debugging, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-debugging`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Debugging
...
## Ресурсы
- Оригинальный навык: security/falco-debugging/SKILL.md
