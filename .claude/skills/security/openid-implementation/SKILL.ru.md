...
version: "1.0"
language: ru
original: openid-implementation
---

# Openid Implementation

> Implementation with OpenID Connect. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openid-implementation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openid Implementation
...
## Ресурсы
- Оригинальный навык: `security/openid-implementation/SKILL.md`
