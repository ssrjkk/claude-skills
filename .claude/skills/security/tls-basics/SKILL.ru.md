...
category: security
tags: [tls-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tls-basics
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tls-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Tls Basics
...
## Ресурсы
- Оригинальный навык: `security/tls-basics/SKILL.md`
