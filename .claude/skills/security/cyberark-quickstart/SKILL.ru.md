...
version: "1.0"
language: ru
original: cyberark-quickstart
---

# Cyberark Quickstart

> Quickstart for Cyberark: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cyberark-quickstart`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Cyberark Quickstart
...
## Ресурсы
- Оригинал: security/cyberark-quickstart/SKILL.md
