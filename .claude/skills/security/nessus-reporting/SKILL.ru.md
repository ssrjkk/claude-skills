...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Reporting
...
## Ресурсы
- Оригинальный навык: `security/nessus-reporting/SKILL.md`
