...
version: "1.0"
language: ru
original: owasp-tools
---

# Owasp Tools

> Tools with OWASP. security tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-tools`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Tools
...
## Ресурсы
- Оригинальный навык: `security/owasp-tools/SKILL.md`
