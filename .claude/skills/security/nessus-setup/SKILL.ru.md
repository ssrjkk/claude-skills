...
version: "1.0"
language: ru
original: nessus-setup
---

# Nessus Setup

> Setup with Nessus. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Setup
...
## Ресурсы
- Оригинальный навык: `security/nessus-setup/SKILL.md`
