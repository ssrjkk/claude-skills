...
category: security
tags: [soc2-best-practices, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: soc2-best-practices
---

# Soc2 Best Practices

> Best Practices with SOC 2. best practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-best-practices`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Best Practices
...
## Ресурсы
- Оригинальный навык: `security/soc2-best-practices/SKILL.md`
