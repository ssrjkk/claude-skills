...
version: "1.0"
language: ru
original: openvas-automation
---

# Openvas Automation

> Automation with OpenVAS. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Automation
...
## Ресурсы
- Оригинальный навык: `security/openvas-automation/SKILL.md`
