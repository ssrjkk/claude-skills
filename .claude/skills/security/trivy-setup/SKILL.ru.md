...
category: security
tags: [trivy-setup, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-setup
---

# Trivy Setup

> Setup with Trivy. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-setup`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Setup
...
## Ресурсы
- Оригинальный навык: `security/trivy-setup/SKILL.md`
