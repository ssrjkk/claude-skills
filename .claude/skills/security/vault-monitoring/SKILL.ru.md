...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vault-monitoring`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Vault Monitoring
...
## Ресурсы
- Оригинальный навык: security/vault-monitoring/SKILL.md
