...
category: security
tags: [burpsuite-automation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: burpsuite-automation
---

# Burpsuite Automation

> Automation with Burp Suite. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Automation
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-automation/SKILL.md`
