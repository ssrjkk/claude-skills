...
version: "1.0"
language: ru
original: openvas-remediation
---

# Openvas Remediation

> Remediation with OpenVAS. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openvas-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Openvas Remediation
...
## Ресурсы
- Оригинальный навык: `security/openvas-remediation/SKILL.md`
