...
category: security
tags: [soc2-testing, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: soc2-testing
---

# Soc2 Testing

> Testing with SOC 2. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `soc2-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Soc2 Testing
...
## Ресурсы
- Оригинальный навык: `security/soc2-testing/SKILL.md`
