...
category: security
tags: [hashcat-analysis, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hashcat-analysis
---

# Hashcat Analysis

> Analysis with Hashcat. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hashcat-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Hashcat Analysis
...
## Ресурсы
- Оригинальный навык: `security/hashcat-analysis/SKILL.md`
