...
version: "1.0"
language: ru
original: zap-compliance
---

# Zap Compliance

> Compliance with ZAP. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Compliance
...
## Ресурсы
- Оригинальный навык: `security/zap-compliance/SKILL.md`
