...
## Быстрый старт
Этот навык на русском языке. Оригинал: `oauth-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Oauth Advanced
...
## Ресурсы
- Оригинальный навык: security/oauth-advanced/SKILL.md
