...
version: "1.0"
language: ru
original: pki-testing
---

# Pki Testing

> Testing with PKI. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pki-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pki Testing
...
## Ресурсы
- Оригинальный навык: `security/pki-testing/SKILL.md`
