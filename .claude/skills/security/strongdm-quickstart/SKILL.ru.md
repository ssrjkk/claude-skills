...
category: security
tags: [strongdm-quickstart, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strongdm-quickstart
---

# Strongdm Quickstart

> Quickstart for Strongdm: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `strongdm-quickstart`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Strongdm Quickstart
...
## Ресурсы
- Оригинал: security/strongdm-quickstart/SKILL.md
