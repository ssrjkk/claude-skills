...
version: "1.0"
language: ru
original: trivy-scanning
---

# Trivy Scanning

> Scanning with Trivy. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Scanning
...
## Ресурсы
- Оригинальный навык: `security/trivy-scanning/SKILL.md`
