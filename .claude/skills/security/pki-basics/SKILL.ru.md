...
> Basics with PKI. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pki-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pki Basics
...
## Ресурсы
- Оригинальный навык: `security/pki-basics/SKILL.md`
