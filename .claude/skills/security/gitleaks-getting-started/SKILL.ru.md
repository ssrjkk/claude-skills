...
version: "1.0"
language: ru
original: gitleaks-getting-started
---

# Gitleaks Getting Started

> Getting Started for Gitleaks: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: gitleaks-getting-started.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gitleaks Getting Started
...
## Ресурсы
- security/gitleaks-getting-started/SKILL.md
