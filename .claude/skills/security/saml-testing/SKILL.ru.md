...
version: "1.0"
language: ru
original: saml-testing
---

# Saml Testing

> Testing with SAML. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saml-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Saml Testing
...
## Ресурсы
- Оригинальный навык: `security/saml-testing/SKILL.md`
