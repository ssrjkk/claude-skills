...
version: "1.0"
language: ru
original: zeek-best-practices
---

# Zeek Best Practices

> Best Practices for Zeek: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: zeek-best-practices.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zeek Best Practices
...
## Ресурсы
- security/zeek-best-practices/SKILL.md
