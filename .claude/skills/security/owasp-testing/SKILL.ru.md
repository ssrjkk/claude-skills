...
version: "1.0"
language: ru
original: owasp-testing
---

# Owasp Testing

> Testing with OWASP. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Testing
...
## Ресурсы
- Оригинальный навык: `security/owasp-testing/SKILL.md`
