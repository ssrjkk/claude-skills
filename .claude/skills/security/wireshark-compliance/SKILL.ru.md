...
version: "1.0"
language: ru
original: wireshark-compliance
---

# Wireshark Compliance

> Compliance with Wireshark. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireshark-compliance`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Wireshark Compliance
...
## Ресурсы
- Оригинальный навык: `security/wireshark-compliance/SKILL.md`
