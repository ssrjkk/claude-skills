...
version: "1.0"
language: ru
original: gdpr-testing
---

# Gdpr Testing

> Testing with GDPR. security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gdpr-testing`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Gdpr Testing
...
## Ресурсы
- Оригинальный навык: `security/gdpr-testing/SKILL.md`
