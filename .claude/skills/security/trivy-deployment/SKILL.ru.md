...
category: security
tags: [trivy-deployment, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trivy-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trivy-deployment`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Trivy Deployment
...
## Ресурсы
- Оригинальный навык: security/trivy-deployment/SKILL.md
