...
category: security
tags: [pcidss-basics, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pcidss-basics
---

# Pcidss Basics

> Basics with PCI DSS. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pcidss-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Pcidss Basics
...
## Ресурсы
- Оригинальный навык: `security/pcidss-basics/SKILL.md`
