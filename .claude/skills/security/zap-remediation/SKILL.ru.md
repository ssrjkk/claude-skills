...
category: security
tags: [zap-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zap-remediation
---

# Zap Remediation

> Remediation with ZAP. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Remediation
...
## Ресурсы
- Оригинальный навык: `security/zap-remediation/SKILL.md`
