...
category: security
tags: [cyberark-fundamentals, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cyberark-fundamentals
---

# Cyberark Fundamentals

> Fundamentals for Cyberark: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cyberark-fundamentals`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Cyberark Fundamentals
...
## Ресурсы
- Оригинал: security/cyberark-fundamentals/SKILL.md
