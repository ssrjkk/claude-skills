...
version: "1.0"
language: ru
original: metasploit-reporting
---

# Metasploit Reporting

> Reporting with Metasploit. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metasploit-reporting`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Metasploit Reporting
...
## Ресурсы
- Оригинальный навык: `security/metasploit-reporting/SKILL.md`
