...
category: security
tags: [vault-advanced, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vault-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vault-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Vault Advanced
...
## Ресурсы
- Оригинальный навык: security/vault-advanced/SKILL.md
