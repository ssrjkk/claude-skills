...
version: "1.0"
language: ru
original: wazuh-automation
---

# Wazuh Automation

> Automation for Wazuh: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: wazuh-automation.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Wazuh Automation
...
## Ресурсы
- security/wazuh-automation/SKILL.md
