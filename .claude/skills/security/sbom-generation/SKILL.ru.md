...
version: "1.0"
language: ru
original: sbom-generation
---

# Sbom Generation

> Generates Software Bill of Materials (SBOM) for tracking dependencies and vulnerabilities. Use for supply chain security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbom-generation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Sbom Generation
...
## Ресурсы
- Оригинальный навык: `security/sbom-generation/SKILL.md`
