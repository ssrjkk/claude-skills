...
version: "1.0"
language: ru
original: teleport-quickstart
---

# Teleport Quickstart

> Quickstart for Teleport: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `teleport-quickstart`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Teleport Quickstart
...
## Ресурсы
- Оригинал: security/teleport-quickstart/SKILL.md
