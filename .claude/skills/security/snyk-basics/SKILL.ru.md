...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-basics`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Basics
...
## Ресурсы
- Оригинальный навык: security/snyk-basics/SKILL.md
