...
category: security
tags: [falco-deployment, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falco-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `falco-deployment`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Falco Deployment
...
## Ресурсы
- Оригинальный навык: security/falco-deployment/SKILL.md
