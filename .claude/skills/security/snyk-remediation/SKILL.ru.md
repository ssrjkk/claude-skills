...
version: "1.0"
language: ru
original: snyk-remediation
---

# Snyk Remediation

> Remediation with Snyk. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Remediation
...
## Ресурсы
- Оригинальный навык: `security/snyk-remediation/SKILL.md`
