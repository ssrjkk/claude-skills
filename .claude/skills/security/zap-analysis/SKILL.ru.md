...
version: "1.0"
language: ru
original: zap-analysis
---

# Zap Analysis

> Analysis with ZAP. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zap-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Zap Analysis
...
## Ресурсы
- Оригинальный навык: `security/zap-analysis/SKILL.md`
