...
category: security
tags: [owasp-advanced, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: owasp-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-advanced`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Advanced
...
## Ресурсы
- Оригинальный навык: security/owasp-advanced/SKILL.md
