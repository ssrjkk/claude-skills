...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-debugging`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Debugging
...
## Ресурсы
- Оригинальный навык: security/owasp-debugging/SKILL.md
