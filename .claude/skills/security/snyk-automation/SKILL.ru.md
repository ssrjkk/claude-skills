...
version: "1.0"
language: ru
original: snyk-automation
---

# Snyk Automation

> Automation with Snyk. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snyk-automation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Snyk Automation
...
## Ресурсы
- Оригинальный навык: `security/snyk-automation/SKILL.md`
