...
version: "1.0"
language: ru
original: suricata-configuration
---

# Suricata Configuration

> Configuration for Suricata: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: suricata-configuration.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Suricata Configuration
...
## Ресурсы
- security/suricata-configuration/SKILL.md
