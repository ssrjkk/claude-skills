...
version: "1.0"
language: ru
original: burpsuite-analysis
---

# Burpsuite Analysis

> Analysis with Burp Suite. analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `burpsuite-analysis`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Burpsuite Analysis
...
## Ресурсы
- Оригинальный навык: `security/burpsuite-analysis/SKILL.md`
