...
category: security
tags: [john-scanning, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: john-scanning
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `john-scanning`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с John Scanning
...
## Ресурсы
- Оригинальный навык: `security/john-scanning/SKILL.md`
