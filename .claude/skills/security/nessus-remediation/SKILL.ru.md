...
category: security
tags: [nessus-remediation, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nessus-remediation
---

# Nessus Remediation

> Remediation with Nessus. fixing vulns.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nessus-remediation`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Nessus Remediation
...
## Ресурсы
- Оригинальный навык: `security/nessus-remediation/SKILL.md`
