...
category: security
tags: [owasp-security, security, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: owasp-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `owasp-security`.

## Когда использовать
- Работа с Безопасность
- Выполнение задач, связанных с Owasp Security
...
## Ресурсы
- Оригинальный навык: security/owasp-security/SKILL.md
