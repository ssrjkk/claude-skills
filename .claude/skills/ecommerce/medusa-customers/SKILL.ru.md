...
category: ecommerce
tags: [medusa-customers, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: medusa-customers
---

# Medusa Customers

> Customers with Medusa. customer API.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-customers`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Customers
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-customers/SKILL.md`
