...
version: "1.0"
language: ru
original: saleor-marketing
---

# Saleor Marketing

> Marketing with Saleor. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-marketing/SKILL.md`
