...
category: ecommerce
tags: [vendure-customers, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vendure-customers
---

# Vendure Customers

> Customers with Vendure. customer API.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vendure-customers`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Vendure Customers
...
## Ресурсы
- Оригинальный навык: `ecommerce/vendure-customers/SKILL.md`
