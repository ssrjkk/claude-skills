...
> Setup with Medusa. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-setup`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Setup
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-setup/SKILL.md`
