...
category: ecommerce
tags: [commercetools-customers, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: commercetools-customers
---

# Commercetools Customers

> Customers with commercetools. customer API.

## Быстрый старт
Этот навык на русском языке. Оригинал: `commercetools-customers`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Commercetools Customers
...
## Ресурсы
- Оригинальный навык: `ecommerce/commercetools-customers/SKILL.md`
