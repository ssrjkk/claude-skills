...
category: ecommerce
tags: [shopify-setup, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shopify-setup
---

# Shopify Setup

> Setup with Shopify. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-setup`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Setup
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-setup/SKILL.md`
