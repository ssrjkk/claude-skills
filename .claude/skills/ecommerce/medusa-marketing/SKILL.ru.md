...
version: "1.0"
language: ru
original: medusa-marketing
---

# Medusa Marketing

> Marketing with Medusa. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-marketing/SKILL.md`
