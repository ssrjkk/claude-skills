...
version: "1.0"
language: ru
original: saleor-cart
---

# Saleor Cart

> Cart with Saleor. cart.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-cart`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Cart
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-cart/SKILL.md`
