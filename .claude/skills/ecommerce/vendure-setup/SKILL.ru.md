...
version: "1.0"
language: ru
original: vendure-setup
---

# Vendure Setup

> Setup with Vendure. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vendure-setup`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Vendure Setup
...
## Ресурсы
- Оригинальный навык: `ecommerce/vendure-setup/SKILL.md`
