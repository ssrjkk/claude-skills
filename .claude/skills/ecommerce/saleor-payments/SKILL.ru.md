...
version: "1.0"
language: ru
original: saleor-payments
---

# Saleor Payments

> Payments with Saleor. payment integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-payments`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Payments
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-payments/SKILL.md`
