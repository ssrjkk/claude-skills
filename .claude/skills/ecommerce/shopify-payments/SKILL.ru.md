...
category: ecommerce
tags: [shopify-payments, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shopify-payments
---

# Shopify Payments

> Payments with Shopify. payment integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-payments`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Payments
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-payments/SKILL.md`
