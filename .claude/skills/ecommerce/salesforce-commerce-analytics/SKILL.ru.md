...
version: "1.0"
language: ru
original: salesforce-commerce-analytics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `salesforce-commerce-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Salesforce Commerce Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/salesforce-commerce-analytics/SKILL.md`
