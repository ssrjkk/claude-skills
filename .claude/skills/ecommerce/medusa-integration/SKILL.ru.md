...
version: "1.0"
language: ru
original: medusa-integration
---

# Medusa Integration

> Integration with Medusa. frontend integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-integration`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Integration
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-integration/SKILL.md`
