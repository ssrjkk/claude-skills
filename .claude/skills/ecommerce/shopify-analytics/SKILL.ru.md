...
version: "1.0"
language: ru
original: shopify-analytics
---

# Shopify Analytics

> Analytics with Shopify. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-analytics/SKILL.md`
