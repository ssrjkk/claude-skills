...
version: "1.0"
language: ru
original: saleor-setup
---

# Saleor Setup

> Setup with Saleor. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-setup`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Setup
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-setup/SKILL.md`
