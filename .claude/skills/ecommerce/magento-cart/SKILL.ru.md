...
category: ecommerce
tags: [magento-cart, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: magento-cart
---

# Magento Cart

> Cart with Magento. cart.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-cart`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Cart
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-cart/SKILL.md`
