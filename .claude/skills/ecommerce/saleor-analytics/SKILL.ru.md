...
version: "1.0"
language: ru
original: saleor-analytics
---

# Saleor Analytics

> Analytics with Saleor. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-analytics/SKILL.md`
