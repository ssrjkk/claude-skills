...
version: "1.0"
language: ru
original: medusa-analytics
---

# Medusa Analytics

> Analytics with Medusa. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-analytics/SKILL.md`
