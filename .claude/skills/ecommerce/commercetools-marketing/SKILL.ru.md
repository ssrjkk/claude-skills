...
version: "1.0"
language: ru
original: commercetools-marketing
---

# Commercetools Marketing

> Marketing with commercetools. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `commercetools-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Commercetools Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/commercetools-marketing/SKILL.md`
