...
version: "1.0"
language: ru
original: shopify-storefront-customers
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-storefront-customers`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Storefront Customers
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-storefront-customers/SKILL.md`
