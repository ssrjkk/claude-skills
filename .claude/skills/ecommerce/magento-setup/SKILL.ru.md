...
category: ecommerce
tags: [magento-setup, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: magento-setup
---

# Magento Setup

> Setup with Magento. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-setup`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Setup
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-setup/SKILL.md`
