...
version: "1.0"
language: ru
original: saleor-integration
---

# Saleor Integration

> Integration with Saleor. frontend integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-integration`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Integration
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-integration/SKILL.md`
