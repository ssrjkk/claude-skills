...
version: "1.0"
language: ru
original: salesforce-commerce-orders
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `salesforce-commerce-orders`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Salesforce Commerce Orders
...
## Ресурсы
- Оригинальный навык: `ecommerce/salesforce-commerce-orders/SKILL.md`
