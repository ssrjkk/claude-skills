...
version: "1.0"
language: ru
original: salesforce-commerce-shipping
---

# Salesforce Commerce Shipping

> Shipping with Salesforce Commerce. shipping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salesforce-commerce-shipping`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Salesforce Commerce Shipping
...
## Ресурсы
- Оригинальный навык: `ecommerce/salesforce-commerce-shipping/SKILL.md`
