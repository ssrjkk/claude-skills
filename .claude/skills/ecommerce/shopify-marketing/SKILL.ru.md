...
version: "1.0"
language: ru
original: shopify-marketing
---

# Shopify Marketing

> Marketing with Shopify. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-marketing/SKILL.md`
