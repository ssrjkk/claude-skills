...
version: "1.0"
language: ru
original: salesforce-commerce-cart
---

# Salesforce Commerce Cart

> Cart with Salesforce Commerce. cart.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salesforce-commerce-cart`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Salesforce Commerce Cart
...
## Ресурсы
- Оригинальный навык: `ecommerce/salesforce-commerce-cart/SKILL.md`
