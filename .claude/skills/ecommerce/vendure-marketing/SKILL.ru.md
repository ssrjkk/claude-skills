...
category: ecommerce
tags: [vendure-marketing, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vendure-marketing
---

# Vendure Marketing

> Marketing with Vendure. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vendure-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Vendure Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/vendure-marketing/SKILL.md`
