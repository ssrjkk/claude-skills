...
version: "1.0"
language: ru
original: magento-marketing
---

# Magento Marketing

> Marketing with Magento. marketing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-marketing/SKILL.md`
