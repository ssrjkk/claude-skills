...
version: "1.0"
language: ru
original: medusa-shipping
---

# Medusa Shipping

> Shipping with Medusa. shipping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-shipping`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Shipping
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-shipping/SKILL.md`
