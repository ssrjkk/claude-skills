...
version: "1.0"
language: ru
original: salesforce-commerce-marketing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `salesforce-commerce-marketing`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Salesforce Commerce Marketing
...
## Ресурсы
- Оригинальный навык: `ecommerce/salesforce-commerce-marketing/SKILL.md`
