...
version: "1.0"
language: ru
original: magento-analytics
---

# Magento Analytics

> Analytics with Magento. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-analytics/SKILL.md`
