...
version: "1.0"
language: ru
original: vendure-analytics
---

# Vendure Analytics

> Analytics with Vendure. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vendure-analytics`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Vendure Analytics
...
## Ресурсы
- Оригинальный навык: `ecommerce/vendure-analytics/SKILL.md`
