...
category: ecommerce
tags: [medusa-payments, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: medusa-payments
---

# Medusa Payments

> Payments with Medusa. payment integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-payments`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Payments
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-payments/SKILL.md`
