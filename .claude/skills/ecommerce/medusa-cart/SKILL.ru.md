...
version: "1.0"
language: ru
original: medusa-cart
---

# Medusa Cart

> Cart with Medusa. cart.

## Быстрый старт
Этот навык на русском языке. Оригинал: `medusa-cart`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Medusa Cart
...
## Ресурсы
- Оригинальный навык: `ecommerce/medusa-cart/SKILL.md`
