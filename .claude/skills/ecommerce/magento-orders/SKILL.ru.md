...
version: "1.0"
language: ru
original: magento-orders
---

# Magento Orders

> Orders with Magento. order management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-orders`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Orders
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-orders/SKILL.md`
