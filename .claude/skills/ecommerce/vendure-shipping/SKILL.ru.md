...
version: "1.0"
language: ru
original: vendure-shipping
---

# Vendure Shipping

> Shipping with Vendure. shipping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vendure-shipping`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Vendure Shipping
...
## Ресурсы
- Оригинальный навык: `ecommerce/vendure-shipping/SKILL.md`
