...
version: "1.0"
language: ru
original: saleor-customers
---

# Saleor Customers

> Customers with Saleor. customer API.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saleor-customers`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Saleor Customers
...
## Ресурсы
- Оригинальный навык: `ecommerce/saleor-customers/SKILL.md`
