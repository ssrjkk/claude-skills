...
category: ecommerce
tags: [magento-payments, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: magento-payments
---

# Magento Payments

> Payments with Magento. payment integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-payments`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Payments
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-payments/SKILL.md`
