...
version: "1.0"
language: ru
original: magento-shipping
---

# Magento Shipping

> Shipping with Magento. shipping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-shipping`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Shipping
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-shipping/SKILL.md`
