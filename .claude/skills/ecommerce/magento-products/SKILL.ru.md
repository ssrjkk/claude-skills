...
version: "1.0"
language: ru
original: magento-products
---

# Magento Products

> Products with Magento. product management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magento-products`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Magento Products
...
## Ресурсы
- Оригинальный навык: `ecommerce/magento-products/SKILL.md`
