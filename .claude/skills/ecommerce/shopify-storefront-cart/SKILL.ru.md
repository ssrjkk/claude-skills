...
category: ecommerce
tags: [shopify-storefront-cart, ecommerce, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shopify-storefront-cart
---

# Shopify Storefront Cart

> Cart with Shopify Storefront. cart API.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shopify-storefront-cart`.

## Когда использовать
- Работа с Электронная коммерция
- Выполнение задач, связанных с Shopify Storefront Cart
...
## Ресурсы
- Оригинальный навык: `ecommerce/shopify-storefront-cart/SKILL.md`
