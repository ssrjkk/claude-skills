...
version: "1.0"
language: ru
original: scylla-aggregation
---

# Scylla Aggregation

> Aggregation with ScyllaDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Aggregation
...
## Ресурсы
- Оригинальный навык: `database/scylla-aggregation/SKILL.md`
