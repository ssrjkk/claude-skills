...
version: "1.0"
language: ru
original: sqlite-optimization
---

# Sqlite Optimization

> Optimization with SQLite. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Optimization
...
## Ресурсы
- Оригинальный навык: `database/sqlite-optimization/SKILL.md`
