...
version: "1.0"
language: ru
original: mongodb-backup
---

# Mongodb Backup

> Backup with MongoDB. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Backup
...
## Ресурсы
- Оригинальный навык: `database/mongodb-backup/SKILL.md`
