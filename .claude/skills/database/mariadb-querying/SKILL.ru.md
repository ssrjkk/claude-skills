...
category: database
tags: [mariadb-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mariadb-querying
---

# Mariadb Querying

> Querying with MariaDB. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Querying
...
## Ресурсы
- Оригинальный навык: `database/mariadb-querying/SKILL.md`
