...
> Setup with MongoDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Setup
...
## Ресурсы
- Оригинальный навык: `database/mongodb-setup/SKILL.md`
