...
version: "1.0"
language: ru
original: arangodb-graph-indexing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-graph-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Graph Indexing
...
## Ресурсы
- Оригинальный навык: `database/arangodb-graph-indexing/SKILL.md`
