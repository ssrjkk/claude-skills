...
version: "1.0"
language: ru
original: algolia-mapping
---

# Algolia Mapping

> Mapping with Algolia. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algolia-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Algolia Mapping
...
## Ресурсы
- Оригинальный навык: `database/algolia-mapping/SKILL.md`
