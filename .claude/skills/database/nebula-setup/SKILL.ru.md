...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nebula-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nebula Setup
...
## Ресурсы
- Оригинальный навык: `database/nebula-setup/SKILL.md`
