...
version: "1.0"
language: ru
original: cassandra-replication
---

# Cassandra Replication

> Replication with Cassandra. replication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-replication`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Replication
...
## Ресурсы
- Оригинальный навык: `database/cassandra-replication/SKILL.md`
