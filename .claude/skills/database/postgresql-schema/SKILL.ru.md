...
> Schema Design with PostgreSQL. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Schema
...
## Ресурсы
- Оригинальный навык: `database/postgresql-schema/SKILL.md`
