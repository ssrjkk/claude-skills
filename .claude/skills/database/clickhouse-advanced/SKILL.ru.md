...
category: database
tags: [clickhouse-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clickhouse-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Advanced
...
## Ресурсы
- Оригинальный навык: database/clickhouse-advanced/SKILL.md
