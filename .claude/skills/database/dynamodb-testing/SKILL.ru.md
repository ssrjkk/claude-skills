...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Testing
...
## Ресурсы
- Оригинальный навык: database/dynamodb-testing/SKILL.md
