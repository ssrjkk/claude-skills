...
version: "1.0"
language: ru
original: memgraph-automation
---

# Memgraph Automation

> Automation for Memgraph: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: memgraph-automation.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Memgraph Automation
...
## Ресурсы
- database/memgraph-automation/SKILL.md
