...
category: database
tags: [weaviate-aggregations, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: weaviate-aggregations
---

# Weaviate Aggregations

> Aggregations with Weaviate. bucket aggs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-aggregations`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Aggregations
...
## Ресурсы
- Оригинальный навык: `database/weaviate-aggregations/SKILL.md`
