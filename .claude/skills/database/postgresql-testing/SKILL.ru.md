...
## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Testing
...
## Ресурсы
- Оригинальный навык: database/postgresql-testing/SKILL.md
