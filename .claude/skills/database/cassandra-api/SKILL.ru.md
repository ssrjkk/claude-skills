...
category: database
tags: [cassandra-api, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Api
...
## Ресурсы
- Оригинальный навык: database/cassandra-api/SKILL.md
