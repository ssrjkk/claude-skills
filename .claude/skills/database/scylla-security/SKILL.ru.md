...
category: database
tags: [scylla-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scylla-security
---

# Scylla Security

> Security with ScyllaDB. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Security
...
## Ресурсы
- Оригинальный навык: `database/scylla-security/SKILL.md`
