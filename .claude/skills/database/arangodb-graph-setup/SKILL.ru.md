...
## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-graph-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Graph Setup
...
## Ресурсы
- Оригинальный навык: `database/arangodb-graph-setup/SKILL.md`
