...
category: database
tags: [sqlite-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlite-advanced
---

# Sqlite Advanced

> Advanced for Sqlite: advanced patterns and techniques

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Advanced
...
## Ресурсы
- Оригинальный навык: database/sqlite-advanced/SKILL.md
