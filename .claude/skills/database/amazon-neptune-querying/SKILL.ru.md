...
version: "1.0"
language: ru
original: amazon-neptune-querying
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `amazon-neptune-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Amazon Neptune Querying
...
## Ресурсы
- Оригинальный навык: `database/amazon-neptune-querying/SKILL.md`
