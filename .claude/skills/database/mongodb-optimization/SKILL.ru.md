...
version: "1.0"
language: ru
original: mongodb-optimization
---

# Mongodb Optimization

> Optimization with MongoDB. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Optimization
...
## Ресурсы
- Оригинальный навык: `database/mongodb-optimization/SKILL.md`
