...
## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Backup
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-backup/SKILL.md`
