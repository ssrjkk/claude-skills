...
version: "1.0"
language: ru
original: arangodb-aggregation
---

# Arangodb Aggregation

> Aggregation with ArangoDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Aggregation
...
## Ресурсы
- Оригинальный навык: `database/arangodb-aggregation/SKILL.md`
