...
category: database
tags: [surreal-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: surreal-aggregation
---

# Surreal Aggregation

> Aggregation with SurrealDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Aggregation
...
## Ресурсы
- Оригинальный навык: `database/surreal-aggregation/SKILL.md`
