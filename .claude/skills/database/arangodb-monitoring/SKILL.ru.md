...
version: "1.0"
language: ru
original: arangodb-monitoring
---

# Arangodb Monitoring

> Monitoring with ArangoDB. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Monitoring
...
## Ресурсы
- Оригинальный навык: `database/arangodb-monitoring/SKILL.md`
