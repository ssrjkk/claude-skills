...
version: "1.0"
language: ru
original: arangodb-setup
---

# Arangodb Setup

> Setup with ArangoDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Setup
...
## Ресурсы
- Оригинальный навык: `database/arangodb-setup/SKILL.md`
