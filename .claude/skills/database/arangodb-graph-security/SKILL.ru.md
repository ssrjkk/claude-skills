...
version: "1.0"
language: ru
original: arangodb-graph-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-graph-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Graph Security
...
## Ресурсы
- Оригинальный навык: `database/arangodb-graph-security/SKILL.md`
