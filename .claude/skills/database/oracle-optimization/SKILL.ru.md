...
version: "1.0"
language: ru
original: oracle-optimization
---

# Oracle Optimization

> Optimization with Oracle. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Optimization
...
## Ресурсы
- Оригинальный навык: `database/oracle-optimization/SKILL.md`
