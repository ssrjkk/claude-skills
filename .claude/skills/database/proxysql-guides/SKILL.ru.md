...
category: database
tags: [proxysql-guides, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: proxysql-guides
---

# Proxysql Guides

> Guides for Proxysql: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `proxysql-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Proxysql Guides
...
## Ресурсы
- Оригинал: database/proxysql-guides/SKILL.md
