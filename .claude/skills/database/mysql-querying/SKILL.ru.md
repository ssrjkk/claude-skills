...
version: "1.0"
language: ru
original: mysql-querying
---

# Mysql Querying

> Querying with MySQL. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Querying
...
## Ресурсы
- Оригинальный навык: `database/mysql-querying/SKILL.md`
