...
version: "1.0"
language: ru
original: opensearch-mapping
---

# Opensearch Mapping

> Mapping with OpenSearch. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opensearch-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Opensearch Mapping
...
## Ресурсы
- Оригинальный навык: `database/opensearch-mapping/SKILL.md`
