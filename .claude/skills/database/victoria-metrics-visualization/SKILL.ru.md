...
version: "1.0"
language: ru
original: victoria-metrics-visualization
---

# Victoria Metrics Visualization

> Visualization with VictoriaMetrics. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Victoria Metrics Visualization
...
## Ресурсы
- Оригинальный навык: `database/victoria-metrics-visualization/SKILL.md`
