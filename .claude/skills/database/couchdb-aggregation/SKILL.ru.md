...
category: database
tags: [couchdb-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: couchdb-aggregation
---

# Couchdb Aggregation

> Aggregation with CouchDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `couchdb-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Couchdb Aggregation
...
## Ресурсы
- Оригинальный навык: `database/couchdb-aggregation/SKILL.md`
