...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-pub-sub`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Pub Sub
...
## Ресурсы
- Оригинальный навык: `database/ignite-pub-sub/SKILL.md`
