...
## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Basics
...
## Ресурсы
- Оригинальный навык: database/postgresql-basics/SKILL.md
