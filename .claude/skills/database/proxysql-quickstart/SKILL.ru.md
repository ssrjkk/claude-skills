...
version: "1.0"
language: ru
original: proxysql-quickstart
---

# Proxysql Quickstart

> Quickstart for Proxysql: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `proxysql-quickstart`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Proxysql Quickstart
...
## Ресурсы
- Оригинал: database/proxysql-quickstart/SKILL.md
