...
version: "1.0"
language: ru
original: meilisearch-setup
---

# Meilisearch Setup

> Setup with Meilisearch. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `meilisearch-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Meilisearch Setup
...
## Ресурсы
- Оригинальный навык: `database/meilisearch-setup/SKILL.md`
