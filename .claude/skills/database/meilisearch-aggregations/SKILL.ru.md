...
category: database
tags: [meilisearch-aggregations, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: meilisearch-aggregations
---

# Meilisearch Aggregations

> Aggregations with Meilisearch. bucket aggs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `meilisearch-aggregations`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Meilisearch Aggregations
...
## Ресурсы
- Оригинальный навык: `database/meilisearch-aggregations/SKILL.md`
