...
version: "1.0"
language: ru
original: surreal-security
---

# Surreal Security

> Security with SurrealDB. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Security
...
## Ресурсы
- Оригинальный навык: `database/surreal-security/SKILL.md`
