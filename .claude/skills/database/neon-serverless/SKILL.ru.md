...
## Быстрый старт
Этот навык на русском языке. Оригинал: `neon-serverless`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neon Serverless
...
## Ресурсы
- Оригинальный навык: `database/neon-serverless/SKILL.md`
