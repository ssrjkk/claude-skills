...
version: "1.0"
language: ru
original: scylla-backup
---

# Scylla Backup

> Backup with ScyllaDB. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Backup
...
## Ресурсы
- Оригинальный навык: `database/scylla-backup/SKILL.md`
