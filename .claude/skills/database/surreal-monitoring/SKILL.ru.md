...
version: "1.0"
language: ru
original: surreal-monitoring
---

# Surreal Monitoring

> Monitoring with SurrealDB. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Monitoring
...
## Ресурсы
- Оригинальный навык: `database/surreal-monitoring/SKILL.md`
