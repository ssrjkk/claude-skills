...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Schema
...
## Ресурсы
- Оригинальный навык: `database/scylla-schema/SKILL.md`
