...
version: "1.0"
language: ru
original: amazon-neptune-modeling
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `amazon-neptune-modeling`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Amazon Neptune Modeling
...
## Ресурсы
- Оригинальный навык: `database/amazon-neptune-modeling/SKILL.md`
