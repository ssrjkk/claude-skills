...
category: database
tags: [hbase-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hbase-backup
---

# Hbase Backup

> Backup with HBase. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hbase-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hbase Backup
...
## Ресурсы
- Оригинальный навык: `database/hbase-backup/SKILL.md`
