...
version: "1.0"
language: ru
original: solr-mapping
---

# Solr Mapping

> Mapping with Solr. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Mapping
...
## Ресурсы
- Оригинальный навык: `database/solr-mapping/SKILL.md`
