...
version: "1.0"
language: ru
original: sphinx-searching
---

# Sphinx Searching

> Searching with Sphinx. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sphinx-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sphinx Searching
...
## Ресурсы
- Оригинальный навык: `database/sphinx-searching/SKILL.md`
