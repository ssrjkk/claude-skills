...
category: database
tags: [sqlite-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlite-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Setup
...
## Ресурсы
- Оригинальный навык: `database/sqlite-setup/SKILL.md`
