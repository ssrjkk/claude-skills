...
version: "1.0"
language: ru
original: scylla-optimization
---

# Scylla Optimization

> Optimization with ScyllaDB. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Optimization
...
## Ресурсы
- Оригинальный навык: `database/scylla-optimization/SKILL.md`
