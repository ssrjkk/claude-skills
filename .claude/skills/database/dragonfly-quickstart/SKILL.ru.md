...
version: "1.0"
language: ru
original: dragonfly-quickstart
---

# Dragonfly Quickstart

> Quickstart for Dragonfly: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `dragonfly-quickstart`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dragonfly Quickstart
...
## Ресурсы
- Оригинал: database/dragonfly-quickstart/SKILL.md
