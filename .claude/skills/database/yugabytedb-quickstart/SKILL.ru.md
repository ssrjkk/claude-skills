...
version: "1.0"
language: ru
original: yugabytedb-quickstart
---

# Yugabytedb Quickstart

> Quickstart for Yugabytedb: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `yugabytedb-quickstart`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabytedb Quickstart
...
## Ресурсы
- Оригинал: database/yugabytedb-quickstart/SKILL.md
