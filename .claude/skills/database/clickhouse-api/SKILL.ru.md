...
## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Api
...
## Ресурсы
- Оригинальный навык: database/clickhouse-api/SKILL.md
