...
version: "1.0"
language: ru
original: dynamodb-optimization
---

# Dynamodb Optimization

> Optimization with DynamoDB. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Optimization
...
## Ресурсы
- Оригинальный навык: `database/dynamodb-optimization/SKILL.md`
