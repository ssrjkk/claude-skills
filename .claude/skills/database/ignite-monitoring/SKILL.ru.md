...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Monitoring
...
## Ресурсы
- Оригинальный навык: `database/ignite-monitoring/SKILL.md`
