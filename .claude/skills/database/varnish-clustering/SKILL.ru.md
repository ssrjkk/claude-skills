...
version: "1.0"
language: ru
original: varnish-clustering
---

# Varnish Clustering

> Clustering with Varnish. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `varnish-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Varnish Clustering
...
## Ресурсы
- Оригинальный навык: `database/varnish-clustering/SKILL.md`
