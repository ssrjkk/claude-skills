...
category: database
tags: [mongodb-api, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Api
...
## Ресурсы
- Оригинальный навык: database/mongodb-api/SKILL.md
