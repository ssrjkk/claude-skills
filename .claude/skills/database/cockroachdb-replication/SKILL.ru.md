...
version: "1.0"
language: ru
original: cockroachdb-replication
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-replication`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Replication
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-replication/SKILL.md`
