...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nginx-cache-caching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nginx Cache Caching
...
## Ресурсы
- Оригинальный навык: `database/nginx-cache-caching/SKILL.md`
