...
version: "1.0"
language: ru
original: solr-clustering
---

# Solr Clustering

> Clustering with Solr. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Clustering
...
## Ресурсы
- Оригинальный навык: `database/solr-clustering/SKILL.md`
