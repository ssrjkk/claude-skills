...
version: "1.0"
language: ru
original: garnet-fundamentals
---

# Garnet Fundamentals

> Fundamentals for Garnet: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `garnet-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Garnet Fundamentals
...
## Ресурсы
- Оригинал: database/garnet-fundamentals/SKILL.md
