...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redis-persistence`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Redis Persistence
...
## Ресурсы
- Оригинальный навык: `database/redis-persistence/SKILL.md`
