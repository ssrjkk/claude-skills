...
category: database
tags: [arangodb-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arangodb-schema
---

# Arangodb Schema

> Schema Design with ArangoDB. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Schema
...
## Ресурсы
- Оригинальный навык: `database/arangodb-schema/SKILL.md`
