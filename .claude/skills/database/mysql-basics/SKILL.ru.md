...
category: database
tags: [mysql-basics, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mysql-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Basics
...
## Ресурсы
- Оригинальный навык: database/mysql-basics/SKILL.md
