...
version: "1.0"
language: ru
original: cratedb-migration
---

# Cratedb Migration

> Migration with CrateDB. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Migration
...
## Ресурсы
- Оригинальный навык: `database/cratedb-migration/SKILL.md`
