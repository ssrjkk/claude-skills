...
version: "1.0"
language: ru
original: oracle-setup
---

# Oracle Setup

> Setup with Oracle. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Setup
...
## Ресурсы
- Оригинальный навык: `database/oracle-setup/SKILL.md`
