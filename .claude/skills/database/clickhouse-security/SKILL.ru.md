...
## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Security
...
## Ресурсы
- Оригинальный навык: database/clickhouse-security/SKILL.md
