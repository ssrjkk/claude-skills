...
version: "1.0"
language: ru
original: debezium-configuration
---

# Debezium Configuration

> Configuration for Debezium: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: debezium-configuration.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Debezium Configuration
...
## Ресурсы
- database/debezium-configuration/SKILL.md
