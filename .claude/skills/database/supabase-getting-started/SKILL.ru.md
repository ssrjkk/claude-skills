...
version: "1.0"
language: ru
original: supabase-getting-started
---

# Supabase Getting Started

> Getting Started for Supabase: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: supabase-getting-started.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Supabase Getting Started
...
## Ресурсы
- database/supabase-getting-started/SKILL.md
