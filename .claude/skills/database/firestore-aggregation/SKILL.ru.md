...
category: database
tags: [firestore-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: firestore-aggregation
---

# Firestore Aggregation

> Aggregation with Firestore. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `firestore-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Firestore Aggregation
...
## Ресурсы
- Оригинальный навык: `database/firestore-aggregation/SKILL.md`
