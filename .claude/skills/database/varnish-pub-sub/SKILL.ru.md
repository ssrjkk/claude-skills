...
version: "1.0"
language: ru
original: varnish-pub-sub
---

# Varnish Pub Sub

> Pub/Sub with Varnish. publish/subscribe.

## Быстрый старт
Этот навык на русском языке. Оригинал: `varnish-pub-sub`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Varnish Pub Sub
...
## Ресурсы
- Оригинальный навык: `database/varnish-pub-sub/SKILL.md`
