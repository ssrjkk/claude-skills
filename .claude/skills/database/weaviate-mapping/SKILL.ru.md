...
category: database
tags: [weaviate-mapping, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: weaviate-mapping
---

# Weaviate Mapping

> Mapping with Weaviate. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Mapping
...
## Ресурсы
- Оригинальный навык: `database/weaviate-mapping/SKILL.md`
