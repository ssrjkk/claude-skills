...
version: "1.0"
language: ru
original: hbase-schema
---

# Hbase Schema

> Schema Design with HBase. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hbase-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hbase Schema
...
## Ресурсы
- Оригинальный навык: `database/hbase-schema/SKILL.md`
