...
category: database
tags: [redis-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redis-optimization
---

# Redis Optimization

> Optimization with Redis. performance tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redis-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Redis Optimization
...
## Ресурсы
- Оригинальный навык: `database/redis-optimization/SKILL.md`
