...
category: database
tags: [oracle-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oracle-backup
---

# Oracle Backup

> Backup with Oracle. backup strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Backup
...
## Ресурсы
- Оригинальный навык: `database/oracle-backup/SKILL.md`
