...
version: "1.0"
language: ru
original: surreal-querying
---

# Surreal Querying

> Querying with SurrealDB. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Querying
...
## Ресурсы
- Оригинальный навык: `database/surreal-querying/SKILL.md`
