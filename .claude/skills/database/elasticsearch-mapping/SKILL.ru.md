...
category: database
tags: [elasticsearch-mapping, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: elasticsearch-mapping
---

# Elasticsearch Mapping

> Mapping with Elasticsearch. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elasticsearch-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Elasticsearch Mapping
...
## Ресурсы
- Оригинальный навык: `database/elasticsearch-mapping/SKILL.md`
