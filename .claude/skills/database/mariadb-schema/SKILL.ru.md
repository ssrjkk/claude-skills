...
version: "1.0"
language: ru
original: mariadb-schema
---

# Mariadb Schema

> Schema Design with MariaDB. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Schema
...
## Ресурсы
- Оригинальный навык: `database/mariadb-schema/SKILL.md`
