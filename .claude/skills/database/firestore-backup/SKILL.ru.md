...
version: "1.0"
language: ru
original: firestore-backup
---

# Firestore Backup

> Backup with Firestore. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `firestore-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Firestore Backup
...
## Ресурсы
- Оригинальный навык: `database/firestore-backup/SKILL.md`
