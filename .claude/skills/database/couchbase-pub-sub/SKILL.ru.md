...
version: "1.0"
language: ru
original: couchbase-pub-sub
---

# Couchbase Pub Sub

> Pub/Sub with Couchbase. publish/subscribe.

## Быстрый старт
Этот навык на русском языке. Оригинал: `couchbase-pub-sub`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Couchbase Pub Sub
...
## Ресурсы
- Оригинальный навык: `database/couchbase-pub-sub/SKILL.md`
