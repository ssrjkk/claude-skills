...
version: "1.0"
language: ru
original: scylla-indexing
---

# Scylla Indexing

> Indexing with ScyllaDB. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Indexing
...
## Ресурсы
- Оригинальный навык: `database/scylla-indexing/SKILL.md`
