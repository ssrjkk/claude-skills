...
## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Testing
...
## Ресурсы
- Оригинальный навык: database/clickhouse-testing/SKILL.md
