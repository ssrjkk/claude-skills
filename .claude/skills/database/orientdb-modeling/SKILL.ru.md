...
version: "1.0"
language: ru
original: orientdb-modeling
---

# Orientdb Modeling

> Modeling with OrientDB. graph modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `orientdb-modeling`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Orientdb Modeling
...
## Ресурсы
- Оригинальный навык: `database/orientdb-modeling/SKILL.md`
