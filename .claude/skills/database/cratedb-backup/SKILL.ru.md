...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Backup
...
## Ресурсы
- Оригинальный навык: `database/cratedb-backup/SKILL.md`
