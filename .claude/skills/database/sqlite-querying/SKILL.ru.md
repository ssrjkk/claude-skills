...
version: "1.0"
language: ru
original: sqlite-querying
---

# Sqlite Querying

> Querying with SQLite. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Querying
...
## Ресурсы
- Оригинальный навык: `database/sqlite-querying/SKILL.md`
