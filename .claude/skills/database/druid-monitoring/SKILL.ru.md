...
category: database
tags: [druid-monitoring, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-monitoring
---

# Druid Monitoring

> Monitoring with Apache Druid. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Monitoring
...
## Ресурсы
- Оригинальный навык: `database/druid-monitoring/SKILL.md`
