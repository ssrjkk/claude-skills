...
category: database
tags: [sqlserver-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlserver-schema
---

# Sqlserver Schema

> Schema Design with SQL Server. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Schema
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-schema/SKILL.md`
