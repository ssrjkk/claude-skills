...
category: database
tags: [dynamodb-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dynamodb-schema
---

# Dynamodb Schema

> Schema Design with DynamoDB. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Schema
...
## Ресурсы
- Оригинальный навык: `database/dynamodb-schema/SKILL.md`
