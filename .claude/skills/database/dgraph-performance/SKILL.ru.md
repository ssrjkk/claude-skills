...
version: "1.0"
language: ru
original: dgraph-performance
---

# Dgraph Performance

> Performance with Dgraph. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-performance`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Performance
...
## Ресурсы
- Оригинальный навык: `database/dgraph-performance/SKILL.md`
