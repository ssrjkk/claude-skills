...
category: database
tags: [hazelcast-pub-sub, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hazelcast-pub-sub
---

# Hazelcast Pub Sub

> Pub/Sub with Hazelcast. publish/subscribe.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hazelcast-pub-sub`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hazelcast Pub Sub
...
## Ресурсы
- Оригинальный навык: `database/hazelcast-pub-sub/SKILL.md`
