...
version: "1.0"
language: ru
original: dynamodb-aggregation
---

# Dynamodb Aggregation

> Aggregation with DynamoDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Aggregation
...
## Ресурсы
- Оригинальный навык: `database/dynamodb-aggregation/SKILL.md`
