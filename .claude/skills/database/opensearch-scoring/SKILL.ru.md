...
version: "1.0"
language: ru
original: opensearch-scoring
---

# Opensearch Scoring

> Scoring with OpenSearch. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opensearch-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Opensearch Scoring
...
## Ресурсы
- Оригинальный навык: `database/opensearch-scoring/SKILL.md`
