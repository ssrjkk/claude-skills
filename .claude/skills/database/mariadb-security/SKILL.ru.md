...
version: "1.0"
language: ru
original: mariadb-security
---

# Mariadb Security

> Security with MariaDB. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Security
...
## Ресурсы
- Оригинальный навык: `database/mariadb-security/SKILL.md`
