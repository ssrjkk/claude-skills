...
version: "1.0"
language: ru
original: weaviate-scoring
---

# Weaviate Scoring

> Scoring with Weaviate. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Scoring
...
## Ресурсы
- Оригинальный навык: `database/weaviate-scoring/SKILL.md`
