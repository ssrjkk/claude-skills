...
category: database
tags: [neo4j-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neo4j-aggregation
---

# Neo4J Aggregation

> Aggregation with Neo4j. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Aggregation
...
## Ресурсы
- Оригинальный навык: `database/neo4j-aggregation/SKILL.md`
