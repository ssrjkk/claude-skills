...
version: "1.0"
language: ru
original: debezium-workflow
---

# Debezium Workflow

> Workflow for Debezium: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: debezium-workflow.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Debezium Workflow
...
## Ресурсы
- database/debezium-workflow/SKILL.md
