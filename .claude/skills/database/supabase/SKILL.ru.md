...
category: database
tags: [supabase, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: supabase
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `supabase`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Supabase
...
## Ресурсы
- Оригинальный навык: `database/supabase/SKILL.md`
