...
category: database
tags: [sqlserver-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlserver-optimization
---

# Sqlserver Optimization

> Optimization with SQL Server. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Optimization
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-optimization/SKILL.md`
