...
category: database
tags: [prometheus-tsdb-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-tsdb-querying
---

# Prometheus Tsdb Querying

> Querying with Prometheus TSDB. time-series queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-tsdb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Prometheus Tsdb Querying
...
## Ресурсы
- Оригинальный навык: `database/prometheus-tsdb-querying/SKILL.md`
