...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nebula-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nebula Clustering
...
## Ресурсы
- Оригинальный навык: `database/nebula-clustering/SKILL.md`
