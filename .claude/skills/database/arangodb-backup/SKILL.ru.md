...
category: database
tags: [arangodb-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arangodb-backup
---

# Arangodb Backup

> Backup with ArangoDB. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Backup
...
## Ресурсы
- Оригинальный навык: `database/arangodb-backup/SKILL.md`
