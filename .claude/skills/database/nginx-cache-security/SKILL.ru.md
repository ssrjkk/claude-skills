...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nginx-cache-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nginx Cache Security
...
## Ресурсы
- Оригинальный навык: `database/nginx-cache-security/SKILL.md`
