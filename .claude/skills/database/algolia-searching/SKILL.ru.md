...
version: "1.0"
language: ru
original: algolia-searching
---

# Algolia Searching

> Searching with Algolia. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algolia-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Algolia Searching
...
## Ресурсы
- Оригинальный навык: `database/algolia-searching/SKILL.md`
