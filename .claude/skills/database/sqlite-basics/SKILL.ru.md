...
## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Basics
...
## Ресурсы
- Оригинальный навык: database/sqlite-basics/SKILL.md
