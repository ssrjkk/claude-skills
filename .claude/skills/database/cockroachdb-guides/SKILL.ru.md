...
category: database
tags: [cockroachdb-guides, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cockroachdb-guides
---

# Cockroachdb Guides

> Guides for Cockroachdb: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cockroachdb-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Guides
...
## Ресурсы
- Оригинал: database/cockroachdb-guides/SKILL.md
