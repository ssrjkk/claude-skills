...
version: "1.0"
language: ru
original: janusgraph-querying
---

# Janusgraph Querying

> Querying with JanusGraph. Cypher/Gremlin.

## Быстрый старт
Этот навык на русском языке. Оригинал: `janusgraph-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Janusgraph Querying
...
## Ресурсы
- Оригинальный навык: `database/janusgraph-querying/SKILL.md`
