...
version: "1.0"
language: ru
original: yugabyte-querying
---

# Yugabyte Querying

> Querying with YugabyteDB. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Querying
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-querying/SKILL.md`
