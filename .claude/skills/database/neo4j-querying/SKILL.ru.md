...
version: "1.0"
language: ru
original: neo4j-querying
---

# Neo4J Querying

> Querying with Neo4j. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Querying
...
## Ресурсы
- Оригинальный навык: `database/neo4j-querying/SKILL.md`
