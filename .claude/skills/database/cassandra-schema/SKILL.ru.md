...
category: database
tags: [cassandra-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-schema
---

# Cassandra Schema

> Schema Design with Cassandra. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Schema
...
## Ресурсы
- Оригинальный навык: `database/cassandra-schema/SKILL.md`
