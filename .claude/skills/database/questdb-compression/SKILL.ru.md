...
version: "1.0"
language: ru
original: questdb-compression
---

# Questdb Compression

> Compression with QuestDB. compression.

## Быстрый старт
Этот навык на русском языке. Оригинал: `questdb-compression`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Questdb Compression
...
## Ресурсы
- Оригинальный навык: `database/questdb-compression/SKILL.md`
