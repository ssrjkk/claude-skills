...
category: database
tags: [dynamodb-basics, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dynamodb-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Basics
...
## Ресурсы
- Оригинальный навык: database/dynamodb-basics/SKILL.md
