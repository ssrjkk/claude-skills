...
category: database
tags: [tidb-quickstart, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tidb-quickstart
---

# Tidb Quickstart

> Quickstart for Tidb: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tidb-quickstart`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Tidb Quickstart
...
## Ресурсы
- Оригинал: database/tidb-quickstart/SKILL.md
