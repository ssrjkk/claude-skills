...
version: "1.0"
language: ru
original: sqlserver-querying
---

# Sqlserver Querying

> Querying with SQL Server. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Querying
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-querying/SKILL.md`
