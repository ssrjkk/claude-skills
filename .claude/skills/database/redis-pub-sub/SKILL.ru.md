...
version: "1.0"
language: ru
original: redis-pub-sub
---

# Redis Pub Sub

> Pub/Sub with Redis. publish/subscribe.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redis-pub-sub`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Redis Pub Sub
...
## Ресурсы
- Оригинальный навык: `database/redis-pub-sub/SKILL.md`
