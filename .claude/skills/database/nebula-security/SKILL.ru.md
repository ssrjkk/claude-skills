...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nebula-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nebula Security
...
## Ресурсы
- Оригинальный навык: `database/nebula-security/SKILL.md`
