...
category: database
tags: [firestore-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: firestore-schema
---

# Firestore Schema

> Schema Design with Firestore. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `firestore-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Firestore Schema
...
## Ресурсы
- Оригинальный навык: `database/firestore-schema/SKILL.md`
