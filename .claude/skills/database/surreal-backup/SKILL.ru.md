...
category: database
tags: [surreal-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: surreal-backup
---

# Surreal Backup

> Backup with SurrealDB. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Backup
...
## Ресурсы
- Оригинальный навык: `database/surreal-backup/SKILL.md`
