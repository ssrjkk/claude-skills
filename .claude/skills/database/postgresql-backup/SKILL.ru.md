...
category: database
tags: [postgresql-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-backup
---

# Postgresql Backup

> Backup with PostgreSQL. backup strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Backup
...
## Ресурсы
- Оригинальный навык: `database/postgresql-backup/SKILL.md`
