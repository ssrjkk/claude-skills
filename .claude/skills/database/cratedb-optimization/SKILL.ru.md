...
category: database
tags: [cratedb-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cratedb-optimization
---

# Cratedb Optimization

> Optimization with CrateDB. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Optimization
...
## Ресурсы
- Оригинальный навык: `database/cratedb-optimization/SKILL.md`
