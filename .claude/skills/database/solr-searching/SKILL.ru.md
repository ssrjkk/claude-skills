...
category: database
tags: [solr-searching, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solr-searching
---

# Solr Searching

> Searching with Solr. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Searching
...
## Ресурсы
- Оригинальный навык: `database/solr-searching/SKILL.md`
