...
version: "1.0"
language: ru
original: debezium-production
---

# Debezium Production

> Production for Debezium: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: debezium-production.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Debezium Production
...
## Ресурсы
- database/debezium-production/SKILL.md
