...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Indexing
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-indexing/SKILL.md`
