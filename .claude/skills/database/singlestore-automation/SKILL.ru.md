...
version: "1.0"
language: ru
original: singlestore-automation
---

# Singlestore Automation

> Automation for Singlestore: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: singlestore-automation.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Singlestore Automation
...
## Ресурсы
- database/singlestore-automation/SKILL.md
