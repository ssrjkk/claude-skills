...
category: database
tags: [neo4j-api, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neo4j-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Api
...
## Ресурсы
- Оригинальный навык: database/neo4j-api/SKILL.md
