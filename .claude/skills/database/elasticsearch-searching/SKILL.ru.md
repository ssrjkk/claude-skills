...
category: database
tags: [elasticsearch-searching, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: elasticsearch-searching
---

# Elasticsearch Searching

> Searching with Elasticsearch. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elasticsearch-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Elasticsearch Searching
...
## Ресурсы
- Оригинальный навык: `database/elasticsearch-searching/SKILL.md`
