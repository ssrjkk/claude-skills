...
version: "1.0"
language: ru
original: yugabytedb-guides
---

# Yugabytedb Guides

> Guides for Yugabytedb: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `yugabytedb-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabytedb Guides
...
## Ресурсы
- Оригинал: database/yugabytedb-guides/SKILL.md
