...
version: "1.0"
language: ru
original: cratedb-indexing
---

# Cratedb Indexing

> Indexing with CrateDB. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Indexing
...
## Ресурсы
- Оригинальный навык: `database/cratedb-indexing/SKILL.md`
