...
category: database
tags: [postgresql-migration, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-migration
---

# Postgresql Migration

> Migration with PostgreSQL. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Migration
...
## Ресурсы
- Оригинальный навык: `database/postgresql-migration/SKILL.md`
