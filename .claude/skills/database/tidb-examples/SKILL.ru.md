...
version: "1.0"
language: ru
original: tidb-examples
---

# Tidb Examples

> Examples for Tidb: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tidb-examples`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Tidb Examples
...
## Ресурсы
- Оригинал: database/tidb-examples/SKILL.md
