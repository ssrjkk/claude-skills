...
version: "1.0"
language: ru
original: duckdb-integration
---

# Duckdb Integration

> Integration for Duckdb: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: duckdb-integration.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Duckdb Integration
...
## Ресурсы
- database/duckdb-integration/SKILL.md
