...
category: database
tags: [clickhouse-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clickhouse-querying
---

# Clickhouse Querying

> Querying with ClickHouse. time-series queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Querying
...
## Ресурсы
- Оригинальный навык: `database/clickhouse-querying/SKILL.md`
