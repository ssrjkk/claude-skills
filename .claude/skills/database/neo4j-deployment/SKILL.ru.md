...
## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-deployment`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Deployment
...
## Ресурсы
- Оригинальный навык: database/neo4j-deployment/SKILL.md
