...
category: database
tags: [cockroachdb-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cockroachdb-security
---

# Cockroachdb Security

> Security with CockroachDB. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Security
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-security/SKILL.md`
