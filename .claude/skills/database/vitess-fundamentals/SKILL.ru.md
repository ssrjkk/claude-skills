...
version: "1.0"
language: ru
original: vitess-fundamentals
---

# Vitess Fundamentals

> Fundamentals for Vitess: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vitess-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Vitess Fundamentals
...
## Ресурсы
- Оригинал: database/vitess-fundamentals/SKILL.md
