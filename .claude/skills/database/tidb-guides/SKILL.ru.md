...
version: "1.0"
language: ru
original: tidb-guides
---

# Tidb Guides

> Guides for Tidb: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tidb-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Tidb Guides
...
## Ресурсы
- Оригинал: database/tidb-guides/SKILL.md
