...
category: database
tags: [ignite-clustering, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ignite-clustering
---

# Ignite Clustering

> Clustering with Apache Ignite. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Clustering
...
## Ресурсы
- Оригинальный навык: `database/ignite-clustering/SKILL.md`
