...
category: database
tags: [solr-scoring, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solr-scoring
---

# Solr Scoring

> Scoring with Solr. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Scoring
...
## Ресурсы
- Оригинальный навык: `database/solr-scoring/SKILL.md`
