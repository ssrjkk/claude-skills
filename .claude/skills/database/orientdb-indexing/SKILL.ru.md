...
version: "1.0"
language: ru
original: orientdb-indexing
---

# Orientdb Indexing

> Indexing with OrientDB. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `orientdb-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Orientdb Indexing
...
## Ресурсы
- Оригинальный навык: `database/orientdb-indexing/SKILL.md`
