...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nebula-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nebula Visualization
...
## Ресурсы
- Оригинальный навык: `database/nebula-visualization/SKILL.md`
