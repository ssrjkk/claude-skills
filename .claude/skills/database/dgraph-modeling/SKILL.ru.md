...
version: "1.0"
language: ru
original: dgraph-modeling
---

# Dgraph Modeling

> Modeling with Dgraph. graph modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-modeling`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Modeling
...
## Ресурсы
- Оригинальный навык: `database/dgraph-modeling/SKILL.md`
