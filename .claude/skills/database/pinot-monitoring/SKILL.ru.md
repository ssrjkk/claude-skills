...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Monitoring
...
## Ресурсы
- Оригинальный навык: `database/pinot-monitoring/SKILL.md`
