...
version: "1.0"
language: ru
original: timescaledb-visualization
---

# Timescaledb Visualization

> Visualization with TimescaleDB. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `timescaledb-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Timescaledb Visualization
...
## Ресурсы
- Оригинальный навык: `database/timescaledb-visualization/SKILL.md`
