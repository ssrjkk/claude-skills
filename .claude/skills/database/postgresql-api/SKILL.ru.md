...
## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Api
...
## Ресурсы
- Оригинальный навык: database/postgresql-api/SKILL.md
