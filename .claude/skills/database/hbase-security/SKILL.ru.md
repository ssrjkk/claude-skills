...
category: database
tags: [hbase-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hbase-security
---

# Hbase Security

> Security with HBase. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hbase-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hbase Security
...
## Ресурсы
- Оригинальный навык: `database/hbase-security/SKILL.md`
