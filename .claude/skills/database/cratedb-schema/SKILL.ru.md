...
category: database
tags: [cratedb-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cratedb-schema
---

# Cratedb Schema

> Schema Design with CrateDB. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Schema
...
## Ресурсы
- Оригинальный навык: `database/cratedb-schema/SKILL.md`
