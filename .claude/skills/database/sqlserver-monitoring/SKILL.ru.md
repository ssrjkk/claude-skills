...
version: "1.0"
language: ru
original: sqlserver-monitoring
---

# Sqlserver Monitoring

> Monitoring with SQL Server. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Monitoring
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-monitoring/SKILL.md`
