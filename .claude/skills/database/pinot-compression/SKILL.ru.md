...
category: database
tags: [pinot-compression, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-compression
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-compression`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Compression
...
## Ресурсы
- Оригинальный навык: `database/pinot-compression/SKILL.md`
