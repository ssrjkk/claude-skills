...
category: database
tags: [clickhouse-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clickhouse-optimization
---

# Clickhouse Optimization

> Optimization for Clickhouse: performance tuning and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Optimization
...
## Ресурсы
- Оригинальный навык: database/clickhouse-optimization/SKILL.md
