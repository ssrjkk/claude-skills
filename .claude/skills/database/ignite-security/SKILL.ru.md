...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Security
...
## Ресурсы
- Оригинальный навык: `database/ignite-security/SKILL.md`
