...
version: "1.0"
language: ru
original: surreal-setup
---

# Surreal Setup

> Setup with SurrealDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Setup
...
## Ресурсы
- Оригинальный навык: `database/surreal-setup/SKILL.md`
