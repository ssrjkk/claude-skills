...
category: database
tags: [sqlserver-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlserver-setup
---

# Sqlserver Setup

> Setup with SQL Server. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Setup
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-setup/SKILL.md`
