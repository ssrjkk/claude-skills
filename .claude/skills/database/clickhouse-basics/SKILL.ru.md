...
## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Basics
...
## Ресурсы
- Оригинальный навык: database/clickhouse-basics/SKILL.md
