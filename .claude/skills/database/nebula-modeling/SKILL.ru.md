...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nebula-modeling`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nebula Modeling
...
## Ресурсы
- Оригинальный навык: `database/nebula-modeling/SKILL.md`
