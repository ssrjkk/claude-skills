...
category: database
tags: [opensearch-searching, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opensearch-searching
---

# Opensearch Searching

> Searching with OpenSearch. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opensearch-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Opensearch Searching
...
## Ресурсы
- Оригинальный навык: `database/opensearch-searching/SKILL.md`
