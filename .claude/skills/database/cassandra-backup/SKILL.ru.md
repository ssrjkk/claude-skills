...
version: "1.0"
language: ru
original: cassandra-backup
---

# Cassandra Backup

> Backup with Cassandra. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Backup
...
## Ресурсы
- Оригинальный навык: `database/cassandra-backup/SKILL.md`
