...
version: "1.0"
language: ru
original: elasticsearch-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `elasticsearch-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Elasticsearch Optimization
...
## Ресурсы
- Оригинальный навык: database/elasticsearch-optimization/SKILL.md
