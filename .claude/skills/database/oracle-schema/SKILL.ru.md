...
category: database
tags: [oracle-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Schema Design with Oracle. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Schema
...
## Ресурсы
- Оригинальный навык: `database/oracle-schema/SKILL.md`
