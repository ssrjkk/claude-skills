...
version: "1.0"
language: ru
original: cassandra-querying
---

# Cassandra Querying

> Querying with Cassandra. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Querying
...
## Ресурсы
- Оригинальный навык: `database/cassandra-querying/SKILL.md`
