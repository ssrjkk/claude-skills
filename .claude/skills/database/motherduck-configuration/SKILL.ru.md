...
version: "1.0"
language: ru
original: motherduck-configuration
---

# Motherduck Configuration

> Configuration for Motherduck: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: motherduck-configuration.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Motherduck Configuration
...
## Ресурсы
- database/motherduck-configuration/SKILL.md
