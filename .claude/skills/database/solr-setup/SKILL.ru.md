...
> Setup with Solr. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Setup
...
## Ресурсы
- Оригинальный навык: `database/solr-setup/SKILL.md`
