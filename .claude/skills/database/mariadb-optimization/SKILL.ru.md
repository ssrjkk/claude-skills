...
category: database
tags: [mariadb-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mariadb-optimization
---

# Mariadb Optimization

> Optimization with MariaDB. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Optimization
...
## Ресурсы
- Оригинальный навык: `database/mariadb-optimization/SKILL.md`
