...
version: "1.0"
language: ru
original: dgraph-visualization
---

# Dgraph Visualization

> Visualization with Dgraph. graph viz.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Visualization
...
## Ресурсы
- Оригинальный навык: `database/dgraph-visualization/SKILL.md`
