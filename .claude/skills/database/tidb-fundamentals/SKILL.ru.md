...
category: database
tags: [tidb-fundamentals, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tidb-fundamentals
---

# Tidb Fundamentals

> Fundamentals for Tidb: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tidb-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Tidb Fundamentals
...
## Ресурсы
- Оригинал: database/tidb-fundamentals/SKILL.md
