...
category: database
tags: [dgraph-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dgraph-querying
---

# Dgraph Querying

> Querying with Dgraph. Cypher/Gremlin.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Querying
...
## Ресурсы
- Оригинальный навык: `database/dgraph-querying/SKILL.md`
