...
version: "1.0"
language: ru
original: oracle-indexing
---

# Oracle Indexing

> Indexing with Oracle. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Indexing
...
## Ресурсы
- Оригинальный навык: `database/oracle-indexing/SKILL.md`
