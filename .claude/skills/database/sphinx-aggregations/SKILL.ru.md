...
version: "1.0"
language: ru
original: sphinx-aggregations
---

# Sphinx Aggregations

> Aggregations with Sphinx. bucket aggs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sphinx-aggregations`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sphinx Aggregations
...
## Ресурсы
- Оригинальный навык: `database/sphinx-aggregations/SKILL.md`
