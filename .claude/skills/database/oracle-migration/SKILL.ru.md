...
version: "1.0"
language: ru
original: oracle-migration
---

# Oracle Migration

> Migration with Oracle. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Migration
...
## Ресурсы
- Оригинальный навык: `database/oracle-migration/SKILL.md`
