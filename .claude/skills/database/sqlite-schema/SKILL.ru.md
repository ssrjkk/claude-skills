...
category: database
tags: [sqlite-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Schema Design with SQLite. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Schema
...
## Ресурсы
- Оригинальный навык: `database/sqlite-schema/SKILL.md`
