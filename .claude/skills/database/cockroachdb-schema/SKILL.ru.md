...
version: "1.0"
language: ru
original: cockroachdb-schema
---

# Cockroachdb Schema

> Schema Design with CockroachDB. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Schema
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-schema/SKILL.md`
