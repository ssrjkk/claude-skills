...
version: "1.0"
language: ru
original: elasticsearch-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `elasticsearch-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Elasticsearch Testing
...
## Ресурсы
- Оригинальный навык: database/elasticsearch-testing/SKILL.md
