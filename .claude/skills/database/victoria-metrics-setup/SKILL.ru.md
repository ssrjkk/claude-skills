...
category: database
tags: [victoria-metrics-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: victoria-metrics-setup
---

# Victoria Metrics Setup

> Setup with VictoriaMetrics. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Victoria Metrics Setup
...
## Ресурсы
- Оригинальный навык: `database/victoria-metrics-setup/SKILL.md`
