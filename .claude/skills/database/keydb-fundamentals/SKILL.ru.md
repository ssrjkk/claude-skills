...
version: "1.0"
language: ru
original: keydb-fundamentals
---

# Keydb Fundamentals

> Fundamentals for Keydb: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `keydb-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Keydb Fundamentals
...
## Ресурсы
- Оригинал: database/keydb-fundamentals/SKILL.md
