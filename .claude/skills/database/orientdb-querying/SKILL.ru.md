...
version: "1.0"
language: ru
original: orientdb-querying
---

# Orientdb Querying

> Querying with OrientDB. Cypher/Gremlin.

## Быстрый старт
Этот навык на русском языке. Оригинал: `orientdb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Orientdb Querying
...
## Ресурсы
- Оригинальный навык: `database/orientdb-querying/SKILL.md`
