...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Testing
...
## Ресурсы
- Оригинальный навык: database/mysql-testing/SKILL.md
