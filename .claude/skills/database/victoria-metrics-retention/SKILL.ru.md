...
version: "1.0"
language: ru
original: victoria-metrics-retention
---

# Victoria Metrics Retention

> Retention with VictoriaMetrics. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Victoria Metrics Retention
...
## Ресурсы
- Оригинальный навык: `database/victoria-metrics-retention/SKILL.md`
