...
> Backup with MySQL. backup strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Backup
...
## Ресурсы
- Оригинальный навык: `database/mysql-backup/SKILL.md`
