...
version: "1.0"
language: ru
original: sphinx-mapping
---

# Sphinx Mapping

> Mapping with Sphinx. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sphinx-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sphinx Mapping
...
## Ресурсы
- Оригинальный навык: `database/sphinx-mapping/SKILL.md`
