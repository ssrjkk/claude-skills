...
category: database
tags: [sqlite-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Backup
...
## Ресурсы
- Оригинальный навык: `database/sqlite-backup/SKILL.md`
