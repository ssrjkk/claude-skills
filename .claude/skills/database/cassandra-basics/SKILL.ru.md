...
category: database
tags: [cassandra-basics, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-basics`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Basics
...
## Ресурсы
- Оригинальный навык: database/cassandra-basics/SKILL.md
