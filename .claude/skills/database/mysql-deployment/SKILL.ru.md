...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-deployment`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Deployment
...
## Ресурсы
- Оригинальный навык: database/mysql-deployment/SKILL.md
