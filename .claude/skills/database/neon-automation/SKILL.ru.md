...
version: "1.0"
language: ru
original: neon-automation
---

# Neon Automation

> Automation for Neon: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: neon-automation.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neon Automation
...
## Ресурсы
- database/neon-automation/SKILL.md
