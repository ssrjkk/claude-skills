...
version: "1.0"
language: ru
original: scylla-querying
---

# Scylla Querying

> Querying with ScyllaDB. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Querying
...
## Ресурсы
- Оригинальный навык: `database/scylla-querying/SKILL.md`
