...
category: database
tags: [timescaledb-ingestion, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: timescaledb-ingestion
---

# Timescaledb Ingestion

> Ingestion with TimescaleDB. data ingestion.

## Быстрый старт
Этот навык на русском языке. Оригинал: `timescaledb-ingestion`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Timescaledb Ingestion
...
## Ресурсы
- Оригинальный навык: `database/timescaledb-ingestion/SKILL.md`
