...
version: "1.0"
language: ru
original: duckdb-getting-started
---

# Duckdb Getting Started

> Getting Started for Duckdb: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: duckdb-getting-started.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Duckdb Getting Started
...
## Ресурсы
- database/duckdb-getting-started/SKILL.md
