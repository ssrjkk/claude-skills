...
version: "1.0"
language: ru
original: solr-aggregations
---

# Solr Aggregations

> Aggregations with Solr. bucket aggs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solr-aggregations`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Solr Aggregations
...
## Ресурсы
- Оригинальный навык: `database/solr-aggregations/SKILL.md`
