...
version: "1.0"
language: ru
original: scylladb-guides
---

# Scylladb Guides

> Guides for Scylladb: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `scylladb-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylladb Guides
...
## Ресурсы
- Оригинал: database/scylladb-guides/SKILL.md
