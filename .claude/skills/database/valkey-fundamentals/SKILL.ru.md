...
version: "1.0"
language: ru
original: valkey-fundamentals
---

# Valkey Fundamentals

> Fundamentals for Valkey: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `valkey-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Valkey Fundamentals
...
## Ресурсы
- Оригинал: database/valkey-fundamentals/SKILL.md
