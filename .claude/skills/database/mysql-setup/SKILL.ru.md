...
category: database
tags: [mysql-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Setup with MySQL. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Setup
...
## Ресурсы
- Оригинальный навык: `database/mysql-setup/SKILL.md`
