...
version: "1.0"
language: ru
original: weaviate-clustering
---

# Weaviate Clustering

> Clustering with Weaviate. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Clustering
...
## Ресурсы
- Оригинальный навык: `database/weaviate-clustering/SKILL.md`
