...
version: "1.0"
language: ru
original: dgraph-security
---

# Dgraph Security

> Security with Dgraph. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Security
...
## Ресурсы
- Оригинальный навык: `database/dgraph-security/SKILL.md`
