...
version: "1.0"
language: ru
original: kafka-connect-workflow
---

# Kafka Connect Workflow

> Workflow for Kafka-Connect: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: kafka-connect-workflow.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Kafka Connect Workflow
...
## Ресурсы
- database/kafka-connect-workflow/SKILL.md
