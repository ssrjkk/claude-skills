...
category: database
tags: [dynamodb-api, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dynamodb-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Api
...
## Ресурсы
- Оригинальный навык: database/dynamodb-api/SKILL.md
