...
category: database
tags: [druid-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-querying
---

# Druid Querying

> Querying with Apache Druid. time-series queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Querying
...
## Ресурсы
- Оригинальный навык: `database/druid-querying/SKILL.md`
