...
category: database
tags: [mongodb-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mongodb-aggregation
---

# Mongodb Aggregation

> Aggregation with MongoDB. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Aggregation
...
## Ресурсы
- Оригинальный навык: `database/mongodb-aggregation/SKILL.md`
