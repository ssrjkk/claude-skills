...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Clustering
...
## Ресурсы
- Оригинальный навык: `database/pinot-clustering/SKILL.md`
