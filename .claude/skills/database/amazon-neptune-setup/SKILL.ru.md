...
## Быстрый старт
Этот навык на русском языке. Оригинал: `amazon-neptune-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Amazon Neptune Setup
...
## Ресурсы
- Оригинальный навык: `database/amazon-neptune-setup/SKILL.md`
