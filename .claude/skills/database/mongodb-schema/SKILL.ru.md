...
category: database
tags: [mongodb-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Schema Design with MongoDB. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mongodb-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mongodb Schema
...
## Ресурсы
- Оригинальный навык: `database/mongodb-schema/SKILL.md`
