...
category: database
tags: [postgresql-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-security
---

# Postgresql Security

> Security with PostgreSQL. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Security
...
## Ресурсы
- Оригинальный навык: `database/postgresql-security/SKILL.md`
