...
version: "1.0"
language: ru
original: mariadb-backup
---

# Mariadb Backup

> Backup with MariaDB. backup strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Backup
...
## Ресурсы
- Оригинальный навык: `database/mariadb-backup/SKILL.md`
