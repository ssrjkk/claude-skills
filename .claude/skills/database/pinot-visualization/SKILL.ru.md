...
category: database
tags: [pinot-visualization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-visualization
---

# Pinot Visualization

> Visualization with Apache Pinot. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Visualization
...
## Ресурсы
- Оригинальный навык: `database/pinot-visualization/SKILL.md`
