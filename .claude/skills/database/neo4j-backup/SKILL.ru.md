...
version: "1.0"
language: ru
original: neo4j-backup
---

# Neo4J Backup

> Backup with Neo4j. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Backup
...
## Ресурсы
- Оригинальный навык: `database/neo4j-backup/SKILL.md`
