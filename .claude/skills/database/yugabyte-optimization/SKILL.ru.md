...
version: "1.0"
language: ru
original: yugabyte-optimization
---

# Yugabyte Optimization

> Optimization with YugabyteDB. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Optimization
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-optimization/SKILL.md`
