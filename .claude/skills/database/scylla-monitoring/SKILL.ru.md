...
version: "1.0"
language: ru
original: scylla-monitoring
---

# Scylla Monitoring

> Monitoring with ScyllaDB. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Monitoring
...
## Ресурсы
- Оригинальный навык: `database/scylla-monitoring/SKILL.md`
