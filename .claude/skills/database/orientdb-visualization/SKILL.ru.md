...
category: database
tags: [orientdb-visualization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: orientdb-visualization
---

# Orientdb Visualization

> Visualization with OrientDB. graph viz.

## Быстрый старт
Этот навык на русском языке. Оригинал: `orientdb-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Orientdb Visualization
...
## Ресурсы
- Оригинальный навык: `database/orientdb-visualization/SKILL.md`
