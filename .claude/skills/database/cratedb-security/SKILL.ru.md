...
category: database
tags: [cratedb-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cratedb-security
---

# Cratedb Security

> Security with CrateDB. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Security
...
## Ресурсы
- Оригинальный навык: `database/cratedb-security/SKILL.md`
