...
version: "1.0"
language: ru
original: arangodb-graph-modeling
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-graph-modeling`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Graph Modeling
...
## Ресурсы
- Оригинальный навык: `database/arangodb-graph-modeling/SKILL.md`
