...
category: database
tags: [postgresql-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Advanced
...
## Ресурсы
- Оригинальный навык: database/postgresql-advanced/SKILL.md
