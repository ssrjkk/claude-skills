...
version: "1.0"
language: ru
original: dgraph-indexing
---

# Dgraph Indexing

> Indexing with Dgraph. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Indexing
...
## Ресурсы
- Оригинальный навык: `database/dgraph-indexing/SKILL.md`
