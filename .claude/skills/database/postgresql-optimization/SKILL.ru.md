...
category: database
tags: [postgresql-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-optimization
---

# Postgresql Optimization

> Optimization with PostgreSQL. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Optimization
...
## Ресурсы
- Оригинальный навык: `database/postgresql-optimization/SKILL.md`
