...
version: "1.0"
language: ru
original: cockroachdb-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Monitoring
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-monitoring/SKILL.md`
