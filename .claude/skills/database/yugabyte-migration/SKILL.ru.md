...
## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Migration
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-migration/SKILL.md`
