...
version: "1.0"
language: ru
original: couchbase-clustering
---

# Couchbase Clustering

> Clustering with Couchbase. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `couchbase-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Couchbase Clustering
...
## Ресурсы
- Оригинальный навык: `database/couchbase-clustering/SKILL.md`
