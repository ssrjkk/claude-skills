...
category: database
tags: [postgresql-monitoring, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-monitoring
---

# Postgresql Monitoring

> Monitoring with PostgreSQL. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Monitoring
...
## Ресурсы
- Оригинальный навык: `database/postgresql-monitoring/SKILL.md`
