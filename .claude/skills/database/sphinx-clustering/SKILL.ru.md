...
version: "1.0"
language: ru
original: sphinx-clustering
---

# Sphinx Clustering

> Clustering with Sphinx. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sphinx-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sphinx Clustering
...
## Ресурсы
- Оригинальный навык: `database/sphinx-clustering/SKILL.md`
