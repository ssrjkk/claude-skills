...
category: database
tags: [cockroachdb-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cockroachdb-optimization
---

# Cockroachdb Optimization

> Optimization with CockroachDB. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Optimization
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-optimization/SKILL.md`
