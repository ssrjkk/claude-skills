...
> Migration with SQLite. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlite-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlite Migration
...
## Ресурсы
- Оригинальный навык: `database/sqlite-migration/SKILL.md`
