...
category: database
tags: [druid-clustering, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-clustering
---

# Druid Clustering

> Clustering with Apache Druid. clustering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Clustering
...
## Ресурсы
- Оригинальный навык: `database/druid-clustering/SKILL.md`
