...
## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Testing
...
## Ресурсы
- Оригинальный навык: database/neo4j-testing/SKILL.md
