...
version: "1.0"
language: ru
original: prometheus-tsdb-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-tsdb-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Prometheus Tsdb Setup
...
## Ресурсы
- Оригинальный навык: `database/prometheus-tsdb-setup/SKILL.md`
