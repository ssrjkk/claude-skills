...
version: "1.0"
language: ru
original: clickhouse-retention
---

# Clickhouse Retention

> Retention with ClickHouse. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Retention
...
## Ресурсы
- Оригинальный навык: `database/clickhouse-retention/SKILL.md`
