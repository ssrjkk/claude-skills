...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cratedb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cratedb Querying
...
## Ресурсы
- Оригинальный навык: `database/cratedb-querying/SKILL.md`
