...
version: "1.0"
language: ru
original: vitess-guides
---

# Vitess Guides

> Guides for Vitess: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vitess-guides`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Vitess Guides
...
## Ресурсы
- Оригинал: database/vitess-guides/SKILL.md
