...
version: "1.0"
language: ru
original: timescaledb-retention
---

# Timescaledb Retention

> Retention with TimescaleDB. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `timescaledb-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Timescaledb Retention
...
## Ресурсы
- Оригинальный навык: `database/timescaledb-retention/SKILL.md`
