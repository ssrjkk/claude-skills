...
category: database
tags: [yugabyte-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: yugabyte-security
---

# Yugabyte Security

> Security with YugabyteDB. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Security
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-security/SKILL.md`
