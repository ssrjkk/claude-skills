...
version: "1.0"
language: ru
original: mysql-security
---

# Mysql Security

> Security with MySQL. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Security
...
## Ресурсы
- Оригинальный навык: `database/mysql-security/SKILL.md`
