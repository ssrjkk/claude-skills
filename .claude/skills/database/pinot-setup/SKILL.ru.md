...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Setup
...
## Ресурсы
- Оригинальный навык: `database/pinot-setup/SKILL.md`
