...
version: "1.0"
language: ru
original: dynamodb-backup
---

# Dynamodb Backup

> Backup with DynamoDB. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Backup
...
## Ресурсы
- Оригинальный навык: `database/dynamodb-backup/SKILL.md`
