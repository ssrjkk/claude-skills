...
version: "1.0"
language: ru
original: oracle-security
---

# Oracle Security

> Security with Oracle. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Security
...
## Ресурсы
- Оригинальный навык: `database/oracle-security/SKILL.md`
