...
category: database
tags: [mysql-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mysql-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Advanced
...
## Ресурсы
- Оригинальный навык: database/mysql-advanced/SKILL.md
