...
category: database
tags: [influxdb-retention, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: influxdb-retention
---

# Influxdb Retention

> Retention with InfluxDB. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `influxdb-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Influxdb Retention
...
## Ресурсы
- Оригинальный навык: `database/influxdb-retention/SKILL.md`
