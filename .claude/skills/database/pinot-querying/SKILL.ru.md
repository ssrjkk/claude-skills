...
category: database
tags: [pinot-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-querying
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Querying
...
## Ресурсы
- Оригинальный навык: `database/pinot-querying/SKILL.md`
