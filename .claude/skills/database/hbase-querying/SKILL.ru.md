...
version: "1.0"
language: ru
original: hbase-querying
---

# Hbase Querying

> Querying with HBase. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hbase-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hbase Querying
...
## Ресурсы
- Оригинальный навык: `database/hbase-querying/SKILL.md`
