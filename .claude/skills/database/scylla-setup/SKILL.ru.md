...
category: database
tags: [scylla-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scylla-setup
---

# Scylla Setup

> Setup with ScyllaDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Setup
...
## Ресурсы
- Оригинальный навык: `database/scylla-setup/SKILL.md`
