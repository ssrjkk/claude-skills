...
version: "1.0"
language: ru
original: cassandra-monitoring
---

# Cassandra Monitoring

> Monitoring with Cassandra. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Monitoring
...
## Ресурсы
- Оригинальный навык: `database/cassandra-monitoring/SKILL.md`
