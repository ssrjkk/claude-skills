...
category: database
tags: [mysql-migration, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mysql-migration
---

# Mysql Migration

> Migration with MySQL. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Migration
...
## Ресурсы
- Оригинальный навык: `database/mysql-migration/SKILL.md`
