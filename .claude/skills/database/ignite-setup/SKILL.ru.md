...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Setup
...
## Ресурсы
- Оригинальный навык: `database/ignite-setup/SKILL.md`
