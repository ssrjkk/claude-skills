...
category: database
tags: [neo4j-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neo4j-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Advanced
...
## Ресурсы
- Оригинальный навык: database/neo4j-advanced/SKILL.md
