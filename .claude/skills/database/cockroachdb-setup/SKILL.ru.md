...
version: "1.0"
language: ru
original: cockroachdb-setup
---

# Cockroachdb Setup

> Setup with CockroachDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Setup
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-setup/SKILL.md`
