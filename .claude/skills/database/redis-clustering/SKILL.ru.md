...
version: "1.0"
language: ru
original: redis-clustering
---

# Redis Clustering

> Clustering with Redis. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redis-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Redis Clustering
...
## Ресурсы
- Оригинальный навык: `database/redis-clustering/SKILL.md`
