...
category: database
tags: [neo4j-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neo4j-optimization
---

# Neo4J Optimization

> Optimization with Neo4j. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Optimization
...
## Ресурсы
- Оригинальный навык: `database/neo4j-optimization/SKILL.md`
