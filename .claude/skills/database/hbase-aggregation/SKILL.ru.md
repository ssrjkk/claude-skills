...
category: database
tags: [hbase-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hbase-aggregation
---

# Hbase Aggregation

> Aggregation with HBase. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hbase-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hbase Aggregation
...
## Ресурсы
- Оригинальный навык: `database/hbase-aggregation/SKILL.md`
