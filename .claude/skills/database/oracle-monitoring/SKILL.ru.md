...
category: database
tags: [oracle-monitoring, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oracle-monitoring
---

# Oracle Monitoring

> Monitoring with Oracle. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Oracle Monitoring
...
## Ресурсы
- Оригинальный навык: `database/oracle-monitoring/SKILL.md`
