...
version: "1.0"
language: ru
original: singlestore-workflow
---

# Singlestore Workflow

> Workflow for Singlestore: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: singlestore-workflow.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Singlestore Workflow
...
## Ресурсы
- database/singlestore-workflow/SKILL.md
