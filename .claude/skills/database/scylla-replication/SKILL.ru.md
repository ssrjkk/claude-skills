...
version: "1.0"
language: ru
original: scylla-replication
---

# Scylla Replication

> Replication with ScyllaDB. replication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scylla-replication`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylla Replication
...
## Ресурсы
- Оригинальный навык: `database/scylla-replication/SKILL.md`
