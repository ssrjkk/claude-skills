...
category: database
tags: [surreal-replication, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: surreal-replication
---

# Surreal Replication

> Replication with SurrealDB. replication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-replication`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Replication
...
## Ресурсы
- Оригинальный навык: `database/surreal-replication/SKILL.md`
