...
category: database
tags: [cassandra-advanced, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-advanced`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Advanced
...
## Ресурсы
- Оригинальный навык: database/cassandra-advanced/SKILL.md
