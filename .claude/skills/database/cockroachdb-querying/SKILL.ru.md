...
category: database
tags: [cockroachdb-querying, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cockroachdb-querying
---

# Cockroachdb Querying

> Querying with CockroachDB. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Querying
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-querying/SKILL.md`
