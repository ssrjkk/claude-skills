...
category: database
tags: [surreal-schema, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: surreal-schema
---

# Surreal Schema

> Schema Design with SurrealDB. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Schema
...
## Ресурсы
- Оригинальный навык: `database/surreal-schema/SKILL.md`
