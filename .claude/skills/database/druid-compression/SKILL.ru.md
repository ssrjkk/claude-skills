...
## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-compression`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Compression
...
## Ресурсы
- Оригинальный навык: `database/druid-compression/SKILL.md`
