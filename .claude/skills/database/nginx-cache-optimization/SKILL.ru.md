...
category: database
tags: [nginx-cache-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nginx-cache-optimization
---

# Nginx Cache Optimization

> Optimization with Nginx Cache. performance tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nginx-cache-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Nginx Cache Optimization
...
## Ресурсы
- Оригинальный навык: `database/nginx-cache-optimization/SKILL.md`
