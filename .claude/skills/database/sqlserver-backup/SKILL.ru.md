...
category: database
tags: [sqlserver-backup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlserver-backup
---

# Sqlserver Backup

> Backup with SQL Server. backup strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-backup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Backup
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-backup/SKILL.md`
