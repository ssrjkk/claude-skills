...
version: "1.0"
language: ru
original: typesense-scoring
---

# Typesense Scoring

> Scoring with Typesense. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typesense-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Typesense Scoring
...
## Ресурсы
- Оригинальный навык: `database/typesense-scoring/SKILL.md`
