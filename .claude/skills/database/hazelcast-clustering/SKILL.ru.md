...
version: "1.0"
language: ru
original: hazelcast-clustering
---

# Hazelcast Clustering

> Clustering with Hazelcast. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hazelcast-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Hazelcast Clustering
...
## Ресурсы
- Оригинальный навык: `database/hazelcast-clustering/SKILL.md`
