...
version: "1.0"
language: ru
original: motherduck-workflow
---

# Motherduck Workflow

> Workflow for Motherduck: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: motherduck-workflow.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Motherduck Workflow
...
## Ресурсы
- database/motherduck-workflow/SKILL.md
