...
category: database
tags: [neon-configuration, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Configuration for Neon: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: neon-configuration.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neon Configuration
...
## Ресурсы
- database/neon-configuration/SKILL.md
