...
version: "1.0"
language: ru
original: cockroachdb-migration
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cockroachdb-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cockroachdb Migration
...
## Ресурсы
- Оригинальный навык: `database/cockroachdb-migration/SKILL.md`
