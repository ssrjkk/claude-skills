...
version: "1.0"
language: ru
original: meilisearch-mapping
---

# Meilisearch Mapping

> Mapping with Meilisearch. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `meilisearch-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Meilisearch Mapping
...
## Ресурсы
- Оригинальный навык: `database/meilisearch-mapping/SKILL.md`
