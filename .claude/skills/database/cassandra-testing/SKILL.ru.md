...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-testing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Testing
...
## Ресурсы
- Оригинальный навык: database/cassandra-testing/SKILL.md
