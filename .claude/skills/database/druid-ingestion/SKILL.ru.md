...
category: database
tags: [druid-ingestion, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-ingestion
---

# Druid Ingestion

> Ingestion with Apache Druid. data ingestion.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-ingestion`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Ingestion
...
## Ресурсы
- Оригинальный навык: `database/druid-ingestion/SKILL.md`
