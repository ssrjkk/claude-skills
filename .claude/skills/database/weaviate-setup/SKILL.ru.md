...
version: "1.0"
language: ru
original: weaviate-setup
---

# Weaviate Setup

> Setup with Weaviate. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Setup
...
## Ресурсы
- Оригинальный навык: `database/weaviate-setup/SKILL.md`
