...
version: "1.0"
language: ru
original: meilisearch-scoring
---

# Meilisearch Scoring

> Scoring with Meilisearch. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `meilisearch-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Meilisearch Scoring
...
## Ресурсы
- Оригинальный навык: `database/meilisearch-scoring/SKILL.md`
