...
category: database
tags: [mariadb-migration, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mariadb-migration
---

# Mariadb Migration

> Migration with MariaDB. schema migrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mariadb-migration`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mariadb Migration
...
## Ресурсы
- Оригинальный навык: `database/mariadb-migration/SKILL.md`
