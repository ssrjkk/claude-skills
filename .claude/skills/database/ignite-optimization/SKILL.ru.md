...
category: database
tags: [ignite-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ignite-optimization
---

# Ignite Optimization

> Optimization with Apache Ignite. performance tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Optimization
...
## Ресурсы
- Оригинальный навык: `database/ignite-optimization/SKILL.md`
