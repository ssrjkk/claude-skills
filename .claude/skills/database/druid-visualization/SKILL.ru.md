...
category: database
tags: [druid-visualization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-visualization
---

# Druid Visualization

> Visualization with Apache Druid. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Visualization
...
## Ресурсы
- Оригинальный навык: `database/druid-visualization/SKILL.md`
