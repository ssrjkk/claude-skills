...
category: database
tags: [pinot-retention, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-retention
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pinot-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Pinot Retention
...
## Ресурсы
- Оригинальный навык: `database/pinot-retention/SKILL.md`
