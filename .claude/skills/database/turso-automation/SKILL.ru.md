...
version: "1.0"
language: ru
original: turso-automation
---

# Turso Automation

> Automation for Turso: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: turso-automation.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Turso Automation
...
## Ресурсы
- database/turso-automation/SKILL.md
