...
category: database
tags: [neo4j-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neo4j-security
---

# Neo4J Security

> Security with Neo4j. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Security
...
## Ресурсы
- Оригинальный навык: `database/neo4j-security/SKILL.md`
