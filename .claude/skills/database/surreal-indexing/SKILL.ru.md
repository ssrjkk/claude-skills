...
category: database
tags: [surreal-indexing, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: surreal-indexing
---

# Surreal Indexing

> Indexing with SurrealDB. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `surreal-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Surreal Indexing
...
## Ресурсы
- Оригинальный навык: `database/surreal-indexing/SKILL.md`
