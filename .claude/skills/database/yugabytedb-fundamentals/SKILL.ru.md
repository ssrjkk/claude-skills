...
category: database
tags: [yugabytedb-fundamentals, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: yugabytedb-fundamentals
---

# Yugabytedb Fundamentals

> Fundamentals for Yugabytedb: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `yugabytedb-fundamentals`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabytedb Fundamentals
...
## Ресурсы
- Оригинал: database/yugabytedb-fundamentals/SKILL.md
