...
version: "1.0"
language: ru
original: mysql-optimization
---

# Mysql Optimization

> Optimization with MySQL. query tuning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Optimization
...
## Ресурсы
- Оригинальный навык: `database/mysql-optimization/SKILL.md`
