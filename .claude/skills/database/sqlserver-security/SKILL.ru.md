...
category: database
tags: [sqlserver-security, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sqlserver-security
---

# Sqlserver Security

> Security with SQL Server. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sqlserver-security`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sqlserver Security
...
## Ресурсы
- Оригинальный навык: `database/sqlserver-security/SKILL.md`
