...
version: "1.0"
language: ru
original: scylladb-examples
---

# Scylladb Examples

> Examples for Scylladb: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `scylladb-examples`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Scylladb Examples
...
## Ресурсы
- Оригинал: database/scylladb-examples/SKILL.md
