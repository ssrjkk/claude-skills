...
category: database
tags: [postgresql-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postgresql-setup
---

# Postgresql Setup

> Setup with PostgreSQL. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Setup
...
## Ресурсы
- Оригинальный навык: `database/postgresql-setup/SKILL.md`
