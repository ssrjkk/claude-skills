...
category: database
tags: [druid-retention, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-retention
---

# Druid Retention

> Retention with Apache Druid. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `druid-retention`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Druid Retention
...
## Ресурсы
- Оригинальный навык: `database/druid-retention/SKILL.md`
