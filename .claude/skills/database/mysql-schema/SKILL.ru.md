...
> Schema Design with MySQL. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mysql-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Mysql Schema
...
## Ресурсы
- Оригинальный навык: `database/mysql-schema/SKILL.md`
