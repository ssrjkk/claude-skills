...
version: "1.0"
language: ru
original: cassandra-indexing
---

# Cassandra Indexing

> Indexing with Cassandra. indexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-indexing`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Indexing
...
## Ресурсы
- Оригинальный навык: `database/cassandra-indexing/SKILL.md`
