...
category: database
tags: [timescaledb-setup, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: timescaledb-setup
---

# Timescaledb Setup

> Setup with TimescaleDB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `timescaledb-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Timescaledb Setup
...
## Ресурсы
- Оригинальный навык: `database/timescaledb-setup/SKILL.md`
