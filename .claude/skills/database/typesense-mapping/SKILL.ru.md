...
version: "1.0"
language: ru
original: typesense-mapping
---

# Typesense Mapping

> Mapping with Typesense. field mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typesense-mapping`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Typesense Mapping
...
## Ресурсы
- Оригинальный навык: `database/typesense-mapping/SKILL.md`
