...
version: "1.0"
language: ru
original: motherduck-best-practices
---

# Motherduck Best Practices

> Best Practices for Motherduck: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: motherduck-best-practices.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Motherduck Best Practices
...
## Ресурсы
- database/motherduck-best-practices/SKILL.md
