...
category: database
tags: [cassandra-aggregation, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-aggregation
---

# Cassandra Aggregation

> Aggregation with Cassandra. aggregation pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-aggregation`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Aggregation
...
## Ресурсы
- Оригинальный навык: `database/cassandra-aggregation/SKILL.md`
