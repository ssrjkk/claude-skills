...
version: "1.0"
language: ru
original: dgraph-setup
---

# Dgraph Setup

> Setup with Dgraph. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dgraph-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dgraph Setup
...
## Ресурсы
- Оригинальный навык: `database/dgraph-setup/SKILL.md`
