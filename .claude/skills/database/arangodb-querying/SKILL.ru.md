...
version: "1.0"
language: ru
original: arangodb-querying
---

# Arangodb Querying

> Querying with ArangoDB. queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arangodb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Arangodb Querying
...
## Ресурсы
- Оригинальный навык: `database/arangodb-querying/SKILL.md`
