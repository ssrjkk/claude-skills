...
version: "1.0"
language: ru
original: valkey-quickstart
---

# Valkey Quickstart

> Quickstart for Valkey: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `valkey-quickstart`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Valkey Quickstart
...
## Ресурсы
- Оригинал: database/valkey-quickstart/SKILL.md
