...
> Setup with Neo4j. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-setup`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Setup
...
## Ресурсы
- Оригинальный навык: `database/neo4j-setup/SKILL.md`
