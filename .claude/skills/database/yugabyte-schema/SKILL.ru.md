...
version: "1.0"
language: ru
original: yugabyte-schema
---

# Yugabyte Schema

> Schema Design with YugabyteDB. schema.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yugabyte-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Yugabyte Schema
...
## Ресурсы
- Оригинальный навык: `database/yugabyte-schema/SKILL.md`
