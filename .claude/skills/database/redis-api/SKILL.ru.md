...
category: database
tags: [redis-api, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redis-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redis-api`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Redis Api
...
## Ресурсы
- Оригинальный навык: database/redis-api/SKILL.md
