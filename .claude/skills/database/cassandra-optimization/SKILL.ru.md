...
category: database
tags: [cassandra-optimization, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cassandra-optimization
---

# Cassandra Optimization

> Optimization with Cassandra. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cassandra-optimization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Cassandra Optimization
...
## Ресурсы
- Оригинальный навык: `database/cassandra-optimization/SKILL.md`
