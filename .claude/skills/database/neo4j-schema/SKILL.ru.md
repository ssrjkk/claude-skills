...
version: "1.0"
language: ru
original: neo4j-schema
---

# Neo4J Schema

> Schema Design with Neo4j. schema design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neo4j-schema`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Neo4J Schema
...
## Ресурсы
- Оригинальный навык: `database/neo4j-schema/SKILL.md`
