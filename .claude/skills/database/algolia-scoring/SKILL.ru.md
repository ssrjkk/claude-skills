...
version: "1.0"
language: ru
original: algolia-scoring
---

# Algolia Scoring

> Scoring with Algolia. relevance scoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algolia-scoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Algolia Scoring
...
## Ресурсы
- Оригинальный навык: `database/algolia-scoring/SKILL.md`
