...
category: database
tags: [ignite-caching, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ignite-caching
---

# Ignite Caching

> Caching with Apache Ignite. caching strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ignite-caching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Ignite Caching
...
## Ресурсы
- Оригинальный навык: `database/ignite-caching/SKILL.md`
