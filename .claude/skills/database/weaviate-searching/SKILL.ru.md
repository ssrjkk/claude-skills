...
category: database
tags: [weaviate-searching, database, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: weaviate-searching
---

# Weaviate Searching

> Searching with Weaviate. full-text search.

## Быстрый старт
Этот навык на русском языке. Оригинал: `weaviate-searching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Weaviate Searching
...
## Ресурсы
- Оригинальный навык: `database/weaviate-searching/SKILL.md`
