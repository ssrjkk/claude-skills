...
version: "1.0"
language: ru
original: postgresql-querying
---

# Postgresql Querying

> Querying with PostgreSQL. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgresql-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Postgresql Querying
...
## Ресурсы
- Оригинальный навык: `database/postgresql-querying/SKILL.md`
