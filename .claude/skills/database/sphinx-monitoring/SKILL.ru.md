...
version: "1.0"
language: ru
original: sphinx-monitoring
---

# Sphinx Monitoring

> Monitoring with Sphinx. cluster monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sphinx-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Sphinx Monitoring
...
## Ресурсы
- Оригинальный навык: `database/sphinx-monitoring/SKILL.md`
