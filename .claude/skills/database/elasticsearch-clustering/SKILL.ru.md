...
version: "1.0"
language: ru
original: elasticsearch-clustering
---

# Elasticsearch Clustering

> Clustering with Elasticsearch. cluster setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elasticsearch-clustering`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Elasticsearch Clustering
...
## Ресурсы
- Оригинальный навык: `database/elasticsearch-clustering/SKILL.md`
