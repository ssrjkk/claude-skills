...
version: "1.0"
language: ru
original: victoria-metrics-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Victoria Metrics Monitoring
...
## Ресурсы
- Оригинальный навык: `database/victoria-metrics-monitoring/SKILL.md`
