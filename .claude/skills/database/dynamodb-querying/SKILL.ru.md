...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynamodb-querying`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Dynamodb Querying
...
## Ресурсы
- Оригинальный навык: `database/dynamodb-querying/SKILL.md`
