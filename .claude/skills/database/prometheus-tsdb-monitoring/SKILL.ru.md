...
version: "1.0"
language: ru
original: prometheus-tsdb-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-tsdb-monitoring`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Prometheus Tsdb Monitoring
...
## Ресурсы
- Оригинальный навык: `database/prometheus-tsdb-monitoring/SKILL.md`
