...
version: "1.0"
language: ru
original: clickhouse-visualization
---

# Clickhouse Visualization

> Visualization with ClickHouse. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clickhouse-visualization`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Clickhouse Visualization
...
## Ресурсы
- Оригинальный навык: `database/clickhouse-visualization/SKILL.md`
