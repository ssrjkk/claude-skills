...
version: "1.0"
language: ru
original: varnish-caching
---

# Varnish Caching

> Caching with Varnish. caching strategies.

## Быстрый старт
Этот навык на русском языке. Оригинал: `varnish-caching`.

## Когда использовать
- Работа с Базы данных
- Выполнение задач, связанных с Varnish Caching
...
## Ресурсы
- Оригинальный навык: `database/varnish-caching/SKILL.md`
