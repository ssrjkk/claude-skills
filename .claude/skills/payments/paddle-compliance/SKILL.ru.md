...
version: "1.0"
language: ru
original: paddle-compliance
---

# Paddle Compliance

> Compliance with Paddle. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Compliance
...
## Ресурсы
- Оригинальный навык: `payments/paddle-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
