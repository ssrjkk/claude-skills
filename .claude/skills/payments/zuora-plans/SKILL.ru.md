...
version: "1.0"
language: ru
original: zuora-plans
---

# Zuora Plans

> Plans with Zuora. plan creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zuora-plans`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Zuora Plans
...
## Ресурсы
- Оригинальный навык: `payments/zuora-plans/SKILL.md`
- Категория: Платежи
- Язык: Русский
