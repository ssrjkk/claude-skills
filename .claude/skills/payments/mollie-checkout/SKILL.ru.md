...
version: "1.0"
language: ru
original: mollie-checkout
---

# Mollie Checkout

> Checkout with Mollie. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mollie-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Mollie Checkout
...
## Ресурсы
- Оригинальный навык: `payments/mollie-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
