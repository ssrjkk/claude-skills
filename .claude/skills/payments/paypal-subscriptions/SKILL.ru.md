...
category: payments
tags: [paypal-subscriptions, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paypal-subscriptions
---

# Paypal Subscriptions

> Subscriptions with PayPal. recurring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-subscriptions`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Subscriptions
...
## Ресурсы
- Оригинальный навык: `payments/paypal-subscriptions/SKILL.md`
- Категория: Платежи
- Язык: Русский
