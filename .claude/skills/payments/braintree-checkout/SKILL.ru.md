...
version: "1.0"
language: ru
original: braintree-checkout
---

# Braintree Checkout

> Checkout with Braintree. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Checkout
...
## Ресурсы
- Оригинальный навык: `payments/braintree-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
