...
category: payments
tags: [adyen-webhooks, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adyen-webhooks
---

# Adyen Webhooks

> Webhooks with Adyen. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-webhooks`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Webhooks
...
## Ресурсы
- Оригинальный навык: `payments/adyen-webhooks/SKILL.md`
- Категория: Платежи
- Язык: Русский
