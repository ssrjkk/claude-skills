...
category: payments
tags: [paypal-setup, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paypal-setup
---

# Paypal Setup

> Setup with PayPal. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Setup
...
## Ресурсы
- Оригинальный навык: `payments/paypal-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
