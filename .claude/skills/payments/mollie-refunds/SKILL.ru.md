...
category: payments
tags: [mollie-refunds, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mollie-refunds
---

# Mollie Refunds

> Refunds with Mollie. refunds.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mollie-refunds`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Mollie Refunds
...
## Ресурсы
- Оригинальный навык: `payments/mollie-refunds/SKILL.md`
- Категория: Платежи
- Язык: Русский
