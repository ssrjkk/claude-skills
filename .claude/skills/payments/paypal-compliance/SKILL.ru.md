...
version: "1.0"
language: ru
original: paypal-compliance
---

# Paypal Compliance

> Compliance with PayPal. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Compliance
...
## Ресурсы
- Оригинальный навык: `payments/paypal-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
