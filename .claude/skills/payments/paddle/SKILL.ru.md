...
> Integrates Paddle for SaaS payment processing, subscriptions, and checkout management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle
...
## Ресурсы
- Оригинальный навык: `payments/paddle/SKILL.md`
- Категория: Платежи
- Язык: Русский
