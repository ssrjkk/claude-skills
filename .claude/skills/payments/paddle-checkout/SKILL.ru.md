...
version: "1.0"
language: ru
original: paddle-checkout
---

# Paddle Checkout

> Checkout with Paddle. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Checkout
...
## Ресурсы
- Оригинальный навык: `payments/paddle-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
