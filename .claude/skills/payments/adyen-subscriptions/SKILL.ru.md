...
version: "1.0"
language: ru
original: adyen-subscriptions
---

# Adyen Subscriptions

> Subscriptions with Adyen. recurring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-subscriptions`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Subscriptions
...
## Ресурсы
- Оригинальный навык: `payments/adyen-subscriptions/SKILL.md`
- Категория: Платежи
- Язык: Русский
