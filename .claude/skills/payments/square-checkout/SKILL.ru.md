...
category: payments
tags: [square-checkout, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: square-checkout
---

# Square Checkout

> Checkout with Square. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `square-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Square Checkout
...
## Ресурсы
- Оригинальный навык: `payments/square-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
