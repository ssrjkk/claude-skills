...
version: "1.0"
language: ru
original: adyen-refunds
---

# Adyen Refunds

> Refunds with Adyen. refunds.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-refunds`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Refunds
...
## Ресурсы
- Оригинальный навык: `payments/adyen-refunds/SKILL.md`
- Категория: Платежи
- Язык: Русский
