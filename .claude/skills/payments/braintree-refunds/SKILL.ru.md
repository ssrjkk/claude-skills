...
version: "1.0"
language: ru
original: braintree-refunds
---

# Braintree Refunds

> Refunds with Braintree. refunds.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-refunds`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Refunds
...
## Ресурсы
- Оригинальный навык: `payments/braintree-refunds/SKILL.md`
- Категория: Платежи
- Язык: Русский
