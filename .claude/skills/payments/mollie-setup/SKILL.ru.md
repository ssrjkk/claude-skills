...
category: payments
tags: [mollie-setup, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mollie-setup
---

# Mollie Setup

> Setup with Mollie. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mollie-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Mollie Setup
...
## Ресурсы
- Оригинальный навык: `payments/mollie-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
