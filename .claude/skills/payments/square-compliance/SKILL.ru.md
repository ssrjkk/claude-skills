...
version: "1.0"
language: ru
original: square-compliance
---

# Square Compliance

> Compliance with Square. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `square-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Square Compliance
...
## Ресурсы
- Оригинальный навык: `payments/square-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
