...
version: "1.0"
language: ru
original: braintree-compliance
---

# Braintree Compliance

> Compliance with Braintree. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Compliance
...
## Ресурсы
- Оригинальный навык: `payments/braintree-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
