...
category: payments
tags: [braintree-webhooks, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: braintree-webhooks
---

# Braintree Webhooks

> Webhooks with Braintree. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-webhooks`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Webhooks
...
## Ресурсы
- Оригинальный навык: `payments/braintree-webhooks/SKILL.md`
- Категория: Платежи
- Язык: Русский
