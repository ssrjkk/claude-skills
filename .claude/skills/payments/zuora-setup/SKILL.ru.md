...
version: "1.0"
language: ru
original: zuora-setup
---

# Zuora Setup

> Setup with Zuora. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zuora-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Zuora Setup
...
## Ресурсы
- Оригинальный навык: `payments/zuora-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
