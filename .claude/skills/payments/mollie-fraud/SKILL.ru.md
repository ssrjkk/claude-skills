...
version: "1.0"
language: ru
original: mollie-fraud
---

# Mollie Fraud

> Fraud with Mollie. fraud detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mollie-fraud`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Mollie Fraud
...
## Ресурсы
- Оригинальный навык: `payments/mollie-fraud/SKILL.md`
- Категория: Платежи
- Язык: Русский
