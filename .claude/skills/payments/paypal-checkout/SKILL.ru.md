...
category: payments
tags: [paypal-checkout, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paypal-checkout
---

# Paypal Checkout

> Checkout with PayPal. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Checkout
...
## Ресурсы
- Оригинальный навык: `payments/paypal-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
