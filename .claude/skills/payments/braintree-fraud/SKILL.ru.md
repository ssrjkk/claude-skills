...
version: "1.0"
language: ru
original: braintree-fraud
---

# Braintree Fraud

> Fraud with Braintree. fraud detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-fraud`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Fraud
...
## Ресурсы
- Оригинальный навык: `payments/braintree-fraud/SKILL.md`
- Категория: Платежи
- Язык: Русский
