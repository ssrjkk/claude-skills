...
category: payments
tags: [adyen-setup, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adyen-setup
---

# Adyen Setup

> Setup with Adyen. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Setup
...
## Ресурсы
- Оригинальный навык: `payments/adyen-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
