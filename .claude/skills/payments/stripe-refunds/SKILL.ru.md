...
category: payments
tags: [stripe-refunds, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stripe-refunds
---

# Stripe Refunds

> Refunds with Stripe. refunds.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stripe-refunds`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Stripe Refunds
...
## Ресурсы
- Оригинальный навык: `payments/stripe-refunds/SKILL.md`
- Категория: Платежи
- Язык: Русский
