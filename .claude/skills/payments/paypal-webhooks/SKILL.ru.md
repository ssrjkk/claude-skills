...
version: "1.0"
language: ru
original: paypal-webhooks
---

# Paypal Webhooks

> Webhooks with PayPal. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-webhooks`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Webhooks
...
## Ресурсы
- Оригинальный навык: `payments/paypal-webhooks/SKILL.md`
- Категория: Платежи
- Язык: Русский
