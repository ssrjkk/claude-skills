...
version: "1.0"
language: ru
original: braintree-setup
---

# Braintree Setup

> Setup with Braintree. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `braintree-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Braintree Setup
...
## Ресурсы
- Оригинальный навык: `payments/braintree-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
