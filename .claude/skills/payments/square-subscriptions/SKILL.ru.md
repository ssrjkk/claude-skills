...
category: payments
tags: [square-subscriptions, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: square-subscriptions
---

# Square Subscriptions

> Subscriptions with Square. recurring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `square-subscriptions`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Square Subscriptions
...
## Ресурсы
- Оригинальный навык: `payments/square-subscriptions/SKILL.md`
- Категория: Платежи
- Язык: Русский
