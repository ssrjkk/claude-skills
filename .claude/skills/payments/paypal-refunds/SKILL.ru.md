...
version: "1.0"
language: ru
original: paypal-refunds
---

# Paypal Refunds

> Refunds with PayPal. refunds.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paypal-refunds`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paypal Refunds
...
## Ресурсы
- Оригинальный навык: `payments/paypal-refunds/SKILL.md`
- Категория: Платежи
- Язык: Русский
