...
category: payments
tags: [paddle-billing-setup, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paddle-billing-setup
---

# Paddle Billing Setup

> Setup with Paddle Billing. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-billing-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Billing Setup
...
## Ресурсы
- Оригинальный навык: `payments/paddle-billing-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
