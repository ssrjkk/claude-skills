...
category: payments
tags: [paddle-subscriptions, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paddle-subscriptions
---

# Paddle Subscriptions

> Subscriptions with Paddle. recurring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-subscriptions`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Subscriptions
...
## Ресурсы
- Оригинальный навык: `payments/paddle-subscriptions/SKILL.md`
- Категория: Платежи
- Язык: Русский
