...
version: "1.0"
language: ru
original: mollie-compliance
---

# Mollie Compliance

> Compliance with Mollie. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mollie-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Mollie Compliance
...
## Ресурсы
- Оригинальный навык: `payments/mollie-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
