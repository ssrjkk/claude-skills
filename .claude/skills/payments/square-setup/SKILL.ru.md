...
version: "1.0"
language: ru
original: square-setup
---

# Square Setup

> Setup with Square. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `square-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Square Setup
...
## Ресурсы
- Оригинальный навык: `payments/square-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
