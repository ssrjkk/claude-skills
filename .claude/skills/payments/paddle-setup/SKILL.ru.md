...
version: "1.0"
language: ru
original: paddle-setup
---

# Paddle Setup

> Setup with Paddle. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-setup`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Setup
...
## Ресурсы
- Оригинальный навык: `payments/paddle-setup/SKILL.md`
- Категория: Платежи
- Язык: Русский
