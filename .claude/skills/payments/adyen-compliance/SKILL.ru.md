...
version: "1.0"
language: ru
original: adyen-compliance
---

# Adyen Compliance

> Compliance with Adyen. PCI DSS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-compliance`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Compliance
...
## Ресурсы
- Оригинальный навык: `payments/adyen-compliance/SKILL.md`
- Категория: Платежи
- Язык: Русский
