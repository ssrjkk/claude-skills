...
category: payments
tags: [adyen-checkout, payments, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adyen-checkout
---

# Adyen Checkout

> Checkout with Adyen. checkout flow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adyen-checkout`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Adyen Checkout
...
## Ресурсы
- Оригинальный навык: `payments/adyen-checkout/SKILL.md`
- Категория: Платежи
- Язык: Русский
