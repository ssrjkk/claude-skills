...
version: "1.0"
language: ru
original: paddle-webhooks
---

# Paddle Webhooks

> Webhooks with Paddle. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddle-webhooks`.

## Когда использовать
- Работа с Платежи
- Выполнение задач, связанных с Paddle Webhooks
...
## Ресурсы
- Оригинальный навык: `payments/paddle-webhooks/SKILL.md`
- Категория: Платежи
- Язык: Русский
