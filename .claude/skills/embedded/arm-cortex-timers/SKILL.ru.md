...
version: "1.0"
language: ru
original: arm-cortex-timers
---

# Arm Cortex Timers

> Timers with ARM Cortex-M. timers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-timers`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Timers
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-timers/SKILL.md`
