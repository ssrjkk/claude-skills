...
> Memory with AVR. memory layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avr-memory`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Avr Memory
...
## Ресурсы
- Оригинальный навык: `embedded/avr-memory/SKILL.md`
