...
version: "1.0"
language: ru
original: zephyr-setup
---

# Zephyr Setup

> Setup with Zephyr. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Setup
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-setup/SKILL.md`
