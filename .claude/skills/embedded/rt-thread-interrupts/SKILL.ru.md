...
category: embedded
tags: [rt-thread-interrupts, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rt-thread-interrupts
---

# Rt Thread Interrupts

> Interrupts with RT-Thread. ISR handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rt-thread-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Rt Thread Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/rt-thread-interrupts/SKILL.md`
