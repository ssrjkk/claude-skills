...
version: "1.0"
language: ru
original: arm-cortex-toolchain
---

# Arm Cortex Toolchain

> Toolchain with ARM Cortex-M. compiler.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-toolchain`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Toolchain
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-toolchain/SKILL.md`
