...
category: embedded
tags: [pic-toolchain, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pic-toolchain
---

# Pic Toolchain

> Toolchain with PIC. compiler.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pic-toolchain`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Pic Toolchain
...
## Ресурсы
- Оригинальный навык: `embedded/pic-toolchain/SKILL.md`
