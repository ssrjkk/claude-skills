...
version: "1.0"
language: ru
original: rt-thread-debugging
---

# Rt Thread Debugging

> Debugging with RT-Thread. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rt-thread-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Rt Thread Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/rt-thread-debugging/SKILL.md`
