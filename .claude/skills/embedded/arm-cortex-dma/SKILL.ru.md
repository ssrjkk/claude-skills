...
version: "1.0"
language: ru
original: arm-cortex-dma
---

# Arm Cortex Dma

> DMA with ARM Cortex-M. DMA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-dma`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Dma
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-dma/SKILL.md`
