...
version: "1.0"
language: ru
original: zephyr-synchronization
---

# Zephyr Synchronization

> Sync with Zephyr. mutexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-synchronization`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Synchronization
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-synchronization/SKILL.md`
