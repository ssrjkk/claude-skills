...
version: "1.0"
language: ru
original: xtensa-bootstrap
---

# Xtensa Bootstrap

> Bootstrap with Xtensa. startup code.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xtensa-bootstrap`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Xtensa Bootstrap
...
## Ресурсы
- Оригинальный навык: `embedded/xtensa-bootstrap/SKILL.md`
