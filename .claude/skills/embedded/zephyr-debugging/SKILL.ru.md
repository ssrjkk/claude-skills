...
version: "1.0"
language: ru
original: zephyr-debugging
---

# Zephyr Debugging

> Debugging with Zephyr. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-debugging/SKILL.md`
