...
version: "1.0"
language: ru
original: pic-debugging
---

# Pic Debugging

> Debugging with PIC. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pic-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Pic Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/pic-debugging/SKILL.md`
