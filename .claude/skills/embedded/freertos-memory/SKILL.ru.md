...
version: "1.0"
language: ru
original: freertos-memory
---

# Freertos Memory

> Memory with FreeRTOS. memory management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `freertos-memory`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Freertos Memory
...
## Ресурсы
- Оригинальный навык: `embedded/freertos-memory/SKILL.md`
