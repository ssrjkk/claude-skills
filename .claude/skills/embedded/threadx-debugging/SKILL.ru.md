...
version: "1.0"
language: ru
original: threadx-debugging
---

# Threadx Debugging

> Debugging with ThreadX. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `threadx-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Threadx Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/threadx-debugging/SKILL.md`
