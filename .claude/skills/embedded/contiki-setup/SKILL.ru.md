...
category: embedded
tags: [contiki-setup, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: contiki-setup
---

# Contiki Setup

> Setup with Contiki-NG. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contiki-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Contiki Setup
...
## Ресурсы
- Оригинальный навык: `embedded/contiki-setup/SKILL.md`
