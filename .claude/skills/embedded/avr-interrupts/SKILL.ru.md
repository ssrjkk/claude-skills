...
category: embedded
tags: [avr-interrupts, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avr-interrupts
---

# Avr Interrupts

> Interrupts with AVR. interrupts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avr-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Avr Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/avr-interrupts/SKILL.md`
