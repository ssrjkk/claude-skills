...
version: "1.0"
language: ru
original: freertos-setup
---

# Freertos Setup

> Setup with FreeRTOS. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `freertos-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Freertos Setup
...
## Ресурсы
- Оригинальный навык: `embedded/freertos-setup/SKILL.md`
