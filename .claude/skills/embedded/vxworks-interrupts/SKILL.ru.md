...
version: "1.0"
language: ru
original: vxworks-interrupts
---

# Vxworks Interrupts

> Interrupts with VxWorks. ISR handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vxworks-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Vxworks Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/vxworks-interrupts/SKILL.md`
