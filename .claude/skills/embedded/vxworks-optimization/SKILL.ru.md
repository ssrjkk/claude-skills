...
version: "1.0"
language: ru
original: vxworks-optimization
---

# Vxworks Optimization

> Optimization with VxWorks. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vxworks-optimization`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Vxworks Optimization
...
## Ресурсы
- Оригинальный навык: `embedded/vxworks-optimization/SKILL.md`
