...
version: "1.0"
language: ru
original: contiki-tasks
---

# Contiki Tasks

> Tasks with Contiki-NG. task management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contiki-tasks`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Contiki Tasks
...
## Ресурсы
- Оригинальный навык: `embedded/contiki-tasks/SKILL.md`
