...
version: "1.0"
language: ru
original: riscv-debugging
---

# Riscv Debugging

> Debugging with RISC-V. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riscv-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Riscv Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/riscv-debugging/SKILL.md`
