...
category: embedded
tags: [arm-cortex-interrupts, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arm-cortex-interrupts
---

# Arm Cortex Interrupts

> Interrupts with ARM Cortex-M. interrupts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-interrupts/SKILL.md`
