...
version: "1.0"
language: ru
original: pic-bootstrap
---

# Pic Bootstrap

> Bootstrap with PIC. startup code.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pic-bootstrap`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Pic Bootstrap
...
## Ресурсы
- Оригинальный навык: `embedded/pic-bootstrap/SKILL.md`
