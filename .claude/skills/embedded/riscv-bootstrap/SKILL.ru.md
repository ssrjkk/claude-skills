...
version: "1.0"
language: ru
original: riscv-bootstrap
---

# Riscv Bootstrap

> Bootstrap with RISC-V. startup code.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riscv-bootstrap`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Riscv Bootstrap
...
## Ресурсы
- Оригинальный навык: `embedded/riscv-bootstrap/SKILL.md`
