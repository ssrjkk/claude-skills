...
version: "1.0"
language: ru
original: contiki-interrupts
---

# Contiki Interrupts

> Interrupts with Contiki-NG. ISR handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contiki-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Contiki Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/contiki-interrupts/SKILL.md`
