...
## Быстрый старт
Этот навык на русском языке. Оригинал: `rt-thread-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Rt Thread Setup
...
## Ресурсы
- Оригинальный навык: `embedded/rt-thread-setup/SKILL.md`
