...
version: "1.0"
language: ru
original: riscv-toolchain
---

# Riscv Toolchain

> Toolchain with RISC-V. compiler.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riscv-toolchain`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Riscv Toolchain
...
## Ресурсы
- Оригинальный навык: `embedded/riscv-toolchain/SKILL.md`
