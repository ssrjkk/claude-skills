...
version: "1.0"
language: ru
original: riscv-setup
---

# Riscv Setup

> Setup with RISC-V. toolchain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riscv-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Riscv Setup
...
## Ресурсы
- Оригинальный навык: `embedded/riscv-setup/SKILL.md`
