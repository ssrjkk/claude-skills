...
category: embedded
tags: [xtensa-debugging, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xtensa-debugging
---

# Xtensa Debugging

> Debugging with Xtensa. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xtensa-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Xtensa Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/xtensa-debugging/SKILL.md`
