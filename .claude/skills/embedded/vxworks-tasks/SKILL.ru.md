...
version: "1.0"
language: ru
original: vxworks-tasks
---

# Vxworks Tasks

> Tasks with VxWorks. task management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vxworks-tasks`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Vxworks Tasks
...
## Ресурсы
- Оригинальный навык: `embedded/vxworks-tasks/SKILL.md`
