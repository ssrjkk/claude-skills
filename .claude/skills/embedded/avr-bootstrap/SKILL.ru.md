...
version: "1.0"
language: ru
original: avr-bootstrap
---

# Avr Bootstrap

> Bootstrap with AVR. startup code.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avr-bootstrap`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Avr Bootstrap
...
## Ресурсы
- Оригинальный навык: `embedded/avr-bootstrap/SKILL.md`
