...
version: "1.0"
language: ru
original: contiki-debugging
---

# Contiki Debugging

> Debugging with Contiki-NG. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contiki-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Contiki Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/contiki-debugging/SKILL.md`
