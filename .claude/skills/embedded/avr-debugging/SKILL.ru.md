...
version: "1.0"
language: ru
original: avr-debugging
---

# Avr Debugging

> Debugging with AVR. debug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avr-debugging`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Avr Debugging
...
## Ресурсы
- Оригинальный навык: `embedded/avr-debugging/SKILL.md`
