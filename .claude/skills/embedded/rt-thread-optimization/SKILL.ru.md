...
version: "1.0"
language: ru
original: rt-thread-optimization
---

# Rt Thread Optimization

> Optimization with RT-Thread. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rt-thread-optimization`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Rt Thread Optimization
...
## Ресурсы
- Оригинальный навык: `embedded/rt-thread-optimization/SKILL.md`
