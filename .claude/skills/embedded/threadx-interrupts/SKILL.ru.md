...
category: embedded
tags: [threadx-interrupts, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: threadx-interrupts
---

# Threadx Interrupts

> Interrupts with ThreadX. ISR handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `threadx-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Threadx Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/threadx-interrupts/SKILL.md`
