...
version: "1.0"
language: ru
original: contiki-synchronization
---

# Contiki Synchronization

> Sync with Contiki-NG. mutexes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contiki-synchronization`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Contiki Synchronization
...
## Ресурсы
- Оригинальный навык: `embedded/contiki-synchronization/SKILL.md`
