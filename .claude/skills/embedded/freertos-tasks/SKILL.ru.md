...
version: "1.0"
language: ru
original: freertos-tasks
---

# Freertos Tasks

> Tasks with FreeRTOS. task management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `freertos-tasks`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Freertos Tasks
...
## Ресурсы
- Оригинальный навык: `embedded/freertos-tasks/SKILL.md`
