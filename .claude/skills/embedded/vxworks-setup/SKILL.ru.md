...
version: "1.0"
language: ru
original: vxworks-setup
---

# Vxworks Setup

> Setup with VxWorks. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vxworks-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Vxworks Setup
...
## Ресурсы
- Оригинальный навык: `embedded/vxworks-setup/SKILL.md`
