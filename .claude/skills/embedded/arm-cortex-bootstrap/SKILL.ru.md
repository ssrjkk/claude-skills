...
version: "1.0"
language: ru
original: arm-cortex-bootstrap
---

# Arm Cortex Bootstrap

> Bootstrap with ARM Cortex-M. startup code.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-bootstrap`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Bootstrap
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-bootstrap/SKILL.md`
