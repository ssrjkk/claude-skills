...
version: "1.0"
language: ru
original: zephyr-timers
---

# Zephyr Timers

> Timers with Zephyr. software timers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-timers`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Timers
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-timers/SKILL.md`
