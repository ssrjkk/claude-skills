...
category: embedded
tags: [zephyr-interrupts, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zephyr-interrupts
---

# Zephyr Interrupts

> Interrupts with Zephyr. ISR handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-interrupts`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Interrupts
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-interrupts/SKILL.md`
