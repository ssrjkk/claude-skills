...
category: embedded
tags: [arm-cortex-setup, embedded, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arm-cortex-setup
---

# Arm Cortex Setup

> Setup with ARM Cortex-M. toolchain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arm-cortex-setup`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Arm Cortex Setup
...
## Ресурсы
- Оригинальный навык: `embedded/arm-cortex-setup/SKILL.md`
