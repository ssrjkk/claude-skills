...
version: "1.0"
language: ru
original: zephyr-optimization
---

# Zephyr Optimization

> Optimization with Zephyr. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zephyr-optimization`.

## Когда использовать
- Работа с Встраиваемые системы
- Выполнение задач, связанных с Zephyr Optimization
...
## Ресурсы
- Оригинальный навык: `embedded/zephyr-optimization/SKILL.md`
