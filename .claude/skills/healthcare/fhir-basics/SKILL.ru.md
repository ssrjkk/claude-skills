...
version: "1.0"
language: ru
original: fhir-basics
---

# Fhir Basics

> Basics with FHIR. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fhir-basics`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Fhir Basics
...
## Ресурсы
- Оригинальный навык: `healthcare/fhir-basics/SKILL.md`
