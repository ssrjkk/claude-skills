...
category: healthcare
tags: [imaging-data, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Data with PACS. data management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imaging-data`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Imaging Data
...
## Ресурсы
- Оригинальный навык: `healthcare/imaging-data/SKILL.md`
