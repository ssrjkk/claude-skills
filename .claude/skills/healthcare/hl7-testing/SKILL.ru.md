...
version: "1.0"
language: ru
original: hl7-testing
---

# Hl7 Testing

> Testing with HL7 v2. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hl7-testing`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hl7 Testing
...
## Ресурсы
- Оригинальный навык: `healthcare/hl7-testing/SKILL.md`
