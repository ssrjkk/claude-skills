...
version: "1.0"
language: ru
original: pharmacy-setup
---

# Pharmacy Setup

> Setup with Pharmacy Systems. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pharmacy-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Pharmacy Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/pharmacy-setup/SKILL.md`
