...
version: "1.0"
language: ru
original: pms-workflow
---

# Pms Workflow

> Workflow with Practice Management. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pms-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Pms Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/pms-workflow/SKILL.md`
