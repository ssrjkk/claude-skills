...
version: "1.0"
language: ru
original: telehealth-setup
---

# Telehealth Setup

> Setup with Telehealth. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `telehealth-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Telehealth Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/telehealth-setup/SKILL.md`
