...
category: healthcare
tags: [hl7-basics, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hl7-basics
...
> Basics with HL7 v2. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hl7-basics`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hl7 Basics
...
## Ресурсы
- Оригинальный навык: `healthcare/hl7-basics/SKILL.md`
