...
version: "1.0"
language: ru
original: hipaa-testing
---

# Hipaa Testing

> Testing with HIPAA. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hipaa-testing`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hipaa Testing
...
## Ресурсы
- Оригинальный навык: `healthcare/hipaa-testing/SKILL.md`
