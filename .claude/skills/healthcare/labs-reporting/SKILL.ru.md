...
version: "1.0"
language: ru
original: labs-reporting
---

# Labs Reporting

> Reporting with LIS. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `labs-reporting`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Labs Reporting
...
## Ресурсы
- Оригинальный навык: `healthcare/labs-reporting/SKILL.md`
