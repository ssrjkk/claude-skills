...
version: "1.0"
language: ru
original: dicom-tools
---

# Dicom Tools

> Tools with DICOM. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dicom-tools`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Dicom Tools
...
## Ресурсы
- Оригинальный навык: `healthcare/dicom-tools/SKILL.md`
