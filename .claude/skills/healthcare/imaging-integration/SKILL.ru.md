...
category: healthcare
tags: [imaging-integration, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: imaging-integration
---

# Imaging Integration

> Integration with PACS. system integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imaging-integration`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Imaging Integration
...
## Ресурсы
- Оригинальный навык: `healthcare/imaging-integration/SKILL.md`
