...
version: "1.0"
language: ru
original: snomed-testing
---

# Snomed Testing

> Testing with SNOMED CT. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snomed-testing`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Snomed Testing
...
## Ресурсы
- Оригинальный навык: `healthcare/snomed-testing/SKILL.md`
