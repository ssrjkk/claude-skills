...
category: healthcare
tags: [fhir-tools, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fhir-tools
...
> Tools with FHIR. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fhir-tools`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Fhir Tools
...
## Ресурсы
- Оригинальный навык: `healthcare/fhir-tools/SKILL.md`
