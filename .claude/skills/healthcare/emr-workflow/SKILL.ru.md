...
version: "1.0"
language: ru
original: emr-workflow
---

# Emr Workflow

> Workflow with EMR Systems. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `emr-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Emr Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/emr-workflow/SKILL.md`
