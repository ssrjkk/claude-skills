...
version: "1.0"
language: ru
original: telehealth-integration
---

# Telehealth Integration

> Integration with Telehealth. system integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `telehealth-integration`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Telehealth Integration
...
## Ресурсы
- Оригинальный навык: `healthcare/telehealth-integration/SKILL.md`
