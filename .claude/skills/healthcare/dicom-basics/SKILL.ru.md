...
version: "1.0"
language: ru
original: dicom-basics
---

# Dicom Basics

> Basics with DICOM. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dicom-basics`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Dicom Basics
...
## Ресурсы
- Оригинальный навык: `healthcare/dicom-basics/SKILL.md`
