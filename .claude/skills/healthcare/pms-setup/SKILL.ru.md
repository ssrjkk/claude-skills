...
category: healthcare
tags: [pms-setup, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pms-setup
...
> Setup with Practice Management. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pms-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Pms Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/pms-setup/SKILL.md`
