...
version: "1.0"
language: ru
original: labs-workflow
---

# Labs Workflow

> Workflow with LIS. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `labs-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Labs Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/labs-workflow/SKILL.md`
