...
category: healthcare
tags: [imaging-workflow, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: imaging-workflow
---

# Imaging Workflow

> Workflow with PACS. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imaging-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Imaging Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/imaging-workflow/SKILL.md`
