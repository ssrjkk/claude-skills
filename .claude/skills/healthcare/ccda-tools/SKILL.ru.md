...
> Tools with C-CDA. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ccda-tools`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Ccda Tools
...
## Ресурсы
- Оригинальный навык: `healthcare/ccda-tools/SKILL.md`
