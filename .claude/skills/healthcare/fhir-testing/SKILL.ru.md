...
version: "1.0"
language: ru
original: fhir-testing
---

# Fhir Testing

> Testing with FHIR. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fhir-testing`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Fhir Testing
...
## Ресурсы
- Оригинальный навык: `healthcare/fhir-testing/SKILL.md`
