...
version: "1.0"
language: ru
original: snomed-interoperability
---

# Snomed Interoperability

> Interop with SNOMED CT. interoperability.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snomed-interoperability`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Snomed Interoperability
...
## Ресурсы
- Оригинальный навык: `healthcare/snomed-interoperability/SKILL.md`
