...
version: "1.0"
language: ru
original: pms-compliance
---

# Pms Compliance

> Compliance with Practice Management. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pms-compliance`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Pms Compliance
...
## Ресурсы
- Оригинальный навык: `healthcare/pms-compliance/SKILL.md`
