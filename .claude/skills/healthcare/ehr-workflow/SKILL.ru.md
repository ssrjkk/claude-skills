...
version: "1.0"
language: ru
original: ehr-workflow
---

# Ehr Workflow

> Workflow with EHR Systems. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ehr-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Ehr Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/ehr-workflow/SKILL.md`
