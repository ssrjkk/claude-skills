...
version: "1.0"
language: ru
original: hipaa-tools
---

# Hipaa Tools

> Tools with HIPAA. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hipaa-tools`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hipaa Tools
...
## Ресурсы
- Оригинальный навык: `healthcare/hipaa-tools/SKILL.md`
