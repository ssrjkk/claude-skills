...
version: "1.0"
language: ru
original: hipaa-compliance
---

# Hipaa Compliance

> Compliance with HIPAA. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hipaa-compliance`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hipaa Compliance
...
## Ресурсы
- Оригинальный навык: `healthcare/hipaa-compliance/SKILL.md`
