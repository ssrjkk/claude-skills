...
version: "1.0"
language: ru
original: imaging-setup
---

# Imaging Setup

> Setup with PACS. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imaging-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Imaging Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/imaging-setup/SKILL.md`
