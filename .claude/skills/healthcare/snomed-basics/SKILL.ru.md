...
version: "1.0"
language: ru
original: snomed-basics
---

# Snomed Basics

> Basics with SNOMED CT. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `snomed-basics`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Snomed Basics
...
## Ресурсы
- Оригинальный навык: `healthcare/snomed-basics/SKILL.md`
