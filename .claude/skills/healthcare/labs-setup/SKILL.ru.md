...
> Setup with LIS. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `labs-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Labs Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/labs-setup/SKILL.md`
