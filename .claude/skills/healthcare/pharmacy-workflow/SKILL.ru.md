...
version: "1.0"
language: ru
original: pharmacy-workflow
---

# Pharmacy Workflow

> Workflow with Pharmacy Systems. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pharmacy-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Pharmacy Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/pharmacy-workflow/SKILL.md`
