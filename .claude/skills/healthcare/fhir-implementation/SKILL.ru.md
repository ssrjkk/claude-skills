...
version: "1.0"
language: ru
original: fhir-implementation
---

# Fhir Implementation

> Implementation with FHIR. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fhir-implementation`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Fhir Implementation
...
## Ресурсы
- Оригинальный навык: `healthcare/fhir-implementation/SKILL.md`
