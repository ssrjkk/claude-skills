...
version: "1.0"
language: ru
original: dicom-interoperability
---

# Dicom Interoperability

> Interop with DICOM. interoperability.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dicom-interoperability`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Dicom Interoperability
...
## Ресурсы
- Оригинальный навык: `healthcare/dicom-interoperability/SKILL.md`
