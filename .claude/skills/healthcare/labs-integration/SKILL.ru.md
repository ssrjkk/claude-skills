...
version: "1.0"
language: ru
original: labs-integration
---

# Labs Integration

> Integration with LIS. system integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `labs-integration`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Labs Integration
...
## Ресурсы
- Оригинальный навык: `healthcare/labs-integration/SKILL.md`
