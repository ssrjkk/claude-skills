...
category: healthcare
tags: [fhir-compliance, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fhir-compliance
---

# Fhir Compliance

> Compliance with FHIR. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fhir-compliance`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Fhir Compliance
...
## Ресурсы
- Оригинальный навык: `healthcare/fhir-compliance/SKILL.md`
