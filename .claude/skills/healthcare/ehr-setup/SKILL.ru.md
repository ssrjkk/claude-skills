...
category: healthcare
tags: [ehr-setup, healthcare, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ehr-setup
...
> Setup with EHR Systems. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ehr-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Ehr Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/ehr-setup/SKILL.md`
