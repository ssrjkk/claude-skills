...
version: "1.0"
language: ru
original: telehealth-workflow
---

# Telehealth Workflow

> Workflow with Telehealth. clinical workflow.

## Быстрый старт
Этот навык на русском языке. Оригинал: `telehealth-workflow`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Telehealth Workflow
...
## Ресурсы
- Оригинальный навык: `healthcare/telehealth-workflow/SKILL.md`
