...
version: "1.0"
language: ru
original: hipaa-basics
---

# Hipaa Basics

> Basics with HIPAA. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hipaa-basics`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Hipaa Basics
...
## Ресурсы
- Оригинальный навык: `healthcare/hipaa-basics/SKILL.md`
