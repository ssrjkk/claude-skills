...
version: "1.0"
language: ru
original: imaging-compliance
---

# Imaging Compliance

> Compliance with PACS. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imaging-compliance`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Imaging Compliance
...
## Ресурсы
- Оригинальный навык: `healthcare/imaging-compliance/SKILL.md`
