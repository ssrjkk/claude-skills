...
version: "1.0"
language: ru
original: ehr-integration
---

# Ehr Integration

> Integration with EHR Systems. system integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ehr-integration`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Ehr Integration
...
## Ресурсы
- Оригинальный навык: `healthcare/ehr-integration/SKILL.md`
