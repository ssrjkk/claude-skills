...
> Setup with EMR Systems. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `emr-setup`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Emr Setup
...
## Ресурсы
- Оригинальный навык: `healthcare/emr-setup/SKILL.md`
