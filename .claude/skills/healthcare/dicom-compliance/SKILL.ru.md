...
version: "1.0"
language: ru
original: dicom-compliance
---

# Dicom Compliance

> Compliance with DICOM. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dicom-compliance`.

## Когда использовать
- Работа с Здравоохранение
- Выполнение задач, связанных с Dicom Compliance
...
## Ресурсы
- Оригинальный навык: `healthcare/dicom-compliance/SKILL.md`
