...
category: ai
tags: [transformers-quantization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: transformers-quantization
---

# Transformers Quantization

> Quantization with Transformers. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Quantization
...
## Ресурсы
- Оригинальный навык: `ai/transformers-quantization/SKILL.md`
