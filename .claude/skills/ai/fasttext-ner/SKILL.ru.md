...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fasttext-ner`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Fasttext Ner
...
## Ресурсы
- Оригинальный навык: `ai/fasttext-ner/SKILL.md`
