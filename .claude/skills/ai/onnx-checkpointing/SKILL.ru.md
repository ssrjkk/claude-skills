...
category: ai
tags: [onnx-checkpointing, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: onnx-checkpointing
---

# Onnx Checkpointing

> Checkpointing with Onnx. model saving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-checkpointing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Checkpointing
...
## Ресурсы
- Оригинальный навык: `ai/onnx-checkpointing/SKILL.md`
