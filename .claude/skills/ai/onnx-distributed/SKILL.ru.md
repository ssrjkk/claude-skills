...
category: ai
tags: [onnx-distributed, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: onnx-distributed
---

# Onnx Distributed

> Distributed with Onnx. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Distributed
...
## Ресурсы
- Оригинальный навык: `ai/onnx-distributed/SKILL.md`
