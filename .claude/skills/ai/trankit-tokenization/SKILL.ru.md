...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-tokenization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Tokenization
...
## Ресурсы
- Оригинальный навык: `ai/trankit-tokenization/SKILL.md`
