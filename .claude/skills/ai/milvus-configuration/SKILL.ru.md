...
version: "1.0"
language: ru
original: milvus-configuration
---

# Milvus Configuration

> Configuration for Milvus: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: milvus-configuration.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Milvus Configuration
...
## Ресурсы
- ai/milvus-configuration/SKILL.md
