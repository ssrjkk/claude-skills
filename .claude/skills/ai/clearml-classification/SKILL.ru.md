...
version: "1.0"
language: ru
original: clearml-classification
---

# Clearml Classification

> Classification with Clearml. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Classification
...
## Ресурсы
- Оригинальный навык: `ai/clearml-classification/SKILL.md`
