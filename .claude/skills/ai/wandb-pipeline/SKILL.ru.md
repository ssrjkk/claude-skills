...
version: "1.0"
language: ru
original: wandb-pipeline
---

# Wandb Pipeline

> Pipeline with Wandb. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/wandb-pipeline/SKILL.md`
