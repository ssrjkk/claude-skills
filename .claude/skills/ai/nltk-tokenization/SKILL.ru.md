...
version: "1.0"
language: ru
original: nltk-tokenization
---

# Nltk Tokenization

> Tokenization with Nltk. text tokenization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nltk-tokenization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Nltk Tokenization
...
## Ресурсы
- Оригинальный навык: `ai/nltk-tokenization/SKILL.md`
