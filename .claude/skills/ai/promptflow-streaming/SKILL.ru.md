...
version: "1.0"
language: ru
original: promptflow-streaming
---

# Promptflow Streaming

> Streaming with Promptflow. token streaming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Streaming
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-streaming/SKILL.md`
