...
version: "1.0"
language: ru
original: spacy-text-classification
---

# Spacy Text Classification

> Text Classification with Spacy. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/spacy-text-classification/SKILL.md`
