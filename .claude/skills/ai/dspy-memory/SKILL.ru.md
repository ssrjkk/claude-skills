...
version: "1.0"
language: ru
original: dspy-memory
---

# Dspy Memory

> Memory with Dspy. conversation memory.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Memory
...
## Ресурсы
- Оригинальный навык: `ai/dspy-memory/SKILL.md`
