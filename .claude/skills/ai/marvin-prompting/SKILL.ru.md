...
category: ai
tags: [marvin-prompting, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marvin-prompting
---

# Marvin Prompting

> Prompt Engineering with Marvin. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Prompting
...
## Ресурсы
- Оригинальный навык: `ai/marvin-prompting/SKILL.md`
