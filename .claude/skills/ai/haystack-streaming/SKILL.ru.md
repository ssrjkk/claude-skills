...
version: "1.0"
language: ru
original: haystack-streaming
---

# Haystack Streaming

> Streaming with Haystack. token streaming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Streaming
...
## Ресурсы
- Оригинальный навык: `ai/haystack-streaming/SKILL.md`
