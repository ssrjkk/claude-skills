...
category: ai
tags: [vllm-agents, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-agents
---

# Vllm Agents

> Agents with Vllm. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Agents
...
## Ресурсы
- Оригинальный навык: `ai/vllm-agents/SKILL.md`
