...
version: "1.0"
language: ru
original: trl-checkpointing
---

# Trl Checkpointing

> Checkpointing with Trl. model saving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trl-checkpointing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trl Checkpointing
...
## Ресурсы
- Оригинальный навык: `ai/trl-checkpointing/SKILL.md`
