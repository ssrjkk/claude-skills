...
version: "1.0"
language: ru
original: jax-distributed
---

# Jax Distributed

> Distributed with Jax. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jax-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Jax Distributed
...
## Ресурсы
- Оригинальный навык: `ai/jax-distributed/SKILL.md`
