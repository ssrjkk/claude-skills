...
version: "1.0"
language: ru
original: keras-inference
---

# Keras Inference

> Inference with Keras. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `keras-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Keras Inference
...
## Ресурсы
- Оригинальный навык: `ai/keras-inference/SKILL.md`
