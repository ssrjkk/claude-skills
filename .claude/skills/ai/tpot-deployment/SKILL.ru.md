...
version: "1.0"
language: ru
original: tpot-deployment
---

# Tpot Deployment

> Deployment with Tpot. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Deployment
...
## Ресурсы
- Оригинальный навык: `ai/tpot-deployment/SKILL.md`
