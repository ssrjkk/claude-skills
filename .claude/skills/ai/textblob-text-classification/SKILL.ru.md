...
version: "1.0"
language: ru
original: textblob-text-classification
---

# Textblob Text Classification

> Text Classification with Textblob. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/textblob-text-classification/SKILL.md`
