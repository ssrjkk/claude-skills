...
version: "1.0"
language: ru
original: lightgbm-deployment
---

# Lightgbm Deployment

> Deployment with Lightgbm. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Deployment
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-deployment/SKILL.md`
