...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-advanced`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Advanced
...
## Ресурсы
- Оригинальный навык: ai/langchain-advanced/SKILL.md
