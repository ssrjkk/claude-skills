...
version: "1.0"
language: ru
original: outlines-tool-use
---

# Outlines Tool Use

> Tool Use with Outlines. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/outlines-tool-use/SKILL.md`
