...
version: "1.0"
language: ru
original: sentence-transformers-pos-tagging
---

# Sentence Transformers Pos Tagging

> POS Tagging with Sentence Transformers. POS tagging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sentence-transformers-pos-tagging`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Sentence Transformers Pos Tagging
...
## Ресурсы
- Оригинальный навык: `ai/sentence-transformers-pos-tagging/SKILL.md`
