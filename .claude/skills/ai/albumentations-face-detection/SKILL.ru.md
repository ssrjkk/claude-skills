...
category: ai
tags: [albumentations-face-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: albumentations-face-detection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `albumentations-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Albumentations Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/albumentations-face-detection/SKILL.md`
