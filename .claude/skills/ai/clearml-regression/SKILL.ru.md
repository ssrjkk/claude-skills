...
version: "1.0"
language: ru
original: clearml-regression
---

# Clearml Regression

> Regression with Clearml. predicting values.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-regression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Regression
...
## Ресурсы
- Оригинальный навык: `ai/clearml-regression/SKILL.md`
