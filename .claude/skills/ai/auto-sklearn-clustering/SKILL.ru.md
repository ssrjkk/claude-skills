...
version: "1.0"
language: ru
original: auto-sklearn-clustering
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-clustering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Clustering
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-clustering/SKILL.md`
