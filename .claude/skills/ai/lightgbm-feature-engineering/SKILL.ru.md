...
category: ai
tags: [lightgbm-feature-engineering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lightgbm-feature-engineering
---

# Lightgbm Feature Engineering

> Feature Engineering with Lightgbm. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-feature-engineering/SKILL.md`
