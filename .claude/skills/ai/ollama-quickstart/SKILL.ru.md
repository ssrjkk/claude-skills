...
version: "1.0"
language: ru
original: ollama-quickstart
---

# Ollama Quickstart

> Quickstart for Ollama: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ollama-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ollama Quickstart
...
## Ресурсы
- Оригинал: ai/ollama-quickstart/SKILL.md
