...
category: ai
tags: [dspy-fine-tuning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dspy-fine-tuning
---

# Dspy Fine Tuning

> Fine-Tuning with Dspy. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/dspy-fine-tuning/SKILL.md`
