...
version: "1.0"
language: ru
original: keras-transfer-learning
---

# Keras Transfer Learning

> Transfer Learning with Keras. transfer learning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `keras-transfer-learning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Keras Transfer Learning
...
## Ресурсы
- Оригинальный навык: `ai/keras-transfer-learning/SKILL.md`
