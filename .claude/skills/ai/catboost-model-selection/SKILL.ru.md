...
version: "1.0"
language: ru
original: catboost-model-selection
---

# Catboost Model Selection

> Model Selection with Catboost. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/catboost-model-selection/SKILL.md`
