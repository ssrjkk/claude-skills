...
version: "1.0"
language: ru
original: paddlepaddle-quantization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `paddlepaddle-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Paddlepaddle Quantization
...
## Ресурсы
- Оригинальный навык: `ai/paddlepaddle-quantization/SKILL.md`
