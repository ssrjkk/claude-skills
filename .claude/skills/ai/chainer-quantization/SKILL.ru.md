...
version: "1.0"
language: ru
original: chainer-quantization
---

# Chainer Quantization

> Quantization with Chainer. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chainer-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Chainer Quantization
...
## Ресурсы
- Оригинальный навык: `ai/chainer-quantization/SKILL.md`
