...
category: ai
tags: [xgboost-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xgboost-model-selection
---

# Xgboost Model Selection

> Model Selection with Xgboost. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-model-selection/SKILL.md`
