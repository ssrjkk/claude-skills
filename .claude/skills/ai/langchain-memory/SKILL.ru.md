...
> Memory with Langchain. conversation memory.

## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Memory
...
## Ресурсы
- Оригинальный навык: `ai/langchain-memory/SKILL.md`
