...
version: "1.0"
language: ru
original: transformers-training
---

# Transformers Training

> Training with Transformers. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Training
...
## Ресурсы
- Оригинальный навык: `ai/transformers-training/SKILL.md`
