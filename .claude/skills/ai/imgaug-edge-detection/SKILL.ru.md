...
category: ai
tags: [imgaug-edge-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: imgaug-edge-detection
---

# Imgaug Edge Detection

> Edge Detection with Imgaug. edge detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imgaug-edge-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Imgaug Edge Detection
...
## Ресурсы
- Оригинальный навык: `ai/imgaug-edge-detection/SKILL.md`
