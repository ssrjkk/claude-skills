...
version: "1.0"
language: ru
original: yolo-image-classification
---

# Yolo Image Classification

> Image Classification with Yolo. classifying images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/yolo-image-classification/SKILL.md`
