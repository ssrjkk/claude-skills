...
category: ai
tags: [opencv-optical-flow, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opencv-optical-flow
---

# Opencv Optical Flow

> Optical Flow with Opencv. motion detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-optical-flow`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Optical Flow
...
## Ресурсы
- Оригинальный навык: `ai/opencv-optical-flow/SKILL.md`
