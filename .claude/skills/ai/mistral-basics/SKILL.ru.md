...
category: ai
tags: [mistral-basics, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mistral-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mistral-basics`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mistral Basics
...
## Ресурсы
- Оригинальный навык: ai/mistral-basics/SKILL.md
