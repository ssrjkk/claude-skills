...
category: ai
tags: [marvin-agents, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marvin-agents
---

# Marvin Agents

> Agents with Marvin. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Agents
...
## Ресурсы
- Оригинальный навык: `ai/marvin-agents/SKILL.md`
