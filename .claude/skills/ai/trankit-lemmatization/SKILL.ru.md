...
category: ai
tags: [trankit-lemmatization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trankit-lemmatization
---

# Trankit Lemmatization

> Lemmatization with Trankit. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/trankit-lemmatization/SKILL.md`
