...
category: ai
tags: [cohere-basics, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cohere-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-basics`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Basics
...
## Ресурсы
- Оригинальный навык: ai/cohere-basics/SKILL.md
