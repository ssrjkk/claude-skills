...
version: "1.0"
language: ru
original: openvino-examples
---

# Openvino Examples

> Examples for Openvino: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `openvino-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openvino Examples
...
## Ресурсы
- Оригинал: ai/openvino-examples/SKILL.md
