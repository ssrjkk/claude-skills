...
version: "1.0"
language: ru
original: opencv-image-augmentation
---

# Opencv Image Augmentation

> Image Augmentation with Opencv. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/opencv-image-augmentation/SKILL.md`
