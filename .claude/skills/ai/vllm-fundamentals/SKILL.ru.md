...
category: ai
tags: [vllm-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-fundamentals
---

# Vllm Fundamentals

> Fundamentals for Vllm: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vllm-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Fundamentals
...
## Ресурсы
- Оригинал: ai/vllm-fundamentals/SKILL.md
