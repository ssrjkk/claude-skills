...
version: "1.0"
language: ru
original: prompt-compression
---

# Prompt Compression

> Reduces prompt token usage through compression techniques, summarization, and selective context inclusion while maintaining output quality. Use for cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prompt-compression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Prompt Compression
...
## Ресурсы
- Оригинальный навык: `ai/prompt-compression/SKILL.md`
