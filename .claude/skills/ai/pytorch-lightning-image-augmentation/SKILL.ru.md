...
version: "1.0"
language: ru
original: pytorch-lightning-image-augmentation
---

# Pytorch Lightning Image Augmentation

> Image Augmentation with Pytorch Lightning. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-lightning-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Lightning Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-lightning-image-augmentation/SKILL.md`
