...
version: "1.0"
language: ru
original: dspy-prompting
---

# Dspy Prompting

> Prompt Engineering with Dspy. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Prompting
...
## Ресурсы
- Оригинальный навык: `ai/dspy-prompting/SKILL.md`
