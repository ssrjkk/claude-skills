...
category: ai
tags: [promptflow-embeddings, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: promptflow-embeddings
---

# Promptflow Embeddings

> Embeddings with Promptflow. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-embeddings/SKILL.md`
