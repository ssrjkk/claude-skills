...
category: ai
tags: [clearml-pipeline, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clearml-pipeline
---

# Clearml Pipeline

> Pipeline with Clearml. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/clearml-pipeline/SKILL.md`
