...
category: ai
tags: [wandb-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wandb-classification
---

# Wandb Classification

> Classification with Wandb. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Classification
...
## Ресурсы
- Оригинальный навык: `ai/wandb-classification/SKILL.md`
