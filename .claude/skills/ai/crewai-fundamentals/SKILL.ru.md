...
category: ai
tags: [crewai-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crewai-fundamentals
---

# Crewai Fundamentals

> Fundamentals for Crewai: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `crewai-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Crewai Fundamentals
...
## Ресурсы
- Оригинал: ai/crewai-fundamentals/SKILL.md
