...
## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Streaming
...
## Ресурсы
- Оригинальный навык: `ai/guidance-streaming/SKILL.md`
