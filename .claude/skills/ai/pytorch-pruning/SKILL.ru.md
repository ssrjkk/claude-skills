...
version: "1.0"
language: ru
original: pytorch-pruning
---

# Pytorch Pruning

> Pruning with Pytorch. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Pruning
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-pruning/SKILL.md`
