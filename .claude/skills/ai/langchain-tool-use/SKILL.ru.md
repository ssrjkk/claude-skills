...
category: ai
tags: [langchain-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: langchain-tool-use
---

# Langchain Tool Use

> Tool Use with Langchain. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/langchain-tool-use/SKILL.md`
