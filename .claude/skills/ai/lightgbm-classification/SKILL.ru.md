...
version: "1.0"
language: ru
original: lightgbm-classification
---

# Lightgbm Classification

> Classification with Lightgbm. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Classification
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-classification/SKILL.md`
