...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-debugging`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Debugging
...
## Ресурсы
- Оригинальный навык: ai/cohere-debugging/SKILL.md
