...
> Model Context Protocol server implementation in Python/TypeScript

## Быстрый старт
Этот навык на русском языке. Оригинал: `mcp-server`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mcp Server
...
## Ресурсы
- Оригинальный навык: `ai/mcp-server/SKILL.md`
