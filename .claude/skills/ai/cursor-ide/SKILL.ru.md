...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cursor-ide`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cursor Ide
...
## Ресурсы
- Оригинальный навык: `ai/cursor-ide/SKILL.md`
