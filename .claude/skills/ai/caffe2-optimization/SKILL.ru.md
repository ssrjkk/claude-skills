...
version: "1.0"
language: ru
original: caffe2-optimization
---

# Caffe2 Optimization

> Optimization with Caffe2. model optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Optimization
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-optimization/SKILL.md`
