...
version: "1.0"
language: ru
original: xgboost-hyperparameter-tuning
---

# Xgboost Hyperparameter Tuning

> Hyperparameter Tuning with Xgboost. optimizing params.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-hyperparameter-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Hyperparameter Tuning
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-hyperparameter-tuning/SKILL.md`
