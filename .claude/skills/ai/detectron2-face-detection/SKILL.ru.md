...
category: ai
tags: [detectron2-face-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: detectron2-face-detection
---

# Detectron2 Face Detection

> Face Detection with Detectron2. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detectron2-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Detectron2 Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/detectron2-face-detection/SKILL.md`
