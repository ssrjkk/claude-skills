...
category: ai
tags: [auto-sklearn-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: auto-sklearn-classification
---

# Auto Sklearn Classification

> Classification with Auto Sklearn. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Classification
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-classification/SKILL.md`
