...
category: ai
tags: [transformers-optimization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: transformers-optimization
---

# Transformers Optimization

> Optimization with Transformers. model optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Optimization
...
## Ресурсы
- Оригинальный навык: `ai/transformers-optimization/SKILL.md`
