...
version: "1.0"
language: ru
original: vllm-quickstart
---

# Vllm Quickstart

> Quickstart for Vllm: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vllm-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Quickstart
...
## Ресурсы
- Оригинал: ai/vllm-quickstart/SKILL.md
