...
version: "1.0"
language: ru
original: catboost-pipeline
---

# Catboost Pipeline

> Pipeline with Catboost. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/catboost-pipeline/SKILL.md`
