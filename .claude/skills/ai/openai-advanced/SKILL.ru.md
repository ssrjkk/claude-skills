...
## Быстрый старт
Этот навык на русском языке. Оригинал: `openai-advanced`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openai Advanced
...
## Ресурсы
- Оригинальный навык: ai/openai-advanced/SKILL.md
