...
> Pipeline with Xgboost. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-pipeline/SKILL.md`
