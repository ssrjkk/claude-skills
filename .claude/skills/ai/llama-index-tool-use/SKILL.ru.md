...
category: ai
tags: [llama-index-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: llama-index-tool-use
---

# Llama Index Tool Use

> Tool Use with Llama Index. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-tool-use/SKILL.md`
