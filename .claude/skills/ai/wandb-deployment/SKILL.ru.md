...
version: "1.0"
language: ru
original: wandb-deployment
---

# Wandb Deployment

> Deployment with Wandb. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Deployment
...
## Ресурсы
- Оригинальный навык: `ai/wandb-deployment/SKILL.md`
