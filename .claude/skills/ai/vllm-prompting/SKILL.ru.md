...
version: "1.0"
language: ru
original: vllm-prompting
---

# Vllm Prompting

> Prompt Engineering with Vllm. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Prompting
...
## Ресурсы
- Оригинальный навык: `ai/vllm-prompting/SKILL.md`
