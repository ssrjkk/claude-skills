...
version: "1.0"
language: ru
original: wandb-regression
---

# Wandb Regression

> Regression with Wandb. predicting values.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-regression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Regression
...
## Ресурсы
- Оригинальный навык: `ai/wandb-regression/SKILL.md`
