...
version: "1.0"
language: ru
original: kornia-image-filtering
---

# Kornia Image Filtering

> Image Filtering with Kornia. image filters.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-image-filtering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Image Filtering
...
## Ресурсы
- Оригинальный навык: `ai/kornia-image-filtering/SKILL.md`
