...
version: "1.0"
language: ru
original: trl-training
---

# Trl Training

> Training with Trl. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trl-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trl Training
...
## Ресурсы
- Оригинальный навык: `ai/trl-training/SKILL.md`
