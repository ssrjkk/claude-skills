...
version: "1.0"
language: ru
original: claude-code-workflows
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-code-workflows`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Code Workflows
...
## Ресурсы
- Оригинальный навык: `ai/claude-code-workflows/SKILL.md`
