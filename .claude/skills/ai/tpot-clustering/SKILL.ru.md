...
category: ai
tags: [tpot-clustering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tpot-clustering
---

# Tpot Clustering

> Clustering with Tpot. grouping data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-clustering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Clustering
...
## Ресурсы
- Оригинальный навык: `ai/tpot-clustering/SKILL.md`
