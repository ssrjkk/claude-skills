...
version: "1.0"
language: ru
original: scikit-image-image-augmentation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-image-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Image Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/scikit-image-image-augmentation/SKILL.md`
