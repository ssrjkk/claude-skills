...
category: ai
tags: [guidance-evaluation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: guidance-evaluation
---

# Guidance Evaluation

> Evaluation with Guidance. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/guidance-evaluation/SKILL.md`
