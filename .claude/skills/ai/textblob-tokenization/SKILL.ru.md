...
version: "1.0"
language: ru
original: textblob-tokenization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-tokenization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Tokenization
...
## Ресурсы
- Оригинальный навык: `ai/textblob-tokenization/SKILL.md`
