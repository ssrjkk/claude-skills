...
category: ai
tags: [vllm-fine-tuning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-fine-tuning
---

# Vllm Fine Tuning

> Fine-Tuning with Vllm. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/vllm-fine-tuning/SKILL.md`
