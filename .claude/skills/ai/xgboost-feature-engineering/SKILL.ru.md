...
category: ai
tags: [xgboost-feature-engineering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xgboost-feature-engineering
---

# Xgboost Feature Engineering

> Feature Engineering with Xgboost. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-feature-engineering/SKILL.md`
