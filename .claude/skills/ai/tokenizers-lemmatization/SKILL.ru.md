...
version: "1.0"
language: ru
original: tokenizers-lemmatization
---

# Tokenizers Lemmatization

> Lemmatization with Tokenizers. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tokenizers-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tokenizers Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/tokenizers-lemmatization/SKILL.md`
