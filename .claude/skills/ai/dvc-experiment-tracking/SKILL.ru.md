...
version: "1.0"
language: ru
original: dvc-experiment-tracking
---

# Dvc Experiment Tracking

> Experiment Tracking with Dvc. tracking experiments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dvc-experiment-tracking`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dvc Experiment Tracking
...
## Ресурсы
- Оригинальный навык: `ai/dvc-experiment-tracking/SKILL.md`
