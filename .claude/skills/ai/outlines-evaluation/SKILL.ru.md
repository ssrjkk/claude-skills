...
category: ai
tags: [outlines-evaluation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: outlines-evaluation
---

# Outlines Evaluation

> Evaluation with Outlines. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/outlines-evaluation/SKILL.md`
