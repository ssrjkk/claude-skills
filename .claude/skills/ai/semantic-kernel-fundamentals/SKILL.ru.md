...
version: "1.0"
language: ru
original: semantic-kernel-fundamentals
---

# Semantic Kernel Fundamentals

> Fundamentals for Semantic-Kernel: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `semantic-kernel-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Fundamentals
...
## Ресурсы
- Оригинал: ai/semantic-kernel-fundamentals/SKILL.md
