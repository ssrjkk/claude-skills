...
version: "1.0"
language: ru
original: wandb-experiment-tracking
---

# Wandb Experiment Tracking

> Experiment Tracking with Wandb. tracking experiments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-experiment-tracking`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Experiment Tracking
...
## Ресурсы
- Оригинальный навык: `ai/wandb-experiment-tracking/SKILL.md`
