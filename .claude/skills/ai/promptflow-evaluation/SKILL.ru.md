...
version: "1.0"
language: ru
original: promptflow-evaluation
---

# Promptflow Evaluation

> Evaluation with Promptflow. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-evaluation/SKILL.md`
