...
version: "1.0"
language: ru
original: weaviate-automation
---

# Weaviate Automation

> Automation for Weaviate: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: weaviate-automation.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Weaviate Automation
...
## Ресурсы
- ai/weaviate-automation/SKILL.md
