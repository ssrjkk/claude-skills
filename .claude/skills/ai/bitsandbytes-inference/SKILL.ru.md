...
version: "1.0"
language: ru
original: bitsandbytes-inference
---

# Bitsandbytes Inference

> Inference with Bitsandbytes. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitsandbytes-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Bitsandbytes Inference
...
## Ресурсы
- Оригинальный навык: `ai/bitsandbytes-inference/SKILL.md`
