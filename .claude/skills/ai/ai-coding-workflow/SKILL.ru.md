...
category: ai
tags: [ai-coding-workflow, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ai-coding-workflow
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ai-coding-workflow`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ai Coding Workflow
...
## Ресурсы
- Оригинальный навык: `ai/ai-coding-workflow/SKILL.md`
