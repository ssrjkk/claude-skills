...
version: "1.0"
language: ru
original: promptflow-chaining
---

# Promptflow Chaining

> Chaining with Promptflow. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Chaining
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-chaining/SKILL.md`
