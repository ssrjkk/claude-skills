...
category: ai
tags: [claude-optimization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: claude-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Optimization
...
## Ресурсы
- Оригинальный навык: ai/claude-optimization/SKILL.md
