...
category: ai
tags: [haystack-agents, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haystack-agents
---

# Haystack Agents

> Agents with Haystack. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Agents
...
## Ресурсы
- Оригинальный навык: `ai/haystack-agents/SKILL.md`
