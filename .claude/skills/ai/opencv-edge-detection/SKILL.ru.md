...
version: "1.0"
language: ru
original: opencv-edge-detection
---

# Opencv Edge Detection

> Edge Detection with Opencv. edge detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-edge-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Edge Detection
...
## Ресурсы
- Оригинальный навык: `ai/opencv-edge-detection/SKILL.md`
