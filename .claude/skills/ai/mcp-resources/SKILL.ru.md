...
category: ai
tags: [mcp-resources, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mcp-resources
---

# Mcp Resources

> MCP resource providers and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: `mcp-resources`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mcp Resources
...
## Ресурсы
- Оригинальный навык: `ai/mcp-resources/SKILL.md`
