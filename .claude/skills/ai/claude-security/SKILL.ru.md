...
category: ai
tags: [claude-security, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: claude-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Security
...
## Ресурсы
- Оригинальный навык: ai/claude-security/SKILL.md
