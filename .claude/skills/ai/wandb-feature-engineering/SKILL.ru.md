...
version: "1.0"
language: ru
original: wandb-feature-engineering
---

# Wandb Feature Engineering

> Feature Engineering with Wandb. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wandb-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Wandb Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/wandb-feature-engineering/SKILL.md`
