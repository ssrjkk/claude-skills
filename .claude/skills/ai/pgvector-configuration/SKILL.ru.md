...
version: "1.0"
language: ru
original: pgvector-configuration
---

# Pgvector Configuration

> Configuration for Pgvector: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: pgvector-configuration.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pgvector Configuration
...
## Ресурсы
- ai/pgvector-configuration/SKILL.md
