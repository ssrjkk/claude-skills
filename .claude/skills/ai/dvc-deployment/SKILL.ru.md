...
version: "1.0"
language: ru
original: dvc-deployment
---

# Dvc Deployment

> Deployment with Dvc. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dvc-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dvc Deployment
...
## Ресурсы
- Оригинальный навык: `ai/dvc-deployment/SKILL.md`
