...
version: "1.0"
language: ru
original: spacy-pos-tagging
---

# Spacy Pos Tagging

> POS Tagging with Spacy. POS tagging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-pos-tagging`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Pos Tagging
...
## Ресурсы
- Оригинальный навык: `ai/spacy-pos-tagging/SKILL.md`
