...
version: "1.0"
language: ru
original: vllm-examples
---

# Vllm Examples

> Examples for Vllm: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vllm-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Examples
...
## Ресурсы
- Оригинал: ai/vllm-examples/SKILL.md
