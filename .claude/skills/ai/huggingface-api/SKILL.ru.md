...
category: ai
tags: [huggingface-api, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `huggingface-api`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Huggingface Api
...
## Ресурсы
- Оригинальный навык: ai/huggingface-api/SKILL.md
