...
version: "1.0"
language: ru
original: flaml-classification
---

# Flaml Classification

> Classification with Flaml. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flaml-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flaml Classification
...
## Ресурсы
- Оригинальный навык: `ai/flaml-classification/SKILL.md`
