...
version: "1.0"
language: ru
original: onnx-pruning
---

# Onnx Pruning

> Pruning with Onnx. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Pruning
...
## Ресурсы
- Оригинальный навык: `ai/onnx-pruning/SKILL.md`
