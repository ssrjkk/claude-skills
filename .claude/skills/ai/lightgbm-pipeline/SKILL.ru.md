...
> Pipeline with Lightgbm. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-pipeline/SKILL.md`
