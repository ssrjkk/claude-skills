...
version: "1.0"
language: ru
original: scikit-image-object-detection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-image-object-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Image Object Detection
...
## Ресурсы
- Оригинальный навык: `ai/scikit-image-object-detection/SKILL.md`
