...
version: "1.0"
language: ru
original: pillow-optical-flow
---

# Pillow Optical Flow

> Optical Flow with Pillow. motion detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pillow-optical-flow`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pillow Optical Flow
...
## Ресурсы
- Оригинальный навык: `ai/pillow-optical-flow/SKILL.md`
