...
version: "1.0"
language: ru
original: onnx-guides
---

# Onnx Guides

> Guides for Onnx: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `onnx-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Guides
...
## Ресурсы
- Оригинал: ai/onnx-guides/SKILL.md
