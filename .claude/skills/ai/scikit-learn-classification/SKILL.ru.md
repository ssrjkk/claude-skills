...
version: "1.0"
language: ru
original: scikit-learn-classification
---

# Scikit Learn Classification

> Classification with Scikit Learn. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-learn-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Learn Classification
...
## Ресурсы
- Оригинальный навык: `ai/scikit-learn-classification/SKILL.md`
