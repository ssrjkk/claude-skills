...
category: ai
tags: [rag-advanced, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rag-advanced
---

# Rag Advanced

> Advanced RAG patterns (HyDE, multi-hop, agentic RAG)

## Быстрый старт
Этот навык на русском языке. Оригинал: `rag-advanced`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Rag Advanced
...
## Ресурсы
- Оригинальный навык: `ai/rag-advanced/SKILL.md`
