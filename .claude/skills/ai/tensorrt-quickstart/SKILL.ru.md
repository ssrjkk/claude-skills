...
category: ai
tags: [tensorrt-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tensorrt-quickstart
---

# Tensorrt Quickstart

> Quickstart for Tensorrt: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tensorrt-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorrt Quickstart
...
## Ресурсы
- Оригинал: ai/tensorrt-quickstart/SKILL.md
