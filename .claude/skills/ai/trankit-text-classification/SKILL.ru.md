...
category: ai
tags: [trankit-text-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trankit-text-classification
---

# Trankit Text Classification

> Text Classification with Trankit. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/trankit-text-classification/SKILL.md`
