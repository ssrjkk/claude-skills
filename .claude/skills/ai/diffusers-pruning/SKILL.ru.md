...
category: ai
tags: [diffusers-pruning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: diffusers-pruning
---

# Diffusers Pruning

> Pruning with Diffusers. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `diffusers-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Diffusers Pruning
...
## Ресурсы
- Оригинальный навык: `ai/diffusers-pruning/SKILL.md`
