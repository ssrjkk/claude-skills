...
version: "1.0"
language: ru
original: pytorch-lightning-image-classification
---

# Pytorch Lightning Image Classification

> Image Classification with Pytorch Lightning. classifying images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-lightning-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Lightning Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-lightning-image-classification/SKILL.md`
