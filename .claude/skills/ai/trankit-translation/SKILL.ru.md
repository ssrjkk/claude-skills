...
category: ai
tags: [trankit-translation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trankit-translation
---

# Trankit Translation

> Translation with Trankit. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Translation
...
## Ресурсы
- Оригинальный навык: `ai/trankit-translation/SKILL.md`
