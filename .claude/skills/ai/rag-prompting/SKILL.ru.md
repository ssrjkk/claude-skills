...
category: ai
tags: [rag-prompting, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rag-prompting
---

# Rag Prompting

> Designs prompts optimized for Retrieval-Augmented Generation systems, including context integration, citation handling, and hallucination reduction. Use for RAG applications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rag-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Rag Prompting
...
## Ресурсы
- Оригинальный навык: `ai/rag-prompting/SKILL.md`
