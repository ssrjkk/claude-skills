...
> Inference with Onnx. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Inference
...
## Ресурсы
- Оригинальный навык: `ai/onnx-inference/SKILL.md`
