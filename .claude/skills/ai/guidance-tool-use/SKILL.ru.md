...
category: ai
tags: [guidance-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: guidance-tool-use
---

# Guidance Tool Use

> Tool Use with Guidance. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/guidance-tool-use/SKILL.md`
