...
category: ai
tags: [haystack-rag, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haystack-rag
---

# Haystack Rag

> RAG with Haystack. building RAG systems.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-rag`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Rag
...
## Ресурсы
- Оригинальный навык: `ai/haystack-rag/SKILL.md`
