...
version: "1.0"
language: ru
original: semantic-kernel-rag
---

# Semantic Kernel Rag

> RAG with Semantic Kernel. building RAG systems.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-rag`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Rag
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-rag/SKILL.md`
