...
category: ai
tags: [openvino-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openvino-guides
---

# Openvino Guides

> Guides for Openvino: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `openvino-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openvino Guides
...
## Ресурсы
- Оригинал: ai/openvino-guides/SKILL.md
