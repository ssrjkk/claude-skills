...
category: ai
tags: [kornia-face-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kornia-face-detection
---

# Kornia Face Detection

> Face Detection with Kornia. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/kornia-face-detection/SKILL.md`
