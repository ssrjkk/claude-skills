...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-rag`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Rag
...
## Ресурсы
- Оригинальный навык: `ai/langchain-rag/SKILL.md`
