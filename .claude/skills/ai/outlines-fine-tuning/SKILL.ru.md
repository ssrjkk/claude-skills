...
version: "1.0"
language: ru
original: outlines-fine-tuning
---

# Outlines Fine Tuning

> Fine-Tuning with Outlines. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/outlines-fine-tuning/SKILL.md`
