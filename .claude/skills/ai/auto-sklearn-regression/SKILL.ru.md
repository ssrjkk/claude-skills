...
version: "1.0"
language: ru
original: auto-sklearn-regression
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-regression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Regression
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-regression/SKILL.md`
