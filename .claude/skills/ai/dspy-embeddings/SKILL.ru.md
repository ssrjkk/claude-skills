...
version: "1.0"
language: ru
original: dspy-embeddings
---

# Dspy Embeddings

> Embeddings with Dspy. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/dspy-embeddings/SKILL.md`
