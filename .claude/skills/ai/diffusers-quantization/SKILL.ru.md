...
category: ai
tags: [diffusers-quantization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: diffusers-quantization
---

# Diffusers Quantization

> Quantization with Diffusers. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `diffusers-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Diffusers Quantization
...
## Ресурсы
- Оригинальный навык: `ai/diffusers-quantization/SKILL.md`
