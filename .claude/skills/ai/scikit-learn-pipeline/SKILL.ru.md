...
> Pipeline with Scikit Learn. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-learn-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Learn Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/scikit-learn-pipeline/SKILL.md`
