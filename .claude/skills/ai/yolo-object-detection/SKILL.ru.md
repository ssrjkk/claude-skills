...
> Object Detection with Yolo. detecting objects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-object-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Object Detection
...
## Ресурсы
- Оригинальный навык: `ai/yolo-object-detection/SKILL.md`
