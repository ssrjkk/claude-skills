...
category: ai
tags: [spacy-sentiment, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spacy-sentiment
---

# Spacy Sentiment

> Sentiment Analysis with Spacy. sentiment detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-sentiment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Sentiment
...
## Ресурсы
- Оригинальный навык: `ai/spacy-sentiment/SKILL.md`
