...
version: "1.0"
language: ru
original: tvm-inference
---

# Tvm Inference

> Inference with Tvm. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tvm-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tvm Inference
...
## Ресурсы
- Оригинальный навык: `ai/tvm-inference/SKILL.md`
