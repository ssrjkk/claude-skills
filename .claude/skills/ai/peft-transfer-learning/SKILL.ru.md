...
version: "1.0"
language: ru
original: peft-transfer-learning
---

# Peft Transfer Learning

> Transfer Learning with Peft. transfer learning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `peft-transfer-learning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Peft Transfer Learning
...
## Ресурсы
- Оригинальный навык: `ai/peft-transfer-learning/SKILL.md`
