...
version: "1.0"
language: ru
original: trl-optimization
---

# Trl Optimization

> Optimization with Trl. model optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trl-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trl Optimization
...
## Ресурсы
- Оригинальный навык: `ai/trl-optimization/SKILL.md`
