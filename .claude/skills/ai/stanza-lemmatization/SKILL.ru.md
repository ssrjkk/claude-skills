...
category: ai
tags: [stanza-lemmatization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stanza-lemmatization
---

# Stanza Lemmatization

> Lemmatization with Stanza. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/stanza-lemmatization/SKILL.md`
