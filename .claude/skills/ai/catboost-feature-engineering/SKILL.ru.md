...
version: "1.0"
language: ru
original: catboost-feature-engineering
---

# Catboost Feature Engineering

> Feature Engineering with Catboost. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/catboost-feature-engineering/SKILL.md`
