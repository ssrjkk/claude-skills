...
version: "1.0"
language: ru
original: semantic-kernel-prompting
---

# Semantic Kernel Prompting

> Prompt Engineering with Semantic Kernel. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Prompting
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-prompting/SKILL.md`
