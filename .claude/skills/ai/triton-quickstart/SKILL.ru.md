...
category: ai
tags: [triton-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: triton-quickstart
---

# Triton Quickstart

> Quickstart for Triton: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `triton-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Triton Quickstart
...
## Ресурсы
- Оригинал: ai/triton-quickstart/SKILL.md
