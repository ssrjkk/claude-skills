...
category: ai
tags: [huggingface-setup, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: huggingface-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `huggingface-setup`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Huggingface Setup
...
## Ресурсы
- Оригинальный навык: ai/huggingface-setup/SKILL.md
