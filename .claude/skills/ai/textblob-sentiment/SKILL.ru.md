...
version: "1.0"
language: ru
original: textblob-sentiment
---

# Textblob Sentiment

> Sentiment Analysis with Textblob. sentiment detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-sentiment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Sentiment
...
## Ресурсы
- Оригинальный навык: `ai/textblob-sentiment/SKILL.md`
