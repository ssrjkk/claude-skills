...
version: "1.0"
language: ru
original: peft-training
---

# Peft Training

> Training with Peft. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `peft-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Peft Training
...
## Ресурсы
- Оригинальный навык: `ai/peft-training/SKILL.md`
