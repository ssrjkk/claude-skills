...
version: "1.0"
language: ru
original: langsmith-automation
---

# Langsmith Automation

> Automation for Langsmith: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: langsmith-automation.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langsmith Automation
...
## Ресурсы
- ai/langsmith-automation/SKILL.md
