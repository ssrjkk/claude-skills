...
version: "1.0"
language: ru
original: clearml-feature-engineering
---

# Clearml Feature Engineering

> Feature Engineering with Clearml. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/clearml-feature-engineering/SKILL.md`
