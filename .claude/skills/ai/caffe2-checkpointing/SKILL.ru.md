...
version: "1.0"
language: ru
original: caffe2-checkpointing
---

# Caffe2 Checkpointing

> Checkpointing with Caffe2. model saving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-checkpointing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Checkpointing
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-checkpointing/SKILL.md`
