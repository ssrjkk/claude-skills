...
category: ai
tags: [promptflow-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: promptflow-tool-use
---

# Promptflow Tool Use

> Tool Use with Promptflow. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-tool-use/SKILL.md`
