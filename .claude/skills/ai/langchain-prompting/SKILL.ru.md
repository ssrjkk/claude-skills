...
category: ai
tags: [langchain-prompting, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: langchain-prompting
---

# Langchain Prompting

> Prompt Engineering with Langchain. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Prompting
...
## Ресурсы
- Оригинальный навык: `ai/langchain-prompting/SKILL.md`
