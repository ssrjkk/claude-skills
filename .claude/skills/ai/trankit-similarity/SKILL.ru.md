...
category: ai
tags: [trankit-similarity, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trankit-similarity
---

# Trankit Similarity

> Similarity with Trankit. text similarity.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-similarity`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Similarity
...
## Ресурсы
- Оригинальный навык: `ai/trankit-similarity/SKILL.md`
