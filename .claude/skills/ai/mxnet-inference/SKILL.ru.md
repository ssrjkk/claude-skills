...
category: ai
tags: [mxnet-inference, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Inference with Mxnet. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mxnet-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mxnet Inference
...
## Ресурсы
- Оригинальный навык: `ai/mxnet-inference/SKILL.md`
