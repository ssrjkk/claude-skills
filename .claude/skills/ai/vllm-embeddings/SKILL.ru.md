...
version: "1.0"
language: ru
original: vllm-embeddings
---

# Vllm Embeddings

> Embeddings with Vllm. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/vllm-embeddings/SKILL.md`
