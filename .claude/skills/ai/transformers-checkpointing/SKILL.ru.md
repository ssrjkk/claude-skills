...
version: "1.0"
language: ru
original: transformers-checkpointing
---

# Transformers Checkpointing

> Checkpointing with Transformers. model saving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-checkpointing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Checkpointing
...
## Ресурсы
- Оригинальный навык: `ai/transformers-checkpointing/SKILL.md`
