...
## Быстрый старт
Этот навык на русском языке. Оригинал: `openai-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openai Security
...
## Ресурсы
- Оригинальный навык: ai/openai-security/SKILL.md
