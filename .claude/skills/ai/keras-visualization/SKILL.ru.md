...
version: "1.0"
language: ru
original: keras-visualization
---

# Keras Visualization

> Visualization with Keras. model viz.

## Быстрый старт
Этот навык на русском языке. Оригинал: `keras-visualization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Keras Visualization
...
## Ресурсы
- Оригинальный навык: `ai/keras-visualization/SKILL.md`
