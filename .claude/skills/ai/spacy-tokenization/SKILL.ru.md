...
version: "1.0"
language: ru
original: spacy-tokenization
---

# Spacy Tokenization

> Tokenization with Spacy. text tokenization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-tokenization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Tokenization
...
## Ресурсы
- Оригинальный навык: `ai/spacy-tokenization/SKILL.md`
