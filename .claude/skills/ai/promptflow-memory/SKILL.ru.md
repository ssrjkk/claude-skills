...
## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Memory
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-memory/SKILL.md`
