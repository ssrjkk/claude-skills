...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Security
...
## Ресурсы
- Оригинальный навык: ai/langchain-security/SKILL.md
