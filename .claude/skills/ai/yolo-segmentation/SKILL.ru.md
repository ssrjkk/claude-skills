...
> Segmentation with Yolo. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/yolo-segmentation/SKILL.md`
