...
category: ai
tags: [detectron2-image-augmentation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: detectron2-image-augmentation
---

# Detectron2 Image Augmentation

> Image Augmentation with Detectron2. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detectron2-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Detectron2 Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/detectron2-image-augmentation/SKILL.md`
