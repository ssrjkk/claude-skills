...
version: "1.0"
language: ru
original: gensim-text-classification
---

# Gensim Text Classification

> Text Classification with Gensim. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gensim-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Gensim Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/gensim-text-classification/SKILL.md`
