...
version: "1.0"
language: ru
original: langgraph-fundamentals
---

# Langgraph Fundamentals

> Fundamentals for Langgraph: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `langgraph-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langgraph Fundamentals
...
## Ресурсы
- Оригинал: ai/langgraph-fundamentals/SKILL.md
