...
version: "1.0"
language: ru
original: ragas-getting-started
---

# Ragas Getting Started

> Getting Started for Ragas: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: ragas-getting-started.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ragas Getting Started
...
## Ресурсы
- ai/ragas-getting-started/SKILL.md
