...
category: ai
tags: [trankit-dependency-parsing, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trankit-dependency-parsing
---

# Trankit Dependency Parsing

> Dependency Parsing with Trankit. syntax analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-dependency-parsing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Dependency Parsing
...
## Ресурсы
- Оригинальный навык: `ai/trankit-dependency-parsing/SKILL.md`
