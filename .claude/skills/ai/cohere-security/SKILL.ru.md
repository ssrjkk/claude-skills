...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Security
...
## Ресурсы
- Оригинальный навык: ai/cohere-security/SKILL.md
