...
version: "1.0"
language: ru
original: accelerate-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `accelerate-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Accelerate Optimization
...
## Ресурсы
- Оригинальный навык: `ai/accelerate-optimization/SKILL.md`
