...
category: ai
tags: [system-prompt-design, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: system-prompt-design
---

# System Prompt Design

> Designs effective system prompts for LLM agents, chatbots, and assistants with role definition, constraints, and behavioral guidelines. Use for production AI systems.

## Быстрый старт
Этот навык на русском языке. Оригинал: `system-prompt-design`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с System Prompt Design
...
## Ресурсы
- Оригинальный навык: `ai/system-prompt-design/SKILL.md`
