...
version: "1.0"
language: ru
original: langgraph-multi-agent
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langgraph-multi-agent`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langgraph Multi Agent
...
## Ресурсы
- Оригинальный навык: `ai/langgraph-multi-agent/SKILL.md`
