...
version: "1.0"
language: ru
original: lightgbm-clustering
---

# Lightgbm Clustering

> Clustering with Lightgbm. grouping data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-clustering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Clustering
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-clustering/SKILL.md`
