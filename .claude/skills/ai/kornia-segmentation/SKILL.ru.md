...
version: "1.0"
language: ru
original: kornia-segmentation
---

# Kornia Segmentation

> Segmentation with Kornia. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/kornia-segmentation/SKILL.md`
