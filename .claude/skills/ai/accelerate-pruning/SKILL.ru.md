...
category: ai
tags: [accelerate-pruning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: accelerate-pruning
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `accelerate-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Accelerate Pruning
...
## Ресурсы
- Оригинальный навык: `ai/accelerate-pruning/SKILL.md`
