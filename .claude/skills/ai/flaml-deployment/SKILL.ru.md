...
version: "1.0"
language: ru
original: flaml-deployment
---

# Flaml Deployment

> Deployment with Flaml. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flaml-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flaml Deployment
...
## Ресурсы
- Оригинальный навык: `ai/flaml-deployment/SKILL.md`
