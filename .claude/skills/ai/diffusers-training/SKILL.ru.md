...
version: "1.0"
language: ru
original: diffusers-training
---

# Diffusers Training

> Training with Diffusers. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `diffusers-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Diffusers Training
...
## Ресурсы
- Оригинальный навык: `ai/diffusers-training/SKILL.md`
