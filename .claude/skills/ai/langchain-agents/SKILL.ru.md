...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Agents
...
## Ресурсы
- Оригинальный навык: `ai/langchain-agents/SKILL.md`
