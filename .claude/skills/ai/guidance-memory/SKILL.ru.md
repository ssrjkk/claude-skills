...
version: "1.0"
language: ru
original: guidance-memory
---

# Guidance Memory

> Memory with Guidance. conversation memory.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Memory
...
## Ресурсы
- Оригинальный навык: `ai/guidance-memory/SKILL.md`
