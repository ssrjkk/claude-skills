...
category: ai
tags: [guidance-chaining, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: guidance-chaining
---

# Guidance Chaining

> Chaining with Guidance. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Chaining
...
## Ресурсы
- Оригинальный навык: `ai/guidance-chaining/SKILL.md`
