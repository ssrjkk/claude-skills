...
version: "1.0"
language: ru
original: yolo-optical-flow
---

# Yolo Optical Flow

> Optical Flow with Yolo. motion detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-optical-flow`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Optical Flow
...
## Ресурсы
- Оригинальный навык: `ai/yolo-optical-flow/SKILL.md`
