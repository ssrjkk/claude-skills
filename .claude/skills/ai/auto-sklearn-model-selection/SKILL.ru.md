...
version: "1.0"
language: ru
original: auto-sklearn-model-selection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-model-selection/SKILL.md`
