...
version: "1.0"
language: ru
original: triton-fundamentals
---

# Triton Fundamentals

> Fundamentals for Triton: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `triton-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Triton Fundamentals
...
## Ресурсы
- Оригинал: ai/triton-fundamentals/SKILL.md
