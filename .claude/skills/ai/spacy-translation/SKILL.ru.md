...
version: "1.0"
language: ru
original: spacy-translation
---

# Spacy Translation

> Translation with Spacy. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Translation
...
## Ресурсы
- Оригинальный навык: `ai/spacy-translation/SKILL.md`
