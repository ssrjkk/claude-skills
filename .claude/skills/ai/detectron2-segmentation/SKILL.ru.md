...
version: "1.0"
language: ru
original: detectron2-segmentation
---

# Detectron2 Segmentation

> Segmentation with Detectron2. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detectron2-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Detectron2 Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/detectron2-segmentation/SKILL.md`
