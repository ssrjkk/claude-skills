...
## Быстрый старт
Этот навык на русском языке. Оригинал: `huggingface-advanced`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Huggingface Advanced
...
## Ресурсы
- Оригинальный навык: ai/huggingface-advanced/SKILL.md
