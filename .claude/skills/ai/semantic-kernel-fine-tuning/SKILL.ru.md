...
version: "1.0"
language: ru
original: semantic-kernel-fine-tuning
---

# Semantic Kernel Fine Tuning

> Fine-Tuning with Semantic Kernel. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-fine-tuning/SKILL.md`
