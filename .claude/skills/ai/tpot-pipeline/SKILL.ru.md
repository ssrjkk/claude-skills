...
version: "1.0"
language: ru
original: tpot-pipeline
---

# Tpot Pipeline

> Pipeline with Tpot. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/tpot-pipeline/SKILL.md`
