...
category: ai
tags: [openvino-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openvino-fundamentals
---

# Openvino Fundamentals

> Fundamentals for Openvino: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `openvino-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openvino Fundamentals
...
## Ресурсы
- Оригинал: ai/openvino-fundamentals/SKILL.md
