...
version: "1.0"
language: ru
original: opencv-face-detection
---

# Opencv Face Detection

> Face Detection with Opencv. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/opencv-face-detection/SKILL.md`
