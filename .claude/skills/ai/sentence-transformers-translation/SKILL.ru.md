...
version: "1.0"
language: ru
original: sentence-transformers-translation
---

# Sentence Transformers Translation

> Translation with Sentence Transformers. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sentence-transformers-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Sentence Transformers Translation
...
## Ресурсы
- Оригинальный навык: `ai/sentence-transformers-translation/SKILL.md`
