...
version: "1.0"
language: ru
original: auto-sklearn-pipeline
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-pipeline/SKILL.md`
