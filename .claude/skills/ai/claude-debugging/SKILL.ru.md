...
category: ai
tags: [claude-debugging, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: claude-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-debugging`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Debugging
...
## Ресурсы
- Оригинальный навык: ai/claude-debugging/SKILL.md
