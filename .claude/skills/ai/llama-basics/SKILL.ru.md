...
category: ai
tags: [llama-basics, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: llama-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-basics`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Basics
...
## Ресурсы
- Оригинальный навык: ai/llama-basics/SKILL.md
