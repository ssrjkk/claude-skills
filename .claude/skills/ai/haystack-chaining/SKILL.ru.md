...
category: ai
tags: [haystack-chaining, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haystack-chaining
---

# Haystack Chaining

> Chaining with Haystack. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Chaining
...
## Ресурсы
- Оригинальный навык: `ai/haystack-chaining/SKILL.md`
