...
version: "1.0"
language: ru
original: mxnet-distributed
---

# Mxnet Distributed

> Distributed with Mxnet. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mxnet-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mxnet Distributed
...
## Ресурсы
- Оригинальный навык: `ai/mxnet-distributed/SKILL.md`
