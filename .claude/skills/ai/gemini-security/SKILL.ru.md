...
category: ai
tags: [gemini-security, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gemini-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gemini-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Gemini Security
...
## Ресурсы
- Оригинальный навык: ai/gemini-security/SKILL.md
