...
version: "1.0"
language: ru
original: sentence-transformers-text-classification
---

# Sentence Transformers Text Classification

> Text Classification with Sentence Transformers. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sentence-transformers-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Sentence Transformers Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/sentence-transformers-text-classification/SKILL.md`
