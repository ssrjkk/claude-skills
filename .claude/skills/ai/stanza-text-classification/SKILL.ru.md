...
category: ai
tags: [stanza-text-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stanza-text-classification
---

# Stanza Text Classification

> Text Classification with Stanza. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/stanza-text-classification/SKILL.md`
