...
version: "1.0"
language: ru
original: mlflow-classification
---

# Mlflow Classification

> Classification with Mlflow. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mlflow-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mlflow Classification
...
## Ресурсы
- Оригинальный навык: `ai/mlflow-classification/SKILL.md`
