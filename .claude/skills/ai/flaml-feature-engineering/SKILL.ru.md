...
category: ai
tags: [flaml-feature-engineering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flaml-feature-engineering
---

# Flaml Feature Engineering

> Feature Engineering with Flaml. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flaml-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flaml Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/flaml-feature-engineering/SKILL.md`
