...
version: "1.0"
language: ru
original: diffusers-inference
---

# Diffusers Inference

> Inference with Diffusers. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `diffusers-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Diffusers Inference
...
## Ресурсы
- Оригинальный навык: `ai/diffusers-inference/SKILL.md`
