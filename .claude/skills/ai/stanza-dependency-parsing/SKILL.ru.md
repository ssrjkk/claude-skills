...
category: ai
tags: [stanza-dependency-parsing, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stanza-dependency-parsing
---

# Stanza Dependency Parsing

> Dependency Parsing with Stanza. syntax analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-dependency-parsing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Dependency Parsing
...
## Ресурсы
- Оригинальный навык: `ai/stanza-dependency-parsing/SKILL.md`
