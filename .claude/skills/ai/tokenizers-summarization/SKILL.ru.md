...
category: ai
tags: [tokenizers-summarization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tokenizers-summarization
---

# Tokenizers Summarization

> Summarization with Tokenizers. text summarization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tokenizers-summarization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tokenizers Summarization
...
## Ресурсы
- Оригинальный навык: `ai/tokenizers-summarization/SKILL.md`
