...
version: "1.0"
language: ru
original: ollama-fundamentals
---

# Ollama Fundamentals

> Fundamentals for Ollama: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ollama-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ollama Fundamentals
...
## Ресурсы
- Оригинал: ai/ollama-fundamentals/SKILL.md
