...
version: "1.0"
language: ru
original: albumentations-edge-detection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `albumentations-edge-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Albumentations Edge Detection
...
## Ресурсы
- Оригинальный навык: `ai/albumentations-edge-detection/SKILL.md`
