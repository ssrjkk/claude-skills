...
version: "1.0"
language: ru
original: optuna-classification
---

# Optuna Classification

> Classification with Optuna. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optuna-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Optuna Classification
...
## Ресурсы
- Оригинальный навык: `ai/optuna-classification/SKILL.md`
