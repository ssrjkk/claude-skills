...
version: "1.0"
language: ru
original: llama-index-evaluation
---

# Llama Index Evaluation

> Evaluation with Llama Index. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-evaluation/SKILL.md`
