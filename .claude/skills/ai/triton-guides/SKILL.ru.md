...
version: "1.0"
language: ru
original: triton-guides
---

# Triton Guides

> Guides for Triton: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `triton-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Triton Guides
...
## Ресурсы
- Оригинал: ai/triton-guides/SKILL.md
