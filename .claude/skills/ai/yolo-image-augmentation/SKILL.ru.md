...
category: ai
tags: [yolo-image-augmentation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: yolo-image-augmentation
---

# Yolo Image Augmentation

> Image Augmentation with Yolo. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/yolo-image-augmentation/SKILL.md`
