...
## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-security`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Security
...
## Ресурсы
- Оригинальный навык: ai/llama-security/SKILL.md
