...
category: ai
tags: [spacy-similarity, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spacy-similarity
---

# Spacy Similarity

> Similarity with Spacy. text similarity.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-similarity`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Similarity
...
## Ресурсы
- Оригинальный навык: `ai/spacy-similarity/SKILL.md`
