...
version: "1.0"
language: ru
original: mxnet-quantization
---

# Mxnet Quantization

> Quantization with Mxnet. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mxnet-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mxnet Quantization
...
## Ресурсы
- Оригинальный навык: `ai/mxnet-quantization/SKILL.md`
