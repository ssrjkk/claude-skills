...
version: "1.0"
language: ru
original: flair-lemmatization
---

# Flair Lemmatization

> Lemmatization with Flair. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flair-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flair Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/flair-lemmatization/SKILL.md`
