...
version: "1.0"
language: ru
original: scikit-learn-feature-engineering
---

# Scikit Learn Feature Engineering

> Feature Engineering with Scikit Learn. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-learn-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Learn Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/scikit-learn-feature-engineering/SKILL.md`
