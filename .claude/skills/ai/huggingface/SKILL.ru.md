...
> Loads, fine-tunes, and deploys models from HuggingFace Hub for NLP, CV, and audio tasks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `huggingface`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Huggingface
...
## Ресурсы
- Оригинальный навык: `ai/huggingface/SKILL.md`
