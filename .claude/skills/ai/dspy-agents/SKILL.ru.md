...
version: "1.0"
language: ru
original: dspy-agents
---

# Dspy Agents

> Agents with Dspy. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Agents
...
## Ресурсы
- Оригинальный навык: `ai/dspy-agents/SKILL.md`
