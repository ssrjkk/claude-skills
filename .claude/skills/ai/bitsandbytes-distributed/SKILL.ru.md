...
version: "1.0"
language: ru
original: bitsandbytes-distributed
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bitsandbytes-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Bitsandbytes Distributed
...
## Ресурсы
- Оригинальный навык: `ai/bitsandbytes-distributed/SKILL.md`
