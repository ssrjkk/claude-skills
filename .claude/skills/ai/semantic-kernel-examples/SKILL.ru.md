...
category: ai
tags: [semantic-kernel-examples, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-examples
---

# Semantic Kernel Examples

> Examples for Semantic-Kernel: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `semantic-kernel-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Examples
...
## Ресурсы
- Оригинал: ai/semantic-kernel-examples/SKILL.md
