...
category: ai
tags: [imgaug-face-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: imgaug-face-detection
---

# Imgaug Face Detection

> Face Detection with Imgaug. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imgaug-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Imgaug Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/imgaug-face-detection/SKILL.md`
