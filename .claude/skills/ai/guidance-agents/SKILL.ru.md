...
version: "1.0"
language: ru
original: guidance-agents
---

# Guidance Agents

> Agents with Guidance. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Agents
...
## Ресурсы
- Оригинальный навык: `ai/guidance-agents/SKILL.md`
