...
category: ai
tags: [optuna-feature-engineering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: optuna-feature-engineering
---

# Optuna Feature Engineering

> Feature Engineering with Optuna. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optuna-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Optuna Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/optuna-feature-engineering/SKILL.md`
