...
version: "1.0"
language: ru
original: haystack-embeddings
---

# Haystack Embeddings

> Embeddings with Haystack. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/haystack-embeddings/SKILL.md`
