...
category: ai
tags: [guidance-rag, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: guidance-rag
---

# Guidance Rag

> RAG with Guidance. building RAG systems.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-rag`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Rag
...
## Ресурсы
- Оригинальный навык: `ai/guidance-rag/SKILL.md`
