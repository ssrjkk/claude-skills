...
version: "1.0"
language: ru
original: sentence-transformers-summarization
---

# Sentence Transformers Summarization

> Summarization with Sentence Transformers. text summarization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sentence-transformers-summarization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Sentence Transformers Summarization
...
## Ресурсы
- Оригинальный навык: `ai/sentence-transformers-summarization/SKILL.md`
