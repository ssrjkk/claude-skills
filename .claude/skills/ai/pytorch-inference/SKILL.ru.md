...
category: ai
tags: [pytorch-inference, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Inference with Pytorch. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Inference
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-inference/SKILL.md`
