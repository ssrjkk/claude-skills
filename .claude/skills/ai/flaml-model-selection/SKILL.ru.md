...
version: "1.0"
language: ru
original: flaml-model-selection
---

# Flaml Model Selection

> Model Selection with Flaml. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flaml-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flaml Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/flaml-model-selection/SKILL.md`
