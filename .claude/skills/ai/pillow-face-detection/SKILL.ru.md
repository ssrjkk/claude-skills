...
category: ai
tags: [pillow-face-detection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pillow-face-detection
---

# Pillow Face Detection

> Face Detection with Pillow. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pillow-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pillow Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/pillow-face-detection/SKILL.md`
