...
category: ai
tags: [neptune-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neptune-classification
---

# Neptune Classification

> Classification with Neptune. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neptune-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Neptune Classification
...
## Ресурсы
- Оригинальный навык: `ai/neptune-classification/SKILL.md`
