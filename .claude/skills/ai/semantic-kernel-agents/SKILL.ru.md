...
version: "1.0"
language: ru
original: semantic-kernel-agents
---

# Semantic Kernel Agents

> Agents with Semantic Kernel. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Agents
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-agents/SKILL.md`
