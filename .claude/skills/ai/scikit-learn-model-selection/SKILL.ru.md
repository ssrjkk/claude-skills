...
category: ai
tags: [scikit-learn-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scikit-learn-model-selection
---

# Scikit Learn Model Selection

> Model Selection with Scikit Learn. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-learn-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Learn Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/scikit-learn-model-selection/SKILL.md`
