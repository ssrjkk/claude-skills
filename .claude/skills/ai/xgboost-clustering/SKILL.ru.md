...
category: ai
tags: [xgboost-clustering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xgboost-clustering
---

# Xgboost Clustering

> Clustering with Xgboost. grouping data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-clustering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Clustering
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-clustering/SKILL.md`
