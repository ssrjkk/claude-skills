...
category: ai
tags: [crewai-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Quickstart for Crewai: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `crewai-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Crewai Quickstart
...
## Ресурсы
- Оригинал: ai/crewai-quickstart/SKILL.md
