...
## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Prompting
...
## Ресурсы
- Оригинальный навык: `ai/haystack-prompting/SKILL.md`
