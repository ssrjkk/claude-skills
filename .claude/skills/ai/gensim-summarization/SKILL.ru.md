...
version: "1.0"
language: ru
original: gensim-summarization
---

# Gensim Summarization

> Summarization with Gensim. text summarization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gensim-summarization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Gensim Summarization
...
## Ресурсы
- Оригинальный навык: `ai/gensim-summarization/SKILL.md`
