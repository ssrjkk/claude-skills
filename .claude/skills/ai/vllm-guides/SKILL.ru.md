...
category: ai
tags: [vllm-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-guides
---

# Vllm Guides

> Guides for Vllm: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vllm-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Guides
...
## Ресурсы
- Оригинал: ai/vllm-guides/SKILL.md
