...
category: ai
tags: [embedding-models, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `embedding-models`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Embedding Models
...
## Ресурсы
- Оригинальный навык: `ai/embedding-models/SKILL.md`
