...
version: "1.0"
language: ru
original: claude-code-customization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-code-customization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Code Customization
...
## Ресурсы
- Оригинальный навык: `ai/claude-code-customization/SKILL.md`
