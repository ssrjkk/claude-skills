...
category: ai
tags: [autogen-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: autogen-guides
---

# Autogen Guides

> Guides for Autogen: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `autogen-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Autogen Guides
...
## Ресурсы
- Оригинал: ai/autogen-guides/SKILL.md
