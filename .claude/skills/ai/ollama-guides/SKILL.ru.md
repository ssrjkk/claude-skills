...
category: ai
tags: [ollama-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ollama-guides
---

# Ollama Guides

> Guides for Ollama: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ollama-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ollama Guides
...
## Ресурсы
- Оригинал: ai/ollama-guides/SKILL.md
