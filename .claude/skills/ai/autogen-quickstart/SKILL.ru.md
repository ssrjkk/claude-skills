...
category: ai
tags: [autogen-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: autogen-quickstart
---

# Autogen Quickstart

> Quickstart for Autogen: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `autogen-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Autogen Quickstart
...
## Ресурсы
- Оригинал: ai/autogen-quickstart/SKILL.md
