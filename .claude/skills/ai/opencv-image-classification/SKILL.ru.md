...
version: "1.0"
language: ru
original: opencv-image-classification
---

# Opencv Image Classification

> Image Classification with Opencv. classifying images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/opencv-image-classification/SKILL.md`
