...
category: ai
tags: [nltk-text-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nltk-text-classification
---

# Nltk Text Classification

> Text Classification with Nltk. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nltk-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Nltk Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/nltk-text-classification/SKILL.md`
