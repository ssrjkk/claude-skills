...
version: "1.0"
language: ru
original: nltk-translation
---

# Nltk Translation

> Translation with Nltk. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nltk-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Nltk Translation
...
## Ресурсы
- Оригинальный навык: `ai/nltk-translation/SKILL.md`
