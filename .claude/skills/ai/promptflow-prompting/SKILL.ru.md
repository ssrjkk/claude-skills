...
category: ai
tags: [promptflow-prompting, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: promptflow-prompting
---

# Promptflow Prompting

> Prompt Engineering with Promptflow. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Prompting
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-prompting/SKILL.md`
