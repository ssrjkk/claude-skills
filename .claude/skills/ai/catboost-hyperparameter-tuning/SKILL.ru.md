...
version: "1.0"
language: ru
original: catboost-hyperparameter-tuning
---

# Catboost Hyperparameter Tuning

> Hyperparameter Tuning with Catboost. optimizing params.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-hyperparameter-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Hyperparameter Tuning
...
## Ресурсы
- Оригинальный навык: `ai/catboost-hyperparameter-tuning/SKILL.md`
