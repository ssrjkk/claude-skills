...
category: ai
tags: [mxnet-pruning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mxnet-pruning
---

# Mxnet Pruning

> Pruning with Mxnet. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mxnet-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mxnet Pruning
...
## Ресурсы
- Оригинальный навык: `ai/mxnet-pruning/SKILL.md`
