...
version: "1.0"
language: ru
original: tensorflow-distributed
---

# Tensorflow Distributed

> Distributed with Tensorflow. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tensorflow-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorflow Distributed
...
## Ресурсы
- Оригинальный навык: `ai/tensorflow-distributed/SKILL.md`
