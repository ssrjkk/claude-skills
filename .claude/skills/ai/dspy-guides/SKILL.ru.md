...
category: ai
tags: [dspy-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dspy-guides
---

# Dspy Guides

> Guides for Dspy: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `dspy-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Guides
...
## Ресурсы
- Оригинал: ai/dspy-guides/SKILL.md
