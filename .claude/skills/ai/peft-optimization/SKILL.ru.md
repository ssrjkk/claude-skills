...
version: "1.0"
language: ru
original: peft-optimization
---

# Peft Optimization

> Optimization with Peft. model optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `peft-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Peft Optimization
...
## Ресурсы
- Оригинальный навык: `ai/peft-optimization/SKILL.md`
