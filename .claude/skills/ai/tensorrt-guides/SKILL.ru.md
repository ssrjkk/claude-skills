...
category: ai
tags: [tensorrt-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tensorrt-guides
---

# Tensorrt Guides

> Guides for Tensorrt: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tensorrt-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorrt Guides
...
## Ресурсы
- Оригинал: ai/tensorrt-guides/SKILL.md
