...
category: ai
tags: [marvin-chaining, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marvin-chaining
---

# Marvin Chaining

> Chaining with Marvin. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Chaining
...
## Ресурсы
- Оригинальный навык: `ai/marvin-chaining/SKILL.md`
