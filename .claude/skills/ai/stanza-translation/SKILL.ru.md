...
category: ai
tags: [stanza-translation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stanza-translation
---

# Stanza Translation

> Translation with Stanza. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Translation
...
## Ресурсы
- Оригинальный навык: `ai/stanza-translation/SKILL.md`
