...
version: "1.0"
language: ru
original: dspy-tool-use
---

# Dspy Tool Use

> Tool Use with Dspy. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/dspy-tool-use/SKILL.md`
