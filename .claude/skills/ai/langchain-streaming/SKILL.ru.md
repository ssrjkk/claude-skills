...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Streaming
...
## Ресурсы
- Оригинальный навык: `ai/langchain-streaming/SKILL.md`
