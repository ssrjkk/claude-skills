...
version: "1.0"
language: ru
original: trl-inference
---

# Trl Inference

> Inference with Trl. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trl-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trl Inference
...
## Ресурсы
- Оригинальный навык: `ai/trl-inference/SKILL.md`
