...
category: ai
tags: [sentence-transformers-ner, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sentence-transformers-ner
---

# Sentence Transformers Ner

> NER with Sentence Transformers. named entity recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sentence-transformers-ner`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Sentence Transformers Ner
...
## Ресурсы
- Оригинальный навык: `ai/sentence-transformers-ner/SKILL.md`
