...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langgraph-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langgraph Agents
...
## Ресурсы
- Оригинальный навык: `ai/langgraph-agents/SKILL.md`
