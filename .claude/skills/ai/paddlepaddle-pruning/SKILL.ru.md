...
category: ai
tags: [paddlepaddle-pruning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: paddlepaddle-pruning
---

# Paddlepaddle Pruning

> Pruning with Paddlepaddle. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `paddlepaddle-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Paddlepaddle Pruning
...
## Ресурсы
- Оригинальный навык: `ai/paddlepaddle-pruning/SKILL.md`
