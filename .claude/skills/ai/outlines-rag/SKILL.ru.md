...
category: ai
tags: [outlines-rag, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: outlines-rag
---

# Outlines Rag

> RAG with Outlines. building RAG systems.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-rag`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Rag
...
## Ресурсы
- Оригинальный навык: `ai/outlines-rag/SKILL.md`
