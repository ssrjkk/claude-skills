...
category: ai
tags: [spacy-summarization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spacy-summarization
---

# Spacy Summarization

> Summarization with Spacy. text summarization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-summarization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Summarization
...
## Ресурсы
- Оригинальный навык: `ai/spacy-summarization/SKILL.md`
