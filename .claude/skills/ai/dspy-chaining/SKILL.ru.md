...
version: "1.0"
language: ru
original: dspy-chaining
---

# Dspy Chaining

> Chaining with Dspy. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Chaining
...
## Ресурсы
- Оригинальный навык: `ai/dspy-chaining/SKILL.md`
