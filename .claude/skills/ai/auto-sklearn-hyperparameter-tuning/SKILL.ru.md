...
version: "1.0"
language: ru
original: auto-sklearn-hyperparameter-tuning
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `auto-sklearn-hyperparameter-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Auto Sklearn Hyperparameter Tuning
...
## Ресурсы
- Оригинальный навык: `ai/auto-sklearn-hyperparameter-tuning/SKILL.md`
