...
version: "1.0"
language: ru
original: scikit-image-optical-flow
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-image-optical-flow`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Image Optical Flow
...
## Ресурсы
- Оригинальный навык: `ai/scikit-image-optical-flow/SKILL.md`
