...
version: "1.0"
language: ru
original: clearml-deployment
---

# Clearml Deployment

> Deployment with Clearml. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Deployment
...
## Ресурсы
- Оригинальный навык: `ai/clearml-deployment/SKILL.md`
