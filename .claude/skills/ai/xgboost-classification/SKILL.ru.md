...
version: "1.0"
language: ru
original: xgboost-classification
---

# Xgboost Classification

> Classification with Xgboost. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xgboost-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Xgboost Classification
...
## Ресурсы
- Оригинальный навык: `ai/xgboost-classification/SKILL.md`
