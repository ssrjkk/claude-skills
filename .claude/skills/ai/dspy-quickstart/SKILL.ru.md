...
version: "1.0"
language: ru
original: dspy-quickstart
---

# Dspy Quickstart

> Quickstart for Dspy: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `dspy-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Quickstart
...
## Ресурсы
- Оригинал: ai/dspy-quickstart/SKILL.md
