...
version: "1.0"
language: ru
original: dvc-feature-engineering
---

# Dvc Feature Engineering

> Feature Engineering with Dvc. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dvc-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dvc Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/dvc-feature-engineering/SKILL.md`
