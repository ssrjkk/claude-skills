...
version: "1.0"
language: ru
original: stable-diffusion-getting-started
---

# Stable Diffusion Getting Started

> Getting Started for Stable-Diffusion: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: stable-diffusion-getting-started.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stable Diffusion Getting Started
...
## Ресурсы
- ai/stable-diffusion-getting-started/SKILL.md
