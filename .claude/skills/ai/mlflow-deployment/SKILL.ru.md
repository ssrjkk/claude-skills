...
version: "1.0"
language: ru
original: mlflow-deployment
---

# Mlflow Deployment

> Deployment with Mlflow. model serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mlflow-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mlflow Deployment
...
## Ресурсы
- Оригинальный навык: `ai/mlflow-deployment/SKILL.md`
