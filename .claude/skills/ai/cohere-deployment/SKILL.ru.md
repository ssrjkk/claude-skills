...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-deployment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Deployment
...
## Ресурсы
- Оригинальный навык: ai/cohere-deployment/SKILL.md
