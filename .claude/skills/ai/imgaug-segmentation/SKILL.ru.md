...
category: ai
tags: [imgaug-segmentation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: imgaug-segmentation
---

# Imgaug Segmentation

> Segmentation with Imgaug. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imgaug-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Imgaug Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/imgaug-segmentation/SKILL.md`
