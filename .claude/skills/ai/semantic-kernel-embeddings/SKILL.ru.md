...
category: ai
tags: [semantic-kernel-embeddings, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-embeddings
---

# Semantic Kernel Embeddings

> Embeddings with Semantic Kernel. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-embeddings/SKILL.md`
