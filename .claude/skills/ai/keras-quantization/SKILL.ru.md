...
category: ai
tags: [keras-quantization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: keras-quantization
---

# Keras Quantization

> Quantization with Keras. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `keras-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Keras Quantization
...
## Ресурсы
- Оригинальный навык: `ai/keras-quantization/SKILL.md`
