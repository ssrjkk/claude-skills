...
version: "1.0"
language: ru
original: yolo-face-detection
---

# Yolo Face Detection

> Face Detection with Yolo. facial recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yolo-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Yolo Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/yolo-face-detection/SKILL.md`
