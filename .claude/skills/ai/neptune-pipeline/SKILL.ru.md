...
category: ai
tags: [neptune-pipeline, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neptune-pipeline
---

# Neptune Pipeline

> Pipeline with Neptune. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neptune-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Neptune Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/neptune-pipeline/SKILL.md`
