...
version: "1.0"
language: ru
original: textblob-lemmatization
---

# Textblob Lemmatization

> Lemmatization with Textblob. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/textblob-lemmatization/SKILL.md`
