...
version: "1.0"
language: ru
original: llama-index-embeddings
---

# Llama Index Embeddings

> Embeddings with Llama Index. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-embeddings/SKILL.md`
