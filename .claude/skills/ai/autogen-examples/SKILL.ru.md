...
version: "1.0"
language: ru
original: autogen-examples
---

# Autogen Examples

> Examples for Autogen: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `autogen-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Autogen Examples
...
## Ресурсы
- Оригинал: ai/autogen-examples/SKILL.md
