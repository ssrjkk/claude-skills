...
## Быстрый старт
Этот навык на русском языке. Оригинал: `claude-basics`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Claude Basics
...
## Ресурсы
- Оригинальный навык: ai/claude-basics/SKILL.md
