...
version: "1.0"
language: ru
original: langchain-evaluation
---

# Langchain Evaluation

> Evaluation with Langchain. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `langchain-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langchain Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/langchain-evaluation/SKILL.md`
