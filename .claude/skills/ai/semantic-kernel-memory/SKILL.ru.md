...
category: ai
tags: [semantic-kernel-memory, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-memory
---

# Semantic Kernel Memory

> Memory with Semantic Kernel. conversation memory.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Memory
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-memory/SKILL.md`
