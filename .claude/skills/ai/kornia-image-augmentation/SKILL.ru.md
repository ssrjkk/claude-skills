...
version: "1.0"
language: ru
original: kornia-image-augmentation
---

# Kornia Image Augmentation

> Image Augmentation with Kornia. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/kornia-image-augmentation/SKILL.md`
