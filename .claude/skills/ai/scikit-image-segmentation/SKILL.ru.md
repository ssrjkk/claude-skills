...
version: "1.0"
language: ru
original: scikit-image-segmentation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-image-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Image Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/scikit-image-segmentation/SKILL.md`
