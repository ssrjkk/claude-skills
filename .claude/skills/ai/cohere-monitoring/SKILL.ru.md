...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-monitoring`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Monitoring
...
## Ресурсы
- Оригинальный навык: ai/cohere-monitoring/SKILL.md
