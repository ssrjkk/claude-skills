...
version: "1.0"
language: ru
original: mmdetection-image-augmentation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mmdetection-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mmdetection Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/mmdetection-image-augmentation/SKILL.md`
