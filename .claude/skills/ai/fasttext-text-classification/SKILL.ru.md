...
version: "1.0"
language: ru
original: fasttext-text-classification
---

# Fasttext Text Classification

> Text Classification with Fasttext. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fasttext-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Fasttext Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/fasttext-text-classification/SKILL.md`
