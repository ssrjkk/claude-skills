...
category: ai
tags: [clearml-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clearml-model-selection
---

# Clearml Model Selection

> Model Selection with Clearml. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clearml-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Clearml Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/clearml-model-selection/SKILL.md`
