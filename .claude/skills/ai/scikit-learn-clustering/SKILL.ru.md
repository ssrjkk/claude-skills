...
category: ai
tags: [scikit-learn-clustering, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scikit-learn-clustering
---

# Scikit Learn Clustering

> Clustering with Scikit Learn. grouping data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scikit-learn-clustering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Scikit Learn Clustering
...
## Ресурсы
- Оригинальный навык: `ai/scikit-learn-clustering/SKILL.md`
