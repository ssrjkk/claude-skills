...
version: "1.0"
language: ru
original: tensorflow-transfer-learning
---

# Tensorflow Transfer Learning

> Transfer Learning with Tensorflow. transfer learning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tensorflow-transfer-learning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorflow Transfer Learning
...
## Ресурсы
- Оригинальный навык: `ai/tensorflow-transfer-learning/SKILL.md`
