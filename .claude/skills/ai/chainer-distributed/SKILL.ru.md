...
version: "1.0"
language: ru
original: chainer-distributed
---

# Chainer Distributed

> Distributed with Chainer. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chainer-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Chainer Distributed
...
## Ресурсы
- Оригинальный навык: `ai/chainer-distributed/SKILL.md`
