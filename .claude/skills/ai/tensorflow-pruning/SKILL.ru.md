...
version: "1.0"
language: ru
original: tensorflow-pruning
---

# Tensorflow Pruning

> Pruning with Tensorflow. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tensorflow-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorflow Pruning
...
## Ресурсы
- Оригинальный навык: `ai/tensorflow-pruning/SKILL.md`
