...
category: ai
tags: [semantic-kernel-guides, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-guides
---

# Semantic Kernel Guides

> Guides for Semantic-Kernel: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `semantic-kernel-guides`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Guides
...
## Ресурсы
- Оригинал: ai/semantic-kernel-guides/SKILL.md
