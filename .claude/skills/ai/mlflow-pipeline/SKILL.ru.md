...
category: ai
tags: [mlflow-pipeline, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mlflow-pipeline
---

# Mlflow Pipeline

> Pipeline with Mlflow. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mlflow-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mlflow Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/mlflow-pipeline/SKILL.md`
