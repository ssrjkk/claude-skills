...
version: "1.0"
language: ru
original: outlines-chaining
---

# Outlines Chaining

> Chaining with Outlines. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Chaining
...
## Ресурсы
- Оригинальный навык: `ai/outlines-chaining/SKILL.md`
