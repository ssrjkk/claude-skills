...
version: "1.0"
language: ru
original: mmdetection-object-detection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mmdetection-object-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mmdetection Object Detection
...
## Ресурсы
- Оригинальный навык: `ai/mmdetection-object-detection/SKILL.md`
