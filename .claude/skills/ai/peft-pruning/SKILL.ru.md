...
version: "1.0"
language: ru
original: peft-pruning
---

# Peft Pruning

> Pruning with Peft. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `peft-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Peft Pruning
...
## Ресурсы
- Оригинальный навык: `ai/peft-pruning/SKILL.md`
