...
version: "1.0"
language: ru
original: langfuse-automation
---

# Langfuse Automation

> Automation for Langfuse: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: langfuse-automation.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langfuse Automation
...
## Ресурсы
- ai/langfuse-automation/SKILL.md
