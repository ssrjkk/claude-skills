...
category: ai
tags: [flair-text-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flair-text-classification
---

# Flair Text Classification

> Text Classification with Flair. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flair-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flair Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/flair-text-classification/SKILL.md`
