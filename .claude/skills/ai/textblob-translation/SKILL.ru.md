...
version: "1.0"
language: ru
original: textblob-translation
---

# Textblob Translation

> Translation with Textblob. machine translation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-translation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Translation
...
## Ресурсы
- Оригинальный навык: `ai/textblob-translation/SKILL.md`
