...
version: "1.0"
language: ru
original: semantic-kernel-chaining
---

# Semantic Kernel Chaining

> Chaining with Semantic Kernel. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Chaining
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-chaining/SKILL.md`
