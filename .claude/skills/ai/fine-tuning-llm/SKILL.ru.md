...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fine-tuning-llm`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Fine Tuning Llm
...
## Ресурсы
- Оригинальный навык: `ai/fine-tuning-llm/SKILL.md`
