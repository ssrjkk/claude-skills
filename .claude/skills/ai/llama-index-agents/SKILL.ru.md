...
version: "1.0"
language: ru
original: llama-index-agents
---

# Llama Index Agents

> Agents with Llama Index. building agents.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Agents
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-agents/SKILL.md`
