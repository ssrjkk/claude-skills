...
category: ai
tags: [mlflow-regression, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mlflow-regression
---

# Mlflow Regression

> Regression with Mlflow. predicting values.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mlflow-regression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mlflow Regression
...
## Ресурсы
- Оригинальный навык: `ai/mlflow-regression/SKILL.md`
