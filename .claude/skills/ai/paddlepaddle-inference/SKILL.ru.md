...
version: "1.0"
language: ru
original: paddlepaddle-inference
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `paddlepaddle-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Paddlepaddle Inference
...
## Ресурсы
- Оригинальный навык: `ai/paddlepaddle-inference/SKILL.md`
