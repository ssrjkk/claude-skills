...
version: "1.0"
language: ru
original: tensorrt-fundamentals
---

# Tensorrt Fundamentals

> Fundamentals for Tensorrt: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tensorrt-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorrt Fundamentals
...
## Ресурсы
- Оригинал: ai/tensorrt-fundamentals/SKILL.md
