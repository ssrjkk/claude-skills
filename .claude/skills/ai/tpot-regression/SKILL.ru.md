...
version: "1.0"
language: ru
original: tpot-regression
---

# Tpot Regression

> Regression with Tpot. predicting values.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-regression`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Regression
...
## Ресурсы
- Оригинальный навык: `ai/tpot-regression/SKILL.md`
