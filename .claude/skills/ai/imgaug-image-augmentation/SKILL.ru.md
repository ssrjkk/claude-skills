...
version: "1.0"
language: ru
original: imgaug-image-augmentation
---

# Imgaug Image Augmentation

> Image Augmentation with Imgaug. data augmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imgaug-image-augmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Imgaug Image Augmentation
...
## Ресурсы
- Оригинальный навык: `ai/imgaug-image-augmentation/SKILL.md`
