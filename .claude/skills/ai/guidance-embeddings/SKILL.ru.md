...
version: "1.0"
language: ru
original: guidance-embeddings
---

# Guidance Embeddings

> Embeddings with Guidance. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/guidance-embeddings/SKILL.md`
