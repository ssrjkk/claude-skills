...
category: ai
tags: [mmdetection-segmentation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mmdetection-segmentation
---

# Mmdetection Segmentation

> Segmentation with Mmdetection. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mmdetection-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mmdetection Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/mmdetection-segmentation/SKILL.md`
