...
version: "1.0"
language: ru
original: paddlepaddle-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `paddlepaddle-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Paddlepaddle Optimization
...
## Ресурсы
- Оригинальный навык: `ai/paddlepaddle-optimization/SKILL.md`
