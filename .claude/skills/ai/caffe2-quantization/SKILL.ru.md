...
version: "1.0"
language: ru
original: caffe2-quantization
---

# Caffe2 Quantization

> Quantization with Caffe2. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Quantization
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-quantization/SKILL.md`
