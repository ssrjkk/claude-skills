...
version: "1.0"
language: ru
original: transformers-pruning
---

# Transformers Pruning

> Pruning with Transformers. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Pruning
...
## Ресурсы
- Оригинальный навык: `ai/transformers-pruning/SKILL.md`
