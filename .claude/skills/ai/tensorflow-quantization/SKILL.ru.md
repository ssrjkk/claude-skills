...
version: "1.0"
language: ru
original: tensorflow-quantization
---

# Tensorflow Quantization

> Quantization with Tensorflow. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tensorflow-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorflow Quantization
...
## Ресурсы
- Оригинальный навык: `ai/tensorflow-quantization/SKILL.md`
