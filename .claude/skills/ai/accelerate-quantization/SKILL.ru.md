...
category: ai
tags: [accelerate-quantization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: accelerate-quantization
---

# Accelerate Quantization

> Quantization with Accelerate. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `accelerate-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Accelerate Quantization
...
## Ресурсы
- Оригинальный навык: `ai/accelerate-quantization/SKILL.md`
