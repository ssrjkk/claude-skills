...
category: ai
tags: [langgraph-workflows, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: langgraph-workflows
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `langgraph-workflows`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Langgraph Workflows
...
## Ресурсы
- Оригинальный навык: `ai/langgraph-workflows/SKILL.md`
