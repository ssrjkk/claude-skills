...
category: ai
tags: [marvin-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marvin-tool-use
---

# Marvin Tool Use

> Tool Use with Marvin. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/marvin-tool-use/SKILL.md`
