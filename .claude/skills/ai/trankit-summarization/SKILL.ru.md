...
version: "1.0"
language: ru
original: trankit-summarization
---

# Trankit Summarization

> Summarization with Trankit. text summarization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-summarization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Summarization
...
## Ресурсы
- Оригинальный навык: `ai/trankit-summarization/SKILL.md`
