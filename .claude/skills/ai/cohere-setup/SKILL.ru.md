...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cohere-setup`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Cohere Setup
...
## Ресурсы
- Оригинальный навык: ai/cohere-setup/SKILL.md
