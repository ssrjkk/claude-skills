...
category: ai
tags: [dspy-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dspy-fundamentals
---

# Dspy Fundamentals

> Fundamentals for Dspy: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `dspy-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Fundamentals
...
## Ресурсы
- Оригинал: ai/dspy-fundamentals/SKILL.md
