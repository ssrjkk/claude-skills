...
category: ai
tags: [onnx-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: onnx-quickstart
---

# Onnx Quickstart

> Quickstart for Onnx: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `onnx-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Quickstart
...
## Ресурсы
- Оригинал: ai/onnx-quickstart/SKILL.md
