...
category: ai
tags: [llama-index-fine-tuning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: llama-index-fine-tuning
---

# Llama Index Fine Tuning

> Fine-Tuning with Llama Index. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-fine-tuning/SKILL.md`
