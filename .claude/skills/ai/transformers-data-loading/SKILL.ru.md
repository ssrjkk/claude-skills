...
version: "1.0"
language: ru
original: transformers-data-loading
---

# Transformers Data Loading

> Data Loading with Transformers. data pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-data-loading`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Data Loading
...
## Ресурсы
- Оригинальный навык: `ai/transformers-data-loading/SKILL.md`
