...
version: "1.0"
language: ru
original: jax-inference
---

# Jax Inference

> Inference with Jax. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jax-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Jax Inference
...
## Ресурсы
- Оригинальный навык: `ai/jax-inference/SKILL.md`
