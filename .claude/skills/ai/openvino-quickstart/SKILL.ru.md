...
category: ai
tags: [openvino-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openvino-quickstart
---

# Openvino Quickstart

> Quickstart for Openvino: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `openvino-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Openvino Quickstart
...
## Ресурсы
- Оригинал: ai/openvino-quickstart/SKILL.md
