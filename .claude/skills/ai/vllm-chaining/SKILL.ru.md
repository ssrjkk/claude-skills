...
category: ai
tags: [vllm-chaining, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-chaining
---

# Vllm Chaining

> Chaining with Vllm. multi-step workflows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Chaining
...
## Ресурсы
- Оригинальный навык: `ai/vllm-chaining/SKILL.md`
