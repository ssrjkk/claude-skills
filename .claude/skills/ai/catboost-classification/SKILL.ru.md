...
category: ai
tags: [catboost-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: catboost-classification
---

# Catboost Classification

> Classification with Catboost. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Classification
...
## Ресурсы
- Оригинальный навык: `ai/catboost-classification/SKILL.md`
