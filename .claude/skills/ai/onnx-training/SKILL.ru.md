...
version: "1.0"
language: ru
original: onnx-training
---

# Onnx Training

> Training with Onnx. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Training
...
## Ресурсы
- Оригинальный навык: `ai/onnx-training/SKILL.md`
