...
version: "1.0"
language: ru
original: transformers-inference
---

# Transformers Inference

> Inference with Transformers. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `transformers-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Transformers Inference
...
## Ресурсы
- Оригинальный навык: `ai/transformers-inference/SKILL.md`
