...
version: "1.0"
language: ru
original: kornia-color-processing
---

# Kornia Color Processing

> Color Processing with Kornia. color manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-color-processing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Color Processing
...
## Ресурсы
- Оригинальный навык: `ai/kornia-color-processing/SKILL.md`
