...
category: ai
tags: [stanza-tokenization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stanza-tokenization
---

# Stanza Tokenization

> Tokenization with Stanza. text tokenization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-tokenization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Tokenization
...
## Ресурсы
- Оригинальный навык: `ai/stanza-tokenization/SKILL.md`
