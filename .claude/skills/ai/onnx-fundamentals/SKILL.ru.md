...
category: ai
tags: [onnx-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: onnx-fundamentals
---

# Onnx Fundamentals

> Fundamentals for Onnx: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `onnx-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Fundamentals
...
## Ресурсы
- Оригинал: ai/onnx-fundamentals/SKILL.md
