...
version: "1.0"
language: ru
original: neptune-feature-engineering
---

# Neptune Feature Engineering

> Feature Engineering with Neptune. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neptune-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Neptune Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/neptune-feature-engineering/SKILL.md`
