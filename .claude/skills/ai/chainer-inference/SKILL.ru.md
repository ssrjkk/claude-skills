...
version: "1.0"
language: ru
original: chainer-inference
---

# Chainer Inference

> Inference with Chainer. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chainer-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Chainer Inference
...
## Ресурсы
- Оригинальный навык: `ai/chainer-inference/SKILL.md`
