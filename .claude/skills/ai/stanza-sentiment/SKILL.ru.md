...
version: "1.0"
language: ru
original: stanza-sentiment
---

# Stanza Sentiment

> Sentiment Analysis with Stanza. sentiment detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stanza-sentiment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Stanza Sentiment
...
## Ресурсы
- Оригинальный навык: `ai/stanza-sentiment/SKILL.md`
