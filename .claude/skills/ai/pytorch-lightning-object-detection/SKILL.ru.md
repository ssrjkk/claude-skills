...
version: "1.0"
language: ru
original: pytorch-lightning-object-detection
---

# Pytorch Lightning Object Detection

> Object Detection with Pytorch Lightning. detecting objects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-lightning-object-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Lightning Object Detection
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-lightning-object-detection/SKILL.md`
