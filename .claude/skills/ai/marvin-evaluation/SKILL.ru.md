...
version: "1.0"
language: ru
original: marvin-evaluation
---

# Marvin Evaluation

> Evaluation with Marvin. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/marvin-evaluation/SKILL.md`
