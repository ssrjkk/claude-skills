...
version: "1.0"
language: ru
original: pytorch-quantization
---

# Pytorch Quantization

> Quantization with Pytorch. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pytorch-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pytorch Quantization
...
## Ресурсы
- Оригинальный навык: `ai/pytorch-quantization/SKILL.md`
