...
version: "1.0"
language: ru
original: lightgbm-hyperparameter-tuning
---

# Lightgbm Hyperparameter Tuning

> Hyperparameter Tuning with Lightgbm. optimizing params.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-hyperparameter-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Hyperparameter Tuning
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-hyperparameter-tuning/SKILL.md`
