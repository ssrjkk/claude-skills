...
category: ai
tags: [haystack-fine-tuning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haystack-fine-tuning
---

# Haystack Fine Tuning

> Fine-Tuning with Haystack. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/haystack-fine-tuning/SKILL.md`
