...
version: "1.0"
language: ru
original: prompt-chaining
---

# Prompt Chaining

> Multi-step prompt chaining strategies

## Быстрый старт
Этот навык на русском языке. Оригинал: `prompt-chaining`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Prompt Chaining
...
## Ресурсы
- Оригинальный навык: `ai/prompt-chaining/SKILL.md`
