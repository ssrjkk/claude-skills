...
version: "1.0"
language: ru
original: marvin-fine-tuning
---

# Marvin Fine Tuning

> Fine-Tuning with Marvin. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/marvin-fine-tuning/SKILL.md`
