...
version: "1.0"
language: ru
original: kornia-edge-detection
---

# Kornia Edge Detection

> Edge Detection with Kornia. edge detection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-edge-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Edge Detection
...
## Ресурсы
- Оригинальный навык: `ai/kornia-edge-detection/SKILL.md`
