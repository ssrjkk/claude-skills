...
version: "1.0"
language: ru
original: opencv-segmentation
---

# Opencv Segmentation

> Segmentation with Opencv. image segmentation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opencv-segmentation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Opencv Segmentation
...
## Ресурсы
- Оригинальный навык: `ai/opencv-segmentation/SKILL.md`
