...
version: "1.0"
language: ru
original: peft-quantization
---

# Peft Quantization

> Quantization with Peft. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `peft-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Peft Quantization
...
## Ресурсы
- Оригинальный навык: `ai/peft-quantization/SKILL.md`
