...
version: "1.0"
language: ru
original: dspy-evaluation
---

# Dspy Evaluation

> Evaluation with Dspy. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dspy-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dspy Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/dspy-evaluation/SKILL.md`
