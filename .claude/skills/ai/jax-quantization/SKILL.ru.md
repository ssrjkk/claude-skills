...
version: "1.0"
language: ru
original: jax-quantization
---

# Jax Quantization

> Quantization with Jax. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jax-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Jax Quantization
...
## Ресурсы
- Оригинальный навык: `ai/jax-quantization/SKILL.md`
