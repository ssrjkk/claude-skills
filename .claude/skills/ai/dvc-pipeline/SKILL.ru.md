...
category: ai
tags: [dvc-pipeline, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dvc-pipeline
---

# Dvc Pipeline

> Pipeline with Dvc. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dvc-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dvc Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/dvc-pipeline/SKILL.md`
