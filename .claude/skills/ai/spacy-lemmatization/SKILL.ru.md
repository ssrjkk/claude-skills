...
category: ai
tags: [spacy-lemmatization, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spacy-lemmatization
---

# Spacy Lemmatization

> Lemmatization with Spacy. word lemmatization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-lemmatization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Lemmatization
...
## Ресурсы
- Оригинальный навык: `ai/spacy-lemmatization/SKILL.md`
