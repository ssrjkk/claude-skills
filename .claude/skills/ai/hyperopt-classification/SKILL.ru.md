...
version: "1.0"
language: ru
original: hyperopt-classification
---

# Hyperopt Classification

> Classification with Hyperopt. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyperopt-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Hyperopt Classification
...
## Ресурсы
- Оригинальный навык: `ai/hyperopt-classification/SKILL.md`
