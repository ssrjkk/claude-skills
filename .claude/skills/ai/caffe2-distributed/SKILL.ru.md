...
category: ai
tags: [caffe2-distributed, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: caffe2-distributed
---

# Caffe2 Distributed

> Distributed with Caffe2. distributed training.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-distributed`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Distributed
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-distributed/SKILL.md`
