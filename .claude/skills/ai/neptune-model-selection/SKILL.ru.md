...
category: ai
tags: [neptune-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: neptune-model-selection
---

# Neptune Model Selection

> Model Selection with Neptune. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `neptune-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Neptune Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/neptune-model-selection/SKILL.md`
