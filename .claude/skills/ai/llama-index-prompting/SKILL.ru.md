...
category: ai
tags: [llama-index-prompting, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: llama-index-prompting
---

# Llama Index Prompting

> Prompt Engineering with Llama Index. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `llama-index-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Llama Index Prompting
...
## Ресурсы
- Оригинальный навык: `ai/llama-index-prompting/SKILL.md`
