...
version: "1.0"
language: ru
original: mmdetection-image-classification
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mmdetection-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mmdetection Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/mmdetection-image-classification/SKILL.md`
