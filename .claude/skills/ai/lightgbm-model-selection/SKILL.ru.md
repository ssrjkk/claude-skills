...
category: ai
tags: [lightgbm-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lightgbm-model-selection
---

# Lightgbm Model Selection

> Model Selection with Lightgbm. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lightgbm-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Lightgbm Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/lightgbm-model-selection/SKILL.md`
