...
version: "1.0"
language: ru
original: onnx-optimization
---

# Onnx Optimization

> Optimization with Onnx. model optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-optimization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Optimization
...
## Ресурсы
- Оригинальный навык: `ai/onnx-optimization/SKILL.md`
