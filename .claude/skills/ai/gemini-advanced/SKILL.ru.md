...
category: ai
tags: [gemini-advanced, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gemini-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gemini-advanced`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Gemini Advanced
...
## Ресурсы
- Оригинальный навык: ai/gemini-advanced/SKILL.md
