...
version: "1.0"
language: ru
original: trl-quantization
---

# Trl Quantization

> Quantization with Trl. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trl-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trl Quantization
...
## Ресурсы
- Оригинальный навык: `ai/trl-quantization/SKILL.md`
