...
## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-agents`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Agents
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-agents/SKILL.md`
