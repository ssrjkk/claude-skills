...
version: "1.0"
language: ru
original: albumentations-image-classification
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `albumentations-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Albumentations Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/albumentations-image-classification/SKILL.md`
