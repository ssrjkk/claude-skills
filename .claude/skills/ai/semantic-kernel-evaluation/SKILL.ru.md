...
category: ai
tags: [semantic-kernel-evaluation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-evaluation
---

# Semantic Kernel Evaluation

> Evaluation with Semantic Kernel. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-evaluation/SKILL.md`
