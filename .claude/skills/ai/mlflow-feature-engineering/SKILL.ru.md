...
version: "1.0"
language: ru
original: mlflow-feature-engineering
---

# Mlflow Feature Engineering

> Feature Engineering with Mlflow. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mlflow-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mlflow Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/mlflow-feature-engineering/SKILL.md`
