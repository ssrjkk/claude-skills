...
category: ai
tags: [tokenizers-text-classification, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tokenizers-text-classification
---

# Tokenizers Text Classification

> Text Classification with Tokenizers. document categorization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tokenizers-text-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tokenizers Text Classification
...
## Ресурсы
- Оригинальный навык: `ai/tokenizers-text-classification/SKILL.md`
