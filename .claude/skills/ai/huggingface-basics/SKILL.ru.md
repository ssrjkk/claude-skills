...
category: ai
tags: [huggingface-basics, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: huggingface-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `huggingface-basics`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Huggingface Basics
...
## Ресурсы
- Оригинальный навык: ai/huggingface-basics/SKILL.md
