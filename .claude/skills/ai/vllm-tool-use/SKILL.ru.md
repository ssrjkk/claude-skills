...
category: ai
tags: [vllm-tool-use, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vllm-tool-use
---

# Vllm Tool Use

> Tool Use with Vllm. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vllm-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Vllm Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/vllm-tool-use/SKILL.md`
