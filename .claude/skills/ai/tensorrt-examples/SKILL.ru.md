...
version: "1.0"
language: ru
original: tensorrt-examples
---

# Tensorrt Examples

> Examples for Tensorrt: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tensorrt-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tensorrt Examples
...
## Ресурсы
- Оригинал: ai/tensorrt-examples/SKILL.md
