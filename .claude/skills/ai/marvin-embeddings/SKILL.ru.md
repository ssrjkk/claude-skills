...
category: ai
tags: [marvin-embeddings, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marvin-embeddings
---

# Marvin Embeddings

> Embeddings with Marvin. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marvin-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Marvin Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/marvin-embeddings/SKILL.md`
