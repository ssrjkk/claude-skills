...
category: ai
tags: [semantic-kernel-quickstart, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: semantic-kernel-quickstart
---

# Semantic Kernel Quickstart

> Quickstart for Semantic-Kernel: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `semantic-kernel-quickstart`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Quickstart
...
## Ресурсы
- Оригинал: ai/semantic-kernel-quickstart/SKILL.md
