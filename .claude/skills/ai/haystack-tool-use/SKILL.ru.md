...
version: "1.0"
language: ru
original: haystack-tool-use
---

# Haystack Tool Use

> Tool Use with Haystack. function calling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-tool-use`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Tool Use
...
## Ресурсы
- Оригинальный навык: `ai/haystack-tool-use/SKILL.md`
