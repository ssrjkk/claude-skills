...
version: "1.0"
language: ru
original: jax-training
---

# Jax Training

> Training with Jax. training models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jax-training`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Jax Training
...
## Ресурсы
- Оригинальный навык: `ai/jax-training/SKILL.md`
