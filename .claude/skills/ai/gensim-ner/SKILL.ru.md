...
> NER with Gensim. named entity recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gensim-ner`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Gensim Ner
...
## Ресурсы
- Оригинальный навык: `ai/gensim-ner/SKILL.md`
