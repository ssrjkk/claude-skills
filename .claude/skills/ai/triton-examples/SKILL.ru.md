...
version: "1.0"
language: ru
original: triton-examples
---

# Triton Examples

> Examples for Triton: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `triton-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Triton Examples
...
## Ресурсы
- Оригинал: ai/triton-examples/SKILL.md
