...
version: "1.0"
language: ru
original: onnx-quantization
---

# Onnx Quantization

> Quantization with Onnx. model quantization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `onnx-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Onnx Quantization
...
## Ресурсы
- Оригинальный навык: `ai/onnx-quantization/SKILL.md`
