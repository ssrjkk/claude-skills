...
version: "1.0"
language: ru
original: guidance-prompting
---

# Guidance Prompting

> Prompt Engineering with Guidance. prompt templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-prompting`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Prompting
...
## Ресурсы
- Оригинальный навык: `ai/guidance-prompting/SKILL.md`
