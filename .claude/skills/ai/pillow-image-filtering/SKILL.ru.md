...
version: "1.0"
language: ru
original: pillow-image-filtering
---

# Pillow Image Filtering

> Image Filtering with Pillow. image filters.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pillow-image-filtering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Pillow Image Filtering
...
## Ресурсы
- Оригинальный навык: `ai/pillow-image-filtering/SKILL.md`
