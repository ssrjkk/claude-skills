...
category: ai
tags: [spacy-dependency-parsing, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spacy-dependency-parsing
---

# Spacy Dependency Parsing

> Dependency Parsing with Spacy. syntax analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spacy-dependency-parsing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Spacy Dependency Parsing
...
## Ресурсы
- Оригинальный навык: `ai/spacy-dependency-parsing/SKILL.md`
