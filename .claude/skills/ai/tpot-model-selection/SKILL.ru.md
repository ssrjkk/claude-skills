...
category: ai
tags: [tpot-model-selection, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tpot-model-selection
---

# Tpot Model Selection

> Model Selection with Tpot. choosing models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-model-selection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Model Selection
...
## Ресурсы
- Оригинальный навык: `ai/tpot-model-selection/SKILL.md`
