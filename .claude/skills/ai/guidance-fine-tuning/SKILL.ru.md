...
version: "1.0"
language: ru
original: guidance-fine-tuning
---

# Guidance Fine Tuning

> Fine-Tuning with Guidance. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `guidance-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Guidance Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/guidance-fine-tuning/SKILL.md`
