...
version: "1.0"
language: ru
original: tpot-classification
---

# Tpot Classification

> Classification with Tpot. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Classification
...
## Ресурсы
- Оригинальный навык: `ai/tpot-classification/SKILL.md`
