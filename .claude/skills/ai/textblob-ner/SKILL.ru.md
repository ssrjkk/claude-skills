...
category: ai
tags: [textblob-ner, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: textblob-ner
---

# Textblob Ner

> NER with Textblob. named entity recognition.

## Быстрый старт
Этот навык на русском языке. Оригинал: `textblob-ner`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Textblob Ner
...
## Ресурсы
- Оригинальный навык: `ai/textblob-ner/SKILL.md`
