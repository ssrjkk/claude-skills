...
version: "1.0"
language: ru
original: hyperopt-pipeline
---

# Hyperopt Pipeline

> Pipeline with Hyperopt. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyperopt-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Hyperopt Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/hyperopt-pipeline/SKILL.md`
