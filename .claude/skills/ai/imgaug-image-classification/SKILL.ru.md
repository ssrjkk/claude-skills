...
version: "1.0"
language: ru
original: imgaug-image-classification
---

# Imgaug Image Classification

> Image Classification with Imgaug. classifying images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `imgaug-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Imgaug Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/imgaug-image-classification/SKILL.md`
