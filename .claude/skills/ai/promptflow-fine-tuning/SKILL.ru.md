...
version: "1.0"
language: ru
original: promptflow-fine-tuning
---

# Promptflow Fine Tuning

> Fine-Tuning with Promptflow. model customization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `promptflow-fine-tuning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Promptflow Fine Tuning
...
## Ресурсы
- Оригинальный навык: `ai/promptflow-fine-tuning/SKILL.md`
