...
version: "1.0"
language: ru
original: caffe2-inference
---

# Caffe2 Inference

> Inference with Caffe2. running models.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-inference`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Inference
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-inference/SKILL.md`
