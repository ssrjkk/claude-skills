...
category: ai
tags: [haystack-evaluation, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haystack-evaluation
---

# Haystack Evaluation

> Evaluation with Haystack. LLM evaluation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haystack-evaluation`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Haystack Evaluation
...
## Ресурсы
- Оригинальный навык: `ai/haystack-evaluation/SKILL.md`
