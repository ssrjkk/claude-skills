...
version: "1.0"
language: ru
original: dvc-classification
---

# Dvc Classification

> Classification with Dvc. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dvc-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Dvc Classification
...
## Ресурсы
- Оригинальный навык: `ai/dvc-classification/SKILL.md`
