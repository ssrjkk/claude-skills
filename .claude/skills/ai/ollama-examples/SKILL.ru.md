...
category: ai
tags: [ollama-examples, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ollama-examples
---

# Ollama Examples

> Examples for Ollama: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ollama-examples`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ollama Examples
...
## Ресурсы
- Оригинал: ai/ollama-examples/SKILL.md
