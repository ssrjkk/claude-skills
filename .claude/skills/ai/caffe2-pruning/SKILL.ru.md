...
category: ai
tags: [caffe2-pruning, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: caffe2-pruning
---

# Caffe2 Pruning

> Pruning with Caffe2. model pruning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caffe2-pruning`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Caffe2 Pruning
...
## Ресурсы
- Оригинальный навык: `ai/caffe2-pruning/SKILL.md`
