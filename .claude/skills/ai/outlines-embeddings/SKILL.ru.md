...
version: "1.0"
language: ru
original: outlines-embeddings
---

# Outlines Embeddings

> Embeddings with Outlines. text embeddings.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-embeddings`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Embeddings
...
## Ресурсы
- Оригинальный навык: `ai/outlines-embeddings/SKILL.md`
