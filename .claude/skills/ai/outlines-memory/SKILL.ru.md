...
## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-memory`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Memory
...
## Ресурсы
- Оригинальный навык: `ai/outlines-memory/SKILL.md`
