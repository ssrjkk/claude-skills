...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trankit-sentiment`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Trankit Sentiment
...
## Ресурсы
- Оригинальный навык: `ai/trankit-sentiment/SKILL.md`
