...
category: ai
tags: [autogen-fundamentals, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: autogen-fundamentals
---

# Autogen Fundamentals

> Fundamentals for Autogen: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `autogen-fundamentals`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Autogen Fundamentals
...
## Ресурсы
- Оригинал: ai/autogen-fundamentals/SKILL.md
