...
version: "1.0"
language: ru
original: ray-tune-classification
---

# Ray Tune Classification

> Classification with Ray Tune. building classifiers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ray-tune-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Ray Tune Classification
...
## Ресурсы
- Оригинальный навык: `ai/ray-tune-classification/SKILL.md`
