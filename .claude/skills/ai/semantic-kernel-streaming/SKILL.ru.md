...
version: "1.0"
language: ru
original: semantic-kernel-streaming
---

# Semantic Kernel Streaming

> Streaming with Semantic Kernel. token streaming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-kernel-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Semantic Kernel Streaming
...
## Ресурсы
- Оригинальный навык: `ai/semantic-kernel-streaming/SKILL.md`
