...
version: "1.0"
language: ru
original: tpot-feature-engineering
---

# Tpot Feature Engineering

> Feature Engineering with Tpot. creating features.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tpot-feature-engineering`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Tpot Feature Engineering
...
## Ресурсы
- Оригинальный навык: `ai/tpot-feature-engineering/SKILL.md`
