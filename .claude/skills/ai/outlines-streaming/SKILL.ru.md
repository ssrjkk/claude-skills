...
category: ai
tags: [outlines-streaming, ai, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: outlines-streaming
---

# Outlines Streaming

> Streaming with Outlines. token streaming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `outlines-streaming`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Outlines Streaming
...
## Ресурсы
- Оригинальный навык: `ai/outlines-streaming/SKILL.md`
