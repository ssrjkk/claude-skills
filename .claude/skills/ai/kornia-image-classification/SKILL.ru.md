...
version: "1.0"
language: ru
original: kornia-image-classification
---

# Kornia Image Classification

> Image Classification with Kornia. classifying images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kornia-image-classification`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Kornia Image Classification
...
## Ресурсы
- Оригинальный навык: `ai/kornia-image-classification/SKILL.md`
