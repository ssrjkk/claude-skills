...
version: "1.0"
language: ru
original: mmdetection-face-detection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mmdetection-face-detection`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Mmdetection Face Detection
...
## Ресурсы
- Оригинальный навык: `ai/mmdetection-face-detection/SKILL.md`
