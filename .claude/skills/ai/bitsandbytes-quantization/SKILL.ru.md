...
version: "1.0"
language: ru
original: bitsandbytes-quantization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bitsandbytes-quantization`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Bitsandbytes Quantization
...
## Ресурсы
- Оригинальный навык: `ai/bitsandbytes-quantization/SKILL.md`
