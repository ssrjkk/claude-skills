...
version: "1.0"
language: ru
original: accelerate-checkpointing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `accelerate-checkpointing`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Accelerate Checkpointing
...
## Ресурсы
- Оригинальный навык: `ai/accelerate-checkpointing/SKILL.md`
