...
version: "1.0"
language: ru
original: flaml-pipeline
---

# Flaml Pipeline

> Pipeline with Flaml. ML pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flaml-pipeline`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Flaml Pipeline
...
## Ресурсы
- Оригинальный навык: `ai/flaml-pipeline/SKILL.md`
