...
version: "1.0"
language: ru
original: catboost-monitoring
---

# Catboost Monitoring

> Monitoring with Catboost. model monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `catboost-monitoring`.

## Когда использовать
- Работа с Искусственный интеллект
- Выполнение задач, связанных с Catboost Monitoring
...
## Ресурсы
- Оригинальный навык: `ai/catboost-monitoring/SKILL.md`
