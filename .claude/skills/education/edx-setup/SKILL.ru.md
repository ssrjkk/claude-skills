...
> Setup with Open edX. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-setup`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Setup
...
## Ресурсы
- Оригинальный навык: `education/edx-setup/SKILL.md`
