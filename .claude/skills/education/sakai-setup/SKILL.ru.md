...
version: "1.0"
language: ru
original: sakai-setup
---

# Sakai Setup

> Setup with Sakai. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sakai-setup`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Sakai Setup
...
## Ресурсы
- Оригинальный навык: `education/sakai-setup/SKILL.md`
