...
category: education
tags: [edx-integration, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: edx-integration
---

# Edx Integration

> Integration with Open edX. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Integration
...
## Ресурсы
- Оригинальный навык: `education/edx-integration/SKILL.md`
