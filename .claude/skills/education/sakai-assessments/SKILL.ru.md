...
version: "1.0"
language: ru
original: sakai-assessments
---

# Sakai Assessments

> Assessments with Sakai. quizzes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sakai-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Sakai Assessments
...
## Ресурсы
- Оригинальный навык: `education/sakai-assessments/SKILL.md`
