...
version: "1.0"
language: ru
original: thinkific-integration
---

# Thinkific Integration

> Integration with Thinkific. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thinkific-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Thinkific Integration
...
## Ресурсы
- Оригинальный навык: `education/thinkific-integration/SKILL.md`
