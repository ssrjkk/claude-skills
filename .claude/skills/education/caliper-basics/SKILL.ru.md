...
version: "1.0"
language: ru
original: caliper-basics
---

# Caliper Basics

> Basics with Caliper. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caliper-basics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Caliper Basics
...
## Ресурсы
- Оригинальный навык: `education/caliper-basics/SKILL.md`
