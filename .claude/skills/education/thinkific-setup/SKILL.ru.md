...
version: "1.0"
language: ru
original: thinkific-setup
---

# Thinkific Setup

> Setup with Thinkific. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thinkific-setup`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Thinkific Setup
...
## Ресурсы
- Оригинальный навык: `education/thinkific-setup/SKILL.md`
