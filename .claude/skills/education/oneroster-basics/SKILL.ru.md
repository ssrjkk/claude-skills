...
category: education
tags: [oneroster-basics, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oneroster-basics
---

# Oneroster Basics

> Basics with OneRoster. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oneroster-basics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Oneroster Basics
...
## Ресурсы
- Оригинальный навык: `education/oneroster-basics/SKILL.md`
