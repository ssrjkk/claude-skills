...
version: "1.0"
language: ru
original: oneroster-deployment
---

# Oneroster Deployment

> Deployment with OneRoster. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oneroster-deployment`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Oneroster Deployment
...
## Ресурсы
- Оригинальный навык: `education/oneroster-deployment/SKILL.md`
