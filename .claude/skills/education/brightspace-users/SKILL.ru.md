...
version: "1.0"
language: ru
original: brightspace-users
---

# Brightspace Users

> Users with Brightspace. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `brightspace-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Brightspace Users
...
## Ресурсы
- Оригинальный навык: `education/brightspace-users/SKILL.md`
