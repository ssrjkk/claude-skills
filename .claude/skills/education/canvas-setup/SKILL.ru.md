...
> Setup with Canvas LMS. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-setup`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Setup
...
## Ресурсы
- Оригинальный навык: `education/canvas-setup/SKILL.md`
