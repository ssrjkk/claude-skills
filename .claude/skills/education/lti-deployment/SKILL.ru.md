...
version: "1.0"
language: ru
original: lti-deployment
---

# Lti Deployment

> Deployment with LTI. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lti-deployment`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Lti Deployment
...
## Ресурсы
- Оригинальный навык: `education/lti-deployment/SKILL.md`
