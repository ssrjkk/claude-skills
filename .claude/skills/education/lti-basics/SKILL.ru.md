...
> Basics with LTI. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lti-basics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Lti Basics
...
## Ресурсы
- Оригинальный навык: `education/lti-basics/SKILL.md`
