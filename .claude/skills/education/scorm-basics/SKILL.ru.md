...
category: education
tags: [scorm-basics, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scorm-basics
---

# Scorm Basics

> Basics with SCORM. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scorm-basics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Scorm Basics
...
## Ресурсы
- Оригинальный навык: `education/scorm-basics/SKILL.md`
