...
version: "1.0"
language: ru
original: scorm-testing
---

# Scorm Testing

> Testing with SCORM. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scorm-testing`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Scorm Testing
...
## Ресурсы
- Оригинальный навык: `education/scorm-testing/SKILL.md`
