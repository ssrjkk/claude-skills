...
category: education
tags: [xapi-basics, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xapi-basics
---

# Xapi Basics

> Basics with xAPI. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xapi-basics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Xapi Basics
...
## Ресурсы
- Оригинальный навык: `education/xapi-basics/SKILL.md`
