...
## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Integration
...
## Ресурсы
- Оригинальный навык: `education/canvas-integration/SKILL.md`
