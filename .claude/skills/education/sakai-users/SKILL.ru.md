...
version: "1.0"
language: ru
original: sakai-users
---

# Sakai Users

> Users with Sakai. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sakai-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Sakai Users
...
## Ресурсы
- Оригинальный навык: `education/sakai-users/SKILL.md`
