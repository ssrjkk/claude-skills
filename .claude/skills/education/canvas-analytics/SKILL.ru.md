...
version: "1.0"
language: ru
original: canvas-analytics
---

# Canvas Analytics

> Analytics with Canvas LMS. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-analytics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Analytics
...
## Ресурсы
- Оригинальный навык: `education/canvas-analytics/SKILL.md`
