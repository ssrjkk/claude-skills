...
## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Assessments
...
## Ресурсы
- Оригинальный навык: `education/canvas-assessments/SKILL.md`
