...
version: "1.0"
language: ru
original: xapi-testing
---

# Xapi Testing

> Testing with xAPI. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xapi-testing`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Xapi Testing
...
## Ресурсы
- Оригинальный навык: `education/xapi-testing/SKILL.md`
