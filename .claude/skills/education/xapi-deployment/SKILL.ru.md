...
version: "1.0"
language: ru
original: xapi-deployment
---

# Xapi Deployment

> Deployment with xAPI. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xapi-deployment`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Xapi Deployment
...
## Ресурсы
- Оригинальный навык: `education/xapi-deployment/SKILL.md`
