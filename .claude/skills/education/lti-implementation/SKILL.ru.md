...
version: "1.0"
language: ru
original: lti-implementation
---

# Lti Implementation

> Implementation with LTI. implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lti-implementation`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Lti Implementation
...
## Ресурсы
- Оригинальный навык: `education/lti-implementation/SKILL.md`
