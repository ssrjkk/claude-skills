...
category: education
tags: [canvas-courses, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: canvas-courses
---

# Canvas Courses

> Courses with Canvas LMS. course creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-courses`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Courses
...
## Ресурсы
- Оригинальный навык: `education/canvas-courses/SKILL.md`
