...
version: "1.0"
language: ru
original: teachable-users
---

# Teachable Users

> Users with Teachable. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teachable-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Teachable Users
...
## Ресурсы
- Оригинальный навык: `education/teachable-users/SKILL.md`
