...
version: "1.0"
language: ru
original: moodle-integration
---

# Moodle Integration

> Integration with Moodle. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `moodle-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Moodle Integration
...
## Ресурсы
- Оригинальный навык: `education/moodle-integration/SKILL.md`
