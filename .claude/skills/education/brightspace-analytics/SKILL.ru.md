...
version: "1.0"
language: ru
original: brightspace-analytics
---

# Brightspace Analytics

> Analytics with Brightspace. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `brightspace-analytics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Brightspace Analytics
...
## Ресурсы
- Оригинальный навык: `education/brightspace-analytics/SKILL.md`
