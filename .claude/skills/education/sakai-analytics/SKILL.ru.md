...
version: "1.0"
language: ru
original: sakai-analytics
---

# Sakai Analytics

> Analytics with Sakai. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sakai-analytics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Sakai Analytics
...
## Ресурсы
- Оригинальный навык: `education/sakai-analytics/SKILL.md`
