...
version: "1.0"
language: ru
original: brightspace-assessments
---

# Brightspace Assessments

> Assessments with Brightspace. quizzes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `brightspace-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Brightspace Assessments
...
## Ресурсы
- Оригинальный навык: `education/brightspace-assessments/SKILL.md`
