...
version: "1.0"
language: ru
original: edx-analytics
---

# Edx Analytics

> Analytics with Open edX. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-analytics`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Analytics
...
## Ресурсы
- Оригинальный навык: `education/edx-analytics/SKILL.md`
