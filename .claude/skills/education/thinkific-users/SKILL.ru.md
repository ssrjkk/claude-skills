...
version: "1.0"
language: ru
original: thinkific-users
---

# Thinkific Users

> Users with Thinkific. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thinkific-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Thinkific Users
...
## Ресурсы
- Оригинальный навык: `education/thinkific-users/SKILL.md`
