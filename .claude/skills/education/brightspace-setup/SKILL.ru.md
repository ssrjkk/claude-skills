...
version: "1.0"
language: ru
original: brightspace-setup
---

# Brightspace Setup

> Setup with Brightspace. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `brightspace-setup`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Brightspace Setup
...
## Ресурсы
- Оригинальный навык: `education/brightspace-setup/SKILL.md`
