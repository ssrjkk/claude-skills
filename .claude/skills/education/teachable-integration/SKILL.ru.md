...
version: "1.0"
language: ru
original: teachable-integration
---

# Teachable Integration

> Integration with Teachable. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teachable-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Teachable Integration
...
## Ресурсы
- Оригинальный навык: `education/teachable-integration/SKILL.md`
