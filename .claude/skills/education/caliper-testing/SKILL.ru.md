...
version: "1.0"
language: ru
original: caliper-testing
---

# Caliper Testing

> Testing with Caliper. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `caliper-testing`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Caliper Testing
...
## Ресурсы
- Оригинальный навык: `education/caliper-testing/SKILL.md`
