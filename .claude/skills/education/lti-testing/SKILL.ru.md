...
category: education
tags: [lti-testing, education, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lti-testing
---

# Lti Testing

> Testing with LTI. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lti-testing`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Lti Testing
...
## Ресурсы
- Оригинальный навык: `education/lti-testing/SKILL.md`
