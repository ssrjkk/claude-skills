...
version: "1.0"
language: ru
original: canvas-users
---

# Canvas Users

> Users with Canvas LMS. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `canvas-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Canvas Users
...
## Ресурсы
- Оригинальный навык: `education/canvas-users/SKILL.md`
