...
version: "1.0"
language: ru
original: brightspace-integration
---

# Brightspace Integration

> Integration with Brightspace. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `brightspace-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Brightspace Integration
...
## Ресурсы
- Оригинальный навык: `education/brightspace-integration/SKILL.md`
