...
version: "1.0"
language: ru
original: oneroster-testing
---

# Oneroster Testing

> Testing with OneRoster. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oneroster-testing`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Oneroster Testing
...
## Ресурсы
- Оригинальный навык: `education/oneroster-testing/SKILL.md`
