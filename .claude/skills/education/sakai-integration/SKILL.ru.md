...
version: "1.0"
language: ru
original: sakai-integration
---

# Sakai Integration

> Integration with Sakai. LTI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sakai-integration`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Sakai Integration
...
## Ресурсы
- Оригинальный навык: `education/sakai-integration/SKILL.md`
