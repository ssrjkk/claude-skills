...
version: "1.0"
language: ru
original: moodle-assessments
---

# Moodle Assessments

> Assessments with Moodle. quizzes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `moodle-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Moodle Assessments
...
## Ресурсы
- Оригинальный навык: `education/moodle-assessments/SKILL.md`
