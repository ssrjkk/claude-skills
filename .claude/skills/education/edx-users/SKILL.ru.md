...
> Users with Open edX. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Users
...
## Ресурсы
- Оригинальный навык: `education/edx-users/SKILL.md`
