...
version: "1.0"
language: ru
original: thinkific-courses
---

# Thinkific Courses

> Courses with Thinkific. course creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thinkific-courses`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Thinkific Courses
...
## Ресурсы
- Оригинальный навык: `education/thinkific-courses/SKILL.md`
