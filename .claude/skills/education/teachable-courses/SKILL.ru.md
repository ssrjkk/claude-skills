...
version: "1.0"
language: ru
original: teachable-courses
---

# Teachable Courses

> Courses with Teachable. course creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teachable-courses`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Teachable Courses
...
## Ресурсы
- Оригинальный навык: `education/teachable-courses/SKILL.md`
