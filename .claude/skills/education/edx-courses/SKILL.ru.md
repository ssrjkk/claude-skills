...
version: "1.0"
language: ru
original: edx-courses
---

# Edx Courses

> Courses with Open edX. course creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-courses`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Courses
...
## Ресурсы
- Оригинальный навык: `education/edx-courses/SKILL.md`
