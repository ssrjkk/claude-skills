...
version: "1.0"
language: ru
original: edx-assessments
---

# Edx Assessments

> Assessments with Open edX. quizzes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `edx-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Edx Assessments
...
## Ресурсы
- Оригинальный навык: `education/edx-assessments/SKILL.md`
