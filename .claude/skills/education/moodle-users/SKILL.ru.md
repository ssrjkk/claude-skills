...
version: "1.0"
language: ru
original: moodle-users
---

# Moodle Users

> Users with Moodle. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `moodle-users`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Moodle Users
...
## Ресурсы
- Оригинальный навык: `education/moodle-users/SKILL.md`
