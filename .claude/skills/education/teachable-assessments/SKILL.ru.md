...
version: "1.0"
language: ru
original: teachable-assessments
---

# Teachable Assessments

> Assessments with Teachable. quizzes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teachable-assessments`.

## Когда использовать
- Работа с Образование
- Выполнение задач, связанных с Teachable Assessments
...
## Ресурсы
- Оригинальный навык: `education/teachable-assessments/SKILL.md`
