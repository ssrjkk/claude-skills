...
version: "1.0"
language: ru
original: lean-coaching
---

# Lean Coaching

> Coaching with Lean. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lean-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Lean Coaching
...
## Ресурсы
- Оригинальный навык: `product/lean-coaching/SKILL.md`
