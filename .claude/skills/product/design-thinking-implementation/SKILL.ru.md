...
version: "1.0"
language: ru
original: design-thinking-implementation
---

# Design Thinking Implementation

> Implementation with Design Thinking. execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `design-thinking-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Design Thinking Implementation
...
## Ресурсы
- Оригинальный навык: `product/design-thinking-implementation/SKILL.md`
