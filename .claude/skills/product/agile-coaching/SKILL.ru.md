...
version: "1.0"
language: ru
original: agile-coaching
---

# Agile Coaching

> Coaching with Agile. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Coaching
...
## Ресурсы
- Оригинальный навык: `product/agile-coaching/SKILL.md`
