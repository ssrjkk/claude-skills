...
version: "1.0"
language: ru
original: agile-maturity
---

# Agile Maturity

> Maturity with Agile. assessment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-maturity`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Maturity
...
## Ресурсы
- Оригинальный навык: `product/agile-maturity/SKILL.md`
