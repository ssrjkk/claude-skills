...
version: "1.0"
language: ru
original: backlog-basics
---

# Backlog Basics

> Basics with Backlog Management. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlog-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Backlog Basics
...
## Ресурсы
- Оригинальный навык: `product/backlog-basics/SKILL.md`
