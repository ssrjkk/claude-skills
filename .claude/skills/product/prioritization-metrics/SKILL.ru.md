...
version: "1.0"
language: ru
original: prioritization-metrics
---

# Prioritization Metrics

> Metrics with Prioritization. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Metrics
...
## Ресурсы
- Оригинальный навык: `product/prioritization-metrics/SKILL.md`
