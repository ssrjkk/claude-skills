...
version: "1.0"
language: ru
original: prince2-implementation
---

# Prince2 Implementation

> Implementation with PRINCE2. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prince2-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prince2 Implementation
...
## Ресурсы
- Оригинальный навык: `product/prince2-implementation/SKILL.md`
