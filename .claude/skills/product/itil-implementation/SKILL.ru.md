...
> Implementation with ITIL. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `itil-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Itil Implementation
...
## Ресурсы
- Оригинальный навык: `product/itil-implementation/SKILL.md`
