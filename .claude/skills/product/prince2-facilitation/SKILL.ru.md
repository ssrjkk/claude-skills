...
version: "1.0"
language: ru
original: prince2-facilitation
---

# Prince2 Facilitation

> Facilitation with PRINCE2. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prince2-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prince2 Facilitation
...
## Ресурсы
- Оригинальный навык: `product/prince2-facilitation/SKILL.md`
