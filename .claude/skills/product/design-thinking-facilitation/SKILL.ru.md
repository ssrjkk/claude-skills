...
version: "1.0"
language: ru
original: design-thinking-facilitation
---

# Design Thinking Facilitation

> Facilitation with Design Thinking. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `design-thinking-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Design Thinking Facilitation
...
## Ресурсы
- Оригинальный навык: `product/design-thinking-facilitation/SKILL.md`
