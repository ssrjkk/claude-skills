...
version: "1.0"
language: ru
original: kanban-maturity
---

# Kanban Maturity

> Maturity with Kanban. assessment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kanban-maturity`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kanban Maturity
...
## Ресурсы
- Оригинальный навык: `product/kanban-maturity/SKILL.md`
