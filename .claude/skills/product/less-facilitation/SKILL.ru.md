...
version: "1.0"
language: ru
original: less-facilitation
---

# Less Facilitation

> Facilitation with LeSS. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Less Facilitation
...
## Ресурсы
- Оригинальный навык: `product/less-facilitation/SKILL.md`
