...
version: "1.0"
language: ru
original: prioritization-facilitation
---

# Prioritization Facilitation

> Facilitation with Prioritization. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Facilitation
...
## Ресурсы
- Оригинальный навык: `product/prioritization-facilitation/SKILL.md`
