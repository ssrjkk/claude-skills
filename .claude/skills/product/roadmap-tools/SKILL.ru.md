...
version: "1.0"
language: ru
original: roadmap-tools
---

# Roadmap Tools

> Tools with Roadmapping. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roadmap-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Roadmap Tools
...
## Ресурсы
- Оригинальный навык: `product/roadmap-tools/SKILL.md`
