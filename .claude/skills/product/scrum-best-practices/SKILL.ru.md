...
version: "1.0"
language: ru
original: scrum-best-practices
---

# Scrum Best Practices

> Best Practices with Scrum. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Best Practices
...
## Ресурсы
- Оригинальный навык: `product/scrum-best-practices/SKILL.md`
