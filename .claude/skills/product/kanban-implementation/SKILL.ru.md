...
> Implementation with Kanban. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kanban-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kanban Implementation
...
## Ресурсы
- Оригинальный навык: `product/kanban-implementation/SKILL.md`
