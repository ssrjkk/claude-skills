...
version: "1.0"
language: ru
original: scrum-metrics
---

# Scrum Metrics

> Metrics with Scrum. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Metrics
...
## Ресурсы
- Оригинальный навык: `product/scrum-metrics/SKILL.md`
