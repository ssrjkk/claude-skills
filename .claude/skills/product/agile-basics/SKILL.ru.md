...
version: "1.0"
language: ru
original: agile-basics
---

# Agile Basics

> Basics with Agile. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Basics
...
## Ресурсы
- Оригинальный навык: `product/agile-basics/SKILL.md`
