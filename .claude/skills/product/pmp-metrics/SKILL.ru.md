...
version: "1.0"
language: ru
original: pmp-metrics
---

# Pmp Metrics

> Metrics with PMP. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pmp-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Pmp Metrics
...
## Ресурсы
- Оригинальный навык: `product/pmp-metrics/SKILL.md`
