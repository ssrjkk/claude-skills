...
version: "1.0"
language: ru
original: itil-coaching
---

# Itil Coaching

> Coaching with ITIL. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `itil-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Itil Coaching
...
## Ресурсы
- Оригинальный навык: `product/itil-coaching/SKILL.md`
