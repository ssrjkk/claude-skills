...
version: "1.0"
language: ru
original: scrum-implementation
---

# Scrum Implementation

> Implementation with Scrum. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Implementation
...
## Ресурсы
- Оригинальный навык: `product/scrum-implementation/SKILL.md`
