...
version: "1.0"
language: ru
original: itil-facilitation
---

# Itil Facilitation

> Facilitation with ITIL. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `itil-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Itil Facilitation
...
## Ресурсы
- Оригинальный навык: `product/itil-facilitation/SKILL.md`
