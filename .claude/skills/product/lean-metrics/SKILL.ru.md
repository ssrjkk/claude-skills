...
version: "1.0"
language: ru
original: lean-metrics
---

# Lean Metrics

> Metrics with Lean. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lean-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Lean Metrics
...
## Ресурсы
- Оригинальный навык: `product/lean-metrics/SKILL.md`
