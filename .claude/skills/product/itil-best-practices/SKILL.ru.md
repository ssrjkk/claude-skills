...
version: "1.0"
language: ru
original: itil-best-practices
---

# Itil Best Practices

> Best Practices with ITIL. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `itil-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Itil Best Practices
...
## Ресурсы
- Оригинальный навык: `product/itil-best-practices/SKILL.md`
