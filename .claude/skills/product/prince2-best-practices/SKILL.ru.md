...
version: "1.0"
language: ru
original: prince2-best-practices
---

# Prince2 Best Practices

> Best Practices with PRINCE2. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prince2-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prince2 Best Practices
...
## Ресурсы
- Оригинальный навык: `product/prince2-best-practices/SKILL.md`
