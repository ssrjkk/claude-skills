...
version: "1.0"
language: ru
original: scrum-facilitation
---

# Scrum Facilitation

> Facilitation with Scrum. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Facilitation
...
## Ресурсы
- Оригинальный навык: `product/scrum-facilitation/SKILL.md`
