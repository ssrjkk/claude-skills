...
category: product
tags: [kpi-metrics, product, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Metrics with KPIs. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kpi-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kpi Metrics
...
## Ресурсы
- Оригинальный навык: `product/kpi-metrics/SKILL.md`
