...
> Basics with PMP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pmp-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Pmp Basics
...
## Ресурсы
- Оригинальный навык: `product/pmp-basics/SKILL.md`
