...
version: "1.0"
language: ru
original: kanban-coaching
---

# Kanban Coaching

> Coaching with Kanban. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kanban-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kanban Coaching
...
## Ресурсы
- Оригинальный навык: `product/kanban-coaching/SKILL.md`
