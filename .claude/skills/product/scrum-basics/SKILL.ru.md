...
version: "1.0"
language: ru
original: scrum-basics
---

# Scrum Basics

> Basics with Scrum. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Basics
...
## Ресурсы
- Оригинальный навык: `product/scrum-basics/SKILL.md`
