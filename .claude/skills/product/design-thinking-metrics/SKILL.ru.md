...
version: "1.0"
language: ru
original: design-thinking-metrics
---

# Design Thinking Metrics

> Metrics with Design Thinking. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `design-thinking-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Design Thinking Metrics
...
## Ресурсы
- Оригинальный навык: `product/design-thinking-metrics/SKILL.md`
