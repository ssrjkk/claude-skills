...
version: "1.0"
language: ru
original: jobs-to-be-done-implementation
---

# Jobs To Be Done Implementation

> Implementation with Jobs to be Done. execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jobs-to-be-done-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Jobs To Be Done Implementation
...
## Ресурсы
- Оригинальный навык: `product/jobs-to-be-done-implementation/SKILL.md`
