...
version: "1.0"
language: ru
original: spec-best-practices
---

# Spec Best Practices

> Best Practices with Specification Writing. tips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Spec Best Practices
...
## Ресурсы
- Оригинальный навык: `product/spec-best-practices/SKILL.md`
