...
version: "1.0"
language: ru
original: agile-best-practices
---

# Agile Best Practices

> Best Practices with Agile. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Best Practices
...
## Ресурсы
- Оригинальный навык: `product/agile-best-practices/SKILL.md`
