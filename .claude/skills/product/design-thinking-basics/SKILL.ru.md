...
version: "1.0"
language: ru
original: design-thinking-basics
---

# Design Thinking Basics

> Basics with Design Thinking. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `design-thinking-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Design Thinking Basics
...
## Ресурсы
- Оригинальный навык: `product/design-thinking-basics/SKILL.md`
