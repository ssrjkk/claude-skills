...
version: "1.0"
language: ru
original: design-thinking-tools
---

# Design Thinking Tools

> Tools with Design Thinking. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `design-thinking-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Design Thinking Tools
...
## Ресурсы
- Оригинальный навык: `product/design-thinking-tools/SKILL.md`
