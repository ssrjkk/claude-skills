...
version: "1.0"
language: ru
original: less-implementation
---

# Less Implementation

> Implementation with LeSS. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Less Implementation
...
## Ресурсы
- Оригинальный навык: `product/less-implementation/SKILL.md`
