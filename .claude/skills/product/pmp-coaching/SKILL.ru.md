...
version: "1.0"
language: ru
original: pmp-coaching
---

# Pmp Coaching

> Coaching with PMP. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pmp-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Pmp Coaching
...
## Ресурсы
- Оригинальный навык: `product/pmp-coaching/SKILL.md`
