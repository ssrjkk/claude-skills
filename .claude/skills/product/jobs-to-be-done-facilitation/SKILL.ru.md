...
version: "1.0"
language: ru
original: jobs-to-be-done-facilitation
---

# Jobs To Be Done Facilitation

> Facilitation with Jobs to be Done. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jobs-to-be-done-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Jobs To Be Done Facilitation
...
## Ресурсы
- Оригинальный навык: `product/jobs-to-be-done-facilitation/SKILL.md`
