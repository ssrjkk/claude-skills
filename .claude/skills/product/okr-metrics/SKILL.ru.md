...
version: "1.0"
language: ru
original: okr-metrics
---

# Okr Metrics

> Metrics with OKRs. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `okr-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Okr Metrics
...
## Ресурсы
- Оригинальный навык: `product/okr-metrics/SKILL.md`
