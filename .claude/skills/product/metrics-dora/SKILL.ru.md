...
version: "1.0"
language: ru
original: metrics-dora
---

# Metrics Dora

> Calculates DORA metrics (Deployment Frequency, Lead Time, MTTR, CFR) for teams. Use for evaluating DevOps effectiveness.

## Быстрый старт
Этот навык на русском языке. Оригинал: `metrics-dora`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Metrics Dora
...
## Ресурсы
- Оригинальный навык: `product/metrics-dora/SKILL.md`
