...
version: "1.0"
language: ru
original: pmp-facilitation
---

# Pmp Facilitation

> Facilitation with PMP. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pmp-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Pmp Facilitation
...
## Ресурсы
- Оригинальный навык: `product/pmp-facilitation/SKILL.md`
