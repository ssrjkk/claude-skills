...
> Basics with OKRs. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `okr-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Okr Basics
...
## Ресурсы
- Оригинальный навык: `product/okr-basics/SKILL.md`
