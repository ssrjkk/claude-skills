...
version: "1.0"
language: ru
original: safe-coaching
---

# Safe Coaching

> Coaching with SAFe. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `safe-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Safe Coaching
...
## Ресурсы
- Оригинальный навык: `product/safe-coaching/SKILL.md`
