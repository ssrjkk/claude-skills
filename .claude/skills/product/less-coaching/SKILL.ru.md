...
version: "1.0"
language: ru
original: less-coaching
---

# Less Coaching

> Coaching with LeSS. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Less Coaching
...
## Ресурсы
- Оригинальный навык: `product/less-coaching/SKILL.md`
