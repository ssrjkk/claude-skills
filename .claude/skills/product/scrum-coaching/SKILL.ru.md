...
version: "1.0"
language: ru
original: scrum-coaching
---

# Scrum Coaching

> Coaching with Scrum. team coaching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-coaching`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Coaching
...
## Ресурсы
- Оригинальный навык: `product/scrum-coaching/SKILL.md`
