...
version: "1.0"
language: ru
original: spec-basics
---

# Spec Basics

> Basics with Specification Writing. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Spec Basics
...
## Ресурсы
- Оригинальный навык: `product/spec-basics/SKILL.md`
