...
version: "1.0"
language: ru
original: kpi-facilitation
---

# Kpi Facilitation

> Facilitation with KPIs. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kpi-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kpi Facilitation
...
## Ресурсы
- Оригинальный навык: `product/kpi-facilitation/SKILL.md`
