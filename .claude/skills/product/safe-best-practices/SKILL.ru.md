...
version: "1.0"
language: ru
original: safe-best-practices
---

# Safe Best Practices

> Best Practices with SAFe. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `safe-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Safe Best Practices
...
## Ресурсы
- Оригинальный навык: `product/safe-best-practices/SKILL.md`
