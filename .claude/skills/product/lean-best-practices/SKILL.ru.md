...
version: "1.0"
language: ru
original: lean-best-practices
---

# Lean Best Practices

> Best Practices with Lean. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lean-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Lean Best Practices
...
## Ресурсы
- Оригинальный навык: `product/lean-best-practices/SKILL.md`
