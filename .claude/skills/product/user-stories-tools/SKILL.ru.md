...
version: "1.0"
language: ru
original: user-stories-tools
---

# User Stories Tools

> Tools with User Stories. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-stories-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с User Stories Tools
...
## Ресурсы
- Оригинальный навык: `product/user-stories-tools/SKILL.md`
