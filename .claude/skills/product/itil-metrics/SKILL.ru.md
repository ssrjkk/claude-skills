...
version: "1.0"
language: ru
original: itil-metrics
---

# Itil Metrics

> Metrics with ITIL. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `itil-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Itil Metrics
...
## Ресурсы
- Оригинальный навык: `product/itil-metrics/SKILL.md`
