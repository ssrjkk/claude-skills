...
version: "1.0"
language: ru
original: prioritization-tools
---

# Prioritization Tools

> Tools with Prioritization. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Tools
...
## Ресурсы
- Оригинальный навык: `product/prioritization-tools/SKILL.md`
