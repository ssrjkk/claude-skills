...
version: "1.0"
language: ru
original: backlog-facilitation
---

# Backlog Facilitation

> Facilitation with Backlog Management. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlog-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Backlog Facilitation
...
## Ресурсы
- Оригинальный навык: `product/backlog-facilitation/SKILL.md`
