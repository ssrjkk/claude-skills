...
version: "1.0"
language: ru
original: jobs-to-be-done-metrics
---

# Jobs To Be Done Metrics

> Metrics with Jobs to be Done. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jobs-to-be-done-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Jobs To Be Done Metrics
...
## Ресурсы
- Оригинальный навык: `product/jobs-to-be-done-metrics/SKILL.md`
