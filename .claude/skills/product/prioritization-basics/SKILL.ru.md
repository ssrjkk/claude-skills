...
version: "1.0"
language: ru
original: prioritization-basics
---

# Prioritization Basics

> Basics with Prioritization. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Basics
...
## Ресурсы
- Оригинальный навык: `product/prioritization-basics/SKILL.md`
