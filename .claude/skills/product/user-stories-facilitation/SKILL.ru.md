...
version: "1.0"
language: ru
original: user-stories-facilitation
---

# User Stories Facilitation

> Facilitation with User Stories. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-stories-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с User Stories Facilitation
...
## Ресурсы
- Оригинальный навык: `product/user-stories-facilitation/SKILL.md`
