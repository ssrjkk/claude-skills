...
version: "1.0"
language: ru
original: agile-implementation
---

# Agile Implementation

> Implementation with Agile. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Implementation
...
## Ресурсы
- Оригинальный навык: `product/agile-implementation/SKILL.md`
