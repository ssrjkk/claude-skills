...
version: "1.0"
language: ru
original: prince2-maturity
---

# Prince2 Maturity

> Maturity with PRINCE2. assessment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prince2-maturity`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prince2 Maturity
...
## Ресурсы
- Оригинальный навык: `product/prince2-maturity/SKILL.md`
