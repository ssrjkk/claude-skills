...
version: "1.0"
language: ru
original: prince2-metrics
---

# Prince2 Metrics

> Metrics with PRINCE2. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prince2-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prince2 Metrics
...
## Ресурсы
- Оригинальный навык: `product/prince2-metrics/SKILL.md`
