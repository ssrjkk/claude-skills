...
version: "1.0"
language: ru
original: prioritization-implementation
---

# Prioritization Implementation

> Implementation with Prioritization. execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Implementation
...
## Ресурсы
- Оригинальный навык: `product/prioritization-implementation/SKILL.md`
