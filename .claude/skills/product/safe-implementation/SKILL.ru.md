...
category: product
tags: [safe-implementation, product, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Implementation with SAFe. adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `safe-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Safe Implementation
...
## Ресурсы
- Оригинальный навык: `product/safe-implementation/SKILL.md`
