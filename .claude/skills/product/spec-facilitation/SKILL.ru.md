...
version: "1.0"
language: ru
original: spec-facilitation
---

# Spec Facilitation

> Facilitation with Specification Writing. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Spec Facilitation
...
## Ресурсы
- Оригинальный навык: `product/spec-facilitation/SKILL.md`
