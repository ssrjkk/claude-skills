...
version: "1.0"
language: ru
original: scrum-maturity
---

# Scrum Maturity

> Maturity with Scrum. assessment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scrum-maturity`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Scrum Maturity
...
## Ресурсы
- Оригинальный навык: `product/scrum-maturity/SKILL.md`
