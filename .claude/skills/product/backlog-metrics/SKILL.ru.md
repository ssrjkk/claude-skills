...
version: "1.0"
language: ru
original: backlog-metrics
---

# Backlog Metrics

> Metrics with Backlog Management. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlog-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Backlog Metrics
...
## Ресурсы
- Оригинальный навык: `product/backlog-metrics/SKILL.md`
