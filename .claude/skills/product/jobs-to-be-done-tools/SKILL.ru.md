...
version: "1.0"
language: ru
original: jobs-to-be-done-tools
---

# Jobs To Be Done Tools

> Tools with Jobs to be Done. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jobs-to-be-done-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Jobs To Be Done Tools
...
## Ресурсы
- Оригинальный навык: `product/jobs-to-be-done-tools/SKILL.md`
