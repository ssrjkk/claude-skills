...
version: "1.0"
language: ru
original: sprint-retro
---

# Sprint Retro

> Facilitates Sprint Retrospective with structured blocks and action items. Use by Scrum masters and teams.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sprint-retro`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Sprint Retro
...
## Ресурсы
- Оригинальный навык: `product/sprint-retro/SKILL.md`
