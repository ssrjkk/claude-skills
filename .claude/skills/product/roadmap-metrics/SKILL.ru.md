...
version: "1.0"
language: ru
original: roadmap-metrics
---

# Roadmap Metrics

> Metrics with Roadmapping. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roadmap-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Roadmap Metrics
...
## Ресурсы
- Оригинальный навык: `product/roadmap-metrics/SKILL.md`
