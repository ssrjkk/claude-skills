...
version: "1.0"
language: ru
original: aarrr-metrics
---

# Aarrr Metrics

> Tracks startup growth metrics using the AARRR (Pirate Metrics) framework: Acquisition, Activation, Retention, Revenue, Referral.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aarrr-metrics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Aarrr Metrics
...
## Ресурсы
- Оригинальный навык: `product/aarrr-metrics/SKILL.md`
