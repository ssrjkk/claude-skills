...
version: "1.0"
language: ru
original: agile-facilitation
---

# Agile Facilitation

> Facilitation with Agile. sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Facilitation
...
## Ресурсы
- Оригинальный навык: `product/agile-facilitation/SKILL.md`
