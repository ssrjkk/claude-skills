...
version: "1.0"
language: ru
original: heuristics-basics
---

# Heuristics Basics

> Basics with Heuristics. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heuristics-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Heuristics Basics
...
## Ресурсы
- Оригинальный навык: `product/heuristics-basics/SKILL.md`
