...
> Tools with Specification Writing. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Spec Tools
...
## Ресурсы
- Оригинальный навык: `product/spec-tools/SKILL.md`
