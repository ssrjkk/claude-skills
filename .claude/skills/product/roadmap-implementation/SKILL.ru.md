...
version: "1.0"
language: ru
original: roadmap-implementation
---

# Roadmap Implementation

> Implementation with Roadmapping. execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roadmap-implementation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Roadmap Implementation
...
## Ресурсы
- Оригинальный навык: `product/roadmap-implementation/SKILL.md`
