...
version: "1.0"
language: ru
original: agile-tools
---

# Agile Tools

> Tools with Agile. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `agile-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Agile Tools
...
## Ресурсы
- Оригинальный навык: `product/agile-tools/SKILL.md`
