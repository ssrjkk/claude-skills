...
version: "1.0"
language: ru
original: okr-best-practices
---

# Okr Best Practices

> Best Practices with OKRs. tips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `okr-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Okr Best Practices
...
## Ресурсы
- Оригинальный навык: `product/okr-best-practices/SKILL.md`
