...
version: "1.0"
language: ru
original: lean-maturity
---

# Lean Maturity

> Maturity with Lean. assessment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lean-maturity`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Lean Maturity
...
## Ресурсы
- Оригинальный навык: `product/lean-maturity/SKILL.md`
