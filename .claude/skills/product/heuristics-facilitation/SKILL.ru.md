...
version: "1.0"
language: ru
original: heuristics-facilitation
---

# Heuristics Facilitation

> Facilitation with Heuristics. running.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heuristics-facilitation`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Heuristics Facilitation
...
## Ресурсы
- Оригинальный навык: `product/heuristics-facilitation/SKILL.md`
