...
category: product
tags: [prd-template, product, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Generates structured PRD (Product Requirements Document) with goals, features, and success criteria. Use for documenting requirements.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prd-template`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prd Template
...
## Ресурсы
- Оригинальный навык: `product/prd-template/SKILL.md`
