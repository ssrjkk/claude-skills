...
version: "1.0"
language: ru
original: backlog-tools
---

# Backlog Tools

> Tools with Backlog Management. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlog-tools`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Backlog Tools
...
## Ресурсы
- Оригинальный навык: `product/backlog-tools/SKILL.md`
