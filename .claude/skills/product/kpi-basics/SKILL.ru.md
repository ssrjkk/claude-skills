...
category: product
tags: [kpi-basics, product, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kpi-basics
...
> Basics with KPIs. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kpi-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Kpi Basics
...
## Ресурсы
- Оригинальный навык: `product/kpi-basics/SKILL.md`
