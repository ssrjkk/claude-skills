...
version: "1.0"
language: ru
original: prioritization-best-practices
---

# Prioritization Best Practices

> Best Practices with Prioritization. tips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prioritization-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Prioritization Best Practices
...
## Ресурсы
- Оригинальный навык: `product/prioritization-best-practices/SKILL.md`
