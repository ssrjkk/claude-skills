...
version: "1.0"
language: ru
original: pmp-best-practices
---

# Pmp Best Practices

> Best Practices with PMP. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pmp-best-practices`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Pmp Best Practices
...
## Ресурсы
- Оригинальный навык: `product/pmp-best-practices/SKILL.md`
