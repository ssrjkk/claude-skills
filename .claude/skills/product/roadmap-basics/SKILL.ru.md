...
version: "1.0"
language: ru
original: roadmap-basics
---

# Roadmap Basics

> Basics with Roadmapping. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roadmap-basics`.

## Когда использовать
- Работа с Продукт-менеджмент
- Выполнение задач, связанных с Roadmap Basics
...
## Ресурсы
- Оригинальный навык: `product/roadmap-basics/SKILL.md`
