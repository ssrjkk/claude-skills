...
version: "1.0"
language: ru
original: azure-aks-examples
---

# Azure Aks Examples

> Examples for Azure-Aks: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `azure-aks-examples`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Azure Aks Examples
...
## Ресурсы
- Оригинал: cloud/azure-aks-examples/SKILL.md
- Категория: cloud
