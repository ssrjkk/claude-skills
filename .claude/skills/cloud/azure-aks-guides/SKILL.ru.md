...
version: "1.0"
language: ru
original: azure-aks-guides
---

# Azure Aks Guides

> Guides for Azure-Aks: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `azure-aks-guides`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Azure Aks Guides
...
## Ресурсы
- Оригинал: cloud/azure-aks-guides/SKILL.md
- Категория: cloud
