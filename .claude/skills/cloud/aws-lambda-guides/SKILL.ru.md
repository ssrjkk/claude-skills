...
version: "1.0"
language: ru
original: aws-lambda-guides
---

# Aws Lambda Guides

> Guides for Aws-Lambda: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `aws-lambda-guides`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Aws Lambda Guides
...
## Ресурсы
- Оригинал: cloud/aws-lambda-guides/SKILL.md
- Категория: cloud
