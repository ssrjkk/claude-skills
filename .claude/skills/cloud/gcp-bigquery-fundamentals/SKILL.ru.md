...
version: "1.0"
language: ru
original: gcp-bigquery-fundamentals
---

# Gcp Bigquery Fundamentals

> Fundamentals for Gcp-Bigquery: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `gcp-bigquery-fundamentals`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Gcp Bigquery Fundamentals
...
## Ресурсы
- Оригинал: cloud/gcp-bigquery-fundamentals/SKILL.md
- Категория: cloud
