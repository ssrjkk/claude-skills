...
version: "1.0"
language: ru
original: aws-eks-fundamentals
---

# Aws Eks Fundamentals

> Fundamentals for Aws-Eks: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `aws-eks-fundamentals`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Aws Eks Fundamentals
...
## Ресурсы
- Оригинал: cloud/aws-eks-fundamentals/SKILL.md
- Категория: cloud
