...
version: "1.0"
language: ru
original: azure-functions-fundamentals
---

# Azure Functions Fundamentals

> Fundamentals for Azure-Functions: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `azure-functions-fundamentals`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Azure Functions Fundamentals
...
## Ресурсы
- Оригинал: cloud/azure-functions-fundamentals/SKILL.md
- Категория: cloud
