...
category: cloud
tags: [gcp-gke-fundamentals, cloud, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gcp-gke-fundamentals
---

# Gcp Gke Fundamentals

> Fundamentals for Gcp-Gke: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `gcp-gke-fundamentals`.

## Когда использовать
- Работа с cloud
- Выполнение задач, связанных с Gcp Gke Fundamentals
...
## Ресурсы
- Оригинал: cloud/gcp-gke-fundamentals/SKILL.md
- Категория: cloud
