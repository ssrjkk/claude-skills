...
version: "1.0"
language: ru
original: project44-shipping
---

# Project44 Shipping

> Shipping with project44. shipping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `project44-shipping`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Project44 Shipping
...
## Ресурсы
- Оригинальный навык: `supply-chain/project44-shipping/SKILL.md`
