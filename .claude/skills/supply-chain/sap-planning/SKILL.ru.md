...
version: "1.0"
language: ru
original: sap-planning
---

# Sap Planning

> Planning with SAP SCM. demand planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-planning`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Sap Planning
...
## Ресурсы
- Оригинальный навык: `supply-chain/sap-planning/SKILL.md`
