...
version: "1.0"
language: ru
original: infor-transportation
---

# Infor Transportation

> Transportation with Infor SCM. TMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `infor-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Infor Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/infor-transportation/SKILL.md`
