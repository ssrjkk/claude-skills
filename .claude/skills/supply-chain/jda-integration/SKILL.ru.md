...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jda-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Jda Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/jda-integration/SKILL.md`
