...
version: "1.0"
language: ru
original: blue-yonder-integration
---

# Blue Yonder Integration

> Integration with Blue Yonder. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blue-yonder-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Blue Yonder Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/blue-yonder-integration/SKILL.md`
