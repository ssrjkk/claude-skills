...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jda-inventory`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Jda Inventory
...
## Ресурсы
- Оригинальный навык: `supply-chain/jda-inventory/SKILL.md`
