...
tags: [sap-setup, supply-chain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sap-setup
...
> Setup with SAP SCM. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Sap Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/sap-setup/SKILL.md`
