...
version: "1.0"
language: ru
original: sap-integration
---

# Sap Integration

> Integration with SAP SCM. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Sap Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/sap-integration/SKILL.md`
