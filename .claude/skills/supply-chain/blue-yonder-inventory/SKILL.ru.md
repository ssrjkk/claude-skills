...
version: "1.0"
language: ru
original: blue-yonder-inventory
---

# Blue Yonder Inventory

> Inventory with Blue Yonder. inventory mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blue-yonder-inventory`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Blue Yonder Inventory
...
## Ресурсы
- Оригинальный навык: `supply-chain/blue-yonder-inventory/SKILL.md`
