...
version: "1.0"
language: ru
original: highjump-inventory
---

# Highjump Inventory

> Inventory with HighJump. inventory mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `highjump-inventory`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Highjump Inventory
...
## Ресурсы
- Оригинальный навык: `supply-chain/highjump-inventory/SKILL.md`
