...
version: "1.0"
language: ru
original: manhattan-integration
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `manhattan-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Manhattan Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/manhattan-integration/SKILL.md`
