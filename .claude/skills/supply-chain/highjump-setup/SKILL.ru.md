...
version: "1.0"
language: ru
original: highjump-setup
---

# Highjump Setup

> Setup with HighJump. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `highjump-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Highjump Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/highjump-setup/SKILL.md`
