...
version: "1.0"
language: ru
original: infor-planning
---

# Infor Planning

> Planning with Infor SCM. demand planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `infor-planning`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Infor Planning
...
## Ресурсы
- Оригинальный навык: `supply-chain/infor-planning/SKILL.md`
