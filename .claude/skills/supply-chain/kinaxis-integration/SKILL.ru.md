...
version: "1.0"
language: ru
original: kinaxis-integration
---

# Kinaxis Integration

> Integration with Kinaxis. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-integration/SKILL.md`
