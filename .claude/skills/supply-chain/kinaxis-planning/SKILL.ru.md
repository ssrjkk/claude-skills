...
version: "1.0"
language: ru
original: kinaxis-planning
---

# Kinaxis Planning

> Planning with Kinaxis. demand planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-planning`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Planning
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-planning/SKILL.md`
