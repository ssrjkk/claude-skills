...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jda-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Jda Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/jda-transportation/SKILL.md`
