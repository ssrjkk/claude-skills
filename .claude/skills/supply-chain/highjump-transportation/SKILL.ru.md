...
version: "1.0"
language: ru
original: highjump-transportation
---

# Highjump Transportation

> Transportation with HighJump. TMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `highjump-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Highjump Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/highjump-transportation/SKILL.md`
