...
version: "1.0"
language: ru
original: kinaxis-setup
---

# Kinaxis Setup

> Setup with Kinaxis. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-setup/SKILL.md`
