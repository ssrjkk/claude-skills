...
version: "1.0"
language: ru
original: oracle-scm-warehousing
---

# Oracle Scm Warehousing

> Warehousing with Oracle SCM. WMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-scm-warehousing`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Oracle Scm Warehousing
...
## Ресурсы
- Оригинальный навык: `supply-chain/oracle-scm-warehousing/SKILL.md`
