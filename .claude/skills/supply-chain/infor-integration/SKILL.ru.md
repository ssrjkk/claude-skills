...
version: "1.0"
language: ru
original: infor-integration
---

# Infor Integration

> Integration with Infor SCM. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `infor-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Infor Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/infor-integration/SKILL.md`
