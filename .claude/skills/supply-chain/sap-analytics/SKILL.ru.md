...
version: "1.0"
language: ru
original: sap-analytics
---

# Sap Analytics

> Analytics with SAP SCM. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Sap Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/sap-analytics/SKILL.md`
