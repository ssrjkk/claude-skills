...
version: "1.0"
language: ru
original: shipstation-setup
---

# Shipstation Setup

> Setup with ShipStation. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shipstation-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Shipstation Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/shipstation-setup/SKILL.md`
