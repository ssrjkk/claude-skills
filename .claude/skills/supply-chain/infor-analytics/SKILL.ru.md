...
version: "1.0"
language: ru
original: infor-analytics
---

# Infor Analytics

> Analytics with Infor SCM. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `infor-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Infor Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/infor-analytics/SKILL.md`
