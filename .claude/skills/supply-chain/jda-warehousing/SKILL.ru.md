...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jda-warehousing`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Jda Warehousing
...
## Ресурсы
- Оригинальный навык: `supply-chain/jda-warehousing/SKILL.md`
