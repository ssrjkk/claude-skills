...
version: "1.0"
language: ru
original: project44-integration
---

# Project44 Integration

> Integration with project44. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `project44-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Project44 Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/project44-integration/SKILL.md`
