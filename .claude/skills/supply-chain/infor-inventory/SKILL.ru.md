...
version: "1.0"
language: ru
original: infor-inventory
---

# Infor Inventory

> Inventory with Infor SCM. inventory mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `infor-inventory`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Infor Inventory
...
## Ресурсы
- Оригинальный навык: `supply-chain/infor-inventory/SKILL.md`
