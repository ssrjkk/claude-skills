...
version: "1.0"
language: ru
original: sap-warehousing
---

# Sap Warehousing

> Warehousing with SAP SCM. WMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-warehousing`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Sap Warehousing
...
## Ресурсы
- Оригинальный навык: `supply-chain/sap-warehousing/SKILL.md`
