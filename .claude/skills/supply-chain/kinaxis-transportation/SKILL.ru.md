...
version: "1.0"
language: ru
original: kinaxis-transportation
---

# Kinaxis Transportation

> Transportation with Kinaxis. TMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-transportation/SKILL.md`
