...
version: "1.0"
language: ru
original: flexport-integration
---

# Flexport Integration

> Integration with Flexport. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flexport-integration`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Flexport Integration
...
## Ресурсы
- Оригинальный навык: `supply-chain/flexport-integration/SKILL.md`
