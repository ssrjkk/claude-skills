...
version: "1.0"
language: ru
original: manhattan-warehousing
---

# Manhattan Warehousing

> Warehousing with Manhattan Associates. WMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `manhattan-warehousing`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Manhattan Warehousing
...
## Ресурсы
- Оригинальный навык: `supply-chain/manhattan-warehousing/SKILL.md`
