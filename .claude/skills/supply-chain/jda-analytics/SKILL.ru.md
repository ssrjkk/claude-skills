...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jda-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Jda Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/jda-analytics/SKILL.md`
