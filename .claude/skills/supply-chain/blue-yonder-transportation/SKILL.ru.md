...
version: "1.0"
language: ru
original: blue-yonder-transportation
---

# Blue Yonder Transportation

> Transportation with Blue Yonder. TMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blue-yonder-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Blue Yonder Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/blue-yonder-transportation/SKILL.md`
