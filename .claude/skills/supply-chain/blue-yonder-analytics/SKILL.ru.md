...
version: "1.0"
language: ru
original: blue-yonder-analytics
---

# Blue Yonder Analytics

> Analytics with Blue Yonder. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blue-yonder-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Blue Yonder Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/blue-yonder-analytics/SKILL.md`
