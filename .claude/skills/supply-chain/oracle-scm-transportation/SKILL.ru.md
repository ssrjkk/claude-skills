...
version: "1.0"
language: ru
original: oracle-scm-transportation
---

# Oracle Scm Transportation

> Transportation with Oracle SCM. TMS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oracle-scm-transportation`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Oracle Scm Transportation
...
## Ресурсы
- Оригинальный навык: `supply-chain/oracle-scm-transportation/SKILL.md`
