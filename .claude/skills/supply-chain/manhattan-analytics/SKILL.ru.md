...
## Быстрый старт
Этот навык на русском языке. Оригинал: `manhattan-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Manhattan Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/manhattan-analytics/SKILL.md`
