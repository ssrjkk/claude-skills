...
version: "1.0"
language: ru
original: highjump-analytics
---

# Highjump Analytics

> Analytics with HighJump. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `highjump-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Highjump Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/highjump-analytics/SKILL.md`
