...
version: "1.0"
language: ru
original: kinaxis-inventory
---

# Kinaxis Inventory

> Inventory with Kinaxis. inventory mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-inventory`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Inventory
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-inventory/SKILL.md`
