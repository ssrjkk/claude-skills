...
tags: [tive-setup, supply-chain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tive-setup
...
> Setup with Tive. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tive-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Tive Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/tive-setup/SKILL.md`
