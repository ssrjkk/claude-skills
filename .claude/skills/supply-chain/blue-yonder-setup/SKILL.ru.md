...
version: "1.0"
language: ru
original: blue-yonder-setup
---

# Blue Yonder Setup

> Setup with Blue Yonder. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blue-yonder-setup`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Blue Yonder Setup
...
## Ресурсы
- Оригинальный навык: `supply-chain/blue-yonder-setup/SKILL.md`
