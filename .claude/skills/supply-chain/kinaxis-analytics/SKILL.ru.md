...
version: "1.0"
language: ru
original: kinaxis-analytics
---

# Kinaxis Analytics

> Analytics with Kinaxis. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinaxis-analytics`.

## Когда использовать
- Работа с Цепочки поставок
- Выполнение задач, связанных с Kinaxis Analytics
...
## Ресурсы
- Оригинальный навык: `supply-chain/kinaxis-analytics/SKILL.md`
