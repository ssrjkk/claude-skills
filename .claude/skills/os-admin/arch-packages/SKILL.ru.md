...
version: "1.0"
language: ru
original: arch-packages
---

# Arch Packages

> Packages with Arch Linux. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-packages/SKILL.md`
