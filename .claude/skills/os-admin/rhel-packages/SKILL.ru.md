...
version: "1.0"
language: ru
original: rhel-packages
---

# Rhel Packages

> Packages with RHEL. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-packages/SKILL.md`
