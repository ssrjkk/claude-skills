...
version: "1.0"
language: ru
original: arch-automation
---

# Arch Automation

> Automation with Arch Linux. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-automation/SKILL.md`
