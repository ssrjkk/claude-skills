...
version: "1.0"
language: ru
original: windows-server-users
---

# Windows Server Users

> Users with Windows Server. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-server-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Server Users
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-server-users/SKILL.md`
