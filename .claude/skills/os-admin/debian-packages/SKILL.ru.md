...
> Packages with Debian. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-packages/SKILL.md`
