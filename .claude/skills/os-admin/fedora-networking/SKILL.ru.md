...
category: os-admin
tags: [fedora-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fedora-networking
---

# Fedora Networking

> Networking with Fedora. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-networking/SKILL.md`
