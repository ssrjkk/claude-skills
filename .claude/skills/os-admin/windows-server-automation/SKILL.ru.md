...
version: "1.0"
language: ru
original: windows-server-automation
---

# Windows Server Automation

> Automation with Windows Server. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-server-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Server Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-server-automation/SKILL.md`
