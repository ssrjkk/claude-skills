...
category: os-admin
tags: [active-directory-backup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: active-directory-backup
---

# Active Directory Backup

> Backup with Active Directory. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `active-directory-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Active Directory Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/active-directory-backup/SKILL.md`
