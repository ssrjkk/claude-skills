...
> Users with SUSE. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Users
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-users/SKILL.md`
