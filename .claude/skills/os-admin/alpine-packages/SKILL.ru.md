...
version: "1.0"
language: ru
original: alpine-packages
---

# Alpine Packages

> Packages with Alpine Linux. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Alpine Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/alpine-packages/SKILL.md`
