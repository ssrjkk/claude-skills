...
category: os-admin
tags: [centos-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: centos-users
---

# Centos Users

> Users with CentOS. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Users
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-users/SKILL.md`
