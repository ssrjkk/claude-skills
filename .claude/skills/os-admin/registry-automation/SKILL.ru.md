...
category: os-admin
tags: [registry-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: registry-automation
---

# Registry Automation

> Automation with Windows Registry. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `registry-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Registry Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/registry-automation/SKILL.md`
