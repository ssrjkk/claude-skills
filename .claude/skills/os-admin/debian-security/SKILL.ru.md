...
version: "1.0"
language: ru
original: debian-security
---

# Debian Security

> Security with Debian. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Security
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-security/SKILL.md`
