...
version: "1.0"
language: ru
original: registry-users
---

# Registry Users

> Users with Windows Registry. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `registry-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Registry Users
...
## Ресурсы
- Оригинальный навык: `os-admin/registry-users/SKILL.md`
