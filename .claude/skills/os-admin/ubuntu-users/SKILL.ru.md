...
category: os-admin
tags: [ubuntu-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ubuntu-users
---

# Ubuntu Users

> Users with Ubuntu. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Users
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-users/SKILL.md`
