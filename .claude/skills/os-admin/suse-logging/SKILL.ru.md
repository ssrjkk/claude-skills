...
version: "1.0"
language: ru
original: suse-logging
---

# Suse Logging

> Logging with SUSE. logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-logging`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Logging
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-logging/SKILL.md`
