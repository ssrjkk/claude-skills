...
version: "1.0"
language: ru
original: iis-automation
---

# Iis Automation

> Automation with IIS. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iis-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Iis Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/iis-automation/SKILL.md`
