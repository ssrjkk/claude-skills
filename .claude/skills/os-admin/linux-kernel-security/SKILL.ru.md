...
category: os-admin
tags: [linux-kernel-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linux-kernel-security
---

# Linux Kernel Security

> Security with Linux Kernel. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-kernel-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Kernel Security
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-kernel-security/SKILL.md`
