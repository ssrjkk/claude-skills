...
category: os-admin
tags: [registry-iis, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: registry-iis
---

# Registry Iis

> IIS with Windows Registry. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `registry-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Registry Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/registry-iis/SKILL.md`
