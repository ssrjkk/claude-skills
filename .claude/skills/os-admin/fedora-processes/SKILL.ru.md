...
version: "1.0"
language: ru
original: fedora-processes
---

# Fedora Processes

> Processes with Fedora. process management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-processes`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Processes
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-processes/SKILL.md`
