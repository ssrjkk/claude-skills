...
category: os-admin
tags: [debian-backup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: debian-backup
---

# Debian Backup

> Backup with Debian. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-backup/SKILL.md`
