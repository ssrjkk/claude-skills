...
version: "1.0"
language: ru
original: debian-logging
---

# Debian Logging

> Logging with Debian. logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-logging`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Logging
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-logging/SKILL.md`
