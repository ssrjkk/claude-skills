...
version: "1.0"
language: ru
original: linux-security-backup
---

# Linux Security Backup

> Backup with Linux Security. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-backup/SKILL.md`
