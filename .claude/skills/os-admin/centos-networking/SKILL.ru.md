...
category: os-admin
tags: [centos-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: centos-networking
---

# Centos Networking

> Networking with CentOS. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-networking/SKILL.md`
