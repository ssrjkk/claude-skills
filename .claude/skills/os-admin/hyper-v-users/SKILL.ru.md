...
category: os-admin
tags: [hyper-v-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hyper-v-users
---

# Hyper V Users

> Users with Hyper-V. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Users
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-users/SKILL.md`
