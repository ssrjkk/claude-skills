...
category: os-admin
tags: [powershell-backup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: powershell-backup
---

# Powershell Backup

> Backup with PowerShell. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-backup/SKILL.md`
