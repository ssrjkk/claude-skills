...
version: "1.0"
language: ru
original: linux-kernel-automation
---

# Linux Kernel Automation

> Automation with Linux Kernel. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-kernel-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Kernel Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-kernel-automation/SKILL.md`
