...
version: "1.0"
language: ru
original: registry-networking
---

# Registry Networking

> Networking with Windows Registry. network.

## Быстрый старт
Этот навык на русском языке. Оригинал: `registry-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Registry Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/registry-networking/SKILL.md`
