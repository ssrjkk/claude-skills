...
category: os-admin
tags: [systemd-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: systemd-users
---

# Systemd Users

> Users with systemd. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Users
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-users/SKILL.md`
