...
category: os-admin
tags: [windows-server-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: windows-server-security
---

# Windows Server Security

> Security with Windows Server. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-server-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Server Security
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-server-security/SKILL.md`
