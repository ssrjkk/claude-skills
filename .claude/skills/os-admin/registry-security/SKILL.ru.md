...
version: "1.0"
language: ru
original: registry-security
---

# Registry Security

> Security with Windows Registry. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `registry-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Registry Security
...
## Ресурсы
- Оригинальный навык: `os-admin/registry-security/SKILL.md`
