...
version: "1.0"
language: ru
original: fedora-backup
---

# Fedora Backup

> Backup with Fedora. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-backup/SKILL.md`
