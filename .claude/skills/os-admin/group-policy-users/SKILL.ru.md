...
category: os-admin
tags: [group-policy-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: group-policy-users
---

# Group Policy Users

> Users with Group Policy. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Users
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-users/SKILL.md`
