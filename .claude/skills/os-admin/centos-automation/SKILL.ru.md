...
category: os-admin
tags: [centos-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: centos-automation
---

# Centos Automation

> Automation with CentOS. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-automation/SKILL.md`
