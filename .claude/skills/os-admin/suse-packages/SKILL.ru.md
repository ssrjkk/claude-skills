...
version: "1.0"
language: ru
original: suse-packages
---

# Suse Packages

> Packages with SUSE. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-packages/SKILL.md`
