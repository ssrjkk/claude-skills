...
version: "1.0"
language: ru
original: centos-setup
---

# Centos Setup

> Setup with CentOS. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-setup/SKILL.md`
