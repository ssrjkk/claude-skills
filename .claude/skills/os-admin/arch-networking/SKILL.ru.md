...
version: "1.0"
language: ru
original: arch-networking
---

# Arch Networking

> Networking with Arch Linux. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-networking/SKILL.md`
