...
version: "1.0"
language: ru
original: windows-server-setup
---

# Windows Server Setup

> Setup with Windows Server. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-server-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Server Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-server-setup/SKILL.md`
