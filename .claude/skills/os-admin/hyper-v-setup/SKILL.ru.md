...
category: os-admin
tags: [hyper-v-setup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hyper-v-setup
---

# Hyper V Setup

> Setup with Hyper-V. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-setup/SKILL.md`
