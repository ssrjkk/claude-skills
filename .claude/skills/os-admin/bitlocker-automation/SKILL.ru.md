...
category: os-admin
tags: [bitlocker-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bitlocker-automation
---

# Bitlocker Automation

> Automation with BitLocker. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-automation/SKILL.md`
