...
category: os-admin
tags: [systemd-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: systemd-automation
---

# Systemd Automation

> Automation with systemd. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-automation/SKILL.md`
