...
category: os-admin
tags: [ubuntu-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ubuntu-security
---

# Ubuntu Security

> Security with Ubuntu. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Security
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-security/SKILL.md`
