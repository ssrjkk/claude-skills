...
version: "1.0"
language: ru
original: ubuntu-backup
---

# Ubuntu Backup

> Backup with Ubuntu. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-backup/SKILL.md`
