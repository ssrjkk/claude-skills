...
version: "1.0"
language: ru
original: suse-security
---

# Suse Security

> Security with SUSE. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Security
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-security/SKILL.md`
