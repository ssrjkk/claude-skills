...
category: os-admin
tags: [bash-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bash-users
...
> Users with Bash Scripting. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bash-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bash Users
...
## Ресурсы
- Оригинальный навык: `os-admin/bash-users/SKILL.md`
