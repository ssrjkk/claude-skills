...
category: os-admin
tags: [ubuntu-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ubuntu-networking
---

# Ubuntu Networking

> Networking with Ubuntu. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-networking/SKILL.md`
