...
version: "1.0"
language: ru
original: powershell-monitoring
---

# Powershell Monitoring

> Monitoring with PowerShell. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-monitoring`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Monitoring
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-monitoring/SKILL.md`
