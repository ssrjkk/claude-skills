...
> Setup with Debian. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-setup/SKILL.md`
