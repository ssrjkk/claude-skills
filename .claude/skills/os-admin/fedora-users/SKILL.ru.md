...
version: "1.0"
language: ru
original: fedora-users
---

# Fedora Users

> Users with Fedora. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Users
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-users/SKILL.md`
