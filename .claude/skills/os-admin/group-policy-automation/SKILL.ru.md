...
version: "1.0"
language: ru
original: group-policy-automation
---

# Group Policy Automation

> Automation with Group Policy. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-automation/SKILL.md`
