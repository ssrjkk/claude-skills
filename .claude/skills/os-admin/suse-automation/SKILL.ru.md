...
category: os-admin
tags: [suse-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: suse-automation
---

# Suse Automation

> Automation with SUSE. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-automation/SKILL.md`
