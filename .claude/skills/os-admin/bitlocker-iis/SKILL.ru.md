...
version: "1.0"
language: ru
original: bitlocker-iis
---

# Bitlocker Iis

> IIS with BitLocker. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-iis/SKILL.md`
