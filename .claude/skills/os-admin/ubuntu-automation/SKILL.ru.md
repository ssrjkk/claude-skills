...
category: os-admin
tags: [ubuntu-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ubuntu-automation
---

# Ubuntu Automation

> Automation with Ubuntu. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-automation/SKILL.md`
