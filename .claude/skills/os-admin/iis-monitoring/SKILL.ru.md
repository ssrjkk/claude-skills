...
version: "1.0"
language: ru
original: iis-monitoring
---

# Iis Monitoring

> Monitoring with IIS. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iis-monitoring`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Iis Monitoring
...
## Ресурсы
- Оригинальный навык: `os-admin/iis-monitoring/SKILL.md`
