...
version: "1.0"
language: ru
original: systemd-security
---

# Systemd Security

> Security with systemd. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Security
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-security/SKILL.md`
