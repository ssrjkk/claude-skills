...
version: "1.0"
language: ru
original: alpine-users
---

# Alpine Users

> Users with Alpine Linux. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Alpine Users
...
## Ресурсы
- Оригинальный навык: `os-admin/alpine-users/SKILL.md`
