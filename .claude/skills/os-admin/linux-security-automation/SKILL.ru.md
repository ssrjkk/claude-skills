...
version: "1.0"
language: ru
original: linux-security-automation
---

# Linux Security Automation

> Automation with Linux Security. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-automation/SKILL.md`
