...
version: "1.0"
language: ru
original: linux-security-packages
---

# Linux Security Packages

> Packages with Linux Security. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-packages/SKILL.md`
