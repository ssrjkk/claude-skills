...
version: "1.0"
language: ru
original: bitlocker-setup
---

# Bitlocker Setup

> Setup with BitLocker. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-setup/SKILL.md`
