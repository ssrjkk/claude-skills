...
version: "1.0"
language: ru
original: iis-networking
---

# Iis Networking

> Networking with IIS. network.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iis-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Iis Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/iis-networking/SKILL.md`
