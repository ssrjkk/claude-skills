...
version: "1.0"
language: ru
original: bitlocker-monitoring
---

# Bitlocker Monitoring

> Monitoring with BitLocker. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-monitoring`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Monitoring
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-monitoring/SKILL.md`
