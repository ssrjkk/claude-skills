...
> Users with RHEL. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Users
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-users/SKILL.md`
