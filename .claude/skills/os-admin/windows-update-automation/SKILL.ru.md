...
category: os-admin
tags: [windows-update-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: windows-update-automation
---

# Windows Update Automation

> Automation with Windows Update. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-update-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Update Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-update-automation/SKILL.md`
