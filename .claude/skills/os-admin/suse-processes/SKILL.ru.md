...
version: "1.0"
language: ru
original: suse-processes
---

# Suse Processes

> Processes with SUSE. process management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `suse-processes`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Suse Processes
...
## Ресурсы
- Оригинальный навык: `os-admin/suse-processes/SKILL.md`
