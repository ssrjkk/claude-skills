...
version: "1.0"
language: ru
original: powershell-networking
---

# Powershell Networking

> Networking with PowerShell. network.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-networking/SKILL.md`
