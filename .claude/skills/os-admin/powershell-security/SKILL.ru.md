...
version: "1.0"
language: ru
original: powershell-security
---

# Powershell Security

> Security with PowerShell. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Security
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-security/SKILL.md`
