...
version: "1.0"
language: ru
original: active-directory-setup
---

# Active Directory Setup

> Setup with Active Directory. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `active-directory-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Active Directory Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/active-directory-setup/SKILL.md`
