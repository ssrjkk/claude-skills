...
version: "1.0"
language: ru
original: hyper-v-security
---

# Hyper V Security

> Security with Hyper-V. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Security
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-security/SKILL.md`
