...
version: "1.0"
language: ru
original: performance-monitor-iis
---

# Performance Monitor Iis

> IIS with Performance Monitor. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `performance-monitor-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Performance Monitor Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/performance-monitor-iis/SKILL.md`
