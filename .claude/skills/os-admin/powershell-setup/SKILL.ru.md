...
version: "1.0"
language: ru
original: powershell-setup
---

# Powershell Setup

> Setup with PowerShell. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-setup/SKILL.md`
