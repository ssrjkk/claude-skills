...
version: "1.0"
language: ru
original: windows-update-iis
---

# Windows Update Iis

> IIS with Windows Update. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-update-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Update Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-update-iis/SKILL.md`
