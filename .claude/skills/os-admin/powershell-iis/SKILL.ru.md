...
category: os-admin
tags: [powershell-iis, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: powershell-iis
---

# Powershell Iis

> IIS with PowerShell. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-iis/SKILL.md`
