...
version: "1.0"
language: ru
original: powershell-users
---

# Powershell Users

> Users with PowerShell. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Users
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-users/SKILL.md`
