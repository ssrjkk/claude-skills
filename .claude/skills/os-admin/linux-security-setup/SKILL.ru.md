...
version: "1.0"
language: ru
original: linux-security-setup
---

# Linux Security Setup

> Setup with Linux Security. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-setup/SKILL.md`
