...
version: "1.0"
language: ru
original: bitlocker-backup
---

# Bitlocker Backup

> Backup with BitLocker. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-backup/SKILL.md`
