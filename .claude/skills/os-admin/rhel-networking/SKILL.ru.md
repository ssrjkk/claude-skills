...
category: os-admin
tags: [rhel-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rhel-networking
---

# Rhel Networking

> Networking with RHEL. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-networking/SKILL.md`
