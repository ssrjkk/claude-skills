...
> Users with Arch Linux. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Users
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-users/SKILL.md`
