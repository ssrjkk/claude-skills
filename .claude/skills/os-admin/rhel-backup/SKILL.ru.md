...
version: "1.0"
language: ru
original: rhel-backup
---

# Rhel Backup

> Backup with RHEL. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-backup/SKILL.md`
