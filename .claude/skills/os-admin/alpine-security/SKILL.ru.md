...
version: "1.0"
language: ru
original: alpine-security
---

# Alpine Security

> Security with Alpine Linux. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Alpine Security
...
## Ресурсы
- Оригинальный навык: `os-admin/alpine-security/SKILL.md`
