...
> Setup with RHEL. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-setup/SKILL.md`
