...
category: os-admin
tags: [active-directory-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: active-directory-networking
---

# Active Directory Networking

> Networking with Active Directory. network.

## Быстрый старт
Этот навык на русском языке. Оригинал: `active-directory-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Active Directory Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/active-directory-networking/SKILL.md`
