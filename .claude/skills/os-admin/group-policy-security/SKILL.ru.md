...
category: os-admin
tags: [group-policy-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: group-policy-security
---

# Group Policy Security

> Security with Group Policy. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Security
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-security/SKILL.md`
