...
version: "1.0"
language: ru
original: bitlocker-users
---

# Bitlocker Users

> Users with BitLocker. user mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bitlocker-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Bitlocker Users
...
## Ресурсы
- Оригинальный навык: `os-admin/bitlocker-users/SKILL.md`
