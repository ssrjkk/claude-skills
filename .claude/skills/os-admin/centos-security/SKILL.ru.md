...
category: os-admin
tags: [centos-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: centos-security
---

# Centos Security

> Security with CentOS. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Security
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-security/SKILL.md`
