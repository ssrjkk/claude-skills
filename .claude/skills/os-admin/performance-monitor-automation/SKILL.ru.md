...
version: "1.0"
language: ru
original: performance-monitor-automation
---

# Performance Monitor Automation

> Automation with Performance Monitor. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `performance-monitor-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Performance Monitor Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/performance-monitor-automation/SKILL.md`
