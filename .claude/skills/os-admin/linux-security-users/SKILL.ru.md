...
category: os-admin
tags: [linux-security-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linux-security-users
---

# Linux Security Users

> Users with Linux Security. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Users
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-users/SKILL.md`
