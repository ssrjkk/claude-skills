...
version: "1.0"
language: ru
original: hyper-v-backup
---

# Hyper V Backup

> Backup with Hyper-V. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-backup/SKILL.md`
