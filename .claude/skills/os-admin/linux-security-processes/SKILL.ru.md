...
category: os-admin
tags: [linux-security-processes, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linux-security-processes
---

# Linux Security Processes

> Processes with Linux Security. process management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-processes`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Processes
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-processes/SKILL.md`
