...
version: "1.0"
language: ru
original: rhel-logging
---

# Rhel Logging

> Logging with RHEL. logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-logging`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Logging
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-logging/SKILL.md`
