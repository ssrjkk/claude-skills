...
category: os-admin
tags: [arch-setup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arch-setup
...
> Setup with Arch Linux. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-setup/SKILL.md`
