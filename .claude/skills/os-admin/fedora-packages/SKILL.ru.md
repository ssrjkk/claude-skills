...
> Packages with Fedora. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-packages/SKILL.md`
