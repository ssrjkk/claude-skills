...
version: "1.0"
language: ru
original: arch-backup
---

# Arch Backup

> Backup with Arch Linux. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-backup/SKILL.md`
