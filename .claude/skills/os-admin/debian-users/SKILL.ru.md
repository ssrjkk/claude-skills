...
category: os-admin
tags: [debian-users, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: debian-users
---

# Debian Users

> Users with Debian. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Users
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-users/SKILL.md`
