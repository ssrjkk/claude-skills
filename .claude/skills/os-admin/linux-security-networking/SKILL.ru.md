...
version: "1.0"
language: ru
original: linux-security-networking
---

# Linux Security Networking

> Networking with Linux Security. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-networking/SKILL.md`
