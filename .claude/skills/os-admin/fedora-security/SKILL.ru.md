...
version: "1.0"
language: ru
original: fedora-security
---

# Fedora Security

> Security with Fedora. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Security
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-security/SKILL.md`
