...
version: "1.0"
language: ru
original: hyper-v-automation
---

# Hyper V Automation

> Automation with Hyper-V. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-automation/SKILL.md`
