...
version: "1.0"
language: ru
original: linux-kernel-users
---

# Linux Kernel Users

> Users with Linux Kernel. user management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-kernel-users`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Kernel Users
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-kernel-users/SKILL.md`
