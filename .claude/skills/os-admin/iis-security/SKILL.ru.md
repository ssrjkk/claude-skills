...
category: os-admin
tags: [iis-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: iis-security
---

# Iis Security

> Security with IIS. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iis-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Iis Security
...
## Ресурсы
- Оригинальный навык: `os-admin/iis-security/SKILL.md`
