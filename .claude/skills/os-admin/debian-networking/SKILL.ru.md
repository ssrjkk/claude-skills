...
category: os-admin
tags: [debian-networking, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: debian-networking
---

# Debian Networking

> Networking with Debian. network config.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-networking/SKILL.md`
