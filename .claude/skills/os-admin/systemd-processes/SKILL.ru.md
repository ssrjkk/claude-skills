...
version: "1.0"
language: ru
original: systemd-processes
---

# Systemd Processes

> Processes with systemd. process management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-processes`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Processes
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-processes/SKILL.md`
