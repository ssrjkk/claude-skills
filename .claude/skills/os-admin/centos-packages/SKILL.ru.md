...
version: "1.0"
language: ru
original: centos-packages
---

# Centos Packages

> Packages with CentOS. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `centos-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Centos Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/centos-packages/SKILL.md`
