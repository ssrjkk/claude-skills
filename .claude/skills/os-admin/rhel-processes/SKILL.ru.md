...
category: os-admin
tags: [rhel-processes, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rhel-processes
---

# Rhel Processes

> Processes with RHEL. process management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-processes`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Processes
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-processes/SKILL.md`
