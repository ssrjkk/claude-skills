...
category: os-admin
tags: [systemd-backup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: systemd-backup
---

# Systemd Backup

> Backup with systemd. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-backup/SKILL.md`
