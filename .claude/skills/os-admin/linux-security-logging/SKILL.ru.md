...
version: "1.0"
language: ru
original: linux-security-logging
---

# Linux Security Logging

> Logging with Linux Security. logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linux-security-logging`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Linux Security Logging
...
## Ресурсы
- Оригинальный навык: `os-admin/linux-security-logging/SKILL.md`
