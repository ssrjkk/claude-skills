...
category: os-admin
tags: [group-policy-backup, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: group-policy-backup
---

# Group Policy Backup

> Backup with Group Policy. backup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-backup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Backup
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-backup/SKILL.md`
