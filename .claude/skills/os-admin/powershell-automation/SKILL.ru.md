...
> Automation with PowerShell. PowerShell.

## Быстрый старт
Этот навык на русском языке. Оригинал: `powershell-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Powershell Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/powershell-automation/SKILL.md`
