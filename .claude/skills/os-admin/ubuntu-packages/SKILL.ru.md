...
category: os-admin
tags: [ubuntu-packages, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ubuntu-packages
---

# Ubuntu Packages

> Packages with Ubuntu. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ubuntu-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Ubuntu Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/ubuntu-packages/SKILL.md`
