...
version: "1.0"
language: ru
original: systemd-packages
---

# Systemd Packages

> Packages with systemd. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `systemd-packages`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Systemd Packages
...
## Ресурсы
- Оригинальный навык: `os-admin/systemd-packages/SKILL.md`
