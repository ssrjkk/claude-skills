...
version: "1.0"
language: ru
original: alpine-automation
---

# Alpine Automation

> Automation with Alpine Linux. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Alpine Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/alpine-automation/SKILL.md`
