...
category: os-admin
tags: [fedora-automation, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fedora-automation
---

# Fedora Automation

> Automation with Fedora. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fedora-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Fedora Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/fedora-automation/SKILL.md`
