...
version: "1.0"
language: ru
original: group-policy-setup
---

# Group Policy Setup

> Setup with Group Policy. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-setup`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Setup
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-setup/SKILL.md`
