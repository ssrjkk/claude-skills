...
category: os-admin
tags: [rhel-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rhel-security
---

# Rhel Security

> Security with RHEL. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rhel-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Rhel Security
...
## Ресурсы
- Оригинальный навык: `os-admin/rhel-security/SKILL.md`
