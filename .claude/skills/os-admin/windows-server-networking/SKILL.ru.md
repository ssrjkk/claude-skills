...
version: "1.0"
language: ru
original: windows-server-networking
---

# Windows Server Networking

> Networking with Windows Server. network.

## Быстрый старт
Этот навык на русском языке. Оригинал: `windows-server-networking`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Windows Server Networking
...
## Ресурсы
- Оригинальный навык: `os-admin/windows-server-networking/SKILL.md`
