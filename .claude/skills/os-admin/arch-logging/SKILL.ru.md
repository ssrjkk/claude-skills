...
version: "1.0"
language: ru
original: arch-logging
---

# Arch Logging

> Logging with Arch Linux. logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-logging`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Logging
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-logging/SKILL.md`
