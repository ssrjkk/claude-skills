...
category: os-admin
tags: [active-directory-iis, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: active-directory-iis
---

# Active Directory Iis

> IIS with Active Directory. web server.

## Быстрый старт
Этот навык на русском языке. Оригинал: `active-directory-iis`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Active Directory Iis
...
## Ресурсы
- Оригинальный навык: `os-admin/active-directory-iis/SKILL.md`
