...
version: "1.0"
language: ru
original: hyper-v-monitoring
---

# Hyper V Monitoring

> Monitoring with Hyper-V. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hyper-v-monitoring`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Hyper V Monitoring
...
## Ресурсы
- Оригинальный навык: `os-admin/hyper-v-monitoring/SKILL.md`
