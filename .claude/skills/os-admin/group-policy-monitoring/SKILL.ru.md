...
version: "1.0"
language: ru
original: group-policy-monitoring
---

# Group Policy Monitoring

> Monitoring with Group Policy. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `group-policy-monitoring`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Group Policy Monitoring
...
## Ресурсы
- Оригинальный навык: `os-admin/group-policy-monitoring/SKILL.md`
