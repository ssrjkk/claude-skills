...
version: "1.0"
language: ru
original: debian-automation
---

# Debian Automation

> Automation with Debian. scripting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `debian-automation`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Debian Automation
...
## Ресурсы
- Оригинальный навык: `os-admin/debian-automation/SKILL.md`
