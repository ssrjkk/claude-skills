...
category: os-admin
tags: [arch-security, os-admin, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arch-security
---

# Arch Security

> Security with Arch Linux. hardening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arch-security`.

## Когда использовать
- Работа с Администрирование
- Выполнение задач, связанных с Arch Security
...
## Ресурсы
- Оригинальный навык: `os-admin/arch-security/SKILL.md`
