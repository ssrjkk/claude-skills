...
version: "1.0"
language: ru
original: stellar-nft
---

# Stellar Nft

> NFT with Stellar. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
