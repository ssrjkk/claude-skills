...
version: "1.0"
language: ru
original: ethereum-bridge
---

# Ethereum Bridge

> Bridge with Ethereum. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ethereum-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Ethereum Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/ethereum-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
