...
category: blockchain
tags: [ethereum-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ethereum-dapps
---

# Ethereum Dapps

> DApps with Ethereum. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ethereum-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Ethereum Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/ethereum-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
