...
version: "1.0"
language: ru
original: polygon-tokens
---

# Polygon Tokens

> Tokens with Polygon. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polygon-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polygon Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/polygon-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
