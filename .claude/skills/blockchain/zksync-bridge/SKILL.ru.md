...
version: "1.0"
language: ru
original: zksync-bridge
---

# Zksync Bridge

> Bridge with zkSync. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
