...
version: "1.0"
language: ru
original: starknet-tokens
---

# Starknet Tokens

> Tokens with StarkNet. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
