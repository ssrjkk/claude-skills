...
category: blockchain
tags: [arbitrum-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arbitrum-defi
---

# Arbitrum Defi

> DeFi with Arbitrum. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arbitrum-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Arbitrum Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/arbitrum-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
