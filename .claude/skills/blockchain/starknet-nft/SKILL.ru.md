...
version: "1.0"
language: ru
original: starknet-nft
---

# Starknet Nft

> NFT with StarkNet. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
