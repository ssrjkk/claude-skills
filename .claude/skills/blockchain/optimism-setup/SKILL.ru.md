...
## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
