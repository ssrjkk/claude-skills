...
version: "1.0"
language: ru
original: solana-setup
---

# Solana Setup

> Setup with Solana. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
