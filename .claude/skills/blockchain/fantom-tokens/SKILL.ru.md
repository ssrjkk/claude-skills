...
version: "1.0"
language: ru
original: fantom-tokens
---

# Fantom Tokens

> Tokens with Fantom. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fantom-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Fantom Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/fantom-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
