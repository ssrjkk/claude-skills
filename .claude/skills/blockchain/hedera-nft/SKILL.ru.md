...
> NFT with Hedera. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
