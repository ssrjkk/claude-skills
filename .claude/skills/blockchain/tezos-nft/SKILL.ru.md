...
> NFT with Tezos. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
