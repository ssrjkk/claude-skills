...
category: blockchain
tags: [polkadot-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polkadot-defi
---

# Polkadot Defi

> DeFi with Polkadot. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polkadot-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polkadot Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/polkadot-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
