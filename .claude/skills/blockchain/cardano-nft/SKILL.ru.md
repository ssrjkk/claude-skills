...
category: blockchain
tags: [cardano-nft, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cardano-nft
---

# Cardano Nft

> NFT with Cardano. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cardano-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cardano Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/cardano-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
