...
category: blockchain
tags: [cosmos-nft, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cosmos-nft
...
> NFT with Cosmos. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
