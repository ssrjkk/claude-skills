...
version: "1.0"
language: ru
original: algorand-staking
---

# Algorand Staking

> Staking with Algorand. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
