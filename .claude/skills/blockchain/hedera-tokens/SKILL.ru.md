...
version: "1.0"
language: ru
original: hedera-tokens
---

# Hedera Tokens

> Tokens with Hedera. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
