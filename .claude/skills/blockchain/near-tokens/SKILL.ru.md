...
category: blockchain
tags: [near-tokens, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: near-tokens
---

# Near Tokens

> Tokens with NEAR. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `near-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Near Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/near-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
