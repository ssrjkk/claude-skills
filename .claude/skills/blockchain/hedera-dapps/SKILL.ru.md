...
version: "1.0"
language: ru
original: hedera-dapps
---

# Hedera Dapps

> DApps with Hedera. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
