...
version: "1.0"
language: ru
original: tezos-tokens
---

# Tezos Tokens

> Tokens with Tezos. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
