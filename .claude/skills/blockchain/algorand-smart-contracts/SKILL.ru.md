...
version: "1.0"
language: ru
original: algorand-smart-contracts
---

# Algorand Smart Contracts

> Smart Contracts with Algorand. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
