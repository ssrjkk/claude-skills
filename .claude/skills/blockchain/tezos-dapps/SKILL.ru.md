...
category: blockchain
tags: [tezos-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tezos-dapps
---

# Tezos Dapps

> DApps with Tezos. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
