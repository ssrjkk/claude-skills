...
## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
