...
version: "1.0"
language: ru
original: algorand-dapps
---

# Algorand Dapps

> DApps with Algorand. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
