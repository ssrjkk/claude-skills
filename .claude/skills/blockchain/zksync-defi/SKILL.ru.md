...
version: "1.0"
language: ru
original: zksync-defi
---

# Zksync Defi

> DeFi with zkSync. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
