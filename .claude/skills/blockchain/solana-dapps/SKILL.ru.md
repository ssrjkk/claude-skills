...
version: "1.0"
language: ru
original: solana-dapps
---

# Solana Dapps

> DApps with Solana. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
