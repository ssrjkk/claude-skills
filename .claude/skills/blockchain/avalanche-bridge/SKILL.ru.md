...
category: blockchain
tags: [avalanche-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avalanche-bridge
---

# Avalanche Bridge

> Bridge with Avalanche. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
