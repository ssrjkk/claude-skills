...
category: blockchain
tags: [hedera-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hedera-defi
---

# Hedera Defi

> DeFi with Hedera. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
