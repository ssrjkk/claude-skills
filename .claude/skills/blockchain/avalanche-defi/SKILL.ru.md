...
version: "1.0"
language: ru
original: avalanche-defi
---

# Avalanche Defi

> DeFi with Avalanche. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
