...
version: "1.0"
language: ru
original: cardano-dapps
---

# Cardano Dapps

> DApps with Cardano. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cardano-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cardano Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/cardano-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
