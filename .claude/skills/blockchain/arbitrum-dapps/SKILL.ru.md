...
category: blockchain
tags: [arbitrum-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arbitrum-dapps
---

# Arbitrum Dapps

> DApps with Arbitrum. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arbitrum-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Arbitrum Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/arbitrum-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
