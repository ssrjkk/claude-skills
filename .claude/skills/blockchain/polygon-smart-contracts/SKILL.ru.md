...
version: "1.0"
language: ru
original: polygon-smart-contracts
---

# Polygon Smart Contracts

> Smart Contracts with Polygon. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polygon-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polygon Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/polygon-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
