...
category: blockchain
tags: [cosmos-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cosmos-bridge
---

# Cosmos Bridge

> Bridge with Cosmos. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
