...
category: blockchain
tags: [web3js, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: web3js
...
> Integrates Web3.js for interacting with Ethereum blockchain from JavaScript/TypeScript. Use for DApp frontend development.

## Быстрый старт
Этот навык на русском языке. Оригинал: `web3js`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Web3Js
...
## Ресурсы
- Оригинальный навык: `blockchain/web3js/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
