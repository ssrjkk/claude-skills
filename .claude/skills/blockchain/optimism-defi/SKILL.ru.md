...
## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
