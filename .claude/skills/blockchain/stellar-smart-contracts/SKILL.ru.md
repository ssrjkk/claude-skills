...
version: "1.0"
language: ru
original: stellar-smart-contracts
---

# Stellar Smart Contracts

> Smart Contracts with Stellar. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
