...
version: "1.0"
language: ru
original: starknet-bridge
---

# Starknet Bridge

> Bridge with StarkNet. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
