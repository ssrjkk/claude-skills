...
category: blockchain
tags: [polkadot-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polkadot-dapps
---

# Polkadot Dapps

> DApps with Polkadot. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polkadot-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polkadot Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/polkadot-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
