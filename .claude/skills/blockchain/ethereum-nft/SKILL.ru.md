...
category: blockchain
tags: [ethereum-nft, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ethereum-nft
---

# Ethereum Nft

> NFT with Ethereum. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ethereum-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Ethereum Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/ethereum-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
