...
category: blockchain
tags: [stellar-tokens, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stellar-tokens
---

# Stellar Tokens

> Tokens with Stellar. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
