...
version: "1.0"
language: ru
original: cosmos-staking
---

# Cosmos Staking

> Staking with Cosmos. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
