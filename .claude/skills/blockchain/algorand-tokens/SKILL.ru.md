...
## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
