...
version: "1.0"
language: ru
original: solana-defi
---

# Solana Defi

> DeFi with Solana. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
