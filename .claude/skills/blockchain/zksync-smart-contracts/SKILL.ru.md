...
category: blockchain
tags: [zksync-smart-contracts, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zksync-smart-contracts
---

# Zksync Smart Contracts

> Smart Contracts with zkSync. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
