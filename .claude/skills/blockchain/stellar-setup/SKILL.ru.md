...
version: "1.0"
language: ru
original: stellar-setup
---

# Stellar Setup

> Setup with Stellar. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
