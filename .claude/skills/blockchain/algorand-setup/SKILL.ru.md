...
## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
