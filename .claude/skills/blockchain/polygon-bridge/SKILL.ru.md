...
version: "1.0"
language: ru
original: polygon-bridge
---

# Polygon Bridge

> Bridge with Polygon. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polygon-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polygon Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/polygon-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
