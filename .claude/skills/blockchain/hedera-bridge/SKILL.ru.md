...
version: "1.0"
language: ru
original: hedera-bridge
---

# Hedera Bridge

> Bridge with Hedera. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
