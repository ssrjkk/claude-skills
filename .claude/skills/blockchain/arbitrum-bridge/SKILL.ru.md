...
version: "1.0"
language: ru
original: arbitrum-bridge
---

# Arbitrum Bridge

> Bridge with Arbitrum. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arbitrum-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Arbitrum Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/arbitrum-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
