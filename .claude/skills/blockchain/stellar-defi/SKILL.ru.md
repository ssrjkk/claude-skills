...
version: "1.0"
language: ru
original: stellar-defi
---

# Stellar Defi

> DeFi with Stellar. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
