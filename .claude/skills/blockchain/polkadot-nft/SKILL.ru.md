...
version: "1.0"
language: ru
original: polkadot-nft
---

# Polkadot Nft

> NFT with Polkadot. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polkadot-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polkadot Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/polkadot-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
