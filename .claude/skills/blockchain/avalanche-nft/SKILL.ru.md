...
version: "1.0"
language: ru
original: avalanche-nft
---

# Avalanche Nft

> NFT with Avalanche. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
