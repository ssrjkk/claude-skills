...
version: "1.0"
language: ru
original: solana-smart-contracts
---

# Solana Smart Contracts

> Smart Contracts with Solana. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
