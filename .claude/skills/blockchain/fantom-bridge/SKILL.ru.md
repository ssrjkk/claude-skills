...
category: blockchain
tags: [fantom-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fantom-bridge
---

# Fantom Bridge

> Bridge with Fantom. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fantom-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Fantom Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/fantom-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
