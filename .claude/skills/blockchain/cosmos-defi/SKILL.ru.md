...
version: "1.0"
language: ru
original: cosmos-defi
---

# Cosmos Defi

> DeFi with Cosmos. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
