...
category: blockchain
tags: [optimism-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: optimism-bridge
---

# Optimism Bridge

> Bridge with Optimism. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
