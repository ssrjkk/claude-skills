...
category: blockchain
tags: [polkadot-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polkadot-bridge
---

# Polkadot Bridge

> Bridge with Polkadot. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polkadot-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polkadot Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/polkadot-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
