...
version: "1.0"
language: ru
original: cosmos-tokens
---

# Cosmos Tokens

> Tokens with Cosmos. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
