...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ethereum-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Ethereum Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/ethereum-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
