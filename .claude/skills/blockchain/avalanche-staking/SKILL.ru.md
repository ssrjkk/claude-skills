...
version: "1.0"
language: ru
original: avalanche-staking
---

# Avalanche Staking

> Staking with Avalanche. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
