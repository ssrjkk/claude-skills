...
version: "1.0"
language: ru
original: optimism-smart-contracts
---

# Optimism Smart Contracts

> Smart Contracts with Optimism. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
