...
version: "1.0"
language: ru
original: zksync-tokens
---

# Zksync Tokens

> Tokens with zkSync. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
