...
category: blockchain
tags: [solana-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solana-bridge
---

# Solana Bridge

> Bridge with Solana. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
