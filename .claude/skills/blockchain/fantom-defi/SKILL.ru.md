...
version: "1.0"
language: ru
original: fantom-defi
---

# Fantom Defi

> DeFi with Fantom. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fantom-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Fantom Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/fantom-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
