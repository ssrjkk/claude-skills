...
category: blockchain
tags: [cardano-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cardano-bridge
---

# Cardano Bridge

> Bridge with Cardano. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cardano-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cardano Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/cardano-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
