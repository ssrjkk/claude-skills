...
category: blockchain
tags: [defi-security, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: defi-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defi-security`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Defi Security
...
## Ресурсы
- Оригинальный навык: `blockchain/defi-security/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
