...
category: blockchain
tags: [zksync-setup, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zksync-setup
---

# Zksync Setup

> Setup with zkSync. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
