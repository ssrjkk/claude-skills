...
version: "1.0"
language: ru
original: solana-staking
---

# Solana Staking

> Staking with Solana. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
