...
category: blockchain
tags: [web3-frontend, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: web3-frontend
---

# Web3 Frontend

> Web3 dApp frontend with wagmi/viem

## Быстрый старт
Этот навык на русском языке. Оригинал: `web3-frontend`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Web3 Frontend
...
## Ресурсы
- Оригинальный навык: `blockchain/web3-frontend/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
