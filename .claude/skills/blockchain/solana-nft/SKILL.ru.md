...
category: blockchain
tags: [solana-nft, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solana-nft
...
> NFT with Solana. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
