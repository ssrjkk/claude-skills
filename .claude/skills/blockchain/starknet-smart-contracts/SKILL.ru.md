...
category: blockchain
tags: [starknet-smart-contracts, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: starknet-smart-contracts
---

# Starknet Smart Contracts

> Smart Contracts with StarkNet. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
