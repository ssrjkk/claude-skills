...
version: "1.0"
language: ru
original: base-smart-contracts
---

# Base Smart Contracts

> Smart Contracts with Base. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `base-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Base Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/base-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
