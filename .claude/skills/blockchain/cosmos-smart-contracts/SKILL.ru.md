...
version: "1.0"
language: ru
original: cosmos-smart-contracts
---

# Cosmos Smart Contracts

> Smart Contracts with Cosmos. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
