...
version: "1.0"
language: ru
original: starknet-staking
---

# Starknet Staking

> Staking with StarkNet. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
