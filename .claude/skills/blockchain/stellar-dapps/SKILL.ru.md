...
category: blockchain
tags: [stellar-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stellar-dapps
---

# Stellar Dapps

> DApps with Stellar. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
