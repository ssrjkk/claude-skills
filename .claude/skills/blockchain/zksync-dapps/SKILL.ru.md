...
category: blockchain
tags: [zksync-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zksync-dapps
---

# Zksync Dapps

> DApps with zkSync. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
