...
version: "1.0"
language: ru
original: tezos-smart-contracts
---

# Tezos Smart Contracts

> Smart Contracts with Tezos. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
