...
category: blockchain
tags: [polygon-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polygon-defi
---

# Polygon Defi

> DeFi with Polygon. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polygon-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polygon Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/polygon-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
