...
category: blockchain
tags: [tezos-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tezos-defi
...
> DeFi with Tezos. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
