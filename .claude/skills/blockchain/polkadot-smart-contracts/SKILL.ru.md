...
category: blockchain
tags: [polkadot-smart-contracts, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polkadot-smart-contracts
---

# Polkadot Smart Contracts

> Smart Contracts with Polkadot. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polkadot-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Polkadot Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/polkadot-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
