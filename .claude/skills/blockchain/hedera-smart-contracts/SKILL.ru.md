...
category: blockchain
tags: [hedera-smart-contracts, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hedera-smart-contracts
---

# Hedera Smart Contracts

> Smart Contracts with Hedera. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
