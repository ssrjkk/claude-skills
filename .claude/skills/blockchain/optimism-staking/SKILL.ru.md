...
version: "1.0"
language: ru
original: optimism-staking
---

# Optimism Staking

> Staking with Optimism. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
