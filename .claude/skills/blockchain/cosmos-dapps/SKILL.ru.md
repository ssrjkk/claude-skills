...
version: "1.0"
language: ru
original: cosmos-dapps
---

# Cosmos Dapps

> DApps with Cosmos. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cosmos-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cosmos Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/cosmos-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
