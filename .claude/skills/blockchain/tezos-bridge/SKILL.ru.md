...
version: "1.0"
language: ru
original: tezos-bridge
---

# Tezos Bridge

> Bridge with Tezos. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
