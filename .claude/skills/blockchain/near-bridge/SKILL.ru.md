...
version: "1.0"
language: ru
original: near-bridge
---

# Near Bridge

> Bridge with NEAR. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `near-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Near Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/near-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
