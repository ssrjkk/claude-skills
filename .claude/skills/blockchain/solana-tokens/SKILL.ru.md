...
> Tokens with Solana. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solana-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Solana Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/solana-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
