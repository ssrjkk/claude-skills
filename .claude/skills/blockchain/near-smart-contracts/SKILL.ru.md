...
version: "1.0"
language: ru
original: near-smart-contracts
---

# Near Smart Contracts

> Smart Contracts with NEAR. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `near-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Near Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/near-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
