...
version: "1.0"
language: ru
original: hedera-setup
---

# Hedera Setup

> Setup with Hedera. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hedera-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Hedera Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/hedera-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
