...
version: "1.0"
language: ru
original: base-tokens
---

# Base Tokens

> Tokens with Base. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `base-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Base Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/base-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
