...
version: "1.0"
language: ru
original: avalanche-tokens
---

# Avalanche Tokens

> Tokens with Avalanche. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
