...
category: blockchain
tags: [starknet-defi, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: starknet-defi
---

# Starknet Defi

> DeFi with StarkNet. DeFi.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
