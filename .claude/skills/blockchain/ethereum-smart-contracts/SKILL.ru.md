...
version: "1.0"
language: ru
original: ethereum-smart-contracts
---

# Ethereum Smart Contracts

> Smart Contracts with Ethereum. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ethereum-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Ethereum Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/ethereum-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
