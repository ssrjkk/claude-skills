...
version: "1.0"
language: ru
original: starknet-setup
---

# Starknet Setup

> Setup with StarkNet. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
