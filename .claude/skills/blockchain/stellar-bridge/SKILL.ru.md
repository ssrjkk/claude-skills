...
category: blockchain
tags: [stellar-bridge, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stellar-bridge
---

# Stellar Bridge

> Bridge with Stellar. cross-chain.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stellar-bridge`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Stellar Bridge
...
## Ресурсы
- Оригинальный навык: `blockchain/stellar-bridge/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
