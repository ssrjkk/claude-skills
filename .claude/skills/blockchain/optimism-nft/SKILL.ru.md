...
version: "1.0"
language: ru
original: optimism-nft
---

# Optimism Nft

> NFT with Optimism. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
