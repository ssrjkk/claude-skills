...
category: blockchain
tags: [avalanche-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avalanche-dapps
---

# Avalanche Dapps

> DApps with Avalanche. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
