...
version: "1.0"
language: ru
original: arbitrum-tokens
---

# Arbitrum Tokens

> Tokens with Arbitrum. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arbitrum-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Arbitrum Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/arbitrum-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
