...
version: "1.0"
language: ru
original: cardano-tokens
---

# Cardano Tokens

> Tokens with Cardano. token standards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cardano-tokens`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Cardano Tokens
...
## Ресурсы
- Оригинальный навык: `blockchain/cardano-tokens/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
