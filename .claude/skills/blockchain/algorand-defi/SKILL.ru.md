...
## Быстрый старт
Этот навык на русском языке. Оригинал: `algorand-defi`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Algorand Defi
...
## Ресурсы
- Оригинальный навык: `blockchain/algorand-defi/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
