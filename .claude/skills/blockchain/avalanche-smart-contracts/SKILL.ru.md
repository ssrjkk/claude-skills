...
version: "1.0"
language: ru
original: avalanche-smart-contracts
---

# Avalanche Smart Contracts

> Smart Contracts with Avalanche. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalanche-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Avalanche Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/avalanche-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
