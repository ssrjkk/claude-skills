...
category: blockchain
tags: [fantom-nft, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fantom-nft
...
> NFT with Fantom. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fantom-nft`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Fantom Nft
...
## Ресурсы
- Оригинальный навык: `blockchain/fantom-nft/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
