...
> DApps with NEAR. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `near-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Near Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/near-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
