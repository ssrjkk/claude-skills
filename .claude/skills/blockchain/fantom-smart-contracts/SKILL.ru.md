...
version: "1.0"
language: ru
original: fantom-smart-contracts
---

# Fantom Smart Contracts

> Smart Contracts with Fantom. contracts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fantom-smart-contracts`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Fantom Smart Contracts
...
## Ресурсы
- Оригинальный навык: `blockchain/fantom-smart-contracts/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
