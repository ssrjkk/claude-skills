...
version: "1.0"
language: ru
original: tezos-setup
---

# Tezos Setup

> Setup with Tezos. node setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-setup`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Setup
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-setup/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
