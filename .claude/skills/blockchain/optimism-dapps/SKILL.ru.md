...
category: blockchain
tags: [optimism-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: optimism-dapps
---

# Optimism Dapps

> DApps with Optimism. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `optimism-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Optimism Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/optimism-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
