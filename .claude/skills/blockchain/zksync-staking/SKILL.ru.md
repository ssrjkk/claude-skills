...
category: blockchain
tags: [zksync-staking, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zksync-staking
---

# Zksync Staking

> Staking with zkSync. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zksync-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Zksync Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/zksync-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
