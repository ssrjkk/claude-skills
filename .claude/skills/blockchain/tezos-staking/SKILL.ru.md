...
version: "1.0"
language: ru
original: tezos-staking
---

# Tezos Staking

> Staking with Tezos. staking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tezos-staking`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Tezos Staking
...
## Ресурсы
- Оригинальный навык: `blockchain/tezos-staking/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
