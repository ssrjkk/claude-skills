...
category: blockchain
tags: [starknet-dapps, blockchain, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: starknet-dapps
---

# Starknet Dapps

> DApps with StarkNet. decentralized apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starknet-dapps`.

## Когда использовать
- Работа с Блокчейн
- Выполнение задач, связанных с Starknet Dapps
...
## Ресурсы
- Оригинальный навык: `blockchain/starknet-dapps/SKILL.md`
- Категория: Блокчейн
- Язык: Русский
