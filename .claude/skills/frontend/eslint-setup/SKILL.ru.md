...
category: frontend
tags: [eslint-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Setup with ESLint. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Setup
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-setup/SKILL.md`
