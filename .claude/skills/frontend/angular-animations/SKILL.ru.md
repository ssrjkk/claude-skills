...
version: "1.0"
language: ru
original: angular-animations
---

# Angular Animations

> Animations with Angular. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Animations
...
## Ресурсы
- Оригинальный навык: `frontend/angular-animations/SKILL.md`
