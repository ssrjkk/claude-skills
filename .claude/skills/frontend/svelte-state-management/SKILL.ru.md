...
version: "1.0"
language: ru
original: svelte-state-management
---

# Svelte State Management

> State Management with Svelte. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte State Management
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-state-management/SKILL.md`
