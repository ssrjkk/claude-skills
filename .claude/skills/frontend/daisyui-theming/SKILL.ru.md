...
version: "1.0"
language: ru
original: daisyui-theming
---

# Daisyui Theming

> Theming with daisyUI. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Theming
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-theming/SKILL.md`
