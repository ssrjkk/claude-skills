...
version: "1.0"
language: ru
original: styled-components-automation
---

# Styled Components Automation

> Automation for Styled-Components: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: styled-components-automation.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Styled Components Automation
...
## Ресурсы
- frontend/styled-components-automation/SKILL.md
