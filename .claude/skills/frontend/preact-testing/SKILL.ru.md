...
version: "1.0"
language: ru
original: preact-testing
---

# Preact Testing

> Testing with Preact. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Testing
...
## Ресурсы
- Оригинальный навык: `frontend/preact-testing/SKILL.md`
