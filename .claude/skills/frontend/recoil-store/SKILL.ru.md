...
version: "1.0"
language: ru
original: recoil-store
---

# Recoil Store

> Store with Recoil. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `recoil-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Recoil Store
...
## Ресурсы
- Оригинальный навык: `frontend/recoil-store/SKILL.md`
