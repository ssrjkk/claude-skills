...
version: "1.0"
language: ru
original: floating-ui-examples
---

# Floating Ui Examples

> Examples for Floating-Ui: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `floating-ui-examples`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Floating Ui Examples
...
## Ресурсы
- Оригинал: frontend/floating-ui-examples/SKILL.md
