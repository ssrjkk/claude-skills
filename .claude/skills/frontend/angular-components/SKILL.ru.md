...
category: frontend
tags: [angular-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Components with Angular. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Components
...
## Ресурсы
- Оригинальный навык: `frontend/angular-components/SKILL.md`
