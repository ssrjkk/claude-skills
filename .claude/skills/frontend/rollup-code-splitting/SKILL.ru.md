...
version: "1.0"
language: ru
original: rollup-code-splitting
---

# Rollup Code Splitting

> Code Splitting with Rollup. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-code-splitting/SKILL.md`
