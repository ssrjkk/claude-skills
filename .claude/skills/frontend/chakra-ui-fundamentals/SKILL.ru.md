...
version: "1.0"
language: ru
original: chakra-ui-fundamentals
---

# Chakra Ui Fundamentals

> Fundamentals for Chakra-Ui: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `chakra-ui-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Fundamentals
...
## Ресурсы
- Оригинал: frontend/chakra-ui-fundamentals/SKILL.md
