---
name: solidstart-isr
description: "ISR with SolidStart. incremental."
category: frontend
tags: [solidstart-isr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solidstart-isr
---

# Solidstart Isr

> ISR with SolidStart. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solidstart-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solidstart Isr
...
## Ресурсы
- Оригинальный навык: `frontend/solidstart-isr/SKILL.md`
