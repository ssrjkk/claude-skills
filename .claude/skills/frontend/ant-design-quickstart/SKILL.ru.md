...
category: frontend
tags: [ant-design-quickstart, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-quickstart
---

# Ant Design Quickstart

> Quickstart for Ant-Design: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ant-design-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Quickstart
...
## Ресурсы
- Оригинал: frontend/ant-design-quickstart/SKILL.md
