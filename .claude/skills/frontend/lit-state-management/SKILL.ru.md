...
version: "1.0"
language: ru
original: lit-state-management
---

# Lit State Management

> State Management with Lit. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit State Management
...
## Ресурсы
- Оригинальный навык: `frontend/lit-state-management/SKILL.md`
