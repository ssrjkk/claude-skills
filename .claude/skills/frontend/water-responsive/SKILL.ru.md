...
category: frontend
tags: [water-responsive, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: water-responsive
---

# Water Responsive

> Responsive with Water.css. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/water-responsive/SKILL.md`
