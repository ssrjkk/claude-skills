...
version: "1.0"
language: ru
original: daisyui-typography
---

# Daisyui Typography

> Typography with daisyUI. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Typography
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-typography/SKILL.md`
