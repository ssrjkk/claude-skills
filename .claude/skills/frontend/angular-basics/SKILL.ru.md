...
category: frontend
tags: [angular-basics, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Basics
...
## Ресурсы
- Оригинальный навык: frontend/angular-basics/SKILL.md
