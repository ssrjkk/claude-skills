...
version: "1.0"
language: ru
original: oxlint-optimization
---

# Oxlint Optimization

> Optimization with Oxlint. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-optimization/SKILL.md`
