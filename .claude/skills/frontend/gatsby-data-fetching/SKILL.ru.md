...
version: "1.0"
language: ru
original: gatsby-data-fetching
---

# Gatsby Data Fetching

> Data Fetching with Gatsby. data loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatsby-data-fetching`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gatsby Data Fetching
...
## Ресурсы
- Оригинальный навык: `frontend/gatsby-data-fetching/SKILL.md`
