...
category: frontend
tags: [react-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-routing
---

# React Routing

> Routing with React. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Routing
...
## Ресурсы
- Оригинальный навык: `frontend/react-routing/SKILL.md`
