...
version: "1.0"
language: ru
original: daisyui-dark-mode
---

# Daisyui Dark Mode

> Dark Mode with daisyUI. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-dark-mode/SKILL.md`
