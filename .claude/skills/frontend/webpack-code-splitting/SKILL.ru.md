...
version: "1.0"
language: ru
original: webpack-code-splitting
---

# Webpack Code Splitting

> Code Splitting with Webpack. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-code-splitting/SKILL.md`
