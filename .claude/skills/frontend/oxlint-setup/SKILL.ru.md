...
category: frontend
tags: [oxlint-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oxlint-setup
---

# Oxlint Setup

> Setup with Oxlint. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Setup
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-setup/SKILL.md`
