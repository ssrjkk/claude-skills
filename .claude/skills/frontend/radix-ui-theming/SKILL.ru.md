...
category: frontend
tags: [radix-ui-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: radix-ui-theming
---

# Radix Ui Theming

> Theming with Radix UI. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Theming
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-theming/SKILL.md`
