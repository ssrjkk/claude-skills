...
category: frontend
tags: [eslint-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eslint-optimization
---

# Eslint Optimization

> Optimization with ESLint. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-optimization/SKILL.md`
