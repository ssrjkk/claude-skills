...
category: frontend
tags: [less-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: less-setup
...
> Setup with Less. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Setup
...
## Ресурсы
- Оригинальный навык: `frontend/less-setup/SKILL.md`
