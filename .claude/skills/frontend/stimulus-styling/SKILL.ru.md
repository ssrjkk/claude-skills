...
category: frontend
tags: [stimulus-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stimulus-styling
---

# Stimulus Styling

> Styling with Stimulus. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Styling
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-styling/SKILL.md`
