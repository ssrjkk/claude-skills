...
category: frontend
tags: [marko-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marko-accessibility
---

# Marko Accessibility

> Accessibility with Marko. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/marko-accessibility/SKILL.md`
