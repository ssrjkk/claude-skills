...
version: "1.0"
language: ru
original: prettier-code-splitting
---

# Prettier Code Splitting

> Code Splitting with Prettier. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-code-splitting/SKILL.md`
