...
version: "1.0"
language: ru
original: backbone-forms
---

# Backbone Forms

> Forms with Backbone. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Forms
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-forms/SKILL.md`
