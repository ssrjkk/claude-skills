...
version: "1.0"
language: ru
original: tailwind-merge-setup
---

# Tailwind Merge Setup

> Setup for Tailwind-Merge: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tailwind-merge-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Merge Setup
...
## Ресурсы
- Оригинал: frontend/tailwind-merge-setup/SKILL.md
