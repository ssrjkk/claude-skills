...
category: frontend
tags: [parcel-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: parcel-bundling
---

# Parcel Bundling

> Bundling with Parcel. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-bundling/SKILL.md`
