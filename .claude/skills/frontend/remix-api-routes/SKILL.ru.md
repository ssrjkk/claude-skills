...
version: "1.0"
language: ru
original: remix-api-routes
---

# Remix Api Routes

> API Routes with Remix. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/remix-api-routes/SKILL.md`
