...
version: "1.0"
language: ru
original: headless-ui-quickstart
---

# Headless Ui Quickstart

> Quickstart for Headless-Ui: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `headless-ui-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Headless Ui Quickstart
...
## Ресурсы
- Оригинал: frontend/headless-ui-quickstart/SKILL.md
