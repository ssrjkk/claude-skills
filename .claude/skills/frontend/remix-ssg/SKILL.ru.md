...
> SSG with Remix. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/remix-ssg/SKILL.md`
