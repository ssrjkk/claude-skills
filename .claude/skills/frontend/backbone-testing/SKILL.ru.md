...
category: frontend
tags: [backbone-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: backbone-testing
---

# Backbone Testing

> Testing with Backbone. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Testing
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-testing/SKILL.md`
