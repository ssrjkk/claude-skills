...
version: "1.0"
language: ru
original: gsap-automation
---

# Gsap Automation

> Automation for Gsap: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: gsap-automation.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gsap Automation
...
## Ресурсы
- frontend/gsap-automation/SKILL.md
