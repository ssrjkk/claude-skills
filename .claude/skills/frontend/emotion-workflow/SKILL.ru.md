...
category: frontend
tags: [emotion-workflow, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: emotion-workflow
---

# Emotion Workflow

> Workflow for Emotion: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: emotion-workflow.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Emotion Workflow
...
## Ресурсы
- frontend/emotion-workflow/SKILL.md
