...
version: "1.0"
language: ru
original: stimulus-state-management
---

# Stimulus State Management

> State Management with Stimulus. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus State Management
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-state-management/SKILL.md`
