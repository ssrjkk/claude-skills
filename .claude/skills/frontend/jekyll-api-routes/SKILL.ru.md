...
category: frontend
tags: [jekyll-api-routes, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jekyll-api-routes
---

# Jekyll Api Routes

> API Routes with Jekyll. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jekyll-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jekyll Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/jekyll-api-routes/SKILL.md`
