...
version: "1.0"
language: ru
original: stimulus-testing
---

# Stimulus Testing

> Testing with Stimulus. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Testing
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-testing/SKILL.md`
