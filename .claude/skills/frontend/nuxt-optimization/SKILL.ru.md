...
category: frontend
tags: [nuxt-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Optimization
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-optimization/SKILL.md
