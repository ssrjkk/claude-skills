...
version: "1.0"
language: ru
original: rollup-config
---

# Rollup Config

> Config with Rollup. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Config
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-config/SKILL.md`
