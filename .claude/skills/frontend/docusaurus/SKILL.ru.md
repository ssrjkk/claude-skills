...
category: frontend
tags: [docusaurus, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: docusaurus
...
> Creates documentation websites with Docusaurus, MDX, versioning, and search. Use for open-source docs and knowledge bases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus/SKILL.md`
