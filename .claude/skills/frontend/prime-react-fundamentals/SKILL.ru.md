...
category: frontend
tags: [prime-react-fundamentals, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prime-react-fundamentals
---

# Prime React Fundamentals

> Fundamentals for Prime-React: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `prime-react-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prime React Fundamentals
...
## Ресурсы
- Оригинал: frontend/prime-react-fundamentals/SKILL.md
