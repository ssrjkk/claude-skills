...
version: "1.0"
language: ru
original: ember-styling
---

# Ember Styling

> Styling with Ember. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Styling
...
## Ресурсы
- Оригинальный навык: `frontend/ember-styling/SKILL.md`
