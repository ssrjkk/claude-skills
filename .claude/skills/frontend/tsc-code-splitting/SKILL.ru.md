...
version: "1.0"
language: ru
original: tsc-code-splitting
---

# Tsc Code Splitting

> Code Splitting with TypeScript. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsc-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tsc Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/tsc-code-splitting/SKILL.md`
