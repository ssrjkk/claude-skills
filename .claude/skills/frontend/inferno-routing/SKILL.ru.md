...
category: frontend
tags: [inferno-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: inferno-routing
---

# Inferno Routing

> Routing with Inferno. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Routing
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-routing/SKILL.md`
