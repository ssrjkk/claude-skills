...
version: "1.0"
language: ru
original: daisyui-responsive
---

# Daisyui Responsive

> Responsive with daisyUI. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-responsive/SKILL.md`
