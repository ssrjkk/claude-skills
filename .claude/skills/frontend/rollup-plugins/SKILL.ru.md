...
category: frontend
tags: [rollup-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Plugins with Rollup. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-plugins/SKILL.md`
