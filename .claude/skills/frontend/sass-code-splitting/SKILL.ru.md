...
version: "1.0"
language: ru
original: sass-code-splitting
---

# Sass Code Splitting

> Code Splitting with Sass. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/sass-code-splitting/SKILL.md`
