...
version: "1.0"
language: ru
original: stylus-code-splitting
---

# Stylus Code Splitting

> Code Splitting with Stylus. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-code-splitting/SKILL.md`
