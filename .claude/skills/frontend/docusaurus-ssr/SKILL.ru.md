...
version: "1.0"
language: ru
original: docusaurus-ssr
---

# Docusaurus Ssr

> SSR with Docusaurus. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus-ssr/SKILL.md`
