...
category: frontend
tags: [vue-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vue-accessibility
---

# Vue Accessibility

> Accessibility with Vue. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/vue-accessibility/SKILL.md`
