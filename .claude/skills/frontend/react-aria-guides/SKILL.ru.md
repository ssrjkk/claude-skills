...
version: "1.0"
language: ru
original: react-aria-guides
---

# React Aria Guides

> Guides for React-Aria: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `react-aria-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Aria Guides
...
## Ресурсы
- Оригинал: frontend/react-aria-guides/SKILL.md
