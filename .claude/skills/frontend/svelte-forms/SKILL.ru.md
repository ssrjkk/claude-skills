...
version: "1.0"
language: ru
original: svelte-forms
---

# Svelte Forms

> Forms with Svelte. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Forms
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-forms/SKILL.md`
