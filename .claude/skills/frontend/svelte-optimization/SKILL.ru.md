...
version: "1.0"
language: ru
original: svelte-optimization
---

# Svelte Optimization

> Optimization for Svelte: performance tuning and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Optimization
...
## Ресурсы
- Оригинальный навык: frontend/svelte-optimization/SKILL.md
