...
category: frontend
tags: [remix-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remix-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Testing
...
## Ресурсы
- Оригинальный навык: frontend/remix-testing/SKILL.md
