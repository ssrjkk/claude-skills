...
category: frontend
tags: [vitepress-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitepress-ssr
---

# Vitepress Ssr

> SSR with VitePress. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitepress-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vitepress Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/vitepress-ssr/SKILL.md`
