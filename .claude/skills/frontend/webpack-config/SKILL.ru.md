...
category: frontend
tags: [webpack-config, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Config with Webpack. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Config
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-config/SKILL.md`
