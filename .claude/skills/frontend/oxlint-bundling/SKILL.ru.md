...
version: "1.0"
language: ru
original: oxlint-bundling
---

# Oxlint Bundling

> Bundling with Oxlint. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-bundling/SKILL.md`
