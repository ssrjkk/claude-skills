...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-monitoring`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Monitoring
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-monitoring/SKILL.md
