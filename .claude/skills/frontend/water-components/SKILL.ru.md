...
category: frontend
tags: [water-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: water-components
---

# Water Components

> Components with Water.css. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Components
...
## Ресурсы
- Оригинальный навык: `frontend/water-components/SKILL.md`
