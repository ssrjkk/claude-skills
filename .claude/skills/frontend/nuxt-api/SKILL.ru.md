...
category: frontend
tags: [nuxt-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Api
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-api/SKILL.md
