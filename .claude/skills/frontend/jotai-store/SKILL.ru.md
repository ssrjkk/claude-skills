...
version: "1.0"
language: ru
original: jotai-store
---

# Jotai Store

> Store with Jotai. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jotai-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jotai Store
...
## Ресурсы
- Оригинальный навык: `frontend/jotai-store/SKILL.md`
