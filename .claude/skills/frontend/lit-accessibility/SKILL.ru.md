...
version: "1.0"
language: ru
original: lit-accessibility
---

# Lit Accessibility

> Accessibility with Lit. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/lit-accessibility/SKILL.md`
