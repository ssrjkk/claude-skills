...
category: frontend
tags: [d3js-workflow, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: d3js-workflow
---

# D3Js Workflow

> Workflow for D3Js: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: d3js-workflow.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с D3Js Workflow
...
## Ресурсы
- frontend/d3js-workflow/SKILL.md
