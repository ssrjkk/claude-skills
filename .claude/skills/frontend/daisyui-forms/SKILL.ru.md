...
version: "1.0"
language: ru
original: daisyui-forms
---

# Daisyui Forms

> Forms with daisyUI. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Forms
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-forms/SKILL.md`
