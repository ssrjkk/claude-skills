...
version: "1.0"
language: ru
original: rollup-bundling
---

# Rollup Bundling

> Bundling with Rollup. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-bundling/SKILL.md`
