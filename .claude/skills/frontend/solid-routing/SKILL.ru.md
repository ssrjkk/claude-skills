...
category: frontend
tags: [solid-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-routing
---

# Solid Routing

> Routing with Solid. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Routing
...
## Ресурсы
- Оригинальный навык: `frontend/solid-routing/SKILL.md`
