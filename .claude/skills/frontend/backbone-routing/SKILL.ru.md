...
version: "1.0"
language: ru
original: backbone-routing
---

# Backbone Routing

> Routing with Backbone. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Routing
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-routing/SKILL.md`
