...
category: frontend
tags: [effector-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: effector-testing
---

# Effector Testing

> Testing with Effector. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Testing
...
## Ресурсы
- Оригинальный навык: `frontend/effector-testing/SKILL.md`
