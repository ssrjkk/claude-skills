...
category: frontend
tags: [storybook-ssg, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: storybook-ssg
---

# Storybook Ssg

> SSG with Storybook. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-ssg/SKILL.md`
