...
category: frontend
tags: [spectre-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spectre-components
---

# Spectre Components

> Components with Spectre.css. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spectre-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Spectre Components
...
## Ресурсы
- Оригинальный навык: `frontend/spectre-components/SKILL.md`
