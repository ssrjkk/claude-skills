...
version: "1.0"
language: ru
original: gatsby-routing
---

# Gatsby Routing

> Routing with Gatsby. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatsby-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gatsby Routing
...
## Ресурсы
- Оригинальный навык: `frontend/gatsby-routing/SKILL.md`
