...
category: frontend
tags: [nuxt-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Debugging
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-debugging/SKILL.md
