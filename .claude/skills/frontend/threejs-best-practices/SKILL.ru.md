...
category: frontend
tags: [threejs-best-practices, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: threejs-best-practices
---

# Threejs Best Practices

> Best Practices for Threejs: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: threejs-best-practices.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Threejs Best Practices
...
## Ресурсы
- frontend/threejs-best-practices/SKILL.md
