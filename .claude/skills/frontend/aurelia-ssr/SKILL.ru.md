...
category: frontend
tags: [aurelia-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aurelia-ssr
---

# Aurelia Ssr

> SSR with Aurelia. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-ssr/SKILL.md`
