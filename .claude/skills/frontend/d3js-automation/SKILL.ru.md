...
version: "1.0"
language: ru
original: d3js-automation
---

# D3Js Automation

> Automation for D3Js: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: d3js-automation.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с D3Js Automation
...
## Ресурсы
- frontend/d3js-automation/SKILL.md
