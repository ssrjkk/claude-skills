...
version: "1.0"
language: ru
original: stylus-source-maps
---

# Stylus Source Maps

> Source Maps with Stylus. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-source-maps/SKILL.md`
