...
version: "1.0"
language: ru
original: redux-optimization
---

# Redux Optimization

> Optimization with Redux. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redux-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Redux Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/redux-optimization/SKILL.md`
