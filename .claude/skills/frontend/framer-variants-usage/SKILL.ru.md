...
version: "1.0"
language: ru
original: framer-variants-usage
---

# Framer Variants Usage

> Usage for Framer-Variants: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-variants-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Framer Variants Usage
...
## Ресурсы
- Оригинал: frontend/framer-variants-usage/SKILL.md
