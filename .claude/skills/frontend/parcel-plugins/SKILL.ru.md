...
version: "1.0"
language: ru
original: parcel-plugins
---

# Parcel Plugins

> Plugins with Parcel. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-plugins/SKILL.md`
