...
category: frontend
tags: [postcss-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postcss-plugins
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-plugins/SKILL.md`
