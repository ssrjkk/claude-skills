...
version: "1.0"
language: ru
original: aurelia-testing
---

# Aurelia Testing

> Testing with Aurelia. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Testing
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-testing/SKILL.md`
