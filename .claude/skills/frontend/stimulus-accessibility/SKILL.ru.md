...
version: "1.0"
language: ru
original: stimulus-accessibility
---

# Stimulus Accessibility

> Accessibility with Stimulus. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-accessibility/SKILL.md`
