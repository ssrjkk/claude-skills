...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-advanced`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Advanced
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-advanced/SKILL.md
