...
> Setup with Vite. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Setup
...
## Ресурсы
- Оригинальный навык: `frontend/vite-setup/SKILL.md`
