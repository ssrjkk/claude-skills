...
version: "1.0"
language: ru
original: turbopack-plugins
---

# Turbopack Plugins

> Plugins with Turbopack. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-plugins/SKILL.md`
