...
version: "1.0"
language: ru
original: vitepress-isr
---

# Vitepress Isr

> ISR with VitePress. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitepress-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vitepress Isr
...
## Ресурсы
- Оригинальный навык: `frontend/vitepress-isr/SKILL.md`
