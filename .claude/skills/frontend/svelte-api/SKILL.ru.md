...
category: frontend
tags: [svelte-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-api
...
> API for Svelte: API development and integration

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Api
...
## Ресурсы
- Оригинальный навык: frontend/svelte-api/SKILL.md
