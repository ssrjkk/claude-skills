...
category: frontend
tags: [hugo-middleware, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hugo-middleware
---

# Hugo Middleware

> Middleware with Hugo. request middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hugo-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Hugo Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/hugo-middleware/SKILL.md`
