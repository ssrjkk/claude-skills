...
version: "1.0"
language: ru
original: leaflet-configuration
---

# Leaflet Configuration

> Configuration for Leaflet: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: leaflet-configuration.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Leaflet Configuration
...
## Ресурсы
- frontend/leaflet-configuration/SKILL.md
