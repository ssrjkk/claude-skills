...
version: "1.0"
language: ru
original: floating-ui-fundamentals
---

# Floating Ui Fundamentals

> Fundamentals for Floating-Ui: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `floating-ui-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Floating Ui Fundamentals
...
## Ресурсы
- Оригинал: frontend/floating-ui-fundamentals/SKILL.md
