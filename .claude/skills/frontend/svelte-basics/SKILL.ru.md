...
category: frontend
tags: [svelte-basics, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-basics
---

# Svelte Basics

> Basics for Svelte: fundamentals and core concepts

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Basics
...
## Ресурсы
- Оригинальный навык: frontend/svelte-basics/SKILL.md
