...
version: "1.0"
language: ru
original: ember-animations
---

# Ember Animations

> Animations with Ember. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Animations
...
## Ресурсы
- Оригинальный навык: `frontend/ember-animations/SKILL.md`
