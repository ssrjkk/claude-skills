...
version: "1.0"
language: ru
original: zod-getting-started
---

# Zod Getting Started

> Getting Started for Zod: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: zod-getting-started.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zod Getting Started
...
## Ресурсы
- frontend/zod-getting-started/SKILL.md
