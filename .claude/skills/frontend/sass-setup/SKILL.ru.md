...
> Setup with Sass. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Setup
...
## Ресурсы
- Оригинальный навык: `frontend/sass-setup/SKILL.md`
