...
category: frontend
tags: [preact-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: preact-forms
---

# Preact Forms

> Forms with Preact. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Forms
...
## Ресурсы
- Оригинальный навык: `frontend/preact-forms/SKILL.md`
