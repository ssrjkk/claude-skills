...
version: "1.0"
language: ru
original: mithril-routing
---

# Mithril Routing

> Routing with Mithril. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Routing
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-routing/SKILL.md`
