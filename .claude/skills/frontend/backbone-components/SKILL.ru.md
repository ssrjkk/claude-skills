...
version: "1.0"
language: ru
original: backbone-components
---

# Backbone Components

> Components with Backbone. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Components
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-components/SKILL.md`
