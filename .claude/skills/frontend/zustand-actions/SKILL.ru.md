...
version: "1.0"
language: ru
original: zustand-actions
---

# Zustand Actions

> Actions with Zustand. actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-actions`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Actions
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-actions/SKILL.md`
