...
category: frontend
tags: [ant-design-guides, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-guides
---

# Ant Design Guides

> Guides for Ant-Design: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ant-design-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Guides
...
## Ресурсы
- Оригинал: frontend/ant-design-guides/SKILL.md
