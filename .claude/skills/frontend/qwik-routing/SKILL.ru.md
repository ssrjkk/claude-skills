...
version: "1.0"
language: ru
original: qwik-routing
---

# Qwik Routing

> Routing with Qwik. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qwik-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Qwik Routing
...
## Ресурсы
- Оригинальный навык: `frontend/qwik-routing/SKILL.md`
