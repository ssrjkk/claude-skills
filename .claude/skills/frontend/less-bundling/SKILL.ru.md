...
version: "1.0"
language: ru
original: less-bundling
---

# Less Bundling

> Bundling with Less. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/less-bundling/SKILL.md`
