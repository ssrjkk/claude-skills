...
version: "1.0"
language: ru
original: pinia-selectors
---

# Pinia Selectors

> Selectors with Pinia. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinia-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pinia Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/pinia-selectors/SKILL.md`
