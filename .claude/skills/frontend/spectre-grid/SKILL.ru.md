...
category: frontend
tags: [spectre-grid, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spectre-grid
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spectre-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Spectre Grid
...
## Ресурсы
- Оригинальный навык: `frontend/spectre-grid/SKILL.md`
