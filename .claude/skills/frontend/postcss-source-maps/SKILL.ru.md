...
version: "1.0"
language: ru
original: postcss-source-maps
---

# Postcss Source Maps

> Source Maps with PostCSS. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-source-maps/SKILL.md`
