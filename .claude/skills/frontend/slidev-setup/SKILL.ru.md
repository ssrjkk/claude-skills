...
category: frontend
tags: [slidev-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: slidev-setup
---

# Slidev Setup

> Setup for Slidev: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `slidev-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Slidev Setup
...
## Ресурсы
- Оригинал: frontend/slidev-setup/SKILL.md
