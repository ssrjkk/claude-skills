...
version: "1.0"
language: ru
original: bulma-typography
---

# Bulma Typography

> Typography with Bulma. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Typography
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-typography/SKILL.md`
