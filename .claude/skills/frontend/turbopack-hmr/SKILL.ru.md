...
version: "1.0"
language: ru
original: turbopack-hmr
---

# Turbopack Hmr

> HMR with Turbopack. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-hmr/SKILL.md`
