...
version: "1.0"
language: ru
original: valtio-persistence
---

# Valtio Persistence

> Persistence with Valtio. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `valtio-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Valtio Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/valtio-persistence/SKILL.md`
