...
version: "1.0"
language: ru
original: lit-routing
---

# Lit Routing

> Routing with Lit. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Routing
...
## Ресурсы
- Оригинальный навык: `frontend/lit-routing/SKILL.md`
