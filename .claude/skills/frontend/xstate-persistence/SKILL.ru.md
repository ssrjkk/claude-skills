...
version: "1.0"
language: ru
original: xstate-persistence
---

# Xstate Persistence

> Persistence with XState. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-persistence/SKILL.md`
