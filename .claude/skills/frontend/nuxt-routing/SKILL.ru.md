...
version: "1.0"
language: ru
original: nuxt-routing
---

# Nuxt Routing

> Routing with Nuxt. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Routing
...
## Ресурсы
- Оригинальный навык: `frontend/nuxt-routing/SKILL.md`
