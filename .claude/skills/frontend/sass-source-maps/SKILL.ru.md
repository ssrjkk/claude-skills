...
version: "1.0"
language: ru
original: sass-source-maps
---

# Sass Source Maps

> Source Maps with Sass. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/sass-source-maps/SKILL.md`
