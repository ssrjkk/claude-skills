...
version: "1.0"
language: ru
original: riot-components
---

# Riot Components

> Components with Riot. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Components
...
## Ресурсы
- Оригинальный навык: `frontend/riot-components/SKILL.md`
