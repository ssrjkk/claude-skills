...
version: "1.0"
language: ru
original: preact-accessibility
---

# Preact Accessibility

> Accessibility with Preact. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/preact-accessibility/SKILL.md`
