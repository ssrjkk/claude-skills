...
version: "1.0"
language: ru
original: turbopack-setup
---

# Turbopack Setup

> Setup with Turbopack. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Setup
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-setup/SKILL.md`
