...
category: frontend
tags: [parcel-config, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: parcel-config
---

# Parcel Config

> Config with Parcel. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Config
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-config/SKILL.md`
