...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-advanced`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Advanced
...
## Ресурсы
- Оригинальный навык: frontend/angular-advanced/SKILL.md
