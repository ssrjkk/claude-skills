...
category: frontend
tags: [svelte-advanced, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-advanced
---

# Svelte Advanced

> Advanced for Svelte: advanced patterns and techniques

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-advanced`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Advanced
...
## Ресурсы
- Оригинальный навык: frontend/svelte-advanced/SKILL.md
