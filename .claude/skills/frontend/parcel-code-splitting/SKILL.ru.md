...
version: "1.0"
language: ru
original: parcel-code-splitting
---

# Parcel Code Splitting

> Code Splitting with Parcel. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-code-splitting/SKILL.md`
