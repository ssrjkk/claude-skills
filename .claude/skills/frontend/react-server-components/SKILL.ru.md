...
version: "1.0"
language: ru
original: react-server-components
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-server-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Server Components
...
## Ресурсы
- Оригинальный навык: `frontend/react-server-components/SKILL.md`
