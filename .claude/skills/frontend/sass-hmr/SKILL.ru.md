...
category: frontend
tags: [sass-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sass-hmr
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/sass-hmr/SKILL.md`
