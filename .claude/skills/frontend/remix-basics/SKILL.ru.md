...
## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Basics
...
## Ресурсы
- Оригинальный навык: frontend/remix-basics/SKILL.md
