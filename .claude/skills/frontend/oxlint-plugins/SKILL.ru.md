...
category: frontend
tags: [oxlint-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oxlint-plugins
---

# Oxlint Plugins

> Plugins with Oxlint. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-plugins/SKILL.md`
