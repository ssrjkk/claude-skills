...
category: frontend
tags: [esbuild-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: esbuild-optimization
---

# Esbuild Optimization

> Optimization with esbuild. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esbuild-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Esbuild Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/esbuild-optimization/SKILL.md`
