...
version: "1.0"
language: ru
original: framer-variants-setup
---

# Framer Variants Setup

> Setup for Framer-Variants: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-variants-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Framer Variants Setup
...
## Ресурсы
- Оригинал: frontend/framer-variants-setup/SKILL.md
