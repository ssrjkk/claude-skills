...
version: "1.0"
language: ru
original: foundation-forms
---

# Foundation Forms

> Forms with Foundation. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Forms
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-forms/SKILL.md`
