...
category: frontend
tags: [ant-design-examples, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-examples
---

# Ant Design Examples

> Examples for Ant-Design: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ant-design-examples`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Examples
...
## Ресурсы
- Оригинал: frontend/ant-design-examples/SKILL.md
