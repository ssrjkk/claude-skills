...
category: frontend
tags: [vite-source-maps, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vite-source-maps
---

# Vite Source Maps

> Source Maps with Vite. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/vite-source-maps/SKILL.md`
