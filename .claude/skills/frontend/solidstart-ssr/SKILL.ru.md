...
version: "1.0"
language: ru
original: solidstart-ssr
---

# Solidstart Ssr

> SSR with SolidStart. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solidstart-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solidstart Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/solidstart-ssr/SKILL.md`
