...
category: frontend
tags: [radix-ui-grid, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: radix-ui-grid
---

# Radix Ui Grid

> Grid with Radix UI. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Grid
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-grid/SKILL.md`
