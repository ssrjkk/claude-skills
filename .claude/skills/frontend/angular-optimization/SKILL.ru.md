...
category: frontend
tags: [angular-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Optimization
...
## Ресурсы
- Оригинальный навык: frontend/angular-optimization/SKILL.md
