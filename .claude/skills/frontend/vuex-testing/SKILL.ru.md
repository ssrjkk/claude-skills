...
version: "1.0"
language: ru
original: vuex-testing
---

# Vuex Testing

> Testing with Vuex. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vuex-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vuex Testing
...
## Ресурсы
- Оригинальный навык: `frontend/vuex-testing/SKILL.md`
