...
category: frontend
tags: [lit-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lit-testing
---

# Lit Testing

> Testing with Lit. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Testing
...
## Ресурсы
- Оригинальный навык: `frontend/lit-testing/SKILL.md`
