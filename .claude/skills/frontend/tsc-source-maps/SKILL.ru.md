...
version: "1.0"
language: ru
original: tsc-source-maps
---

# Tsc Source Maps

> Source Maps with TypeScript. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsc-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tsc Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/tsc-source-maps/SKILL.md`
