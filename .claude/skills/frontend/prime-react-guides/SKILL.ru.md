...
category: frontend
tags: [prime-react-guides, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prime-react-guides
---

# Prime React Guides

> Guides for Prime-React: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `prime-react-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prime React Guides
...
## Ресурсы
- Оригинал: frontend/prime-react-guides/SKILL.md
