...
version: "1.0"
language: ru
original: babel-setup
---

# Babel Setup

> Setup with Babel. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Setup
...
## Ресурсы
- Оригинальный навык: `frontend/babel-setup/SKILL.md`
