...
version: "1.0"
language: ru
original: semantic-ui-responsive
---

# Semantic Ui Responsive

> Responsive with Semantic UI. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `semantic-ui-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Semantic Ui Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/semantic-ui-responsive/SKILL.md`
