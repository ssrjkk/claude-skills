...
version: "1.0"
language: ru
original: ant-design-utilities
---

# Ant Design Utilities

> Utilities with Ant Design. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-utilities/SKILL.md`
