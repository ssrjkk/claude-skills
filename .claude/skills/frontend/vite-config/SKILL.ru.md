...
> Config with Vite. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Config
...
## Ресурсы
- Оригинальный навык: `frontend/vite-config/SKILL.md`
