...
## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Grid
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-grid/SKILL.md`
