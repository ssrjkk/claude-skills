...
category: frontend
tags: [nuxt-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Testing
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-testing/SKILL.md
