...
version: "1.0"
language: ru
original: tailwind-grid
---

# Tailwind Grid

> Grid with Tailwind CSS. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Grid
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-grid/SKILL.md`
