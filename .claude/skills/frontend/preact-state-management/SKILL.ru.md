...
version: "1.0"
language: ru
original: preact-state-management
---

# Preact State Management

> State Management with Preact. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact State Management
...
## Ресурсы
- Оригинальный навык: `frontend/preact-state-management/SKILL.md`
