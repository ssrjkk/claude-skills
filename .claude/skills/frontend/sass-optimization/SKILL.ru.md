...
version: "1.0"
language: ru
original: sass-optimization
---

# Sass Optimization

> Optimization with Sass. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/sass-optimization/SKILL.md`
