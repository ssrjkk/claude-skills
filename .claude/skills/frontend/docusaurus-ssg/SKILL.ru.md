...
version: "1.0"
language: ru
original: docusaurus-ssg
---

# Docusaurus Ssg

> SSG with Docusaurus. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus-ssg/SKILL.md`
