...
category: frontend
tags: [marko-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marko-styling
---

# Marko Styling

> Styling with Marko. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Styling
...
## Ресурсы
- Оригинальный навык: `frontend/marko-styling/SKILL.md`
