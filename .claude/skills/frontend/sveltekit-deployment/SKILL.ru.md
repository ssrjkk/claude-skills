...
version: "1.0"
language: ru
original: sveltekit-deployment
---

# Sveltekit Deployment

> Deployment with SvelteKit. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-deployment/SKILL.md`
