...
version: "1.0"
language: ru
original: sveltekit-ssg
---

# Sveltekit Ssg

> SSG with SvelteKit. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-ssg/SKILL.md`
