...
version: "1.0"
language: ru
original: remix-routing
---

# Remix Routing

> Routing with Remix. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Routing
...
## Ресурсы
- Оригинальный навык: `frontend/remix-routing/SKILL.md`
