...
version: "1.0"
language: ru
original: ngrx-persistence
---

# Ngrx Persistence

> Persistence with NgRx. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-persistence/SKILL.md`
