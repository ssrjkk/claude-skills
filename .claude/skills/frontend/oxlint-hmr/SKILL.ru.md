...
category: frontend
tags: [oxlint-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oxlint-hmr
...
> HMR with Oxlint. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-hmr/SKILL.md`
