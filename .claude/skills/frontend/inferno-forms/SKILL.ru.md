...
version: "1.0"
language: ru
original: inferno-forms
---

# Inferno Forms

> Forms with Inferno. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Forms
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-forms/SKILL.md`
