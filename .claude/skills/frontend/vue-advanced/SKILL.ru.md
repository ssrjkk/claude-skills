...
category: frontend
tags: [vue-advanced, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vue-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-advanced`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Advanced
...
## Ресурсы
- Оригинальный навык: frontend/vue-advanced/SKILL.md
