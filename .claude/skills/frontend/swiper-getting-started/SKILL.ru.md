...
category: frontend
tags: [swiper-getting-started, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swiper-getting-started
---

# Swiper Getting Started

> Getting Started for Swiper: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: swiper-getting-started.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swiper Getting Started
...
## Ресурсы
- frontend/swiper-getting-started/SKILL.md
