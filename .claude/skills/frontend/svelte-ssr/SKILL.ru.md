...
category: frontend
tags: [svelte-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-ssr
...
> SSR with Svelte. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-ssr/SKILL.md`
