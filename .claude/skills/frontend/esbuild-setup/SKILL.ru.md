...
version: "1.0"
language: ru
original: esbuild-setup
---

# Esbuild Setup

> Setup with esbuild. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esbuild-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Esbuild Setup
...
## Ресурсы
- Оригинальный навык: `frontend/esbuild-setup/SKILL.md`
