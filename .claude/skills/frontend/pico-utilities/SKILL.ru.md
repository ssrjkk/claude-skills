...
category: frontend
tags: [pico-utilities, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pico-utilities
---

# Pico Utilities

> Utilities with Pico CSS. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/pico-utilities/SKILL.md`
