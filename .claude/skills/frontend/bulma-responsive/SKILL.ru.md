...
version: "1.0"
language: ru
original: bulma-responsive
---

# Bulma Responsive

> Responsive with Bulma. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-responsive/SKILL.md`
