...
category: frontend
tags: [headless-ui-guides, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: headless-ui-guides
---

# Headless Ui Guides

> Guides for Headless-Ui: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `headless-ui-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Headless Ui Guides
...
## Ресурсы
- Оригинал: frontend/headless-ui-guides/SKILL.md
