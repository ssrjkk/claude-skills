...
version: "1.0"
language: ru
original: aurelia-accessibility
---

# Aurelia Accessibility

> Accessibility with Aurelia. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-accessibility/SKILL.md`
