...
version: "1.0"
language: ru
original: vue-components
---

# Vue Components

> Components with Vue. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Components
...
## Ресурсы
- Оригинальный навык: `frontend/vue-components/SKILL.md`
