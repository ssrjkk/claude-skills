...
version: "1.0"
language: ru
original: daisyui-utilities
---

# Daisyui Utilities

> Utilities with daisyUI. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `daisyui-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Daisyui Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/daisyui-utilities/SKILL.md`
