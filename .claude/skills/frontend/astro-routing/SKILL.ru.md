...
version: "1.0"
language: ru
original: astro-routing
---

# Astro Routing

> Routing with Astro. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Routing
...
## Ресурсы
- Оригинальный навык: `frontend/astro-routing/SKILL.md`
