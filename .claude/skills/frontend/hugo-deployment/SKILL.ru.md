...
version: "1.0"
language: ru
original: hugo-deployment
---

# Hugo Deployment

> Deployment with Hugo. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hugo-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Hugo Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/hugo-deployment/SKILL.md`
