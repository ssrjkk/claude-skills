...
category: frontend
tags: [solid-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Api
...
## Ресурсы
- Оригинальный навык: frontend/solid-api/SKILL.md
