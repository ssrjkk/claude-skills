...
category: frontend
tags: [less-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: less-plugins
---

# Less Plugins

> Plugins with Less. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/less-plugins/SKILL.md`
