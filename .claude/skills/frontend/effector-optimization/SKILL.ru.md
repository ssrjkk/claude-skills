...
category: frontend
tags: [effector-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: effector-optimization
---

# Effector Optimization

> Optimization with Effector. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/effector-optimization/SKILL.md`
