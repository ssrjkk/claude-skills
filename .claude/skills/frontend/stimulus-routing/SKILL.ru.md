...
category: frontend
tags: [stimulus-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stimulus-routing
---

# Stimulus Routing

> Routing with Stimulus. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Routing
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-routing/SKILL.md`
