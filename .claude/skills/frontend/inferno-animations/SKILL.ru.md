...
version: "1.0"
language: ru
original: inferno-animations
---

# Inferno Animations

> Animations with Inferno. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Animations
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-animations/SKILL.md`
