...
category: frontend
tags: [riot-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: riot-forms
...
> Forms with Riot. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Forms
...
## Ресурсы
- Оригинальный навык: `frontend/riot-forms/SKILL.md`
