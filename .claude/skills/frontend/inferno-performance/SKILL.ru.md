...
version: "1.0"
language: ru
original: inferno-performance
---

# Inferno Performance

> Performance with Inferno. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Performance
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-performance/SKILL.md`
