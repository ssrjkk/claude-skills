...
category: frontend
tags: [sveltekit-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sveltekit-routing
---

# Sveltekit Routing

> Routing with SvelteKit. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Routing
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-routing/SKILL.md`
