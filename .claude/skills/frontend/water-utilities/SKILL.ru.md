...
category: frontend
tags: [water-utilities, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: water-utilities
---

# Water Utilities

> Utilities with Water.css. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/water-utilities/SKILL.md`
