...
category: frontend
tags: [remix-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remix-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Debugging
...
## Ресурсы
- Оригинальный навык: frontend/remix-debugging/SKILL.md
