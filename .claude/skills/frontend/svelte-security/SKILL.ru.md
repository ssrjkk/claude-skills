...
## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Security
...
## Ресурсы
- Оригинальный навык: frontend/svelte-security/SKILL.md
