...
category: frontend
tags: [parcel-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: parcel-setup
---

# Parcel Setup

> Setup with Parcel. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Setup
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-setup/SKILL.md`
