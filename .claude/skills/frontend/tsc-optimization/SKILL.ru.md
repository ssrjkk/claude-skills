...
category: frontend
tags: [tsc-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tsc-optimization
---

# Tsc Optimization

> Optimization with TypeScript. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsc-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tsc Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/tsc-optimization/SKILL.md`
