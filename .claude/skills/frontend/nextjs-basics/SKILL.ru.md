...
category: frontend
tags: [nextjs-basics, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Basics
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-basics/SKILL.md
