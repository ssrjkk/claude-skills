...
version: "1.0"
language: ru
original: bootstrap-grid
---

# Bootstrap Grid

> Grid with Bootstrap. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Grid
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-grid/SKILL.md`
