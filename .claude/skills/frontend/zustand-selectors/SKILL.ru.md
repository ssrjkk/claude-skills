...
category: frontend
tags: [zustand-selectors, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zustand-selectors
---

# Zustand Selectors

> Selectors with Zustand. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-selectors/SKILL.md`
