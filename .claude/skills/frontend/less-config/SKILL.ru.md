...
category: frontend
tags: [less-config, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: less-config
---

# Less Config

> Config with Less. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Config
...
## Ресурсы
- Оригинальный навык: `frontend/less-config/SKILL.md`
