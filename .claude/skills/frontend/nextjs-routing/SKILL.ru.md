...
version: "1.0"
language: ru
original: nextjs-routing
---

# Nextjs Routing

> Routing with Next.js. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Routing
...
## Ресурсы
- Оригинальный навык: `frontend/nextjs-routing/SKILL.md`
