...
category: frontend
tags: [astro-security, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Security
...
## Ресурсы
- Оригинальный навык: frontend/astro-security/SKILL.md
