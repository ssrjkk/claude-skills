...
version: "1.0"
language: ru
original: pico-responsive
---

# Pico Responsive

> Responsive with Pico CSS. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/pico-responsive/SKILL.md`
