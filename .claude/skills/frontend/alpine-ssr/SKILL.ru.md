...
category: frontend
tags: [alpine-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: alpine-ssr
...
> SSR with Alpine. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Alpine Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/alpine-ssr/SKILL.md`
