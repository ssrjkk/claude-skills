...
version: "1.0"
language: ru
original: storybook-deployment
---

# Storybook Deployment

> Deployment with Storybook. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-deployment/SKILL.md`
