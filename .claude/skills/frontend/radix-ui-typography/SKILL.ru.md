...
version: "1.0"
language: ru
original: radix-ui-typography
---

# Radix Ui Typography

> Typography with Radix UI. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Typography
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-typography/SKILL.md`
