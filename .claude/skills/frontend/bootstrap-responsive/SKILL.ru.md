...
> Responsive with Bootstrap. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-responsive/SKILL.md`
