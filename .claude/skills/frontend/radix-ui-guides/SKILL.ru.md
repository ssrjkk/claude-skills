...
version: "1.0"
language: ru
original: radix-ui-guides
---

# Radix Ui Guides

> Guides for Radix-Ui: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `radix-ui-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Guides
...
## Ресурсы
- Оригинал: frontend/radix-ui-guides/SKILL.md
