...
category: frontend
tags: [nextjs-api-routes, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-api-routes
---

# Nextjs Api Routes

> API Routes with Next.js. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/nextjs-api-routes/SKILL.md`
