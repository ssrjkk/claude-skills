...
category: frontend
tags: [mithril-animations, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mithril-animations
---

# Mithril Animations

> Animations with Mithril. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Animations
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-animations/SKILL.md`
