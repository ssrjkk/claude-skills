...
category: frontend
tags: [babel-code-splitting, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: babel-code-splitting
---

# Babel Code Splitting

> Code Splitting with Babel. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/babel-code-splitting/SKILL.md`
