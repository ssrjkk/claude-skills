...
version: "1.0"
language: ru
original: xstate-store
---

# Xstate Store

> Store with XState. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Store
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-store/SKILL.md`
