...
category: frontend
tags: [solid-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-accessibility
---

# Solid Accessibility

> Accessibility with Solid. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/solid-accessibility/SKILL.md`
