...
version: "1.0"
language: ru
original: ngrx-actions
---

# Ngrx Actions

> Actions with NgRx. actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-actions`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Actions
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-actions/SKILL.md`
