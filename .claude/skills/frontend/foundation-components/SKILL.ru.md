...
> Components with Foundation. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Components
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-components/SKILL.md`
