...
version: "1.0"
language: ru
original: xstate-testing
---

# Xstate Testing

> Testing with XState. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Testing
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-testing/SKILL.md`
