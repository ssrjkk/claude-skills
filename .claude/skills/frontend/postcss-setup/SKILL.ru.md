...
category: frontend
tags: [postcss-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postcss-setup
---

# Postcss Setup

> Setup with PostCSS. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Setup
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-setup/SKILL.md`
