...
version: "1.0"
language: ru
original: zod-integration
---

# Zod Integration

> Integration for Zod: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: zod-integration.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zod Integration
...
## Ресурсы
- frontend/zod-integration/SKILL.md
