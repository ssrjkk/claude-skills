...
category: frontend
tags: [astro-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-ssr
...
> SSR with Astro. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/astro-ssr/SKILL.md`
