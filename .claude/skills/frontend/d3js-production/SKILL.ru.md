...
version: "1.0"
language: ru
original: d3js-production
---

# D3Js Production

> Production for D3Js: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: d3js-production.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с D3Js Production
...
## Ресурсы
- frontend/d3js-production/SKILL.md
