...
version: "1.0"
language: ru
original: purecss-theming
---

# Purecss Theming

> Theming with Pure.css. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `purecss-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Purecss Theming
...
## Ресурсы
- Оригинальный навык: `frontend/purecss-theming/SKILL.md`
