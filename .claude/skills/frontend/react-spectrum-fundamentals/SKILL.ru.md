...
version: "1.0"
language: ru
original: react-spectrum-fundamentals
---

# React Spectrum Fundamentals

> Fundamentals for React-Spectrum: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `react-spectrum-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Spectrum Fundamentals
...
## Ресурсы
- Оригинал: frontend/react-spectrum-fundamentals/SKILL.md
