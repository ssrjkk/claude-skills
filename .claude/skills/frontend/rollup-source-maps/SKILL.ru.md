...
version: "1.0"
language: ru
original: rollup-source-maps
---

# Rollup Source Maps

> Source Maps with Rollup. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-source-maps/SKILL.md`
