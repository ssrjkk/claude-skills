...
version: "1.0"
language: ru
original: mithril-accessibility
---

# Mithril Accessibility

> Accessibility with Mithril. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-accessibility/SKILL.md`
