...
category: frontend
tags: [redux-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redux-testing
---

# Redux Testing

> Testing with Redux. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redux-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Redux Testing
...
## Ресурсы
- Оригинальный навык: `frontend/redux-testing/SKILL.md`
