...
version: "1.0"
language: ru
original: alpine-animations
---

# Alpine Animations

> Animations with Alpine. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Alpine Animations
...
## Ресурсы
- Оригинальный навык: `frontend/alpine-animations/SKILL.md`
