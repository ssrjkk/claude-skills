...
category: frontend
tags: [aurelia-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aurelia-components
---

# Aurelia Components

> Components with Aurelia. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Components
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-components/SKILL.md`
