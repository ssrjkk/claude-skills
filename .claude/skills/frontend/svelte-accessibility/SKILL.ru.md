...
version: "1.0"
language: ru
original: svelte-accessibility
---

# Svelte Accessibility

> Accessibility with Svelte. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-accessibility/SKILL.md`
