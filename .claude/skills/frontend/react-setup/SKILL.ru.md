...
category: frontend
tags: [react-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Setup
...
## Ресурсы
- Оригинальный навык: frontend/react-setup/SKILL.md
