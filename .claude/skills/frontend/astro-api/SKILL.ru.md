...
category: frontend
tags: [astro-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Api
...
## Ресурсы
- Оригинальный навык: frontend/astro-api/SKILL.md
