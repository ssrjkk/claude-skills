...
category: frontend
tags: [solid-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-forms
---

# Solid Forms

> Forms with Solid. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Forms
...
## Ресурсы
- Оригинальный навык: `frontend/solid-forms/SKILL.md`
