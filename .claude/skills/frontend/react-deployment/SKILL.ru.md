...
category: frontend
tags: [react-deployment, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Deployment
...
## Ресурсы
- Оригинальный навык: frontend/react-deployment/SKILL.md
