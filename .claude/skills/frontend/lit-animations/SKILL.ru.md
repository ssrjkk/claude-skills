...
category: frontend
tags: [lit-animations, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lit-animations
---

# Lit Animations

> Animations with Lit. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Animations
...
## Ресурсы
- Оригинальный навык: `frontend/lit-animations/SKILL.md`
