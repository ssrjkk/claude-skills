...
category: frontend
tags: [ant-design-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-forms
---

# Ant Design Forms

> Forms with Ant Design. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Forms
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-forms/SKILL.md`
