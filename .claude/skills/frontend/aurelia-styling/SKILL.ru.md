...
version: "1.0"
language: ru
original: aurelia-styling
---

# Aurelia Styling

> Styling with Aurelia. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Styling
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-styling/SKILL.md`
