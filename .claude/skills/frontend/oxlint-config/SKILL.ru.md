...
version: "1.0"
language: ru
original: oxlint-config
---

# Oxlint Config

> Config with Oxlint. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Config
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-config/SKILL.md`
