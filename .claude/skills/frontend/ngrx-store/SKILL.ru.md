...
category: frontend
tags: [ngrx-store, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ngrx-store
...
> Store with NgRx. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Store
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-store/SKILL.md`
