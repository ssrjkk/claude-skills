...
category: frontend
tags: [angular-performance, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-performance
---

# Angular Performance

> Performance with Angular. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Performance
...
## Ресурсы
- Оригинальный навык: `frontend/angular-performance/SKILL.md`
