...
version: "1.0"
language: ru
original: gsap-integration
---

# Gsap Integration

> Integration for Gsap: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: gsap-integration.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gsap Integration
...
## Ресурсы
- frontend/gsap-integration/SKILL.md
