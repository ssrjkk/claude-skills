...
category: frontend
tags: [preact-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: preact-ssr
...
> SSR with Preact. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/preact-ssr/SKILL.md`
