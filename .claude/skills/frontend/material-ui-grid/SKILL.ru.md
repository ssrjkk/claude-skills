...
category: frontend
tags: [material-ui-grid, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: material-ui-grid
---

# Material Ui Grid

> Grid with MUI. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Grid
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-grid/SKILL.md`
