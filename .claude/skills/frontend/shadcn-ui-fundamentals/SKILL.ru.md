...
version: "1.0"
language: ru
original: shadcn-ui-fundamentals
---

# Shadcn Ui Fundamentals

> Fundamentals for Shadcn-Ui: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `shadcn-ui-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Shadcn Ui Fundamentals
...
## Ресурсы
- Оригинал: frontend/shadcn-ui-fundamentals/SKILL.md
