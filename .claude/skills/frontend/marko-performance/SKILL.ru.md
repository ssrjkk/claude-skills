...
version: "1.0"
language: ru
original: marko-performance
---

# Marko Performance

> Performance with Marko. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Performance
...
## Ресурсы
- Оригинальный навык: `frontend/marko-performance/SKILL.md`
