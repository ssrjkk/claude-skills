...
version: "1.0"
language: ru
original: tailwind-theming
---

# Tailwind Theming

> Theming with Tailwind CSS. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Theming
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-theming/SKILL.md`
