...
category: frontend
tags: [aurelia-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aurelia-forms
---

# Aurelia Forms

> Forms with Aurelia. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Forms
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-forms/SKILL.md`
