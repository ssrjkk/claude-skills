...
version: "1.0"
language: ru
original: effector-store
---

# Effector Store

> Store with Effector. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Store
...
## Ресурсы
- Оригинальный навык: `frontend/effector-store/SKILL.md`
