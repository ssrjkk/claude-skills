...
version: "1.0"
language: ru
original: ant-design-responsive
---

# Ant Design Responsive

> Responsive with Ant Design. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-responsive/SKILL.md`
