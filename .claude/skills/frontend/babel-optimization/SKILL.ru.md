...
category: frontend
tags: [babel-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: babel-optimization
---

# Babel Optimization

> Optimization with Babel. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/babel-optimization/SKILL.md`
