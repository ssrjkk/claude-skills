...
category: frontend
tags: [pico-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pico-theming
---

# Pico Theming

> Theming with Pico CSS. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Theming
...
## Ресурсы
- Оригинальный навык: `frontend/pico-theming/SKILL.md`
