...
category: frontend
tags: [astro-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Optimization
...
## Ресурсы
- Оригинальный навык: frontend/astro-optimization/SKILL.md
