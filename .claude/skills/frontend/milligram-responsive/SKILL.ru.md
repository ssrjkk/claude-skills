...
## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-responsive/SKILL.md`
