...
category: frontend
tags: [angular-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Debugging
...
## Ресурсы
- Оригинальный навык: frontend/angular-debugging/SKILL.md
