...
category: frontend
tags: [alpine-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: alpine-accessibility
---

# Alpine Accessibility

> Accessibility with Alpine. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Alpine Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/alpine-accessibility/SKILL.md`
