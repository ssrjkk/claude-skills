...
category: frontend
tags: [tailwind-utilities, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Utilities with Tailwind CSS. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-utilities/SKILL.md`
