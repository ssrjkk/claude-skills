...
version: "1.0"
language: ru
original: qwik-api-routes
---

# Qwik Api Routes

> API Routes with Qwik. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qwik-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Qwik Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/qwik-api-routes/SKILL.md`
