...
version: "1.0"
language: ru
original: histoire-setup
---

# Histoire Setup

> Setup for Histoire: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `histoire-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Histoire Setup
...
## Ресурсы
- Оригинал: frontend/histoire-setup/SKILL.md
