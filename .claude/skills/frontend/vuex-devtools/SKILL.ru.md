...
version: "1.0"
language: ru
original: vuex-devtools
---

# Vuex Devtools

> DevTools with Vuex. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vuex-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vuex Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/vuex-devtools/SKILL.md`
