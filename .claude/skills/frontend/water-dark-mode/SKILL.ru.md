...
category: frontend
tags: [water-dark-mode, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: water-dark-mode
---

# Water Dark Mode

> Dark Mode with Water.css. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/water-dark-mode/SKILL.md`
