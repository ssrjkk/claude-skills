...
version: "1.0"
language: ru
original: water-forms
---

# Water Forms

> Forms with Water.css. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Forms
...
## Ресурсы
- Оригинальный навык: `frontend/water-forms/SKILL.md`
