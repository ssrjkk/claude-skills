...
version: "1.0"
language: ru
original: nextjs-deployment
---

# Nextjs Deployment

> Deployment with Next.js. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/nextjs-deployment/SKILL.md`
