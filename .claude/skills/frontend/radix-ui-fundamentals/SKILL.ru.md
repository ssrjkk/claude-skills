...
category: frontend
tags: [radix-ui-fundamentals, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: radix-ui-fundamentals
---

# Radix Ui Fundamentals

> Fundamentals for Radix-Ui: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `radix-ui-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Fundamentals
...
## Ресурсы
- Оригинал: frontend/radix-ui-fundamentals/SKILL.md
