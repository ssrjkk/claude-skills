...
category: frontend
tags: [akita-selectors, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: akita-selectors
---

# Akita Selectors

> Selectors with Akita. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akita-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Akita Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/akita-selectors/SKILL.md`
