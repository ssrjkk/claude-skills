...
category: frontend
tags: [mithril-state-management, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mithril-state-management
---

# Mithril State Management

> State Management with Mithril. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril State Management
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-state-management/SKILL.md`
