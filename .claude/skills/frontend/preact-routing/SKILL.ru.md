...
## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Routing
...
## Ресурсы
- Оригинальный навык: `frontend/preact-routing/SKILL.md`
