...
version: "1.0"
language: ru
original: backbone-accessibility
---

# Backbone Accessibility

> Accessibility with Backbone. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-accessibility/SKILL.md`
