...
version: "1.0"
language: ru
original: material-ui-utilities
---

# Material Ui Utilities

> Utilities with MUI. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-utilities/SKILL.md`
