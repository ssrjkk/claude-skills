...
version: "1.0"
language: ru
original: bulma-forms
---

# Bulma Forms

> Forms with Bulma. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Forms
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-forms/SKILL.md`
