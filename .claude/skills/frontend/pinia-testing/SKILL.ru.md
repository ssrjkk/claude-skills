...
category: frontend
tags: [pinia-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinia-testing
---

# Pinia Testing

> Testing with Pinia. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinia-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pinia Testing
...
## Ресурсы
- Оригинальный навык: `frontend/pinia-testing/SKILL.md`
