...
version: "1.0"
language: ru
original: milligram-components
---

# Milligram Components

> Components with Milligram. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Components
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-components/SKILL.md`
