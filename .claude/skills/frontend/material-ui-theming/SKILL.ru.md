...
version: "1.0"
language: ru
original: material-ui-theming
---

# Material Ui Theming

> Theming with MUI. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Theming
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-theming/SKILL.md`
