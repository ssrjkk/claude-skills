...
> Store with Vuex. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vuex-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vuex Store
...
## Ресурсы
- Оригинальный навык: `frontend/vuex-store/SKILL.md`
