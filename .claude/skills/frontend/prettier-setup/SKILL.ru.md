...
version: "1.0"
language: ru
original: prettier-setup
---

# Prettier Setup

> Setup with Prettier. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Setup
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-setup/SKILL.md`
