...
category: frontend
tags: [inferno-state-management, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: inferno-state-management
---

# Inferno State Management

> State Management with Inferno. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno State Management
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-state-management/SKILL.md`
