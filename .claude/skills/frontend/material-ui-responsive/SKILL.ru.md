...
category: frontend
tags: [material-ui-responsive, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: material-ui-responsive
---

# Material Ui Responsive

> Responsive with MUI. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-responsive/SKILL.md`
