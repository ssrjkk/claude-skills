...
version: "1.0"
language: ru
original: radix-ui-quickstart
---

# Radix Ui Quickstart

> Quickstart for Radix-Ui: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `radix-ui-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Quickstart
...
## Ресурсы
- Оригинал: frontend/radix-ui-quickstart/SKILL.md
