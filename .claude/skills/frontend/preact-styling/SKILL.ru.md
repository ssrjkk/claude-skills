...
category: frontend
tags: [preact-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: preact-styling
---

# Preact Styling

> Styling with Preact. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Styling
...
## Ресурсы
- Оригинальный навык: `frontend/preact-styling/SKILL.md`
