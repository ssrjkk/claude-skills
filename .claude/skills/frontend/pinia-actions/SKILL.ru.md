...
version: "1.0"
language: ru
original: pinia-actions
---

# Pinia Actions

> Actions with Pinia. actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinia-actions`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pinia Actions
...
## Ресурсы
- Оригинальный навык: `frontend/pinia-actions/SKILL.md`
