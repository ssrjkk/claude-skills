...
category: frontend
tags: [stimulus-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stimulus-components
---

# Stimulus Components

> Components with Stimulus. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Components
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-components/SKILL.md`
