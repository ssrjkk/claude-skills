...
version: "1.0"
language: ru
original: storybook-routing
---

# Storybook Routing

> Routing with Storybook. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Routing
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-routing/SKILL.md`
