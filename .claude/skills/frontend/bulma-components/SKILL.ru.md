...
version: "1.0"
language: ru
original: bulma-components
---

# Bulma Components

> Components with Bulma. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Components
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-components/SKILL.md`
