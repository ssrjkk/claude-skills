...
version: "1.0"
language: ru
original: eleventy-ssg
---

# Eleventy Ssg

> SSG with Eleventy. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eleventy-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eleventy Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/eleventy-ssg/SKILL.md`
