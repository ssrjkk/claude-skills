...
version: "1.0"
language: ru
original: effector-middleware
---

# Effector Middleware

> Middleware with Effector. side effects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/effector-middleware/SKILL.md`
