...
category: frontend
tags: [cva-usage, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cva-usage
...
> Usage for Cva: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cva-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Cva Usage
...
## Ресурсы
- Оригинал: frontend/cva-usage/SKILL.md
