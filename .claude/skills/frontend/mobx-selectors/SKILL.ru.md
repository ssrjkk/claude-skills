...
version: "1.0"
language: ru
original: mobx-selectors
---

# Mobx Selectors

> Selectors with MobX. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-selectors/SKILL.md`
