...
version: "1.0"
language: ru
original: angular-ssr
---

# Angular Ssr

> SSR with Angular. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/angular-ssr/SKILL.md`
