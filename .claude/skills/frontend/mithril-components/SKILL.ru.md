...
category: frontend
tags: [mithril-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mithril-components
---

# Mithril Components

> Components with Mithril. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Components
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-components/SKILL.md`
