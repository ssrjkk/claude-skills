...
version: "1.0"
language: ru
original: hugo-api-routes
---

# Hugo Api Routes

> API Routes with Hugo. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hugo-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Hugo Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/hugo-api-routes/SKILL.md`
