...
version: "1.0"
language: ru
original: eleventy-isr
---

# Eleventy Isr

> ISR with Eleventy. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eleventy-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eleventy Isr
...
## Ресурсы
- Оригинальный навык: `frontend/eleventy-isr/SKILL.md`
