...
category: frontend
tags: [svelte-performance, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-performance
---

# Svelte Performance

> Performance with Svelte. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Performance
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-performance/SKILL.md`
