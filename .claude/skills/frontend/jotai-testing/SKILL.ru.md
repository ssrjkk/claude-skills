...
category: frontend
tags: [jotai-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jotai-testing
---

# Jotai Testing

> Testing with Jotai. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jotai-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jotai Testing
...
## Ресурсы
- Оригинальный навык: `frontend/jotai-testing/SKILL.md`
