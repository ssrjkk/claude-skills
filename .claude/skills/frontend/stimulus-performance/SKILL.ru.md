...
version: "1.0"
language: ru
original: stimulus-performance
---

# Stimulus Performance

> Performance with Stimulus. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Performance
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-performance/SKILL.md`
