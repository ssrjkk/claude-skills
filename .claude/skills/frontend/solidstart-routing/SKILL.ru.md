...
category: frontend
tags: [solidstart-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solidstart-routing
---

# Solidstart Routing

> Routing with SolidStart. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solidstart-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solidstart Routing
...
## Ресурсы
- Оригинальный навык: `frontend/solidstart-routing/SKILL.md`
