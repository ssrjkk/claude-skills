...
category: frontend
tags: [oxlint-source-maps, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oxlint-source-maps
---

# Oxlint Source Maps

> Source Maps with Oxlint. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-source-maps/SKILL.md`
