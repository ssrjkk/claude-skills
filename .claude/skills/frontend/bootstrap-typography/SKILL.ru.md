...
category: frontend
tags: [bootstrap-typography, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bootstrap-typography
---

# Bootstrap Typography

> Typography with Bootstrap. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Typography
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-typography/SKILL.md`
