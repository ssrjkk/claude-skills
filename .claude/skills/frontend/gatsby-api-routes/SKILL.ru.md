...
category: frontend
tags: [gatsby-api-routes, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatsby-api-routes
---

# Gatsby Api Routes

> API Routes with Gatsby. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatsby-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gatsby Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/gatsby-api-routes/SKILL.md`
