...
version: "1.0"
language: ru
original: backbone-styling
---

# Backbone Styling

> Styling with Backbone. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Styling
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-styling/SKILL.md`
