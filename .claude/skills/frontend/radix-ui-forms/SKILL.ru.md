...
version: "1.0"
language: ru
original: radix-ui-forms
---

# Radix Ui Forms

> Forms with Radix UI. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Forms
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-forms/SKILL.md`
