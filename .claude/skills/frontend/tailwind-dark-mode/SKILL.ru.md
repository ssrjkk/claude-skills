...
version: "1.0"
language: ru
original: tailwind-dark-mode
---

# Tailwind Dark Mode

> Dark Mode with Tailwind CSS. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-dark-mode/SKILL.md`
