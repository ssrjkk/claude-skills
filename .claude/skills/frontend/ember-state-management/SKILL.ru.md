...
version: "1.0"
language: ru
original: ember-state-management
---

# Ember State Management

> State Management with Ember. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember State Management
...
## Ресурсы
- Оригинальный навык: `frontend/ember-state-management/SKILL.md`
