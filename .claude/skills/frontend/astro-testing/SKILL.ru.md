...
category: frontend
tags: [astro-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Testing
...
## Ресурсы
- Оригинальный навык: frontend/astro-testing/SKILL.md
