...
version: "1.0"
language: ru
original: akita-testing
---

# Akita Testing

> Testing with Akita. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akita-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Akita Testing
...
## Ресурсы
- Оригинальный навык: `frontend/akita-testing/SKILL.md`
