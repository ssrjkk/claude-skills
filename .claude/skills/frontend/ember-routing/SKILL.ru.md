...
category: frontend
tags: [ember-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ember-routing
---

# Ember Routing

> Routing with Ember. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Routing
...
## Ресурсы
- Оригинальный навык: `frontend/ember-routing/SKILL.md`
