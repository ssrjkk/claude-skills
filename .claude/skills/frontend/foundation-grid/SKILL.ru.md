...
version: "1.0"
language: ru
original: foundation-grid
---

# Foundation Grid

> Grid with Foundation. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Grid
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-grid/SKILL.md`
