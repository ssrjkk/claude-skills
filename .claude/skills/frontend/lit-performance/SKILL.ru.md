...
category: frontend
tags: [lit-performance, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lit-performance
---

# Lit Performance

> Performance with Lit. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Performance
...
## Ресурсы
- Оригинальный навык: `frontend/lit-performance/SKILL.md`
