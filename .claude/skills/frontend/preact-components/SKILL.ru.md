...
version: "1.0"
language: ru
original: preact-components
---

# Preact Components

> Components with Preact. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Components
...
## Ресурсы
- Оригинальный навык: `frontend/preact-components/SKILL.md`
