...
version: "1.0"
language: ru
original: inferno-accessibility
---

# Inferno Accessibility

> Accessibility with Inferno. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-accessibility/SKILL.md`
