...
category: frontend
tags: [stylus-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stylus-bundling
---

# Stylus Bundling

> Bundling with Stylus. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-bundling/SKILL.md`
