...
version: "1.0"
language: ru
original: storybook-isr
---

# Storybook Isr

> ISR with Storybook. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Isr
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-isr/SKILL.md`
