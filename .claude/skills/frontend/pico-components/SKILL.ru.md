...
version: "1.0"
language: ru
original: pico-components
---

# Pico Components

> Components with Pico CSS. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Components
...
## Ресурсы
- Оригинальный навык: `frontend/pico-components/SKILL.md`
