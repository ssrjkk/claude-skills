...
version: "1.0"
language: ru
original: react-animations
---

# React Animations

> Animations with React. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Animations
...
## Ресурсы
- Оригинальный навык: `frontend/react-animations/SKILL.md`
