...
version: "1.0"
language: ru
original: prettier-optimization
---

# Prettier Optimization

> Optimization with Prettier. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-optimization/SKILL.md`
