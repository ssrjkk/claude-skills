...
version: "1.0"
language: ru
original: aurelia-animations
---

# Aurelia Animations

> Animations with Aurelia. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Animations
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-animations/SKILL.md`
