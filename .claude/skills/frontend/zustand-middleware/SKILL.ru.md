...
category: frontend
tags: [zustand-middleware, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zustand-middleware
---

# Zustand Middleware

> Middleware with Zustand. side effects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-middleware/SKILL.md`
