...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Deployment
...
## Ресурсы
- Оригинальный навык: frontend/vue-deployment/SKILL.md
