...
version: "1.0"
language: ru
original: mobx-devtools
---

# Mobx Devtools

> DevTools with MobX. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-devtools/SKILL.md`
