...
> Store with Pinia. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinia-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pinia Store
...
## Ресурсы
- Оригинальный навык: `frontend/pinia-store/SKILL.md`
