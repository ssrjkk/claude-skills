...
category: frontend
tags: [eslint-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eslint-hmr
...
> HMR with ESLint. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-hmr/SKILL.md`
