...
version: "1.0"
language: ru
original: tsc-plugins
---

# Tsc Plugins

> Plugins with TypeScript. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsc-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tsc Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/tsc-plugins/SKILL.md`
