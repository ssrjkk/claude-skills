...
category: frontend
tags: [vite-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vite-bundling
---

# Vite Bundling

> Bundling with Vite. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/vite-bundling/SKILL.md`
