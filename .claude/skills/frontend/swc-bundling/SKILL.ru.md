...
version: "1.0"
language: ru
original: swc-bundling
---

# Swc Bundling

> Bundling with SWC. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swc-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swc Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/swc-bundling/SKILL.md`
