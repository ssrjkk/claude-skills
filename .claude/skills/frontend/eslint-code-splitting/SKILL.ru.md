...
category: frontend
tags: [eslint-code-splitting, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eslint-code-splitting
---

# Eslint Code Splitting

> Code Splitting with ESLint. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-code-splitting/SKILL.md`
