...
version: "1.0"
language: ru
original: sveltekit-api-routes
---

# Sveltekit Api Routes

> API Routes with SvelteKit. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-api-routes/SKILL.md`
