...
version: "1.0"
language: ru
original: foundation-utilities
---

# Foundation Utilities

> Utilities with Foundation. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-utilities/SKILL.md`
