...
version: "1.0"
language: ru
original: chakra-ui-forms
---

# Chakra Ui Forms

> Forms with Chakra UI. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Forms
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-forms/SKILL.md`
