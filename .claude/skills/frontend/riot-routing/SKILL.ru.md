...
category: frontend
tags: [riot-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: riot-routing
---

# Riot Routing

> Routing with Riot. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Routing
...
## Ресурсы
- Оригинальный навык: `frontend/riot-routing/SKILL.md`
