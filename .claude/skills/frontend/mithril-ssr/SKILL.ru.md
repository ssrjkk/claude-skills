...
version: "1.0"
language: ru
original: mithril-ssr
---

# Mithril Ssr

> SSR with Mithril. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-ssr/SKILL.md`
