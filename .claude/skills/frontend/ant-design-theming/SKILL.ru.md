...
category: frontend
tags: [ant-design-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-theming
---

# Ant Design Theming

> Theming with Ant Design. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Theming
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-theming/SKILL.md`
