...
version: "1.0"
language: ru
original: ngrx-optimization
---

# Ngrx Optimization

> Optimization with NgRx. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-optimization/SKILL.md`
