...
category: frontend
tags: [redux-selectors, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redux-selectors
---

# Redux Selectors

> Selectors with Redux. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redux-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Redux Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/redux-selectors/SKILL.md`
