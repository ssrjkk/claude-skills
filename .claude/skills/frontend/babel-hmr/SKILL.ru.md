...
category: frontend
tags: [babel-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: babel-hmr
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/babel-hmr/SKILL.md`
