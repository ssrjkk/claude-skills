...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Theming
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-theming/SKILL.md`
