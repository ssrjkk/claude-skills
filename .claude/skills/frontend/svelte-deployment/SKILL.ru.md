...
## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Deployment
...
## Ресурсы
- Оригинальный навык: frontend/svelte-deployment/SKILL.md
