...
version: "1.0"
language: ru
original: eleventy-routing
---

# Eleventy Routing

> Routing with Eleventy. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eleventy-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eleventy Routing
...
## Ресурсы
- Оригинальный навык: `frontend/eleventy-routing/SKILL.md`
