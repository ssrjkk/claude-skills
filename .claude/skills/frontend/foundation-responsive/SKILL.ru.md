...
version: "1.0"
language: ru
original: foundation-responsive
---

# Foundation Responsive

> Responsive with Foundation. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-responsive/SKILL.md`
