...
version: "1.0"
language: ru
original: chakra-ui-typography
---

# Chakra Ui Typography

> Typography with Chakra UI. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Typography
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-typography/SKILL.md`
