...
> Plugins with ESLint. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-plugins/SKILL.md`
