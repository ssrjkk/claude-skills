...
version: "1.0"
language: ru
original: remix-deployment
---

# Remix Deployment

> Deployment with Remix. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/remix-deployment/SKILL.md`
