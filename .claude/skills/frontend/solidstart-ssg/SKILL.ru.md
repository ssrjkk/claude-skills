...
version: "1.0"
language: ru
original: solidstart-ssg
---

# Solidstart Ssg

> SSG with SolidStart. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solidstart-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solidstart Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/solidstart-ssg/SKILL.md`
