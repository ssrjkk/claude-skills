...
category: frontend
tags: [ultra-usage, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Usage for Ultra: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ultra-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ultra Usage
...
## Ресурсы
- Оригинал: frontend/ultra-usage/SKILL.md
