...
category: frontend
tags: [babel-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: babel-bundling
---

# Babel Bundling

> Bundling with Babel. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/babel-bundling/SKILL.md`
