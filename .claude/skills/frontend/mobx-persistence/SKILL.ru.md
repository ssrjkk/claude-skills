...
version: "1.0"
language: ru
original: mobx-persistence
---

# Mobx Persistence

> Persistence with MobX. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-persistence/SKILL.md`
