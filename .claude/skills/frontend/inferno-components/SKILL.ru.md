...
category: frontend
tags: [inferno-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: inferno-components
---

# Inferno Components

> Components with Inferno. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `inferno-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Inferno Components
...
## Ресурсы
- Оригинальный навык: `frontend/inferno-components/SKILL.md`
