...
version: "1.0"
language: ru
original: lit-styling
---

# Lit Styling

> Styling with Lit. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lit-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lit Styling
...
## Ресурсы
- Оригинальный навык: `frontend/lit-styling/SKILL.md`
