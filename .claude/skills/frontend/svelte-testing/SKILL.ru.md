...
category: frontend
tags: [svelte-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-testing
---

# Svelte Testing

> Testing with Svelte. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Testing
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-testing/SKILL.md`
