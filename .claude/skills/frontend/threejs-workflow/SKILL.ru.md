...
category: frontend
tags: [threejs-workflow, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: threejs-workflow
---

# Threejs Workflow

> Workflow for Threejs: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: threejs-workflow.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Threejs Workflow
...
## Ресурсы
- frontend/threejs-workflow/SKILL.md
