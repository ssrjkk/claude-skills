...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spectre-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Spectre Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/spectre-responsive/SKILL.md`
