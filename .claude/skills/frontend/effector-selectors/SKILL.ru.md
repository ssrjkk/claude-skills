...
## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/effector-selectors/SKILL.md`
