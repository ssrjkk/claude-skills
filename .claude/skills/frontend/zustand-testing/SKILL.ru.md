...
version: "1.0"
language: ru
original: zustand-testing
---

# Zustand Testing

> Testing with Zustand. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Testing
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-testing/SKILL.md`
