...
version: "1.0"
language: ru
original: babel-source-maps
---

# Babel Source Maps

> Source Maps with Babel. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/babel-source-maps/SKILL.md`
