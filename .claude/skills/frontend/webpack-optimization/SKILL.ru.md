...
version: "1.0"
language: ru
original: webpack-optimization
---

# Webpack Optimization

> Optimization with Webpack. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-optimization/SKILL.md`
