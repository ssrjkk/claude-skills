...
category: frontend
tags: [bootstrap-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bootstrap-components
---

# Bootstrap Components

> Components with Bootstrap. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Components
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-components/SKILL.md`
