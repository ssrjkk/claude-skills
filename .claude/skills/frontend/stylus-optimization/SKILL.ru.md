...
version: "1.0"
language: ru
original: stylus-optimization
---

# Stylus Optimization

> Optimization with Stylus. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-optimization/SKILL.md`
