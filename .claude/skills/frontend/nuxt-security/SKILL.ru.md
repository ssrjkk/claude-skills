...
category: frontend
tags: [nuxt-security, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Security
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-security/SKILL.md
