...
> Store with Redux. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redux-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Redux Store
...
## Ресурсы
- Оригинальный навык: `frontend/redux-store/SKILL.md`
