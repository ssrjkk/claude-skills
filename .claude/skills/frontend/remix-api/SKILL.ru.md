...
category: frontend
tags: [remix-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remix-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Api
...
## Ресурсы
- Оригинальный навык: frontend/remix-api/SKILL.md
