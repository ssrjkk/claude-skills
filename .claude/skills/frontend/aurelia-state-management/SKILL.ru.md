...
category: frontend
tags: [aurelia-state-management, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aurelia-state-management
---

# Aurelia State Management

> State Management with Aurelia. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia State Management
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-state-management/SKILL.md`
