...
category: frontend
tags: [shadcn-ui-quickstart, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shadcn-ui-quickstart
---

# Shadcn Ui Quickstart

> Quickstart for Shadcn-Ui: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `shadcn-ui-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Shadcn Ui Quickstart
...
## Ресурсы
- Оригинал: frontend/shadcn-ui-quickstart/SKILL.md
