...
version: "1.0"
language: ru
original: d3js-best-practices
---

# D3Js Best Practices

> Best Practices for D3Js: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: d3js-best-practices.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с D3Js Best Practices
...
## Ресурсы
- frontend/d3js-best-practices/SKILL.md
