...
category: frontend
tags: [vitepress-ssg, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitepress-ssg
---

# Vitepress Ssg

> SSG with VitePress. static generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitepress-ssg`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vitepress Ssg
...
## Ресурсы
- Оригинальный навык: `frontend/vitepress-ssg/SKILL.md`
