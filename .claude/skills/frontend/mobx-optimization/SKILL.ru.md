...
category: frontend
tags: [mobx-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mobx-optimization
---

# Mobx Optimization

> Optimization with MobX. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-optimization/SKILL.md`
