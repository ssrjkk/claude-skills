...
version: "1.0"
language: ru
original: tailwind-forms
---

# Tailwind Forms

> Forms with Tailwind CSS. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Forms
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-forms/SKILL.md`
