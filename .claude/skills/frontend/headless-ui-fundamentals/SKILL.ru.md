...
category: frontend
tags: [headless-ui-fundamentals, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: headless-ui-fundamentals
---

# Headless Ui Fundamentals

> Fundamentals for Headless-Ui: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `headless-ui-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Headless Ui Fundamentals
...
## Ресурсы
- Оригинал: frontend/headless-ui-fundamentals/SKILL.md
