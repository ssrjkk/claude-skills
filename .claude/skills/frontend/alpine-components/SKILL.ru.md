...
version: "1.0"
language: ru
original: alpine-components
---

# Alpine Components

> Components with Alpine. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Alpine Components
...
## Ресурсы
- Оригинальный навык: `frontend/alpine-components/SKILL.md`
