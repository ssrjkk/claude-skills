...
category: frontend
tags: [radix-ui-dark-mode, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: radix-ui-dark-mode
---

# Radix Ui Dark Mode

> Dark Mode with Radix UI. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-dark-mode/SKILL.md`
