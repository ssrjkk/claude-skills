...
category: frontend
tags: [remix-security, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remix-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `remix-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Remix Security
...
## Ресурсы
- Оригинальный навык: frontend/remix-security/SKILL.md
