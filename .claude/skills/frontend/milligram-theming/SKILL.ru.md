...
version: "1.0"
language: ru
original: milligram-theming
---

# Milligram Theming

> Theming with Milligram. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Theming
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-theming/SKILL.md`
