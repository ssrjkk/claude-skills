...
version: "1.0"
language: ru
original: webpack-source-maps
---

# Webpack Source Maps

> Source Maps with Webpack. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-source-maps/SKILL.md`
