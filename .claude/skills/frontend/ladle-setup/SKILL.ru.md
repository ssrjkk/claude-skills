...
version: "1.0"
language: ru
original: ladle-setup
---

# Ladle Setup

> Setup for Ladle: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ladle-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ladle Setup
...
## Ресурсы
- Оригинал: frontend/ladle-setup/SKILL.md
