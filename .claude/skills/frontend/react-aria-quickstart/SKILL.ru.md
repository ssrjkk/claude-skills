...
category: frontend
tags: [react-aria-quickstart, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-aria-quickstart
---

# React Aria Quickstart

> Quickstart for React-Aria: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `react-aria-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Aria Quickstart
...
## Ресурсы
- Оригинал: frontend/react-aria-quickstart/SKILL.md
