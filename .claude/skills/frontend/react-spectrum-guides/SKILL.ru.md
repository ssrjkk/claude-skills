...
category: frontend
tags: [react-spectrum-guides, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-spectrum-guides
---

# React Spectrum Guides

> Guides for React-Spectrum: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `react-spectrum-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Spectrum Guides
...
## Ресурсы
- Оригинал: frontend/react-spectrum-guides/SKILL.md
