...
category: frontend
tags: [ngrx-selectors, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ngrx-selectors
---

# Ngrx Selectors

> Selectors with NgRx. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-selectors/SKILL.md`
