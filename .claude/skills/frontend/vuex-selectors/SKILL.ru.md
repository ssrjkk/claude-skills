...
version: "1.0"
language: ru
original: vuex-selectors
---

# Vuex Selectors

> Selectors with Vuex. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vuex-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vuex Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/vuex-selectors/SKILL.md`
