...
category: frontend
tags: [riot-animations, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: riot-animations
---

# Riot Animations

> Animations with Riot. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Animations
...
## Ресурсы
- Оригинальный навык: `frontend/riot-animations/SKILL.md`
