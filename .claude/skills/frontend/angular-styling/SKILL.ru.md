...
category: frontend
tags: [angular-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-styling
---

# Angular Styling

> Styling with Angular. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Styling
...
## Ресурсы
- Оригинальный навык: `frontend/angular-styling/SKILL.md`
