...
version: "1.0"
language: ru
original: recoil-selectors
---

# Recoil Selectors

> Selectors with Recoil. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `recoil-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Recoil Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/recoil-selectors/SKILL.md`
