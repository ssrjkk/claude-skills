...
category: frontend
tags: [mobx-store, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mobx-store
...
> Store with MobX. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Store
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-store/SKILL.md`
