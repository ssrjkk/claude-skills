...
version: "1.0"
language: ru
original: webpack-bundling
---

# Webpack Bundling

> Bundling with Webpack. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-bundling/SKILL.md`
