...
category: frontend
tags: [mithril-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mithril-forms
---

# Mithril Forms

> Forms with Mithril. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Forms
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-forms/SKILL.md`
