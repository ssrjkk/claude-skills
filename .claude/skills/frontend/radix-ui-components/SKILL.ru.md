...
category: frontend
tags: [radix-ui-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Components with Radix UI. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Components
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-components/SKILL.md`
