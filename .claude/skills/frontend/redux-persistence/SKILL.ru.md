...
version: "1.0"
language: ru
original: redux-persistence
---

# Redux Persistence

> Persistence with Redux. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `redux-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Redux Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/redux-persistence/SKILL.md`
