...
version: "1.0"
language: ru
original: zod-production
---

# Zod Production

> Production for Zod: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: zod-production.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zod Production
...
## Ресурсы
- frontend/zod-production/SKILL.md
