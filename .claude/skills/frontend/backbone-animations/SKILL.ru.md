...
version: "1.0"
language: ru
original: backbone-animations
---

# Backbone Animations

> Animations with Backbone. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backbone-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Backbone Animations
...
## Ресурсы
- Оригинальный навык: `frontend/backbone-animations/SKILL.md`
