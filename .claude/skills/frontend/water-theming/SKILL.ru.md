...
category: frontend
tags: [water-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: water-theming
---

# Water Theming

> Theming with Water.css. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `water-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Water Theming
...
## Ресурсы
- Оригинальный навык: `frontend/water-theming/SKILL.md`
