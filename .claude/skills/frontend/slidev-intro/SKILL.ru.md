...
version: "1.0"
language: ru
original: slidev-intro
---

# Slidev Intro

> Intro for Slidev: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `slidev-intro`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Slidev Intro
...
## Ресурсы
- Оригинал: frontend/slidev-intro/SKILL.md
