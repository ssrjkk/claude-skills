...
version: "1.0"
language: ru
original: prettier-plugins
---

# Prettier Plugins

> Plugins with Prettier. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-plugins/SKILL.md`
