...
category: frontend
tags: [nextjs-api, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-api`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Api
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-api/SKILL.md
