...
> Config with SWC. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swc-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swc Config
...
## Ресурсы
- Оригинальный навык: `frontend/swc-config/SKILL.md`
