...
version: "1.0"
language: ru
original: radix-ui-responsive
---

# Radix Ui Responsive

> Responsive with Radix UI. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-responsive/SKILL.md`
