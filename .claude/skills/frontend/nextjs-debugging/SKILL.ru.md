...
category: frontend
tags: [nextjs-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Debugging
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-debugging/SKILL.md
