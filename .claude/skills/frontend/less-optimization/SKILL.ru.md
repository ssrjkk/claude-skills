...
version: "1.0"
language: ru
original: less-optimization
---

# Less Optimization

> Optimization with Less. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/less-optimization/SKILL.md`
