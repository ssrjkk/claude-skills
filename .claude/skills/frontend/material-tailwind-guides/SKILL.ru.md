...
version: "1.0"
language: ru
original: material-tailwind-guides
---

# Material Tailwind Guides

> Guides for Material-Tailwind: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `material-tailwind-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Tailwind Guides
...
## Ресурсы
- Оригинал: frontend/material-tailwind-guides/SKILL.md
