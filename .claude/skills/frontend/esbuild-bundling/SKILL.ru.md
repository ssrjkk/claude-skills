...
version: "1.0"
language: ru
original: esbuild-bundling
---

# Esbuild Bundling

> Bundling with esbuild. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esbuild-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Esbuild Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/esbuild-bundling/SKILL.md`
