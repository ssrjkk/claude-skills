...
version: "1.0"
language: ru
original: aurelia-performance
---

# Aurelia Performance

> Performance with Aurelia. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Performance
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-performance/SKILL.md`
