...
version: "1.0"
language: ru
original: milligram-forms
---

# Milligram Forms

> Forms with Milligram. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Forms
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-forms/SKILL.md`
