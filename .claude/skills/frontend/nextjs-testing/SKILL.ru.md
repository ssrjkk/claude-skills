...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Testing
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-testing/SKILL.md
