...
category: frontend
tags: [ember-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ember-components
---

# Ember Components

> Components with Ember. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Components
...
## Ресурсы
- Оригинальный навык: `frontend/ember-components/SKILL.md`
