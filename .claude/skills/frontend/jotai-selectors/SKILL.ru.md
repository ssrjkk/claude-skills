...
version: "1.0"
language: ru
original: jotai-selectors
---

# Jotai Selectors

> Selectors with Jotai. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jotai-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jotai Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/jotai-selectors/SKILL.md`
