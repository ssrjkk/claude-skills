...
category: frontend
tags: [chakra-ui-responsive, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chakra-ui-responsive
---

# Chakra Ui Responsive

> Responsive with Chakra UI. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-responsive/SKILL.md`
