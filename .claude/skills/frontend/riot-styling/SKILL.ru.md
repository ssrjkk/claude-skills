...
version: "1.0"
language: ru
original: riot-styling
---

# Riot Styling

> Styling with Riot. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Styling
...
## Ресурсы
- Оригинальный навык: `frontend/riot-styling/SKILL.md`
