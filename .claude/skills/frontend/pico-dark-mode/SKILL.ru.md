...
category: frontend
tags: [pico-dark-mode, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pico-dark-mode
---

# Pico Dark Mode

> Dark Mode with Pico CSS. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/pico-dark-mode/SKILL.md`
