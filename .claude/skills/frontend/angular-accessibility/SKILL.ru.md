...
version: "1.0"
language: ru
original: angular-accessibility
---

# Angular Accessibility

> Accessibility with Angular. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/angular-accessibility/SKILL.md`
