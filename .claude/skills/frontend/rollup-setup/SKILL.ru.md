...
version: "1.0"
language: ru
original: rollup-setup
---

# Rollup Setup

> Setup with Rollup. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Setup
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-setup/SKILL.md`
