...
version: "1.0"
language: ru
original: docusaurus-api-routes
---

# Docusaurus Api Routes

> API Routes with Docusaurus. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus-api-routes/SKILL.md`
