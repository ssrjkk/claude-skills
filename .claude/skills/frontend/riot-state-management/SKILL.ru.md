...
version: "1.0"
language: ru
original: riot-state-management
---

# Riot State Management

> State Management with Riot. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot State Management
...
## Ресурсы
- Оригинальный навык: `frontend/riot-state-management/SKILL.md`
