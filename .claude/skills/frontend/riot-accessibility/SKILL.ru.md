...
category: frontend
tags: [riot-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: riot-accessibility
---

# Riot Accessibility

> Accessibility with Riot. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/riot-accessibility/SKILL.md`
