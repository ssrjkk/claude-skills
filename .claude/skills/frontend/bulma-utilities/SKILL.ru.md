...
version: "1.0"
language: ru
original: bulma-utilities
---

# Bulma Utilities

> Utilities with Bulma. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-utilities/SKILL.md`
