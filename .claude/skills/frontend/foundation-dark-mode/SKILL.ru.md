...
category: frontend
tags: [foundation-dark-mode, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: foundation-dark-mode
---

# Foundation Dark Mode

> Dark Mode with Foundation. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-dark-mode/SKILL.md`
