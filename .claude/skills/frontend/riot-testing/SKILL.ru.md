...
version: "1.0"
language: ru
original: riot-testing
---

# Riot Testing

> Testing with Riot. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `riot-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Riot Testing
...
## Ресурсы
- Оригинальный навык: `frontend/riot-testing/SKILL.md`
