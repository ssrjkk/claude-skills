...
category: frontend
tags: [react-basics, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Basics
...
## Ресурсы
- Оригинальный навык: frontend/react-basics/SKILL.md
