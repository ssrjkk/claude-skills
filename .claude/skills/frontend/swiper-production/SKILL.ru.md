...
version: "1.0"
language: ru
original: swiper-production
---

# Swiper Production

> Production for Swiper: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: swiper-production.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swiper Production
...
## Ресурсы
- frontend/swiper-production/SKILL.md
