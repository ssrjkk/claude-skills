...
version: "1.0"
language: ru
original: solid-animations
---

# Solid Animations

> Animations with Solid. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Animations
...
## Ресурсы
- Оригинальный навык: `frontend/solid-animations/SKILL.md`
