...
category: frontend
tags: [turbopack-code-splitting, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: turbopack-code-splitting
---

# Turbopack Code Splitting

> Code Splitting with Turbopack. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-code-splitting/SKILL.md`
