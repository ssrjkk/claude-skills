...
version: "1.0"
language: ru
original: lagon-usage
---

# Lagon Usage

> Usage for Lagon: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lagon-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lagon Usage
...
## Ресурсы
- Оригинал: frontend/lagon-usage/SKILL.md
