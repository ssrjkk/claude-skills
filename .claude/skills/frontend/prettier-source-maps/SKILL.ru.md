...
version: "1.0"
language: ru
original: prettier-source-maps
---

# Prettier Source Maps

> Source Maps with Prettier. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-source-maps/SKILL.md`
