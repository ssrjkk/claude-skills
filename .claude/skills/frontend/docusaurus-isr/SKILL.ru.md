...
version: "1.0"
language: ru
original: docusaurus-isr
---

# Docusaurus Isr

> ISR with Docusaurus. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus Isr
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus-isr/SKILL.md`
