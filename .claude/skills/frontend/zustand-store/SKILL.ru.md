...
> Store with Zustand. state store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-store`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Store
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-store/SKILL.md`
