...
version: "1.0"
language: ru
original: nextjs-data-fetching
---

# Nextjs Data Fetching

> Data Fetching with Next.js. data loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-data-fetching`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Data Fetching
...
## Ресурсы
- Оригинальный навык: `frontend/nextjs-data-fetching/SKILL.md`
