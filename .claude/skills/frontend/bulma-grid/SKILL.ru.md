...
> Grid with Bulma. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Grid
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-grid/SKILL.md`
