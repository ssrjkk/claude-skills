...
version: "1.0"
language: ru
original: ngrx-testing
---

# Ngrx Testing

> Testing with NgRx. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Testing
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-testing/SKILL.md`
