...
category: frontend
tags: [bulma-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bulma-theming
---

# Bulma Theming

> Theming with Bulma. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulma-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bulma Theming
...
## Ресурсы
- Оригинальный навык: `frontend/bulma-theming/SKILL.md`
