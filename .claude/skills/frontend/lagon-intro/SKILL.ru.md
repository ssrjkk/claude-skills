...
version: "1.0"
language: ru
original: lagon-intro
---

# Lagon Intro

> Intro for Lagon: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lagon-intro`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lagon Intro
...
## Ресурсы
- Оригинал: frontend/lagon-intro/SKILL.md
