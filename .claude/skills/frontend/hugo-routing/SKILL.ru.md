...
version: "1.0"
language: ru
original: hugo-routing
---

# Hugo Routing

> Routing with Hugo. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hugo-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Hugo Routing
...
## Ресурсы
- Оригинальный навык: `frontend/hugo-routing/SKILL.md`
