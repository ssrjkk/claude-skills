...
category: frontend
tags: [jotai-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jotai-optimization
---

# Jotai Optimization

> Optimization with Jotai. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jotai-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jotai Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/jotai-optimization/SKILL.md`
