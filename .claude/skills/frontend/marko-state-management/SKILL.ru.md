...
version: "1.0"
language: ru
original: marko-state-management
---

# Marko State Management

> State Management with Marko. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko State Management
...
## Ресурсы
- Оригинальный навык: `frontend/marko-state-management/SKILL.md`
