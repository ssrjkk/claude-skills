...
version: "1.0"
language: ru
original: turbopack-source-maps
---

# Turbopack Source Maps

> Source Maps with Turbopack. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-source-maps/SKILL.md`
