...
category: frontend
tags: [preact-animations, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: preact-animations
---

# Preact Animations

> Animations with Preact. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Animations
...
## Ресурсы
- Оригинальный навык: `frontend/preact-animations/SKILL.md`
