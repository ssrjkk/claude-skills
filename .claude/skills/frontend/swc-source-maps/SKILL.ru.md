...
version: "1.0"
language: ru
original: swc-source-maps
---

# Swc Source Maps

> Source Maps with SWC. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swc-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swc Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/swc-source-maps/SKILL.md`
