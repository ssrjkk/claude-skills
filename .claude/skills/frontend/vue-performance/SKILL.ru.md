...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Performance
...
## Ресурсы
- Оригинальный навык: `frontend/vue-performance/SKILL.md`
