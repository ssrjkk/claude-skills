...
category: frontend
tags: [foundation-typography, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: foundation-typography
---

# Foundation Typography

> Typography with Foundation. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Typography
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-typography/SKILL.md`
