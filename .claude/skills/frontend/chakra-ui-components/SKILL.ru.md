...
version: "1.0"
language: ru
original: chakra-ui-components
---

# Chakra Ui Components

> Components with Chakra UI. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Components
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-components/SKILL.md`
