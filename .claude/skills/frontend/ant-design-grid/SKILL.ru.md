...
category: frontend
tags: [ant-design-grid, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-grid
---

# Ant Design Grid

> Grid with Ant Design. layout grids.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-grid`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Grid
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-grid/SKILL.md`
