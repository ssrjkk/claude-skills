...
version: "1.0"
language: ru
original: turbopack-config
---

# Turbopack Config

> Config with Turbopack. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Config
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-config/SKILL.md`
