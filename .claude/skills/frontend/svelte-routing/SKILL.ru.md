...
version: "1.0"
language: ru
original: svelte-routing
---

# Svelte Routing

> Routing with Svelte. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Routing
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-routing/SKILL.md`
