...
> Forms with Bootstrap. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Forms
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-forms/SKILL.md`
