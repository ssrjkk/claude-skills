...
version: "1.0"
language: ru
original: qwik-deployment
---

# Qwik Deployment

> Deployment with Qwik. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qwik-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Qwik Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/qwik-deployment/SKILL.md`
