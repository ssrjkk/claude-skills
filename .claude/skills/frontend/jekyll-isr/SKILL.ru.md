...
> ISR with Jekyll. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jekyll-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jekyll Isr
...
## Ресурсы
- Оригинальный навык: `frontend/jekyll-isr/SKILL.md`
