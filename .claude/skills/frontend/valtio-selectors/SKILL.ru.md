...
category: frontend
tags: [valtio-selectors, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: valtio-selectors
---

# Valtio Selectors

> Selectors with Valtio. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `valtio-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Valtio Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/valtio-selectors/SKILL.md`
