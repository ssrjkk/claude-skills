...
version: "1.0"
language: ru
original: purecss-responsive
---

# Purecss Responsive

> Responsive with Pure.css. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `purecss-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Purecss Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/purecss-responsive/SKILL.md`
