...
category: frontend
tags: [react-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Debugging
...
## Ресурсы
- Оригинальный навык: frontend/react-debugging/SKILL.md
