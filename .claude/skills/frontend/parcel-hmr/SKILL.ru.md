...
category: frontend
tags: [parcel-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: parcel-hmr
...
> HMR with Parcel. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-hmr/SKILL.md`
