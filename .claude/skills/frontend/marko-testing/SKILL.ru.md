...
version: "1.0"
language: ru
original: marko-testing
---

# Marko Testing

> Testing with Marko. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Testing
...
## Ресурсы
- Оригинальный навык: `frontend/marko-testing/SKILL.md`
