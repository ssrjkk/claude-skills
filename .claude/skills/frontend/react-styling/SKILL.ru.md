...
category: frontend
tags: [react-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-styling
---

# React Styling

> Styling with React. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Styling
...
## Ресурсы
- Оригинальный навык: `frontend/react-styling/SKILL.md`
