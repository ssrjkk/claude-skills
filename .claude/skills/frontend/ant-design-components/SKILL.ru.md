...
category: frontend
tags: [ant-design-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design-components
---

# Ant Design Components

> Components with Ant Design. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Components
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-components/SKILL.md`
