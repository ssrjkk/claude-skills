...
version: "1.0"
language: ru
original: stylus-config
---

# Stylus Config

> Config with Stylus. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Config
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-config/SKILL.md`
