...
category: frontend
tags: [react-router-configuration, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Configuration for React-Router: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: react-router-configuration.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Router Configuration
...
## Ресурсы
- frontend/react-router-configuration/SKILL.md
