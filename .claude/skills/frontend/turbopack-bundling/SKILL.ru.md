...
version: "1.0"
language: ru
original: turbopack-bundling
---

# Turbopack Bundling

> Bundling with Turbopack. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-bundling/SKILL.md`
