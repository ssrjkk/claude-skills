...
category: frontend
tags: [less-source-maps, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: less-source-maps
---

# Less Source Maps

> Source Maps with Less. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/less-source-maps/SKILL.md`
