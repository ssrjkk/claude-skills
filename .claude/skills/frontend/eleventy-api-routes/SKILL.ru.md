...
version: "1.0"
language: ru
original: eleventy-api-routes
---

# Eleventy Api Routes

> API Routes with Eleventy. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eleventy-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eleventy Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/eleventy-api-routes/SKILL.md`
