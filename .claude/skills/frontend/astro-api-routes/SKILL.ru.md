...
version: "1.0"
language: ru
original: astro-api-routes
---

# Astro Api Routes

> API Routes with Astro. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/astro-api-routes/SKILL.md`
