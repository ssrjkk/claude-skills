...
version: "1.0"
language: ru
original: shadcn-ui-guides
---

# Shadcn Ui Guides

> Guides for Shadcn-Ui: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `shadcn-ui-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Shadcn Ui Guides
...
## Ресурсы
- Оригинал: frontend/shadcn-ui-guides/SKILL.md
