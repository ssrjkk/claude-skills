...
version: "1.0"
language: ru
original: esbuild-code-splitting
---

# Esbuild Code Splitting

> Code Splitting with esbuild. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esbuild-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Esbuild Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/esbuild-code-splitting/SKILL.md`
