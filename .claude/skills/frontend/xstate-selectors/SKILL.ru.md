...
version: "1.0"
language: ru
original: xstate-selectors
---

# Xstate Selectors

> Selectors with XState. derived data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-selectors`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Selectors
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-selectors/SKILL.md`
