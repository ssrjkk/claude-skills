...
version: "1.0"
language: ru
original: esbuild-hmr
---

# Esbuild Hmr

> HMR with esbuild. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esbuild-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Esbuild Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/esbuild-hmr/SKILL.md`
