...
version: "1.0"
language: ru
original: swc-optimization
---

# Swc Optimization

> Optimization with SWC. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swc-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swc Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/swc-optimization/SKILL.md`
