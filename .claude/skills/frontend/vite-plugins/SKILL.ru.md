...
> Plugins with Vite. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/vite-plugins/SKILL.md`
