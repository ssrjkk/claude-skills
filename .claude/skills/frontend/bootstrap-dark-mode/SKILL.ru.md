...
version: "1.0"
language: ru
original: bootstrap-dark-mode
---

# Bootstrap Dark Mode

> Dark Mode with Bootstrap. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-dark-mode/SKILL.md`
