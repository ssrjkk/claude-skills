...
> SSR with Gatsby. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatsby-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gatsby Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/gatsby-ssr/SKILL.md`
