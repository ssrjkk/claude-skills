...
version: "1.0"
language: ru
original: ngrx-devtools
---

# Ngrx Devtools

> DevTools with NgRx. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ngrx-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ngrx Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/ngrx-devtools/SKILL.md`
