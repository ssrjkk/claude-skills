...
category: frontend
tags: [nextjs-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Setup
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-setup/SKILL.md
