...
category: frontend
tags: [shadcn-ui-examples, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shadcn-ui-examples
---

# Shadcn Ui Examples

> Examples for Shadcn-Ui: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `shadcn-ui-examples`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Shadcn Ui Examples
...
## Ресурсы
- Оригинал: frontend/shadcn-ui-examples/SKILL.md
