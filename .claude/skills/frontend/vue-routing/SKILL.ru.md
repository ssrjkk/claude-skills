...
category: frontend
tags: [vue-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vue-routing
---

# Vue Routing

> Routing with Vue. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Routing
...
## Ресурсы
- Оригинальный навык: `frontend/vue-routing/SKILL.md`
