...
category: frontend
tags: [storybook-middleware, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: storybook-middleware
---

# Storybook Middleware

> Middleware with Storybook. request middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-middleware/SKILL.md`
