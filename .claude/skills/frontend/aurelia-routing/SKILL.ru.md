...
category: frontend
tags: [aurelia-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aurelia-routing
---

# Aurelia Routing

> Routing with Aurelia. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aurelia-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Aurelia Routing
...
## Ресурсы
- Оригинальный навык: `frontend/aurelia-routing/SKILL.md`
