...
version: "1.0"
language: ru
original: astro-deployment
---

# Astro Deployment

> Deployment with Astro. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/astro-deployment/SKILL.md`
