...
version: "1.0"
language: ru
original: recoil-testing
---

# Recoil Testing

> Testing with Recoil. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `recoil-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Recoil Testing
...
## Ресурсы
- Оригинальный навык: `frontend/recoil-testing/SKILL.md`
