...
category: frontend
tags: [react-aria-fundamentals, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-aria-fundamentals
---

# React Aria Fundamentals

> Fundamentals for React-Aria: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `react-aria-fundamentals`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Aria Fundamentals
...
## Ресурсы
- Оригинал: frontend/react-aria-fundamentals/SKILL.md
