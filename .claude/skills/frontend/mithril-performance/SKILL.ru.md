...
version: "1.0"
language: ru
original: mithril-performance
---

# Mithril Performance

> Performance with Mithril. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Performance
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-performance/SKILL.md`
