...
version: "1.0"
language: ru
original: marko-routing
---

# Marko Routing

> Routing with Marko. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Routing
...
## Ресурсы
- Оригинальный навык: `frontend/marko-routing/SKILL.md`
