...
category: frontend
tags: [purecss-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: purecss-forms
---

# Purecss Forms

> Forms with Pure.css. form styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `purecss-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Purecss Forms
...
## Ресурсы
- Оригинальный навык: `frontend/purecss-forms/SKILL.md`
