...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-monitoring`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Monitoring
...
## Ресурсы
- Оригинальный навык: frontend/angular-monitoring/SKILL.md
