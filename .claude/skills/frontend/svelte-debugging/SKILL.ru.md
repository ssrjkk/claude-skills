...
category: frontend
tags: [svelte-debugging, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: svelte-debugging
---

# Svelte Debugging

> Debugging for Svelte: debugging and troubleshooting

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-debugging`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Debugging
...
## Ресурсы
- Оригинальный навык: frontend/svelte-debugging/SKILL.md
