...
version: "1.0"
language: ru
original: leaflet-automation
---

# Leaflet Automation

> Automation for Leaflet: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: leaflet-automation.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Leaflet Automation
...
## Ресурсы
- frontend/leaflet-automation/SKILL.md
