...
## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Deployment
...
## Ресурсы
- Оригинальный навык: frontend/angular-deployment/SKILL.md
