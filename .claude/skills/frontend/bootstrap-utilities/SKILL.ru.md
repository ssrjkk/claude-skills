...
version: "1.0"
language: ru
original: bootstrap-utilities
---

# Bootstrap Utilities

> Utilities with Bootstrap. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bootstrap-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Bootstrap Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/bootstrap-utilities/SKILL.md`
