...
category: frontend
tags: [react-security, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Security
...
## Ресурсы
- Оригинальный навык: frontend/react-security/SKILL.md
