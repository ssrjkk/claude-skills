...
category: frontend
tags: [solid-security, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-security`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Security
...
## Ресурсы
- Оригинальный навык: frontend/solid-security/SKILL.md
