...
category: frontend
tags: [vue-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vue-setup
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vue-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vue Setup
...
## Ресурсы
- Оригинальный навык: frontend/vue-setup/SKILL.md
