...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pico-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pico Typography
...
## Ресурсы
- Оригинальный навык: `frontend/pico-typography/SKILL.md`
