...
version: "1.0"
language: ru
original: zustand-persistence
---

# Zustand Persistence

> Persistence with Zustand. state persistence.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zustand-persistence`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Zustand Persistence
...
## Ресурсы
- Оригинальный навык: `frontend/zustand-persistence/SKILL.md`
