...
category: frontend
tags: [sveltekit-ssr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sveltekit-ssr
---

# Sveltekit Ssr

> SSR with SvelteKit. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-ssr/SKILL.md`
