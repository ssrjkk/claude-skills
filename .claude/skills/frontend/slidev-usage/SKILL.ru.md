...
category: frontend
tags: [slidev-usage, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: slidev-usage
---

# Slidev Usage

> Usage for Slidev: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `slidev-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Slidev Usage
...
## Ресурсы
- Оригинал: frontend/slidev-usage/SKILL.md
