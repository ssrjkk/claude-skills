...
category: frontend
tags: [gatsby-isr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatsby-isr
...
> ISR with Gatsby. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatsby-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Gatsby Isr
...
## Ресурсы
- Оригинальный навык: `frontend/gatsby-isr/SKILL.md`
