...
category: frontend
tags: [clsx-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clsx-setup
...
> Setup for Clsx: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clsx-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Clsx Setup
...
## Ресурсы
- Оригинал: frontend/clsx-setup/SKILL.md
