...
category: frontend
tags: [nextjs-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nextjs-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Optimization
...
## Ресурсы
- Оригинальный навык: frontend/nextjs-optimization/SKILL.md
