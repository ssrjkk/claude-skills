...
version: "1.0"
language: ru
original: ant-design-typography
---

# Ant Design Typography

> Typography with Ant Design. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ant Design Typography
...
## Ресурсы
- Оригинальный навык: `frontend/ant-design-typography/SKILL.md`
