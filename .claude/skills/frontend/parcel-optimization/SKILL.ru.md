...
category: frontend
tags: [parcel-optimization, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: parcel-optimization
---

# Parcel Optimization

> Optimization with Parcel. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-optimization/SKILL.md`
