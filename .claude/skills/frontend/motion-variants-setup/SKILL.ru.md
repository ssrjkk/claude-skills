...
version: "1.0"
language: ru
original: motion-variants-setup
---

# Motion Variants Setup

> Setup for Motion-Variants: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `motion-variants-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Motion Variants Setup
...
## Ресурсы
- Оригинал: frontend/motion-variants-setup/SKILL.md
