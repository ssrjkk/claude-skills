...
version: "1.0"
language: ru
original: angular-testing
---

# Angular Testing

> Testing with Angular. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Testing
...
## Ресурсы
- Оригинальный навык: `frontend/angular-testing/SKILL.md`
