...
category: frontend
tags: [akita-devtools, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: akita-devtools
---

# Akita Devtools

> DevTools with Akita. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akita-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Akita Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/akita-devtools/SKILL.md`
