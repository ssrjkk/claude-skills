...
version: "1.0"
language: ru
original: vite-optimization
---

# Vite Optimization

> Optimization with Vite. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vite-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vite Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/vite-optimization/SKILL.md`
