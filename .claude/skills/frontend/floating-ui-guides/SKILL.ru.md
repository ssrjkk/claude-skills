...
version: "1.0"
language: ru
original: floating-ui-guides
---

# Floating Ui Guides

> Guides for Floating-Ui: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `floating-ui-guides`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Floating Ui Guides
...
## Ресурсы
- Оригинал: frontend/floating-ui-guides/SKILL.md
