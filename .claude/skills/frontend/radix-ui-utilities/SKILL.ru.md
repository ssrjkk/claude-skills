...
category: frontend
tags: [radix-ui-utilities, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: radix-ui-utilities
---

# Radix Ui Utilities

> Utilities with Radix UI. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/radix-ui-utilities/SKILL.md`
