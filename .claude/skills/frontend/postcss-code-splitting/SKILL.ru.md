...
category: frontend
tags: [postcss-code-splitting, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: postcss-code-splitting
---

# Postcss Code Splitting

> Code Splitting with PostCSS. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-code-splitting/SKILL.md`
