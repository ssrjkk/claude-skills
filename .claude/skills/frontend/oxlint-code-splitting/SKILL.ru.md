...
version: "1.0"
language: ru
original: oxlint-code-splitting
---

# Oxlint Code Splitting

> Code Splitting with Oxlint. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oxlint-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Oxlint Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/oxlint-code-splitting/SKILL.md`
