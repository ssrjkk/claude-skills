...
category: frontend
tags: [sass-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sass-bundling
---

# Sass Bundling

> Bundling with Sass. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/sass-bundling/SKILL.md`
