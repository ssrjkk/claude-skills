...
category: frontend
tags: [mithril-styling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mithril-styling
---

# Mithril Styling

> Styling with Mithril. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mithril-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mithril Styling
...
## Ресурсы
- Оригинальный навык: `frontend/mithril-styling/SKILL.md`
