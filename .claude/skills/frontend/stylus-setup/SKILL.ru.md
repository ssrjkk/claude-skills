...
version: "1.0"
language: ru
original: stylus-setup
---

# Stylus Setup

> Setup with Stylus. initial setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Setup
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-setup/SKILL.md`
