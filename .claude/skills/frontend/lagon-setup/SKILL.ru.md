...
version: "1.0"
language: ru
original: lagon-setup
---

# Lagon Setup

> Setup for Lagon: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lagon-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Lagon Setup
...
## Ресурсы
- Оригинал: frontend/lagon-setup/SKILL.md
