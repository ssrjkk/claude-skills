...
version: "1.0"
language: ru
original: pinia-optimization
---

# Pinia Optimization

> Optimization with Pinia. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pinia-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Pinia Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/pinia-optimization/SKILL.md`
