...
category: frontend
tags: [clsx-intro, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clsx-intro
...
> Intro for Clsx: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clsx-intro`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Clsx Intro
...
## Ресурсы
- Оригинал: frontend/clsx-intro/SKILL.md
