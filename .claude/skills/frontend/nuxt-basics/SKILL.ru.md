...
category: frontend
tags: [nuxt-basics, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuxt-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-basics`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Basics
...
## Ресурсы
- Оригинальный навык: frontend/nuxt-basics/SKILL.md
