...
category: frontend
tags: [ember-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ember-testing
---

# Ember Testing

> Testing with Ember. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Testing
...
## Ресурсы
- Оригинальный навык: `frontend/ember-testing/SKILL.md`
