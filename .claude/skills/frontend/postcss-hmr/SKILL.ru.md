...
version: "1.0"
language: ru
original: postcss-hmr
---

# Postcss Hmr

> HMR with PostCSS. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-hmr/SKILL.md`
