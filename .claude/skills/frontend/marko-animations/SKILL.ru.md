...
version: "1.0"
language: ru
original: marko-animations
---

# Marko Animations

> Animations with Marko. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Animations
...
## Ресурсы
- Оригинальный навык: `frontend/marko-animations/SKILL.md`
