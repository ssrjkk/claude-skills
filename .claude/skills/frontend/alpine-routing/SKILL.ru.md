...
category: frontend
tags: [alpine-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: alpine-routing
---

# Alpine Routing

> Routing with Alpine. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `alpine-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Alpine Routing
...
## Ресурсы
- Оригинальный навык: `frontend/alpine-routing/SKILL.md`
