...
> Components with Svelte. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Components
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-components/SKILL.md`
