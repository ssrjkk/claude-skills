...
version: "1.0"
language: ru
original: ember-accessibility
---

# Ember Accessibility

> Accessibility with Ember. a11y.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/ember-accessibility/SKILL.md`
