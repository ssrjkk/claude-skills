...
version: "1.0"
language: ru
original: solid-styling
---

# Solid Styling

> Styling with Solid. component styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-styling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Styling
...
## Ресурсы
- Оригинальный навык: `frontend/solid-styling/SKILL.md`
