...
category: frontend
tags: [material-ui-dark-mode, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: material-ui-dark-mode
---

# Material Ui Dark Mode

> Dark Mode with MUI. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-dark-mode/SKILL.md`
