...
version: "1.0"
language: ru
original: solid-testing
---

# Solid Testing

> Testing with Solid. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Testing
...
## Ресурсы
- Оригинальный навык: `frontend/solid-testing/SKILL.md`
