...
version: "1.0"
language: ru
original: turbopack-optimization
---

# Turbopack Optimization

> Optimization with Turbopack. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `turbopack-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Turbopack Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/turbopack-optimization/SKILL.md`
