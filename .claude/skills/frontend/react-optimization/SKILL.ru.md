...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Optimization
...
## Ресурсы
- Оригинальный навык: frontend/react-optimization/SKILL.md
