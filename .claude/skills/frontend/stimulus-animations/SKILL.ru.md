...
version: "1.0"
language: ru
original: stimulus-animations
---

# Stimulus Animations

> Animations with Stimulus. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Animations
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-animations/SKILL.md`
