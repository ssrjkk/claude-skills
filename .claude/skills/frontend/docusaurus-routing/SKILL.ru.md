...
category: frontend
tags: [docusaurus-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: docusaurus-routing
---

# Docusaurus Routing

> Routing with Docusaurus. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docusaurus-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Docusaurus Routing
...
## Ресурсы
- Оригинальный навык: `frontend/docusaurus-routing/SKILL.md`
