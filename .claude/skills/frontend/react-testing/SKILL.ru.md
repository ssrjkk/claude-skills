...
category: frontend
tags: [react-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-testing
---

# React Testing

> Testing with React. component testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Testing
...
## Ресурсы
- Оригинальный навык: `frontend/react-testing/SKILL.md`
