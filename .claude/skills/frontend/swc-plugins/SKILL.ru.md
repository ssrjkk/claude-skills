...
version: "1.0"
language: ru
original: swc-plugins
---

# Swc Plugins

> Plugins with SWC. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swc-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Swc Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/swc-plugins/SKILL.md`
