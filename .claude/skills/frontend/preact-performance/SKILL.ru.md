...
version: "1.0"
language: ru
original: preact-performance
---

# Preact Performance

> Performance with Preact. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `preact-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Preact Performance
...
## Ресурсы
- Оригинальный навык: `frontend/preact-performance/SKILL.md`
