...
version: "1.0"
language: ru
original: nuxt-deployment
---

# Nuxt Deployment

> Deployment with Nuxt. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuxt-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nuxt Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/nuxt-deployment/SKILL.md`
