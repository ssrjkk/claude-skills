...
category: frontend
tags: [material-ui-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Components with MUI. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `material-ui-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Material Ui Components
...
## Ресурсы
- Оригинальный навык: `frontend/material-ui-components/SKILL.md`
