...
version: "1.0"
language: ru
original: xstate-actions
---

# Xstate Actions

> Actions with XState. actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-actions`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Actions
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-actions/SKILL.md`
