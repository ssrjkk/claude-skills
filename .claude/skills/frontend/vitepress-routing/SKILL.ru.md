...
version: "1.0"
language: ru
original: vitepress-routing
---

# Vitepress Routing

> Routing with VitePress. file-based routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitepress-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vitepress Routing
...
## Ресурсы
- Оригинальный навык: `frontend/vitepress-routing/SKILL.md`
