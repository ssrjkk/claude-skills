...
category: frontend
tags: [spectre-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spectre-theming
---

# Spectre Theming

> Theming with Spectre.css. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spectre-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Spectre Theming
...
## Ресурсы
- Оригинальный навык: `frontend/spectre-theming/SKILL.md`
