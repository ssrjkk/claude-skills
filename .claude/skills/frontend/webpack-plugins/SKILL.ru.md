...
version: "1.0"
language: ru
original: webpack-plugins
---

# Webpack Plugins

> Plugins with Webpack. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-plugins/SKILL.md`
