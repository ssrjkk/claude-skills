...
category: frontend
tags: [solid-performance, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solid-performance
---

# Solid Performance

> Performance with Solid. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solid-performance`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solid Performance
...
## Ресурсы
- Оригинальный навык: `frontend/solid-performance/SKILL.md`
