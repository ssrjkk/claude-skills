...
version: "1.0"
language: ru
original: framer-motion-production
---

# Framer Motion Production

> Production for Framer-Motion: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: framer-motion-production.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Framer Motion Production
...
## Ресурсы
- frontend/framer-motion-production/SKILL.md
