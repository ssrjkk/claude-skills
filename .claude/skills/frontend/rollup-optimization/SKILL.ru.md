...
version: "1.0"
language: ru
original: rollup-optimization
---

# Rollup Optimization

> Optimization with Rollup. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rollup-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Rollup Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/rollup-optimization/SKILL.md`
