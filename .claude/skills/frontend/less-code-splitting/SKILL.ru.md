...
version: "1.0"
language: ru
original: less-code-splitting
---

# Less Code Splitting

> Code Splitting with Less. lazy loading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `less-code-splitting`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Less Code Splitting
...
## Ресурсы
- Оригинальный навык: `frontend/less-code-splitting/SKILL.md`
