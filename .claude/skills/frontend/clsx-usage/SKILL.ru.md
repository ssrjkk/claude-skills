...
category: frontend
tags: [clsx-usage, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clsx-usage
...
> Usage for Clsx: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clsx-usage`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Clsx Usage
...
## Ресурсы
- Оригинал: frontend/clsx-usage/SKILL.md
