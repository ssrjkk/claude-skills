...
category: frontend
tags: [xstate-devtools, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xstate-devtools
---

# Xstate Devtools

> DevTools with XState. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-devtools/SKILL.md`
