...
version: "1.0"
language: ru
original: marko-forms
---

# Marko Forms

> Forms with Marko. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Forms
...
## Ресурсы
- Оригинальный навык: `frontend/marko-forms/SKILL.md`
