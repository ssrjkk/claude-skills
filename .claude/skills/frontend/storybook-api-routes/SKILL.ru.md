...
version: "1.0"
language: ru
original: storybook-api-routes
---

# Storybook Api Routes

> API Routes with Storybook. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `storybook-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Storybook Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/storybook-api-routes/SKILL.md`
