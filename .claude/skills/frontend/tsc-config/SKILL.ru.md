...
> Config with TypeScript. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsc-config`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tsc Config
...
## Ресурсы
- Оригинальный навык: `frontend/tsc-config/SKILL.md`
