...
version: "1.0"
language: ru
original: tailwind-responsive
---

# Tailwind Responsive

> Responsive with Tailwind CSS. mobile-first.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tailwind-responsive`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Tailwind Responsive
...
## Ресурсы
- Оригинальный навык: `frontend/tailwind-responsive/SKILL.md`
