...
version: "1.0"
language: ru
original: angular-state-management
---

# Angular State Management

> State Management with Angular. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular State Management
...
## Ресурсы
- Оригинальный навык: `frontend/angular-state-management/SKILL.md`
