...
version: "1.0"
language: ru
original: parcel-source-maps
---

# Parcel Source Maps

> Source Maps with Parcel. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `parcel-source-maps`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Parcel Source Maps
...
## Ресурсы
- Оригинальный навык: `frontend/parcel-source-maps/SKILL.md`
