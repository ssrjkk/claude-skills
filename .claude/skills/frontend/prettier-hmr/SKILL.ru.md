...
category: frontend
tags: [prettier-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prettier-hmr
---

# Prettier Hmr

> HMR with Prettier. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-hmr/SKILL.md`
