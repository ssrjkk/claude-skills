...
category: frontend
tags: [angular-routing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-routing
---

# Angular Routing

> Routing with Angular. client routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-routing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Routing
...
## Ресурсы
- Оригинальный навык: `frontend/angular-routing/SKILL.md`
