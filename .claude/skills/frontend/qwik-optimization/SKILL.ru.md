...
## Быстрый старт
Этот навык на русском языке. Оригинал: `qwik-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Qwik Optimization
...
## Ресурсы
- Оригинальный навык: frontend/qwik-optimization/SKILL.md
