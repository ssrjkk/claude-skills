...
> Components with React. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Components
...
## Ресурсы
- Оригинальный навык: `frontend/react-components/SKILL.md`
