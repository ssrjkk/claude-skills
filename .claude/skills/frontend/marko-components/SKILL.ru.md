...
category: frontend
tags: [marko-components, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: marko-components
---

# Marko Components

> Components with Marko. building components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marko-components`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Marko Components
...
## Ресурсы
- Оригинальный навык: `frontend/marko-components/SKILL.md`
