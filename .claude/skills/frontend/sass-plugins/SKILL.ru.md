...
category: frontend
tags: [sass-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sass-plugins
---

# Sass Plugins

> Plugins with Sass. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sass-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sass Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/sass-plugins/SKILL.md`
