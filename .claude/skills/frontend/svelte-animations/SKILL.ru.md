...
version: "1.0"
language: ru
original: svelte-animations
---

# Svelte Animations

> Animations with Svelte. UI animations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `svelte-animations`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Svelte Animations
...
## Ресурсы
- Оригинальный навык: `frontend/svelte-animations/SKILL.md`
