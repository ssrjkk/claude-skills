...
version: "1.0"
language: ru
original: effector-devtools
---

# Effector Devtools

> DevTools with Effector. debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `effector-devtools`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Effector Devtools
...
## Ресурсы
- Оригинальный навык: `frontend/effector-devtools/SKILL.md`
