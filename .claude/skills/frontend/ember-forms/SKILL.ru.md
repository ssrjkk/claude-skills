...
version: "1.0"
language: ru
original: ember-forms
---

# Ember Forms

> Forms with Ember. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Forms
...
## Ресурсы
- Оригинальный навык: `frontend/ember-forms/SKILL.md`
