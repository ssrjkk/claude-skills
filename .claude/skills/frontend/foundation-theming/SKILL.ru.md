...
category: frontend
tags: [foundation-theming, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: foundation-theming
---

# Foundation Theming

> Theming with Foundation. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `foundation-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Foundation Theming
...
## Ресурсы
- Оригинальный навык: `frontend/foundation-theming/SKILL.md`
