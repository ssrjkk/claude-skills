...
category: frontend
tags: [stylus-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stylus-plugins
---

# Stylus Plugins

> Plugins with Stylus. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-plugins/SKILL.md`
