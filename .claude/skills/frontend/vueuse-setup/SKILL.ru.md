...
version: "1.0"
language: ru
original: vueuse-setup
---

# Vueuse Setup

> Setup for Vueuse: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `vueuse-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Vueuse Setup
...
## Ресурсы
- Оригинал: frontend/vueuse-setup/SKILL.md
