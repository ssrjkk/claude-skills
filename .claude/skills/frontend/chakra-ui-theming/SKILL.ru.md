...
version: "1.0"
language: ru
original: chakra-ui-theming
---

# Chakra Ui Theming

> Theming with Chakra UI. custom themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-theming`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Theming
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-theming/SKILL.md`
