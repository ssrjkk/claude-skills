...
category: frontend
tags: [chakra-ui-utilities, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chakra-ui-utilities
---

# Chakra Ui Utilities

> Utilities with Chakra UI. utility classes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-utilities`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Utilities
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-utilities/SKILL.md`
