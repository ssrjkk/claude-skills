...
version: "1.0"
language: ru
original: chakra-ui-dark-mode
---

# Chakra Ui Dark Mode

> Dark Mode with Chakra UI. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chakra-ui-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chakra Ui Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/chakra-ui-dark-mode/SKILL.md`
