...
category: frontend
tags: [babel-plugins, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: babel-plugins
---

# Babel Plugins

> Plugins with Babel. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `babel-plugins`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Babel Plugins
...
## Ресурсы
- Оригинальный навык: `frontend/babel-plugins/SKILL.md`
