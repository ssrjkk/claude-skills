...
category: frontend
tags: [react-accessibility, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-accessibility
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-accessibility`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React Accessibility
...
## Ресурсы
- Оригинальный навык: `frontend/react-accessibility/SKILL.md`
