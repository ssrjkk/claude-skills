...
version: "1.0"
language: ru
original: stimulus-forms
---

# Stimulus Forms

> Forms with Stimulus. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stimulus-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stimulus Forms
...
## Ресурсы
- Оригинальный навык: `frontend/stimulus-forms/SKILL.md`
