...
version: "1.0"
language: ru
original: motion-variants-intro
---

# Motion Variants Intro

> Intro for Motion-Variants: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `motion-variants-intro`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Motion Variants Intro
...
## Ресурсы
- Оригинал: frontend/motion-variants-intro/SKILL.md
