...
version: "1.0"
language: ru
original: d3js-getting-started
---

# D3Js Getting Started

> Getting Started for D3Js: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: d3js-getting-started.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с D3Js Getting Started
...
## Ресурсы
- frontend/d3js-getting-started/SKILL.md
