...
category: frontend
tags: [solidstart-api-routes, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: solidstart-api-routes
---

# Solidstart Api Routes

> API Routes with SolidStart. API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `solidstart-api-routes`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Solidstart Api Routes
...
## Ресурсы
- Оригинальный навык: `frontend/solidstart-api-routes/SKILL.md`
