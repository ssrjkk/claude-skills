...
category: frontend
tags: [react-state-management, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> State Management with React. state handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-state-management`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с React State Management
...
## Ресурсы
- Оригинальный навык: `frontend/react-state-management/SKILL.md`
