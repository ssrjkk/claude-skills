...
> SSR with Ember. server rendering.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ember-ssr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ember Ssr
...
## Ресурсы
- Оригинальный навык: `frontend/ember-ssr/SKILL.md`
