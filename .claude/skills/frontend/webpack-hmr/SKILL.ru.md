...
category: frontend
tags: [webpack-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webpack-hmr
---

# Webpack Hmr

> HMR with Webpack. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webpack-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Webpack Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/webpack-hmr/SKILL.md`
