...
category: frontend
tags: [mobx-testing, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mobx-testing
---

# Mobx Testing

> Testing with MobX. state testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mobx-testing`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Mobx Testing
...
## Ресурсы
- Оригинальный навык: `frontend/mobx-testing/SKILL.md`
