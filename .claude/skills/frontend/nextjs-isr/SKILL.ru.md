...
> ISR with Next.js. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nextjs-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Nextjs Isr
...
## Ресурсы
- Оригинальный навык: `frontend/nextjs-isr/SKILL.md`
