...
category: frontend
tags: [astro-setup, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: astro-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `astro-setup`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Astro Setup
...
## Ресурсы
- Оригинальный навык: frontend/astro-setup/SKILL.md
