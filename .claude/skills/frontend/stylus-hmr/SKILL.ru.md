...
category: frontend
tags: [stylus-hmr, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stylus-hmr
...
> HMR with Stylus. hot reload.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stylus-hmr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Stylus Hmr
...
## Ресурсы
- Оригинальный навык: `frontend/stylus-hmr/SKILL.md`
