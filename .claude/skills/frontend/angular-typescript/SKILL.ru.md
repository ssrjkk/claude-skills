...
category: frontend
tags: [angular-typescript, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-typescript
---

# Angular Typescript

> Creates Angular applications with TypeScript, components, and services. Use for enterprise frontend development.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-typescript`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Typescript
...
## Ресурсы
- Оригинальный навык: `frontend/angular-typescript/SKILL.md`
