...
category: frontend
tags: [ladle-intro, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ladle-intro
---

# Ladle Intro

> Intro for Ladle: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `ladle-intro`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Ladle Intro
...
## Ресурсы
- Оригинал: frontend/ladle-intro/SKILL.md
