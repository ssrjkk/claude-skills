...
category: frontend
tags: [akita-middleware, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: akita-middleware
---

# Akita Middleware

> Middleware with Akita. side effects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akita-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Akita Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/akita-middleware/SKILL.md`
