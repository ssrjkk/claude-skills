...
version: "1.0"
language: ru
original: radix-ui-examples
---

# Radix Ui Examples

> Examples for Radix-Ui: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `radix-ui-examples`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Radix Ui Examples
...
## Ресурсы
- Оригинал: frontend/radix-ui-examples/SKILL.md
