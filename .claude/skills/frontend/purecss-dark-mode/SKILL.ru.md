...
version: "1.0"
language: ru
original: purecss-dark-mode
---

# Purecss Dark Mode

> Dark Mode with Pure.css. dark theme.

## Быстрый старт
Этот навык на русском языке. Оригинал: `purecss-dark-mode`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Purecss Dark Mode
...
## Ресурсы
- Оригинальный навык: `frontend/purecss-dark-mode/SKILL.md`
