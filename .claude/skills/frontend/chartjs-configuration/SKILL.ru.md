...
version: "1.0"
language: ru
original: chartjs-configuration
---

# Chartjs Configuration

> Configuration for Chartjs: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: chartjs-configuration.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Chartjs Configuration
...
## Ресурсы
- frontend/chartjs-configuration/SKILL.md
