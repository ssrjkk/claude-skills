...
category: frontend
tags: [eslint-bundling, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eslint-bundling
---

# Eslint Bundling

> Bundling with ESLint. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eslint-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Eslint Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/eslint-bundling/SKILL.md`
