...
version: "1.0"
language: ru
original: postcss-optimization
---

# Postcss Optimization

> Optimization with PostCSS. build optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postcss-optimization`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Postcss Optimization
...
## Ресурсы
- Оригинальный навык: `frontend/postcss-optimization/SKILL.md`
