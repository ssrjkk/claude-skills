...
version: "1.0"
language: ru
original: sveltekit-isr
---

# Sveltekit Isr

> ISR with SvelteKit. incremental.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sveltekit-isr`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Sveltekit Isr
...
## Ресурсы
- Оригинальный навык: `frontend/sveltekit-isr/SKILL.md`
