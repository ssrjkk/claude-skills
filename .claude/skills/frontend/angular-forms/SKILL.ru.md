...
category: frontend
tags: [angular-forms, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angular-forms
---

# Angular Forms

> Forms with Angular. form handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angular-forms`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Angular Forms
...
## Ресурсы
- Оригинальный навык: `frontend/angular-forms/SKILL.md`
