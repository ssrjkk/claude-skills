...
version: "1.0"
language: ru
original: milligram-typography
---

# Milligram Typography

> Typography with Milligram. text styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `milligram-typography`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Milligram Typography
...
## Ресурсы
- Оригинальный навык: `frontend/milligram-typography/SKILL.md`
