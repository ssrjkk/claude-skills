...
version: "1.0"
language: ru
original: prettier-bundling
---

# Prettier Bundling

> Bundling with Prettier. code bundling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prettier-bundling`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prettier Bundling
...
## Ресурсы
- Оригинальный навык: `frontend/prettier-bundling/SKILL.md`
