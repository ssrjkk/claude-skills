...
version: "1.0"
language: ru
original: xstate-middleware
---

# Xstate Middleware

> Middleware with XState. side effects.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xstate-middleware`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Xstate Middleware
...
## Ресурсы
- Оригинальный навык: `frontend/xstate-middleware/SKILL.md`
