...
version: "1.0"
language: ru
original: jekyll-deployment
---

# Jekyll Deployment

> Deployment with Jekyll. production.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jekyll-deployment`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Jekyll Deployment
...
## Ресурсы
- Оригинальный навык: `frontend/jekyll-deployment/SKILL.md`
