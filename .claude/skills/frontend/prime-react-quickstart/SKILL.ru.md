...
category: frontend
tags: [prime-react-quickstart, frontend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prime-react-quickstart
---

# Prime React Quickstart

> Quickstart for Prime-React: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `prime-react-quickstart`.

## Когда использовать
- Работа с Фронтенд-разработка
- Выполнение задач, связанных с Prime React Quickstart
...
## Ресурсы
- Оригинал: frontend/prime-react-quickstart/SKILL.md
