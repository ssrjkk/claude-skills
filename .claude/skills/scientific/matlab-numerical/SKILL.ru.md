...
version: "1.0"
language: ru
original: matlab-numerical
---

# Matlab Numerical

> Numerical with MATLAB. numerical methods.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matlab-numerical`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Matlab Numerical
...
## Ресурсы
- Оригинальный навык: `scientific/matlab-numerical/SKILL.md`
- Категория: Наука
- Язык: Русский
