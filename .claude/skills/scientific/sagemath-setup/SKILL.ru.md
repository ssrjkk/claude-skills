...
version: "1.0"
language: ru
original: sagemath-setup
---

# Sagemath Setup

> Setup with SageMath. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sagemath-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sagemath Setup
...
## Ресурсы
- Оригинальный навык: `scientific/sagemath-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
