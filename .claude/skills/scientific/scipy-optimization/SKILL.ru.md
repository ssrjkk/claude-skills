...
category: scientific
tags: [scipy-optimization, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scipy-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-optimization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Scipy Optimization
...
## Ресурсы
- Оригинальный навык: `scientific/scipy-optimization/SKILL.md`
- Категория: Наука
- Язык: Русский
