...
version: "1.0"
language: ru
original: sympy-numerical
---

# Sympy Numerical

> Numerical with SymPy. numerical methods.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sympy-numerical`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sympy Numerical
...
## Ресурсы
- Оригинальный навык: `scientific/sympy-numerical/SKILL.md`
- Категория: Наука
- Язык: Русский
