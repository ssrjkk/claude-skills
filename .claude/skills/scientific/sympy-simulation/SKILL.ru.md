...
version: "1.0"
language: ru
original: sympy-simulation
---

# Sympy Simulation

> Simulation with SymPy. Monte Carlo.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sympy-simulation`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sympy Simulation
...
## Ресурсы
- Оригинальный навык: `scientific/sympy-simulation/SKILL.md`
- Категория: Наука
- Язык: Русский
