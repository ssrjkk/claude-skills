...
version: "1.0"
language: ru
original: numpy-numerical
---

# Numpy Numerical

> Numerical with NumPy. numerical methods.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-numerical`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Numpy Numerical
...
## Ресурсы
- Оригинальный навык: `scientific/numpy-numerical/SKILL.md`
- Категория: Наука
- Язык: Русский
