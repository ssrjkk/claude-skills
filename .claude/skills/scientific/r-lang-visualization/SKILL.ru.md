...
category: scientific
tags: [r-lang-visualization, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: r-lang-visualization
---

# R Lang Visualization

> Visualization with R. scientific plots.

## Быстрый старт
Этот навык на русском языке. Оригинал: `r-lang-visualization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с R Lang Visualization
...
## Ресурсы
- Оригинальный навык: `scientific/r-lang-visualization/SKILL.md`
- Категория: Наука
- Язык: Русский
