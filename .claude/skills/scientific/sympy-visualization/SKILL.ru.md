...
version: "1.0"
language: ru
original: sympy-visualization
---

# Sympy Visualization

> Visualization with SymPy. scientific plots.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sympy-visualization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sympy Visualization
...
## Ресурсы
- Оригинальный навык: `scientific/sympy-visualization/SKILL.md`
- Категория: Наука
- Язык: Русский
