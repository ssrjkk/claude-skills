...
category: scientific
tags: [octave-statistics, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: octave-statistics
---

# Octave Statistics

> Statistics with GNU Octave. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `octave-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Octave Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/octave-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
