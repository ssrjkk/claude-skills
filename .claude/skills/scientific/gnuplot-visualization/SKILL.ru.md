...
category: scientific
tags: [gnuplot-visualization, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gnuplot-visualization
---

# Gnuplot Visualization

> Visualization with gnuplot. scientific plots.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gnuplot-visualization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Gnuplot Visualization
...
## Ресурсы
- Оригинальный навык: `scientific/gnuplot-visualization/SKILL.md`
- Категория: Наука
- Язык: Русский
