...
category: scientific
tags: [gnuplot-setup, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gnuplot-setup
---

# Gnuplot Setup

> Setup with gnuplot. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gnuplot-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Gnuplot Setup
...
## Ресурсы
- Оригинальный навык: `scientific/gnuplot-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
