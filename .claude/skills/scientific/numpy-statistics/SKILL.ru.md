...
version: "1.0"
language: ru
original: numpy-statistics
---

# Numpy Statistics

> Statistics with NumPy. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Numpy Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/numpy-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
