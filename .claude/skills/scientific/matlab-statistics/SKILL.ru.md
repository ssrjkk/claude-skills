...
category: scientific
tags: [matlab-statistics, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: matlab-statistics
---

# Matlab Statistics

> Statistics with MATLAB. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matlab-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Matlab Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/matlab-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
