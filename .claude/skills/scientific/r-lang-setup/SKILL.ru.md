...
version: "1.0"
language: ru
original: r-lang-setup
---

# R Lang Setup

> Setup with R. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `r-lang-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с R Lang Setup
...
## Ресурсы
- Оригинальный навык: `scientific/r-lang-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
