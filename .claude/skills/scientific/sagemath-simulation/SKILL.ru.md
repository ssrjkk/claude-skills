...
version: "1.0"
language: ru
original: sagemath-simulation
---

# Sagemath Simulation

> Simulation with SageMath. Monte Carlo.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sagemath-simulation`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sagemath Simulation
...
## Ресурсы
- Оригинальный навык: `scientific/sagemath-simulation/SKILL.md`
- Категория: Наука
- Язык: Русский
