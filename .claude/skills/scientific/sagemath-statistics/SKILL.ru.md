...
category: scientific
tags: [sagemath-statistics, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sagemath-statistics
---

# Sagemath Statistics

> Statistics with SageMath. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sagemath-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sagemath Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/sagemath-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
