...
version: "1.0"
language: ru
original: sympy-statistics
---

# Sympy Statistics

> Statistics with SymPy. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sympy-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sympy Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/sympy-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
