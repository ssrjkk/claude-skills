...
version: "1.0"
language: ru
original: mathematica-simulation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mathematica-simulation`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Mathematica Simulation
...
## Ресурсы
- Оригинальный навык: `scientific/mathematica-simulation/SKILL.md`
- Категория: Наука
- Язык: Русский
