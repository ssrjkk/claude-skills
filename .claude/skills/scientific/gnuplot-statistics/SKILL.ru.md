...
version: "1.0"
language: ru
original: gnuplot-statistics
---

# Gnuplot Statistics

> Statistics with gnuplot. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gnuplot-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Gnuplot Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/gnuplot-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
