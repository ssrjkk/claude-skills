...
version: "1.0"
language: ru
original: sagemath-parallel
---

# Sagemath Parallel

> Parallel with SageMath. parallel computing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sagemath-parallel`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Sagemath Parallel
...
## Ресурсы
- Оригинальный навык: `scientific/sagemath-parallel/SKILL.md`
- Категория: Наука
- Язык: Русский
