...
version: "1.0"
language: ru
original: matlab-setup
---

# Matlab Setup

> Setup with MATLAB. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matlab-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Matlab Setup
...
## Ресурсы
- Оригинальный навык: `scientific/matlab-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
