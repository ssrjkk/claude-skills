...
version: "1.0"
language: ru
original: scipy-statistics
---

# Scipy Statistics

> Statistics with SciPy. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Scipy Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/scipy-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
