...
version: "1.0"
language: ru
original: scipy-parallel
---

# Scipy Parallel

> Parallel with SciPy. parallel computing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-parallel`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Scipy Parallel
...
## Ресурсы
- Оригинальный навык: `scientific/scipy-parallel/SKILL.md`
- Категория: Наука
- Язык: Русский
