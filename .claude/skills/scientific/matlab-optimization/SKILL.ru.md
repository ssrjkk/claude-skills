...
category: scientific
tags: [matlab-optimization, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: matlab-optimization
---

# Matlab Optimization

> Optimization with MATLAB. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matlab-optimization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Matlab Optimization
...
## Ресурсы
- Оригинальный навык: `scientific/matlab-optimization/SKILL.md`
- Категория: Наука
- Язык: Русский
