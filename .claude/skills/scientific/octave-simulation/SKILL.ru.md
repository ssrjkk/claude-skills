...
version: "1.0"
language: ru
original: octave-simulation
---

# Octave Simulation

> Simulation with GNU Octave. Monte Carlo.

## Быстрый старт
Этот навык на русском языке. Оригинал: `octave-simulation`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Octave Simulation
...
## Ресурсы
- Оригинальный навык: `scientific/octave-simulation/SKILL.md`
- Категория: Наука
- Язык: Русский
