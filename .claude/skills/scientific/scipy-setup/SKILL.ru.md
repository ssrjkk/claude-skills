...
category: scientific
tags: [scipy-setup, scientific, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scipy-setup
---

# Scipy Setup

> Setup with SciPy. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Scipy Setup
...
## Ресурсы
- Оригинальный навык: `scientific/scipy-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
