...
version: "1.0"
language: ru
original: mathematica-numerical
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mathematica-numerical`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Mathematica Numerical
...
## Ресурсы
- Оригинальный навык: `scientific/mathematica-numerical/SKILL.md`
- Категория: Наука
- Язык: Русский
