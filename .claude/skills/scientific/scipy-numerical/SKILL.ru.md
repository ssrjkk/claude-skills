...
version: "1.0"
language: ru
original: scipy-numerical
---

# Scipy Numerical

> Numerical with SciPy. numerical methods.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-numerical`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Scipy Numerical
...
## Ресурсы
- Оригинальный навык: `scientific/scipy-numerical/SKILL.md`
- Категория: Наука
- Язык: Русский
