...
version: "1.0"
language: ru
original: numpy-setup
---

# Numpy Setup

> Setup with NumPy. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-setup`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Numpy Setup
...
## Ресурсы
- Оригинальный навык: `scientific/numpy-setup/SKILL.md`
- Категория: Наука
- Язык: Русский
