...
version: "1.0"
language: ru
original: julia-statistics
---

# Julia Statistics

> Statistics with Julia. statistical analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `julia-statistics`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Julia Statistics
...
## Ресурсы
- Оригинальный навык: `scientific/julia-statistics/SKILL.md`
- Категория: Наука
- Язык: Русский
