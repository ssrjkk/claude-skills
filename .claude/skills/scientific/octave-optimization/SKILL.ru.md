...
## Быстрый старт
Этот навык на русском языке. Оригинал: `octave-optimization`.

## Когда использовать
- Работа с Наука
- Выполнение задач, связанных с Octave Optimization
...
## Ресурсы
- Оригинальный навык: `scientific/octave-optimization/SKILL.md`
- Категория: Наука
- Язык: Русский
