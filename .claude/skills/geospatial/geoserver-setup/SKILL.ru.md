...
version: "1.0"
language: ru
original: geoserver-setup
---

# Geoserver Setup

> Setup with GeoServer. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `geoserver-setup`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Geoserver Setup
...
## Ресурсы
- Оригинальный навык: `geospatial/geoserver-setup/SKILL.md`
