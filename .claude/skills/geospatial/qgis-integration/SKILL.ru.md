...
version: "1.0"
language: ru
original: qgis-integration
---

# Qgis Integration

> Integration with QGIS. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qgis-integration`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Qgis Integration
...
## Ресурсы
- Оригинальный навык: `geospatial/qgis-integration/SKILL.md`
