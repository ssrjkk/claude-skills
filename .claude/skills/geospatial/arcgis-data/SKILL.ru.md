...
version: "1.0"
language: ru
original: arcgis-data
---

# Arcgis Data

> Data with ArcGIS. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcgis-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Arcgis Data
...
## Ресурсы
- Оригинальный навык: `geospatial/arcgis-data/SKILL.md`
