...
version: "1.0"
language: ru
original: qgis-routing
---

# Qgis Routing

> Routing with QGIS. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qgis-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Qgis Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/qgis-routing/SKILL.md`
