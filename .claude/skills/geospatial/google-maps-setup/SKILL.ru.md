...
version: "1.0"
language: ru
original: google-maps-setup
---

# Google Maps Setup

> Setup with Google Maps API. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-maps-setup`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Google Maps Setup
...
## Ресурсы
- Оригинальный навык: `geospatial/google-maps-setup/SKILL.md`
