...
version: "1.0"
language: ru
original: openlayers-data
---

# Openlayers Data

> Data with OpenLayers. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openlayers-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Openlayers Data
...
## Ресурсы
- Оригинальный навык: `geospatial/openlayers-data/SKILL.md`
