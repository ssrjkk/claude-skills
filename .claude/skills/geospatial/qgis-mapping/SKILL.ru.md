...
version: "1.0"
language: ru
original: qgis-mapping
---

# Qgis Mapping

> Mapping with QGIS. mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qgis-mapping`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Qgis Mapping
...
## Ресурсы
- Оригинальный навык: `geospatial/qgis-mapping/SKILL.md`
