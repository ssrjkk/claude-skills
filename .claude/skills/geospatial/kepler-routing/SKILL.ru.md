...
version: "1.0"
language: ru
original: kepler-routing
---

# Kepler Routing

> Routing with Kepler.gl. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kepler-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Kepler Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/kepler-routing/SKILL.md`
