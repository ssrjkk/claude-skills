...
version: "1.0"
language: ru
original: postgis-routing
---

# Postgis Routing

> Routing with PostGIS. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgis-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Postgis Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/postgis-routing/SKILL.md`
