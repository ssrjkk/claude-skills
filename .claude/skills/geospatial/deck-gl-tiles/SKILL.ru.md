...
version: "1.0"
language: ru
original: deck-gl-tiles
---

# Deck Gl Tiles

> Tiles with Deck.gl. tile serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deck-gl-tiles`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Deck Gl Tiles
...
## Ресурсы
- Оригинальный навык: `geospatial/deck-gl-tiles/SKILL.md`
