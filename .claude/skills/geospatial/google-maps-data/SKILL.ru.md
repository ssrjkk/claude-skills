...
version: "1.0"
language: ru
original: google-maps-data
---

# Google Maps Data

> Data with Google Maps API. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-maps-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Google Maps Data
...
## Ресурсы
- Оригинальный навык: `geospatial/google-maps-data/SKILL.md`
