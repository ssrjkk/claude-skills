...
version: "1.0"
language: ru
original: deck-gl-analysis
---

# Deck Gl Analysis

> Analysis with Deck.gl. spatial analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deck-gl-analysis`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Deck Gl Analysis
...
## Ресурсы
- Оригинальный навык: `geospatial/deck-gl-analysis/SKILL.md`
