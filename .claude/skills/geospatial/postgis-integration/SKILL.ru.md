...
version: "1.0"
language: ru
original: postgis-integration
---

# Postgis Integration

> Integration with PostGIS. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgis-integration`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Postgis Integration
...
## Ресурсы
- Оригинальный навык: `geospatial/postgis-integration/SKILL.md`
