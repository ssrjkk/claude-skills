...
version: "1.0"
language: ru
original: mapserver-routing
---

# Mapserver Routing

> Routing with MapServer. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapserver-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapserver Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/mapserver-routing/SKILL.md`
