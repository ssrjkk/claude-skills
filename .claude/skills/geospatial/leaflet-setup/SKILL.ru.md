...
version: "1.0"
language: ru
original: leaflet-setup
---

# Leaflet Setup

> Setup with Leaflet. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `leaflet-setup`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Leaflet Setup
...
## Ресурсы
- Оригинальный навык: `geospatial/leaflet-setup/SKILL.md`
