...
version: "1.0"
language: ru
original: deck-gl-data
---

# Deck Gl Data

> Data with Deck.gl. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deck-gl-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Deck Gl Data
...
## Ресурсы
- Оригинальный навык: `geospatial/deck-gl-data/SKILL.md`
