...
version: "1.0"
language: ru
original: mapserver-analysis
---

# Mapserver Analysis

> Analysis with MapServer. spatial analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapserver-analysis`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapserver Analysis
...
## Ресурсы
- Оригинальный навык: `geospatial/mapserver-analysis/SKILL.md`
