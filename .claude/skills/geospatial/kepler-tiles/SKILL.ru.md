...
version: "1.0"
language: ru
original: kepler-tiles
---

# Kepler Tiles

> Tiles with Kepler.gl. tile serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kepler-tiles`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Kepler Tiles
...
## Ресурсы
- Оригинальный навык: `geospatial/kepler-tiles/SKILL.md`
