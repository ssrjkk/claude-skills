...
version: "1.0"
language: ru
original: postgis-tiles
---

# Postgis Tiles

> Tiles with PostGIS. tile serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgis-tiles`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Postgis Tiles
...
## Ресурсы
- Оригинальный навык: `geospatial/postgis-tiles/SKILL.md`
