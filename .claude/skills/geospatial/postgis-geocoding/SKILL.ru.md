...
version: "1.0"
language: ru
original: postgis-geocoding
---

# Postgis Geocoding

> Geocoding with PostGIS. geocoding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `postgis-geocoding`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Postgis Geocoding
...
## Ресурсы
- Оригинальный навык: `geospatial/postgis-geocoding/SKILL.md`
