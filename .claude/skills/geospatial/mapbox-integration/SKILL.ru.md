...
category: geospatial
tags: [mapbox-integration, geospatial, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Integration with Mapbox. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapbox-integration`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapbox Integration
...
## Ресурсы
- Оригинальный навык: `geospatial/mapbox-integration/SKILL.md`
