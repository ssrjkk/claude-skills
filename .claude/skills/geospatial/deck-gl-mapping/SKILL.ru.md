...
version: "1.0"
language: ru
original: deck-gl-mapping
---

# Deck Gl Mapping

> Mapping with Deck.gl. mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deck-gl-mapping`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Deck Gl Mapping
...
## Ресурсы
- Оригинальный навык: `geospatial/deck-gl-mapping/SKILL.md`
