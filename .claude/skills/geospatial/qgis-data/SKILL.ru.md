...
> Data with QGIS. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qgis-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Qgis Data
...
## Ресурсы
- Оригинальный навык: `geospatial/qgis-data/SKILL.md`
