...
version: "1.0"
language: ru
original: mapserver-tiles
---

# Mapserver Tiles

> Tiles with MapServer. tile serving.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapserver-tiles`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapserver Tiles
...
## Ресурсы
- Оригинальный навык: `geospatial/mapserver-tiles/SKILL.md`
