...
version: "1.0"
language: ru
original: mapserver-geocoding
---

# Mapserver Geocoding

> Geocoding with MapServer. geocoding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapserver-geocoding`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapserver Geocoding
...
## Ресурсы
- Оригинальный навык: `geospatial/mapserver-geocoding/SKILL.md`
