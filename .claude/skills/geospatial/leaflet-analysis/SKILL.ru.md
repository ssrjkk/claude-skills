...
version: "1.0"
language: ru
original: leaflet-analysis
---

# Leaflet Analysis

> Analysis with Leaflet. spatial analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `leaflet-analysis`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Leaflet Analysis
...
## Ресурсы
- Оригинальный навык: `geospatial/leaflet-analysis/SKILL.md`
