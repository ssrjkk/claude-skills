...
version: "1.0"
language: ru
original: kepler-setup
---

# Kepler Setup

> Setup with Kepler.gl. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kepler-setup`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Kepler Setup
...
## Ресурсы
- Оригинальный навык: `geospatial/kepler-setup/SKILL.md`
