...
version: "1.0"
language: ru
original: openlayers-mapping
---

# Openlayers Mapping

> Mapping with OpenLayers. mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openlayers-mapping`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Openlayers Mapping
...
## Ресурсы
- Оригинальный навык: `geospatial/openlayers-mapping/SKILL.md`
