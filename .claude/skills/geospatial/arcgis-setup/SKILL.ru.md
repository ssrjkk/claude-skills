...
version: "1.0"
language: ru
original: arcgis-setup
---

# Arcgis Setup

> Setup with ArcGIS. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcgis-setup`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Arcgis Setup
...
## Ресурсы
- Оригинальный навык: `geospatial/arcgis-setup/SKILL.md`
