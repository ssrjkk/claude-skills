...
version: "1.0"
language: ru
original: leaflet-routing
---

# Leaflet Routing

> Routing with Leaflet. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `leaflet-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Leaflet Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/leaflet-routing/SKILL.md`
