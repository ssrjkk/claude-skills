...
category: geospatial
tags: [kepler-data, geospatial, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Data with Kepler.gl. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kepler-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Kepler Data
...
## Ресурсы
- Оригинальный навык: `geospatial/kepler-data/SKILL.md`
