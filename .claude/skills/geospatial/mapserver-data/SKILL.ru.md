...
version: "1.0"
language: ru
original: mapserver-data
---

# Mapserver Data

> Data with MapServer. geospatial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapserver-data`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapserver Data
...
## Ресурсы
- Оригинальный навык: `geospatial/mapserver-data/SKILL.md`
