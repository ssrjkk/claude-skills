...
version: "1.0"
language: ru
original: mapbox-routing
---

# Mapbox Routing

> Routing with Mapbox. routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mapbox-routing`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Mapbox Routing
...
## Ресурсы
- Оригинальный навык: `geospatial/mapbox-routing/SKILL.md`
