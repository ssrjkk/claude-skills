...
version: "1.0"
language: ru
original: google-maps-mapping
---

# Google Maps Mapping

> Mapping with Google Maps API. mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-maps-mapping`.

## Когда использовать
- Работа с Геопространственные данные
- Выполнение задач, связанных с Google Maps Mapping
...
## Ресурсы
- Оригинальный навык: `geospatial/google-maps-mapping/SKILL.md`
