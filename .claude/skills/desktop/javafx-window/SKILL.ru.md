...
version: "1.0"
language: ru
original: javafx-window
---

# Javafx Window

> Window with JavaFX. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Window
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
