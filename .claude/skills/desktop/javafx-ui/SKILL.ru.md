...
> UI with JavaFX. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Ui
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
