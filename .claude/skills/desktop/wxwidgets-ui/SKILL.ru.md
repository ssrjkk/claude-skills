...
category: desktop
tags: [wxwidgets-ui, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wxwidgets-ui
---

# Wxwidgets Ui

> UI with wxWidgets. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wxwidgets-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wxwidgets Ui
...
## Ресурсы
- Оригинальный навык: `desktop/wxwidgets-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
