...
version: "1.0"
language: ru
original: avalonia-ui
---

# Avalonia Ui

> UI with Avalonia. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Ui
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
