...
category: desktop
tags: [avalonia-packaging, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avalonia-packaging
---

# Avalonia Packaging

> Packaging with Avalonia. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
