...
version: "1.0"
language: ru
original: winui-window
---

# Winui Window

> Window with WinUI. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Window
...
## Ресурсы
- Оригинальный навык: `desktop/winui-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
