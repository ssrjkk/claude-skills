...
version: "1.0"
language: ru
original: flutter-desktop-packaging
---

# Flutter Desktop Packaging

> Packaging with Flutter Desktop. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-desktop-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Flutter Desktop Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/flutter-desktop-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
