...
category: desktop
tags: [flutter-desktop, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-desktop
---

# Flutter Desktop

> Builds desktop applications with Flutter for Windows, macOS, and Linux from a single codebase.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-desktop`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Flutter Desktop
...
## Ресурсы
- Оригинальный навык: `desktop/flutter-desktop/SKILL.md`
- Категория: Десктоп
- Язык: Русский
