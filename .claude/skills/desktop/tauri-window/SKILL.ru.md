...
version: "1.0"
language: ru
original: tauri-window
---

# Tauri Window

> Window with Tauri. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Window
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
