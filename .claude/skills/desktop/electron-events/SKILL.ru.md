...
version: "1.0"
language: ru
original: electron-events
---

# Electron Events

> Events with Electron. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Events
...
## Ресурсы
- Оригинальный навык: `desktop/electron-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
