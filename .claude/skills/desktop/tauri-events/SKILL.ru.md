...
version: "1.0"
language: ru
original: tauri-events
---

# Tauri Events

> Events with Tauri. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Events
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
