...
version: "1.0"
language: ru
original: javafx-native
---

# Javafx Native

> Native with JavaFX. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Native
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
