...
version: "1.0"
language: ru
original: electron-ui
---

# Electron Ui

> UI with Electron. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Ui
...
## Ресурсы
- Оригинальный навык: `desktop/electron-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
