...
version: "1.0"
language: ru
original: javafx-packaging
---

# Javafx Packaging

> Packaging with JavaFX. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
