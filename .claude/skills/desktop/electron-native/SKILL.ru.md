...
category: desktop
tags: [electron-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Native with Electron. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Native
...
## Ресурсы
- Оригинальный навык: `desktop/electron-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
