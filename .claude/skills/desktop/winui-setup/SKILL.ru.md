...
category: desktop
tags: [winui-setup, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: winui-setup
---

# Winui Setup

> Setup with WinUI. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Setup
...
## Ресурсы
- Оригинальный навык: `desktop/winui-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
