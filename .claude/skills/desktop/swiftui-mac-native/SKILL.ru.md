...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swiftui-mac-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Swiftui Mac Native
...
## Ресурсы
- Оригинальный навык: `desktop/swiftui-mac-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
