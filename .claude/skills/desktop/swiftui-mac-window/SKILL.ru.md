...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swiftui-mac-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Swiftui Mac Window
...
## Ресурсы
- Оригинальный навык: `desktop/swiftui-mac-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
