...
> Window with Electron. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Window
...
## Ресурсы
- Оригинальный навык: `desktop/electron-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
