...
version: "1.0"
language: ru
original: wxwidgets-setup
---

# Wxwidgets Setup

> Setup with wxWidgets. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wxwidgets-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wxwidgets Setup
...
## Ресурсы
- Оригинальный навык: `desktop/wxwidgets-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
