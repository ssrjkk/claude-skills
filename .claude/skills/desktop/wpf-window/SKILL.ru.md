...
> Window with WPF. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wpf-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wpf Window
...
## Ресурсы
- Оригинальный навык: `desktop/wpf-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
