...
> Events with WPF. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wpf-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wpf Events
...
## Ресурсы
- Оригинальный навык: `desktop/wpf-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
