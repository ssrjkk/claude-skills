...
version: "1.0"
language: ru
original: avalonia-styling
---

# Avalonia Styling

> Styling with Avalonia. styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-styling`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Styling
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-styling/SKILL.md`
- Категория: Десктоп
- Язык: Русский
