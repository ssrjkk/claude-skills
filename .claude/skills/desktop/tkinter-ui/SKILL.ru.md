...
category: desktop
tags: [tkinter-ui, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tkinter-ui
...
> UI with Tkinter. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tkinter-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tkinter Ui
...
## Ресурсы
- Оригинальный навык: `desktop/tkinter-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
