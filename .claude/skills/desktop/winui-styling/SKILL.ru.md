...
category: desktop
tags: [winui-styling, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: winui-styling
---

# Winui Styling

> Styling with WinUI. styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-styling`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Styling
...
## Ресурсы
- Оригинальный навык: `desktop/winui-styling/SKILL.md`
- Категория: Десктоп
- Язык: Русский
