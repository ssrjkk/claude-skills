...
category: desktop
tags: [gtk-styling, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gtk-styling
---

# Gtk Styling

> Styling with GTK. styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gtk-styling`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Gtk Styling
...
## Ресурсы
- Оригинальный навык: `desktop/gtk-styling/SKILL.md`
- Категория: Десктоп
- Язык: Русский
