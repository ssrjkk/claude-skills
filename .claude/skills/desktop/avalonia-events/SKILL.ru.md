...
version: "1.0"
language: ru
original: avalonia-events
---

# Avalonia Events

> Events with Avalonia. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Events
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
