...
category: desktop
tags: [winui-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: winui-native
---

# Winui Native

> Native with WinUI. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Native
...
## Ресурсы
- Оригинальный навык: `desktop/winui-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
