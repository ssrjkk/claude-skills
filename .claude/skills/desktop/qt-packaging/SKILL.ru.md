...
version: "1.0"
language: ru
original: qt-packaging
---

# Qt Packaging

> Packaging with Qt. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qt-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Qt Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/qt-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
