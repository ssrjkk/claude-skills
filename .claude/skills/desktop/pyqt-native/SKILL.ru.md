...
category: desktop
tags: [pyqt-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pyqt-native
---

# Pyqt Native

> Native with PyQt. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyqt-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Pyqt Native
...
## Ресурсы
- Оригинальный навык: `desktop/pyqt-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
