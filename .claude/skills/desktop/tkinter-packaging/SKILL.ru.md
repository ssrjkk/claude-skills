...
version: "1.0"
language: ru
original: tkinter-packaging
---

# Tkinter Packaging

> Packaging with Tkinter. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tkinter-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tkinter Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/tkinter-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
