...
version: "1.0"
language: ru
original: gtk-packaging
---

# Gtk Packaging

> Packaging with GTK. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gtk-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Gtk Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/gtk-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
