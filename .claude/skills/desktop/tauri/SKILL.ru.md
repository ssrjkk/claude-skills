...
> Builds lightweight, secure desktop applications with Tauri, Rust backend, and web frontend. Use for small, fast native apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri
...
## Ресурсы
- Оригинальный навык: `desktop/tauri/SKILL.md`
- Категория: Десктоп
- Язык: Русский
