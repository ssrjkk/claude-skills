...
category: desktop
tags: [flutter-desktop-setup, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-desktop-setup
---

# Flutter Desktop Setup

> Setup with Flutter Desktop. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-desktop-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Flutter Desktop Setup
...
## Ресурсы
- Оригинальный навык: `desktop/flutter-desktop-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
