...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swiftui-mac-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Swiftui Mac Setup
...
## Ресурсы
- Оригинальный навык: `desktop/swiftui-mac-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
