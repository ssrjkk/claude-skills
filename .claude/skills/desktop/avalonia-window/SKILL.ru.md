...
version: "1.0"
language: ru
original: avalonia-window
---

# Avalonia Window

> Window with Avalonia. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Window
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
