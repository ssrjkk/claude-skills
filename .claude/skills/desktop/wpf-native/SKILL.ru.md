...
category: desktop
tags: [wpf-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wpf-native
...
> Native with WPF. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wpf-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wpf Native
...
## Ресурсы
- Оригинальный навык: `desktop/wpf-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
