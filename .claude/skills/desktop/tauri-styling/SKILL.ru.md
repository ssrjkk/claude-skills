...
version: "1.0"
language: ru
original: tauri-styling
---

# Tauri Styling

> Styling with Tauri. styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-styling`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Styling
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-styling/SKILL.md`
- Категория: Десктоп
- Язык: Русский
