...
category: desktop
tags: [gtk-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gtk-native
...
> Native with GTK. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gtk-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Gtk Native
...
## Ресурсы
- Оригинальный навык: `desktop/gtk-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
