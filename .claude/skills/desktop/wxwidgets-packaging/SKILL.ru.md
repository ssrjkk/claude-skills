...
version: "1.0"
language: ru
original: wxwidgets-packaging
---

# Wxwidgets Packaging

> Packaging with wxWidgets. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wxwidgets-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wxwidgets Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/wxwidgets-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
