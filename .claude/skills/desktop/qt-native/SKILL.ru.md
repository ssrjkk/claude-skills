...
> Native with Qt. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qt-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Qt Native
...
## Ресурсы
- Оригинальный навык: `desktop/qt-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
