...
category: desktop
tags: [avalonia-setup, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avalonia-setup
---

# Avalonia Setup

> Setup with Avalonia. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Setup
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
