...
category: desktop
tags: [tauri-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tauri-native
---

# Tauri Native

> Native with Tauri. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Native
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
