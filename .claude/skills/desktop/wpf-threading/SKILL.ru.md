...
version: "1.0"
language: ru
original: wpf-threading
---

# Wpf Threading

> Threading with WPF. multithreading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wpf-threading`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wpf Threading
...
## Ресурсы
- Оригинальный навык: `desktop/wpf-threading/SKILL.md`
- Категория: Десктоп
- Язык: Русский
