...
version: "1.0"
language: ru
original: winui-packaging
---

# Winui Packaging

> Packaging with WinUI. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/winui-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
