...
> Events with GTK. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gtk-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Gtk Events
...
## Ресурсы
- Оригинальный навык: `desktop/gtk-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
