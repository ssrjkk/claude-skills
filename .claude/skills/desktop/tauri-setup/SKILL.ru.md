...
category: desktop
tags: [tauri-setup, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tauri-setup
---

# Tauri Setup

> Setup with Tauri. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Setup
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
