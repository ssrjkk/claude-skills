...
version: "1.0"
language: ru
original: pyqt-window
---

# Pyqt Window

> Window with PyQt. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyqt-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Pyqt Window
...
## Ресурсы
- Оригинальный навык: `desktop/pyqt-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
