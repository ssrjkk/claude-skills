...
## Быстрый старт
Этот навык на русском языке. Оригинал: `qt-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Qt Setup
...
## Ресурсы
- Оригинальный навык: `desktop/qt-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
