...
version: "1.0"
language: ru
original: tauri-packaging
---

# Tauri Packaging

> Packaging with Tauri. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tauri-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tauri Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/tauri-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
