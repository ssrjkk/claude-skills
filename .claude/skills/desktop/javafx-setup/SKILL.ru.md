...
version: "1.0"
language: ru
original: javafx-setup
---

# Javafx Setup

> Setup with JavaFX. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Setup
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
