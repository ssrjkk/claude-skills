...
category: desktop
tags: [tkinter-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Native with Tkinter. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tkinter-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tkinter Native
...
## Ресурсы
- Оригинальный навык: `desktop/tkinter-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
