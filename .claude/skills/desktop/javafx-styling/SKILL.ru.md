...
category: desktop
tags: [javafx-styling, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: javafx-styling
---

# Javafx Styling

> Styling with JavaFX. styling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-styling`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Styling
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-styling/SKILL.md`
- Категория: Десктоп
- Язык: Русский
