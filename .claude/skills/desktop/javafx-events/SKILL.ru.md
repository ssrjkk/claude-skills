...
version: "1.0"
language: ru
original: javafx-events
---

# Javafx Events

> Events with JavaFX. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javafx-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Javafx Events
...
## Ресурсы
- Оригинальный навык: `desktop/javafx-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
