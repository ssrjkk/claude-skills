...
category: desktop
tags: [pyqt-packaging, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pyqt-packaging
---

# Pyqt Packaging

> Packaging with PyQt. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyqt-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Pyqt Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/pyqt-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
