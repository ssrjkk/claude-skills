...
> Window with GTK. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gtk-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Gtk Window
...
## Ресурсы
- Оригинальный навык: `desktop/gtk-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
