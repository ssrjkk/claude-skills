...
category: desktop
tags: [qt-events, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: qt-events
...
> Events with Qt. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `qt-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Qt Events
...
## Ресурсы
- Оригинальный навык: `desktop/qt-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
