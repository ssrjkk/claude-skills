...
version: "1.0"
language: ru
original: wpf-packaging
---

# Wpf Packaging

> Packaging with WPF. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wpf-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wpf Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/wpf-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
