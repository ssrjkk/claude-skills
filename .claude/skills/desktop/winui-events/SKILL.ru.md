...
version: "1.0"
language: ru
original: winui-events
---

# Winui Events

> Events with WinUI. event handling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `winui-events`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Winui Events
...
## Ресурсы
- Оригинальный навык: `desktop/winui-events/SKILL.md`
- Категория: Десктоп
- Язык: Русский
