...
version: "1.0"
language: ru
original: swiftui-mac-packaging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swiftui-mac-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Swiftui Mac Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/swiftui-mac-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
