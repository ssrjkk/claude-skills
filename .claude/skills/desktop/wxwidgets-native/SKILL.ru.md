...
category: desktop
tags: [wxwidgets-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wxwidgets-native
---

# Wxwidgets Native

> Native with wxWidgets. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wxwidgets-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Wxwidgets Native
...
## Ресурсы
- Оригинальный навык: `desktop/wxwidgets-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
