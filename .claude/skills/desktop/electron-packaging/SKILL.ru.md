...
category: desktop
tags: [electron-packaging, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: electron-packaging
---

# Electron Packaging

> Packaging with Electron. app packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-packaging`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Packaging
...
## Ресурсы
- Оригинальный навык: `desktop/electron-packaging/SKILL.md`
- Категория: Десктоп
- Язык: Русский
