...
version: "1.0"
language: ru
original: tkinter-window
---

# Tkinter Window

> Window with Tkinter. windows.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tkinter-window`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Tkinter Window
...
## Ресурсы
- Оригинальный навык: `desktop/tkinter-window/SKILL.md`
- Категория: Десктоп
- Язык: Русский
