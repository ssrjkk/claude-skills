...
category: desktop
tags: [avalonia-native, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: avalonia-native
---

# Avalonia Native

> Native with Avalonia. native APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `avalonia-native`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Avalonia Native
...
## Ресурсы
- Оригинальный навык: `desktop/avalonia-native/SKILL.md`
- Категория: Десктоп
- Язык: Русский
