...
category: desktop
tags: [electron-setup, desktop, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: electron-setup
---

# Electron Setup

> Setup with Electron. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `electron-setup`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Electron Setup
...
## Ресурсы
- Оригинальный навык: `desktop/electron-setup/SKILL.md`
- Категория: Десктоп
- Язык: Русский
