...
version: "1.0"
language: ru
original: flutter-desktop-ui
---

# Flutter Desktop Ui

> UI with Flutter Desktop. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-desktop-ui`.

## Когда использовать
- Работа с Десктоп
- Выполнение задач, связанных с Flutter Desktop Ui
...
## Ресурсы
- Оригинальный навык: `desktop/flutter-desktop-ui/SKILL.md`
- Категория: Десктоп
- Язык: Русский
