...
category: backend
tags: [chi-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chi-templating
---

# Chi Templating

> Templating with Chi. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Templating
...
## Ресурсы
- Оригинальный навык: `backend/chi-templating/SKILL.md`
