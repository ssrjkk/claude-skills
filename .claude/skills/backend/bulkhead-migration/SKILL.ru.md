...
version: "1.0"
language: ru
original: bulkhead-migration
---

# Bulkhead Migration

> Migration with Bulkhead. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bulkhead-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bulkhead Migration
...
## Ресурсы
- Оригинальный навык: `backend/bulkhead-migration/SKILL.md`
