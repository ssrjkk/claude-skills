...
version: "1.0"
language: ru
original: csharp-logging
---

# Csharp Logging

> Logging with Csharp. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csharp-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Csharp Logging
...
## Ресурсы
- Оригинальный навык: `backend/csharp-logging/SKILL.md`
