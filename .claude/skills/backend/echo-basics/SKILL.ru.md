...
## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Basics
...
## Ресурсы
- Оригинальный навык: backend/echo-basics/SKILL.md
