...
version: "1.0"
language: ru
original: scala-testing
---

# Scala Testing

> Testing with Scala. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Testing
...
## Ресурсы
- Оригинальный навык: `backend/scala-testing/SKILL.md`
