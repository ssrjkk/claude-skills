...
version: "1.0"
language: ru
original: rust-logging
---

# Rust Logging

> Logging with Rust. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Logging
...
## Ресурсы
- Оригинальный навык: `backend/rust-logging/SKILL.md`
