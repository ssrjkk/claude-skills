...
version: "1.0"
language: ru
original: sidecar-scaling
---

# Sidecar Scaling

> Scaling with Sidecar. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sidecar-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sidecar Scaling
...
## Ресурсы
- Оригинальный навык: `backend/sidecar-scaling/SKILL.md`
