...
version: "1.0"
language: ru
original: ruby-web-framework
---

# Ruby Web Framework

> Web Framework with Ruby. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/ruby-web-framework/SKILL.md`
