...
version: "1.0"
language: ru
original: microservices-intro
---

# Microservices Intro

> Introduction with Microservices. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microservices-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Microservices Intro
...
## Ресурсы
- Оригинальный навык: `backend/microservices-intro/SKILL.md`
