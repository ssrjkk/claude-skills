...
version: "1.0"
language: ru
original: cuba-deployment
---

# Cuba Deployment

> Deployment with Cuba. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Deployment
...
## Ресурсы
- Оригинальный навык: `backend/cuba-deployment/SKILL.md`
