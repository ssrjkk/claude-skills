...
version: "1.0"
language: ru
original: aiohttp-database
---

# Aiohttp Database

> Database with aiohttp. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aiohttp-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aiohttp Database
...
## Ресурсы
- Оригинальный навык: `backend/aiohttp-database/SKILL.md`
