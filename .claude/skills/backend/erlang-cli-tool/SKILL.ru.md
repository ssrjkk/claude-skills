...
version: "1.0"
language: ru
original: erlang-cli-tool
---

# Erlang Cli Tool

> CLI Tool with Erlang. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/erlang-cli-tool/SKILL.md`
