...
category: backend
tags: [sinatra-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sinatra-api
---

# Sinatra Api

> API with Sinatra. API building.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Api
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-api/SKILL.md`
