...
category: backend
tags: [kotlin-logging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-logging
---

# Kotlin Logging

> Logging with Kotlin. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Logging
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-logging/SKILL.md`
