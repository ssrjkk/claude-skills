...
category: backend
tags: [grape-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Api
...
## Ресурсы
- Оригинальный навык: `backend/grape-api/SKILL.md`
