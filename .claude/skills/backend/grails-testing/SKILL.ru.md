...
category: backend
tags: [grails-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grails-testing
---

# Grails Testing

> Testing with Grails. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Testing
...
## Ресурсы
- Оригинальный навык: `backend/grails-testing/SKILL.md`
