...
version: "1.0"
language: ru
original: envoy-fundamentals
---

# Envoy Fundamentals

> Fundamentals for Envoy: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `envoy-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Envoy Fundamentals
...
## Ресурсы
- Оригинал: backend/envoy-fundamentals/SKILL.md
