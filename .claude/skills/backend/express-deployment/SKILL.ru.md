...
category: backend
tags: [express-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: express-deployment
---

# Express Deployment

> Deployment with Express. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Deployment
...
## Ресурсы
- Оригинальный навык: `backend/express-deployment/SKILL.md`
