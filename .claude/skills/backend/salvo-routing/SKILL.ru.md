...
category: backend
tags: [salvo-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: salvo-routing
---

# Salvo Routing

> Routing with Salvo. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Routing
...
## Ресурсы
- Оригинальный навык: `backend/salvo-routing/SKILL.md`
