...
version: "1.0"
language: ru
original: grpc-getting-started
---

# Grpc Getting Started

> Getting Started for Grpc: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: grpc-getting-started.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grpc Getting Started
...
## Ресурсы
- backend/grpc-getting-started/SKILL.md
