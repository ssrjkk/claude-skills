...
version: "1.0"
language: ru
original: redis-production
---

# Redis Production

> Production for Redis: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: redis-production.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Redis Production
...
## Ресурсы
- backend/redis-production/SKILL.md
