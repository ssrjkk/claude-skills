...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Database
...
## Ресурсы
- Оригинальный навык: `backend/django-database/SKILL.md`
