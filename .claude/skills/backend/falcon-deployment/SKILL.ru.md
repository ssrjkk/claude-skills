...
version: "1.0"
language: ru
original: falcon-deployment
---

# Falcon Deployment

> Deployment with Falcon. production deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Deployment
...
## Ресурсы
- Оригинальный навык: `backend/falcon-deployment/SKILL.md`
