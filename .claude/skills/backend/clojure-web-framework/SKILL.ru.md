...
version: "1.0"
language: ru
original: clojure-web-framework
---

# Clojure Web Framework

> Web Framework with Clojure. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/clojure-web-framework/SKILL.md`
