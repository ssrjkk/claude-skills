...
category: backend
tags: [python-fastapi, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Creates REST API templates with FastAPI, Pydantic validation, and auto-generated documentation. Use for building new microservices or API endpoints.

## Быстрый старт
Этот навык на русском языке. Оригинал: `python-fastapi`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Fastapi
...
## Ресурсы
- Оригинальный навык: `backend/python-fastapi/SKILL.md`
