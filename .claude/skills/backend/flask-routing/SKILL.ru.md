...
category: backend
tags: [flask-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-routing
---

# Flask Routing

> Routing with Flask. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Routing
...
## Ресурсы
- Оригинальный навык: `backend/flask-routing/SKILL.md`
