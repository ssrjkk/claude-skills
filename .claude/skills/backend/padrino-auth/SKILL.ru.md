...
category: backend
tags: [padrino-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: padrino-auth
---

# Padrino Auth

> Auth with Padrino. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `padrino-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Padrino Auth
...
## Ресурсы
- Оригинальный навык: `backend/padrino-auth/SKILL.md`
