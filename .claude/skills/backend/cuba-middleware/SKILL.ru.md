...
version: "1.0"
language: ru
original: cuba-middleware
---

# Cuba Middleware

> Middleware with Cuba. rack middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Middleware
...
## Ресурсы
- Оригинальный навык: `backend/cuba-middleware/SKILL.md`
