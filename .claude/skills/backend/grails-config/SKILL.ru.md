...
version: "1.0"
language: ru
original: grails-config
---

# Grails Config

> Config with Grails. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Config
...
## Ресурсы
- Оригинальный навык: `backend/grails-config/SKILL.md`
