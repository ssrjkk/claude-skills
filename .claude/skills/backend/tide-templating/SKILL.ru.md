...
category: backend
tags: [tide-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tide-templating
---

# Tide Templating

> Templating with Tide. templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Templating
...
## Ресурсы
- Оригинальный навык: `backend/tide-templating/SKILL.md`
