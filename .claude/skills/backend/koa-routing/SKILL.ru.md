...
version: "1.0"
language: ru
original: koa-routing
---

# Koa Routing

> Routing with Koa. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `koa-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Koa Routing
...
## Ресурсы
- Оригинальный навык: `backend/koa-routing/SKILL.md`
