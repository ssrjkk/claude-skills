---
name: hanami-auth
description: "Auth with Hanami. authentication."
category: backend
tags: [hanami-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-auth
---

# Hanami Auth

> Auth with Hanami. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Auth
...
## Ресурсы
- Оригинальный навык: `backend/hanami-auth/SKILL.md`
