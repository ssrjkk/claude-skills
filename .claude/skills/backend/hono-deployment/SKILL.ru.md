...
version: "1.0"
language: ru
original: hono-deployment
---

# Hono Deployment

> Deployment with Hono. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Deployment
...
## Ресурсы
- Оригинальный навык: `backend/hono-deployment/SKILL.md`
