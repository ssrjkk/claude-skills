...
category: backend
tags: [api-gateway-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: api-gateway-migration
---

# Api Gateway Migration

> Migration with API Gateway. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-gateway-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Api Gateway Migration
...
## Ресурсы
- Оригинальный навык: `backend/api-gateway-migration/SKILL.md`
