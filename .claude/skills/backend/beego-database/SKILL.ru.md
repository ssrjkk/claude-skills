...
version: "1.0"
language: ru
original: beego-database
---

# Beego Database

> Database with Beego. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `beego-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Beego Database
...
## Ресурсы
- Оригинальный навык: `backend/beego-database/SKILL.md`
