...
version: "1.0"
language: ru
original: salvo-templating
---

# Salvo Templating

> Templating with Salvo. templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Templating
...
## Ресурсы
- Оригинальный навык: `backend/salvo-templating/SKILL.md`
