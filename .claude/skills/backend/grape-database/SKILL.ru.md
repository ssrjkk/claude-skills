...
version: "1.0"
language: ru
original: grape-database
---

# Grape Database

> Database with Grape. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Database
...
## Ресурсы
- Оригинальный навык: `backend/grape-database/SKILL.md`
