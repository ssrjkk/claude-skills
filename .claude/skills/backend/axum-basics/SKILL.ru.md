...
category: backend
tags: [axum-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: axum-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Basics
...
## Ресурсы
- Оригинальный навык: backend/axum-basics/SKILL.md
