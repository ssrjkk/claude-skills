...
version: "1.0"
language: ru
original: grails-routing
---

# Grails Routing

> Routing with Grails. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Routing
...
## Ресурсы
- Оригинальный навык: `backend/grails-routing/SKILL.md`
