...
category: backend
tags: [echo-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: echo-routing
---

# Echo Routing

> Routing with Echo. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Routing
...
## Ресурсы
- Оригинальный навык: `backend/echo-routing/SKILL.md`
