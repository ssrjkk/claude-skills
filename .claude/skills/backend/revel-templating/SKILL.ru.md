...
version: "1.0"
language: ru
original: revel-templating
---

# Revel Templating

> Templating with Revel. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Templating
...
## Ресурсы
- Оригинальный навык: `backend/revel-templating/SKILL.md`
