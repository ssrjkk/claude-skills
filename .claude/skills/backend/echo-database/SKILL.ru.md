...
category: backend
tags: [echo-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: echo-database
---

# Echo Database

> Database with Echo. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Database
...
## Ресурсы
- Оригинальный навык: `backend/echo-database/SKILL.md`
