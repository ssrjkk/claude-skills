...
category: backend
tags: [hanami-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-routing
---

# Hanami Routing

> Routing with Hanami. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Routing
...
## Ресурсы
- Оригинальный навык: `backend/hanami-routing/SKILL.md`
