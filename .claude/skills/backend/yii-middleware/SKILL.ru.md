...
version: "1.0"
language: ru
original: yii-middleware
---

# Yii Middleware

> Middleware with Yii. pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Middleware
...
## Ресурсы
- Оригинальный навык: `backend/yii-middleware/SKILL.md`
