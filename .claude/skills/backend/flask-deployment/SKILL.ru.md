...
category: backend
tags: [flask-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-deployment
---

# Flask Deployment

> Deployment with Flask. production deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Deployment
...
## Ресурсы
- Оригинальный навык: `backend/flask-deployment/SKILL.md`
