...
version: "1.0"
language: ru
original: flask-websocket
---

# Flask Websocket

> WebSocket with Flask. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Websocket
...
## Ресурсы
- Оригинальный навык: `backend/flask-websocket/SKILL.md`
