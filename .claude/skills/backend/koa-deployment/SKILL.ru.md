...
version: "1.0"
language: ru
original: koa-deployment
---

# Koa Deployment

> Deployment with Koa. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `koa-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Koa Deployment
...
## Ресурсы
- Оригинальный навык: `backend/koa-deployment/SKILL.md`
