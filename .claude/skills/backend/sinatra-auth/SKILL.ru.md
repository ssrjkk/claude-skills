...
version: "1.0"
language: ru
original: sinatra-auth
---

# Sinatra Auth

> Auth with Sinatra. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Auth
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-auth/SKILL.md`
