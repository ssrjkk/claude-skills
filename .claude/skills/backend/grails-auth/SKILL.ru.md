...
version: "1.0"
language: ru
original: grails-auth
---

# Grails Auth

> Auth with Grails. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Auth
...
## Ресурсы
- Оригинальный навык: `backend/grails-auth/SKILL.md`
