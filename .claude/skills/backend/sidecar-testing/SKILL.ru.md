...
category: backend
tags: [sidecar-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sidecar-testing
---

# Sidecar Testing

> Testing with Sidecar. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sidecar-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sidecar Testing
...
## Ресурсы
- Оригинальный навык: `backend/sidecar-testing/SKILL.md`
