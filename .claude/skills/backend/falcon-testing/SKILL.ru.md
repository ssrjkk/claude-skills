...
category: backend
tags: [falcon-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falcon-testing
---

# Falcon Testing

> Testing with Falcon. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Testing
...
## Ресурсы
- Оригинальный навык: `backend/falcon-testing/SKILL.md`
