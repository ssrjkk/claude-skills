...
category: backend
tags: [rust-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rust-dependency-injection
---

# Rust Dependency Injection

> DI with Rust. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/rust-dependency-injection/SKILL.md`
