...
version: "1.0"
language: ru
original: quarkus-routing
---

# Quarkus Routing

> Routing with Quarkus. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Routing
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-routing/SKILL.md`
