...
version: "1.0"
language: ru
original: clojure-async
---

# Clojure Async

> Async with Clojure. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Async
...
## Ресурсы
- Оригинальный навык: `backend/clojure-async/SKILL.md`
