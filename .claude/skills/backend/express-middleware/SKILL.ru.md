...
version: "1.0"
language: ru
original: express-middleware
---

# Express Middleware

> Middleware with Express. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Middleware
...
## Ресурсы
- Оригинальный навык: `backend/express-middleware/SKILL.md`
