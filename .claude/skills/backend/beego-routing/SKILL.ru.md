...
version: "1.0"
language: ru
original: beego-routing
---

# Beego Routing

> Routing with Beego. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `beego-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Beego Routing
...
## Ресурсы
- Оригинальный навык: `backend/beego-routing/SKILL.md`
