...
category: backend
tags: [adonisjs-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adonisjs-auth
---

# Adonisjs Auth

> Auth with AdonisJS. JWT.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adonisjs-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adonisjs Auth
...
## Ресурсы
- Оригинальный навык: `backend/adonisjs-auth/SKILL.md`
