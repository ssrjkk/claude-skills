...
category: backend
tags: [nitro-setup, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nitro-setup
---

# Nitro Setup

> Setup for Nitro: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nitro-setup`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nitro Setup
...
## Ресурсы
- Оригинал: backend/nitro-setup/SKILL.md
