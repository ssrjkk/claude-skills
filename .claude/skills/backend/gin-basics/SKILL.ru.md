...
category: backend
tags: [gin-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gin-basics
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Basics
...
## Ресурсы
- Оригинальный навык: backend/gin-basics/SKILL.md
