...
version: "1.0"
language: ru
original: kit-templating
---

# Kit Templating

> Templating with Go Kit. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kit-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kit Templating
...
## Ресурсы
- Оригинальный навык: `backend/kit-templating/SKILL.md`
