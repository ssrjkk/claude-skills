...
version: "1.0"
language: ru
original: poem-database
---

# Poem Database

> Database with Poem. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Database
...
## Ресурсы
- Оригинальный навык: `backend/poem-database/SKILL.md`
