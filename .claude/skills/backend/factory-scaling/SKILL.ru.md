...
category: backend
tags: [factory-scaling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: factory-scaling
---

# Factory Scaling

> Scaling with Factory. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `factory-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Factory Scaling
...
## Ресурсы
- Оригинальный навык: `backend/factory-scaling/SKILL.md`
