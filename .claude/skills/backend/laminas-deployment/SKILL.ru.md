...
category: backend
tags: [laminas-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: laminas-deployment
---

# Laminas Deployment

> Deployment with Laminas. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Deployment
...
## Ресурсы
- Оригинальный навык: `backend/laminas-deployment/SKILL.md`
