...
version: "1.0"
language: ru
original: loopback-testing
---

# Loopback Testing

> Testing with LoopBack. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Testing
...
## Ресурсы
- Оригинальный навык: `backend/loopback-testing/SKILL.md`
