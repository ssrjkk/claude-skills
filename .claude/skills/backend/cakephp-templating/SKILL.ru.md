...
version: "1.0"
language: ru
original: cakephp-templating
---

# Cakephp Templating

> Templating with CakePHP. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Templating
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-templating/SKILL.md`
