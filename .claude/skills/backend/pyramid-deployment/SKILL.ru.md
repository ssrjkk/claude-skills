...
category: backend
tags: [pyramid-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pyramid-deployment
---

# Pyramid Deployment

> Deployment with Pyramid. production deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Deployment
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-deployment/SKILL.md`
