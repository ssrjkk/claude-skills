...
version: "1.0"
language: ru
original: scala-logging
---

# Scala Logging

> Logging with Scala. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Logging
...
## Ресурсы
- Оригинальный навык: `backend/scala-logging/SKILL.md`
