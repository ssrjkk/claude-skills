...
category: backend
tags: [swift-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-async
---

# Swift Async

> Async with Swift. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Async
...
## Ресурсы
- Оригинальный навык: `backend/swift-async/SKILL.md`
