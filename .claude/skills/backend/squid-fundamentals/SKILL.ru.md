...
version: "1.0"
language: ru
original: squid-fundamentals
---

# Squid Fundamentals

> Fundamentals for Squid: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `squid-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Squid Fundamentals
...
## Ресурсы
- Оригинал: backend/squid-fundamentals/SKILL.md
