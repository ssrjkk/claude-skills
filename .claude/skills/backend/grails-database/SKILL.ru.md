...
version: "1.0"
language: ru
original: grails-database
---

# Grails Database

> Database with Grails. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Database
...
## Ресурсы
- Оригинальный навык: `backend/grails-database/SKILL.md`
