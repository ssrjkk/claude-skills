...
version: "1.0"
language: ru
original: rocket-middleware
---

# Rocket Middleware

> Middleware with Rocket. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Middleware
...
## Ресурсы
- Оригинальный навык: `backend/rocket-middleware/SKILL.md`
