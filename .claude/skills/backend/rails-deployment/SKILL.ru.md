...
category: backend
tags: [rails-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rails-deployment
---

# Rails Deployment

> Deployment with Rails. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Deployment
...
## Ресурсы
- Оригинальный навык: `backend/rails-deployment/SKILL.md`
