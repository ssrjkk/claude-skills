...
version: "1.0"
language: ru
original: crystal-orm
---

# Crystal Orm

> ORM with Crystal. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Orm
...
## Ресурсы
- Оригинальный навык: `backend/crystal-orm/SKILL.md`
