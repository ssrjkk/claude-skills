...
category: backend
tags: [elixir-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: elixir-testing
---

# Elixir Testing

> Testing with Elixir. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Testing
...
## Ресурсы
- Оригинальный навык: `backend/elixir-testing/SKILL.md`
