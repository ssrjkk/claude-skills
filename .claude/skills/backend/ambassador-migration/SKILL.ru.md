...
category: backend
tags: [ambassador-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ambassador-migration
---

# Ambassador Migration

> Migration with Ambassador. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ambassador-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ambassador Migration
...
## Ресурсы
- Оригинальный навык: `backend/ambassador-migration/SKILL.md`
