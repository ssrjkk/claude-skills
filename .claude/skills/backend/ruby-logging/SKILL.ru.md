...
category: backend
tags: [ruby-logging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ruby-logging
---

# Ruby Logging

> Logging with Ruby. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Logging
...
## Ресурсы
- Оригинальный навык: `backend/ruby-logging/SKILL.md`
