...
category: backend
tags: [axum-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: axum-async
...
> Async with Axum. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Async
...
## Ресурсы
- Оригинальный навык: `backend/axum-async/SKILL.md`
