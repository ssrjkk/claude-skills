...
version: "1.0"
language: ru
original: cakephp-database
---

# Cakephp Database

> Database with CakePHP. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Database
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-database/SKILL.md`
