...
version: "1.0"
language: ru
original: celery-configuration
---

# Celery Configuration

> Configuration for Celery: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: celery-configuration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Celery Configuration
...
## Ресурсы
- backend/celery-configuration/SKILL.md
