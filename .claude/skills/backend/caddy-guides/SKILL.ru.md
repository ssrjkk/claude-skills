...
version: "1.0"
language: ru
original: caddy-guides
---

# Caddy Guides

> Guides for Caddy: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `caddy-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Caddy Guides
...
## Ресурсы
- Оригинал: backend/caddy-guides/SKILL.md
