...
version: "1.0"
language: ru
original: javascript-testing
---

# Javascript Testing

> Testing with Javascript. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javascript-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javascript Testing
...
## Ресурсы
- Оригинальный навык: `backend/javascript-testing/SKILL.md`
