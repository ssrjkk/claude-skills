...
category: backend
tags: [falcon-websocket, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falcon-websocket
---

# Falcon Websocket

> WebSocket with Falcon. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Websocket
...
## Ресурсы
- Оригинальный навык: `backend/falcon-websocket/SKILL.md`
