...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Deployment
...
## Ресурсы
- Оригинальный навык: `backend/django-deployment/SKILL.md`
