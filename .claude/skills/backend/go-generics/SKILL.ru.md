...
version: "1.0"
language: ru
original: go-generics
---

# Go Generics

> Go generics patterns and best practices

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-generics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Generics
...
## Ресурсы
- Оригинальный навык: `backend/go-generics/SKILL.md`
