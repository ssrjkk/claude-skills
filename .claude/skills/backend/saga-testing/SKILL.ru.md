...
category: backend
tags: [saga-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saga-testing
---

# Saga Testing

> Testing with Saga. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saga-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Saga Testing
...
## Ресурсы
- Оригинальный навык: `backend/saga-testing/SKILL.md`
