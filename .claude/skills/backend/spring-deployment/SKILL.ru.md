...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Deployment
...
## Ресурсы
- Оригинальный навык: backend/spring-deployment/SKILL.md
