...
version: "1.0"
language: ru
original: rails-middleware
---

# Rails Middleware

> Middleware with Rails. rack middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Middleware
...
## Ресурсы
- Оригинальный навык: `backend/rails-middleware/SKILL.md`
