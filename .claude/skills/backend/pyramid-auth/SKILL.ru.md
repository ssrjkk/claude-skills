...
version: "1.0"
language: ru
original: pyramid-auth
---

# Pyramid Auth

> Authentication with Pyramid. user auth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Auth
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-auth/SKILL.md`
