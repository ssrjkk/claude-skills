...
version: "1.0"
language: ru
original: starlette-database
---

# Starlette Database

> Database with Starlette. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Database
...
## Ресурсы
- Оригинальный навык: `backend/starlette-database/SKILL.md`
