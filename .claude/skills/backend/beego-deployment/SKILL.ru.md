...
version: "1.0"
language: ru
original: beego-deployment
---

# Beego Deployment

> Deployment with Beego. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `beego-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Beego Deployment
...
## Ресурсы
- Оригинальный навык: `backend/beego-deployment/SKILL.md`
