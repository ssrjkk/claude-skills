...
version: "1.0"
language: ru
original: feathers-testing
---

# Feathers Testing

> Testing with FeathersJS. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Testing
...
## Ресурсы
- Оригинальный навык: `backend/feathers-testing/SKILL.md`
