...
> Configuration with Erlang. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Config
...
## Ресурсы
- Оригинальный навык: `backend/erlang-config/SKILL.md`
