...
version: "1.0"
language: ru
original: starlette-websocket
---

# Starlette Websocket

> WebSocket with Starlette. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Websocket
...
## Ресурсы
- Оригинальный навык: `backend/starlette-websocket/SKILL.md`
