...
version: "1.0"
language: ru
original: buffalo-config
---

# Buffalo Config

> Config with Buffalo. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Config
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-config/SKILL.md`
