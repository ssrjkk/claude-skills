...
version: "1.0"
language: ru
original: microservices-scaling
---

# Microservices Scaling

> Scaling with Microservices. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microservices-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Microservices Scaling
...
## Ресурсы
- Оригинальный навык: `backend/microservices-scaling/SKILL.md`
