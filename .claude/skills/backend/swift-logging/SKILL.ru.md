...
version: "1.0"
language: ru
original: swift-logging
---

# Swift Logging

> Logging with Swift. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Logging
...
## Ресурсы
- Оригинальный навык: `backend/swift-logging/SKILL.md`
