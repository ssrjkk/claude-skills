...
category: backend
tags: [gin-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gin-config
...
> Config with Gin. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Config
...
## Ресурсы
- Оригинальный навык: `backend/gin-config/SKILL.md`
