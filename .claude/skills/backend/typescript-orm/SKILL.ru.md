...
category: backend
tags: [typescript-orm, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: typescript-orm
---

# Typescript Orm

> ORM with Typescript. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Orm
...
## Ресурсы
- Оригинальный навык: `backend/typescript-orm/SKILL.md`
