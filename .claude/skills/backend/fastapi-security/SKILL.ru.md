...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-security`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Security
...
## Ресурсы
- Оригинальный навык: backend/fastapi-security/SKILL.md
