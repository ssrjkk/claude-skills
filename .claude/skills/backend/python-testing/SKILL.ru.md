...
> Testing with Python. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `python-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Testing
...
## Ресурсы
- Оригинальный навык: `backend/python-testing/SKILL.md`
