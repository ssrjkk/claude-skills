...
category: backend
tags: [sanic-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sanic-testing
---

# Sanic Testing

> Testing with Sanic. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Testing
...
## Ресурсы
- Оригинальный навык: `backend/sanic-testing/SKILL.md`
