...
version: "1.0"
language: ru
original: go-cli-tool
---

# Go Cli Tool

> CLI Tool with Go. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/go-cli-tool/SKILL.md`
