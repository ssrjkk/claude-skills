...
category: backend
tags: [flask-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Api
...
## Ресурсы
- Оригинальный навык: backend/flask-api/SKILL.md
