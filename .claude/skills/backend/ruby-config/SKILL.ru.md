...
category: backend
tags: [ruby-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ruby-config
---

# Ruby Config

> Configuration with Ruby. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Config
...
## Ресурсы
- Оригинальный навык: `backend/ruby-config/SKILL.md`
