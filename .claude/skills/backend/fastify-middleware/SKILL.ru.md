...
version: "1.0"
language: ru
original: fastify-middleware
---

# Fastify Middleware

> Middleware with Fastify. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Middleware
...
## Ресурсы
- Оригинальный навык: `backend/fastify-middleware/SKILL.md`
