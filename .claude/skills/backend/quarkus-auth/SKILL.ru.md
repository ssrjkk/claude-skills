...
version: "1.0"
language: ru
original: quarkus-auth
---

# Quarkus Auth

> Auth with Quarkus. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Auth
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-auth/SKILL.md`
