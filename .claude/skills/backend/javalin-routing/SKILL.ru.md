...
## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Routing
...
## Ресурсы
- Оригинальный навык: `backend/javalin-routing/SKILL.md`
