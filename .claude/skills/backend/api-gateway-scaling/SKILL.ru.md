...
version: "1.0"
language: ru
original: api-gateway-scaling
---

# Api Gateway Scaling

> Scaling with API Gateway. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-gateway-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Api Gateway Scaling
...
## Ресурсы
- Оригинальный навык: `backend/api-gateway-scaling/SKILL.md`
