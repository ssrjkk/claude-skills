---
name: rust-rest-api
description: "REST API with Rust. building REST APIs."
category: backend
tags: [rust-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rust-rest-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/rust-rest-api/SKILL.md`
