...
version: "1.0"
language: ru
original: fiber-routing
---

# Fiber Routing

> Routing with Fiber. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fiber-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fiber Routing
...
## Ресурсы
- Оригинальный навык: `backend/fiber-routing/SKILL.md`
