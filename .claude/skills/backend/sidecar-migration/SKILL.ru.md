...
category: backend
tags: [sidecar-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sidecar-migration
---

# Sidecar Migration

> Migration with Sidecar. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sidecar-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sidecar Migration
...
## Ресурсы
- Оригинальный навык: `backend/sidecar-migration/SKILL.md`
