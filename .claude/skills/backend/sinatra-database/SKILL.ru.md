...
version: "1.0"
language: ru
original: sinatra-database
---

# Sinatra Database

> Database with Sinatra. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Database
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-database/SKILL.md`
