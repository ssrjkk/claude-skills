...
version: "1.0"
language: ru
original: cqrs-scaling
---

# Cqrs Scaling

> Scaling with CQRS. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cqrs-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cqrs Scaling
...
## Ресурсы
- Оригинальный навык: `backend/cqrs-scaling/SKILL.md`
