...
category: backend
tags: [tide-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tide-async
...
> Async with Tide. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Async
...
## Ресурсы
- Оригинальный навык: `backend/tide-async/SKILL.md`
