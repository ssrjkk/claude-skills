...
version: "1.0"
language: ru
original: clojure-logging
---

# Clojure Logging

> Logging with Clojure. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Logging
...
## Ресурсы
- Оригинальный навык: `backend/clojure-logging/SKILL.md`
