...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bff-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bff Scaling
...
## Ресурсы
- Оригинальный навык: `backend/bff-scaling/SKILL.md`
