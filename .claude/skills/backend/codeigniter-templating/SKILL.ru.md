...
version: "1.0"
language: ru
original: codeigniter-templating
---

# Codeigniter Templating

> Templating with CodeIgniter. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Templating
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-templating/SKILL.md`
