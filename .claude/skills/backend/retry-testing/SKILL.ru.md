...
category: backend
tags: [retry-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: retry-testing
---

# Retry Testing

> Testing with Retry. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `retry-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Retry Testing
...
## Ресурсы
- Оригинальный навык: `backend/retry-testing/SKILL.md`
