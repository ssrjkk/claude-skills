...
category: backend
tags: [symfony-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: symfony-routing
---

# Symfony Routing

> Routing with Symfony. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Routing
...
## Ресурсы
- Оригинальный навык: `backend/symfony-routing/SKILL.md`
