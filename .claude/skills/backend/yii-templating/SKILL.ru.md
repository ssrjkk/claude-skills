...
category: backend
tags: [yii-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: yii-templating
---

# Yii Templating

> Templating with Yii. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Templating
...
## Ресурсы
- Оригинальный навык: `backend/yii-templating/SKILL.md`
