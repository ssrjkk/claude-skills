...
category: backend
tags: [api-gateway-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: api-gateway-intro
---

# Api Gateway Intro

> Introduction with API Gateway. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-gateway-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Api Gateway Intro
...
## Ресурсы
- Оригинальный навык: `backend/api-gateway-intro/SKILL.md`
