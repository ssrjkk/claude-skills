...
version: "1.0"
language: ru
original: sanic-database
---

# Sanic Database

> Database with Sanic. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Database
...
## Ресурсы
- Оригинальный навык: `backend/sanic-database/SKILL.md`
