...
> Async with Warp. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `warp-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Warp Async
...
## Ресурсы
- Оригинальный навык: `backend/warp-async/SKILL.md`
