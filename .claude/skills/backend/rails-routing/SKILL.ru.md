...
version: "1.0"
language: ru
original: rails-routing
---

# Rails Routing

> Routing with Rails. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Routing
...
## Ресурсы
- Оригинальный навык: `backend/rails-routing/SKILL.md`
