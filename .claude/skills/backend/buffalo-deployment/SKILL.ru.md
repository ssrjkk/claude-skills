...
version: "1.0"
language: ru
original: buffalo-deployment
---

# Buffalo Deployment

> Deployment with Buffalo. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Deployment
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-deployment/SKILL.md`
