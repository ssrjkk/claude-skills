...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-optimization`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Optimization
...
## Ресурсы
- Оригинальный навык: backend/flask-optimization/SKILL.md
