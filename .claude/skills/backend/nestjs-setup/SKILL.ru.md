...
category: backend
tags: [nestjs-setup, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-setup`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Setup
...
## Ресурсы
- Оригинальный навык: backend/nestjs-setup/SKILL.md
