...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Websocket
...
## Ресурсы
- Оригинальный навык: `backend/fastapi-websocket/SKILL.md`
