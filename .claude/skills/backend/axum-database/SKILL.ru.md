...
category: backend
tags: [axum-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: axum-database
---

# Axum Database

> Database with Axum. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Database
...
## Ресурсы
- Оригинальный навык: `backend/axum-database/SKILL.md`
