...
category: backend
tags: [rails-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rails-database
---

# Rails Database

> Database with Rails. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Database
...
## Ресурсы
- Оригинальный навык: `backend/rails-database/SKILL.md`
