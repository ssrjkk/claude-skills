...
version: "1.0"
language: ru
original: axum-routing
---

# Axum Routing

> Routing with Axum. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Routing
...
## Ресурсы
- Оригинальный навык: `backend/axum-routing/SKILL.md`
