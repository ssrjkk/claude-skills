...
version: "1.0"
language: ru
original: dropwizard-testing
---

# Dropwizard Testing

> Testing with Dropwizard. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dropwizard-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dropwizard Testing
...
## Ресурсы
- Оригинальный навык: `backend/dropwizard-testing/SKILL.md`
