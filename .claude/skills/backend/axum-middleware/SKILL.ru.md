...
version: "1.0"
language: ru
original: axum-middleware
---

# Axum Middleware

> Middleware with Axum. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Middleware
...
## Ресурсы
- Оригинальный навык: `backend/axum-middleware/SKILL.md`
