...
category: backend
tags: [hono-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-templating
---

# Hono Templating

> Templating with Hono. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Templating
...
## Ресурсы
- Оригинальный навык: `backend/hono-templating/SKILL.md`
