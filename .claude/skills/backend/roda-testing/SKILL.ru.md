...
version: "1.0"
language: ru
original: roda-testing
---

# Roda Testing

> Testing with Roda. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roda-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Roda Testing
...
## Ресурсы
- Оригинальный навык: `backend/roda-testing/SKILL.md`
