...
version: "1.0"
language: ru
original: axum-websocket
---

# Axum Websocket

> WebSocket with Axum. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Websocket
...
## Ресурсы
- Оригинальный навык: `backend/axum-websocket/SKILL.md`
