...
version: "1.0"
language: ru
original: tide-routing
---

# Tide Routing

> Routing with Tide. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Routing
...
## Ресурсы
- Оригинальный навык: `backend/tide-routing/SKILL.md`
