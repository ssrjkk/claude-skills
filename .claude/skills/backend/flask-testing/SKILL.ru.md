...
category: backend
tags: [flask-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-testing
---

# Flask Testing

> Testing with Flask. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Testing
...
## Ресурсы
- Оригинальный навык: `backend/flask-testing/SKILL.md`
