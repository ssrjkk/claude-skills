...
version: "1.0"
language: ru
original: slim-middleware
---

# Slim Middleware

> Middleware with Slim. pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Middleware
...
## Ресурсы
- Оригинальный навык: `backend/slim-middleware/SKILL.md`
