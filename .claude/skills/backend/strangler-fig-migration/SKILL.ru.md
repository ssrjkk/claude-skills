...
category: backend
tags: [strangler-fig-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strangler-fig-migration
---

# Strangler Fig Migration

> Migration with Strangler Fig. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strangler-fig-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strangler Fig Migration
...
## Ресурсы
- Оригинальный навык: `backend/strangler-fig-migration/SKILL.md`
