...
## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/haskell-rest-api/SKILL.md`
