...
version: "1.0"
language: ru
original: spring-boot-database
---

# Spring Boot Database

> Database with Spring Boot. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Database
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-database/SKILL.md`
