...
version: "1.0"
language: ru
original: strategy-migration
---

# Strategy Migration

> Migration with Strategy. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strategy-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strategy Migration
...
## Ресурсы
- Оригинальный навык: `backend/strategy-migration/SKILL.md`
