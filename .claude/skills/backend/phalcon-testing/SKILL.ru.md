...
category: backend
tags: [phalcon-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: phalcon-testing
---

# Phalcon Testing

> Testing with Phalcon. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Testing
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-testing/SKILL.md`
