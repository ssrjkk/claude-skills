...
version: "1.0"
language: ru
original: fastify-websocket
---

# Fastify Websocket

> WebSocket with Fastify. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Websocket
...
## Ресурсы
- Оригинальный навык: `backend/fastify-websocket/SKILL.md`
