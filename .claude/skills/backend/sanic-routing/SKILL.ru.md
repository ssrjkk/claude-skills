...
version: "1.0"
language: ru
original: sanic-routing
---

# Sanic Routing

> Routing with Sanic. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Routing
...
## Ресурсы
- Оригинальный навык: `backend/sanic-routing/SKILL.md`
