...
version: "1.0"
language: ru
original: ruby-error-handling
---

# Ruby Error Handling

> Error Handling with Ruby. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/ruby-error-handling/SKILL.md`
