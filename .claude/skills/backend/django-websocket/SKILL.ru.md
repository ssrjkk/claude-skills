...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Websocket
...
## Ресурсы
- Оригинальный навык: `backend/django-websocket/SKILL.md`
