...
version: "1.0"
language: ru
original: nestjs-templating
---

# Nestjs Templating

> Templating with NestJS. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Templating
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-templating/SKILL.md`
