...
category: backend
tags: [buffalo-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: buffalo-templating
---

# Buffalo Templating

> Templating with Buffalo. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Templating
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-templating/SKILL.md`
