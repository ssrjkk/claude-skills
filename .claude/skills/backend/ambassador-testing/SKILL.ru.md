...
version: "1.0"
language: ru
original: ambassador-testing
---

# Ambassador Testing

> Testing with Ambassador. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ambassador-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ambassador Testing
...
## Ресурсы
- Оригинальный навык: `backend/ambassador-testing/SKILL.md`
