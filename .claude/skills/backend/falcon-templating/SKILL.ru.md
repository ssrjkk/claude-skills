...
category: backend
tags: [falcon-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falcon-templating
---

# Falcon Templating

> Templating with Falcon. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Templating
...
## Ресурсы
- Оригинальный навык: `backend/falcon-templating/SKILL.md`
