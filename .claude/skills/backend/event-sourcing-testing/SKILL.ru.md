...
version: "1.0"
language: ru
original: event-sourcing-testing
---

# Event Sourcing Testing

> Testing with Event Sourcing. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-sourcing-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Event Sourcing Testing
...
## Ресурсы
- Оригинальный навык: `backend/event-sourcing-testing/SKILL.md`
