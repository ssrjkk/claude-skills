...
category: backend
tags: [rocket-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rocket-testing
---

# Rocket Testing

> Testing with Rocket. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Testing
...
## Ресурсы
- Оригинальный навык: `backend/rocket-testing/SKILL.md`
