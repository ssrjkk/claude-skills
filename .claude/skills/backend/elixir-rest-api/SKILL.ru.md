...
version: "1.0"
language: ru
original: elixir-rest-api
---

# Elixir Rest Api

> REST API with Elixir. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/elixir-rest-api/SKILL.md`
