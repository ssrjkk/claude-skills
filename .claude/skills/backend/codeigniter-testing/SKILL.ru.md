...
version: "1.0"
language: ru
original: codeigniter-testing
---

# Codeigniter Testing

> Testing with CodeIgniter. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Testing
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-testing/SKILL.md`
