...
version: "1.0"
language: ru
original: cuba-database
---

# Cuba Database

> Database with Cuba. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Database
...
## Ресурсы
- Оригинальный навык: `backend/cuba-database/SKILL.md`
