...
category: backend
tags: [rocket-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rocket-routing
---

# Rocket Routing

> Routing with Rocket. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Routing
...
## Ресурсы
- Оригинальный навык: `backend/rocket-routing/SKILL.md`
