...
category: backend
tags: [typescript-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: typescript-config
---

# Typescript Config

> Configuration with Typescript. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Config
...
## Ресурсы
- Оригинальный навык: `backend/typescript-config/SKILL.md`
