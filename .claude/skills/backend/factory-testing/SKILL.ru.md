...
category: backend
tags: [factory-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Testing with Factory. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `factory-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Factory Testing
...
## Ресурсы
- Оригинальный навык: `backend/factory-testing/SKILL.md`
