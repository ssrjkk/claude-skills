...
version: "1.0"
language: ru
original: zig-logging
---

# Zig Logging

> Logging with Zig. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Logging
...
## Ресурсы
- Оригинальный навык: `backend/zig-logging/SKILL.md`
