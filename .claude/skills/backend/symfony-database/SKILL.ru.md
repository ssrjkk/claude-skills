...
version: "1.0"
language: ru
original: symfony-database
---

# Symfony Database

> Database with Symfony. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Database
...
## Ресурсы
- Оригинальный навык: `backend/symfony-database/SKILL.md`
