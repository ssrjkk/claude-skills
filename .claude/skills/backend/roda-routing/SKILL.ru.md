...
category: backend
tags: [roda-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: roda-routing
---

# Roda Routing

> Routing with Roda. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roda-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Roda Routing
...
## Ресурсы
- Оригинальный навык: `backend/roda-routing/SKILL.md`
