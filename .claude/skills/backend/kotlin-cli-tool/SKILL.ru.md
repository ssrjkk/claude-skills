...
category: backend
tags: [kotlin-cli-tool, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-cli-tool
---

# Kotlin Cli Tool

> CLI Tool with Kotlin. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-cli-tool/SKILL.md`
