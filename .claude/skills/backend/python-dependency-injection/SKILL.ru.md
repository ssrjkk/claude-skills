...
version: "1.0"
language: ru
original: python-dependency-injection
---

# Python Dependency Injection

> DI with Python. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `python-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/python-dependency-injection/SKILL.md`
