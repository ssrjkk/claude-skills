...
category: backend
tags: [express-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: express-database
---

# Express Database

> Database with Express. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Database
...
## Ресурсы
- Оригинальный навык: `backend/express-database/SKILL.md`
