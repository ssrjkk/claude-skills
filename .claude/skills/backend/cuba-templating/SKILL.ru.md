...
category: backend
tags: [cuba-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cuba-templating
---

# Cuba Templating

> Templating with Cuba. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Templating
...
## Ресурсы
- Оригинальный навык: `backend/cuba-templating/SKILL.md`
