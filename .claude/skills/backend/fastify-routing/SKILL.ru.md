...
version: "1.0"
language: ru
original: fastify-routing
---

# Fastify Routing

> Routing with Fastify. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Routing
...
## Ресурсы
- Оригинальный навык: `backend/fastify-routing/SKILL.md`
