...
version: "1.0"
language: ru
original: haskell-logging
---

# Haskell Logging

> Logging with Haskell. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Logging
...
## Ресурсы
- Оригинальный навык: `backend/haskell-logging/SKILL.md`
