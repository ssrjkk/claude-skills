...
version: "1.0"
language: ru
original: cqrs-migration
---

# Cqrs Migration

> Migration with CQRS. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cqrs-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cqrs Migration
...
## Ресурсы
- Оригинальный навык: `backend/cqrs-migration/SKILL.md`
