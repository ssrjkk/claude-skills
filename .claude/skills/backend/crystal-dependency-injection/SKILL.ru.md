...
version: "1.0"
language: ru
original: crystal-dependency-injection
---

# Crystal Dependency Injection

> DI with Crystal. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/crystal-dependency-injection/SKILL.md`
