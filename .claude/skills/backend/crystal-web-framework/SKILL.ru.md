...
version: "1.0"
language: ru
original: crystal-web-framework
---

# Crystal Web Framework

> Web Framework with Crystal. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/crystal-web-framework/SKILL.md`
