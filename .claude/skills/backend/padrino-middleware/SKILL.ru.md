...
version: "1.0"
language: ru
original: padrino-middleware
---

# Padrino Middleware

> Middleware with Padrino. rack middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `padrino-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Padrino Middleware
...
## Ресурсы
- Оригинальный навык: `backend/padrino-middleware/SKILL.md`
