...
category: backend
tags: [erlang-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: erlang-rest-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/erlang-rest-api/SKILL.md`
