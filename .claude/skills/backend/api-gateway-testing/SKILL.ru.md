...
category: backend
tags: [api-gateway-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: api-gateway-testing
---

# Api Gateway Testing

> Testing with API Gateway. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-gateway-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Api Gateway Testing
...
## Ресурсы
- Оригинальный навык: `backend/api-gateway-testing/SKILL.md`
