...
category: backend
tags: [nginx-fundamentals, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nginx-fundamentals
---

# Nginx Fundamentals

> Fundamentals for Nginx: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nginx-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nginx Fundamentals
...
## Ресурсы
- Оригинал: backend/nginx-fundamentals/SKILL.md
