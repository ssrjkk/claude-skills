...
version: "1.0"
language: ru
original: sanic-websocket
---

# Sanic Websocket

> WebSocket with Sanic. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Websocket
...
## Ресурсы
- Оригинальный навык: `backend/sanic-websocket/SKILL.md`
