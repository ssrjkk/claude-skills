...
version: "1.0"
language: ru
original: drizzle-integration
---

# Drizzle Integration

> Integration for Drizzle: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: drizzle-integration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Drizzle Integration
...
## Ресурсы
- backend/drizzle-integration/SKILL.md
