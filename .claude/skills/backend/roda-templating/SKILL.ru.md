...
version: "1.0"
language: ru
original: roda-templating
---

# Roda Templating

> Templating with Roda. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roda-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Roda Templating
...
## Ресурсы
- Оригинальный навык: `backend/roda-templating/SKILL.md`
