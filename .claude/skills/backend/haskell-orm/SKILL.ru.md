...
version: "1.0"
language: ru
original: haskell-orm
---

# Haskell Orm

> ORM with Haskell. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Orm
...
## Ресурсы
- Оригинальный навык: `backend/haskell-orm/SKILL.md`
