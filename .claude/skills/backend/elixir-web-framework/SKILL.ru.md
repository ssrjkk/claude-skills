...
version: "1.0"
language: ru
original: elixir-web-framework
---

# Elixir Web Framework

> Web Framework with Elixir. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/elixir-web-framework/SKILL.md`
