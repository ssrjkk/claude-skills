...
category: backend
tags: [crystal-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crystal-async
---

# Crystal Async

> Async with Crystal. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Async
...
## Ресурсы
- Оригинальный навык: `backend/crystal-async/SKILL.md`
