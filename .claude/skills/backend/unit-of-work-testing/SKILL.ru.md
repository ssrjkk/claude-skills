...
category: backend
tags: [unit-of-work-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unit-of-work-testing
---

# Unit Of Work Testing

> Testing with Unit of Work. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unit-of-work-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Unit Of Work Testing
...
## Ресурсы
- Оригинальный навык: `backend/unit-of-work-testing/SKILL.md`
