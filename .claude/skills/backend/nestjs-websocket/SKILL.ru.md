...
version: "1.0"
language: ru
original: nestjs-websocket
---

# Nestjs Websocket

> WebSocket with NestJS. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Websocket
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-websocket/SKILL.md`
