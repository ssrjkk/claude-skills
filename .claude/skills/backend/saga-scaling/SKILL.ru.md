...
version: "1.0"
language: ru
original: saga-scaling
---

# Saga Scaling

> Scaling with Saga. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saga-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Saga Scaling
...
## Ресурсы
- Оригинальный навык: `backend/saga-scaling/SKILL.md`
