...
category: backend
tags: [poem-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: poem-deployment
---

# Poem Deployment

> Deployment with Poem. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Deployment
...
## Ресурсы
- Оригинальный навык: `backend/poem-deployment/SKILL.md`
