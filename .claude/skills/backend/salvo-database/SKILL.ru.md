...
category: backend
tags: [salvo-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: salvo-database
---

# Salvo Database

> Database with Salvo. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Database
...
## Ресурсы
- Оригинальный навык: `backend/salvo-database/SKILL.md`
