...
category: backend
tags: [csharp-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: csharp-dependency-injection
---

# Csharp Dependency Injection

> DI with Csharp. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csharp-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Csharp Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/csharp-dependency-injection/SKILL.md`
