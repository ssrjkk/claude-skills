...
version: "1.0"
language: ru
original: nim-testing
---

# Nim Testing

> Testing with Nim. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nim-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nim Testing
...
## Ресурсы
- Оригинальный навык: `backend/nim-testing/SKILL.md`
