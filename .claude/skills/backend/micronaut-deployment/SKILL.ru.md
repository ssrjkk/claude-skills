...
version: "1.0"
language: ru
original: micronaut-deployment
---

# Micronaut Deployment

> Deployment with Micronaut. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Deployment
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-deployment/SKILL.md`
