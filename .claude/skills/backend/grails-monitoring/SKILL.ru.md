...
version: "1.0"
language: ru
original: grails-monitoring
---

# Grails Monitoring

> Monitoring with Grails. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/grails-monitoring/SKILL.md`
