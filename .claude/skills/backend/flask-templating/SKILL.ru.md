...
version: "1.0"
language: ru
original: flask-templating
---

# Flask Templating

> Templating with Flask. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Templating
...
## Ресурсы
- Оригинальный навык: `backend/flask-templating/SKILL.md`
