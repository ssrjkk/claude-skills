...
version: "1.0"
language: ru
original: quarkus-config
---

# Quarkus Config

> Config with Quarkus. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Config
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-config/SKILL.md`
