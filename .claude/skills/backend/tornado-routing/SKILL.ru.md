...
category: backend
tags: [tornado-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tornado-routing
---

# Tornado Routing

> Routing with Tornado. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Routing
...
## Ресурсы
- Оригинальный навык: `backend/tornado-routing/SKILL.md`
