...
version: "1.0"
language: ru
original: nim-logging
---

# Nim Logging

> Logging with Nim. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nim-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nim Logging
...
## Ресурсы
- Оригинальный навык: `backend/nim-logging/SKILL.md`
