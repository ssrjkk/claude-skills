...
category: backend
tags: [padrino-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: padrino-deployment
---

# Padrino Deployment

> Deployment with Padrino. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `padrino-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Padrino Deployment
...
## Ресурсы
- Оригинальный навык: `backend/padrino-deployment/SKILL.md`
