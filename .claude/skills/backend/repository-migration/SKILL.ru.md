...
> Migration with Repository. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `repository-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Repository Migration
...
## Ресурсы
- Оригинальный навык: `backend/repository-migration/SKILL.md`
