...
category: backend
tags: [quarkus-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: quarkus-deployment
---

# Quarkus Deployment

> Deployment with Quarkus. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Deployment
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-deployment/SKILL.md`
