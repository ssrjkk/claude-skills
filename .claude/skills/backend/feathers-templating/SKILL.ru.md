...
## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Templating
...
## Ресурсы
- Оригинальный навык: `backend/feathers-templating/SKILL.md`
