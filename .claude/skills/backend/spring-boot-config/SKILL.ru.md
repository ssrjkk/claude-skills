...
category: backend
tags: [spring-boot-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Config with Spring Boot. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Config
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-config/SKILL.md`
