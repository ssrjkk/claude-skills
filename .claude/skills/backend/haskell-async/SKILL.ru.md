...
category: backend
tags: [haskell-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haskell-async
---

# Haskell Async

> Async with Haskell. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Async
...
## Ресурсы
- Оригинальный навык: `backend/haskell-async/SKILL.md`
