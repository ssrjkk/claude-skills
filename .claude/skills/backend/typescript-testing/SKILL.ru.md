...
version: "1.0"
language: ru
original: typescript-testing
---

# Typescript Testing

> Testing with Typescript. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Testing
...
## Ресурсы
- Оригинальный навык: `backend/typescript-testing/SKILL.md`
