...
category: backend
tags: [aspnet-core, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aspnet-core
---

# Aspnet Core

> Builds web APIs and applications with ASP.NET Core, controllers, Entity Framework, and middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aspnet-core`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aspnet Core
...
## Ресурсы
- Оригинальный навык: `backend/aspnet-core/SKILL.md`
