...
version: "1.0"
language: ru
original: tornado-database
---

# Tornado Database

> Database with Tornado. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Database
...
## Ресурсы
- Оригинальный навык: `backend/tornado-database/SKILL.md`
