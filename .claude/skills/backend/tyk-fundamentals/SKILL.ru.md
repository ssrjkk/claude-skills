...
version: "1.0"
language: ru
original: tyk-fundamentals
---

# Tyk Fundamentals

> Fundamentals for Tyk: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tyk-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tyk Fundamentals
...
## Ресурсы
- Оригинал: backend/tyk-fundamentals/SKILL.md
