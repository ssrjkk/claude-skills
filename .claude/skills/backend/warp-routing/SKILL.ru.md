...
version: "1.0"
language: ru
original: warp-routing
---

# Warp Routing

> Routing with Warp. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `warp-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Warp Routing
...
## Ресурсы
- Оригинальный навык: `backend/warp-routing/SKILL.md`
