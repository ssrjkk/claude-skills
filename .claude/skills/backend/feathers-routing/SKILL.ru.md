...
category: backend
tags: [feathers-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: feathers-routing
---

# Feathers Routing

> Routing with FeathersJS. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Routing
...
## Ресурсы
- Оригинальный навык: `backend/feathers-routing/SKILL.md`
