...
version: "1.0"
language: ru
original: express-auth
---

# Express Auth

> Auth with Express. JWT.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Auth
...
## Ресурсы
- Оригинальный навык: `backend/express-auth/SKILL.md`
