...
category: backend
tags: [java-web-framework, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: java-web-framework
---

# Java Web Framework

> Web Framework with Java. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/java-web-framework/SKILL.md`
