...
version: "1.0"
language: ru
original: tide-websocket
---

# Tide Websocket

> WebSocket with Tide. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Websocket
...
## Ресурсы
- Оригинальный навык: `backend/tide-websocket/SKILL.md`
