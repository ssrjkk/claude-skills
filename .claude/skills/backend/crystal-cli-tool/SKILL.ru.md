...
version: "1.0"
language: ru
original: crystal-cli-tool
---

# Crystal Cli Tool

> CLI Tool with Crystal. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/crystal-cli-tool/SKILL.md`
