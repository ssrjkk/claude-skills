...
version: "1.0"
language: ru
original: ruby-testing
---

# Ruby Testing

> Testing with Ruby. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Testing
...
## Ресурсы
- Оригинальный навык: `backend/ruby-testing/SKILL.md`
