...
category: backend
tags: [php-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: php-testing
---

# Php Testing

> Testing with Php. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `php-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Php Testing
...
## Ресурсы
- Оригинальный навык: `backend/php-testing/SKILL.md`
