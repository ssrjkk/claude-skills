...
version: "1.0"
language: ru
original: clojure-orm
---

# Clojure Orm

> ORM with Clojure. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Orm
...
## Ресурсы
- Оригинальный навык: `backend/clojure-orm/SKILL.md`
