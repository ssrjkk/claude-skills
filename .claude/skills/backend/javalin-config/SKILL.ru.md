...
## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Config
...
## Ресурсы
- Оригинальный навык: `backend/javalin-config/SKILL.md`
