...
category: backend
tags: [pyramid-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pyramid-testing
---

# Pyramid Testing

> Testing with Pyramid. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Testing
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-testing/SKILL.md`
