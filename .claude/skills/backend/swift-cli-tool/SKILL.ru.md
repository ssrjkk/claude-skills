...
version: "1.0"
language: ru
original: swift-cli-tool
---

# Swift Cli Tool

> CLI Tool with Swift. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/swift-cli-tool/SKILL.md`
