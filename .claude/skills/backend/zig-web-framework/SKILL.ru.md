...
version: "1.0"
language: ru
original: zig-web-framework
---

# Zig Web Framework

> Web Framework with Zig. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/zig-web-framework/SKILL.md`
