...
version: "1.0"
language: ru
original: laravel-database
---

# Laravel Database

> Database with Laravel. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laravel-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laravel Database
...
## Ресурсы
- Оригинальный навык: `backend/laravel-database/SKILL.md`
