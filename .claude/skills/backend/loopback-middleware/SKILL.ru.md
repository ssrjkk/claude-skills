...
category: backend
tags: [loopback-middleware, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: loopback-middleware
---

# Loopback Middleware

> Middleware with LoopBack. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Middleware
...
## Ресурсы
- Оригинальный навык: `backend/loopback-middleware/SKILL.md`
