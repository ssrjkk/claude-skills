...
category: backend
tags: [java-logging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Logging with Java. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Logging
...
## Ресурсы
- Оригинальный навык: `backend/java-logging/SKILL.md`
