...
category: backend
tags: [clojure-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clojure-dependency-injection
---

# Clojure Dependency Injection

> DI with Clojure. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/clojure-dependency-injection/SKILL.md`
