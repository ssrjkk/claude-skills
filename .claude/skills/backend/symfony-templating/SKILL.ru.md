...
category: backend
tags: [symfony-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: symfony-templating
---

# Symfony Templating

> Templating with Symfony. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Templating
...
## Ресурсы
- Оригинальный навык: `backend/symfony-templating/SKILL.md`
