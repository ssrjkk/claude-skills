...
category: backend
tags: [python-error-handling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Error Handling with Python. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `python-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/python-error-handling/SKILL.md`
