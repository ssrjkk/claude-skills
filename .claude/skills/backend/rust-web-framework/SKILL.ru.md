...
category: backend
tags: [rust-web-framework, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rust-web-framework
---

# Rust Web Framework

> Web Framework with Rust. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/rust-web-framework/SKILL.md`
