...
category: backend
tags: [django-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: django-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Basics
...
## Ресурсы
- Оригинальный навык: backend/django-basics/SKILL.md
