...
category: backend
tags: [adonisjs-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adonisjs-testing
---

# Adonisjs Testing

> Testing with AdonisJS. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adonisjs-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adonisjs Testing
...
## Ресурсы
- Оригинальный навык: `backend/adonisjs-testing/SKILL.md`
