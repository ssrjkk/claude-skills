...
category: backend
tags: [swift-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-dependency-injection
---

# Swift Dependency Injection

> DI with Swift. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/swift-dependency-injection/SKILL.md`
