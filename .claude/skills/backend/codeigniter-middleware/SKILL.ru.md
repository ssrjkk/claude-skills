...
version: "1.0"
language: ru
original: codeigniter-middleware
---

# Codeigniter Middleware

> Middleware with CodeIgniter. pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Middleware
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-middleware/SKILL.md`
