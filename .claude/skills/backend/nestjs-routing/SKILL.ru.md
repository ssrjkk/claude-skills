...
category: backend
tags: [nestjs-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-routing
---

# Nestjs Routing

> Routing with NestJS. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Routing
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-routing/SKILL.md`
