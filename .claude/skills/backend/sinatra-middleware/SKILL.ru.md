...
version: "1.0"
language: ru
original: sinatra-middleware
---

# Sinatra Middleware

> Middleware with Sinatra. rack middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Middleware
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-middleware/SKILL.md`
