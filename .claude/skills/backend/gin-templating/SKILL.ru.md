...
version: "1.0"
language: ru
original: gin-templating
---

# Gin Templating

> Templating with Gin. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Templating
...
## Ресурсы
- Оригинальный навык: `backend/gin-templating/SKILL.md`
