...
version: "1.0"
language: ru
original: gin-middleware
---

# Gin Middleware

> Middleware with Gin. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Middleware
...
## Ресурсы
- Оригинальный навык: `backend/gin-middleware/SKILL.md`
