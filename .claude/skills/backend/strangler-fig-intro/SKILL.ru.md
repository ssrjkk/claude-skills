...
version: "1.0"
language: ru
original: strangler-fig-intro
---

# Strangler Fig Intro

> Introduction with Strangler Fig. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strangler-fig-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strangler Fig Intro
...
## Ресурсы
- Оригинальный навык: `backend/strangler-fig-intro/SKILL.md`
