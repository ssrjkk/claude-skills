...
version: "1.0"
language: ru
original: erlang-logging
---

# Erlang Logging

> Logging with Erlang. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Logging
...
## Ресурсы
- Оригинальный навык: `backend/erlang-logging/SKILL.md`
