...
category: backend
tags: [symfony-middleware, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: symfony-middleware
---

# Symfony Middleware

> Middleware with Symfony. pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Middleware
...
## Ресурсы
- Оригинальный навык: `backend/symfony-middleware/SKILL.md`
