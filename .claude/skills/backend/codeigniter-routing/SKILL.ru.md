...
version: "1.0"
language: ru
original: codeigniter-routing
---

# Codeigniter Routing

> Routing with CodeIgniter. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Routing
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-routing/SKILL.md`
