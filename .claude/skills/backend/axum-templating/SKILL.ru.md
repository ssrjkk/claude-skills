...
version: "1.0"
language: ru
original: axum-templating
---

# Axum Templating

> Templating with Axum. templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Templating
...
## Ресурсы
- Оригинальный навык: `backend/axum-templating/SKILL.md`
