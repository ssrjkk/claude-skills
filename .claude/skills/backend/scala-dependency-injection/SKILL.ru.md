...
version: "1.0"
language: ru
original: scala-dependency-injection
---

# Scala Dependency Injection

> DI with Scala. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/scala-dependency-injection/SKILL.md`
