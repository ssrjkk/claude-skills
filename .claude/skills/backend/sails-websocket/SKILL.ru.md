...
category: backend
tags: [sails-websocket, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sails-websocket
---

# Sails Websocket

> WebSocket with Sails.js. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sails-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sails Websocket
...
## Ресурсы
- Оригинальный навык: `backend/sails-websocket/SKILL.md`
