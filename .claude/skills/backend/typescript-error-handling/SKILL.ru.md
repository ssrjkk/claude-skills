...
version: "1.0"
language: ru
original: typescript-error-handling
---

# Typescript Error Handling

> Error Handling with Typescript. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/typescript-error-handling/SKILL.md`
