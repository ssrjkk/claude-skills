...
version: "1.0"
language: ru
original: cakephp-deployment
---

# Cakephp Deployment

> Deployment with CakePHP. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Deployment
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-deployment/SKILL.md`
