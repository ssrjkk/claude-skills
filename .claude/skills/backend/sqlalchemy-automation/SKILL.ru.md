...
version: "1.0"
language: ru
original: sqlalchemy-automation
---

# Sqlalchemy Automation

> Automation for Sqlalchemy: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: sqlalchemy-automation.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sqlalchemy Automation
...
## Ресурсы
- backend/sqlalchemy-automation/SKILL.md
