...
category: backend
tags: [scala-orm, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scala-orm
...
> ORM with Scala. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Orm
...
## Ресурсы
- Оригинальный навык: `backend/scala-orm/SKILL.md`
