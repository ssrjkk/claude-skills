...
version: "1.0"
language: ru
original: nestjs-deployment
---

# Nestjs Deployment

> Deployment with NestJS. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Deployment
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-deployment/SKILL.md`
