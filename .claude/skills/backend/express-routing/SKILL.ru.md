...
> Routing with Express. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Routing
...
## Ресурсы
- Оригинальный навык: `backend/express-routing/SKILL.md`
