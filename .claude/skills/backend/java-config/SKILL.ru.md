...
category: backend
tags: [java-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: java-config
---

# Java Config

> Configuration with Java. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Config
...
## Ресурсы
- Оригинальный навык: `backend/java-config/SKILL.md`
