...
version: "1.0"
language: ru
original: repository-intro
---

# Repository Intro

> Introduction with Repository. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `repository-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Repository Intro
...
## Ресурсы
- Оригинальный навык: `backend/repository-intro/SKILL.md`
