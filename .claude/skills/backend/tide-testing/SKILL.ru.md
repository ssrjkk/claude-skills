...
category: backend
tags: [tide-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tide-testing
---

# Tide Testing

> Testing with Tide. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Testing
...
## Ресурсы
- Оригинальный навык: `backend/tide-testing/SKILL.md`
