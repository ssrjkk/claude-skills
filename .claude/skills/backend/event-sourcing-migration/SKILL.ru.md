...
version: "1.0"
language: ru
original: event-sourcing-migration
---

# Event Sourcing Migration

> Migration with Event Sourcing. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-sourcing-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Event Sourcing Migration
...
## Ресурсы
- Оригинальный навык: `backend/event-sourcing-migration/SKILL.md`
