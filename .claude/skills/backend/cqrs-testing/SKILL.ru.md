...
category: backend
tags: [cqrs-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cqrs-testing
---

# Cqrs Testing

> Testing with CQRS. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cqrs-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cqrs Testing
...
## Ресурсы
- Оригинальный навык: `backend/cqrs-testing/SKILL.md`
