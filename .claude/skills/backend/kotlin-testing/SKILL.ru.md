...
category: backend
tags: [kotlin-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-testing
---

# Kotlin Testing

> Testing with Kotlin. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Testing
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-testing/SKILL.md`
