...
version: "1.0"
language: ru
original: phalcon-templating
---

# Phalcon Templating

> Templating with Phalcon. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Templating
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-templating/SKILL.md`
