...
version: "1.0"
language: ru
original: erlang-web-framework
---

# Erlang Web Framework

> Web Framework with Erlang. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/erlang-web-framework/SKILL.md`
