...
version: "1.0"
language: ru
original: adonisjs-database
---

# Adonisjs Database

> Database with AdonisJS. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adonisjs-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adonisjs Database
...
## Ресурсы
- Оригинальный навык: `backend/adonisjs-database/SKILL.md`
