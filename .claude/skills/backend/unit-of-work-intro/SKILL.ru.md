...
category: backend
tags: [unit-of-work-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unit-of-work-intro
---

# Unit Of Work Intro

> Introduction with Unit of Work. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unit-of-work-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Unit Of Work Intro
...
## Ресурсы
- Оригинальный навык: `backend/unit-of-work-intro/SKILL.md`
