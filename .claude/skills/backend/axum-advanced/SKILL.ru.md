...
category: backend
tags: [axum-advanced, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: axum-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Advanced
...
## Ресурсы
- Оригинальный навык: backend/axum-advanced/SKILL.md
