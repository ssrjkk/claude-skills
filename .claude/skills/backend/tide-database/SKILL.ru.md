...
version: "1.0"
language: ru
original: tide-database
---

# Tide Database

> Database with Tide. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Database
...
## Ресурсы
- Оригинальный навык: `backend/tide-database/SKILL.md`
