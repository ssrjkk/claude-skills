...
version: "1.0"
language: ru
original: typeorm-configuration
---

# Typeorm Configuration

> Configuration for Typeorm: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: typeorm-configuration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typeorm Configuration
...
## Ресурсы
- backend/typeorm-configuration/SKILL.md
