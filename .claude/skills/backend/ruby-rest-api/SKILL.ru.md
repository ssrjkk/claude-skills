...
category: backend
tags: [ruby-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ruby-rest-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/ruby-rest-api/SKILL.md`
