...
version: "1.0"
language: ru
original: falcon-auth
---

# Falcon Auth

> Authentication with Falcon. user auth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Auth
...
## Ресурсы
- Оригинальный навык: `backend/falcon-auth/SKILL.md`
