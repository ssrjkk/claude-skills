...
> Auth with Laravel. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laravel-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laravel Auth
...
## Ресурсы
- Оригинальный навык: `backend/laravel-auth/SKILL.md`
