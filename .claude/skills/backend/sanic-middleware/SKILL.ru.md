...
version: "1.0"
language: ru
original: sanic-middleware
---

# Sanic Middleware

> Middleware with Sanic. middleware pipelines.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Middleware
...
## Ресурсы
- Оригинальный навык: `backend/sanic-middleware/SKILL.md`
