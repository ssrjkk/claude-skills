...
category: backend
tags: [factory-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: factory-migration
---

# Factory Migration

> Migration with Factory. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `factory-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Factory Migration
...
## Ресурсы
- Оригинальный навык: `backend/factory-migration/SKILL.md`
