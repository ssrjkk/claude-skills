...
category: backend
tags: [sinatra-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sinatra-testing
---

# Sinatra Testing

> Testing with Sinatra. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Testing
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-testing/SKILL.md`
