...
category: backend
tags: [feathers-middleware, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: feathers-middleware
---

# Feathers Middleware

> Middleware with FeathersJS. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Middleware
...
## Ресурсы
- Оригинальный навык: `backend/feathers-middleware/SKILL.md`
