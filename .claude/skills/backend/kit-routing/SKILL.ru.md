...
category: backend
tags: [kit-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kit-routing
---

# Kit Routing

> Routing with Go Kit. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kit-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kit Routing
...
## Ресурсы
- Оригинальный навык: `backend/kit-routing/SKILL.md`
