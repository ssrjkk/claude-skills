...
category: backend
tags: [circuit-breaker-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: circuit-breaker-intro
---

# Circuit Breaker Intro

> Introduction with Circuit Breaker. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circuit-breaker-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Circuit Breaker Intro
...
## Ресурсы
- Оригинальный навык: `backend/circuit-breaker-intro/SKILL.md`
