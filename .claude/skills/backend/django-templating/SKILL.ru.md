...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Templating
...
## Ресурсы
- Оригинальный навык: `backend/django-templating/SKILL.md`
