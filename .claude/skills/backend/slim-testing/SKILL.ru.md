...
category: backend
tags: [slim-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: slim-testing
---

# Slim Testing

> Testing with Slim. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Testing
...
## Ресурсы
- Оригинальный навык: `backend/slim-testing/SKILL.md`
