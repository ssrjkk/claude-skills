...
version: "1.0"
language: ru
original: adapter-migration
---

# Adapter Migration

> Migration with Adapter. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adapter-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adapter Migration
...
## Ресурсы
- Оригинальный навык: `backend/adapter-migration/SKILL.md`
