...
category: backend
tags: [java-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: java-rest-api
---

# Java Rest Api

> REST API with Java. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/java-rest-api/SKILL.md`
