...
category: backend
tags: [go-web-framework, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: go-web-framework
---

# Go Web Framework

> Web Framework with Go. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/go-web-framework/SKILL.md`
