...
category: backend
tags: [dart-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dart-rest-api
---

# Dart Rest Api

> REST API with Dart. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/dart-rest-api/SKILL.md`
