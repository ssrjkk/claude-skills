...
version: "1.0"
language: ru
original: padrino-templating
---

# Padrino Templating

> Templating with Padrino. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `padrino-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Padrino Templating
...
## Ресурсы
- Оригинальный навык: `backend/padrino-templating/SKILL.md`
