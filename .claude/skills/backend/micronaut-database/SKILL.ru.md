...
version: "1.0"
language: ru
original: micronaut-database
---

# Micronaut Database

> Database with Micronaut. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Database
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-database/SKILL.md`
