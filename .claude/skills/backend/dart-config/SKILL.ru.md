...
version: "1.0"
language: ru
original: dart-config
---

# Dart Config

> Configuration with Dart. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Config
...
## Ресурсы
- Оригинальный навык: `backend/dart-config/SKILL.md`
