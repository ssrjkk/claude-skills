...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-optimization`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Optimization
...
## Ресурсы
- Оригинальный навык: backend/spring-optimization/SKILL.md
