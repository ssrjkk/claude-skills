...
version: "1.0"
language: ru
original: redis-integration
---

# Redis Integration

> Integration for Redis: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: redis-integration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Redis Integration
...
## Ресурсы
- backend/redis-integration/SKILL.md
