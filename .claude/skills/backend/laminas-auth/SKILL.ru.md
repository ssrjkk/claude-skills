...
version: "1.0"
language: ru
original: laminas-auth
---

# Laminas Auth

> Auth with Laminas. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Auth
...
## Ресурсы
- Оригинальный навык: `backend/laminas-auth/SKILL.md`
