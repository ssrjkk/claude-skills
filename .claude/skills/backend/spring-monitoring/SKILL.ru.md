...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Monitoring
...
## Ресурсы
- Оригинальный навык: backend/spring-monitoring/SKILL.md
