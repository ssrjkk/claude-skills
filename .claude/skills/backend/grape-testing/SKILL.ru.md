...
category: backend
tags: [grape-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-testing
---

# Grape Testing

> Testing with Grape. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Testing
...
## Ресурсы
- Оригинальный навык: `backend/grape-testing/SKILL.md`
