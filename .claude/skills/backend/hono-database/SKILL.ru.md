...
category: backend
tags: [hono-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-database
---

# Hono Database

> Database with Hono. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Database
...
## Ресурсы
- Оригинальный навык: `backend/hono-database/SKILL.md`
