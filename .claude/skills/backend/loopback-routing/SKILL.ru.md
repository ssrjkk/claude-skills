...
version: "1.0"
language: ru
original: loopback-routing
---

# Loopback Routing

> Routing with LoopBack. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Routing
...
## Ресурсы
- Оригинальный навык: `backend/loopback-routing/SKILL.md`
