...
category: backend
tags: [spring-debugging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-debugging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Debugging
...
## Ресурсы
- Оригинальный навык: backend/spring-debugging/SKILL.md
