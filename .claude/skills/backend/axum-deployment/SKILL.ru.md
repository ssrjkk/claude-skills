...
version: "1.0"
language: ru
original: axum-deployment
---

# Axum Deployment

> Deployment with Axum. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Deployment
...
## Ресурсы
- Оригинальный навык: `backend/axum-deployment/SKILL.md`
