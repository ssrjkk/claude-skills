...
version: "1.0"
language: ru
original: swift-web-framework
---

# Swift Web Framework

> Web Framework with Swift. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/swift-web-framework/SKILL.md`
