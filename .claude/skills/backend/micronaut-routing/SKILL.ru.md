...
category: backend
tags: [micronaut-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: micronaut-routing
---

# Micronaut Routing

> Routing with Micronaut. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Routing
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-routing/SKILL.md`
