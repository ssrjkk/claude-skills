...
category: backend
tags: [feathers-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: feathers-auth
---

# Feathers Auth

> Auth with FeathersJS. JWT.

## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Auth
...
## Ресурсы
- Оригинальный навык: `backend/feathers-auth/SKILL.md`
