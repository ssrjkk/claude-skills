...
version: "1.0"
language: ru
original: salvo-deployment
---

# Salvo Deployment

> Deployment with Salvo. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Deployment
...
## Ресурсы
- Оригинальный навык: `backend/salvo-deployment/SKILL.md`
