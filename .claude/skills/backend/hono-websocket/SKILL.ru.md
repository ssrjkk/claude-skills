...
version: "1.0"
language: ru
original: hono-websocket
---

# Hono Websocket

> WebSocket with Hono. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Websocket
...
## Ресурсы
- Оригинальный навык: `backend/hono-websocket/SKILL.md`
