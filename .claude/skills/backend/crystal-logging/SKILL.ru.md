...
version: "1.0"
language: ru
original: crystal-logging
---

# Crystal Logging

> Logging with Crystal. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Logging
...
## Ресурсы
- Оригинальный навык: `backend/crystal-logging/SKILL.md`
