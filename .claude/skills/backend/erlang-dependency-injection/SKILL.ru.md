...
version: "1.0"
language: ru
original: erlang-dependency-injection
---

# Erlang Dependency Injection

> DI with Erlang. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/erlang-dependency-injection/SKILL.md`
