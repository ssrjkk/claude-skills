...
category: backend
tags: [nestjs-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Api
...
## Ресурсы
- Оригинальный навык: backend/nestjs-api/SKILL.md
