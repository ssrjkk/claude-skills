...
version: "1.0"
language: ru
original: haskell-web-framework
---

# Haskell Web Framework

> Web Framework with Haskell. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/haskell-web-framework/SKILL.md`
