...
## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-optimization`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Optimization
...
## Ресурсы
- Оригинальный навык: backend/actix-optimization/SKILL.md
