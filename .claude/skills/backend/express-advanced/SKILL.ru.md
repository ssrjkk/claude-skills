...
category: backend
tags: [express-advanced, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: express-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `express-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Advanced
...
## Ресурсы
- Оригинальный навык: backend/express-advanced/SKILL.md
