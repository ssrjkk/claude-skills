...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Middleware
...
## Ресурсы
- Оригинальный навык: `backend/django-middleware/SKILL.md`
