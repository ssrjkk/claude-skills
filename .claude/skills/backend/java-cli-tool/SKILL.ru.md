...
version: "1.0"
language: ru
original: java-cli-tool
---

# Java Cli Tool

> CLI Tool with Java. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/java-cli-tool/SKILL.md`
