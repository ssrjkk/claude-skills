...
category: backend
tags: [play-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: play-deployment
---

# Play Deployment

> Deployment with Play. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `play-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Play Deployment
...
## Ресурсы
- Оригинальный навык: `backend/play-deployment/SKILL.md`
