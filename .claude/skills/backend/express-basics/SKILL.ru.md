...
category: backend
tags: [express-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: express-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `express-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Basics
...
## Ресурсы
- Оригинальный навык: backend/express-basics/SKILL.md
