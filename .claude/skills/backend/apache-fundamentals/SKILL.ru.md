...
category: backend
tags: [apache-fundamentals, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-fundamentals
---

# Apache Fundamentals

> Fundamentals for Apache: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `apache-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Apache Fundamentals
...
## Ресурсы
- Оригинал: backend/apache-fundamentals/SKILL.md
