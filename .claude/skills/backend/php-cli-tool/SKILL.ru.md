...
version: "1.0"
language: ru
original: php-cli-tool
---

# Php Cli Tool

> CLI Tool with Php. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `php-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Php Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/php-cli-tool/SKILL.md`
