...
category: backend
tags: [clojure-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clojure-testing
---

# Clojure Testing

> Testing with Clojure. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Testing
...
## Ресурсы
- Оригинальный навык: `backend/clojure-testing/SKILL.md`
