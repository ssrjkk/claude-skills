...
category: backend
tags: [haproxy-fundamentals, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: haproxy-fundamentals
---

# Haproxy Fundamentals

> Fundamentals for Haproxy: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `haproxy-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haproxy Fundamentals
...
## Ресурсы
- Оригинал: backend/haproxy-fundamentals/SKILL.md
