...
## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Monitoring
...
## Ресурсы
- Оригинальный навык: backend/axum-monitoring/SKILL.md
