...
version: "1.0"
language: ru
original: aiohttp-routing
---

# Aiohttp Routing

> Routing with aiohttp. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aiohttp-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aiohttp Routing
...
## Ресурсы
- Оригинальный навык: `backend/aiohttp-routing/SKILL.md`
