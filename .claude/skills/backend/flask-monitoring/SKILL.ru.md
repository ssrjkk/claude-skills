...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Monitoring
...
## Ресурсы
- Оригинальный навык: backend/flask-monitoring/SKILL.md
