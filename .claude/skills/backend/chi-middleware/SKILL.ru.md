...
version: "1.0"
language: ru
original: chi-middleware
---

# Chi Middleware

> Middleware with Chi. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Middleware
...
## Ресурсы
- Оригинальный навык: `backend/chi-middleware/SKILL.md`
