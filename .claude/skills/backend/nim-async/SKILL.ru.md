...
category: backend
tags: [nim-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nim-async
...
> Async with Nim. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nim-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nim Async
...
## Ресурсы
- Оригинальный навык: `backend/nim-async/SKILL.md`
