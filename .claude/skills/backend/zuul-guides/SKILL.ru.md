...
category: backend
tags: [zuul-guides, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zuul-guides
---

# Zuul Guides

> Guides for Zuul: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `zuul-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zuul Guides
...
## Ресурсы
- Оригинал: backend/zuul-guides/SKILL.md
