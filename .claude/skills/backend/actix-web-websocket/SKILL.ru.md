...
version: "1.0"
language: ru
original: actix-web-websocket
---

# Actix Web Websocket

> WebSocket with Actix Web. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-web-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Web Websocket
...
## Ресурсы
- Оригинальный навык: `backend/actix-web-websocket/SKILL.md`
