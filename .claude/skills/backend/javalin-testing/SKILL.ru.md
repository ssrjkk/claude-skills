...
category: backend
tags: [javalin-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: javalin-testing
---

# Javalin Testing

> Testing with Javalin. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Testing
...
## Ресурсы
- Оригинальный навык: `backend/javalin-testing/SKILL.md`
