...
version: "1.0"
language: ru
original: kit-testing
---

# Kit Testing

> Testing with Go Kit. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kit-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kit Testing
...
## Ресурсы
- Оригинальный навык: `backend/kit-testing/SKILL.md`
