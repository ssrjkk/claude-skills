...
version: "1.0"
language: ru
original: rocket-templating
---

# Rocket Templating

> Templating with Rocket. templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Templating
...
## Ресурсы
- Оригинальный навык: `backend/rocket-templating/SKILL.md`
