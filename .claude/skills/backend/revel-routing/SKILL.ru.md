...
category: backend
tags: [revel-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: revel-routing
---

# Revel Routing

> Routing with Revel. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Routing
...
## Ресурсы
- Оригинальный навык: `backend/revel-routing/SKILL.md`
