...
category: backend
tags: [go-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: go-dependency-injection
---

# Go Dependency Injection

> DI with Go. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/go-dependency-injection/SKILL.md`
