...
version: "1.0"
language: ru
original: express-websocket
---

# Express Websocket

> WebSocket with Express. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Websocket
...
## Ресурсы
- Оригинальный навык: `backend/express-websocket/SKILL.md`
