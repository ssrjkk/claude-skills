...
version: "1.0"
language: ru
original: javascript-web-framework
---

# Javascript Web Framework

> Web Framework with Javascript. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javascript-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javascript Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/javascript-web-framework/SKILL.md`
