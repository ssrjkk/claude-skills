...
category: backend
tags: [django-setup, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: django-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-setup`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Setup
...
## Ресурсы
- Оригинальный навык: backend/django-setup/SKILL.md
