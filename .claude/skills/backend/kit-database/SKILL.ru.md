...
version: "1.0"
language: ru
original: kit-database
---

# Kit Database

> Database with Go Kit. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kit-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kit Database
...
## Ресурсы
- Оригинальный навык: `backend/kit-database/SKILL.md`
