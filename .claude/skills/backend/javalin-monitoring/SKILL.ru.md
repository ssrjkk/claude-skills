...
category: backend
tags: [javalin-monitoring, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: javalin-monitoring
---

# Javalin Monitoring

> Monitoring with Javalin. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/javalin-monitoring/SKILL.md`
