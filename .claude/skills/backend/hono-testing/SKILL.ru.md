...
category: backend
tags: [hono-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-testing
---

# Hono Testing

> Testing with Hono. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Testing
...
## Ресурсы
- Оригинальный навык: `backend/hono-testing/SKILL.md`
