...
version: "1.0"
language: ru
original: cakephp-auth
---

# Cakephp Auth

> Auth with CakePHP. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Auth
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-auth/SKILL.md`
