...
category: backend
tags: [nim-web-framework, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nim-web-framework
---

# Nim Web Framework

> Web Framework with Nim. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nim-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nim Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/nim-web-framework/SKILL.md`
