...
version: "1.0"
language: ru
original: nitro-intro
---

# Nitro Intro

> Intro for Nitro: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nitro-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nitro Intro
...
## Ресурсы
- Оригинал: backend/nitro-intro/SKILL.md
