...
version: "1.0"
language: ru
original: event-sourcing-intro
---

# Event Sourcing Intro

> Introduction with Event Sourcing. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-sourcing-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Event Sourcing Intro
...
## Ресурсы
- Оригинальный навык: `backend/event-sourcing-intro/SKILL.md`
