...
version: "1.0"
language: ru
original: poem-templating
---

# Poem Templating

> Templating with Poem. templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Templating
...
## Ресурсы
- Оригинальный навык: `backend/poem-templating/SKILL.md`
