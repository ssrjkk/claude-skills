...
version: "1.0"
language: ru
original: redis-workflow
---

# Redis Workflow

> Workflow for Redis: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: redis-workflow.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Redis Workflow
...
## Ресурсы
- backend/redis-workflow/SKILL.md
