...
category: backend
tags: [retry-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: retry-migration
---

# Retry Migration

> Migration with Retry. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `retry-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Retry Migration
...
## Ресурсы
- Оригинальный навык: `backend/retry-migration/SKILL.md`
