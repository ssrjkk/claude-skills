...
version: "1.0"
language: ru
original: buffalo-middleware
---

# Buffalo Middleware

> Middleware with Buffalo. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Middleware
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-middleware/SKILL.md`
