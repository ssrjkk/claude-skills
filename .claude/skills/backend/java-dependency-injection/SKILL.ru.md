...
category: backend
tags: [java-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: java-dependency-injection
---

# Java Dependency Injection

> DI with Java. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/java-dependency-injection/SKILL.md`
