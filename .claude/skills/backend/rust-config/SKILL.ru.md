...
> Configuration with Rust. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Config
...
## Ресурсы
- Оригинальный навык: `backend/rust-config/SKILL.md`
