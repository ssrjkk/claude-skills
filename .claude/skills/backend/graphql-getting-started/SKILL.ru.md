...
version: "1.0"
language: ru
original: graphql-getting-started
---

# Graphql Getting Started

> Getting Started for Graphql: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: graphql-getting-started.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Graphql Getting Started
...
## Ресурсы
- backend/graphql-getting-started/SKILL.md
