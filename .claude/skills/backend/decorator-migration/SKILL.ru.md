...
category: backend
tags: [decorator-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: decorator-migration
---

# Decorator Migration

> Migration with Decorator. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `decorator-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Decorator Migration
...
## Ресурсы
- Оригинальный навык: `backend/decorator-migration/SKILL.md`
