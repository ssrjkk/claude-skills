...
category: backend
tags: [strangler-fig-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strangler-fig-testing
---

# Strangler Fig Testing

> Testing with Strangler Fig. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strangler-fig-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strangler Fig Testing
...
## Ресурсы
- Оригинальный навык: `backend/strangler-fig-testing/SKILL.md`
