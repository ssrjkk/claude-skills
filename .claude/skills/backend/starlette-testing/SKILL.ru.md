...
category: backend
tags: [starlette-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: starlette-testing
---

# Starlette Testing

> Testing with Starlette. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Testing
...
## Ресурсы
- Оригинальный навык: `backend/starlette-testing/SKILL.md`
