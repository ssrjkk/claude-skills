...
version: "1.0"
language: ru
original: dart-logging
---

# Dart Logging

> Logging with Dart. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Logging
...
## Ресурсы
- Оригинальный навык: `backend/dart-logging/SKILL.md`
