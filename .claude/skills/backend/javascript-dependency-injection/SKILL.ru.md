...
version: "1.0"
language: ru
original: javascript-dependency-injection
---

# Javascript Dependency Injection

> DI with Javascript. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javascript-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javascript Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/javascript-dependency-injection/SKILL.md`
