...
version: "1.0"
language: ru
original: javalin-database
---

# Javalin Database

> Database with Javalin. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Database
...
## Ресурсы
- Оригинальный навык: `backend/javalin-database/SKILL.md`
