...
version: "1.0"
language: ru
original: haskell-cli-tool
---

# Haskell Cli Tool

> CLI Tool with Haskell. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/haskell-cli-tool/SKILL.md`
