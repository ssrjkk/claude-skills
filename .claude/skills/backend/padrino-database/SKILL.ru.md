...
## Быстрый старт
Этот навык на русском языке. Оригинал: `padrino-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Padrino Database
...
## Ресурсы
- Оригинальный навык: `backend/padrino-database/SKILL.md`
