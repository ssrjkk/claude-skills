...
category: backend
tags: [actix-web-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: actix-web-testing
---

# Actix Web Testing

> Testing with Actix Web. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-web-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Web Testing
...
## Ресурсы
- Оригинальный навык: `backend/actix-web-testing/SKILL.md`
