...
category: backend
tags: [unit-of-work-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unit-of-work-migration
---

# Unit Of Work Migration

> Migration with Unit of Work. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unit-of-work-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Unit Of Work Migration
...
## Ресурсы
- Оригинальный навык: `backend/unit-of-work-migration/SKILL.md`
