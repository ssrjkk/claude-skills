...
version: "1.0"
language: ru
original: play-monitoring
---

# Play Monitoring

> Monitoring with Play. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `play-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Play Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/play-monitoring/SKILL.md`
