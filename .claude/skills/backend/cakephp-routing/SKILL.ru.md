...
category: backend
tags: [cakephp-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cakephp-routing
---

# Cakephp Routing

> Routing with CakePHP. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Routing
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-routing/SKILL.md`
