...
category: backend
tags: [falcon-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: falcon-database
---

# Falcon Database

> Database with Falcon. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `falcon-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Falcon Database
...
## Ресурсы
- Оригинальный навык: `backend/falcon-database/SKILL.md`
