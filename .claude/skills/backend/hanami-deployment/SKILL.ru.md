...
category: backend
tags: [hanami-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-deployment
---

# Hanami Deployment

> Deployment with Hanami. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Deployment
...
## Ресурсы
- Оригинальный навык: `backend/hanami-deployment/SKILL.md`
