...
version: "1.0"
language: ru
original: poem-middleware
---

# Poem Middleware

> Middleware with Poem. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Middleware
...
## Ресурсы
- Оригинальный навык: `backend/poem-middleware/SKILL.md`
