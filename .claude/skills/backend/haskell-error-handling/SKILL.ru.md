...
version: "1.0"
language: ru
original: haskell-error-handling
---

# Haskell Error Handling

> Error Handling with Haskell. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/haskell-error-handling/SKILL.md`
