...
## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-web-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Web Database
...
## Ресурсы
- Оригинальный навык: `backend/actix-web-database/SKILL.md`
