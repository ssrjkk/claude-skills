...
version: "1.0"
language: ru
original: yii-testing
---

# Yii Testing

> Testing with Yii. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Testing
...
## Ресурсы
- Оригинальный навык: `backend/yii-testing/SKILL.md`
