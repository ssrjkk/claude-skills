...
category: backend
tags: [throttling-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: throttling-migration
---

# Throttling Migration

> Migration with Throttling. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `throttling-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Throttling Migration
...
## Ресурсы
- Оригинальный навык: `backend/throttling-migration/SKILL.md`
