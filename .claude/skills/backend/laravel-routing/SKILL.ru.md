...
> Routing with Laravel. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laravel-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laravel Routing
...
## Ресурсы
- Оригинальный навык: `backend/laravel-routing/SKILL.md`
