...
version: "1.0"
language: ru
original: nginx-guides
---

# Nginx Guides

> Guides for Nginx: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nginx-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nginx Guides
...
## Ресурсы
- Оригинал: backend/nginx-guides/SKILL.md
