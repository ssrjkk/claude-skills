...
category: backend
tags: [prisma-automation, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prisma-automation
---

# Prisma Automation

> Automation for Prisma: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: prisma-automation.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Prisma Automation
...
## Ресурсы
- backend/prisma-automation/SKILL.md
