...
category: backend
tags: [celery-workflow, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: celery-workflow
---

# Celery Workflow

> Workflow for Celery: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: celery-workflow.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Celery Workflow
...
## Ресурсы
- backend/celery-workflow/SKILL.md
