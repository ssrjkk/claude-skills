...
category: backend
tags: [squid-guides, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: squid-guides
---

# Squid Guides

> Guides for Squid: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `squid-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Squid Guides
...
## Ресурсы
- Оригинал: backend/squid-guides/SKILL.md
