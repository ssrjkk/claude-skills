...
version: "1.0"
language: ru
original: apache-guides
---

# Apache Guides

> Guides for Apache: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `apache-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Apache Guides
...
## Ресурсы
- Оригинал: backend/apache-guides/SKILL.md
