...
version: "1.0"
language: ru
original: slim-database
---

# Slim Database

> Database with Slim. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Database
...
## Ресурсы
- Оригинальный навык: `backend/slim-database/SKILL.md`
