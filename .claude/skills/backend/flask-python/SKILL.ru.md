...
category: backend
tags: [flask-python, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-python
---

# Flask Python

> Creates lightweight web applications and REST APIs with Flask, Jinja2 templates, and SQLAlchemy. Use for simple Python web apps and microservices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-python`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Python
...
## Ресурсы
- Оригинальный навык: `backend/flask-python/SKILL.md`
