...
category: backend
tags: [express-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: express-testing
---

# Express Testing

> Testing with Express. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `express-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Express Testing
...
## Ресурсы
- Оригинальный навык: `backend/express-testing/SKILL.md`
