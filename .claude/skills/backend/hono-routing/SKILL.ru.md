...
category: backend
tags: [hono-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-routing
---

# Hono Routing

> Routing with Hono. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hono-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Routing
...
## Ресурсы
- Оригинальный навык: `backend/hono-routing/SKILL.md`
