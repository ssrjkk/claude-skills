...
version: "1.0"
language: ru
original: laminas-templating
---

# Laminas Templating

> Templating with Laminas. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Templating
...
## Ресурсы
- Оригинальный навык: `backend/laminas-templating/SKILL.md`
