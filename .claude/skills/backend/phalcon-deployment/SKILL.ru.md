...
## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Deployment
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-deployment/SKILL.md`
