...
version: "1.0"
language: ru
original: slim-routing
---

# Slim Routing

> Routing with Slim. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Routing
...
## Ресурсы
- Оригинальный навык: `backend/slim-routing/SKILL.md`
