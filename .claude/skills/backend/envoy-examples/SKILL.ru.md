...
version: "1.0"
language: ru
original: envoy-examples
---

# Envoy Examples

> Examples for Envoy: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `envoy-examples`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Envoy Examples
...
## Ресурсы
- Оригинал: backend/envoy-examples/SKILL.md
