...
category: backend
tags: [hanami-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-database
---

# Hanami Database

> Database with Hanami. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Database
...
## Ресурсы
- Оригинальный навык: `backend/hanami-database/SKILL.md`
