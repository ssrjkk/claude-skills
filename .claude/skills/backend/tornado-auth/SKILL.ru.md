...
version: "1.0"
language: ru
original: tornado-auth
---

# Tornado Auth

> Authentication with Tornado. user auth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Auth
...
## Ресурсы
- Оригинальный навык: `backend/tornado-auth/SKILL.md`
