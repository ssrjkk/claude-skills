...
category: backend
tags: [gin-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gin-routing
---

# Gin Routing

> Routing with Gin. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Routing
...
## Ресурсы
- Оригинальный навык: `backend/gin-routing/SKILL.md`
