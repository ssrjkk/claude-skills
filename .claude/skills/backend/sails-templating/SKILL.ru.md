...
category: backend
tags: [sails-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sails-templating
---

# Sails Templating

> Templating with Sails.js. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sails-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sails Templating
...
## Ресурсы
- Оригинальный навык: `backend/sails-templating/SKILL.md`
