...
version: "1.0"
language: ru
original: erlang-async
---

# Erlang Async

> Async with Erlang. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Async
...
## Ресурсы
- Оригинальный навык: `backend/erlang-async/SKILL.md`
