...
category: backend
tags: [spring-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Testing
...
## Ресурсы
- Оригинальный навык: backend/spring-testing/SKILL.md
