...
version: "1.0"
language: ru
original: nim-rest-api
---

# Nim Rest Api

> REST API with Nim. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nim-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nim Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/nim-rest-api/SKILL.md`
