...
version: "1.0"
language: ru
original: decorator-testing
---

# Decorator Testing

> Testing with Decorator. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `decorator-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Decorator Testing
...
## Ресурсы
- Оригинальный навык: `backend/decorator-testing/SKILL.md`
