...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-security`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Security
...
## Ресурсы
- Оригинальный навык: backend/django-security/SKILL.md
