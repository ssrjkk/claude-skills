...
version: "1.0"
language: ru
original: fastify-testing
---

# Fastify Testing

> Testing with Fastify. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Testing
...
## Ресурсы
- Оригинальный навык: `backend/fastify-testing/SKILL.md`
