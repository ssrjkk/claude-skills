...
category: backend
tags: [python-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Async with Python. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `python-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Async
...
## Ресурсы
- Оригинальный навык: `backend/python-async/SKILL.md`
