...
version: "1.0"
language: ru
original: salvo-async
---

# Salvo Async

> Async with Salvo. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Async
...
## Ресурсы
- Оригинальный навык: `backend/salvo-async/SKILL.md`
