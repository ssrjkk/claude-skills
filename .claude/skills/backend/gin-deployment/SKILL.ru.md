...
version: "1.0"
language: ru
original: gin-deployment
---

# Gin Deployment

> Deployment with Gin. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Deployment
...
## Ресурсы
- Оригинальный навык: `backend/gin-deployment/SKILL.md`
