...
version: "1.0"
language: ru
original: fastify-database
---

# Fastify Database

> Database with Fastify. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Database
...
## Ресурсы
- Оригинальный навык: `backend/fastify-database/SKILL.md`
