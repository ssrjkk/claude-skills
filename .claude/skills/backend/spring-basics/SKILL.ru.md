...
category: backend
tags: [spring-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Basics
...
## Ресурсы
- Оригинальный навык: backend/spring-basics/SKILL.md
