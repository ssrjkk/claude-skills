...
version: "1.0"
language: ru
original: cakephp-middleware
---

# Cakephp Middleware

> Middleware with CakePHP. pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Middleware
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-middleware/SKILL.md`
