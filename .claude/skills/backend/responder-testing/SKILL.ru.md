...
category: backend
tags: [responder-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: responder-testing
---

# Responder Testing

> Testing with Responder. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `responder-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Responder Testing
...
## Ресурсы
- Оригинальный навык: `backend/responder-testing/SKILL.md`
