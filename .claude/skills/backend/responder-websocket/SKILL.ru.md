...
version: "1.0"
language: ru
original: responder-websocket
---

# Responder Websocket

> WebSocket with Responder. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `responder-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Responder Websocket
...
## Ресурсы
- Оригинальный навык: `backend/responder-websocket/SKILL.md`
