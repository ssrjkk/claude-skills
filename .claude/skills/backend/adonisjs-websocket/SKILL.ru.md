...
version: "1.0"
language: ru
original: adonisjs-websocket
---

# Adonisjs Websocket

> WebSocket with AdonisJS. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adonisjs-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adonisjs Websocket
...
## Ресурсы
- Оригинальный навык: `backend/adonisjs-websocket/SKILL.md`
