...
category: backend
tags: [sanic-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sanic-templating
---

# Sanic Templating

> Templating with Sanic. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Templating
...
## Ресурсы
- Оригинальный навык: `backend/sanic-templating/SKILL.md`
