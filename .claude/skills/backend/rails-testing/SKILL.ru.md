...
version: "1.0"
language: ru
original: rails-testing
---

# Rails Testing

> Testing with Rails. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Testing
...
## Ресурсы
- Оригинальный навык: `backend/rails-testing/SKILL.md`
