...
category: backend
tags: [flask-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Database with Flask. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Database
...
## Ресурсы
- Оригинальный навык: `backend/flask-database/SKILL.md`
