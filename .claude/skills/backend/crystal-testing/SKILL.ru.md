...
category: backend
tags: [crystal-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crystal-testing
---

# Crystal Testing

> Testing with Crystal. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Testing
...
## Ресурсы
- Оригинальный навык: `backend/crystal-testing/SKILL.md`
