...
category: backend
tags: [tornado-websocket, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tornado-websocket
---

# Tornado Websocket

> WebSocket with Tornado. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Websocket
...
## Ресурсы
- Оригинальный навык: `backend/tornado-websocket/SKILL.md`
