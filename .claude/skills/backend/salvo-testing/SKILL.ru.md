...
version: "1.0"
language: ru
original: salvo-testing
---

# Salvo Testing

> Testing with Salvo. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Testing
...
## Ресурсы
- Оригинальный навык: `backend/salvo-testing/SKILL.md`
