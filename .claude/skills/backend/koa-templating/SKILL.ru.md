...
version: "1.0"
language: ru
original: koa-templating
---

# Koa Templating

> Templating with Koa. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `koa-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Koa Templating
...
## Ресурсы
- Оригинальный навык: `backend/koa-templating/SKILL.md`
