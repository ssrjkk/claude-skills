...
version: "1.0"
language: ru
original: poem-websocket
---

# Poem Websocket

> WebSocket with Poem. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Websocket
...
## Ресурсы
- Оригинальный навык: `backend/poem-websocket/SKILL.md`
