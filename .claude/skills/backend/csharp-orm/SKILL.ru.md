...
> ORM with Csharp. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csharp-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Csharp Orm
...
## Ресурсы
- Оригинальный навык: `backend/csharp-orm/SKILL.md`
