...
version: "1.0"
language: ru
original: scala-cli-tool
---

# Scala Cli Tool

> CLI Tool with Scala. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/scala-cli-tool/SKILL.md`
