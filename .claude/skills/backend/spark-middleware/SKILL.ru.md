...
version: "1.0"
language: ru
original: spark-middleware
---

# Spark Middleware

> Middleware with Spark. request processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spark Middleware
...
## Ресурсы
- Оригинальный навык: `backend/spark-middleware/SKILL.md`
