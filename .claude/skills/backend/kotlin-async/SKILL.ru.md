...
category: backend
tags: [kotlin-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-async
---

# Kotlin Async

> Async with Kotlin. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Async
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-async/SKILL.md`
