...
category: backend
tags: [hono-usage, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-usage
...
> Usage for Hono: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `hono-usage`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Usage
...
## Ресурсы
- Оригинал: backend/hono-usage/SKILL.md
