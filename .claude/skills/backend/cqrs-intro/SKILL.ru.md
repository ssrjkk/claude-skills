...
category: backend
tags: [cqrs-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cqrs-intro
...
> Introduction with CQRS. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cqrs-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cqrs Intro
...
## Ресурсы
- Оригинальный навык: `backend/cqrs-intro/SKILL.md`
