...
version: "1.0"
language: ru
original: dart-web-framework
---

# Dart Web Framework

> Web Framework with Dart. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/dart-web-framework/SKILL.md`
