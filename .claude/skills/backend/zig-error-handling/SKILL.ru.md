...
> Error Handling with Zig. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/zig-error-handling/SKILL.md`
