...
version: "1.0"
language: ru
original: koa-database
---

# Koa Database

> Database with Koa. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `koa-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Koa Database
...
## Ресурсы
- Оригинальный навык: `backend/koa-database/SKILL.md`
