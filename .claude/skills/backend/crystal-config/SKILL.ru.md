...
category: backend
tags: [crystal-config, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crystal-config
---

# Crystal Config

> Configuration with Crystal. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Config
...
## Ресурсы
- Оригинальный навык: `backend/crystal-config/SKILL.md`
