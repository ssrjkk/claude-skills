...
version: "1.0"
language: ru
original: php-rest-api
---

# Php Rest Api

> REST API with Php. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `php-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Php Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/php-rest-api/SKILL.md`
