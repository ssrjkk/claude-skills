...
category: backend
tags: [spring-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Api
...
## Ресурсы
- Оригинальный навык: backend/spring-api/SKILL.md
