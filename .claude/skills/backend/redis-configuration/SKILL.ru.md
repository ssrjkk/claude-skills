...
category: backend
tags: [redis-configuration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Configuration for Redis: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: redis-configuration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Redis Configuration
...
## Ресурсы
- backend/redis-configuration/SKILL.md
