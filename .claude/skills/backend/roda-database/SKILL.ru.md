...
category: backend
tags: [roda-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: roda-database
---

# Roda Database

> Database with Roda. ActiveRecord.

## Быстрый старт
Этот навык на русском языке. Оригинал: `roda-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Roda Database
...
## Ресурсы
- Оригинальный навык: `backend/roda-database/SKILL.md`
