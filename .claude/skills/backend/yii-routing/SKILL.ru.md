...
category: backend
tags: [yii-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: yii-routing
---

# Yii Routing

> Routing with Yii. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Routing
...
## Ресурсы
- Оригинальный навык: `backend/yii-routing/SKILL.md`
