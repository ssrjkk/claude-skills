...
version: "1.0"
language: ru
original: phalcon-routing
---

# Phalcon Routing

> Routing with Phalcon. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Routing
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-routing/SKILL.md`
