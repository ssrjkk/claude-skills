...
version: "1.0"
language: ru
original: feathers-database
---

# Feathers Database

> Database with FeathersJS. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `feathers-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Feathers Database
...
## Ресурсы
- Оригинальный навык: `backend/feathers-database/SKILL.md`
