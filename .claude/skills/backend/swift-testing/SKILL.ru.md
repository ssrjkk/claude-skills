...
version: "1.0"
language: ru
original: swift-testing
---

# Swift Testing

> Testing with Swift. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Testing
...
## Ресурсы
- Оригинальный навык: `backend/swift-testing/SKILL.md`
