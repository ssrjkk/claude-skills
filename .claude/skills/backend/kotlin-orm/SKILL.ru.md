...
> ORM with Kotlin. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Orm
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-orm/SKILL.md`
