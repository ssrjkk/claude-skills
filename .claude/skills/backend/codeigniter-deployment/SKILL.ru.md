...
version: "1.0"
language: ru
original: codeigniter-deployment
---

# Codeigniter Deployment

> Deployment with CodeIgniter. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Deployment
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-deployment/SKILL.md`
