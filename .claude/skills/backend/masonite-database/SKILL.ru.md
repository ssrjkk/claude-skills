...
version: "1.0"
language: ru
original: masonite-database
---

# Masonite Database

> Database with Masonite. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `masonite-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Masonite Database
...
## Ресурсы
- Оригинальный навык: `backend/masonite-database/SKILL.md`
