...
version: "1.0"
language: ru
original: rocket-websocket
---

# Rocket Websocket

> WebSocket with Rocket. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Websocket
...
## Ресурсы
- Оригинальный навык: `backend/rocket-websocket/SKILL.md`
