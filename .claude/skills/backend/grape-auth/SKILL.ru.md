...
category: backend
tags: [grape-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-auth
...
> Auth with Grape. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Auth
...
## Ресурсы
- Оригинальный навык: `backend/grape-auth/SKILL.md`
