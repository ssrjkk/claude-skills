...
version: "1.0"
language: ru
original: graphql-automation
---

# Graphql Automation

> Automation for Graphql: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: graphql-automation.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Graphql Automation
...
## Ресурсы
- backend/graphql-automation/SKILL.md
