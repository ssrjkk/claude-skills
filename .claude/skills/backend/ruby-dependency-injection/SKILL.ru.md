...
category: backend
tags: [ruby-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ruby-dependency-injection
---

# Ruby Dependency Injection

> DI with Ruby. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/ruby-dependency-injection/SKILL.md`
