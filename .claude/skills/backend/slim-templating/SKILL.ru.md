...
version: "1.0"
language: ru
original: slim-templating
---

# Slim Templating

> Templating with Slim. Blade.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Templating
...
## Ресурсы
- Оригинальный навык: `backend/slim-templating/SKILL.md`
