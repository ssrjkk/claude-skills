...
version: "1.0"
language: ru
original: starlette-routing
---

# Starlette Routing

> Routing with Starlette. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Routing
...
## Ресурсы
- Оригинальный навык: `backend/starlette-routing/SKILL.md`
