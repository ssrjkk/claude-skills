...
version: "1.0"
language: ru
original: chi-database
---

# Chi Database

> Database with Chi. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Database
...
## Ресурсы
- Оригинальный навык: `backend/chi-database/SKILL.md`
