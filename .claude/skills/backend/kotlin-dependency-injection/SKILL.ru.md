...
version: "1.0"
language: ru
original: kotlin-dependency-injection
---

# Kotlin Dependency Injection

> DI with Kotlin. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-dependency-injection/SKILL.md`
