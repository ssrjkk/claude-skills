...
version: "1.0"
language: ru
original: fiber-testing
---

# Fiber Testing

> Testing with Fiber. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fiber-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fiber Testing
...
## Ресурсы
- Оригинальный навык: `backend/fiber-testing/SKILL.md`
