...
## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/rust-cli-tool/SKILL.md`
