...
category: backend
tags: [responder-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: responder-database
---

# Responder Database

> Database with Responder. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `responder-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Responder Database
...
## Ресурсы
- Оригинальный навык: `backend/responder-database/SKILL.md`
