...
## Быстрый старт
Этот навык на русском языке. Оригинал: `python-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Python Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/python-rest-api/SKILL.md`
