...
category: backend
tags: [repository-scaling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: repository-scaling
---

# Repository Scaling

> Scaling with Repository. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `repository-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Repository Scaling
...
## Ресурсы
- Оригинальный навык: `backend/repository-scaling/SKILL.md`
