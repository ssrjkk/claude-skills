...
version: "1.0"
language: ru
original: scala-async
---

# Scala Async

> Async with Scala. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Async
...
## Ресурсы
- Оригинальный навык: `backend/scala-async/SKILL.md`
