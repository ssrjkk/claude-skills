...
version: "1.0"
language: ru
original: play-testing
---

# Play Testing

> Testing with Play. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `play-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Play Testing
...
## Ресурсы
- Оригинальный навык: `backend/play-testing/SKILL.md`
