...
version: "1.0"
language: ru
original: sails-routing
---

# Sails Routing

> Routing with Sails.js. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sails-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sails Routing
...
## Ресурсы
- Оригинальный навык: `backend/sails-routing/SKILL.md`
