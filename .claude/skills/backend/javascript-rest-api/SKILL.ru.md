...
version: "1.0"
language: ru
original: javascript-rest-api
---

# Javascript Rest Api

> REST API with Javascript. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javascript-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javascript Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/javascript-rest-api/SKILL.md`
