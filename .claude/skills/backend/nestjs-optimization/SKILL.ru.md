...
category: backend
tags: [nestjs-optimization, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-optimization`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Optimization
...
## Ресурсы
- Оригинальный навык: backend/nestjs-optimization/SKILL.md
