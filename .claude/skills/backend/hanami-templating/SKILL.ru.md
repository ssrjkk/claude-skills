...
category: backend
tags: [hanami-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-templating
---

# Hanami Templating

> Templating with Hanami. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Templating
...
## Ресурсы
- Оригинальный навык: `backend/hanami-templating/SKILL.md`
