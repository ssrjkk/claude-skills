...
version: "1.0"
language: ru
original: rocket-deployment
---

# Rocket Deployment

> Deployment with Rocket. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Deployment
...
## Ресурсы
- Оригинальный навык: `backend/rocket-deployment/SKILL.md`
