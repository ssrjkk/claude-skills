...
category: backend
tags: [hanami-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hanami-testing
---

# Hanami Testing

> Testing with Hanami. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hanami-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hanami Testing
...
## Ресурсы
- Оригинальный навык: `backend/hanami-testing/SKILL.md`
