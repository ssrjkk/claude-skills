...
version: "1.0"
language: ru
original: tide-deployment
---

# Tide Deployment

> Deployment with Tide. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tide-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tide Deployment
...
## Ресурсы
- Оригинальный навык: `backend/tide-deployment/SKILL.md`
