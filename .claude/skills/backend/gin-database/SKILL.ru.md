...
version: "1.0"
language: ru
original: gin-database
---

# Gin Database

> Database with Gin. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Database
...
## Ресурсы
- Оригинальный навык: `backend/gin-database/SKILL.md`
