...
category: backend
tags: [bottle-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bottle-routing
---

# Bottle Routing

> Routing with Bottle. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bottle-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bottle Routing
...
## Ресурсы
- Оригинальный навык: `backend/bottle-routing/SKILL.md`
