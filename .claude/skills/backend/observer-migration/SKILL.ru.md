...
version: "1.0"
language: ru
original: observer-migration
---

# Observer Migration

> Migration with Observer. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `observer-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Observer Migration
...
## Ресурсы
- Оригинальный навык: `backend/observer-migration/SKILL.md`
