...
version: "1.0"
language: ru
original: rocket-database
---

# Rocket Database

> Database with Rocket. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Database
...
## Ресурсы
- Оригинальный навык: `backend/rocket-database/SKILL.md`
