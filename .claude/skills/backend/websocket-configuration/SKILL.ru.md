...
> Configuration for Websocket: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: websocket-configuration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Websocket Configuration
...
## Ресурсы
- backend/websocket-configuration/SKILL.md
