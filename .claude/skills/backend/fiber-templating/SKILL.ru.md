...
category: backend
tags: [fiber-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fiber-templating
---

# Fiber Templating

> Templating with Fiber. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fiber-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fiber Templating
...
## Ресурсы
- Оригинальный навык: `backend/fiber-templating/SKILL.md`
