...
version: "1.0"
language: ru
original: masonite-templating
---

# Masonite Templating

> Templating with Masonite. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `masonite-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Masonite Templating
...
## Ресурсы
- Оригинальный навык: `backend/masonite-templating/SKILL.md`
