...
category: backend
tags: [spring-advanced, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Advanced
...
## Ресурсы
- Оригинальный навык: backend/spring-advanced/SKILL.md
