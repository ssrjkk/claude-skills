...
category: backend
tags: [adapter-scaling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adapter-scaling
---

# Adapter Scaling

> Scaling with Adapter. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adapter-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adapter Scaling
...
## Ресурсы
- Оригинальный навык: `backend/adapter-scaling/SKILL.md`
