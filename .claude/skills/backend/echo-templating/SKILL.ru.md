...
version: "1.0"
language: ru
original: echo-templating
---

# Echo Templating

> Templating with Echo. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Templating
...
## Ресурсы
- Оригинальный навык: `backend/echo-templating/SKILL.md`
