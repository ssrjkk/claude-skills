...
version: "1.0"
language: ru
original: quarkus-testing
---

# Quarkus Testing

> Testing with Quarkus. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Testing
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-testing/SKILL.md`
