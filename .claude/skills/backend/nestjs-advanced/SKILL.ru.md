...
category: backend
tags: [nestjs-advanced, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Advanced
...
## Ресурсы
- Оригинальный навык: backend/nestjs-advanced/SKILL.md
