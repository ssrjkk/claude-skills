...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-security`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Security
...
## Ресурсы
- Оригинальный навык: backend/spring-security/SKILL.md
