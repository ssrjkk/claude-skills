...
version: "1.0"
language: ru
original: fastify-templating
---

# Fastify Templating

> Templating with Fastify. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Templating
...
## Ресурсы
- Оригинальный навык: `backend/fastify-templating/SKILL.md`
