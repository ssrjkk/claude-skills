...
version: "1.0"
language: ru
original: typescript-dependency-injection
---

# Typescript Dependency Injection

> DI with Typescript. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/typescript-dependency-injection/SKILL.md`
