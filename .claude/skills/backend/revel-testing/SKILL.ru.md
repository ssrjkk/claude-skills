...
version: "1.0"
language: ru
original: revel-testing
---

# Revel Testing

> Testing with Revel. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Testing
...
## Ресурсы
- Оригинальный навык: `backend/revel-testing/SKILL.md`
