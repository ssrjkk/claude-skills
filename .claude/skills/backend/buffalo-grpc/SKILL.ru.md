...
version: "1.0"
language: ru
original: buffalo-grpc
---

# Buffalo Grpc

> gRPC with Buffalo. gRPC services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-grpc`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Grpc
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-grpc/SKILL.md`
