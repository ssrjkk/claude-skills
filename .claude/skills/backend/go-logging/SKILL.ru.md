...
> Logging with Go. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Logging
...
## Ресурсы
- Оригинальный навык: `backend/go-logging/SKILL.md`
