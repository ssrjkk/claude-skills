...
category: backend
tags: [grape-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-templating
---

# Grape Templating

> Templating with Grape. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Templating
...
## Ресурсы
- Оригинальный навык: `backend/grape-templating/SKILL.md`
