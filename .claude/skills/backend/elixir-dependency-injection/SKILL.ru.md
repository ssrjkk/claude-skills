...
category: backend
tags: [elixir-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: elixir-dependency-injection
---

# Elixir Dependency Injection

> DI with Elixir. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/elixir-dependency-injection/SKILL.md`
