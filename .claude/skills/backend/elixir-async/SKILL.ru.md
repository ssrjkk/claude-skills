...
version: "1.0"
language: ru
original: elixir-async
---

# Elixir Async

> Async with Elixir. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Async
...
## Ресурсы
- Оригинальный навык: `backend/elixir-async/SKILL.md`
