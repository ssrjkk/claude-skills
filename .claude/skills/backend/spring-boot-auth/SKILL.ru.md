...
category: backend
tags: [spring-boot-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-boot-auth
---

# Spring Boot Auth

> Auth with Spring Boot. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Auth
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-auth/SKILL.md`
