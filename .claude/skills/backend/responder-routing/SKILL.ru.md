...
## Быстрый старт
Этот навык на русском языке. Оригинал: `responder-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Responder Routing
...
## Ресурсы
- Оригинальный навык: `backend/responder-routing/SKILL.md`
