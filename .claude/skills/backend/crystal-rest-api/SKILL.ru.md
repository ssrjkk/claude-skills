...
category: backend
tags: [crystal-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crystal-rest-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/crystal-rest-api/SKILL.md`
