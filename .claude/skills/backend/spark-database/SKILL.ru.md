...
category: backend
tags: [spark-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-database
---

# Spark Database

> Database with Spark. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spark Database
...
## Ресурсы
- Оригинальный навык: `backend/spark-database/SKILL.md`
