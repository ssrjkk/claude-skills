...
version: "1.0"
language: ru
original: symfony-auth
---

# Symfony Auth

> Auth with Symfony. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Auth
...
## Ресурсы
- Оригинальный навык: `backend/symfony-auth/SKILL.md`
