...
version: "1.0"
language: ru
original: warp-websocket
---

# Warp Websocket

> WebSocket with Warp. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `warp-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Warp Websocket
...
## Ресурсы
- Оригинальный навык: `backend/warp-websocket/SKILL.md`
