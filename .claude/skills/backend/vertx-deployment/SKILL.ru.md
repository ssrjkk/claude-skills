...
version: "1.0"
language: ru
original: vertx-deployment
---

# Vertx Deployment

> Deployment with Vert.x. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vertx-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Vertx Deployment
...
## Ресурсы
- Оригинальный навык: `backend/vertx-deployment/SKILL.md`
