...
version: "1.0"
language: ru
original: rabbitmq-best-practices
---

# Rabbitmq Best Practices

> Best Practices for Rabbitmq: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: rabbitmq-best-practices.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rabbitmq Best Practices
...
## Ресурсы
- backend/rabbitmq-best-practices/SKILL.md
