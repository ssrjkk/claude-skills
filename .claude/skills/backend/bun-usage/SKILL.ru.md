...
category: backend
tags: [bun-usage, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bun-usage
...
> Usage for Bun: usage guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `bun-usage`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bun Usage
...
## Ресурсы
- Оригинал: backend/bun-usage/SKILL.md
