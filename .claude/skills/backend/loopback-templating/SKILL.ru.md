...
version: "1.0"
language: ru
original: loopback-templating
---

# Loopback Templating

> Templating with LoopBack. Pug.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Templating
...
## Ресурсы
- Оригинальный навык: `backend/loopback-templating/SKILL.md`
