...
version: "1.0"
language: ru
original: zuul-fundamentals
---

# Zuul Fundamentals

> Fundamentals for Zuul: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `zuul-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zuul Fundamentals
...
## Ресурсы
- Оригинал: backend/zuul-fundamentals/SKILL.md
