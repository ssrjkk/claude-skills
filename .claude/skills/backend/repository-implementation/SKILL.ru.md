...
category: backend
tags: [repository-implementation, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Implementation with Repository. practical implementation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `repository-implementation`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Repository Implementation
...
## Ресурсы
- Оригинальный навык: `backend/repository-implementation/SKILL.md`
