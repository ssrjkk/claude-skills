...
version: "1.0"
language: ru
original: play-database
---

# Play Database

> Database with Play. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `play-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Play Database
...
## Ресурсы
- Оригинальный навык: `backend/play-database/SKILL.md`
