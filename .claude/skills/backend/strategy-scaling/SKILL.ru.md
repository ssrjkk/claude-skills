...
category: backend
tags: [strategy-scaling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strategy-scaling
---

# Strategy Scaling

> Scaling with Strategy. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strategy-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strategy Scaling
...
## Ресурсы
- Оригинальный навык: `backend/strategy-scaling/SKILL.md`
