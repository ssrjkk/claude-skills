...
category: backend
tags: [django-rest, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: django-rest
---

# Django Rest

> Creates REST APIs on Django with Django REST Framework. Use for Python web applications with powerful admin interface.

## Быстрый старт
Этот навык на русском языке. Оригинал: `django-rest`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Rest
...
## Ресурсы
- Оригинальный навык: `backend/django-rest/SKILL.md`
