...
category: backend
tags: [sidecar-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sidecar-intro
---

# Sidecar Intro

> Introduction with Sidecar. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sidecar-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sidecar Intro
...
## Ресурсы
- Оригинальный навык: `backend/sidecar-intro/SKILL.md`
