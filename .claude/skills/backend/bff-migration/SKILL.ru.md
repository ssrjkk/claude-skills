...
version: "1.0"
language: ru
original: bff-migration
---

# Bff Migration

> Migration with Backend for Frontend. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bff-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bff Migration
...
## Ресурсы
- Оригинальный навык: `backend/bff-migration/SKILL.md`
