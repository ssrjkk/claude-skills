...
version: "1.0"
language: ru
original: caddy-quickstart
---

# Caddy Quickstart

> Quickstart for Caddy: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `caddy-quickstart`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Caddy Quickstart
...
## Ресурсы
- Оригинал: backend/caddy-quickstart/SKILL.md
