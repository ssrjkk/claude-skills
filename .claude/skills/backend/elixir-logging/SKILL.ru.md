...
version: "1.0"
language: ru
original: elixir-logging
---

# Elixir Logging

> Logging with Elixir. app logging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-logging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Logging
...
## Ресурсы
- Оригинальный навык: `backend/elixir-logging/SKILL.md`
