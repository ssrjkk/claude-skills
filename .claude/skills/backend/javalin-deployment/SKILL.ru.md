...
version: "1.0"
language: ru
original: javalin-deployment
---

# Javalin Deployment

> Deployment with Javalin. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Deployment
...
## Ресурсы
- Оригинальный навык: `backend/javalin-deployment/SKILL.md`
