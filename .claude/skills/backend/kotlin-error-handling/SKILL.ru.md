...
version: "1.0"
language: ru
original: kotlin-error-handling
---

# Kotlin Error Handling

> Error Handling with Kotlin. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-error-handling/SKILL.md`
