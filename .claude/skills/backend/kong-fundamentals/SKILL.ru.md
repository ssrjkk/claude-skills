...
version: "1.0"
language: ru
original: kong-fundamentals
---

# Kong Fundamentals

> Fundamentals for Kong: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kong-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kong Fundamentals
...
## Ресурсы
- Оригинал: backend/kong-fundamentals/SKILL.md
