...
> Async with Ruby. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ruby-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ruby Async
...
## Ресурсы
- Оригинальный навык: `backend/ruby-async/SKILL.md`
