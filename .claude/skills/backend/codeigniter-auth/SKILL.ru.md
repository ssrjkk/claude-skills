...
category: backend
tags: [codeigniter-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: codeigniter-auth
---

# Codeigniter Auth

> Auth with CodeIgniter. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Auth
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-auth/SKILL.md`
