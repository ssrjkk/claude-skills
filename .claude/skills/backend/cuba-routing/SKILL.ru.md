...
version: "1.0"
language: ru
original: cuba-routing
---

# Cuba Routing

> Routing with Cuba. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Routing
...
## Ресурсы
- Оригинальный навык: `backend/cuba-routing/SKILL.md`
