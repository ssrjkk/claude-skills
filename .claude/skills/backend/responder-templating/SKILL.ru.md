...
## Быстрый старт
Этот навык на русском языке. Оригинал: `responder-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Responder Templating
...
## Ресурсы
- Оригинальный навык: `backend/responder-templating/SKILL.md`
