...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Middleware
...
## Ресурсы
- Оригинальный навык: `backend/fastapi-middleware/SKILL.md`
