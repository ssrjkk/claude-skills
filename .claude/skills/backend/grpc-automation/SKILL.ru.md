...
category: backend
tags: [grpc-automation, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grpc-automation
---

# Grpc Automation

> Automation for Grpc: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: grpc-automation.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grpc Automation
...
## Ресурсы
- backend/grpc-automation/SKILL.md
