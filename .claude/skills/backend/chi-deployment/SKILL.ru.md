...
category: backend
tags: [chi-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chi-deployment
---

# Chi Deployment

> Deployment with Chi. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Deployment
...
## Ресурсы
- Оригинальный навык: `backend/chi-deployment/SKILL.md`
