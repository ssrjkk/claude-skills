...
description: "Database with NestJS. ORM."
category: backend
tags: [nestjs-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-database
---

# Nestjs Database

> Database with NestJS. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Database
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-database/SKILL.md`
