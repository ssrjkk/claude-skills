...
category: backend
tags: [spark-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-routing
---

# Spark Routing

> Routing with Spark. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spark Routing
...
## Ресурсы
- Оригинальный навык: `backend/spark-routing/SKILL.md`
