...
version: "1.0"
language: ru
original: beego-templating
---

# Beego Templating

> Templating with Beego. HTML templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `beego-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Beego Templating
...
## Ресурсы
- Оригинальный навык: `backend/beego-templating/SKILL.md`
