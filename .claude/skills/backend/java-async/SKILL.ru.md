...
category: backend
tags: [java-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: java-async
...
> Async with Java. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Async
...
## Ресурсы
- Оригинальный навык: `backend/java-async/SKILL.md`
