...
version: "1.0"
language: ru
original: starlette-deployment
---

# Starlette Deployment

> Deployment with Starlette. production deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Deployment
...
## Ресурсы
- Оригинальный навык: `backend/starlette-deployment/SKILL.md`
