...
## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/typescript-rest-api/SKILL.md`
