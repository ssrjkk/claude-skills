...
> Async with Zig. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Async
...
## Ресурсы
- Оригинальный навык: `backend/zig-async/SKILL.md`
