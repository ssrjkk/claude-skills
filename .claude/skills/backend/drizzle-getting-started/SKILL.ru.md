...
version: "1.0"
language: ru
original: drizzle-getting-started
---

# Drizzle Getting Started

> Getting Started for Drizzle: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: drizzle-getting-started.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Drizzle Getting Started
...
## Ресурсы
- backend/drizzle-getting-started/SKILL.md
