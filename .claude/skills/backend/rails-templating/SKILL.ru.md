...
version: "1.0"
language: ru
original: rails-templating
---

# Rails Templating

> Templating with Rails. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rails-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rails Templating
...
## Ресурсы
- Оригинальный навык: `backend/rails-templating/SKILL.md`
