...
category: backend
tags: [sails-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sails-testing
---

# Sails Testing

> Testing with Sails.js. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sails-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sails Testing
...
## Ресурсы
- Оригинальный навык: `backend/sails-testing/SKILL.md`
