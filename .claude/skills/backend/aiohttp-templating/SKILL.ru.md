...
version: "1.0"
language: ru
original: aiohttp-templating
---

# Aiohttp Templating

> Templating with aiohttp. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aiohttp-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aiohttp Templating
...
## Ресурсы
- Оригинальный навык: `backend/aiohttp-templating/SKILL.md`
