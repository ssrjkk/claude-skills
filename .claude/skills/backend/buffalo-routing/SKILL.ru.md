...
## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Routing
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-routing/SKILL.md`
