...
version: "1.0"
language: ru
original: adapter-intro
---

# Adapter Intro

> Introduction with Adapter. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adapter-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adapter Intro
...
## Ресурсы
- Оригинальный навык: `backend/adapter-intro/SKILL.md`
