...
version: "1.0"
language: ru
original: cuba-testing
---

# Cuba Testing

> Testing with Cuba. RSpec.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cuba-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cuba Testing
...
## Ресурсы
- Оригинальный навык: `backend/cuba-testing/SKILL.md`
