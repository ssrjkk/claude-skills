...
version: "1.0"
language: ru
original: pyramid-database
---

# Pyramid Database

> Database with Pyramid. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Database
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-database/SKILL.md`
