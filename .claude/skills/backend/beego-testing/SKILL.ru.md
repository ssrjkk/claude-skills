...
version: "1.0"
language: ru
original: beego-testing
---

# Beego Testing

> Testing with Beego. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `beego-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Beego Testing
...
## Ресурсы
- Оригинальный навык: `backend/beego-testing/SKILL.md`
