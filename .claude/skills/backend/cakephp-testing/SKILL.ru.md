...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cakephp-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Cakephp Testing
...
## Ресурсы
- Оригинальный навык: `backend/cakephp-testing/SKILL.md`
