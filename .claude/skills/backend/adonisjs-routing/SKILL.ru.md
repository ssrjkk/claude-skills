...
category: backend
tags: [adonisjs-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adonisjs-routing
---

# Adonisjs Routing

> Routing with AdonisJS. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adonisjs-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adonisjs Routing
...
## Ресурсы
- Оригинальный навык: `backend/adonisjs-routing/SKILL.md`
