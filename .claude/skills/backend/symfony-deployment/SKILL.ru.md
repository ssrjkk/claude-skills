...
category: backend
tags: [symfony-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: symfony-deployment
---

# Symfony Deployment

> Deployment with Symfony. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Deployment
...
## Ресурсы
- Оригинальный навык: `backend/symfony-deployment/SKILL.md`
