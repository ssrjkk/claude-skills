...
category: backend
tags: [vertx-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vertx-testing
---

# Vertx Testing

> Testing with Vert.x. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vertx-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Vertx Testing
...
## Ресурсы
- Оригинальный навык: `backend/vertx-testing/SKILL.md`
