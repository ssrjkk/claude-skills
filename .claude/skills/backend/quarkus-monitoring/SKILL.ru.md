...
version: "1.0"
language: ru
original: quarkus-monitoring
---

# Quarkus Monitoring

> Monitoring with Quarkus. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-monitoring/SKILL.md`
