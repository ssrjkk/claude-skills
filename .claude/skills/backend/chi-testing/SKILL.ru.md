...
version: "1.0"
language: ru
original: chi-testing
---

# Chi Testing

> Testing with Chi. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Testing
...
## Ресурсы
- Оригинальный навык: `backend/chi-testing/SKILL.md`
