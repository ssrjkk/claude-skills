...
category: backend
tags: [sinatra-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sinatra-routing
---

# Sinatra Routing

> Routing with Sinatra. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Routing
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-routing/SKILL.md`
