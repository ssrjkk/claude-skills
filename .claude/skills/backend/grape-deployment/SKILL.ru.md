...
category: backend
tags: [grape-deployment, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-deployment
---

# Grape Deployment

> Deployment with Grape. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Deployment
...
## Ресурсы
- Оригинальный навык: `backend/grape-deployment/SKILL.md`
