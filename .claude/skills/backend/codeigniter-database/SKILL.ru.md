...
version: "1.0"
language: ru
original: codeigniter-database
---

# Codeigniter Database

> Database with CodeIgniter. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Database
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-database/SKILL.md`
