...
version: "1.0"
language: ru
original: grpc-production
---

# Grpc Production

> Production for Grpc: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: grpc-production.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grpc Production
...
## Ресурсы
- backend/grpc-production/SKILL.md
