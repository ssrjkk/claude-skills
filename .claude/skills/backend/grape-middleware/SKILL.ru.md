...
version: "1.0"
language: ru
original: grape-middleware
---

# Grape Middleware

> Middleware with Grape. rack middleware.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Middleware
...
## Ресурсы
- Оригинальный навык: `backend/grape-middleware/SKILL.md`
