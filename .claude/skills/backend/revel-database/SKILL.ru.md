...
category: backend
tags: [revel-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: revel-database
---

# Revel Database

> Database with Revel. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Database
...
## Ресурсы
- Оригинальный навык: `backend/revel-database/SKILL.md`
