...
version: "1.0"
language: ru
original: symfony-testing
---

# Symfony Testing

> Testing with Symfony. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `symfony-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Symfony Testing
...
## Ресурсы
- Оригинальный навык: `backend/symfony-testing/SKILL.md`
