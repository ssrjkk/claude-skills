...
version: "1.0"
language: ru
original: rabbitmq-automation
---

# Rabbitmq Automation

> Automation for Rabbitmq: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: rabbitmq-automation.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rabbitmq Automation
...
## Ресурсы
- backend/rabbitmq-automation/SKILL.md
