...
version: "1.0"
language: ru
original: varnish-fundamentals
---

# Varnish Fundamentals

> Fundamentals for Varnish: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `varnish-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Varnish Fundamentals
...
## Ресурсы
- Оригинал: backend/varnish-fundamentals/SKILL.md
