...
version: "1.0"
language: ru
original: laminas-database
---

# Laminas Database

> Database with Laminas. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Database
...
## Ресурсы
- Оригинальный навык: `backend/laminas-database/SKILL.md`
