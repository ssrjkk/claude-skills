...
category: backend
tags: [laravel-templating, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: laravel-templating
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `laravel-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laravel Templating
...
## Ресурсы
- Оригинальный навык: `backend/laravel-templating/SKILL.md`
