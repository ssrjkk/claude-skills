...
category: backend
tags: [flask-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flask-auth
...
> Authentication with Flask. user auth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flask-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Flask Auth
...
## Ресурсы
- Оригинальный навык: `backend/flask-auth/SKILL.md`
