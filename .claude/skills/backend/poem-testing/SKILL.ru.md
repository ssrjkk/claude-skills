...
version: "1.0"
language: ru
original: poem-testing
---

# Poem Testing

> Testing with Poem. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Testing
...
## Ресурсы
- Оригинальный навык: `backend/poem-testing/SKILL.md`
