...
> ORM with Elixir. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elixir-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Elixir Orm
...
## Ресурсы
- Оригинальный навык: `backend/elixir-orm/SKILL.md`
