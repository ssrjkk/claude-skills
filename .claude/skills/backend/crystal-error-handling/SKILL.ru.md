...
category: backend
tags: [crystal-error-handling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crystal-error-handling
---

# Crystal Error Handling

> Error Handling with Crystal. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crystal-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Crystal Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/crystal-error-handling/SKILL.md`
