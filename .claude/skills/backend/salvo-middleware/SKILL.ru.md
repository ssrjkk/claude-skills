...
version: "1.0"
language: ru
original: salvo-middleware
---

# Salvo Middleware

> Middleware with Salvo. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Middleware
...
## Ресурсы
- Оригинальный навык: `backend/salvo-middleware/SKILL.md`
