...
version: "1.0"
language: ru
original: slim-deployment
---

# Slim Deployment

> Deployment with Slim. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Deployment
...
## Ресурсы
- Оригинальный навык: `backend/slim-deployment/SKILL.md`
