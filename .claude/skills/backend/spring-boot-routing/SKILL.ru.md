...
version: "1.0"
language: ru
original: spring-boot-routing
---

# Spring Boot Routing

> Routing with Spring Boot. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Routing
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-routing/SKILL.md`
