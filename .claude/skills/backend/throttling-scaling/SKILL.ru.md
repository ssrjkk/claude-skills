...
version: "1.0"
language: ru
original: throttling-scaling
---

# Throttling Scaling

> Scaling with Throttling. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `throttling-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Throttling Scaling
...
## Ресурсы
- Оригинальный навык: `backend/throttling-scaling/SKILL.md`
