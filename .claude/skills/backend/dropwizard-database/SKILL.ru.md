...
version: "1.0"
language: ru
original: dropwizard-database
---

# Dropwizard Database

> Database with Dropwizard. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dropwizard-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dropwizard Database
...
## Ресурсы
- Оригинальный навык: `backend/dropwizard-database/SKILL.md`
