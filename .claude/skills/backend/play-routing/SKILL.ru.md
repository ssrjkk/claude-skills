...
version: "1.0"
language: ru
original: play-routing
---

# Play Routing

> Routing with Play. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `play-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Play Routing
...
## Ресурсы
- Оригинальный навык: `backend/play-routing/SKILL.md`
