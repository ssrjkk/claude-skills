...
category: backend
tags: [spark-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-testing
---

# Spark Testing

> Testing with Spark. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spark Testing
...
## Ресурсы
- Оригинальный навык: `backend/spark-testing/SKILL.md`
