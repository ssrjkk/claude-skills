...
version: "1.0"
language: ru
original: masonite-websocket
---

# Masonite Websocket

> WebSocket with Masonite. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `masonite-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Masonite Websocket
...
## Ресурсы
- Оригинальный навык: `backend/masonite-websocket/SKILL.md`
