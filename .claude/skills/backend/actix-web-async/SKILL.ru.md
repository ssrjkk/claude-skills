...
version: "1.0"
language: ru
original: actix-web-async
---

# Actix Web Async

> Async with Actix Web. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-web-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Web Async
...
## Ресурсы
- Оригинальный навык: `backend/actix-web-async/SKILL.md`
