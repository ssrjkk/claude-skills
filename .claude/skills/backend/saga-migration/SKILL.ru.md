...
category: backend
tags: [saga-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saga-migration
---

# Saga Migration

> Migration with Saga. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saga-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Saga Migration
...
## Ресурсы
- Оригинальный навык: `backend/saga-migration/SKILL.md`
