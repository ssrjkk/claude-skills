...
category: backend
tags: [circuit-breaker-migration, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: circuit-breaker-migration
---

# Circuit Breaker Migration

> Migration with Circuit Breaker. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circuit-breaker-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Circuit Breaker Migration
...
## Ресурсы
- Оригинальный навык: `backend/circuit-breaker-migration/SKILL.md`
