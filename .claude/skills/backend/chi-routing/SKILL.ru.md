...
category: backend
tags: [chi-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chi-routing
---

# Chi Routing

> Routing with Chi. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chi-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Chi Routing
...
## Ресурсы
- Оригинальный навык: `backend/chi-routing/SKILL.md`
