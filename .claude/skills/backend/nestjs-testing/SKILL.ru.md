...
category: backend
tags: [nestjs-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-testing
---

# Nestjs Testing

> Testing with NestJS. Jest.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Testing
...
## Ресурсы
- Оригинальный навык: `backend/nestjs-testing/SKILL.md`
