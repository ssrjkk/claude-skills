...
version: "1.0"
language: ru
original: throttling-intro
---

# Throttling Intro

> Introduction with Throttling. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `throttling-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Throttling Intro
...
## Ресурсы
- Оригинальный навык: `backend/throttling-intro/SKILL.md`
