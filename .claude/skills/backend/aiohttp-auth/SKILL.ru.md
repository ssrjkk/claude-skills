...
version: "1.0"
language: ru
original: aiohttp-auth
---

# Aiohttp Auth

> Authentication with aiohttp. user auth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aiohttp-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aiohttp Auth
...
## Ресурсы
- Оригинальный навык: `backend/aiohttp-auth/SKILL.md`
