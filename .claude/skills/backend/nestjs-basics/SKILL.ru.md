...
category: backend
tags: [nestjs-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Basics
...
## Ресурсы
- Оригинальный навык: backend/nestjs-basics/SKILL.md
