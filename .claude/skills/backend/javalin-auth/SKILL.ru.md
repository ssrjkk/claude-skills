---
name: javalin-auth
description: Auth with Javalin. security.
category: backend
tags: [javalin-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: javalin-auth
---

# Javalin Auth

> Auth with Javalin. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javalin-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javalin Auth
...
## Ресурсы
- Оригинальный навык: `backend/javalin-auth/SKILL.md`
