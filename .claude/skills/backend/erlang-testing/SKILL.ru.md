...
category: backend
tags: [erlang-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: erlang-testing
---

# Erlang Testing

> Testing with Erlang. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `erlang-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Erlang Testing
...
## Ресурсы
- Оригинальный навык: `backend/erlang-testing/SKILL.md`
