...
version: "1.0"
language: ru
original: kotlin-config
---

# Kotlin Config

> Configuration with Kotlin. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Config
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-config/SKILL.md`
