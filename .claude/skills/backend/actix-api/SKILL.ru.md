...
category: backend
tags: [actix-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: actix-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Api
...
## Ресурсы
- Оригинальный навык: backend/actix-api/SKILL.md
