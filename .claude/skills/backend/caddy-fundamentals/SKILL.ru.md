...
category: backend
tags: [caddy-fundamentals, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: caddy-fundamentals
---

# Caddy Fundamentals

> Fundamentals for Caddy: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `caddy-fundamentals`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Caddy Fundamentals
...
## Ресурсы
- Оригинал: backend/caddy-fundamentals/SKILL.md
