...
version: "1.0"
language: ru
original: microservices-testing
---

# Microservices Testing

> Testing with Microservices. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microservices-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Microservices Testing
...
## Ресурсы
- Оригинальный навык: `backend/microservices-testing/SKILL.md`
