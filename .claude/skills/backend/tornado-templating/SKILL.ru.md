...
version: "1.0"
language: ru
original: tornado-templating
---

# Tornado Templating

> Templating with Tornado. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Templating
...
## Ресурсы
- Оригинальный навык: `backend/tornado-templating/SKILL.md`
