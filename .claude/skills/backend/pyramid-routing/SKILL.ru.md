...
version: "1.0"
language: ru
original: pyramid-routing
---

# Pyramid Routing

> Routing with Pyramid. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Routing
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-routing/SKILL.md`
