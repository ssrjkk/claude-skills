...
version: "1.0"
language: ru
original: tornado-testing
---

# Tornado Testing

> Testing with Tornado. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tornado-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Tornado Testing
...
## Ресурсы
- Оригинальный навык: `backend/tornado-testing/SKILL.md`
