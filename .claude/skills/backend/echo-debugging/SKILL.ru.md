...
## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-debugging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Debugging
...
## Ресурсы
- Оригинальный навык: backend/echo-debugging/SKILL.md
