...
category: backend
tags: [hono-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-intro
...
> Intro for Hono: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `hono-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Intro
...
## Ресурсы
- Оригинал: backend/hono-intro/SKILL.md
