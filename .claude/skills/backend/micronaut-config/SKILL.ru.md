...
version: "1.0"
language: ru
original: micronaut-config
---

# Micronaut Config

> Config with Micronaut. configuration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Config
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-config/SKILL.md`
