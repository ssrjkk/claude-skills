...
version: "1.0"
language: ru
original: envoy-guides
---

# Envoy Guides

> Guides for Envoy: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `envoy-guides`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Envoy Guides
...
## Ресурсы
- Оригинал: backend/envoy-guides/SKILL.md
