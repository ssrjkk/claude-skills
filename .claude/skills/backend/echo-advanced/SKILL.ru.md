...
## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Advanced
...
## Ресурсы
- Оригинальный навык: backend/echo-advanced/SKILL.md
