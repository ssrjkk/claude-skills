...
category: backend
tags: [phalcon-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: phalcon-auth
---

# Phalcon Auth

> Auth with Phalcon. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Auth
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-auth/SKILL.md`
