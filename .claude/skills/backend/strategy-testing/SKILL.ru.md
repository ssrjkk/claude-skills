...
version: "1.0"
language: ru
original: strategy-testing
---

# Strategy Testing

> Testing with Strategy. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strategy-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strategy Testing
...
## Ресурсы
- Оригинальный навык: `backend/strategy-testing/SKILL.md`
