...
version: "1.0"
language: ru
original: rust-error-handling
---

# Rust Error Handling

> Error Handling with Rust. error management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rust-error-handling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rust Error Handling
...
## Ресурсы
- Оригинальный навык: `backend/rust-error-handling/SKILL.md`
