...
category: backend
tags: [grape-routing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grape-routing
---

# Grape Routing

> Routing with Grape. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grape-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grape Routing
...
## Ресурсы
- Оригинальный навык: `backend/grape-routing/SKILL.md`
