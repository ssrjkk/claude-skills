...
category: backend
tags: [javascript-async, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: javascript-async
---

# Javascript Async

> Async with Javascript. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `javascript-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Javascript Async
...
## Ресурсы
- Оригинальный навык: `backend/javascript-async/SKILL.md`
