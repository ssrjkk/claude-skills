...
category: backend
tags: [spring-boot-monitoring, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-boot-monitoring
---

# Spring Boot Monitoring

> Monitoring with Spring Boot. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-monitoring/SKILL.md`
