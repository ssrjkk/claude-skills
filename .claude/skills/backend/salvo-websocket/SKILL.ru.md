...
version: "1.0"
language: ru
original: salvo-websocket
---

# Salvo Websocket

> WebSocket with Salvo. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `salvo-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Salvo Websocket
...
## Ресурсы
- Оригинальный навык: `backend/salvo-websocket/SKILL.md`
