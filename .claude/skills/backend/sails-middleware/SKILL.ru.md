...
version: "1.0"
language: ru
original: sails-middleware
---

# Sails Middleware

> Middleware with Sails.js. request pipeline.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sails-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sails Middleware
...
## Ресурсы
- Оригинальный навык: `backend/sails-middleware/SKILL.md`
