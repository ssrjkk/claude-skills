...
version: "1.0"
language: ru
original: loopback-websocket
---

# Loopback Websocket

> WebSocket with LoopBack. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Websocket
...
## Ресурсы
- Оригинальный навык: `backend/loopback-websocket/SKILL.md`
