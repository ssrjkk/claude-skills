...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dropwizard-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dropwizard Routing
...
## Ресурсы
- Оригинальный навык: `backend/dropwizard-routing/SKILL.md`
