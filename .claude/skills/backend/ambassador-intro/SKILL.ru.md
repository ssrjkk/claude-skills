...
version: "1.0"
language: ru
original: ambassador-intro
---

# Ambassador Intro

> Introduction with Ambassador. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ambassador-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ambassador Intro
...
## Ресурсы
- Оригинальный навык: `backend/ambassador-intro/SKILL.md`
