...
version: "1.0"
language: ru
original: rocket-async
---

# Rocket Async

> Async with Rocket. async handlers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rocket-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Rocket Async
...
## Ресурсы
- Оригинальный навык: `backend/rocket-async/SKILL.md`
