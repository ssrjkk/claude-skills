...
version: "1.0"
language: ru
original: pyramid-websocket
---

# Pyramid Websocket

> WebSocket with Pyramid. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Websocket
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-websocket/SKILL.md`
