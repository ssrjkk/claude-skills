...
version: "1.0"
language: ru
original: kotlin-rest-api
---

# Kotlin Rest Api

> REST API with Kotlin. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-rest-api/SKILL.md`
