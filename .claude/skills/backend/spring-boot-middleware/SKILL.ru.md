...
category: backend
tags: [spring-boot-middleware, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-boot-middleware
---

# Spring Boot Middleware

> Middleware with Spring Boot. request processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Middleware
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-middleware/SKILL.md`
