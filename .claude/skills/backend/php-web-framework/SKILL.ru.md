...
version: "1.0"
language: ru
original: php-web-framework
---

# Php Web Framework

> Web Framework with Php. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `php-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Php Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/php-web-framework/SKILL.md`
