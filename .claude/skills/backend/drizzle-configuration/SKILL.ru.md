...
version: "1.0"
language: ru
original: drizzle-configuration
---

# Drizzle Configuration

> Configuration for Drizzle: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: drizzle-configuration.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Drizzle Configuration
...
## Ресурсы
- backend/drizzle-configuration/SKILL.md
