...
version: "1.0"
language: ru
original: loopback-database
---

# Loopback Database

> Database with LoopBack. ORM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Database
...
## Ресурсы
- Оригинальный навык: `backend/loopback-database/SKILL.md`
