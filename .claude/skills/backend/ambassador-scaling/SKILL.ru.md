...
version: "1.0"
language: ru
original: ambassador-scaling
---

# Ambassador Scaling

> Scaling with Ambassador. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ambassador-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Ambassador Scaling
...
## Ресурсы
- Оригинальный навык: `backend/ambassador-scaling/SKILL.md`
