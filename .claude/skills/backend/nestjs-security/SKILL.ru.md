...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-security`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Security
...
## Ресурсы
- Оригинальный навык: backend/nestjs-security/SKILL.md
