...
version: "1.0"
language: ru
original: clojure-rest-api
---

# Clojure Rest Api

> REST API with Clojure. building REST APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clojure-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Clojure Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/clojure-rest-api/SKILL.md`
