...
version: "1.0"
language: ru
original: envoy-quickstart
---

# Envoy Quickstart

> Quickstart for Envoy: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `envoy-quickstart`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Envoy Quickstart
...
## Ресурсы
- Оригинал: backend/envoy-quickstart/SKILL.md
