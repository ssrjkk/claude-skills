...
> Introduction with Saga. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saga-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Saga Intro
...
## Ресурсы
- Оригинальный навык: `backend/saga-intro/SKILL.md`
