...
category: backend
tags: [dart-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dart-dependency-injection
---

# Dart Dependency Injection

> DI with Dart. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/dart-dependency-injection/SKILL.md`
