...
version: "1.0"
language: ru
original: laminas-routing
---

# Laminas Routing

> Routing with Laminas. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Routing
...
## Ресурсы
- Оригинальный навык: `backend/laminas-routing/SKILL.md`
