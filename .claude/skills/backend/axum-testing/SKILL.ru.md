...
version: "1.0"
language: ru
original: axum-testing
---

# Axum Testing

> Testing with Axum. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `axum-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Axum Testing
...
## Ресурсы
- Оригинальный навык: `backend/axum-testing/SKILL.md`
