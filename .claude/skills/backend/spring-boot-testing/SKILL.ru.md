...
category: backend
tags: [spring-boot-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spring-boot-testing
---

# Spring Boot Testing

> Testing with Spring Boot. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Testing
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-testing/SKILL.md`
