...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-debugging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Debugging
...
## Ресурсы
- Оригинальный навык: backend/gin-debugging/SKILL.md
