...
version: "1.0"
language: ru
original: warp-database
---

# Warp Database

> Database with Warp. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `warp-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Warp Database
...
## Ресурсы
- Оригинальный навык: `backend/warp-database/SKILL.md`
