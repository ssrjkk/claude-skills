...
> Auth with Slim. authentication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slim-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Slim Auth
...
## Ресурсы
- Оригинальный навык: `backend/slim-auth/SKILL.md`
