...
version: "1.0"
language: ru
original: revel-config
---

# Revel Config

> Config with Revel. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Config
...
## Ресурсы
- Оригинальный навык: `backend/revel-config/SKILL.md`
