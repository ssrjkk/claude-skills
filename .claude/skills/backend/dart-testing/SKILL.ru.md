...
version: "1.0"
language: ru
original: dart-testing
---

# Dart Testing

> Testing with Dart. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Testing
...
## Ресурсы
- Оригинальный навык: `backend/dart-testing/SKILL.md`
