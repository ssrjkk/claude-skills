...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Testing
...
## Ресурсы
- Оригинальный навык: `backend/fastapi-testing/SKILL.md`
