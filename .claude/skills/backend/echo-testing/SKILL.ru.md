...
version: "1.0"
language: ru
original: echo-testing
---

# Echo Testing

> Testing with Echo. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `echo-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Echo Testing
...
## Ресурсы
- Оригинальный навык: `backend/echo-testing/SKILL.md`
