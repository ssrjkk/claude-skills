...
> Testing with Go. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `go-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Go Testing
...
## Ресурсы
- Оригинальный навык: `backend/go-testing/SKILL.md`
