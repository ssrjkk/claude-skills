...
version: "1.0"
language: ru
original: phalcon-api
---

# Phalcon Api

> API with Phalcon. APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Api
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-api/SKILL.md`
