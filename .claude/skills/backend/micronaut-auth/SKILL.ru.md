...
version: "1.0"
language: ru
original: micronaut-auth
---

# Micronaut Auth

> Auth with Micronaut. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Auth
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-auth/SKILL.md`
