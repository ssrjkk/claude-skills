...
version: "1.0"
language: ru
original: grails-middleware
---

# Grails Middleware

> Middleware with Grails. request processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grails-middleware`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Grails Middleware
...
## Ресурсы
- Оригинальный навык: `backend/grails-middleware/SKILL.md`
