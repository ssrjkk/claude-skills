...
version: "1.0"
language: ru
original: scala-web-framework
---

# Scala Web Framework

> Web Framework with Scala. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scala-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Scala Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/scala-web-framework/SKILL.md`
