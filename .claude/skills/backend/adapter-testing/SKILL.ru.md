...
version: "1.0"
language: ru
original: adapter-testing
---

# Adapter Testing

> Testing with Adapter. testing the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adapter-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Adapter Testing
...
## Ресурсы
- Оригинальный навык: `backend/adapter-testing/SKILL.md`
