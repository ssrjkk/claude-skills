...
version: "1.0"
language: ru
original: micronaut-testing
---

# Micronaut Testing

> Testing with Micronaut. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Testing
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-testing/SKILL.md`
