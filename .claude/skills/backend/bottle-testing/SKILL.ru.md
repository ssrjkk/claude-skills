...
version: "1.0"
language: ru
original: bottle-testing
---

# Bottle Testing

> Testing with Bottle. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bottle-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bottle Testing
...
## Ресурсы
- Оригинальный навык: `backend/bottle-testing/SKILL.md`
