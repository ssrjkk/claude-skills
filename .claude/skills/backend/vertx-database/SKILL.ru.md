...
category: backend
tags: [vertx-database, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vertx-database
---

# Vertx Database

> Database with Vert.x. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vertx-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Vertx Database
...
## Ресурсы
- Оригинальный навык: `backend/vertx-database/SKILL.md`
