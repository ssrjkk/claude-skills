...
version: "1.0"
language: ru
original: typescript-cli-tool
---

# Typescript Cli Tool

> CLI Tool with Typescript. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/typescript-cli-tool/SKILL.md`
