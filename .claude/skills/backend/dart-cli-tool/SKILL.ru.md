...
category: backend
tags: [dart-cli-tool, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dart-cli-tool
---

# Dart Cli Tool

> CLI Tool with Dart. building CLI tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-cli-tool`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dart Cli Tool
...
## Ресурсы
- Оригинальный навык: `backend/dart-cli-tool/SKILL.md`
