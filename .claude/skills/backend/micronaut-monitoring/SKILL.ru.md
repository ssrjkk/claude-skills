...
version: "1.0"
language: ru
original: micronaut-monitoring
---

# Micronaut Monitoring

> Monitoring with Micronaut. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micronaut-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Micronaut Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/micronaut-monitoring/SKILL.md`
