...
version: "1.0"
language: ru
original: zig-testing
---

# Zig Testing

> Testing with Zig. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Testing
...
## Ресурсы
- Оригинальный навык: `backend/zig-testing/SKILL.md`
