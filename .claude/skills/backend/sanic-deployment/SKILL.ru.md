...
version: "1.0"
language: ru
original: sanic-deployment
---

# Sanic Deployment

> Deployment with Sanic. production deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sanic-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sanic Deployment
...
## Ресурсы
- Оригинальный навык: `backend/sanic-deployment/SKILL.md`
