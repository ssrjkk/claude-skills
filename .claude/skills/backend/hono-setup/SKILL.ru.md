...
category: backend
tags: [hono-setup, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hono-setup
...
> Setup for Hono: setup guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `hono-setup`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Hono Setup
...
## Ресурсы
- Оригинал: backend/hono-setup/SKILL.md
