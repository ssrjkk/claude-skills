...
version: "1.0"
language: ru
original: sinatra-templating
---

# Sinatra Templating

> Templating with Sinatra. ERB.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sinatra-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Sinatra Templating
...
## Ресурсы
- Оригинальный навык: `backend/sinatra-templating/SKILL.md`
