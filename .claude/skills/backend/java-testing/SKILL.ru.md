...
version: "1.0"
language: ru
original: java-testing
---

# Java Testing

> Testing with Java. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `java-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Java Testing
...
## Ресурсы
- Оригинальный навык: `backend/java-testing/SKILL.md`
