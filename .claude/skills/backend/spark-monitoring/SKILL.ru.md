...
category: backend
tags: [spark-monitoring, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-monitoring
---

# Spark Monitoring

> Monitoring with Spark. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spark Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/spark-monitoring/SKILL.md`
