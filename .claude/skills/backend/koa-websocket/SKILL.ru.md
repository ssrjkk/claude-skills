...
version: "1.0"
language: ru
original: koa-websocket
---

# Koa Websocket

> WebSocket with Koa. Socket.io.

## Быстрый старт
Этот навык на русском языке. Оригинал: `koa-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Koa Websocket
...
## Ресурсы
- Оригинальный навык: `backend/koa-websocket/SKILL.md`
