...
category: backend
tags: [django-auth, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: django-auth
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Auth
...
## Ресурсы
- Оригинальный навык: `backend/django-auth/SKILL.md`
