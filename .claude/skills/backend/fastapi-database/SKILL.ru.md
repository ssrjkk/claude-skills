...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Database
...
## Ресурсы
- Оригинальный навык: `backend/fastapi-database/SKILL.md`
