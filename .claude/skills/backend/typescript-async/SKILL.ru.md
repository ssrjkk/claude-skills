...
version: "1.0"
language: ru
original: typescript-async
---

# Typescript Async

> Async with Typescript. async operations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `typescript-async`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Typescript Async
...
## Ресурсы
- Оригинальный навык: `backend/typescript-async/SKILL.md`
