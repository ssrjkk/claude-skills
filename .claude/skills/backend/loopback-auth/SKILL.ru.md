...
version: "1.0"
language: ru
original: loopback-auth
---

# Loopback Auth

> Auth with LoopBack. JWT.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loopback-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Loopback Auth
...
## Ресурсы
- Оригинальный навык: `backend/loopback-auth/SKILL.md`
