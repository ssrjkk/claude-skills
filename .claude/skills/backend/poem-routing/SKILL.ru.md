...
version: "1.0"
language: ru
original: poem-routing
---

# Poem Routing

> Routing with Poem. HTTP routing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `poem-routing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Poem Routing
...
## Ресурсы
- Оригинальный навык: `backend/poem-routing/SKILL.md`
