...
category: backend
tags: [gin-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gin-testing
---

# Gin Testing

> Testing with Gin. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gin-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Gin Testing
...
## Ресурсы
- Оригинальный навык: `backend/gin-testing/SKILL.md`
