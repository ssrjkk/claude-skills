...
version: "1.0"
language: ru
original: dropwizard-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dropwizard-monitoring`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dropwizard Monitoring
...
## Ресурсы
- Оригинальный навык: `backend/dropwizard-monitoring/SKILL.md`
