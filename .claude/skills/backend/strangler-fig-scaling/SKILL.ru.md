...
category: backend
tags: [strangler-fig-scaling, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: strangler-fig-scaling
---

# Strangler Fig Scaling

> Scaling with Strangler Fig. scaling considerations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `strangler-fig-scaling`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Strangler Fig Scaling
...
## Ресурсы
- Оригинальный навык: `backend/strangler-fig-scaling/SKILL.md`
