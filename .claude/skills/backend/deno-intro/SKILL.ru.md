...
category: backend
tags: [deno-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: deno-intro
...
> Intro for Deno: introduction

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `deno-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Deno Intro
...
## Ресурсы
- Оригинал: backend/deno-intro/SKILL.md
