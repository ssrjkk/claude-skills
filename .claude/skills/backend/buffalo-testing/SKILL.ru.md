...
category: backend
tags: [buffalo-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: buffalo-testing
---

# Buffalo Testing

> Testing with Buffalo. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buffalo-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Buffalo Testing
...
## Ресурсы
- Оригинальный навык: `backend/buffalo-testing/SKILL.md`
