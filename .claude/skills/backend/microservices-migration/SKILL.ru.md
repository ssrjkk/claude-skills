...
version: "1.0"
language: ru
original: microservices-migration
---

# Microservices Migration

> Migration with Microservices. adopting the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microservices-migration`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Microservices Migration
...
## Ресурсы
- Оригинальный навык: `backend/microservices-migration/SKILL.md`
