...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Templating
...
## Ресурсы
- Оригинальный навык: `backend/fastapi-templating/SKILL.md`
