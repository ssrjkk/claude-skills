...
version: "1.0"
language: ru
original: haskell-config
---

# Haskell Config

> Configuration with Haskell. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Config
...
## Ресурсы
- Оригинальный навык: `backend/haskell-config/SKILL.md`
