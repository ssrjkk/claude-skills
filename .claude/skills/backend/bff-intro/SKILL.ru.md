...
category: backend
tags: [bff-intro, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bff-intro
...
> Introduction with Backend for Frontend. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bff-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bff Intro
...
## Ресурсы
- Оригинальный навык: `backend/bff-intro/SKILL.md`
