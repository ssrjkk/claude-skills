...
version: "1.0"
language: ru
original: phalcon-database
---

# Phalcon Database

> Database with Phalcon. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phalcon-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Phalcon Database
...
## Ресурсы
- Оригинальный навык: `backend/phalcon-database/SKILL.md`
