...
version: "1.0"
language: ru
original: yii-deployment
---

# Yii Deployment

> Deployment with Yii. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Deployment
...
## Ресурсы
- Оригинальный навык: `backend/yii-deployment/SKILL.md`
