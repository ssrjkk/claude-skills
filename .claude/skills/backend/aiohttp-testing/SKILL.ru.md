...
version: "1.0"
language: ru
original: aiohttp-testing
---

# Aiohttp Testing

> Testing with aiohttp. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aiohttp-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Aiohttp Testing
...
## Ресурсы
- Оригинальный навык: `backend/aiohttp-testing/SKILL.md`
