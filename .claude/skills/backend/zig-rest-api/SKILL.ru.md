...
category: backend
tags: [zig-rest-api, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zig-rest-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-rest-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Rest Api
...
## Ресурсы
- Оригинальный навык: `backend/zig-rest-api/SKILL.md`
