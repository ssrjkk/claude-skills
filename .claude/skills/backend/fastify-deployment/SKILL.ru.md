...
version: "1.0"
language: ru
original: fastify-deployment
---

# Fastify Deployment

> Deployment with Fastify. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastify-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastify Deployment
...
## Ресурсы
- Оригинальный навык: `backend/fastify-deployment/SKILL.md`
