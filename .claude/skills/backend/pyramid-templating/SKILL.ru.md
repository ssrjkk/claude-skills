...
version: "1.0"
language: ru
original: pyramid-templating
---

# Pyramid Templating

> Templating with Pyramid. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pyramid-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Pyramid Templating
...
## Ресурсы
- Оригинальный навык: `backend/pyramid-templating/SKILL.md`
