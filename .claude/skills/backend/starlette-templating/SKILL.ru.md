...
version: "1.0"
language: ru
original: starlette-templating
---

# Starlette Templating

> Templating with Starlette. server templates.

## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-templating`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Templating
...
## Ресурсы
- Оригинальный навык: `backend/starlette-templating/SKILL.md`
