...
category: backend
tags: [bottle-websocket, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bottle-websocket
---

# Bottle Websocket

> WebSocket with Bottle. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bottle-websocket`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Bottle Websocket
...
## Ресурсы
- Оригинальный навык: `backend/bottle-websocket/SKILL.md`
