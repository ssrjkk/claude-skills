...
version: "1.0"
language: ru
original: laminas-testing
---

# Laminas Testing

> Testing with Laminas. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laminas-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laminas Testing
...
## Ресурсы
- Оригинальный навык: `backend/laminas-testing/SKILL.md`
