...
category: backend
tags: [zig-dependency-injection, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zig-dependency-injection
---

# Zig Dependency Injection

> DI with Zig. DI containers.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zig-dependency-injection`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Zig Dependency Injection
...
## Ресурсы
- Оригинальный навык: `backend/zig-dependency-injection/SKILL.md`
