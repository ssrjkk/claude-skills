...
## Быстрый старт
Этот навык на русском языке. Оригинал: `fastapi-advanced`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Fastapi Advanced
...
## Ресурсы
- Оригинальный навык: backend/fastapi-advanced/SKILL.md
