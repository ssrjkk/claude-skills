...
version: "1.0"
language: ru
original: yii-database
---

# Yii Database

> Database with Yii. Eloquent.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yii-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Yii Database
...
## Ресурсы
- Оригинальный навык: `backend/yii-database/SKILL.md`
