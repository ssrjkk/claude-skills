...
version: "1.0"
language: ru
original: warp-testing
---

# Warp Testing

> Testing with Warp. unit tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `warp-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Warp Testing
...
## Ресурсы
- Оригинальный навык: `backend/warp-testing/SKILL.md`
