...
version: "1.0"
language: ru
original: factory-intro
---

# Factory Intro

> Introduction with Factory. understanding the pattern.

## Быстрый старт
Этот навык на русском языке. Оригинал: `factory-intro`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Factory Intro
...
## Ресурсы
- Оригинальный навык: `backend/factory-intro/SKILL.md`
