...
> ORM with Swift. database access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-orm`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Swift Orm
...
## Ресурсы
- Оригинальный навык: `backend/swift-orm/SKILL.md`
