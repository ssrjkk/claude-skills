...
version: "1.0"
language: ru
original: revel-deployment
---

# Revel Deployment

> Deployment with Revel. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `revel-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Revel Deployment
...
## Ресурсы
- Оригинальный навык: `backend/revel-deployment/SKILL.md`
