...
category: backend
tags: [celery-getting-started, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: celery-getting-started
---

# Celery Getting Started

> Getting Started for Celery: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: celery-getting-started.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Celery Getting Started
...
## Ресурсы
- backend/celery-getting-started/SKILL.md
