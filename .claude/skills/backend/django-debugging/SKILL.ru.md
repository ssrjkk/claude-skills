...
category: backend
tags: [django-debugging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: django-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `django-debugging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Django Debugging
...
## Ресурсы
- Оригинальный навык: backend/django-debugging/SKILL.md
