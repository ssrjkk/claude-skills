...
## Быстрый старт
Этот навык на русском языке. Оригинал: `starlette-auth`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Starlette Auth
...
## Ресурсы
- Оригинальный навык: `backend/starlette-auth/SKILL.md`
