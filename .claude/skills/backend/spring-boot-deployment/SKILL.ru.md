...
version: "1.0"
language: ru
original: spring-boot-deployment
---

# Spring Boot Deployment

> Deployment with Spring Boot. build.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spring-boot-deployment`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Spring Boot Deployment
...
## Ресурсы
- Оригинальный навык: `backend/spring-boot-deployment/SKILL.md`
