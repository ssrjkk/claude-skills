...
version: "1.0"
language: ru
original: codeigniter-api
---

# Codeigniter Api

> API with CodeIgniter. APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codeigniter-api`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Codeigniter Api
...
## Ресурсы
- Оригинальный навык: `backend/codeigniter-api/SKILL.md`
