...
category: backend
tags: [actix-basics, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: actix-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `actix-basics`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Actix Basics
...
## Ресурсы
- Оригинальный навык: backend/actix-basics/SKILL.md
