...
category: backend
tags: [nestjs-debugging, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nestjs-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nestjs-debugging`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Nestjs Debugging
...
## Ресурсы
- Оригинальный навык: backend/nestjs-debugging/SKILL.md
