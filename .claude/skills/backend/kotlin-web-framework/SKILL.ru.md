...
category: backend
tags: [kotlin-web-framework, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-web-framework
---

# Kotlin Web Framework

> Web Framework with Kotlin. web dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-web-framework`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Kotlin Web Framework
...
## Ресурсы
- Оригинальный навык: `backend/kotlin-web-framework/SKILL.md`
