...
version: "1.0"
language: ru
original: quarkus-database
---

# Quarkus Database

> Database with Quarkus. DB access.

## Быстрый старт
Этот навык на русском языке. Оригинал: `quarkus-database`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Quarkus Database
...
## Ресурсы
- Оригинальный навык: `backend/quarkus-database/SKILL.md`
