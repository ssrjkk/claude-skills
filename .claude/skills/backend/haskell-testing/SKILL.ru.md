...
version: "1.0"
language: ru
original: haskell-testing
---

# Haskell Testing

> Testing with Haskell. writing tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `haskell-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Haskell Testing
...
## Ресурсы
- Оригинальный навык: `backend/haskell-testing/SKILL.md`
