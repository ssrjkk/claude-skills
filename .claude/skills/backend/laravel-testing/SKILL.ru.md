...
category: backend
tags: [laravel-testing, backend, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: laravel-testing
---

# Laravel Testing

> Testing with Laravel. PHPUnit.

## Быстрый старт
Этот навык на русском языке. Оригинал: `laravel-testing`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Laravel Testing
...
## Ресурсы
- Оригинальный навык: `backend/laravel-testing/SKILL.md`
