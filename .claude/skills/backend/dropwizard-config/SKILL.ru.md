...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dropwizard-config`.

## Когда использовать
- Работа с Бэкенд-разработка
- Выполнение задач, связанных с Dropwizard Config
...
## Ресурсы
- Оригинальный навык: `backend/dropwizard-config/SKILL.md`
