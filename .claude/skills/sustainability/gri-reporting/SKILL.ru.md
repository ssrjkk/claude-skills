...
tags: [gri-reporting, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gri-reporting
---

# Gri Reporting

> Reporting with GRI. reporting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-reporting`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Reporting
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-reporting/SKILL.md`
