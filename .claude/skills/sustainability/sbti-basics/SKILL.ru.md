...
tags: [sbti-basics, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sbti-basics
---

# Sbti Basics

> Basics with SBTi. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbti-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sbti Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/sbti-basics/SKILL.md`
