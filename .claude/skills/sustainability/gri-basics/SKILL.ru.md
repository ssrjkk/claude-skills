...
> Basics with GRI. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-basics/SKILL.md`
