...
tags: [ghg-protocol-basics, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ghg-protocol-basics
---

# Ghg Protocol Basics

> Basics with GHG Protocol. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ghg-protocol-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Ghg Protocol Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/ghg-protocol-basics/SKILL.md`
