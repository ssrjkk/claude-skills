...
version: "1.0"
language: ru
original: ghg-protocol-measurement
---

# Ghg Protocol Measurement

> Measurement with GHG Protocol. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ghg-protocol-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Ghg Protocol Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/ghg-protocol-measurement/SKILL.md`
