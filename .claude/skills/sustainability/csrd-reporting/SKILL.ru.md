...
version: "1.0"
language: ru
original: csrd-reporting
---

# Csrd Reporting

> Reporting with CSRD. reporting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csrd-reporting`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Csrd Reporting
...
## Ресурсы
- Оригинальный навык: `sustainability/csrd-reporting/SKILL.md`
