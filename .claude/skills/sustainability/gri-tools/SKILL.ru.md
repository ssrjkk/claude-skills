...
tags: [gri-tools, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gri-tools
...
> Tools with GRI. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-tools`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Tools
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-tools/SKILL.md`
