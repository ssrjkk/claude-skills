...
## Быстрый старт
Этот навык на русском языке. Оригинал: `esg-reporting`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Esg Reporting
...
## Ресурсы
- Оригинальный навык: `sustainability/esg-reporting/SKILL.md`
