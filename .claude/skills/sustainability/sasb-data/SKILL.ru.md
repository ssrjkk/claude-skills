...
tags: [sasb-data, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sasb-data
...
> Data with SASB. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sasb-data`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sasb Data
...
## Ресурсы
- Оригинальный навык: `sustainability/sasb-data/SKILL.md`
