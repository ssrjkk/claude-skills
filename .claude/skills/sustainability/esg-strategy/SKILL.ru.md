...
version: "1.0"
language: ru
original: esg-strategy
---

# Esg Strategy

> Strategy with ESG. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esg-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Esg Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/esg-strategy/SKILL.md`
