...
version: "1.0"
language: ru
original: csrd-basics
---

# Csrd Basics

> Basics with CSRD. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csrd-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Csrd Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/csrd-basics/SKILL.md`
