...
> Tools with ESG. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esg-tools`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Esg Tools
...
## Ресурсы
- Оригинальный навык: `sustainability/esg-tools/SKILL.md`
