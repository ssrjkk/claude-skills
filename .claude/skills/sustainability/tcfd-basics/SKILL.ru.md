...
tags: [tcfd-basics, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tcfd-basics
---

# Tcfd Basics

> Basics with TCFD. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcfd-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Tcfd Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/tcfd-basics/SKILL.md`
