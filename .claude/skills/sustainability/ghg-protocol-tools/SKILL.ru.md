...
version: "1.0"
language: ru
original: ghg-protocol-tools
---

# Ghg Protocol Tools

> Tools with GHG Protocol. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ghg-protocol-tools`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Ghg Protocol Tools
...
## Ресурсы
- Оригинальный навык: `sustainability/ghg-protocol-tools/SKILL.md`
