...
tags: [tcfd-strategy, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tcfd-strategy
---

# Tcfd Strategy

> Strategy with TCFD. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tcfd-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Tcfd Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/tcfd-strategy/SKILL.md`
