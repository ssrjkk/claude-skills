...
tags: [sbti-data, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sbti-data
...
> Data with SBTi. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbti-data`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sbti Data
...
## Ресурсы
- Оригинальный навык: `sustainability/sbti-data/SKILL.md`
