...
version: "1.0"
language: ru
original: ghg-protocol-data
---

# Ghg Protocol Data

> Data with GHG Protocol. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ghg-protocol-data`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Ghg Protocol Data
...
## Ресурсы
- Оригинальный навык: `sustainability/ghg-protocol-data/SKILL.md`
