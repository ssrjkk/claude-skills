...
version: "1.0"
language: ru
original: sasb-measurement
---

# Sasb Measurement

> Measurement with SASB. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sasb-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sasb Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/sasb-measurement/SKILL.md`
