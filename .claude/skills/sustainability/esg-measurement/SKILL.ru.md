...
tags: [esg-measurement, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: esg-measurement
---

# Esg Measurement

> Measurement with ESG. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esg-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Esg Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/esg-measurement/SKILL.md`
