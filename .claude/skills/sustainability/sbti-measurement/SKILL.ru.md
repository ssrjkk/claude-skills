...
version: "1.0"
language: ru
original: sbti-measurement
---

# Sbti Measurement

> Measurement with SBTi. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbti-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sbti Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/sbti-measurement/SKILL.md`
