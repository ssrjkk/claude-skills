...
> Tools with SBTi. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbti-tools`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sbti Tools
...
## Ресурсы
- Оригинальный навык: `sustainability/sbti-tools/SKILL.md`
