...
version: "1.0"
language: ru
original: gri-measurement
---

# Gri Measurement

> Measurement with GRI. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-measurement/SKILL.md`
