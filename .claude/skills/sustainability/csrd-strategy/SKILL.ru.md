...
tags: [csrd-strategy, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: csrd-strategy
---

# Csrd Strategy

> Strategy with CSRD. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csrd-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Csrd Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/csrd-strategy/SKILL.md`
