...
version: "1.0"
language: ru
original: carbon-accounting-strategy
---

# Carbon Accounting Strategy

> Strategy with Carbon Accounting. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `carbon-accounting-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Carbon Accounting Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/carbon-accounting-strategy/SKILL.md`
