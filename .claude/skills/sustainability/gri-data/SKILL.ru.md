...
> Data with GRI. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-data`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Data
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-data/SKILL.md`
