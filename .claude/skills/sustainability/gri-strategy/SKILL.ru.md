...
version: "1.0"
language: ru
original: gri-strategy
---

# Gri Strategy

> Strategy with GRI. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gri-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Gri Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/gri-strategy/SKILL.md`
