...
> Basics with ESG. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esg-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Esg Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/esg-basics/SKILL.md`
