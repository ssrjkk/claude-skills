...
version: "1.0"
language: ru
original: sasb-strategy
---

# Sasb Strategy

> Strategy with SASB. strategy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sasb-strategy`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sasb Strategy
...
## Ресурсы
- Оригинальный навык: `sustainability/sasb-strategy/SKILL.md`
