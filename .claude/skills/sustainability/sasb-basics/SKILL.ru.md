...
version: "1.0"
language: ru
original: sasb-basics
---

# Sasb Basics

> Basics with SASB. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sasb-basics`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sasb Basics
...
## Ресурсы
- Оригинальный навык: `sustainability/sasb-basics/SKILL.md`
