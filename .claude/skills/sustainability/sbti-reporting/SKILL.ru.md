...
tags: [sbti-reporting, sustainability, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sbti-reporting
---

# Sbti Reporting

> Reporting with SBTi. reporting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sbti-reporting`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Sbti Reporting
...
## Ресурсы
- Оригинальный навык: `sustainability/sbti-reporting/SKILL.md`
