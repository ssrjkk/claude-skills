...
version: "1.0"
language: ru
original: csrd-measurement
---

# Csrd Measurement

> Measurement with CSRD. measurement.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csrd-measurement`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Csrd Measurement
...
## Ресурсы
- Оригинальный навык: `sustainability/csrd-measurement/SKILL.md`
