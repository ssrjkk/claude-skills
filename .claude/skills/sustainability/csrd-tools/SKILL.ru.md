...
> Tools with CSRD. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `csrd-tools`.

## Когда использовать
- Работа с Устойчивое развитие
- Выполнение задач, связанных с Csrd Tools
...
## Ресурсы
- Оригинальный навык: `sustainability/csrd-tools/SKILL.md`
