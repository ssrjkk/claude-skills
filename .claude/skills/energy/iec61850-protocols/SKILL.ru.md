...
version: "1.0"
language: ru
original: iec61850-protocols
---

# Iec61850 Protocols

> Protocols with IEC 61850. communication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iec61850-protocols`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Iec61850 Protocols
...
## Ресурсы
- Оригинальный навык: `energy/iec61850-protocols/SKILL.md`
