...
version: "1.0"
language: ru
original: dnp3-basics
---

# Dnp3 Basics

> Basics with DNP3. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dnp3-basics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Dnp3 Basics
...
## Ресурсы
- Оригинальный навык: `energy/dnp3-basics/SKILL.md`
