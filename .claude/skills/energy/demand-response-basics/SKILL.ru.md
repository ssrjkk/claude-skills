...
version: "1.0"
language: ru
original: demand-response-basics
---

# Demand Response Basics

> Basics with Demand Response. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `demand-response-basics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Demand Response Basics
...
## Ресурсы
- Оригинальный навык: `energy/demand-response-basics/SKILL.md`
