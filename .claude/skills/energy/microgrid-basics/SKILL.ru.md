...
version: "1.0"
language: ru
original: microgrid-basics
---

# Microgrid Basics

> Basics with Microgrid. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microgrid-basics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Microgrid Basics
...
## Ресурсы
- Оригинальный навык: `energy/microgrid-basics/SKILL.md`
