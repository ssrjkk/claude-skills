...
category: energy
tags: [plc-basics, energy, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plc-basics
...
> Basics with PLC Programming. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plc-basics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Plc Basics
...
## Ресурсы
- Оригинальный навык: `energy/plc-basics/SKILL.md`
