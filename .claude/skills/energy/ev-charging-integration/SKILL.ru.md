...
category: energy
tags: [ev-charging-integration, energy, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ev-charging-integration
---

# Ev Charging Integration

> Integration with EV Charging. grid integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ev-charging-integration`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Ev Charging Integration
...
## Ресурсы
- Оригинальный навык: `energy/ev-charging-integration/SKILL.md`
