...
version: "1.0"
language: ru
original: iec61850-analytics
---

# Iec61850 Analytics

> Analytics with IEC 61850. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `iec61850-analytics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Iec61850 Analytics
...
## Ресурсы
- Оригинальный навык: `energy/iec61850-analytics/SKILL.md`
