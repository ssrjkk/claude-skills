...
version: "1.0"
language: ru
original: scada-protocols
---

# Scada Protocols

> Protocols with SCADA. communication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scada-protocols`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Scada Protocols
...
## Ресурсы
- Оригинальный навык: `energy/scada-protocols/SKILL.md`
