...
version: "1.0"
language: ru
original: ev-charging-design
---

# Ev Charging Design

> Design with EV Charging. system design.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ev-charging-design`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Ev Charging Design
...
## Ресурсы
- Оригинальный навык: `energy/ev-charging-design/SKILL.md`
