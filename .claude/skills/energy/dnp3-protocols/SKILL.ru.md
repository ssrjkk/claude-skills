...
version: "1.0"
language: ru
original: dnp3-protocols
---

# Dnp3 Protocols

> Protocols with DNP3. communication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dnp3-protocols`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Dnp3 Protocols
...
## Ресурсы
- Оригинальный навык: `energy/dnp3-protocols/SKILL.md`
