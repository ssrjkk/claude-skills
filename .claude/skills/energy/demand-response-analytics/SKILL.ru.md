...
version: "1.0"
language: ru
original: demand-response-analytics
---

# Demand Response Analytics

> Analytics with Demand Response. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `demand-response-analytics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Demand Response Analytics
...
## Ресурсы
- Оригинальный навык: `energy/demand-response-analytics/SKILL.md`
