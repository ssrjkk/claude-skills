...
version: "1.0"
language: ru
original: ev-charging-optimization
---

# Ev Charging Optimization

> Optimization with EV Charging. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ev-charging-optimization`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Ev Charging Optimization
...
## Ресурсы
- Оригинальный навык: `energy/ev-charging-optimization/SKILL.md`
