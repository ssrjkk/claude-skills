...
version: "1.0"
language: ru
original: scada-basics
---

# Scada Basics

> Basics with SCADA. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scada-basics`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Scada Basics
...
## Ресурсы
- Оригинальный навык: `energy/scada-basics/SKILL.md`
