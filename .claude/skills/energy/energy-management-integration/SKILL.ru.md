...
version: "1.0"
language: ru
original: energy-management-integration
---

# Energy Management Integration

> Integration with Energy Management. grid integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `energy-management-integration`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Energy Management Integration
...
## Ресурсы
- Оригинальный навык: `energy/energy-management-integration/SKILL.md`
