...
version: "1.0"
language: ru
original: modbus-protocols
---

# Modbus Protocols

> Protocols with Modbus. communication.

## Быстрый старт
Этот навык на русском языке. Оригинал: `modbus-protocols`.

## Когда использовать
- Работа с Энергетика
- Выполнение задач, связанных с Modbus Protocols
...
## Ресурсы
- Оригинальный навык: `energy/modbus-protocols/SKILL.md`
