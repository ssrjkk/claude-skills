...
version: "1.0"
language: ru
original: tech-debt-measurement
---

# Tech Debt Measurement

> Measurement with Tech Debt Management. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tech-debt-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tech Debt Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/tech-debt-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
