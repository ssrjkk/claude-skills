...
version: "1.0"
language: ru
original: c4-model-basics
---

# C4 Model Basics

> Basics with C4 Model. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `c4-model-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с C4 Model Basics
...
## Ресурсы
- Оригинальный навык: `engineering/c4-model-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
