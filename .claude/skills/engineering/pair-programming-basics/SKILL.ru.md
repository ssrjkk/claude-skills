...
version: "1.0"
language: ru
original: pair-programming-basics
---

# Pair Programming Basics

> Basics with Pair Programming. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pair-programming-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Pair Programming Basics
...
## Ресурсы
- Оригинальный навык: `engineering/pair-programming-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
