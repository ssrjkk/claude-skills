...
tags: [tdd-measurement, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tdd-measurement
---

# Tdd Measurement

> Measurement with TDD. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tdd-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tdd Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/tdd-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
