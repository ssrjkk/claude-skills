...
> Diagrams with System Design. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `system-design-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с System Design Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/system-design-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
