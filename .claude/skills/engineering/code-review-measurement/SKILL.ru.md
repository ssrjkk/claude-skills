...
version: "1.0"
language: ru
original: code-review-measurement
---

# Code Review Measurement

> Measurement with Code Review. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `code-review-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Code Review Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/code-review-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
