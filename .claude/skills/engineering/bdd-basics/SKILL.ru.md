...
> Basics with BDD. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bdd-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bdd Basics
...
## Ресурсы
- Оригинальный навык: `engineering/bdd-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
