...
version: "1.0"
language: ru
original: api-design-basics
---

# Api Design Basics

> Basics with API Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-design-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Api Design Basics
...
## Ресурсы
- Оригинальный навык: `engineering/api-design-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
