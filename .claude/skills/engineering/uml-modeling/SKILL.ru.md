...
version: "1.0"
language: ru
original: uml-modeling
---

# Uml Modeling

> Modeling with UML. system modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `uml-modeling`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Uml Modeling
...
## Ресурсы
- Оригинальный навык: `engineering/uml-modeling/SKILL.md`
- Категория: Инженерия
- Язык: Русский
