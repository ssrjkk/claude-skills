...
version: "1.0"
language: ru
original: mermaid-tools
---

# Mermaid Tools

> Tools with Mermaid.js. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mermaid-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Mermaid Tools
...
## Ресурсы
- Оригинальный навык: `engineering/mermaid-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
