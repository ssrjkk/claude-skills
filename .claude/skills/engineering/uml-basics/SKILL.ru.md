...
> Basics with UML. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `uml-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Uml Basics
...
## Ресурсы
- Оригинальный навык: `engineering/uml-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
