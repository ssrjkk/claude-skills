...
tags: [refactoring-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: refactoring-team
---

# Refactoring Team

> Team with Refactoring. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `refactoring-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Refactoring Team
...
## Ресурсы
- Оригинальный навык: `engineering/refactoring-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
