...
version: "1.0"
language: ru
original: bpmn-collaboration
---

# Bpmn Collaboration

> Collaboration with BPMN. team collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bpmn-collaboration`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bpmn Collaboration
...
## Ресурсы
- Оригинальный навык: `engineering/bpmn-collaboration/SKILL.md`
- Категория: Инженерия
- Язык: Русский
