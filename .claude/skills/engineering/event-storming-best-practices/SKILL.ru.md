...
version: "1.0"
language: ru
original: event-storming-best-practices
---

# Event Storming Best Practices

> Best Practices with Event Storming. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-storming-best-practices`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Event Storming Best Practices
...
## Ресурсы
- Оригинальный навык: `engineering/event-storming-best-practices/SKILL.md`
- Категория: Инженерия
- Язык: Русский
