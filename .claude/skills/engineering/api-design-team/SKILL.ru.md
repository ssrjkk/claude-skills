...
tags: [api-design-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: api-design-team
---

# Api Design Team

> Team with API Design. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-design-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Api Design Team
...
## Ресурсы
- Оригинальный навык: `engineering/api-design-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
