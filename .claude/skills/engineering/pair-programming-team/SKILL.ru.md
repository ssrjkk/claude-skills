...
tags: [pair-programming-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pair-programming-team
---

# Pair Programming Team

> Team with Pair Programming. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pair-programming-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Pair Programming Team
...
## Ресурсы
- Оригинальный навык: `engineering/pair-programming-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
