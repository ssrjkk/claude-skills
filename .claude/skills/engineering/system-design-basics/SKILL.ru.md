...
version: "1.0"
language: ru
original: system-design-basics
---

# System Design Basics

> Basics with System Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `system-design-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с System Design Basics
...
## Ресурсы
- Оригинальный навык: `engineering/system-design-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
