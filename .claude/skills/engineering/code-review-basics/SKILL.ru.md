...
version: "1.0"
language: ru
original: code-review-basics
---

# Code Review Basics

> Basics with Code Review. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `code-review-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Code Review Basics
...
## Ресурсы
- Оригинальный навык: `engineering/code-review-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
