...
version: "1.0"
language: ru
original: tech-debt-basics
---

# Tech Debt Basics

> Basics with Tech Debt Management. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tech-debt-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tech Debt Basics
...
## Ресурсы
- Оригинальный навык: `engineering/tech-debt-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
