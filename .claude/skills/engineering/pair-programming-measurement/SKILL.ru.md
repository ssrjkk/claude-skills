...
version: "1.0"
language: ru
original: pair-programming-measurement
---

# Pair Programming Measurement

> Measurement with Pair Programming. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pair-programming-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Pair Programming Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/pair-programming-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
