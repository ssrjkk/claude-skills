...
version: "1.0"
language: ru
original: plantuml-collaboration
---

# Plantuml Collaboration

> Collaboration with PlantUML. team collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plantuml-collaboration`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Plantuml Collaboration
...
## Ресурсы
- Оригинальный навык: `engineering/plantuml-collaboration/SKILL.md`
- Категория: Инженерия
- Язык: Русский
