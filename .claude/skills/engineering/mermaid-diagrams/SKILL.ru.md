...
tags: [mermaid-diagrams, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Diagrams with Mermaid.js. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mermaid-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Mermaid Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/mermaid-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
