...
> Tools with UML. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `uml-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Uml Tools
...
## Ресурсы
- Оригинальный навык: `engineering/uml-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
