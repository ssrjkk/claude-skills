...
tags: [ddd-basics, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ddd-basics
...
> Basics with Domain-Driven Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ddd-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Ddd Basics
...
## Ресурсы
- Оригинальный навык: `engineering/ddd-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
