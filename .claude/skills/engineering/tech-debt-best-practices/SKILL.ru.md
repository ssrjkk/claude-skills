...
version: "1.0"
language: ru
original: tech-debt-best-practices
---

# Tech Debt Best Practices

> Best Practices with Tech Debt Management. tips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tech-debt-best-practices`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tech Debt Best Practices
...
## Ресурсы
- Оригинальный навык: `engineering/tech-debt-best-practices/SKILL.md`
- Категория: Инженерия
- Язык: Русский
