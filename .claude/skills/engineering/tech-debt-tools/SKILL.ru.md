...
tags: [tech-debt-tools, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tech-debt-tools
---

# Tech Debt Tools

> Tools with Tech Debt Management. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tech-debt-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tech Debt Tools
...
## Ресурсы
- Оригинальный навык: `engineering/tech-debt-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
