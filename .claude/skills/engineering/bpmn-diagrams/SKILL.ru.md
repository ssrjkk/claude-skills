...
version: "1.0"
language: ru
original: bpmn-diagrams
---

# Bpmn Diagrams

> Diagrams with BPMN. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bpmn-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bpmn Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/bpmn-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
