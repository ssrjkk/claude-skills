...
> Team with Documentation. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `documentation-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Documentation Team
...
## Ресурсы
- Оригинальный навык: `engineering/documentation-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
