...
version: "1.0"
language: ru
original: architecture-basics
---

# Architecture Basics

> Basics with Software Architecture. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `architecture-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Architecture Basics
...
## Ресурсы
- Оригинальный навык: `engineering/architecture-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
