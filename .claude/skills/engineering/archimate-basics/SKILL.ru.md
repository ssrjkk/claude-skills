...
tags: [archimate-basics, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: archimate-basics
---

# Archimate Basics

> Basics with ArchiMate. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `archimate-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Archimate Basics
...
## Ресурсы
- Оригинальный навык: `engineering/archimate-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
