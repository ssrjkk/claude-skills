...
version: "1.0"
language: ru
original: archimate-diagrams
---

# Archimate Diagrams

> Diagrams with ArchiMate. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `archimate-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Archimate Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/archimate-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
