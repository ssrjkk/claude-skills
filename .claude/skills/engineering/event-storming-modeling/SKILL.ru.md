...
version: "1.0"
language: ru
original: event-storming-modeling
---

# Event Storming Modeling

> Modeling with Event Storming. system modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-storming-modeling`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Event Storming Modeling
...
## Ресурсы
- Оригинальный навык: `engineering/event-storming-modeling/SKILL.md`
- Категория: Инженерия
- Язык: Русский
