...
tags: [documentation-tools, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Tools with Documentation. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `documentation-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Documentation Tools
...
## Ресурсы
- Оригинальный навык: `engineering/documentation-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
