...
version: "1.0"
language: ru
original: refactoring-basics
---

# Refactoring Basics

> Basics with Refactoring. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `refactoring-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Refactoring Basics
...
## Ресурсы
- Оригинальный навык: `engineering/refactoring-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
