...
version: "1.0"
language: ru
original: api-design-measurement
---

# Api Design Measurement

> Measurement with API Design. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-design-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Api Design Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/api-design-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
