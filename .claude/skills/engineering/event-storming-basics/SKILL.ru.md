...
version: "1.0"
language: ru
original: event-storming-basics
---

# Event Storming Basics

> Basics with Event Storming. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-storming-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Event Storming Basics
...
## Ресурсы
- Оригинальный навык: `engineering/event-storming-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
