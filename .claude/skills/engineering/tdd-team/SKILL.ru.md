...
> Team with TDD. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tdd-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tdd Team
...
## Ресурсы
- Оригинальный навык: `engineering/tdd-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
