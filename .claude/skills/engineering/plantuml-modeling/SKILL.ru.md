...
tags: [plantuml-modeling, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plantuml-modeling
---

# Plantuml Modeling

> Modeling with PlantUML. system modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plantuml-modeling`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Plantuml Modeling
...
## Ресурсы
- Оригинальный навык: `engineering/plantuml-modeling/SKILL.md`
- Категория: Инженерия
- Язык: Русский
