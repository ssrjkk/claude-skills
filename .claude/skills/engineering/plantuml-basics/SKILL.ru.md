...
version: "1.0"
language: ru
original: plantuml-basics
---

# Plantuml Basics

> Basics with PlantUML. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plantuml-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Plantuml Basics
...
## Ресурсы
- Оригинальный навык: `engineering/plantuml-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
