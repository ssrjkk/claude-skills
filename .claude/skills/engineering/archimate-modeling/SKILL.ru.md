...
version: "1.0"
language: ru
original: archimate-modeling
---

# Archimate Modeling

> Modeling with ArchiMate. system modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `archimate-modeling`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Archimate Modeling
...
## Ресурсы
- Оригинальный навык: `engineering/archimate-modeling/SKILL.md`
- Категория: Инженерия
- Язык: Русский
