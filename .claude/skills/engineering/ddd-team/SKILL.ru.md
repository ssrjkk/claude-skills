...
tags: [ddd-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ddd-team
...
> Team with Domain-Driven Design. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ddd-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Ddd Team
...
## Ресурсы
- Оригинальный навык: `engineering/ddd-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
