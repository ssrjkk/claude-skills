...
> Tools with BPMN. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bpmn-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bpmn Tools
...
## Ресурсы
- Оригинальный навык: `engineering/bpmn-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
