...
tags: [event-storming-collaboration, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: event-storming-collaboration
---

# Event Storming Collaboration

> Collaboration with Event Storming. team collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-storming-collaboration`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Event Storming Collaboration
...
## Ресурсы
- Оригинальный навык: `engineering/event-storming-collaboration/SKILL.md`
- Категория: Инженерия
- Язык: Русский
