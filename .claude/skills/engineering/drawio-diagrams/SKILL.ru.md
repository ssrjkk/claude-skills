...
> Diagrams with Draw.io. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drawio-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Drawio Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/drawio-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
