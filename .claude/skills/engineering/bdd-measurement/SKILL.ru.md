...
tags: [bdd-measurement, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bdd-measurement
---

# Bdd Measurement

> Measurement with BDD. metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bdd-measurement`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bdd Measurement
...
## Ресурсы
- Оригинальный навык: `engineering/bdd-measurement/SKILL.md`
- Категория: Инженерия
- Язык: Русский
