...
version: "1.0"
language: ru
original: bpmn-basics
---

# Bpmn Basics

> Basics with BPMN. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bpmn-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bpmn Basics
...
## Ресурсы
- Оригинальный навык: `engineering/bpmn-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
