...
version: "1.0"
language: ru
original: architecture-modeling
---

# Architecture Modeling

> Modeling with Software Architecture. system modeling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `architecture-modeling`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Architecture Modeling
...
## Ресурсы
- Оригинальный навык: `engineering/architecture-modeling/SKILL.md`
- Категория: Инженерия
- Язык: Русский
