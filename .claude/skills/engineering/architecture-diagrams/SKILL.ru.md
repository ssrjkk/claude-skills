...
tags: [architecture-diagrams, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Diagrams with Software Architecture. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `architecture-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Architecture Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/architecture-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
