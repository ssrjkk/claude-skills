...
tags: [mermaid-basics, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mermaid-basics
---

# Mermaid Basics

> Basics with Mermaid.js. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mermaid-basics`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Mermaid Basics
...
## Ресурсы
- Оригинальный навык: `engineering/mermaid-basics/SKILL.md`
- Категория: Инженерия
- Язык: Русский
