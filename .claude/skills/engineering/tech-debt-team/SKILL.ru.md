...
tags: [tech-debt-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tech-debt-team
---

# Tech Debt Team

> Team with Tech Debt Management. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tech-debt-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Tech Debt Team
...
## Ресурсы
- Оригинальный навык: `engineering/tech-debt-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
