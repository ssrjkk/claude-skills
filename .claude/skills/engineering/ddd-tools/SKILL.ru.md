...
tags: [ddd-tools, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ddd-tools
...
> Tools with Domain-Driven Design. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ddd-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Ddd Tools
...
## Ресурсы
- Оригинальный навык: `engineering/ddd-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
