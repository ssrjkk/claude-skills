...
tags: [api-design-best-practices, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Best Practices with API Design. tips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `api-design-best-practices`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Api Design Best Practices
...
## Ресурсы
- Оригинальный навык: `engineering/api-design-best-practices/SKILL.md`
- Категория: Инженерия
- Язык: Русский
