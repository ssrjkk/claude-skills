...
> Team with BDD. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bdd-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bdd Team
...
## Ресурсы
- Оригинальный навык: `engineering/bdd-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
