...
> Tools with BDD. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bdd-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Bdd Tools
...
## Ресурсы
- Оригинальный навык: `engineering/bdd-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
