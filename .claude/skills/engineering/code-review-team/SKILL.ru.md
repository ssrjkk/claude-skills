...
tags: [code-review-team, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: code-review-team
---

# Code Review Team

> Team with Code Review. team adoption.

## Быстрый старт
Этот навык на русском языке. Оригинал: `code-review-team`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Code Review Team
...
## Ресурсы
- Оригинальный навык: `engineering/code-review-team/SKILL.md`
- Категория: Инженерия
- Язык: Русский
