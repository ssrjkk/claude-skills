...
version: "1.0"
language: ru
original: event-storming-tools
---

# Event Storming Tools

> Tools with Event Storming. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `event-storming-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Event Storming Tools
...
## Ресурсы
- Оригинальный навык: `engineering/event-storming-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
