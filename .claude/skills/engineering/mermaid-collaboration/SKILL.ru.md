...
version: "1.0"
language: ru
original: mermaid-collaboration
---

# Mermaid Collaboration

> Collaboration with Mermaid.js. team collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mermaid-collaboration`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Mermaid Collaboration
...
## Ресурсы
- Оригинальный навык: `engineering/mermaid-collaboration/SKILL.md`
- Категория: Инженерия
- Язык: Русский
