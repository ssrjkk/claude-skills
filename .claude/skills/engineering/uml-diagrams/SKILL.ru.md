...
> Diagrams with UML. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `uml-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Uml Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/uml-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
