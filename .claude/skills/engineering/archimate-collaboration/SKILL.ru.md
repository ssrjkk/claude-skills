...
version: "1.0"
language: ru
original: archimate-collaboration
---

# Archimate Collaboration

> Collaboration with ArchiMate. team collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `archimate-collaboration`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Archimate Collaboration
...
## Ресурсы
- Оригинальный навык: `engineering/archimate-collaboration/SKILL.md`
- Категория: Инженерия
- Язык: Русский
