...
tags: [mermaid-best-practices, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mermaid-best-practices
---

# Mermaid Best Practices

> Best Practices with Mermaid.js. practices.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mermaid-best-practices`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Mermaid Best Practices
...
## Ресурсы
- Оригинальный навык: `engineering/mermaid-best-practices/SKILL.md`
- Категория: Инженерия
- Язык: Русский
