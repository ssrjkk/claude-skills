...
> Diagrams with PlantUML. diagramming.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plantuml-diagrams`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Plantuml Diagrams
...
## Ресурсы
- Оригинальный навык: `engineering/plantuml-diagrams/SKILL.md`
- Категория: Инженерия
- Язык: Русский
