...
tags: [clean-code-tools, engineering, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clean-code-tools
---

# Clean Code Tools

> Tools with Clean Code. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `clean-code-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Clean Code Tools
...
## Ресурсы
- Оригинальный навык: `engineering/clean-code-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
