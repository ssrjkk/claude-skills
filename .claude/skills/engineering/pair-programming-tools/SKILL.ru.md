...
version: "1.0"
language: ru
original: pair-programming-tools
---

# Pair Programming Tools

> Tools with Pair Programming. tooling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pair-programming-tools`.

## Когда использовать
- Работа с Инженерия
- Выполнение задач, связанных с Pair Programming Tools
...
## Ресурсы
- Оригинальный навык: `engineering/pair-programming-tools/SKILL.md`
- Категория: Инженерия
- Язык: Русский
