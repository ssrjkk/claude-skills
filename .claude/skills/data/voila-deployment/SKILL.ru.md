...
version: "1.0"
language: ru
original: voila-deployment
---

# Voila Deployment

> Deployment with Voila. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Deployment
...
## Ресурсы
- Оригинальный навык: `data/voila-deployment/SKILL.md`
