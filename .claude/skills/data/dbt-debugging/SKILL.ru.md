...
category: data
tags: [dbt-debugging, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dbt-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Debugging
...
## Ресурсы
- Оригинальный навык: data/dbt-debugging/SKILL.md
