...
category: data
tags: [druid-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-fundamentals
---

# Druid Fundamentals

> Fundamentals for Druid: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `druid-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Druid Fundamentals
...
## Ресурсы
- Оригинал: data/druid-fundamentals/SKILL.md
