...
version: "1.0"
language: ru
original: shiny-charts
---

# Shiny Charts

> Charts with Shiny. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Charts
...
## Ресурсы
- Оригинальный навык: `data/shiny-charts/SKILL.md`
