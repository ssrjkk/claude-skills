...
version: "1.0"
language: ru
original: numpy-analysis
---

# Numpy Analysis

> Analysis with NumPy. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Analysis
...
## Ресурсы
- Оригинальный навык: `data/numpy-analysis/SKILL.md`
