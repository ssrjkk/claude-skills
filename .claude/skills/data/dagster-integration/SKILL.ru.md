...
category: data
tags: [dagster-integration, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dagster-integration
---

# Dagster Integration

> Integration with Dagster. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Integration
...
## Ресурсы
- Оригинальный навык: `data/dagster-integration/SKILL.md`
