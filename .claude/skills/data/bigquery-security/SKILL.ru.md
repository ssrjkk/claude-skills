...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Security
...
## Ресурсы
- Оригинальный навык: data/bigquery-security/SKILL.md
