...
category: data
tags: [pinot-guides, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-guides
---

# Pinot Guides

> Guides for Pinot: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pinot-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pinot Guides
...
## Ресурсы
- Оригинал: data/pinot-guides/SKILL.md
