...
category: data
tags: [jupyter-visualization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jupyter-visualization
---

# Jupyter Visualization

> Visualization with Jupyter. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Visualization
...
## Ресурсы
- Оригинальный навык: `data/jupyter-visualization/SKILL.md`
