...
version: "1.0"
language: ru
original: seaborn-transformation
---

# Seaborn Transformation

> Transformation with Seaborn. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Transformation
...
## Ресурсы
- Оригинальный навык: `data/seaborn-transformation/SKILL.md`
