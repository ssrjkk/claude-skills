...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Spark Optimization
...
## Ресурсы
- Оригинальный навык: data/spark-optimization/SKILL.md
