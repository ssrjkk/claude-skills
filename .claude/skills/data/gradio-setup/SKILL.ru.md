...
version: "1.0"
language: ru
original: gradio-setup
---

# Gradio Setup

> Setup with Gradio. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Setup
...
## Ресурсы
- Оригинальный навык: `data/gradio-setup/SKILL.md`
