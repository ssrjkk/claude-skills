...
version: "1.0"
language: ru
original: altair-integration
---

# Altair Integration

> Integration with Altair. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Integration
...
## Ресурсы
- Оригинальный навык: `data/altair-integration/SKILL.md`
