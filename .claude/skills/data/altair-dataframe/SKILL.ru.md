...
## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Dataframe
...
## Ресурсы
- Оригинальный навык: `data/altair-dataframe/SKILL.md`
