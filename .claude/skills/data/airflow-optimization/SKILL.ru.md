...
category: data
tags: [airflow-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-optimization
---

# Airflow Optimization

> Optimization with Airflow. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Optimization
...
## Ресурсы
- Оригинальный навык: `data/airflow-optimization/SKILL.md`
