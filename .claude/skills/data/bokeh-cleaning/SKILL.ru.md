...
version: "1.0"
language: ru
original: bokeh-cleaning
---

# Bokeh Cleaning

> Cleaning with Bokeh. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Cleaning
...
## Ресурсы
- Оригинальный навык: `data/bokeh-cleaning/SKILL.md`
