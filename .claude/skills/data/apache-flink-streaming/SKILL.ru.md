...
version: "1.0"
language: ru
original: apache-flink-streaming
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-flink-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Flink Streaming
...
## Ресурсы
- Оригинальный навык: `data/apache-flink-streaming/SKILL.md`
