...
category: data
tags: [plotly-visualization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Visualization with Plotly. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Visualization
...
## Ресурсы
- Оригинальный навык: `data/plotly-visualization/SKILL.md`
