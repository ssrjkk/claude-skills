...
category: data
tags: [jupyter-cleaning, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jupyter-cleaning
---

# Jupyter Cleaning

> Cleaning with Jupyter. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Cleaning
...
## Ресурсы
- Оригинальный навык: `data/jupyter-cleaning/SKILL.md`
