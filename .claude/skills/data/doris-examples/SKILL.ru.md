...
category: data
tags: [doris-examples, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: doris-examples
---

# Doris Examples

> Examples for Doris: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `doris-examples`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Doris Examples
...
## Ресурсы
- Оригинал: data/doris-examples/SKILL.md
