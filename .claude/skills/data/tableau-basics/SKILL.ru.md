...
category: data
tags: [tableau-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tableau-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tableau-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Tableau Basics
...
## Ресурсы
- Оригинальный навык: data/tableau-basics/SKILL.md
