...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Basics
...
## Ресурсы
- Оригинальный навык: data/dbt-basics/SKILL.md
