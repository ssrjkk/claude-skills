...
version: "1.0"
language: ru
original: databricks-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Optimization
...
## Ресурсы
- Оригинальный навык: data/databricks-optimization/SKILL.md
