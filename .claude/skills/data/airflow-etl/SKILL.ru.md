...
version: "1.0"
language: ru
original: airflow-etl
---

# Airflow Etl

> ETL with Airflow. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Etl
...
## Ресурсы
- Оригинальный навык: `data/airflow-etl/SKILL.md`
