...
category: data
tags: [airflow-api, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-api`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Api
...
## Ресурсы
- Оригинальный навык: data/airflow-api/SKILL.md
