...
category: data
tags: [pulsar-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pulsar-fundamentals
---

# Pulsar Fundamentals

> Fundamentals for Pulsar: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pulsar-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Fundamentals
...
## Ресурсы
- Оригинал: data/pulsar-fundamentals/SKILL.md
