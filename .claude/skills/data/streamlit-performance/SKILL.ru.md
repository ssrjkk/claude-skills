...
version: "1.0"
language: ru
original: streamlit-performance
---

# Streamlit Performance

> Performance with Streamlit. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Performance
...
## Ресурсы
- Оригинальный навык: `data/streamlit-performance/SKILL.md`
