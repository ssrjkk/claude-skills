...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Debugging
...
## Ресурсы
- Оригинальный навык: data/pandas-debugging/SKILL.md
