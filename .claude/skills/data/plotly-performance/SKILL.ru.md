...
category: data
tags: [plotly-performance, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plotly-performance
---

# Plotly Performance

> Performance with Plotly. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Performance
...
## Ресурсы
- Оригинальный навык: `data/plotly-performance/SKILL.md`
