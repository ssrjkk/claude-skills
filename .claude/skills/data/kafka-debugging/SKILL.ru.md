...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Debugging
...
## Ресурсы
- Оригинальный навык: data/kafka-debugging/SKILL.md
