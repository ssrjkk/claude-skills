...
version: "1.0"
language: ru
original: nicegui-charts
---

# Nicegui Charts

> Charts with NiceGUI. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Charts
...
## Ресурсы
- Оригинальный навык: `data/nicegui-charts/SKILL.md`
