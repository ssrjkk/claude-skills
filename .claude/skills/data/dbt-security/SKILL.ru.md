...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Security
...
## Ресурсы
- Оригинальный навык: data/dbt-security/SKILL.md
