...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tableau-testing`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Tableau Testing
...
## Ресурсы
- Оригинальный навык: data/tableau-testing/SKILL.md
