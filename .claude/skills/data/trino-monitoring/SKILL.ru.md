...
category: data
tags: [trino-monitoring, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trino-monitoring
---

# Trino Monitoring

> Monitoring with Trino. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Monitoring
...
## Ресурсы
- Оригинальный навык: `data/trino-monitoring/SKILL.md`
