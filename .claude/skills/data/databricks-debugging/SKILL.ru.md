...
category: data
tags: [databricks-debugging, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: databricks-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Debugging
...
## Ресурсы
- Оригинальный навык: data/databricks-debugging/SKILL.md
