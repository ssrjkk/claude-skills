...
category: data
tags: [apache-flink-sql, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-flink-sql
---

# Apache Flink Sql

> SQL with Apache Flink. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-flink-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Flink Sql
...
## Ресурсы
- Оригинальный навык: `data/apache-flink-sql/SKILL.md`
