...
category: data
tags: [nats-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nats-fundamentals
---

# Nats Fundamentals

> Fundamentals for Nats: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nats-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nats Fundamentals
...
## Ресурсы
- Оригинал: data/nats-fundamentals/SKILL.md
