...
category: data
tags: [hadoop-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Streaming with Hadoop. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Streaming
...
## Ресурсы
- Оригинальный навык: `data/hadoop-streaming/SKILL.md`
