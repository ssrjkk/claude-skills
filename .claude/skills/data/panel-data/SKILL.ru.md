...
> Data with Panel. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Data
...
## Ресурсы
- Оригинальный навык: `data/panel-data/SKILL.md`
