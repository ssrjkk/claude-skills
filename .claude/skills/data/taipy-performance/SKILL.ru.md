...
version: "1.0"
language: ru
original: taipy-performance
---

# Taipy Performance

> Performance with Taipy. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Performance
...
## Ресурсы
- Оригинальный навык: `data/taipy-performance/SKILL.md`
