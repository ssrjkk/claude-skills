...
category: data
tags: [bigquery-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bigquery-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Basics
...
## Ресурсы
- Оригинальный навык: data/bigquery-basics/SKILL.md
