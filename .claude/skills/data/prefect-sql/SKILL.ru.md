...
version: "1.0"
language: ru
original: prefect-sql
---

# Prefect Sql

> SQL with Prefect. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Sql
...
## Ресурсы
- Оригинальный навык: `data/prefect-sql/SKILL.md`
