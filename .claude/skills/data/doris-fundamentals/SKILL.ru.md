...
version: "1.0"
language: ru
original: doris-fundamentals
---

# Doris Fundamentals

> Fundamentals for Doris: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `doris-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Doris Fundamentals
...
## Ресурсы
- Оригинал: data/doris-fundamentals/SKILL.md
