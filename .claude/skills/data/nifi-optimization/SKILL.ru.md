...
category: data
tags: [nifi-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nifi-optimization
---

# Nifi Optimization

> Optimization with NiFi. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Optimization
...
## Ресурсы
- Оригинальный навык: `data/nifi-optimization/SKILL.md`
