...
version: "1.0"
language: ru
original: apache-flink
---

# Apache Flink

> Builds real-time stream processing applications with Apache Flink, event time, and exactly-once semantics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-flink`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Flink
...
## Ресурсы
- Оригинальный навык: `data/apache-flink/SKILL.md`
