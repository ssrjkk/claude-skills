...
version: "1.0"
language: ru
original: jupyter-integration
---

# Jupyter Integration

> Integration with Jupyter. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Integration
...
## Ресурсы
- Оригинальный навык: `data/jupyter-integration/SKILL.md`
