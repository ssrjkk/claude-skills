...
category: data
tags: [panel-widgets, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: panel-widgets
---

# Panel Widgets

> Widgets with Panel. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Widgets
...
## Ресурсы
- Оригинальный навык: `data/panel-widgets/SKILL.md`
