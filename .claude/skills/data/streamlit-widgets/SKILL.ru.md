...
version: "1.0"
language: ru
original: streamlit-widgets
---

# Streamlit Widgets

> Widgets with Streamlit. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Widgets
...
## Ресурсы
- Оригинальный навык: `data/streamlit-widgets/SKILL.md`
