...
category: data
tags: [numpy-transformation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: numpy-transformation
---

# Numpy Transformation

> Transformation with NumPy. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Transformation
...
## Ресурсы
- Оригинальный навык: `data/numpy-transformation/SKILL.md`
