...
version: "1.0"
language: ru
original: jupyter-transformation
---

# Jupyter Transformation

> Transformation with Jupyter. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Transformation
...
## Ресурсы
- Оригинальный навык: `data/jupyter-transformation/SKILL.md`
