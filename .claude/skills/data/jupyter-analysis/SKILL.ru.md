...
category: data
tags: [jupyter-analysis, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Analysis with Jupyter. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Analysis
...
## Ресурсы
- Оригинальный навык: `data/jupyter-analysis/SKILL.md`
