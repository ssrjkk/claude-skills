...
version: "1.0"
language: ru
original: nifi-integration
---

# Nifi Integration

> Integration with NiFi. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Integration
...
## Ресурсы
- Оригинальный навык: `data/nifi-integration/SKILL.md`
