...
version: "1.0"
language: ru
original: presto-batch
---

# Presto Batch

> Batch with Presto. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Batch
...
## Ресурсы
- Оригинальный навык: `data/presto-batch/SKILL.md`
