...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Batch
...
## Ресурсы
- Оригинальный навык: `data/kinesis-batch/SKILL.md`
