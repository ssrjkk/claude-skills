...
category: data
tags: [pandas-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Optimization
...
## Ресурсы
- Оригинальный навык: data/pandas-optimization/SKILL.md
