...
category: data
tags: [starrocks-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: starrocks-fundamentals
---

# Starrocks Fundamentals

> Fundamentals for Starrocks: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `starrocks-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Starrocks Fundamentals
...
## Ресурсы
- Оригинал: data/starrocks-fundamentals/SKILL.md
