...
version: "1.0"
language: ru
original: doris-guides
---

# Doris Guides

> Guides for Doris: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `doris-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Doris Guides
...
## Ресурсы
- Оригинал: data/doris-guides/SKILL.md
