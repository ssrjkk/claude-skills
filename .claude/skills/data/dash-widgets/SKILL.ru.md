...
> Widgets with Dash. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dash Widgets
...
## Ресурсы
- Оригинальный навык: `data/dash-widgets/SKILL.md`
