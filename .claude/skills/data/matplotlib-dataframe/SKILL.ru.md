...
version: "1.0"
language: ru
original: matplotlib-dataframe
---

# Matplotlib Dataframe

> DataFrame with Matplotlib. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Dataframe
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-dataframe/SKILL.md`
