...
version: "1.0"
language: ru
original: seaborn-analysis
---

# Seaborn Analysis

> Analysis with Seaborn. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Analysis
...
## Ресурсы
- Оригинальный навык: `data/seaborn-analysis/SKILL.md`
