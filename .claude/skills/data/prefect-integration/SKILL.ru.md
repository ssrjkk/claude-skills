...
version: "1.0"
language: ru
original: prefect-integration
---

# Prefect Integration

> Integration with Prefect. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Integration
...
## Ресурсы
- Оригинальный навык: `data/prefect-integration/SKILL.md`
