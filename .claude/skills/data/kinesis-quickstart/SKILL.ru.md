...
category: data
tags: [kinesis-quickstart, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kinesis-quickstart
---

# Kinesis Quickstart

> Quickstart for Kinesis: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinesis-quickstart`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Quickstart
...
## Ресурсы
- Оригинал: data/kinesis-quickstart/SKILL.md
