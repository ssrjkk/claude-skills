...
category: data
tags: [presto-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: presto-streaming
---

# Presto Streaming

> Streaming with Presto. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Streaming
...
## Ресурсы
- Оригинальный навык: `data/presto-streaming/SKILL.md`
