...
version: "1.0"
language: ru
original: taipy-charts
---

# Taipy Charts

> Charts with Taipy. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Charts
...
## Ресурсы
- Оригинальный навык: `data/taipy-charts/SKILL.md`
