...
version: "1.0"
language: ru
original: altair-transformation
---

# Altair Transformation

> Transformation with Altair. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Transformation
...
## Ресурсы
- Оригинальный навык: `data/altair-transformation/SKILL.md`
