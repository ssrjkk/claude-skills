...
version: "1.0"
language: ru
original: nicegui-setup
---

# Nicegui Setup

> Setup with NiceGUI. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Setup
...
## Ресурсы
- Оригинальный навык: `data/nicegui-setup/SKILL.md`
