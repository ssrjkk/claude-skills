...
> Setup with NiFi. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Setup
...
## Ресурсы
- Оригинальный навык: `data/nifi-setup/SKILL.md`
