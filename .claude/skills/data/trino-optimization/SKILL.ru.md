...
category: data
tags: [trino-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trino-optimization
---

# Trino Optimization

> Optimization with Trino. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Optimization
...
## Ресурсы
- Оригинальный навык: `data/trino-optimization/SKILL.md`
