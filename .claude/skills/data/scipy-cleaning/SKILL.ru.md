...
version: "1.0"
language: ru
original: scipy-cleaning
---

# Scipy Cleaning

> Cleaning with SciPy. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Cleaning
...
## Ресурсы
- Оригинальный навык: `data/scipy-cleaning/SKILL.md`
