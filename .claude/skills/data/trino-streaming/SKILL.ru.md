...
category: data
tags: [trino-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: trino-streaming
---

# Trino Streaming

> Streaming with Trino. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Streaming
...
## Ресурсы
- Оригинальный навык: `data/trino-streaming/SKILL.md`
