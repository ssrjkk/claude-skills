...
version: "1.0"
language: ru
original: hadoop-integration
---

# Hadoop Integration

> Integration with Hadoop. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Integration
...
## Ресурсы
- Оригинальный навык: `data/hadoop-integration/SKILL.md`
