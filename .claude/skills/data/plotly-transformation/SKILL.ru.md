...
category: data
tags: [plotly-transformation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plotly-transformation
---

# Plotly Transformation

> Transformation with Plotly. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Transformation
...
## Ресурсы
- Оригинальный навык: `data/plotly-transformation/SKILL.md`
