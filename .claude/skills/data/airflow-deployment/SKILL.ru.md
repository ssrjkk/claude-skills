...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Deployment
...
## Ресурсы
- Оригинальный навык: data/airflow-deployment/SKILL.md
