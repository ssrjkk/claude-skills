...
category: data
tags: [spark-advanced, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Spark Advanced
...
## Ресурсы
- Оригинальный навык: data/spark-advanced/SKILL.md
