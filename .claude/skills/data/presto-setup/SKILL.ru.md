...
## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Setup
...
## Ресурсы
- Оригинальный навык: `data/presto-setup/SKILL.md`
