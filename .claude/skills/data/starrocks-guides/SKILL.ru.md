...
version: "1.0"
language: ru
original: starrocks-guides
---

# Starrocks Guides

> Guides for Starrocks: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `starrocks-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Starrocks Guides
...
## Ресурсы
- Оригинал: data/starrocks-guides/SKILL.md
