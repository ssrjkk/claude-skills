...
category: data
tags: [databricks-security, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: databricks-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Security
...
## Ресурсы
- Оригинальный навык: data/databricks-security/SKILL.md
