...
version: "1.0"
language: ru
original: airflow-monitoring
---

# Airflow Monitoring

> Monitoring with Airflow. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Monitoring
...
## Ресурсы
- Оригинальный навык: `data/airflow-monitoring/SKILL.md`
