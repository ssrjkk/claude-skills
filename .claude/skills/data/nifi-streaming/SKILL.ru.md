...
category: data
tags: [nifi-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nifi-streaming
---

# Nifi Streaming

> Streaming with NiFi. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Streaming
...
## Ресурсы
- Оригинальный навык: `data/nifi-streaming/SKILL.md`
