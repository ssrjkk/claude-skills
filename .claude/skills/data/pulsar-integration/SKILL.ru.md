...
version: "1.0"
language: ru
original: pulsar-integration
---

# Pulsar Integration

> Integration with Pulsar. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulsar-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Integration
...
## Ресурсы
- Оригинальный навык: `data/pulsar-integration/SKILL.md`
