...
category: data
tags: [tableau-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tableau-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tableau-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Tableau Optimization
...
## Ресурсы
- Оригинальный навык: data/tableau-optimization/SKILL.md
