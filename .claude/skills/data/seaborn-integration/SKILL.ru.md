...
version: "1.0"
language: ru
original: seaborn-integration
---

# Seaborn Integration

> Integration with Seaborn. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Integration
...
## Ресурсы
- Оригинальный навык: `data/seaborn-integration/SKILL.md`
