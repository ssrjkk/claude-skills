...
version: "1.0"
language: ru
original: streamlit-setup
---

# Streamlit Setup

> Setup with Streamlit. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Setup
...
## Ресурсы
- Оригинальный навык: `data/streamlit-setup/SKILL.md`
