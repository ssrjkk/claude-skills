...
category: data
tags: [kinesis-sql, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kinesis-sql
---

# Kinesis Sql

> SQL with Kinesis. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Sql
...
## Ресурсы
- Оригинальный навык: `data/kinesis-sql/SKILL.md`
