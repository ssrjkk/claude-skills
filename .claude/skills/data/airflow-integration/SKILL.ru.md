...
version: "1.0"
language: ru
original: airflow-integration
---

# Airflow Integration

> Integration with Airflow. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Integration
...
## Ресурсы
- Оригинальный навык: `data/airflow-integration/SKILL.md`
