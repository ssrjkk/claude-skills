...
version: "1.0"
language: ru
original: numpy-cleaning
---

# Numpy Cleaning

> Cleaning with NumPy. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Cleaning
...
## Ресурсы
- Оригинальный навык: `data/numpy-cleaning/SKILL.md`
