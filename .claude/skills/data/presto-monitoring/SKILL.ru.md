...
version: "1.0"
language: ru
original: presto-monitoring
---

# Presto Monitoring

> Monitoring with Presto. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Monitoring
...
## Ресурсы
- Оригинальный навык: `data/presto-monitoring/SKILL.md`
