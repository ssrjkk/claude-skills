...
version: "1.0"
language: ru
original: polars-performance
---

# Polars Performance

> Performance with Polars. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Performance
...
## Ресурсы
- Оригинальный навык: `data/polars-performance/SKILL.md`
