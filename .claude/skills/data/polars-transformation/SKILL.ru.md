...
version: "1.0"
language: ru
original: polars-transformation
---

# Polars Transformation

> Transformation with Polars. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Transformation
...
## Ресурсы
- Оригинальный навык: `data/polars-transformation/SKILL.md`
