...
category: data
tags: [druid-guides, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-guides
---

# Druid Guides

> Guides for Druid: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `druid-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Druid Guides
...
## Ресурсы
- Оригинал: data/druid-guides/SKILL.md
