...
category: data
tags: [druid-examples, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-examples
---

# Druid Examples

> Examples for Druid: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `druid-examples`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Druid Examples
...
## Ресурсы
- Оригинал: data/druid-examples/SKILL.md
