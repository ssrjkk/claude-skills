...
version: "1.0"
language: ru
original: dagster-etl
---

# Dagster Etl

> ETL with Dagster. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Etl
...
## Ресурсы
- Оригинальный навык: `data/dagster-etl/SKILL.md`
