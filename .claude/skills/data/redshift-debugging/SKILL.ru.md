...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Debugging
...
## Ресурсы
- Оригинальный навык: data/redshift-debugging/SKILL.md
