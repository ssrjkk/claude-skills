...
category: data
tags: [pandas-visualization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-visualization
---

# Pandas Visualization

> Visualization with Pandas. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Visualization
...
## Ресурсы
- Оригинальный навык: `data/pandas-visualization/SKILL.md`
