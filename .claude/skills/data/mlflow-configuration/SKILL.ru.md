...
version: "1.0"
language: ru
original: mlflow-configuration
---

# Mlflow Configuration

> Configuration for Mlflow: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: mlflow-configuration.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Mlflow Configuration
...
## Ресурсы
- data/mlflow-configuration/SKILL.md
