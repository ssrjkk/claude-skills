...
> Validates data quality with Great Expectations, creating expectations, suites, and data docs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `great-expectations`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Great Expectations
...
## Ресурсы
- Оригинальный навык: `data/great-expectations/SKILL.md`
