...
version: "1.0"
language: ru
original: apache-spark-integration
---

# Apache Spark Integration

> Integration with Apache Spark. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Integration
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-integration/SKILL.md`
