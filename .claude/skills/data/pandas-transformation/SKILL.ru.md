...
category: data
tags: [pandas-transformation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-transformation
---

# Pandas Transformation

> Transformation with Pandas. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Transformation
...
## Ресурсы
- Оригинальный навык: `data/pandas-transformation/SKILL.md`
