...
version: "1.0"
language: ru
original: dagster-monitoring
---

# Dagster Monitoring

> Monitoring with Dagster. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Monitoring
...
## Ресурсы
- Оригинальный навык: `data/dagster-monitoring/SKILL.md`
