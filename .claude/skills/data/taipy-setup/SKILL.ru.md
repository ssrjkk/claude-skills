...
category: data
tags: [taipy-setup, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: taipy-setup
---

# Taipy Setup

> Setup with Taipy. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Setup
...
## Ресурсы
- Оригинальный навык: `data/taipy-setup/SKILL.md`
