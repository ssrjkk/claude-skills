...
> SQL with Hadoop. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Sql
...
## Ресурсы
- Оригинальный навык: `data/hadoop-sql/SKILL.md`
