...
category: data
tags: [dash-theming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dash-theming
---

# Dash Theming

> Theming with Dash. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dash Theming
...
## Ресурсы
- Оригинальный навык: `data/dash-theming/SKILL.md`
