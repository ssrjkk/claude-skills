...
version: "1.0"
language: ru
original: kinesis-integration
---

# Kinesis Integration

> Integration with Kinesis. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Integration
...
## Ресурсы
- Оригинальный навык: `data/kinesis-integration/SKILL.md`
