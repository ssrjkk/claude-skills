...
category: data
tags: [scipy-dataframe, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scipy-dataframe
---

# Scipy Dataframe

> DataFrame with SciPy. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Dataframe
...
## Ресурсы
- Оригинальный навык: `data/scipy-dataframe/SKILL.md`
