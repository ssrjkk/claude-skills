...
version: "1.0"
language: ru
original: taipy-theming
---

# Taipy Theming

> Theming with Taipy. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Theming
...
## Ресурсы
- Оригинальный навык: `data/taipy-theming/SKILL.md`
