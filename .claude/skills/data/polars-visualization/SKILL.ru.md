...
version: "1.0"
language: ru
original: polars-visualization
---

# Polars Visualization

> Visualization with Polars. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Visualization
...
## Ресурсы
- Оригинальный навык: `data/polars-visualization/SKILL.md`
