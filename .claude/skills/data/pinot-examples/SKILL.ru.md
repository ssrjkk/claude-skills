...
category: data
tags: [pinot-examples, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-examples
---

# Pinot Examples

> Examples for Pinot: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pinot-examples`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pinot Examples
...
## Ресурсы
- Оригинал: data/pinot-examples/SKILL.md
