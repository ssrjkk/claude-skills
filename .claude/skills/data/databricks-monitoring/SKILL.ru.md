...
category: data
tags: [databricks-monitoring, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: databricks-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Monitoring
...
## Ресурсы
- Оригинальный навык: data/databricks-monitoring/SKILL.md
