...
category: data
tags: [plotly-integration, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plotly-integration
---

# Plotly Integration

> Integration with Plotly. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Integration
...
## Ресурсы
- Оригинальный навык: `data/plotly-integration/SKILL.md`
