...
version: "1.0"
language: ru
original: dagster-batch
---

# Dagster Batch

> Batch with Dagster. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Batch
...
## Ресурсы
- Оригинальный навык: `data/dagster-batch/SKILL.md`
