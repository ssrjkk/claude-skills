...
version: "1.0"
language: ru
original: numpy-deployment
---

# Numpy Deployment

> Deployment with NumPy. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Deployment
...
## Ресурсы
- Оригинальный навык: `data/numpy-deployment/SKILL.md`
