...
version: "1.0"
language: ru
original: apache-beam-integration
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-beam-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Beam Integration
...
## Ресурсы
- Оригинальный навык: `data/apache-beam-integration/SKILL.md`
