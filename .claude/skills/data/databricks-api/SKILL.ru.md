...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-api`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Api
...
## Ресурсы
- Оригинальный навык: data/databricks-api/SKILL.md
