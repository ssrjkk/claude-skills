...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Setup
...
## Ресурсы
- Оригинальный навык: data/snowflake-setup/SKILL.md
