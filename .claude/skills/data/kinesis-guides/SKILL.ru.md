...
version: "1.0"
language: ru
original: kinesis-guides
---

# Kinesis Guides

> Guides for Kinesis: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinesis-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Guides
...
## Ресурсы
- Оригинал: data/kinesis-guides/SKILL.md
