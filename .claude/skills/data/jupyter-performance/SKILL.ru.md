...
category: data
tags: [jupyter-performance, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jupyter-performance
---

# Jupyter Performance

> Performance with Jupyter. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Performance
...
## Ресурсы
- Оригинальный навык: `data/jupyter-performance/SKILL.md`
