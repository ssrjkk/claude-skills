...
category: data
tags: [snowflake-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: snowflake-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Basics
...
## Ресурсы
- Оригинальный навык: data/snowflake-basics/SKILL.md
