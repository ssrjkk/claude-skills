...
version: "1.0"
language: ru
original: kinesis-etl
---

# Kinesis Etl

> ETL with Kinesis. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Etl
...
## Ресурсы
- Оригинальный навык: `data/kinesis-etl/SKILL.md`
