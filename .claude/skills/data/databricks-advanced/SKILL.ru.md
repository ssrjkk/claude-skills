...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Advanced
...
## Ресурсы
- Оригинальный навык: data/databricks-advanced/SKILL.md
