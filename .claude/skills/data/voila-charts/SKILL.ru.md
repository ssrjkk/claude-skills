...
version: "1.0"
language: ru
original: voila-charts
---

# Voila Charts

> Charts with Voila. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Charts
...
## Ресурсы
- Оригинальный навык: `data/voila-charts/SKILL.md`
