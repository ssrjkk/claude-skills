...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Spark Basics
...
## Ресурсы
- Оригинальный навык: data/spark-basics/SKILL.md
