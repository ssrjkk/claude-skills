...
version: "1.0"
language: ru
original: matplotlib-transformation
---

# Matplotlib Transformation

> Transformation with Matplotlib. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Transformation
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-transformation/SKILL.md`
