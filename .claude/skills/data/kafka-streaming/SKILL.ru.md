...
category: data
tags: [kafka-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kafka-streaming
---

# Kafka Streaming

> Streaming with Kafka. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Streaming
...
## Ресурсы
- Оригинальный навык: `data/kafka-streaming/SKILL.md`
