...
> Data with Shiny. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Data
...
## Ресурсы
- Оригинальный навык: `data/shiny-data/SKILL.md`
