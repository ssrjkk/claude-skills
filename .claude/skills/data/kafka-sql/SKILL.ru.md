...
> SQL with Kafka. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Sql
...
## Ресурсы
- Оригинальный навык: `data/kafka-sql/SKILL.md`
