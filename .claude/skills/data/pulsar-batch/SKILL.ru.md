...
category: data
tags: [pulsar-batch, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pulsar-batch
---

# Pulsar Batch

> Batch with Pulsar. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulsar-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Batch
...
## Ресурсы
- Оригинальный навык: `data/pulsar-batch/SKILL.md`
