...
version: "1.0"
language: ru
original: scipy-deployment
---

# Scipy Deployment

> Deployment with SciPy. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Deployment
...
## Ресурсы
- Оригинальный навык: `data/scipy-deployment/SKILL.md`
