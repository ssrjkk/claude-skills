...
version: "1.0"
language: ru
original: altair-deployment
---

# Altair Deployment

> Deployment with Altair. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Deployment
...
## Ресурсы
- Оригинальный навык: `data/altair-deployment/SKILL.md`
