...
category: data
tags: [altair-performance, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: altair-performance
---

# Altair Performance

> Performance with Altair. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Performance
...
## Ресурсы
- Оригинальный навык: `data/altair-performance/SKILL.md`
