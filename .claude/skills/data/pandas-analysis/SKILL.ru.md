...
category: data
tags: [pandas-analysis, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-analysis
---

# Pandas Analysis

> Analysis with Pandas. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Analysis
...
## Ресурсы
- Оригинальный навык: `data/pandas-analysis/SKILL.md`
