...
> Setup with dbt. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Setup
...
## Ресурсы
- Оригинальный навык: `data/dbt-setup/SKILL.md`
