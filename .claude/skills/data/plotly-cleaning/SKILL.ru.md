...
version: "1.0"
language: ru
original: plotly-cleaning
---

# Plotly Cleaning

> Cleaning with Plotly. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Cleaning
...
## Ресурсы
- Оригинальный навык: `data/plotly-cleaning/SKILL.md`
