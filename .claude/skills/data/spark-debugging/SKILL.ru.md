...
category: data
tags: [spark-debugging, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spark-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Spark Debugging
...
## Ресурсы
- Оригинальный навык: data/spark-debugging/SKILL.md
