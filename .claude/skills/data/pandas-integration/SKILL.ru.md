...
version: "1.0"
language: ru
original: pandas-integration
---

# Pandas Integration

> Integration with Pandas. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Integration
...
## Ресурсы
- Оригинальный навык: `data/pandas-integration/SKILL.md`
