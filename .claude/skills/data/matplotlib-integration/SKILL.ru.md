...
version: "1.0"
language: ru
original: matplotlib-integration
---

# Matplotlib Integration

> Integration with Matplotlib. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Integration
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-integration/SKILL.md`
