...
category: data
tags: [druid-quickstart, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: druid-quickstart
---

# Druid Quickstart

> Quickstart for Druid: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `druid-quickstart`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Druid Quickstart
...
## Ресурсы
- Оригинал: data/druid-quickstart/SKILL.md
