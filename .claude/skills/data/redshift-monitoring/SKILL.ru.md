...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Monitoring
...
## Ресурсы
- Оригинальный навык: data/redshift-monitoring/SKILL.md
