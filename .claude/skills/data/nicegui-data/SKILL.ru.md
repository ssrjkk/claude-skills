...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Data
...
## Ресурсы
- Оригинальный навык: `data/nicegui-data/SKILL.md`
