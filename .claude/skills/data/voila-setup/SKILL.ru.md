...
version: "1.0"
language: ru
original: voila-setup
---

# Voila Setup

> Setup with Voila. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Setup
...
## Ресурсы
- Оригинальный навык: `data/voila-setup/SKILL.md`
