...
category: data
tags: [apache-spark-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-spark-optimization
---

# Apache Spark Optimization

> Optimization with Apache Spark. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Optimization
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-optimization/SKILL.md`
