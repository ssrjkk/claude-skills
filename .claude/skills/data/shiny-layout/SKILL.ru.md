...
version: "1.0"
language: ru
original: shiny-layout
---

# Shiny Layout

> Layout with Shiny. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Layout
...
## Ресурсы
- Оригинальный навык: `data/shiny-layout/SKILL.md`
