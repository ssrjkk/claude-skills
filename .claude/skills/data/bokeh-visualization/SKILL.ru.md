...
category: data
tags: [bokeh-visualization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bokeh-visualization
---

# Bokeh Visualization

> Visualization with Bokeh. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Visualization
...
## Ресурсы
- Оригинальный навык: `data/bokeh-visualization/SKILL.md`
