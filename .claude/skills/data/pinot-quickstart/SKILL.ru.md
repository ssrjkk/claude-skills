...
version: "1.0"
language: ru
original: pinot-quickstart
---

# Pinot Quickstart

> Quickstart for Pinot: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pinot-quickstart`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pinot Quickstart
...
## Ресурсы
- Оригинал: data/pinot-quickstart/SKILL.md
