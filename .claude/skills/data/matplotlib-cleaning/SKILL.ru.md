...
version: "1.0"
language: ru
original: matplotlib-cleaning
---

# Matplotlib Cleaning

> Cleaning with Matplotlib. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Cleaning
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-cleaning/SKILL.md`
