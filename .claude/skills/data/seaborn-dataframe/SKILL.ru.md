...
category: data
tags: [seaborn-dataframe, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: seaborn-dataframe
---

# Seaborn Dataframe

> DataFrame with Seaborn. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Dataframe
...
## Ресурсы
- Оригинальный навык: `data/seaborn-dataframe/SKILL.md`
