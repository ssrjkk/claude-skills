...
version: "1.0"
language: ru
original: voila-theming
---

# Voila Theming

> Theming with Voila. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Theming
...
## Ресурсы
- Оригинальный навык: `data/voila-theming/SKILL.md`
