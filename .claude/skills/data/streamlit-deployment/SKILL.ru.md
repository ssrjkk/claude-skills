...
category: data
tags: [streamlit-deployment, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: streamlit-deployment
---

# Streamlit Deployment

> Deployment with Streamlit. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Deployment
...
## Ресурсы
- Оригинальный навык: `data/streamlit-deployment/SKILL.md`
