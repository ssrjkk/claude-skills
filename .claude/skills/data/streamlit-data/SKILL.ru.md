...
version: "1.0"
language: ru
original: streamlit-data
---

# Streamlit Data

> Data with Streamlit. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Data
...
## Ресурсы
- Оригинальный навык: `data/streamlit-data/SKILL.md`
