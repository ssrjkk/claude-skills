...
> Data with Taipy. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Data
...
## Ресурсы
- Оригинальный навык: `data/taipy-data/SKILL.md`
