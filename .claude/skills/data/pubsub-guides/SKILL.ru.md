...
category: data
tags: [pubsub-guides, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pubsub-guides
---

# Pubsub Guides

> Guides for Pubsub: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pubsub-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pubsub Guides
...
## Ресурсы
- Оригинал: data/pubsub-guides/SKILL.md
