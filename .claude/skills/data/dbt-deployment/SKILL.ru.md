...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Deployment
...
## Ресурсы
- Оригинальный навык: data/dbt-deployment/SKILL.md
