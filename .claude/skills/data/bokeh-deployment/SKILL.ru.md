...
version: "1.0"
language: ru
original: bokeh-deployment
---

# Bokeh Deployment

> Deployment with Bokeh. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Deployment
...
## Ресурсы
- Оригинальный навык: `data/bokeh-deployment/SKILL.md`
