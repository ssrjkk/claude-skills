...
category: data
tags: [whylabs-configuration, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: whylabs-configuration
---

# Whylabs Configuration

> Configuration for Whylabs: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: whylabs-configuration.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Whylabs Configuration
...
## Ресурсы
- data/whylabs-configuration/SKILL.md
