...
category: data
tags: [pubsub-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pubsub-fundamentals
---

# Pubsub Fundamentals

> Fundamentals for Pubsub: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pubsub-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pubsub Fundamentals
...
## Ресурсы
- Оригинал: data/pubsub-fundamentals/SKILL.md
