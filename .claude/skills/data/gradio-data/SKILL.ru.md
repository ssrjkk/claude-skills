...
version: "1.0"
language: ru
original: gradio-data
---

# Gradio Data

> Data with Gradio. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Data
...
## Ресурсы
- Оригинальный навык: `data/gradio-data/SKILL.md`
