...
version: "1.0"
language: ru
original: bokeh-analysis
---

# Bokeh Analysis

> Analysis with Bokeh. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Analysis
...
## Ресурсы
- Оригинальный навык: `data/bokeh-analysis/SKILL.md`
