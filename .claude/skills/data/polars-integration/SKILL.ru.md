...
version: "1.0"
language: ru
original: polars-integration
---

# Polars Integration

> Integration with Polars. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Integration
...
## Ресурсы
- Оригинальный навык: `data/polars-integration/SKILL.md`
