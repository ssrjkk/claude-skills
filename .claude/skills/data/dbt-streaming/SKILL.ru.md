...
version: "1.0"
language: ru
original: dbt-streaming
---

# Dbt Streaming

> Streaming with dbt. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Streaming
...
## Ресурсы
- Оригинальный навык: `data/dbt-streaming/SKILL.md`
