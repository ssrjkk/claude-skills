...
category: data
tags: [snowflake-advanced, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: snowflake-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Advanced
...
## Ресурсы
- Оригинальный навык: data/snowflake-advanced/SKILL.md
