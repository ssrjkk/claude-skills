...
version: "1.0"
language: ru
original: doris-quickstart
---

# Doris Quickstart

> Quickstart for Doris: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `doris-quickstart`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Doris Quickstart
...
## Ресурсы
- Оригинал: data/doris-quickstart/SKILL.md
