...
category: data
tags: [nicegui-layout, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nicegui-layout
---

# Nicegui Layout

> Layout with NiceGUI. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Layout
...
## Ресурсы
- Оригинальный навык: `data/nicegui-layout/SKILL.md`
