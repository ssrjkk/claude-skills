...
version: "1.0"
language: ru
original: bokeh-performance
---

# Bokeh Performance

> Performance with Bokeh. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Performance
...
## Ресурсы
- Оригинальный навык: `data/bokeh-performance/SKILL.md`
