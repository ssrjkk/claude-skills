...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Security
...
## Ресурсы
- Оригинальный навык: data/airflow-security/SKILL.md
