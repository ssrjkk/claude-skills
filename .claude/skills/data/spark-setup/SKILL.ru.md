...
## Быстрый старт
Этот навык на русском языке. Оригинал: `spark-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Spark Setup
...
## Ресурсы
- Оригинальный навык: data/spark-setup/SKILL.md
