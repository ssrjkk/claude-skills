...
> Data with Dash. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dash Data
...
## Ресурсы
- Оригинальный навык: `data/dash-data/SKILL.md`
