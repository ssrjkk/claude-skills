...
> Data with Voila. data binding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-data`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Data
...
## Ресурсы
- Оригинальный навык: `data/voila-data/SKILL.md`
