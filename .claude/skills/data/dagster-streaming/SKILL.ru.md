...
version: "1.0"
language: ru
original: dagster-streaming
---

# Dagster Streaming

> Streaming with Dagster. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Streaming
...
## Ресурсы
- Оригинальный навык: `data/dagster-streaming/SKILL.md`
