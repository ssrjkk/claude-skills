...
version: "1.0"
language: ru
original: dbt-optimization
---

# Dbt Optimization

> Optimization with dbt. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Optimization
...
## Ресурсы
- Оригинальный навык: `data/dbt-optimization/SKILL.md`
