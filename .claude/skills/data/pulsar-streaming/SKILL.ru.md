...
version: "1.0"
language: ru
original: pulsar-streaming
---

# Pulsar Streaming

> Streaming with Pulsar. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulsar-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Streaming
...
## Ресурсы
- Оригинальный навык: `data/pulsar-streaming/SKILL.md`
