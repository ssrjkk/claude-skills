...
> Batch with dbt. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Batch
...
## Ресурсы
- Оригинальный навык: `data/dbt-batch/SKILL.md`
