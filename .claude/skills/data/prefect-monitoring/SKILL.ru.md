...
category: data
tags: [prefect-monitoring, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prefect-monitoring
---

# Prefect Monitoring

> Monitoring with Prefect. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Monitoring
...
## Ресурсы
- Оригинальный навык: `data/prefect-monitoring/SKILL.md`
