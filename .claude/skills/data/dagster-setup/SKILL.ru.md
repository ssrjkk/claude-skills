...
version: "1.0"
language: ru
original: dagster-setup
---

# Dagster Setup

> Setup with Dagster. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Setup
...
## Ресурсы
- Оригинальный навык: `data/dagster-setup/SKILL.md`
