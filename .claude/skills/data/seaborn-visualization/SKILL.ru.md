...
version: "1.0"
language: ru
original: seaborn-visualization
---

# Seaborn Visualization

> Visualization with Seaborn. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Visualization
...
## Ресурсы
- Оригинальный навык: `data/seaborn-visualization/SKILL.md`
