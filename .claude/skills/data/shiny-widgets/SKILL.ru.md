...
category: data
tags: [shiny-widgets, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shiny-widgets
---

# Shiny Widgets

> Widgets with Shiny. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Widgets
...
## Ресурсы
- Оригинальный навык: `data/shiny-widgets/SKILL.md`
