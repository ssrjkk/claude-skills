...
version: "1.0"
language: ru
original: streamlit-charts
---

# Streamlit Charts

> Charts with Streamlit. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Charts
...
## Ресурсы
- Оригинальный навык: `data/streamlit-charts/SKILL.md`
