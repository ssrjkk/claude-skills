...
version: "1.0"
language: ru
original: jupyter-dataframe
---

# Jupyter Dataframe

> DataFrame with Jupyter. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jupyter-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Jupyter Dataframe
...
## Ресурсы
- Оригинальный навык: `data/jupyter-dataframe/SKILL.md`
