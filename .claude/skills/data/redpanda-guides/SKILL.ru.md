...
version: "1.0"
language: ru
original: redpanda-guides
---

# Redpanda Guides

> Guides for Redpanda: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `redpanda-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redpanda Guides
...
## Ресурсы
- Оригинал: data/redpanda-guides/SKILL.md
