...
category: data
tags: [bokeh-transformation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bokeh-transformation
---

# Bokeh Transformation

> Transformation with Bokeh. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Transformation
...
## Ресурсы
- Оригинальный навык: `data/bokeh-transformation/SKILL.md`
