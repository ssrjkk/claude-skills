...
category: data
tags: [matplotlib-analysis, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: matplotlib-analysis
---

# Matplotlib Analysis

> Analysis with Matplotlib. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Analysis
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-analysis/SKILL.md`
