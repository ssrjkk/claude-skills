...
version: "1.0"
language: ru
original: plotly-dataframe
---

# Plotly Dataframe

> DataFrame with Plotly. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Dataframe
...
## Ресурсы
- Оригинальный навык: `data/plotly-dataframe/SKILL.md`
