...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Security
...
## Ресурсы
- Оригинальный навык: data/pandas-security/SKILL.md
