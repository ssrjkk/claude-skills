...
> ETL with dbt. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Etl
...
## Ресурсы
- Оригинальный навык: `data/dbt-etl/SKILL.md`
