...
version: "1.0"
language: ru
original: matplotlib-deployment
---

# Matplotlib Deployment

> Deployment with Matplotlib. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Deployment
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-deployment/SKILL.md`
