...
version: "1.0"
language: ru
original: nats-guides
---

# Nats Guides

> Guides for Nats: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nats-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nats Guides
...
## Ресурсы
- Оригинал: data/nats-guides/SKILL.md
