...
version: "1.0"
language: ru
original: hadoop-batch
---

# Hadoop Batch

> Batch with Hadoop. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Batch
...
## Ресурсы
- Оригинальный навык: `data/hadoop-batch/SKILL.md`
