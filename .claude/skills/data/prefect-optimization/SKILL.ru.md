...
category: data
tags: [prefect-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prefect-optimization
---

# Prefect Optimization

> Optimization with Prefect. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Optimization
...
## Ресурсы
- Оригинальный навык: `data/prefect-optimization/SKILL.md`
