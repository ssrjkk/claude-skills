...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Advanced
...
## Ресурсы
- Оригинальный навык: data/dbt-advanced/SKILL.md
