...
category: data
tags: [clickhouse-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clickhouse-fundamentals
---

# Clickhouse Fundamentals

> Fundamentals for Clickhouse: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clickhouse-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Clickhouse Fundamentals
...
## Ресурсы
- Оригинал: data/clickhouse-fundamentals/SKILL.md
