...
version: "1.0"
language: ru
original: soda-production
---

# Soda Production

> Production for Soda: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: soda-production.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Soda Production
