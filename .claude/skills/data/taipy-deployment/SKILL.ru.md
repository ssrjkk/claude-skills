...
version: "1.0"
language: ru
original: taipy-deployment
---

# Taipy Deployment

> Deployment with Taipy. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Deployment
...
## Ресурсы
- Оригинальный навык: `data/taipy-deployment/SKILL.md`
