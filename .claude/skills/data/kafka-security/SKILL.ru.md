...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Security
...
## Ресурсы
- Оригинальный навык: data/kafka-security/SKILL.md
