...
version: "1.0"
language: ru
original: kafka-batch
---

# Kafka Batch

> Batch with Kafka. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Batch
...
## Ресурсы
- Оригинальный навык: `data/kafka-batch/SKILL.md`
