...
version: "1.0"
language: ru
original: trino-setup
---

# Trino Setup

> Setup with Trino. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Setup
...
## Ресурсы
- Оригинальный навык: `data/trino-setup/SKILL.md`
