...
> ETL with Trino. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Etl
...
## Ресурсы
- Оригинальный навык: `data/trino-etl/SKILL.md`
