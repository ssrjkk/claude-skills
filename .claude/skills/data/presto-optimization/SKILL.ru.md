...
version: "1.0"
language: ru
original: presto-optimization
---

# Presto Optimization

> Optimization with Presto. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Optimization
...
## Ресурсы
- Оригинальный навык: `data/presto-optimization/SKILL.md`
