...
category: data
tags: [airflow-batch, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-batch
---

# Airflow Batch

> Batch with Airflow. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Batch
...
## Ресурсы
- Оригинальный навык: `data/airflow-batch/SKILL.md`
