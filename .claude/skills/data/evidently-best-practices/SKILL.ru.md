...
version: "1.0"
language: ru
original: evidently-best-practices
---

# Evidently Best Practices

> Best Practices for Evidently: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: evidently-best-practices.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Evidently Best Practices
...
## Ресурсы
- data/evidently-best-practices/SKILL.md
