...
version: "1.0"
language: ru
original: scipy-analysis
---

# Scipy Analysis

> Analysis with SciPy. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Analysis
...
## Ресурсы
- Оригинальный навык: `data/scipy-analysis/SKILL.md`
