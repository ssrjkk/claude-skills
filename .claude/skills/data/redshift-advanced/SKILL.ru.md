...
category: data
tags: [redshift-advanced, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redshift-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Advanced
...
## Ресурсы
- Оригинальный навык: data/redshift-advanced/SKILL.md
