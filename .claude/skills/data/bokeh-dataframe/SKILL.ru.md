...
category: data
tags: [bokeh-dataframe, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bokeh-dataframe
---

# Bokeh Dataframe

> DataFrame with Bokeh. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Dataframe
...
## Ресурсы
- Оригинальный навык: `data/bokeh-dataframe/SKILL.md`
