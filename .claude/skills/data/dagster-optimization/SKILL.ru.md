...
version: "1.0"
language: ru
original: dagster-optimization
---

# Dagster Optimization

> Optimization with Dagster. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Optimization
...
## Ресурсы
- Оригинальный навык: `data/dagster-optimization/SKILL.md`
