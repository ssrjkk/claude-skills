...
version: "1.0"
language: ru
original: pulsar-optimization
---

# Pulsar Optimization

> Optimization with Pulsar. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulsar-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Optimization
...
## Ресурсы
- Оригинальный навык: `data/pulsar-optimization/SKILL.md`
