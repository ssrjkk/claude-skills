...
version: "1.0"
language: ru
original: redshift-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Optimization
...
## Ресурсы
- Оригинальный навык: data/redshift-optimization/SKILL.md
