...
version: "1.0"
language: ru
original: voila-layout
---

# Voila Layout

> Layout with Voila. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Layout
...
## Ресурсы
- Оригинальный навык: `data/voila-layout/SKILL.md`
