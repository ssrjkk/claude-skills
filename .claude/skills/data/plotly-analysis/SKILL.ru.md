...
version: "1.0"
language: ru
original: plotly-analysis
---

# Plotly Analysis

> Analysis with Plotly. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Analysis
...
## Ресурсы
- Оригинальный навык: `data/plotly-analysis/SKILL.md`
