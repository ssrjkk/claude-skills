...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tableau-security`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Tableau Security
...
## Ресурсы
- Оригинальный навык: data/tableau-security/SKILL.md
