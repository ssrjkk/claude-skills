...
category: data
tags: [shiny-theming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shiny-theming
---

# Shiny Theming

> Theming with Shiny. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Theming
...
## Ресурсы
- Оригинальный навык: `data/shiny-theming/SKILL.md`
