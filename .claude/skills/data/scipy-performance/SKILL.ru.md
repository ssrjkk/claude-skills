...
version: "1.0"
language: ru
original: scipy-performance
---

# Scipy Performance

> Performance with SciPy. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Performance
...
## Ресурсы
- Оригинальный навык: `data/scipy-performance/SKILL.md`
