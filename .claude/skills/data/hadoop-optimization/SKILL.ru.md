...
category: data
tags: [hadoop-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hadoop-optimization
---

# Hadoop Optimization

> Optimization with Hadoop. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Optimization
...
## Ресурсы
- Оригинальный навык: `data/hadoop-optimization/SKILL.md`
