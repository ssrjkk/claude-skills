...
version: "1.0"
language: ru
original: scipy-integration
---

# Scipy Integration

> Integration with SciPy. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Integration
...
## Ресурсы
- Оригинальный навык: `data/scipy-integration/SKILL.md`
