...
version: "1.0"
language: ru
original: polars-analysis
---

# Polars Analysis

> Analysis with Polars. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Analysis
...
## Ресурсы
- Оригинальный навык: `data/polars-analysis/SKILL.md`
