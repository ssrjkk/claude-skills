...
category: data
tags: [pulsar-quickstart, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pulsar-quickstart
---

# Pulsar Quickstart

> Quickstart for Pulsar: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pulsar-quickstart`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Quickstart
...
## Ресурсы
- Оригинал: data/pulsar-quickstart/SKILL.md
