...
category: data
tags: [kafka-advanced, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kafka-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Advanced
...
## Ресурсы
- Оригинальный навык: data/kafka-advanced/SKILL.md
