...
category: data
tags: [seaborn-cleaning, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: seaborn-cleaning
---

# Seaborn Cleaning

> Cleaning with Seaborn. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `seaborn-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Seaborn Cleaning
...
## Ресурсы
- Оригинальный навык: `data/seaborn-cleaning/SKILL.md`
