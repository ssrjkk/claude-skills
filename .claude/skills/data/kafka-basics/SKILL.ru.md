...
category: data
tags: [kafka-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kafka-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Basics
...
## Ресурсы
- Оригинальный навык: data/kafka-basics/SKILL.md
