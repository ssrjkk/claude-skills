...
category: data
tags: [bigquery-optimization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bigquery-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Optimization
...
## Ресурсы
- Оригинальный навык: data/bigquery-optimization/SKILL.md
