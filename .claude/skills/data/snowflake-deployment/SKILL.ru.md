...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Deployment
...
## Ресурсы
- Оригинальный навык: data/snowflake-deployment/SKILL.md
