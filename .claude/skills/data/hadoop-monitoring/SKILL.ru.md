...
version: "1.0"
language: ru
original: hadoop-monitoring
---

# Hadoop Monitoring

> Monitoring with Hadoop. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Monitoring
...
## Ресурсы
- Оригинальный навык: `data/hadoop-monitoring/SKILL.md`
