...
> Batch with NiFi. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Batch
...
## Ресурсы
- Оригинальный навык: `data/nifi-batch/SKILL.md`
