...
version: "1.0"
language: ru
original: trino-batch
---

# Trino Batch

> Batch with Trino. batch processing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Batch
...
## Ресурсы
- Оригинальный навык: `data/trino-batch/SKILL.md`
