...
version: "1.0"
language: ru
original: dash-charts
---

# Dash Charts

> Charts with Dash. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dash Charts
...
## Ресурсы
- Оригинальный навык: `data/dash-charts/SKILL.md`
