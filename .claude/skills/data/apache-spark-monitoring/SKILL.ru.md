...
version: "1.0"
language: ru
original: apache-spark-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Monitoring
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-monitoring/SKILL.md`
