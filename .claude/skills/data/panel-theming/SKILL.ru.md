...
version: "1.0"
language: ru
original: panel-theming
---

# Panel Theming

> Theming with Panel. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Theming
...
## Ресурсы
- Оригинальный навык: `data/panel-theming/SKILL.md`
