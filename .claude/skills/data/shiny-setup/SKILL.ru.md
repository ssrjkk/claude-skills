...
version: "1.0"
language: ru
original: shiny-setup
---

# Shiny Setup

> Setup with Shiny. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Setup
...
## Ресурсы
- Оригинальный навык: `data/shiny-setup/SKILL.md`
