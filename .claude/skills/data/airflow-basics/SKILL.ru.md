...
category: data
tags: [airflow-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Basics
...
## Ресурсы
- Оригинальный навык: data/airflow-basics/SKILL.md
