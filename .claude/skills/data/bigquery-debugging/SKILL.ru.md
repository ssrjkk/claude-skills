...
category: data
tags: [bigquery-debugging, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bigquery-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Debugging
...
## Ресурсы
- Оригинальный навык: data/bigquery-debugging/SKILL.md
