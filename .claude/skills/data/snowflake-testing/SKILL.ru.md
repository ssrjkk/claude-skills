...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-testing`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Testing
...
## Ресурсы
- Оригинальный навык: data/snowflake-testing/SKILL.md
