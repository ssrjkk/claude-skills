...
category: data
tags: [redshift-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redshift-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Basics
...
## Ресурсы
- Оригинальный навык: data/redshift-basics/SKILL.md
