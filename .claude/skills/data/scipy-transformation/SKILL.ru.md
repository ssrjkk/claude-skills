...
category: data
tags: [scipy-transformation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scipy-transformation
---

# Scipy Transformation

> Transformation with SciPy. transform.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-transformation`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Transformation
...
## Ресурсы
- Оригинальный навык: `data/scipy-transformation/SKILL.md`
