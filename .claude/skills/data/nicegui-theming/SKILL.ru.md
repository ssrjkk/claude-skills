...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Theming
...
## Ресурсы
- Оригинальный навык: `data/nicegui-theming/SKILL.md`
