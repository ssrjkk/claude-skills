...
## Быстрый старт
Этот навык на русском языке. Оригинал: `snowflake-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Snowflake Debugging
...
## Ресурсы
- Оригинальный навык: data/snowflake-debugging/SKILL.md
