...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Setup
...
## Ресурсы
- Оригинальный навык: data/databricks-setup/SKILL.md
