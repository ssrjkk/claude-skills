...
version: "1.0"
language: ru
original: dbt-integration
---

# Dbt Integration

> Integration with dbt. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Integration
...
## Ресурсы
- Оригинальный навык: `data/dbt-integration/SKILL.md`
