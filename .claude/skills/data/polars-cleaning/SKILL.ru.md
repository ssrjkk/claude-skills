...
category: data
tags: [polars-cleaning, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: polars-cleaning
---

# Polars Cleaning

> Cleaning with Polars. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Cleaning
...
## Ресурсы
- Оригинальный навык: `data/polars-cleaning/SKILL.md`
