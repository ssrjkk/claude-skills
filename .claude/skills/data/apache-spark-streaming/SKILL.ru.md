...
category: data
tags: [apache-spark-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-spark-streaming
---

# Apache Spark Streaming

> Streaming with Apache Spark. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Streaming
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-streaming/SKILL.md`
