...
category: data
tags: [prefect-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prefect-streaming
---

# Prefect Streaming

> Streaming with Prefect. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Streaming
...
## Ресурсы
- Оригинальный навык: `data/prefect-streaming/SKILL.md`
