...
version: "1.0"
language: ru
original: kinesis-streaming
---

# Kinesis Streaming

> Streaming with Kinesis. real-time.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Streaming
...
## Ресурсы
- Оригинальный навык: `data/kinesis-streaming/SKILL.md`
