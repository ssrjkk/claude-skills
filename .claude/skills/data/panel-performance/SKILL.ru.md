...
version: "1.0"
language: ru
original: panel-performance
---

# Panel Performance

> Performance with Panel. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Performance
...
## Ресурсы
- Оригинальный навык: `data/panel-performance/SKILL.md`
