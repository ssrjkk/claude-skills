...
> ETL with Hadoop. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hadoop-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Hadoop Etl
...
## Ресурсы
- Оригинальный навык: `data/hadoop-etl/SKILL.md`
