...
version: "1.0"
language: ru
original: panel-charts
---

# Panel Charts

> Charts with Panel. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Charts
...
## Ресурсы
- Оригинальный навык: `data/panel-charts/SKILL.md`
