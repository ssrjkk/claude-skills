...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Setup
...
## Ресурсы
- Оригинальный навык: data/bigquery-setup/SKILL.md
