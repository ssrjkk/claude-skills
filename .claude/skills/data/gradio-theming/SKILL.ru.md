...
version: "1.0"
language: ru
original: gradio-theming
---

# Gradio Theming

> Theming with Gradio. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Theming
...
## Ресурсы
- Оригинальный навык: `data/gradio-theming/SKILL.md`
