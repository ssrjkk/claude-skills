...
version: "1.0"
language: ru
original: cml-production
---

# Cml Production

> Production for Cml: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: cml-production.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Cml Production
