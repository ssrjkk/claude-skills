...
version: "1.0"
language: ru
original: altair-visualization
---

# Altair Visualization

> Visualization with Altair. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Visualization
...
## Ресурсы
- Оригинальный навык: `data/altair-visualization/SKILL.md`
