...
category: data
tags: [gradio-charts, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gradio-charts
---

# Gradio Charts

> Charts with Gradio. charts.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-charts`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Charts
...
## Ресурсы
- Оригинальный навык: `data/gradio-charts/SKILL.md`
