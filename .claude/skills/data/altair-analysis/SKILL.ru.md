...
## Быстрый старт
Этот навык на русском языке. Оригинал: `altair-analysis`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Altair Analysis
...
## Ресурсы
- Оригинальный навык: `data/altair-analysis/SKILL.md`
