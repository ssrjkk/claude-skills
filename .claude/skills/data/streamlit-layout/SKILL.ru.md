...
version: "1.0"
language: ru
original: streamlit-layout
---

# Streamlit Layout

> Layout with Streamlit. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Layout
...
## Ресурсы
- Оригинальный навык: `data/streamlit-layout/SKILL.md`
