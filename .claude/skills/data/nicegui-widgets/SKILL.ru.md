...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Widgets
...
## Ресурсы
- Оригинальный навык: `data/nicegui-widgets/SKILL.md`
