...
version: "1.0"
language: ru
original: gradio-layout
---

# Gradio Layout

> Layout with Gradio. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Layout
...
## Ресурсы
- Оригинальный навык: `data/gradio-layout/SKILL.md`
