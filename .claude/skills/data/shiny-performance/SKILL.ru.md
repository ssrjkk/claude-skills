...
version: "1.0"
language: ru
original: shiny-performance
---

# Shiny Performance

> Performance with Shiny. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Performance
...
## Ресурсы
- Оригинальный навык: `data/shiny-performance/SKILL.md`
