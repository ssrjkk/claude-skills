...
category: data
tags: [pinot-fundamentals, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pinot-fundamentals
---

# Pinot Fundamentals

> Fundamentals for Pinot: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pinot-fundamentals`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pinot Fundamentals
...
## Ресурсы
- Оригинал: data/pinot-fundamentals/SKILL.md
