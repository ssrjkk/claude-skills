...
version: "1.0"
language: ru
original: pandas-performance
---

# Pandas Performance

> Performance with Pandas. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Performance
...
## Ресурсы
- Оригинальный навык: `data/pandas-performance/SKILL.md`
