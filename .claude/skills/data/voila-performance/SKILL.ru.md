...
version: "1.0"
language: ru
original: voila-performance
---

# Voila Performance

> Performance with Voila. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voila-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Voila Performance
...
## Ресурсы
- Оригинальный навык: `data/voila-performance/SKILL.md`
