...
category: data
tags: [wandb-automation, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: wandb-automation
---

# Wandb Automation

> Automation for Wandb: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: wandb-automation.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Wandb Automation
...
## Ресурсы
- data/wandb-automation/SKILL.md
