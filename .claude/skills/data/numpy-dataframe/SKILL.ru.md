...
version: "1.0"
language: ru
original: numpy-dataframe
---

# Numpy Dataframe

> DataFrame with NumPy. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Dataframe
...
## Ресурсы
- Оригинальный навык: `data/numpy-dataframe/SKILL.md`
