...
category: data
tags: [apache-spark-sql, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-spark-sql
---

# Apache Spark Sql

> SQL with Apache Spark. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Sql
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-sql/SKILL.md`
