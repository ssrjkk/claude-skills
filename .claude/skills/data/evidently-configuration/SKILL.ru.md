...
version: "1.0"
language: ru
original: evidently-configuration
---

# Evidently Configuration

> Configuration for Evidently: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: evidently-configuration.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Evidently Configuration
...
## Ресурсы
- data/evidently-configuration/SKILL.md
