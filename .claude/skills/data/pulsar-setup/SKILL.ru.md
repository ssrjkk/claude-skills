...
category: data
tags: [pulsar-setup, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pulsar-setup
---

# Pulsar Setup

> Setup with Pulsar. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulsar-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pulsar Setup
...
## Ресурсы
- Оригинальный навык: `data/pulsar-setup/SKILL.md`
