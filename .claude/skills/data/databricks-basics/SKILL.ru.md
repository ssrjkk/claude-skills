...
category: data
tags: [databricks-basics, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: databricks-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Basics
...
## Ресурсы
- Оригинальный навык: data/databricks-basics/SKILL.md
