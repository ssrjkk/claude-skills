...
version: "1.0"
language: ru
original: nicegui-performance
---

# Nicegui Performance

> Performance with NiceGUI. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-performance`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Performance
...
## Ресурсы
- Оригинальный навык: `data/nicegui-performance/SKILL.md`
