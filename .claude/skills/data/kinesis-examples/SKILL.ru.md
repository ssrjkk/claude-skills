...
version: "1.0"
language: ru
original: kinesis-examples
---

# Kinesis Examples

> Examples for Kinesis: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinesis-examples`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Examples
...
## Ресурсы
- Оригинал: data/kinesis-examples/SKILL.md
