...
> Visualization with Matplotlib. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `matplotlib-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Matplotlib Visualization
...
## Ресурсы
- Оригинальный навык: `data/matplotlib-visualization/SKILL.md`
