...
version: "1.0"
language: ru
original: airflow-setup
---

# Airflow Setup

> Setup with Airflow. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Setup
...
## Ресурсы
- Оригинальный навык: `data/airflow-setup/SKILL.md`
