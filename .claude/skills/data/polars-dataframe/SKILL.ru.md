...
category: data
tags: [polars-dataframe, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> DataFrame with Polars. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `polars-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Polars Dataframe
...
## Ресурсы
- Оригинальный навык: `data/polars-dataframe/SKILL.md`
