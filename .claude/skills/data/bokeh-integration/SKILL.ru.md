...
version: "1.0"
language: ru
original: bokeh-integration
---

# Bokeh Integration

> Integration with Bokeh. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bokeh-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bokeh Integration
...
## Ресурсы
- Оригинальный навык: `data/bokeh-integration/SKILL.md`
