...
version: "1.0"
language: ru
original: kinesis-optimization
---

# Kinesis Optimization

> Optimization with Kinesis. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-optimization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Optimization
...
## Ресурсы
- Оригинальный навык: `data/kinesis-optimization/SKILL.md`
