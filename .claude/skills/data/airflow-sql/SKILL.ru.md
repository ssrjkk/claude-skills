...
version: "1.0"
language: ru
original: airflow-sql
---

# Airflow Sql

> SQL with Airflow. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Sql
...
## Ресурсы
- Оригинальный навык: `data/airflow-sql/SKILL.md`
