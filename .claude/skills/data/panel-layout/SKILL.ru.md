...
category: data
tags: [panel-layout, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Layout with Panel. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Layout
...
## Ресурсы
- Оригинальный навык: `data/panel-layout/SKILL.md`
