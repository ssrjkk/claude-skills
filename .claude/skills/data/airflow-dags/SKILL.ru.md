...
category: data
tags: [airflow-dags, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-dags
---

# Airflow Dags

> Creates DAGs for Apache Airflow with tasks and scheduling. Use for ETL pipeline orchestration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-dags`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Dags
...
## Ресурсы
- Оригинальный навык: `data/airflow-dags/SKILL.md`
