...
category: data
tags: [redshift-api, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: redshift-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `redshift-api`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Redshift Api
...
## Ресурсы
- Оригинальный навык: data/redshift-api/SKILL.md
