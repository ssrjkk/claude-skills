...
version: "1.0"
language: ru
original: kinesis-monitoring
---

# Kinesis Monitoring

> Monitoring with Kinesis. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kinesis-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kinesis Monitoring
...
## Ресурсы
- Оригинальный навык: `data/kinesis-monitoring/SKILL.md`
