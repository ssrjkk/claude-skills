...
> ETL with NiFi. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Etl
...
## Ресурсы
- Оригинальный навык: `data/nifi-etl/SKILL.md`
