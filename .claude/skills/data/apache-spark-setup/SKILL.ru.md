...
category: data
tags: [apache-spark-setup, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: apache-spark-setup
---

# Apache Spark Setup

> Setup with Apache Spark. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Setup
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-setup/SKILL.md`
