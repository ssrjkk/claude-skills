...
## Быстрый старт
Этот навык на русском языке. Оригинал: `apache-spark-batch`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Apache Spark Batch
...
## Ресурсы
- Оригинальный навык: `data/apache-spark-batch/SKILL.md`
