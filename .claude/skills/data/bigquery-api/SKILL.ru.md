...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bigquery-api`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Bigquery Api
...
## Ресурсы
- Оригинальный навык: data/bigquery-api/SKILL.md
