...
version: "1.0"
language: ru
original: taipy-widgets
---

# Taipy Widgets

> Widgets with Taipy. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Widgets
...
## Ресурсы
- Оригинальный навык: `data/taipy-widgets/SKILL.md`
