...
> DataFrame with Pandas. data manipulation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-dataframe`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Dataframe
...
## Ресурсы
- Оригинальный навык: `data/pandas-dataframe/SKILL.md`
