...
version: "1.0"
language: ru
original: databricks-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Deployment
...
## Ресурсы
- Оригинальный навык: data/databricks-deployment/SKILL.md
