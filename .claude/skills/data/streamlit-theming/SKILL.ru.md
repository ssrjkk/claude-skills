...
version: "1.0"
language: ru
original: streamlit-theming
---

# Streamlit Theming

> Theming with Streamlit. themes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `streamlit-theming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Streamlit Theming
...
## Ресурсы
- Оригинальный навык: `data/streamlit-theming/SKILL.md`
