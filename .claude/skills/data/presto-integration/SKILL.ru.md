...
category: data
tags: [presto-integration, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: presto-integration
---

# Presto Integration

> Integration with Presto. connectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `presto-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Presto Integration
...
## Ресурсы
- Оригинальный навык: `data/presto-integration/SKILL.md`
