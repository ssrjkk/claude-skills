...
category: data
tags: [prefect-etl, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prefect-etl
---

# Prefect Etl

> ETL with Prefect. extract-transform-load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-etl`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Etl
...
## Ресурсы
- Оригинальный навык: `data/prefect-etl/SKILL.md`
