...
version: "1.0"
language: ru
original: nicegui-deployment
---

# Nicegui Deployment

> Deployment with NiceGUI. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nicegui-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nicegui Deployment
...
## Ресурсы
- Оригинальный навык: `data/nicegui-deployment/SKILL.md`
