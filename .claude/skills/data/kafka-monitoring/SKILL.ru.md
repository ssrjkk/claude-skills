...
version: "1.0"
language: ru
original: kafka-monitoring
---

# Kafka Monitoring

> Monitoring with Kafka. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kafka-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Kafka Monitoring
...
## Ресурсы
- Оригинальный навык: `data/kafka-monitoring/SKILL.md`
