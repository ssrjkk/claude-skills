...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-basics`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Basics
...
## Ресурсы
- Оригинальный навык: data/pandas-basics/SKILL.md
