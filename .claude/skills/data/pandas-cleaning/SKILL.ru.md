...
category: data
tags: [pandas-cleaning, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-cleaning
---

# Pandas Cleaning

> Cleaning with Pandas. data cleaning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-cleaning`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Cleaning
...
## Ресурсы
- Оригинальный навык: `data/pandas-cleaning/SKILL.md`
