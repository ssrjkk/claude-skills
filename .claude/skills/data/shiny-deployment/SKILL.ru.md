...
category: data
tags: [shiny-deployment, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shiny-deployment
---

# Shiny Deployment

> Deployment with Shiny. deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shiny-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Shiny Deployment
...
## Ресурсы
- Оригинальный навык: `data/shiny-deployment/SKILL.md`
