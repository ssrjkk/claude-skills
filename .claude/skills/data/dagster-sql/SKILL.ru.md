...
version: "1.0"
language: ru
original: dagster-sql
---

# Dagster Sql

> SQL with Dagster. SQL queries.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagster-sql`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dagster Sql
...
## Ресурсы
- Оригинальный навык: `data/dagster-sql/SKILL.md`
