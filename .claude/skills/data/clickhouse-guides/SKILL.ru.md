...
version: "1.0"
language: ru
original: clickhouse-guides
---

# Clickhouse Guides

> Guides for Clickhouse: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clickhouse-guides`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Clickhouse Guides
...
## Ресурсы
- Оригинал: data/clickhouse-guides/SKILL.md
