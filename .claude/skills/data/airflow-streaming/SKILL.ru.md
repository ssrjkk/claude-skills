...
category: data
tags: [airflow-streaming, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: airflow-streaming
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-streaming`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Streaming
...
## Ресурсы
- Оригинальный навык: `data/airflow-streaming/SKILL.md`
