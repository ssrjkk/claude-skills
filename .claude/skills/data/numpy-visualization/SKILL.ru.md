...
version: "1.0"
language: ru
original: numpy-visualization
---

# Numpy Visualization

> Visualization with NumPy. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `numpy-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Numpy Visualization
...
## Ресурсы
- Оригинальный навык: `data/numpy-visualization/SKILL.md`
