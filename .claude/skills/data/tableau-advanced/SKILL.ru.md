...
## Быстрый старт
Этот навык на русском языке. Оригинал: `tableau-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Tableau Advanced
...
## Ресурсы
- Оригинальный навык: data/tableau-advanced/SKILL.md
