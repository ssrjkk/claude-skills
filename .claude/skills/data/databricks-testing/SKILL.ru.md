...
## Быстрый старт
Этот навык на русском языке. Оригинал: `databricks-testing`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Databricks Testing
...
## Ресурсы
- Оригинальный навык: data/databricks-testing/SKILL.md
