...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-testing`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Testing
...
## Ресурсы
- Оригинальный навык: data/airflow-testing/SKILL.md
