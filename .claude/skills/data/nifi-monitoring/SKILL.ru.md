...
version: "1.0"
language: ru
original: nifi-monitoring
---

# Nifi Monitoring

> Monitoring with NiFi. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nifi-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Nifi Monitoring
...
## Ресурсы
- Оригинальный навык: `data/nifi-monitoring/SKILL.md`
