...
version: "1.0"
language: ru
original: prefect-setup
---

# Prefect Setup

> Setup with Prefect. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prefect-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Prefect Setup
...
## Ресурсы
- Оригинальный навык: `data/prefect-setup/SKILL.md`
