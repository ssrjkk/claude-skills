...
## Быстрый старт
Этот навык на русском языке. Оригинал: `trino-integration`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Trino Integration
...
## Ресурсы
- Оригинальный навык: `data/trino-integration/SKILL.md`
