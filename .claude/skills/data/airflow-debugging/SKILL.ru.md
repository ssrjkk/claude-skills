...
## Быстрый старт
Этот навык на русском языке. Оригинал: `airflow-debugging`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Airflow Debugging
...
## Ресурсы
- Оригинальный навык: data/airflow-debugging/SKILL.md
