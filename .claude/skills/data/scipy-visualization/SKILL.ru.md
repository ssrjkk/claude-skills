...
category: data
tags: [scipy-visualization, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: scipy-visualization
---

# Scipy Visualization

> Visualization with SciPy. charting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `scipy-visualization`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Scipy Visualization
...
## Ресурсы
- Оригинальный навык: `data/scipy-visualization/SKILL.md`
