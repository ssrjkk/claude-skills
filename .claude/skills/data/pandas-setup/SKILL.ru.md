...
category: data
tags: [pandas-setup, data, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pandas-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Setup
...
## Ресурсы
- Оригинальный навык: data/pandas-setup/SKILL.md
