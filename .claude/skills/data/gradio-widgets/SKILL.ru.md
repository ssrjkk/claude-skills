...
version: "1.0"
language: ru
original: gradio-widgets
---

# Gradio Widgets

> Widgets with Gradio. input widgets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gradio-widgets`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Gradio Widgets
...
## Ресурсы
- Оригинальный навык: `data/gradio-widgets/SKILL.md`
