...
version: "1.0"
language: ru
original: taipy-layout
---

# Taipy Layout

> Layout with Taipy. app layout.

## Быстрый старт
Этот навык на русском языке. Оригинал: `taipy-layout`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Taipy Layout
...
## Ресурсы
- Оригинальный навык: `data/taipy-layout/SKILL.md`
