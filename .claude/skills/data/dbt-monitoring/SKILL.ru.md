...
version: "1.0"
language: ru
original: dbt-monitoring
---

# Dbt Monitoring

> Monitoring with dbt. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dbt-monitoring`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Dbt Monitoring
...
## Ресурсы
- Оригинальный навык: `data/dbt-monitoring/SKILL.md`
