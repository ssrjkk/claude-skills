...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pandas-advanced`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Pandas Advanced
...
## Ресурсы
- Оригинальный навык: data/pandas-advanced/SKILL.md
