...
> Setup with Panel. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `panel-setup`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Panel Setup
...
## Ресурсы
- Оригинальный навык: `data/panel-setup/SKILL.md`
