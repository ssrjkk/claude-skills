...
version: "1.0"
language: ru
original: plotly-deployment
---

# Plotly Deployment

> Deployment with Plotly. app deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plotly-deployment`.

## Когда использовать
- Работа с Data Science
- Выполнение задач, связанных с Plotly Deployment
...
## Ресурсы
- Оригинальный навык: `data/plotly-deployment/SKILL.md`
