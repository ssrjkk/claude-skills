...
version: "1.0"
language: ru
original: thingsboard-devices
---

# Thingsboard Devices

> Devices with ThingsBoard. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Devices
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-devices/SKILL.md`
