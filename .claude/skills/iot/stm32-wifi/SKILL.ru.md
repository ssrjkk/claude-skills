...
## Быстрый старт
Этот навык на русском языке. Оригинал: `stm32-wifi`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Stm32 Wifi
...
## Ресурсы
- Оригинальный навык: `iot/stm32-wifi/SKILL.md`
