...
> Power with Mbed OS. power management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mbed-power`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Mbed Power
...
## Ресурсы
- Оригинальный навык: `iot/mbed-power/SKILL.md`
