...
version: "1.0"
language: ru
original: home-assistant-dashboards
---

# Home Assistant Dashboards

> Dashboards with Home Assistant. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-dashboards/SKILL.md`
