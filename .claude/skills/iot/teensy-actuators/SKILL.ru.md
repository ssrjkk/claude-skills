...
version: "1.0"
language: ru
original: teensy-actuators
---

# Teensy Actuators

> Actuators with Teensy. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teensy-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Teensy Actuators
...
## Ресурсы
- Оригинальный навык: `iot/teensy-actuators/SKILL.md`
