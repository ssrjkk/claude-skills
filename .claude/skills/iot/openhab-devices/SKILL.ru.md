...
version: "1.0"
language: ru
original: openhab-devices
---

# Openhab Devices

> Devices with openHAB. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Devices
...
## Ресурсы
- Оригинальный навык: `iot/openhab-devices/SKILL.md`
