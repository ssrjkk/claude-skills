...
version: "1.0"
language: ru
original: azure-iot-devices
---

# Azure Iot Devices

> Devices with Azure IoT. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-iot-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Azure Iot Devices
...
## Ресурсы
- Оригинальный навык: `iot/azure-iot-devices/SKILL.md`
