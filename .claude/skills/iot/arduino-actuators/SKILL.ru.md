...
version: "1.0"
language: ru
original: arduino-actuators
---

# Arduino Actuators

> Actuators with Arduino. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Actuators
...
## Ресурсы
- Оригинальный навык: `iot/arduino-actuators/SKILL.md`
