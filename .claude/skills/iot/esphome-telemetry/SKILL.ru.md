...
version: "1.0"
language: ru
original: esphome-telemetry
---

# Esphome Telemetry

> Telemetry with ESPHome. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/esphome-telemetry/SKILL.md`
