...
version: "1.0"
language: ru
original: node-red-commands
---

# Node Red Commands

> Commands with Node-RED. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `node-red-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Node Red Commands
...
## Ресурсы
- Оригинальный навык: `iot/node-red-commands/SKILL.md`
