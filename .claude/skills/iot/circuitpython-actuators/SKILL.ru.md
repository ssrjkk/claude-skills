...
version: "1.0"
language: ru
original: circuitpython-actuators
---

# Circuitpython Actuators

> Actuators with CircuitPython. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circuitpython-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Circuitpython Actuators
...
## Ресурсы
- Оригинальный навык: `iot/circuitpython-actuators/SKILL.md`
