...
## Быстрый старт
Этот навык на русском языке. Оригинал: `circuitpython-pwm`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Circuitpython Pwm
...
## Ресурсы
- Оригинальный навык: `iot/circuitpython-pwm/SKILL.md`
