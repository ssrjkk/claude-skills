...
version: "1.0"
language: ru
original: micropython-adc
---

# Micropython Adc

> ADC with MicroPython. analog input.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-adc`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Adc
...
## Ресурсы
- Оригинальный навык: `iot/micropython-adc/SKILL.md`
