...
version: "1.0"
language: ru
original: micropython-actuators
---

# Micropython Actuators

> Actuators with MicroPython. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Actuators
...
## Ресурсы
- Оригинальный навык: `iot/micropython-actuators/SKILL.md`
