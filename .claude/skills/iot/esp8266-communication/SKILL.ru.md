...
version: "1.0"
language: ru
original: esp8266-communication
---

# Esp8266 Communication

> Comm with ESP8266. I2C.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esp8266-communication`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esp8266 Communication
...
## Ресурсы
- Оригинальный навык: `iot/esp8266-communication/SKILL.md`
