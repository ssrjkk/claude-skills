...
version: "1.0"
language: ru
original: raspberry-pi-adc
---

# Raspberry Pi Adc

> ADC with Raspberry Pi. analog input.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-adc`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Adc
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-adc/SKILL.md`
