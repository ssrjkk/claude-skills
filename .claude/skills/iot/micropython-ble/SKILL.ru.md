...
category: iot
tags: [micropython-ble, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: micropython-ble
---

# Micropython Ble

> BLE with MicroPython. Bluetooth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-ble`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Ble
...
## Ресурсы
- Оригинальный навык: `iot/micropython-ble/SKILL.md`
