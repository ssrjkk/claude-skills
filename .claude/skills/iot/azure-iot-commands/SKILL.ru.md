...
version: "1.0"
language: ru
original: azure-iot-commands
---

# Azure Iot Commands

> Commands with Azure IoT. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-iot-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Azure Iot Commands
...
## Ресурсы
- Оригинальный навык: `iot/azure-iot-commands/SKILL.md`
