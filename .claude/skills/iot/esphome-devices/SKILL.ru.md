...
version: "1.0"
language: ru
original: esphome-devices
---

# Esphome Devices

> Devices with ESPHome. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Devices
...
## Ресурсы
- Оригинальный навык: `iot/esphome-devices/SKILL.md`
