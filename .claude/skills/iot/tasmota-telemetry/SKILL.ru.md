...
category: iot
tags: [tasmota-telemetry, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tasmota-telemetry
---

# Tasmota Telemetry

> Telemetry with Tasmota. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tasmota-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Tasmota Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/tasmota-telemetry/SKILL.md`
