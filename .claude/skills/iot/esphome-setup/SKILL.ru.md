...
version: "1.0"
language: ru
original: esphome-setup
---

# Esphome Setup

> Setup with ESPHome. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Setup
...
## Ресурсы
- Оригинальный навык: `iot/esphome-setup/SKILL.md`
