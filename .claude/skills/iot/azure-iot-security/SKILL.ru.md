...
version: "1.0"
language: ru
original: azure-iot-security
---

# Azure Iot Security

> Security with Azure IoT. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-iot-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Azure Iot Security
...
## Ресурсы
- Оригинальный навык: `iot/azure-iot-security/SKILL.md`
