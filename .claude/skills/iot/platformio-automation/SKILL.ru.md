...
version: "1.0"
language: ru
original: platformio-automation
---

# Platformio Automation

> Automation with PlatformIO. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `platformio-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Platformio Automation
...
## Ресурсы
- Оригинальный навык: `iot/platformio-automation/SKILL.md`
