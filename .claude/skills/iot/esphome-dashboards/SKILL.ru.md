...
version: "1.0"
language: ru
original: esphome-dashboards
---

# Esphome Dashboards

> Dashboards with ESPHome. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/esphome-dashboards/SKILL.md`
