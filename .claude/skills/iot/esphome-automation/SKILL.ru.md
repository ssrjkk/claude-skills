...
version: "1.0"
language: ru
original: esphome-automation
---

# Esphome Automation

> Automation with ESPHome. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Automation
...
## Ресурсы
- Оригинальный навык: `iot/esphome-automation/SKILL.md`
