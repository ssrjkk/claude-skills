...
version: "1.0"
language: ru
original: teensy-gpio
---

# Teensy Gpio

> GPIO with Teensy. digital I/O.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teensy-gpio`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Teensy Gpio
...
## Ресурсы
- Оригинальный навык: `iot/teensy-gpio/SKILL.md`
