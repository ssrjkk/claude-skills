...
version: "1.0"
language: ru
original: esp32-actuators
---

# Esp32 Actuators

> Actuators with ESP32. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esp32-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esp32 Actuators
...
## Ресурсы
- Оригинальный навык: `iot/esp32-actuators/SKILL.md`
