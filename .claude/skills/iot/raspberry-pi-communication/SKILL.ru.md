...
version: "1.0"
language: ru
original: raspberry-pi-communication
---

# Raspberry Pi Communication

> Comm with Raspberry Pi. I2C.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-communication`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Communication
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-communication/SKILL.md`
