...
version: "1.0"
language: ru
original: micropython-setup
---

# Micropython Setup

> Setup with MicroPython. board setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Setup
...
## Ресурсы
- Оригинальный навык: `iot/micropython-setup/SKILL.md`
