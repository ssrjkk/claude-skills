...
version: "1.0"
language: ru
original: aws-iot-security
---

# Aws Iot Security

> Security with AWS IoT. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Security
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-security/SKILL.md`
