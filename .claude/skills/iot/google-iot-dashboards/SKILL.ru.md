...
version: "1.0"
language: ru
original: google-iot-dashboards
---

# Google Iot Dashboards

> Dashboards with Google IoT. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-iot-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Google Iot Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/google-iot-dashboards/SKILL.md`
