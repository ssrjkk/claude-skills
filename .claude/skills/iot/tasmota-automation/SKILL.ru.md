...
version: "1.0"
language: ru
original: tasmota-automation
---

# Tasmota Automation

> Automation with Tasmota. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tasmota-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Tasmota Automation
...
## Ресурсы
- Оригинальный навык: `iot/tasmota-automation/SKILL.md`
