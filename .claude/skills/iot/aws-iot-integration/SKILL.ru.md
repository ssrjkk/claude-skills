...
version: "1.0"
language: ru
original: aws-iot-integration
---

# Aws Iot Integration

> Integration with AWS IoT. integrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-integration`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Integration
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-integration/SKILL.md`
