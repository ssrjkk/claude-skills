...
version: "1.0"
language: ru
original: aws-iot-automation
---

# Aws Iot Automation

> Automation with AWS IoT. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Automation
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-automation/SKILL.md`
