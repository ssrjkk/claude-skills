...
version: "1.0"
language: ru
original: google-iot-telemetry
---

# Google Iot Telemetry

> Telemetry with Google IoT. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-iot-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Google Iot Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/google-iot-telemetry/SKILL.md`
