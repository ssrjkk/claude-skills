...
version: "1.0"
language: ru
original: micropython-wifi
---

# Micropython Wifi

> WiFi with MicroPython. wireless.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-wifi`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Wifi
...
## Ресурсы
- Оригинальный навык: `iot/micropython-wifi/SKILL.md`
