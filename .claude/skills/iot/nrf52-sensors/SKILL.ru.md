...
version: "1.0"
language: ru
original: nrf52-sensors
---

# Nrf52 Sensors

> Sensors with nRF52. sensor integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nrf52-sensors`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Nrf52 Sensors
...
## Ресурсы
- Оригинальный навык: `iot/nrf52-sensors/SKILL.md`
