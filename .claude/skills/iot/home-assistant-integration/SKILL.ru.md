...
category: iot
tags: [home-assistant-integration, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Integration with Home Assistant. integrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-integration`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Integration
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-integration/SKILL.md`
