...
version: "1.0"
language: ru
original: tasmota-devices
---

# Tasmota Devices

> Devices with Tasmota. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tasmota-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Tasmota Devices
...
## Ресурсы
- Оригинальный навык: `iot/tasmota-devices/SKILL.md`
