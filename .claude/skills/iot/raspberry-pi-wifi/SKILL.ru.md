...
category: iot
tags: [raspberry-pi-wifi, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: raspberry-pi-wifi
---

# Raspberry Pi Wifi

> WiFi with Raspberry Pi. wireless.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-wifi`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Wifi
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-wifi/SKILL.md`
