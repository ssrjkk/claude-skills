...
version: "1.0"
language: ru
original: tasmota-dashboards
---

# Tasmota Dashboards

> Dashboards with Tasmota. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tasmota-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Tasmota Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/tasmota-dashboards/SKILL.md`
