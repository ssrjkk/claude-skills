...
category: iot
tags: [openhab-security, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openhab-security
---

# Openhab Security

> Security with openHAB. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Security
...
## Ресурсы
- Оригинальный навык: `iot/openhab-security/SKILL.md`
