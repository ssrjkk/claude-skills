...
version: "1.0"
language: ru
original: openhab-integration
---

# Openhab Integration

> Integration with openHAB. integrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-integration`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Integration
...
## Ресурсы
- Оригинальный навык: `iot/openhab-integration/SKILL.md`
