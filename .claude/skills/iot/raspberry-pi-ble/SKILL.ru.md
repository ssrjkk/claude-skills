...
version: "1.0"
language: ru
original: raspberry-pi-ble
---

# Raspberry Pi Ble

> BLE with Raspberry Pi. Bluetooth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-ble`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Ble
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-ble/SKILL.md`
