...
## Быстрый старт
Этот навык на русском языке. Оригинал: `node-red-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Node Red Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/node-red-telemetry/SKILL.md`
