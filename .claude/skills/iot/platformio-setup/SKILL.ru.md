...
version: "1.0"
language: ru
original: platformio-setup
---

# Platformio Setup

> Setup with PlatformIO. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `platformio-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Platformio Setup
...
## Ресурсы
- Оригинальный навык: `iot/platformio-setup/SKILL.md`
