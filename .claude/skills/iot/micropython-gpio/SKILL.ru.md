...
version: "1.0"
language: ru
original: micropython-gpio
---

# Micropython Gpio

> GPIO with MicroPython. digital I/O.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-gpio`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Gpio
...
## Ресурсы
- Оригинальный навык: `iot/micropython-gpio/SKILL.md`
