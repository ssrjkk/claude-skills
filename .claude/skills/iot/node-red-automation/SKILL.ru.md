...
version: "1.0"
language: ru
original: node-red-automation
---

# Node Red Automation

> Automation with Node-RED. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `node-red-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Node Red Automation
...
## Ресурсы
- Оригинальный навык: `iot/node-red-automation/SKILL.md`
