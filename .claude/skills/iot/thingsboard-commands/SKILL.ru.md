...
version: "1.0"
language: ru
original: thingsboard-commands
---

# Thingsboard Commands

> Commands with ThingsBoard. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Commands
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-commands/SKILL.md`
