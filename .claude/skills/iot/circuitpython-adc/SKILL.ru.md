...
## Быстрый старт
Этот навык на русском языке. Оригинал: `circuitpython-adc`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Circuitpython Adc
...
## Ресурсы
- Оригинальный навык: `iot/circuitpython-adc/SKILL.md`
