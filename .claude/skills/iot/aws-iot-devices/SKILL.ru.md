...
version: "1.0"
language: ru
original: aws-iot-devices
---

# Aws Iot Devices

> Devices with AWS IoT. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Devices
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-devices/SKILL.md`
