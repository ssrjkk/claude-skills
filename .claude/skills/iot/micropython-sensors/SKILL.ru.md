...
version: "1.0"
language: ru
original: micropython-sensors
---

# Micropython Sensors

> Sensors with MicroPython. sensor integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `micropython-sensors`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Micropython Sensors
...
## Ресурсы
- Оригинальный навык: `iot/micropython-sensors/SKILL.md`
