...
version: "1.0"
language: ru
original: openhab-commands
---

# Openhab Commands

> Commands with openHAB. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Commands
...
## Ресурсы
- Оригинальный навык: `iot/openhab-commands/SKILL.md`
