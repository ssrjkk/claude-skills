...
version: "1.0"
language: ru
original: aws-iot-commands
---

# Aws Iot Commands

> Commands with AWS IoT. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Commands
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-commands/SKILL.md`
