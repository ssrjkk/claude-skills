...
version: "1.0"
language: ru
original: aws-iot-telemetry
---

# Aws Iot Telemetry

> Telemetry with AWS IoT. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-telemetry/SKILL.md`
