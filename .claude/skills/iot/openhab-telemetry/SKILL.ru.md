...
category: iot
tags: [openhab-telemetry, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openhab-telemetry
---

# Openhab Telemetry

> Telemetry with openHAB. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/openhab-telemetry/SKILL.md`
