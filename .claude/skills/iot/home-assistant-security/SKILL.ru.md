...
version: "1.0"
language: ru
original: home-assistant-security
---

# Home Assistant Security

> Security with Home Assistant. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Security
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-security/SKILL.md`
