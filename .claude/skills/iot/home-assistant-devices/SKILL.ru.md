...
version: "1.0"
language: ru
original: home-assistant-devices
---

# Home Assistant Devices

> Devices with Home Assistant. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Devices
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-devices/SKILL.md`
