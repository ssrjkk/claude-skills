...
version: "1.0"
language: ru
original: mbed-sensors
---

# Mbed Sensors

> Sensors with Mbed OS. sensor integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mbed-sensors`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Mbed Sensors
...
## Ресурсы
- Оригинальный навык: `iot/mbed-sensors/SKILL.md`
