...
version: "1.0"
language: ru
original: nrf52-actuators
---

# Nrf52 Actuators

> Actuators with nRF52. motors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nrf52-actuators`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Nrf52 Actuators
...
## Ресурсы
- Оригинальный навык: `iot/nrf52-actuators/SKILL.md`
