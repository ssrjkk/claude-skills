...
version: "1.0"
language: ru
original: home-assistant-setup
---

# Home Assistant Setup

> Setup with Home Assistant. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Setup
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-setup/SKILL.md`
