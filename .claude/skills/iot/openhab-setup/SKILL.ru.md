...
version: "1.0"
language: ru
original: openhab-setup
---

# Openhab Setup

> Setup with openHAB. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Setup
...
## Ресурсы
- Оригинальный навык: `iot/openhab-setup/SKILL.md`
