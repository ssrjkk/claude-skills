...
version: "1.0"
language: ru
original: arduino-communication
---

# Arduino Communication

> Comm with Arduino. I2C.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-communication`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Communication
...
## Ресурсы
- Оригинальный навык: `iot/arduino-communication/SKILL.md`
