...
version: "1.0"
language: ru
original: thingsboard-integration
---

# Thingsboard Integration

> Integration with ThingsBoard. integrations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-integration`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Integration
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-integration/SKILL.md`
