...
version: "1.0"
language: ru
original: platformio-devices
---

# Platformio Devices

> Devices with PlatformIO. device management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `platformio-devices`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Platformio Devices
...
## Ресурсы
- Оригинальный навык: `iot/platformio-devices/SKILL.md`
