...
version: "1.0"
language: ru
original: arduino-gpio
---

# Arduino Gpio

> GPIO with Arduino. digital I/O.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-gpio`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Gpio
...
## Ресурсы
- Оригинальный навык: `iot/arduino-gpio/SKILL.md`
