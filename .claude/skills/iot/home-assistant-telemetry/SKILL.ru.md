...
version: "1.0"
language: ru
original: home-assistant-telemetry
---

# Home Assistant Telemetry

> Telemetry with Home Assistant. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-telemetry/SKILL.md`
