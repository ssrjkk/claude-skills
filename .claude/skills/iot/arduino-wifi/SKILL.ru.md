...
version: "1.0"
language: ru
original: arduino-wifi
---

# Arduino Wifi

> WiFi with Arduino. wireless.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-wifi`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Wifi
...
## Ресурсы
- Оригинальный навык: `iot/arduino-wifi/SKILL.md`
