...
category: iot
tags: [arduino-setup, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Setup with Arduino. board setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Setup
...
## Ресурсы
- Оригинальный навык: `iot/arduino-setup/SKILL.md`
