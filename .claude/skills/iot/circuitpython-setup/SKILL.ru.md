...
## Быстрый старт
Этот навык на русском языке. Оригинал: `circuitpython-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Circuitpython Setup
...
## Ресурсы
- Оригинальный навык: `iot/circuitpython-setup/SKILL.md`
