...
category: iot
tags: [arduino-ble, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arduino-ble
---

# Arduino Ble

> BLE with Arduino. Bluetooth.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-ble`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Ble
...
## Ресурсы
- Оригинальный навык: `iot/arduino-ble/SKILL.md`
