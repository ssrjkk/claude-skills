...
category: iot
tags: [arduino-adc, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arduino-adc
---

# Arduino Adc

> ADC with Arduino. analog input.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arduino-adc`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Arduino Adc
...
## Ресурсы
- Оригинальный навык: `iot/arduino-adc/SKILL.md`
