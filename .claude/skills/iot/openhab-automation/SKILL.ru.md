...
version: "1.0"
language: ru
original: openhab-automation
---

# Openhab Automation

> Automation with openHAB. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Automation
...
## Ресурсы
- Оригинальный навык: `iot/openhab-automation/SKILL.md`
