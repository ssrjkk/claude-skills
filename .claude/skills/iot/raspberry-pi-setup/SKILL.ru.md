...
category: iot
tags: [raspberry-pi-setup, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Setup with Raspberry Pi. board setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-setup`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Setup
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-setup/SKILL.md`
