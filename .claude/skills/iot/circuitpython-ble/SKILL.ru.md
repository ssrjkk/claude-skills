...
## Быстрый старт
Этот навык на русском языке. Оригинал: `circuitpython-ble`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Circuitpython Ble
...
## Ресурсы
- Оригинальный навык: `iot/circuitpython-ble/SKILL.md`
