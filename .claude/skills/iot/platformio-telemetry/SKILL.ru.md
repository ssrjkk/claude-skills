...
version: "1.0"
language: ru
original: platformio-telemetry
---

# Platformio Telemetry

> Telemetry with PlatformIO. data collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `platformio-telemetry`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Platformio Telemetry
...
## Ресурсы
- Оригинальный навык: `iot/platformio-telemetry/SKILL.md`
