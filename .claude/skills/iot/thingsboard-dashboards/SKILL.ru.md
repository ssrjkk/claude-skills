...
version: "1.0"
language: ru
original: thingsboard-dashboards
---

# Thingsboard Dashboards

> Dashboards with ThingsBoard. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-dashboards/SKILL.md`
