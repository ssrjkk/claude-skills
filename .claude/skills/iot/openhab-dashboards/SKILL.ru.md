...
version: "1.0"
language: ru
original: openhab-dashboards
---

# Openhab Dashboards

> Dashboards with openHAB. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openhab-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Openhab Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/openhab-dashboards/SKILL.md`
