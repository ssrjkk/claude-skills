...
version: "1.0"
language: ru
original: thingsboard-security
---

# Thingsboard Security

> Security with ThingsBoard. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Security
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-security/SKILL.md`
