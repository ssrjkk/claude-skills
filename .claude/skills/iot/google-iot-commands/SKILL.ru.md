...
version: "1.0"
language: ru
original: google-iot-commands
---

# Google Iot Commands

> Commands with Google IoT. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `google-iot-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Google Iot Commands
...
## Ресурсы
- Оригинальный навык: `iot/google-iot-commands/SKILL.md`
