...
version: "1.0"
language: ru
original: aws-iot-dashboards
---

# Aws Iot Dashboards

> Dashboards with AWS IoT. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-iot-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Aws Iot Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/aws-iot-dashboards/SKILL.md`
