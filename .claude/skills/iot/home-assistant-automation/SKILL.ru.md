...
version: "1.0"
language: ru
original: home-assistant-automation
---

# Home Assistant Automation

> Automation with Home Assistant. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Automation
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-automation/SKILL.md`
