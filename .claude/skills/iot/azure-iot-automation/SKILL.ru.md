...
version: "1.0"
language: ru
original: azure-iot-automation
---

# Azure Iot Automation

> Automation with Azure IoT. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-iot-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Azure Iot Automation
...
## Ресурсы
- Оригинальный навык: `iot/azure-iot-automation/SKILL.md`
