...
version: "1.0"
language: ru
original: tasmota-commands
---

# Tasmota Commands

> Commands with Tasmota. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tasmota-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Tasmota Commands
...
## Ресурсы
- Оригинальный навык: `iot/tasmota-commands/SKILL.md`
