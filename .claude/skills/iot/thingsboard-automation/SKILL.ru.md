...
version: "1.0"
language: ru
original: thingsboard-automation
---

# Thingsboard Automation

> Automation with ThingsBoard. automation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thingsboard-automation`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Thingsboard Automation
...
## Ресурсы
- Оригинальный навык: `iot/thingsboard-automation/SKILL.md`
