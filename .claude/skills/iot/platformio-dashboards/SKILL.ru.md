...
version: "1.0"
language: ru
original: platformio-dashboards
---

# Platformio Dashboards

> Dashboards with PlatformIO. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `platformio-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Platformio Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/platformio-dashboards/SKILL.md`
