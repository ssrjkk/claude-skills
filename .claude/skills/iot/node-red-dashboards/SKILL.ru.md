...
version: "1.0"
language: ru
original: node-red-dashboards
---

# Node Red Dashboards

> Dashboards with Node-RED. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `node-red-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Node Red Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/node-red-dashboards/SKILL.md`
