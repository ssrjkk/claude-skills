...
version: "1.0"
language: ru
original: azure-iot-dashboards
---

# Azure Iot Dashboards

> Dashboards with Azure IoT. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-iot-dashboards`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Azure Iot Dashboards
...
## Ресурсы
- Оригинальный навык: `iot/azure-iot-dashboards/SKILL.md`
