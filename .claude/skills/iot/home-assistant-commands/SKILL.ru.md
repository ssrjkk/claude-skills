...
version: "1.0"
language: ru
original: home-assistant-commands
---

# Home Assistant Commands

> Commands with Home Assistant. device commands.

## Быстрый старт
Этот навык на русском языке. Оригинал: `home-assistant-commands`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Home Assistant Commands
...
## Ресурсы
- Оригинальный навык: `iot/home-assistant-commands/SKILL.md`
