...
version: "1.0"
language: ru
original: raspberry-pi-gpio
---

# Raspberry Pi Gpio

> GPIO with Raspberry Pi. digital I/O.

## Быстрый старт
Этот навык на русском языке. Оригинал: `raspberry-pi-gpio`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Raspberry Pi Gpio
...
## Ресурсы
- Оригинальный навык: `iot/raspberry-pi-gpio/SKILL.md`
