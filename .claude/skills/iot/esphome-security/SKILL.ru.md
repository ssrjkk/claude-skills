...
category: iot
tags: [esphome-security, iot, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: esphome-security
---

# Esphome Security

> Security with ESPHome. device security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `esphome-security`.

## Когда использовать
- Работа с Интернет вещей
- Выполнение задач, связанных с Esphome Security
...
## Ресурсы
- Оригинальный навык: `iot/esphome-security/SKILL.md`
