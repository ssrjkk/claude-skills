...
version: "1.0"
language: ru
original: color-grading-editing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `color-grading-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Color Grading Editing
...
## Ресурсы
- Оригинальный навык: `media/color-grading-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
