...
## Быстрый старт
Этот навык на русском языке. Оригинал: `davinci-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Davinci Setup
...
## Ресурсы
- Оригинальный навык: `media/davinci-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
