...
category: media
tags: [nuke-effects, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nuke-effects
---

# Nuke Effects

> Effects with Nuke. VFX.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuke-effects`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Nuke Effects
...
## Ресурсы
- Оригинальный навык: `media/nuke-effects/SKILL.md`
- Категория: Медиа
- Язык: Русский
