...
## Быстрый старт
Этот навык на русском языке. Оригинал: `final-cut-export`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Final Cut Export
...
## Ресурсы
- Оригинальный навык: `media/final-cut-export/SKILL.md`
- Категория: Медиа
- Язык: Русский
