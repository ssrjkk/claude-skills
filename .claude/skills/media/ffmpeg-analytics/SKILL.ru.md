...
version: "1.0"
language: ru
original: ffmpeg-analytics
---

# Ffmpeg Analytics

> Analytics with FFmpeg. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Analytics
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
