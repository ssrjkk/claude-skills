...
version: "1.0"
language: ru
original: gstreamer-packaging
---

# Gstreamer Packaging

> Packaging with GStreamer. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gstreamer-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Gstreamer Packaging
...
## Ресурсы
- Оригинальный навык: `media/gstreamer-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
