...
category: media
tags: [ffmpeg-setup, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ffmpeg-setup
---

# Ffmpeg Setup

> Setup with FFmpeg. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Setup
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
