...
version: "1.0"
language: ru
original: ffmpeg-encoding
---

# Ffmpeg Encoding

> Encoding with FFmpeg. encoding.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-encoding`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Encoding
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-encoding/SKILL.md`
- Категория: Медиа
- Язык: Русский
