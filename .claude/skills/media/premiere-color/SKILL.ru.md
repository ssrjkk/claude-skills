...
category: media
tags: [premiere-color, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: premiere-color
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `premiere-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Premiere Color
...
## Ресурсы
- Оригинальный навык: `media/premiere-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
