...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nuke-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Nuke Color
...
## Ресурсы
- Оригинальный навык: `media/nuke-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
