...
category: media
tags: [blender-vfx-audio, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: blender-vfx-audio
---

# Blender Vfx Audio

> Audio with Blender VFX. audio editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blender-vfx-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Blender Vfx Audio
...
## Ресурсы
- Оригинальный навык: `media/blender-vfx-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
