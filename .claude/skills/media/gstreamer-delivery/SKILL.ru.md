...
version: "1.0"
language: ru
original: gstreamer-delivery
---

# Gstreamer Delivery

> Delivery with GStreamer. delivery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gstreamer-delivery`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Gstreamer Delivery
...
## Ресурсы
- Оригинальный навык: `media/gstreamer-delivery/SKILL.md`
- Категория: Медиа
- Язык: Русский
