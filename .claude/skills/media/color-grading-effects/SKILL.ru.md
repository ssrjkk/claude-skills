...
version: "1.0"
language: ru
original: color-grading-effects
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `color-grading-effects`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Color Grading Effects
...
## Ресурсы
- Оригинальный навык: `media/color-grading-effects/SKILL.md`
- Категория: Медиа
- Язык: Русский
