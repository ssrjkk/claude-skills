...
version: "1.0"
language: ru
original: transcoding-protection
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `transcoding-protection`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Transcoding Protection
...
## Ресурсы
- Оригинальный навык: `media/transcoding-protection/SKILL.md`
- Категория: Медиа
- Язык: Русский
