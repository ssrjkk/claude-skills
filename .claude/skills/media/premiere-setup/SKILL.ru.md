...
## Быстрый старт
Этот навык на русском языке. Оригинал: `premiere-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Premiere Setup
...
## Ресурсы
- Оригинальный навык: `media/premiere-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
