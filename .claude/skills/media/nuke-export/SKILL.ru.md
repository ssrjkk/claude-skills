...
version: "1.0"
language: ru
original: nuke-export
---

# Nuke Export

> Export with Nuke. export.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuke-export`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Nuke Export
...
## Ресурсы
- Оригинальный навык: `media/nuke-export/SKILL.md`
- Категория: Медиа
- Язык: Русский
