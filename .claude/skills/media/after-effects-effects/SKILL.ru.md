...
category: media
tags: [after-effects-effects, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: after-effects-effects
---

# After Effects Effects

> Effects with After Effects. VFX.

## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-effects`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Effects
...
## Ресурсы
- Оригинальный навык: `media/after-effects-effects/SKILL.md`
- Категория: Медиа
- Язык: Русский
