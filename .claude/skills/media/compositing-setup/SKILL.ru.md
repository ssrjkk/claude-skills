...
version: "1.0"
language: ru
original: compositing-setup
---

# Compositing Setup

> Setup with Compositing. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Setup
...
## Ресурсы
- Оригинальный навык: `media/compositing-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
