...
category: media
tags: [final-cut-color, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: final-cut-color
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `final-cut-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Final Cut Color
...
## Ресурсы
- Оригинальный навык: `media/final-cut-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
