...
version: "1.0"
language: ru
original: dash-protection
---

# Dash Protection

> Protection with MPEG-DASH. DRM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-protection`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Dash Protection
...
## Ресурсы
- Оригинальный навык: `media/dash-protection/SKILL.md`
- Категория: Медиа
- Язык: Русский
