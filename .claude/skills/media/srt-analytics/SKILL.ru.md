...
version: "1.0"
language: ru
original: srt-analytics
---

# Srt Analytics

> Analytics with SRT. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `srt-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Srt Analytics
...
## Ресурсы
- Оригинальный навык: `media/srt-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
