...
## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Audio
...
## Ресурсы
- Оригинальный навык: `media/after-effects-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
