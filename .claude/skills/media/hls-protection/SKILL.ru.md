...
category: media
tags: [hls-protection, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hls-protection
---

# Hls Protection

> Protection with HLS. DRM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hls-protection`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Hls Protection
...
## Ресурсы
- Оригинальный навык: `media/hls-protection/SKILL.md`
- Категория: Медиа
- Язык: Русский
