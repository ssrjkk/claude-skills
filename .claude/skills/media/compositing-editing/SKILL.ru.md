...
version: "1.0"
language: ru
original: compositing-editing
---

# Compositing Editing

> Editing with Compositing. editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Editing
...
## Ресурсы
- Оригинальный навык: `media/compositing-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
