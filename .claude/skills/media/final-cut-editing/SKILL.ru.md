...
category: media
tags: [final-cut-editing, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: final-cut-editing
---

# Final Cut Editing

> Editing with Final Cut Pro. editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `final-cut-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Final Cut Editing
...
## Ресурсы
- Оригинальный навык: `media/final-cut-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
