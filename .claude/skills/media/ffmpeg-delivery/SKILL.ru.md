...
version: "1.0"
language: ru
original: ffmpeg-delivery
---

# Ffmpeg Delivery

> Delivery with FFmpeg. delivery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-delivery`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Delivery
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-delivery/SKILL.md`
- Категория: Медиа
- Язык: Русский
