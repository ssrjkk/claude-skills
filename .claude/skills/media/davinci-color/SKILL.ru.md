...
## Быстрый старт
Этот навык на русском языке. Оригинал: `davinci-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Davinci Color
...
## Ресурсы
- Оригинальный навык: `media/davinci-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
