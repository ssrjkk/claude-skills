...
## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-export`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Export
...
## Ресурсы
- Оригинальный навык: `media/after-effects-export/SKILL.md`
- Категория: Медиа
- Язык: Русский
