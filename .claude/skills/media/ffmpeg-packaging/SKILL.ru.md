...
version: "1.0"
language: ru
original: ffmpeg-packaging
---

# Ffmpeg Packaging

> Packaging with FFmpeg. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Packaging
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
