...
category: media
tags: [final-cut-setup, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: final-cut-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `final-cut-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Final Cut Setup
...
## Ресурсы
- Оригинальный навык: `media/final-cut-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
