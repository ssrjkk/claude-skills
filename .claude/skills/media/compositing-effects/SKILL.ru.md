...
## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-effects`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Effects
...
## Ресурсы
- Оригинальный навык: `media/compositing-effects/SKILL.md`
- Категория: Медиа
- Язык: Русский
