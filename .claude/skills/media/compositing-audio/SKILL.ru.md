...
version: "1.0"
language: ru
original: compositing-audio
---

# Compositing Audio

> Audio with Compositing. audio editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Audio
...
## Ресурсы
- Оригинальный навык: `media/compositing-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
