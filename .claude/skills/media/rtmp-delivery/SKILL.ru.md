...
version: "1.0"
language: ru
original: rtmp-delivery
---

# Rtmp Delivery

> Delivery with RTMP. delivery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rtmp-delivery`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Rtmp Delivery
...
## Ресурсы
- Оригинальный навык: `media/rtmp-delivery/SKILL.md`
- Категория: Медиа
- Язык: Русский
