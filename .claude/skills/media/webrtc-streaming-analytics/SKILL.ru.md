...
version: "1.0"
language: ru
original: webrtc-streaming-analytics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webrtc-streaming-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Webrtc Streaming Analytics
...
## Ресурсы
- Оригинальный навык: `media/webrtc-streaming-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
