...
version: "1.0"
language: ru
original: ffmpeg-protection
---

# Ffmpeg Protection

> Protection with FFmpeg. DRM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ffmpeg-protection`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Ffmpeg Protection
...
## Ресурсы
- Оригинальный навык: `media/ffmpeg-protection/SKILL.md`
- Категория: Медиа
- Язык: Русский
