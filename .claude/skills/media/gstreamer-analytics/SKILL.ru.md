...
version: "1.0"
language: ru
original: gstreamer-analytics
---

# Gstreamer Analytics

> Analytics with GStreamer. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gstreamer-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Gstreamer Analytics
...
## Ресурсы
- Оригинальный навык: `media/gstreamer-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
