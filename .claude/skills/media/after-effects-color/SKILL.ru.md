...
category: media
tags: [after-effects-color, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: after-effects-color
---

# After Effects Color

> Color with After Effects. color grading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Color
...
## Ресурсы
- Оригинальный навык: `media/after-effects-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
