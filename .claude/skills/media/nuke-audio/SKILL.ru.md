...
> Audio with Nuke. audio editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuke-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Nuke Audio
...
## Ресурсы
- Оригинальный навык: `media/nuke-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
