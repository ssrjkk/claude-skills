...
version: "1.0"
language: ru
original: hls-packaging
---

# Hls Packaging

> Packaging with HLS. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hls-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Hls Packaging
...
## Ресурсы
- Оригинальный навык: `media/hls-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
