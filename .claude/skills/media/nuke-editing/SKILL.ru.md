...
version: "1.0"
language: ru
original: nuke-editing
---

# Nuke Editing

> Editing with Nuke. editing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nuke-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Nuke Editing
...
## Ресурсы
- Оригинальный навык: `media/nuke-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
