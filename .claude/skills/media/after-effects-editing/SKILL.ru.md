...
version: "1.0"
language: ru
original: after-effects-editing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Editing
...
## Ресурсы
- Оригинальный навык: `media/after-effects-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
