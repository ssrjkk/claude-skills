...
category: media
tags: [compositing-export, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: compositing-export
---

# Compositing Export

> Export with Compositing. export.

## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-export`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Export
...
## Ресурсы
- Оригинальный навык: `media/compositing-export/SKILL.md`
- Категория: Медиа
- Язык: Русский
