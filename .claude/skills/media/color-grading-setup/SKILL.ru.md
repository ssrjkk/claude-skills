...
category: media
tags: [color-grading-setup, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: color-grading-setup
---

# Color Grading Setup

> Setup with Color Grading. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `color-grading-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Color Grading Setup
...
## Ресурсы
- Оригинальный навык: `media/color-grading-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
