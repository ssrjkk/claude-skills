...
category: media
tags: [after-effects-setup, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: after-effects-setup
---

# After Effects Setup

> Setup with After Effects. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `after-effects-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с After Effects Setup
...
## Ресурсы
- Оригинальный навык: `media/after-effects-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
