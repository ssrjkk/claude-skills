...
version: "1.0"
language: ru
original: transcoding-analytics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `transcoding-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Transcoding Analytics
...
## Ресурсы
- Оригинальный навык: `media/transcoding-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
