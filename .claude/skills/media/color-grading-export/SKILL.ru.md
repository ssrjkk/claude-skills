...
## Быстрый старт
Этот навык на русском языке. Оригинал: `color-grading-export`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Color Grading Export
...
## Ресурсы
- Оригинальный навык: `media/color-grading-export/SKILL.md`
- Категория: Медиа
- Язык: Русский
