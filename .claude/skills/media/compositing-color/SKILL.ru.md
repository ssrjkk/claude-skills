...
version: "1.0"
language: ru
original: compositing-color
---

# Compositing Color

> Color with Compositing. color grading.

## Быстрый старт
Этот навык на русском языке. Оригинал: `compositing-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Compositing Color
...
## Ресурсы
- Оригинальный навык: `media/compositing-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
