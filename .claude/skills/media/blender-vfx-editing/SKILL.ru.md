...
## Быстрый старт
Этот навык на русском языке. Оригинал: `blender-vfx-editing`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Blender Vfx Editing
...
## Ресурсы
- Оригинальный навык: `media/blender-vfx-editing/SKILL.md`
- Категория: Медиа
- Язык: Русский
