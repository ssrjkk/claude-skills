...
category: media
tags: [premiere-audio, media, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: premiere-audio
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `premiere-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Premiere Audio
...
## Ресурсы
- Оригинальный навык: `media/premiere-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
