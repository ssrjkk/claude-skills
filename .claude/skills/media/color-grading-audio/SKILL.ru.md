...
## Быстрый старт
Этот навык на русском языке. Оригинал: `color-grading-audio`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Color Grading Audio
...
## Ресурсы
- Оригинальный навык: `media/color-grading-audio/SKILL.md`
- Категория: Медиа
- Язык: Русский
