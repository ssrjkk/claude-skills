...
version: "1.0"
language: ru
original: rtmp-protection
---

# Rtmp Protection

> Protection with RTMP. DRM.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rtmp-protection`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Rtmp Protection
...
## Ресурсы
- Оригинальный навык: `media/rtmp-protection/SKILL.md`
- Категория: Медиа
- Язык: Русский
