...
## Быстрый старт
Этот навык на русском языке. Оригинал: `blender-vfx-color`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Blender Vfx Color
...
## Ресурсы
- Оригинальный навык: `media/blender-vfx-color/SKILL.md`
- Категория: Медиа
- Язык: Русский
