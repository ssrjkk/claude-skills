...
version: "1.0"
language: ru
original: rtmp-packaging
---

# Rtmp Packaging

> Packaging with RTMP. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rtmp-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Rtmp Packaging
...
## Ресурсы
- Оригинальный навык: `media/rtmp-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
