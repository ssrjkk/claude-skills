...
version: "1.0"
language: ru
original: srt-packaging
---

# Srt Packaging

> Packaging with SRT. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `srt-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Srt Packaging
...
## Ресурсы
- Оригинальный навык: `media/srt-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
