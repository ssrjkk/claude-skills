...
version: "1.0"
language: ru
original: dash-packaging
---

# Dash Packaging

> Packaging with MPEG-DASH. packaging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dash-packaging`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Dash Packaging
...
## Ресурсы
- Оригинальный навык: `media/dash-packaging/SKILL.md`
- Категория: Медиа
- Язык: Русский
