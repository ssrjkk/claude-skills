...
## Быстрый старт
Этот навык на русском языке. Оригинал: `hls-analytics`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Hls Analytics
...
## Ресурсы
- Оригинальный навык: `media/hls-analytics/SKILL.md`
- Категория: Медиа
- Язык: Русский
