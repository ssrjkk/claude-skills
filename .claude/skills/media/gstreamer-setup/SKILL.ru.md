...
version: "1.0"
language: ru
original: gstreamer-setup
---

# Gstreamer Setup

> Setup with GStreamer. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gstreamer-setup`.

## Когда использовать
- Работа с Медиа
- Выполнение задач, связанных с Gstreamer Setup
...
## Ресурсы
- Оригинальный навык: `media/gstreamer-setup/SKILL.md`
- Категория: Медиа
- Язык: Русский
