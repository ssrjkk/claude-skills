...
> Examples for Motion: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `motion-examples`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Motion Examples
...
## Ресурсы
- Оригинал: design/motion-examples/SKILL.md
- Категория: Дизайн
