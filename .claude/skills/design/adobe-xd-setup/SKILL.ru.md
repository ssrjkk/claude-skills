...
version: "1.0"
language: ru
original: adobe-xd-setup
---

# Adobe Xd Setup

> Setup with Adobe XD. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Setup
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
