...
category: design
tags: [framer-motion-guides, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-motion-guides
---

# Framer Motion Guides

> Guides for Framer-Motion: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-motion-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Motion Guides
...
## Ресурсы
- Оригинал: design/framer-motion-guides/SKILL.md
- Категория: Дизайн
