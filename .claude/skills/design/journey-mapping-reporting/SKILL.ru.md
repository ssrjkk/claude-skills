...
version: "1.0"
language: ru
original: journey-mapping-reporting
---

# Journey Mapping Reporting

> Reporting with Journey Mapping. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-reporting`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Reporting
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-reporting/SKILL.md`
- Категория: Дизайн
- Язык: Русский
