...
category: design
tags: [framer-export, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Export with Framer. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Export
...
## Ресурсы
- Оригинальный навык: `design/framer-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
