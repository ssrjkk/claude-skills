...
version: "1.0"
language: ru
original: adobe-xd-collaboration
---

# Adobe Xd Collaboration

> Collaboration with Adobe XD. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Collaboration
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
