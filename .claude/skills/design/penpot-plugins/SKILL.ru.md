...
version: "1.0"
language: ru
original: penpot-plugins
---

# Penpot Plugins

> Plugins with Penpot. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Plugins
...
## Ресурсы
- Оригинальный навык: `design/penpot-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
