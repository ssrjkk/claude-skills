...
version: "1.0"
language: ru
original: persona-reporting
---

# Persona Reporting

> Reporting with Personas. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-reporting`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Reporting
...
## Ресурсы
- Оригинальный навык: `design/persona-reporting/SKILL.md`
- Категория: Дизайн
- Язык: Русский
