...
category: design
tags: [zeroheight-design-system, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeroheight-design-system
---

# Zeroheight Design System

> Design Systems with Zeroheight. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Design System
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
