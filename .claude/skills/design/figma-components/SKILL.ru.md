...
> Components with Figma. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Components
...
## Ресурсы
- Оригинальный навык: `design/figma-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
