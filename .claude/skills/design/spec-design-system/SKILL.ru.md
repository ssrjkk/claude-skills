...
version: "1.0"
language: ru
original: spec-design-system
---

# Spec Design System

> Design Systems with Spec. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Spec Design System
...
## Ресурсы
- Оригинальный навык: `design/spec-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
