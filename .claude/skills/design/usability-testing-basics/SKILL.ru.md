...
category: design
tags: [usability-testing-basics, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: usability-testing-basics
---

# Usability Testing Basics

> Basics with Usability Testing. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `usability-testing-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Usability Testing Basics
...
## Ресурсы
- Оригинальный навык: `design/usability-testing-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
