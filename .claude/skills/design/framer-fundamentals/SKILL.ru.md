...
version: "1.0"
language: ru
original: framer-fundamentals
---

# Framer Fundamentals

> Fundamentals for Framer: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Fundamentals
...
## Ресурсы
- Оригинал: design/framer-fundamentals/SKILL.md
- Категория: Дизайн
