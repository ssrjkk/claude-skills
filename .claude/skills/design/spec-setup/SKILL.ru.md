...
> Setup with Spec. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Spec Setup
...
## Ресурсы
- Оригинальный навык: `design/spec-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
