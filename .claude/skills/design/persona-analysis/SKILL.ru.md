...
version: "1.0"
language: ru
original: persona-analysis
---

# Persona Analysis

> Analysis with Personas. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-analysis`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Analysis
...
## Ресурсы
- Оригинальный навык: `design/persona-analysis/SKILL.md`
- Категория: Дизайн
- Язык: Русский
