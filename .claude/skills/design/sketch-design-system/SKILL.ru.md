...
category: design
tags: [sketch-design-system, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sketch-design-system
---

# Sketch Design System

> Design Systems with Sketch. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Design System
...
## Ресурсы
- Оригинальный навык: `design/sketch-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
