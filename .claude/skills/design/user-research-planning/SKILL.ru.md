...
category: design
tags: [user-research-planning, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: user-research-planning
---

# User Research Planning

> Planning with User Research. study planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-research-planning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с User Research Planning
...
## Ресурсы
- Оригинальный навык: `design/user-research-planning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
