...
version: "1.0"
language: ru
original: penpot-prototyping
---

# Penpot Prototyping

> Prototyping with Penpot. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Prototyping
...
## Ресурсы
- Оригинальный навык: `design/penpot-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
