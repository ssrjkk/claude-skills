...
version: "1.0"
language: ru
original: invision-design-system
---

# Invision Design System

> Design Systems with InVision. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `invision-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Invision Design System
...
## Ресурсы
- Оригинальный навык: `design/invision-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
