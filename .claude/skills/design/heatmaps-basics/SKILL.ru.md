...
version: "1.0"
language: ru
original: heatmaps-basics
---

# Heatmaps Basics

> Basics with Heatmaps. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heatmaps-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Heatmaps Basics
...
## Ресурсы
- Оригинальный навык: `design/heatmaps-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
