...
version: "1.0"
language: ru
original: persona-execution
---

# Persona Execution

> Execution with Personas. running sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-execution`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Execution
...
## Ресурсы
- Оригинальный навык: `design/persona-execution/SKILL.md`
- Категория: Дизайн
- Язык: Русский
