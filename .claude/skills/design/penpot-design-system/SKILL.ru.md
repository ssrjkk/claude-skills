...
category: design
tags: [penpot-design-system, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-design-system
---

# Penpot Design System

> Design Systems with Penpot. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Design System
...
## Ресурсы
- Оригинальный навык: `design/penpot-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
