...
version: "1.0"
language: ru
original: user-research-basics
---

# User Research Basics

> Basics with User Research. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-research-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с User Research Basics
...
## Ресурсы
- Оригинальный навык: `design/user-research-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
