...
category: design
tags: [sketch-plugins, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sketch-plugins
---

# Sketch Plugins

> Plugins with Sketch. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Plugins
...
## Ресурсы
- Оригинальный навык: `design/sketch-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
