...
version: "1.0"
language: ru
original: adobe-xd-versioning
---

# Adobe Xd Versioning

> Versioning with Adobe XD. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Versioning
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
