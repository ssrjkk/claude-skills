...
category: design
tags: [framer-examples, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-examples
---

# Framer Examples

> Examples for Framer: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-examples`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Examples
...
## Ресурсы
- Оригинал: design/framer-examples/SKILL.md
- Категория: Дизайн
