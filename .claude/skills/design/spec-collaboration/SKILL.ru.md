...
category: design
tags: [spec-collaboration, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: spec-collaboration
---

# Spec Collaboration

> Collaboration with Spec. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Spec Collaboration
...
## Ресурсы
- Оригинальный навык: `design/spec-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
