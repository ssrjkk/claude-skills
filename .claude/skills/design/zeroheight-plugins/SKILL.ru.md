...
category: design
tags: [zeroheight-plugins, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeroheight-plugins
---

# Zeroheight Plugins

> Plugins with Zeroheight. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Plugins
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
