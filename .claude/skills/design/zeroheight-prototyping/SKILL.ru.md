...
version: "1.0"
language: ru
original: zeroheight-prototyping
---

# Zeroheight Prototyping

> Prototyping with Zeroheight. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Prototyping
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
