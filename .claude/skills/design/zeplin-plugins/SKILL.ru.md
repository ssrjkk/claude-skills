...
version: "1.0"
language: ru
original: zeplin-plugins
---

# Zeplin Plugins

> Plugins with Zeplin. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Plugins
...
## Ресурсы
- Оригинальный навык: `design/zeplin-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
