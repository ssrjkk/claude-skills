...
category: design
tags: [motion-fundamentals, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: motion-fundamentals
---

# Motion Fundamentals

> Fundamentals for Motion: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `motion-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Motion Fundamentals
...
## Ресурсы
- Оригинал: design/motion-fundamentals/SKILL.md
- Категория: Дизайн
