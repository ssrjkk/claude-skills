...
category: design
tags: [invision-prototyping, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: invision-prototyping
---

# Invision Prototyping

> Prototyping with InVision. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `invision-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Invision Prototyping
...
## Ресурсы
- Оригинальный навык: `design/invision-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
