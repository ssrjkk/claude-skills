...
category: design
tags: [zeplin-versioning, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeplin-versioning
---

# Zeplin Versioning

> Versioning with Zeplin. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Versioning
...
## Ресурсы
- Оригинальный навык: `design/zeplin-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
