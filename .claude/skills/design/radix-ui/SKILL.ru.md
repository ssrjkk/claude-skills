...
> Builds accessible React UI primitives with Radix UI, including dialogs, dropdowns, and tooltips.

## Быстрый старт
Этот навык на русском языке. Оригинал: `radix-ui`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Radix Ui
...
## Ресурсы
- Оригинальный навык: `design/radix-ui/SKILL.md`
- Категория: Дизайн
- Язык: Русский
