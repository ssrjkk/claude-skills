...
> Builds modern UI components with shadcn/ui, a collection of re-usable components built with Radix UI and Tailwind CSS. Use for beautiful, accessible React apps.

## Быстрый старт
Этот навык на русском языке. Оригинал: `shadcn-ui`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Shadcn Ui
...
## Ресурсы
- Оригинальный навык: `design/shadcn-ui/SKILL.md`
- Категория: Дизайн
- Язык: Русский
