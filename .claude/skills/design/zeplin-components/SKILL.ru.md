...
version: "1.0"
language: ru
original: zeplin-components
---

# Zeplin Components

> Components with Zeplin. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Components
...
## Ресурсы
- Оригинальный навык: `design/zeplin-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
