...
category: design
tags: [ant-design, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ant-design
...
> Builds enterprise UIs with Ant Design, including pre-built components, theming, and i18n support.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ant-design`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Ant Design
...
## Ресурсы
- Оригинальный навык: `design/ant-design/SKILL.md`
- Категория: Дизайн
- Язык: Русский
