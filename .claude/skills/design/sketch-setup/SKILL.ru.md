...
version: "1.0"
language: ru
original: sketch-setup
---

# Sketch Setup

> Setup with Sketch. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Setup
...
## Ресурсы
- Оригинальный навык: `design/sketch-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
