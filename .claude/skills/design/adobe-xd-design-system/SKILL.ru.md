...
version: "1.0"
language: ru
original: adobe-xd-design-system
---

# Adobe Xd Design System

> Design Systems with Adobe XD. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Design System
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
