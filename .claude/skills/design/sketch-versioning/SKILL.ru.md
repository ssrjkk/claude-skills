...
version: "1.0"
language: ru
original: sketch-versioning
---

# Sketch Versioning

> Versioning with Sketch. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Versioning
...
## Ресурсы
- Оригинальный навык: `design/sketch-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
