...
version: "1.0"
language: ru
original: persona-tools
---

# Persona Tools

> Tools with Personas. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-tools`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Tools
...
## Ресурсы
- Оригинальный навык: `design/persona-tools/SKILL.md`
- Категория: Дизайн
- Язык: Русский
