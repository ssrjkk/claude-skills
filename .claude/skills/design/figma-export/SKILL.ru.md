...
category: design
tags: [figma-export, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Export with Figma. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Export
...
## Ресурсы
- Оригинальный навык: `design/figma-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
