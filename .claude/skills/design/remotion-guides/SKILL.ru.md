...
category: design
tags: [remotion-guides, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remotion-guides
---

# Remotion Guides

> Guides for Remotion: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `remotion-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Remotion Guides
...
## Ресурсы
- Оригинал: design/remotion-guides/SKILL.md
- Категория: Дизайн
