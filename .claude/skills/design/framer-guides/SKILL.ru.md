...
version: "1.0"
language: ru
original: framer-guides
---

# Framer Guides

> Guides for Framer: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Guides
...
## Ресурсы
- Оригинал: design/framer-guides/SKILL.md
- Категория: Дизайн
