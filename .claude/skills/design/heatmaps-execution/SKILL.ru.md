...
version: "1.0"
language: ru
original: heatmaps-execution
---

# Heatmaps Execution

> Execution with Heatmaps. running sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heatmaps-execution`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Heatmaps Execution
...
## Ресурсы
- Оригинальный навык: `design/heatmaps-execution/SKILL.md`
- Категория: Дизайн
- Язык: Русский
