...
version: "1.0"
language: ru
original: journey-mapping-execution
---

# Journey Mapping Execution

> Execution with Journey Mapping. running sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-execution`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Execution
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-execution/SKILL.md`
- Категория: Дизайн
- Язык: Русский
