...
version: "1.0"
language: ru
original: backlight-design-system
---

# Backlight Design System

> Design Systems with Backlight. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlight-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Backlight Design System
...
## Ресурсы
- Оригинальный навык: `design/backlight-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
