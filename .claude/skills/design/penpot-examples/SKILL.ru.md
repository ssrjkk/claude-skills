...
category: design
tags: [penpot-examples, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-examples
---

# Penpot Examples

> Examples for Penpot: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `penpot-examples`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Examples
...
## Ресурсы
- Оригинал: design/penpot-examples/SKILL.md
- Категория: Дизайн
