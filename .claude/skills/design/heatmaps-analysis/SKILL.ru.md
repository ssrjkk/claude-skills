...
category: design
tags: [heatmaps-analysis, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: heatmaps-analysis
---

# Heatmaps Analysis

> Analysis with Heatmaps. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heatmaps-analysis`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Heatmaps Analysis
...
## Ресурсы
- Оригинальный навык: `design/heatmaps-analysis/SKILL.md`
- Категория: Дизайн
- Язык: Русский
