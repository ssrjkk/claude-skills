...
version: "1.0"
language: ru
original: sketch-components
---

# Sketch Components

> Components with Sketch. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Components
...
## Ресурсы
- Оригинальный навык: `design/sketch-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
