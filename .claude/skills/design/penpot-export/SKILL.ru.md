...
category: design
tags: [penpot-export, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-export
---

# Penpot Export

> Export with Penpot. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Export
...
## Ресурсы
- Оригинальный навык: `design/penpot-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
