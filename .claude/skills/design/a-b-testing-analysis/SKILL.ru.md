...
version: "1.0"
language: ru
original: a-b-testing-analysis
---

# A B Testing Analysis

> Analysis with A/B Testing. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `a-b-testing-analysis`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с A B Testing Analysis
...
## Ресурсы
- Оригинальный навык: `design/a-b-testing-analysis/SKILL.md`
- Категория: Дизайн
- Язык: Русский
