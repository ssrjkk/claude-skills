...
category: design
tags: [framer-plugins, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-plugins
---

# Framer Plugins

> Plugins with Framer. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Plugins
...
## Ресурсы
- Оригинальный навык: `design/framer-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
