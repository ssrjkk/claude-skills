...
version: "1.0"
language: ru
original: zeroheight-versioning
---

# Zeroheight Versioning

> Versioning with Zeroheight. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Versioning
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
