...
category: design
tags: [animejs-quickstart, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: animejs-quickstart
---

# Animejs Quickstart

> Quickstart for Animejs: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `animejs-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Animejs Quickstart
...
## Ресурсы
- Оригинал: design/animejs-quickstart/SKILL.md
- Категория: Дизайн
