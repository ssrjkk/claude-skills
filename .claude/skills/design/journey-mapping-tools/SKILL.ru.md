...
version: "1.0"
language: ru
original: journey-mapping-tools
---

# Journey Mapping Tools

> Tools with Journey Mapping. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-tools`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Tools
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-tools/SKILL.md`
- Категория: Дизайн
- Язык: Русский
