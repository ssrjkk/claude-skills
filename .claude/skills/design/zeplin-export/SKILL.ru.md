...
version: "1.0"
language: ru
original: zeplin-export
---

# Zeplin Export

> Export with Zeplin. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Export
...
## Ресурсы
- Оригинальный навык: `design/zeplin-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
