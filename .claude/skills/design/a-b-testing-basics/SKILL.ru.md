...
version: "1.0"
language: ru
original: a-b-testing-basics
---

# A B Testing Basics

> Basics with A/B Testing. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `a-b-testing-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с A B Testing Basics
...
## Ресурсы
- Оригинальный навык: `design/a-b-testing-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
