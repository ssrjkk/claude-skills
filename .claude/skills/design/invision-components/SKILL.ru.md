...
version: "1.0"
language: ru
original: invision-components
---

# Invision Components

> Components with InVision. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `invision-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Invision Components
...
## Ресурсы
- Оригинальный навык: `design/invision-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
