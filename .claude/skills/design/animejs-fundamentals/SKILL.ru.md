...
version: "1.0"
language: ru
original: animejs-fundamentals
---

# Animejs Fundamentals

> Fundamentals for Animejs: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `animejs-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Animejs Fundamentals
...
## Ресурсы
- Оригинал: design/animejs-fundamentals/SKILL.md
- Категория: Дизайн
