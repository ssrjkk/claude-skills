...
version: "1.0"
language: ru
original: user-research-execution
---

# User Research Execution

> Execution with User Research. running sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-research-execution`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с User Research Execution
...
## Ресурсы
- Оригинальный навык: `design/user-research-execution/SKILL.md`
- Категория: Дизайн
- Язык: Русский
