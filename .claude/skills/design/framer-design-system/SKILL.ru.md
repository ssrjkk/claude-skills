...
version: "1.0"
language: ru
original: framer-design-system
---

# Framer Design System

> Design Systems with Framer. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Design System
...
## Ресурсы
- Оригинальный навык: `design/framer-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
