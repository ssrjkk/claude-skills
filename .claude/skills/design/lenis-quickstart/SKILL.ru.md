...
category: design
tags: [lenis-quickstart, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lenis-quickstart
---

# Lenis Quickstart

> Quickstart for Lenis: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lenis-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Lenis Quickstart
...
## Ресурсы
- Оригинал: design/lenis-quickstart/SKILL.md
- Категория: Дизайн
