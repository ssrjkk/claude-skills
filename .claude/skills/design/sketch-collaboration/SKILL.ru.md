...
version: "1.0"
language: ru
original: sketch-collaboration
---

# Sketch Collaboration

> Collaboration with Sketch. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Collaboration
...
## Ресурсы
- Оригинальный навык: `design/sketch-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
