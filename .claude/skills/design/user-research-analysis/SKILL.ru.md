...
version: "1.0"
language: ru
original: user-research-analysis
---

# User Research Analysis

> Analysis with User Research. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `user-research-analysis`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с User Research Analysis
...
## Ресурсы
- Оригинальный навык: `design/user-research-analysis/SKILL.md`
- Категория: Дизайн
- Язык: Русский
