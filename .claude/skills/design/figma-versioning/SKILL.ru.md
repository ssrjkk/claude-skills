...
version: "1.0"
language: ru
original: figma-versioning
---

# Figma Versioning

> Versioning with Figma. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Versioning
...
## Ресурсы
- Оригинальный навык: `design/figma-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
