...
category: design
tags: [lenis-guides, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lenis-guides
---

# Lenis Guides

> Guides for Lenis: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lenis-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Lenis Guides
...
## Ресурсы
- Оригинал: design/lenis-guides/SKILL.md
- Категория: Дизайн
