...
category: design
tags: [journey-mapping-basics, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: journey-mapping-basics
---

# Journey Mapping Basics

> Basics with Journey Mapping. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Basics
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
