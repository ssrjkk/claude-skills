...
category: design
tags: [motion-quickstart, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: motion-quickstart
---

# Motion Quickstart

> Quickstart for Motion: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `motion-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Motion Quickstart
...
## Ресурсы
- Оригинал: design/motion-quickstart/SKILL.md
- Категория: Дизайн
