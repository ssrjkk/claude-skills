...
category: design
tags: [framer-collaboration, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-collaboration
---

# Framer Collaboration

> Collaboration with Framer. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Collaboration
...
## Ресурсы
- Оригинальный навык: `design/framer-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
