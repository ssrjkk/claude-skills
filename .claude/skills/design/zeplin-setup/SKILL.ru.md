...
category: design
tags: [zeplin-setup, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeplin-setup
---

# Zeplin Setup

> Setup with Zeplin. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Setup
...
## Ресурсы
- Оригинальный навык: `design/zeplin-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
