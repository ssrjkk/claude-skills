...
version: "1.0"
language: ru
original: figma-plugins
---

# Figma Plugins

> Plugins with Figma. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Plugins
...
## Ресурсы
- Оригинальный навык: `design/figma-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
