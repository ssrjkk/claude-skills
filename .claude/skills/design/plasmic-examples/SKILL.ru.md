...
version: "1.0"
language: ru
original: plasmic-examples
---

# Plasmic Examples

> Examples for Plasmic: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `plasmic-examples`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Plasmic Examples
...
## Ресурсы
- Оригинал: design/plasmic-examples/SKILL.md
- Категория: Дизайн
