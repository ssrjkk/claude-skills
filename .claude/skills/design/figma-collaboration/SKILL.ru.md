...
version: "1.0"
language: ru
original: figma-collaboration
---

# Figma Collaboration

> Collaboration with Figma. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Collaboration
...
## Ресурсы
- Оригинальный навык: `design/figma-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
