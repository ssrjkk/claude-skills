...
version: "1.0"
language: ru
original: backlight-setup
---

# Backlight Setup

> Setup with Backlight. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlight-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Backlight Setup
...
## Ресурсы
- Оригинальный навык: `design/backlight-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
