...
version: "1.0"
language: ru
original: framer-setup
---

# Framer Setup

> Setup with Framer. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Setup
...
## Ресурсы
- Оригинальный навык: `design/framer-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
