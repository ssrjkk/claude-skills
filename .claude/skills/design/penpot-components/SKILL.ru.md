...
version: "1.0"
language: ru
original: penpot-components
---

# Penpot Components

> Components with Penpot. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Components
...
## Ресурсы
- Оригинальный навык: `design/penpot-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
