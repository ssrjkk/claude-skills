...
category: design
tags: [figma-design-system, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: figma-design-system
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Design System
...
## Ресурсы
- Оригинальный навык: `design/figma-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
