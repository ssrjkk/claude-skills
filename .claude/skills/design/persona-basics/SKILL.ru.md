...
version: "1.0"
language: ru
original: persona-basics
---

# Persona Basics

> Basics with Personas. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Basics
...
## Ресурсы
- Оригинальный навык: `design/persona-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
