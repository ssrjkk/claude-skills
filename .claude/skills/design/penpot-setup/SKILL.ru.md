...
category: design
tags: [penpot-setup, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-setup
---

# Penpot Setup

> Setup with Penpot. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Setup
...
## Ресурсы
- Оригинальный навык: `design/penpot-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
