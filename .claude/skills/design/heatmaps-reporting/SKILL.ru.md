...
version: "1.0"
language: ru
original: heatmaps-reporting
---

# Heatmaps Reporting

> Reporting with Heatmaps. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heatmaps-reporting`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Heatmaps Reporting
...
## Ресурсы
- Оригинальный навык: `design/heatmaps-reporting/SKILL.md`
- Категория: Дизайн
- Язык: Русский
