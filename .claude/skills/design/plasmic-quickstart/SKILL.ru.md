...
category: design
tags: [plasmic-quickstart, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plasmic-quickstart
---

# Plasmic Quickstart

> Quickstart for Plasmic: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `plasmic-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Plasmic Quickstart
...
## Ресурсы
- Оригинал: design/plasmic-quickstart/SKILL.md
- Категория: Дизайн
