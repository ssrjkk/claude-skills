...
version: "1.0"
language: ru
original: a-b-testing-execution
---

# A B Testing Execution

> Execution with A/B Testing. running sessions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `a-b-testing-execution`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с A B Testing Execution
...
## Ресурсы
- Оригинальный навык: `design/a-b-testing-execution/SKILL.md`
- Категория: Дизайн
- Язык: Русский
