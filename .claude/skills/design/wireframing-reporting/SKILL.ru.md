...
version: "1.0"
language: ru
original: wireframing-reporting
---

# Wireframing Reporting

> Reporting with Wireframing. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireframing-reporting`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Wireframing Reporting
...
## Ресурсы
- Оригинальный навык: `design/wireframing-reporting/SKILL.md`
- Категория: Дизайн
- Язык: Русский
