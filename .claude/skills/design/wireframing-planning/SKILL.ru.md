...
version: "1.0"
language: ru
original: wireframing-planning
---

# Wireframing Planning

> Planning with Wireframing. study planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireframing-planning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Wireframing Planning
...
## Ресурсы
- Оригинальный навык: `design/wireframing-planning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
