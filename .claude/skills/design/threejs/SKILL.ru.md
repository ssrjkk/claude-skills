...
> Creates 3D graphics on the web with Three.js, including scenes, cameras, animations, and WebGL.

## Быстрый старт
Этот навык на русском языке. Оригинал: `threejs`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Threejs
...
## Ресурсы
- Оригинальный навык: `design/threejs/SKILL.md`
- Категория: Дизайн
- Язык: Русский
