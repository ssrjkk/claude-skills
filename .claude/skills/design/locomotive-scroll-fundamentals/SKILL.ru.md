...
version: "1.0"
language: ru
original: locomotive-scroll-fundamentals
---

# Locomotive Scroll Fundamentals

> Fundamentals for Locomotive-Scroll: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `locomotive-scroll-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Locomotive Scroll Fundamentals
...
## Ресурсы
- Оригинал: design/locomotive-scroll-fundamentals/SKILL.md
- Категория: Дизайн
