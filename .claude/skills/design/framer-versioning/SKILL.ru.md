...
version: "1.0"
language: ru
original: framer-versioning
---

# Framer Versioning

> Versioning with Framer. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Versioning
...
## Ресурсы
- Оригинальный навык: `design/framer-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
