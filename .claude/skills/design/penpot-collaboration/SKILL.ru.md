...
version: "1.0"
language: ru
original: penpot-collaboration
---

# Penpot Collaboration

> Collaboration with Penpot. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Collaboration
...
## Ресурсы
- Оригинальный навык: `design/penpot-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
