...
category: design
tags: [zeplin-design-system, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeplin-design-system
---

# Zeplin Design System

> Design Systems with Zeplin. tokens.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-design-system`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Design System
...
## Ресурсы
- Оригинальный навык: `design/zeplin-design-system/SKILL.md`
- Категория: Дизайн
- Язык: Русский
