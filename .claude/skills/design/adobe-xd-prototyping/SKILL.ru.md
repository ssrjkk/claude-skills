...
category: design
tags: [adobe-xd-prototyping, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adobe-xd-prototyping
---

# Adobe Xd Prototyping

> Prototyping with Adobe XD. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Prototyping
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
