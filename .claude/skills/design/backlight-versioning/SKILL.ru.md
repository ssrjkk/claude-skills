...
category: design
tags: [backlight-versioning, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: backlight-versioning
---

# Backlight Versioning

> Versioning with Backlight. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlight-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Backlight Versioning
...
## Ресурсы
- Оригинальный навык: `design/backlight-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
