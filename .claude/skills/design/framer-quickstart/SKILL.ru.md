...
version: "1.0"
language: ru
original: framer-quickstart
---

# Framer Quickstart

> Quickstart for Framer: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Quickstart
...
## Ресурсы
- Оригинал: design/framer-quickstart/SKILL.md
- Категория: Дизайн
