...
category: design
tags: [penpot-versioning, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-versioning
---

# Penpot Versioning

> Versioning with Penpot. version control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `penpot-versioning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Versioning
...
## Ресурсы
- Оригинальный навык: `design/penpot-versioning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
