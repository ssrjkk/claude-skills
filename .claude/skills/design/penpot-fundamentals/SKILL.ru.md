...
version: "1.0"
language: ru
original: penpot-fundamentals
---

# Penpot Fundamentals

> Fundamentals for Penpot: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `penpot-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Fundamentals
...
## Ресурсы
- Оригинал: design/penpot-fundamentals/SKILL.md
- Категория: Дизайн
