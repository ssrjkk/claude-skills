...
version: "1.0"
language: ru
original: backlight-export
---

# Backlight Export

> Export with Backlight. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlight-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Backlight Export
...
## Ресурсы
- Оригинальный навык: `design/backlight-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
