...
version: "1.0"
language: ru
original: adobe-xd-components
---

# Adobe Xd Components

> Components with Adobe XD. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Components
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
