...
category: design
tags: [adobe-xd-export, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: adobe-xd-export
---

# Adobe Xd Export

> Export with Adobe XD. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `adobe-xd-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Adobe Xd Export
...
## Ресурсы
- Оригинальный навык: `design/adobe-xd-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
