...
version: "1.0"
language: ru
original: spec-prototyping
---

# Spec Prototyping

> Prototyping with Spec. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `spec-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Spec Prototyping
...
## Ресурсы
- Оригинальный навык: `design/spec-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
