...
version: "1.0"
language: ru
original: backlight-plugins
---

# Backlight Plugins

> Plugins with Backlight. plugins.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backlight-plugins`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Backlight Plugins
...
## Ресурсы
- Оригинальный навык: `design/backlight-plugins/SKILL.md`
- Категория: Дизайн
- Язык: Русский
