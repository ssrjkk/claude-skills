...
version: "1.0"
language: ru
original: plasmic-fundamentals
---

# Plasmic Fundamentals

> Fundamentals for Plasmic: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `plasmic-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Plasmic Fundamentals
...
## Ресурсы
- Оригинал: design/plasmic-fundamentals/SKILL.md
- Категория: Дизайн
