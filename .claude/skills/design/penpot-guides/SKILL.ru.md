...
version: "1.0"
language: ru
original: penpot-guides
---

# Penpot Guides

> Guides for Penpot: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `penpot-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Guides
...
## Ресурсы
- Оригинал: design/penpot-guides/SKILL.md
- Категория: Дизайн
