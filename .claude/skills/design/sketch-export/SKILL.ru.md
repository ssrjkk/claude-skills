...
category: design
tags: [sketch-export, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sketch-export
---

# Sketch Export

> Export with Sketch. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Export
...
## Ресурсы
- Оригинальный навык: `design/sketch-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
