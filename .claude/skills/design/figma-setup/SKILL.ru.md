...
version: "1.0"
language: ru
original: figma-setup
---

# Figma Setup

> Setup with Figma. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Setup
...
## Ресурсы
- Оригинальный навык: `design/figma-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
