...
version: "1.0"
language: ru
original: usability-testing-reporting
---

# Usability Testing Reporting

> Reporting with Usability Testing. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `usability-testing-reporting`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Usability Testing Reporting
...
## Ресурсы
- Оригинальный навык: `design/usability-testing-reporting/SKILL.md`
- Категория: Дизайн
- Язык: Русский
