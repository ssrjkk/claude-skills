...
version: "1.0"
language: ru
original: zeplin-collaboration
---

# Zeplin Collaboration

> Collaboration with Zeplin. collaboration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeplin-collaboration`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeplin Collaboration
...
## Ресурсы
- Оригинальный навык: `design/zeplin-collaboration/SKILL.md`
- Категория: Дизайн
- Язык: Русский
