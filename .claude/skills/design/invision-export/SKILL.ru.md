...
version: "1.0"
language: ru
original: invision-export
---

# Invision Export

> Export with InVision. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `invision-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Invision Export
...
## Ресурсы
- Оригинальный навык: `design/invision-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
