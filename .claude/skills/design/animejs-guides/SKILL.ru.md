...
version: "1.0"
language: ru
original: animejs-guides
---

# Animejs Guides

> Guides for Animejs: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `animejs-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Animejs Guides
...
## Ресурсы
- Оригинал: design/animejs-guides/SKILL.md
- Категория: Дизайн
