...
category: design
tags: [framer-motion-fundamentals, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-motion-fundamentals
---

# Framer Motion Fundamentals

> Fundamentals for Framer-Motion: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `framer-motion-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Motion Fundamentals
...
## Ресурсы
- Оригинал: design/framer-motion-fundamentals/SKILL.md
- Категория: Дизайн
