...
version: "1.0"
language: ru
original: sketch-prototyping
---

# Sketch Prototyping

> Prototyping with Sketch. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sketch-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Sketch Prototyping
...
## Ресурсы
- Оригинальный навык: `design/sketch-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
