...
category: design
tags: [remotion-fundamentals, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remotion-fundamentals
---

# Remotion Fundamentals

> Fundamentals for Remotion: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `remotion-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Remotion Fundamentals
...
## Ресурсы
- Оригинал: design/remotion-fundamentals/SKILL.md
- Категория: Дизайн
