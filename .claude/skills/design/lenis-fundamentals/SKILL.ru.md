...
category: design
tags: [lenis-fundamentals, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lenis-fundamentals
---

# Lenis Fundamentals

> Fundamentals for Lenis: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `lenis-fundamentals`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Lenis Fundamentals
...
## Ресурсы
- Оригинал: design/lenis-fundamentals/SKILL.md
- Категория: Дизайн
