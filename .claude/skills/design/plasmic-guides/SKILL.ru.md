...
category: design
tags: [plasmic-guides, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plasmic-guides
---

# Plasmic Guides

> Guides for Plasmic: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `plasmic-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Plasmic Guides
...
## Ресурсы
- Оригинал: design/plasmic-guides/SKILL.md
- Категория: Дизайн
