...
version: "1.0"
language: ru
original: journey-mapping-planning
---

# Journey Mapping Planning

> Planning with Journey Mapping. study planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-planning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Planning
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-planning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
