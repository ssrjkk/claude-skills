...
category: design
tags: [framer-prototyping, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: framer-prototyping
---

# Framer Prototyping

> Prototyping with Framer. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `framer-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Framer Prototyping
...
## Ресурсы
- Оригинальный навык: `design/framer-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
