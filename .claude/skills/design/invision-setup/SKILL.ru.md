...
version: "1.0"
language: ru
original: invision-setup
---

# Invision Setup

> Setup with InVision. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `invision-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Invision Setup
...
## Ресурсы
- Оригинальный навык: `design/invision-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
