...
version: "1.0"
language: ru
original: zeroheight-components
---

# Zeroheight Components

> Components with Zeroheight. components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-components`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Components
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-components/SKILL.md`
- Категория: Дизайн
- Язык: Русский
