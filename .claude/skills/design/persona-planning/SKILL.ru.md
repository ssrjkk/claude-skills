...
category: design
tags: [persona-planning, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: persona-planning
---

# Persona Planning

> Planning with Personas. study planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `persona-planning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Persona Planning
...
## Ресурсы
- Оригинальный навык: `design/persona-planning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
