...
category: design
tags: [greensock-guides, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: greensock-guides
---

# Greensock Guides

> Guides for Greensock: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `greensock-guides`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Greensock Guides
...
## Ресурсы
- Оригинал: design/greensock-guides/SKILL.md
- Категория: Дизайн
