...
category: design
tags: [journey-mapping-analysis, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: journey-mapping-analysis
---

# Journey Mapping Analysis

> Analysis with Journey Mapping. data analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `journey-mapping-analysis`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Journey Mapping Analysis
...
## Ресурсы
- Оригинальный навык: `design/journey-mapping-analysis/SKILL.md`
- Категория: Дизайн
- Язык: Русский
