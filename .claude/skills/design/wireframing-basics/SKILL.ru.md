...
version: "1.0"
language: ru
original: wireframing-basics
---

# Wireframing Basics

> Basics with Wireframing. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wireframing-basics`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Wireframing Basics
...
## Ресурсы
- Оригинальный навык: `design/wireframing-basics/SKILL.md`
- Категория: Дизайн
- Язык: Русский
