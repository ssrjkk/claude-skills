...
category: design
tags: [figma-prototyping, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: figma-prototyping
---

# Figma Prototyping

> Prototyping with Figma. prototypes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `figma-prototyping`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Figma Prototyping
...
## Ресурсы
- Оригинальный навык: `design/figma-prototyping/SKILL.md`
- Категория: Дизайн
- Язык: Русский
