...
category: design
tags: [zeroheight-setup, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zeroheight-setup
---

# Zeroheight Setup

> Setup with Zeroheight. workspace.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-setup`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Setup
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-setup/SKILL.md`
- Категория: Дизайн
- Язык: Русский
