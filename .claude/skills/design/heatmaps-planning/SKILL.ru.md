...
version: "1.0"
language: ru
original: heatmaps-planning
---

# Heatmaps Planning

> Planning with Heatmaps. study planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heatmaps-planning`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Heatmaps Planning
...
## Ресурсы
- Оригинальный навык: `design/heatmaps-planning/SKILL.md`
- Категория: Дизайн
- Язык: Русский
