...
version: "1.0"
language: ru
original: zeroheight-export
---

# Zeroheight Export

> Export with Zeroheight. assets.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zeroheight-export`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Zeroheight Export
...
## Ресурсы
- Оригинальный навык: `design/zeroheight-export/SKILL.md`
- Категория: Дизайн
- Язык: Русский
