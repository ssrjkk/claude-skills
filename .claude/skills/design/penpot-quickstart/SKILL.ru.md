...
category: design
tags: [penpot-quickstart, design, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: penpot-quickstart
---

# Penpot Quickstart

> Quickstart for Penpot: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `penpot-quickstart`.

## Когда использовать
- Работа с Дизайн
- Выполнение задач, связанных с Penpot Quickstart
...
## Ресурсы
- Оригинал: design/penpot-quickstart/SKILL.md
- Категория: Дизайн
