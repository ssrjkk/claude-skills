...
version: "1.0"
language: ru
original: gotest-mocking
---

# Gotest Mocking

> Mocking with Go Test. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gotest-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gotest Mocking
...
## Ресурсы
- Оригинальный навык: `qa/gotest-mocking/SKILL.md`
