...
version: "1.0"
language: ru
original: rest-assured-examples
---

# Rest Assured Examples

> Examples for Rest-Assured: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `rest-assured-examples`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rest Assured Examples
...
## Ресурсы
- Оригинал: qa/rest-assured-examples/SKILL.md
