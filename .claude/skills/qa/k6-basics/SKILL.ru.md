...
> Basics for K6: fundamentals and core concepts

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-basics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Basics
...
## Ресурсы
- Оригинальный навык: qa/k6-basics/SKILL.md
