...
version: "1.0"
language: ru
original: locust-scenarios
---

# Locust Scenarios

> Scenarios with Locust. test scenarios.

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/locust-scenarios/SKILL.md`
