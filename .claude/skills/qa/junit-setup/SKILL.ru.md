...
version: "1.0"
language: ru
original: junit-setup
---

# Junit Setup

> Setup with JUnit. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Setup
...
## Ресурсы
- Оригинальный навык: `qa/junit-setup/SKILL.md`
