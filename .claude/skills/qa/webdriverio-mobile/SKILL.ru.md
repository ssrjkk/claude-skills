...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Mobile
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-mobile/SKILL.md`
