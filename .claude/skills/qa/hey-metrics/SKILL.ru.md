...
version: "1.0"
language: ru
original: hey-metrics
---

# Hey Metrics

> Metrics with hey. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hey-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Hey Metrics
...
## Ресурсы
- Оригинальный навык: `qa/hey-metrics/SKILL.md`
