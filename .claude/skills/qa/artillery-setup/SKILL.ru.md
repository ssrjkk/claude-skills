...
version: "1.0"
language: ru
original: artillery-setup
---

# Artillery Setup

> Setup with Artillery. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `artillery-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Artillery Setup
...
## Ресурсы
- Оригинальный навык: `qa/artillery-setup/SKILL.md`
