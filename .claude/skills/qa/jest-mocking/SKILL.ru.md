...
category: qa
tags: [jest-mocking, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jest-mocking
---

# Jest Mocking

> Mocking with Jest. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Mocking
...
## Ресурсы
- Оригинальный навык: `qa/jest-mocking/SKILL.md`
