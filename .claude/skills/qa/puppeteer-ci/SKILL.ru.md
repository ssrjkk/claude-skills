...
version: "1.0"
language: ru
original: puppeteer-ci
---

# Puppeteer Ci

> CI with Puppeteer. CI integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-ci`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Ci
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-ci/SKILL.md`
