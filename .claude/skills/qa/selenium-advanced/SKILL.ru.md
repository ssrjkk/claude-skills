...
category: qa
tags: [selenium-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: selenium-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Advanced
...
## Ресурсы
- Оригинальный навык: qa/selenium-advanced/SKILL.md
