...
version: "1.0"
language: ru
original: testng-coverage
---

# Testng Coverage

> Coverage with TestNG. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Coverage
...
## Ресурсы
- Оригинальный навык: `qa/testng-coverage/SKILL.md`
