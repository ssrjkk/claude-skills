...
version: "1.0"
language: ru
original: minitest-integration
---

# Minitest Integration

> Integration with Minitest. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Integration
...
## Ресурсы
- Оригинальный навык: `qa/minitest-integration/SKILL.md`
