...
category: qa
tags: [cypress-selectors, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-selectors
---

# Cypress Selectors

> Selectors with Cypress. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Selectors
...
## Ресурсы
- Оригинальный навык: `qa/cypress-selectors/SKILL.md`
