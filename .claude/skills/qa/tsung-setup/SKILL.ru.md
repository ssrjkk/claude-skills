...
category: qa
tags: [tsung-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tsung-setup
---

# Tsung Setup

> Setup with Tsung. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Setup
...
## Ресурсы
- Оригинальный навык: `qa/tsung-setup/SKILL.md`
