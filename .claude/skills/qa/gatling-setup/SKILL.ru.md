...
category: qa
tags: [gatling-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-setup
---

# Gatling Setup

> Setup with Gatling. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Setup
...
## Ресурсы
- Оригинальный навык: `qa/gatling-setup/SKILL.md`
