...
version: "1.0"
language: ru
original: vegeta-metrics
---

# Vegeta Metrics

> Metrics with Vegeta. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vegeta-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vegeta Metrics
...
## Ресурсы
- Оригинальный навык: `qa/vegeta-metrics/SKILL.md`
