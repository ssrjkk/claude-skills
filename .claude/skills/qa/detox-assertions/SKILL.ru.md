...
category: qa
tags: [detox-assertions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: detox-assertions
---

# Detox Assertions

> Assertions with Detox. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detox-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Detox Assertions
...
## Ресурсы
- Оригинальный навык: `qa/detox-assertions/SKILL.md`
