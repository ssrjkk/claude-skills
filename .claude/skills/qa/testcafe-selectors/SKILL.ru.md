...
version: "1.0"
language: ru
original: testcafe-selectors
---

# Testcafe Selectors

> Selectors with TestCafe. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Selectors
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-selectors/SKILL.md`
