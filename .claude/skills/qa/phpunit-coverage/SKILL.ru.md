...
category: qa
tags: [phpunit-coverage, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: phpunit-coverage
---

# Phpunit Coverage

> Coverage with PHPUnit. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Coverage
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-coverage/SKILL.md`
