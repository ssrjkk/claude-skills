...
version: "1.0"
language: ru
original: cargo-test-parameterization
---

# Cargo Test Parameterization

> Parameterization with Cargo Test. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cargo-test-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cargo Test Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/cargo-test-parameterization/SKILL.md`
