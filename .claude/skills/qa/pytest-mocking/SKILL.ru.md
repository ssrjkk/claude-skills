...
category: qa
tags: [pytest-mocking, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pytest-mocking
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Mocking
...
## Ресурсы
- Оригинальный навык: `qa/pytest-mocking/SKILL.md`
