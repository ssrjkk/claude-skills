...
category: qa
tags: [cypress-e2e, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-e2e
---

# Cypress E2E

> Creates E2E tests with Cypress for modern web applications. Use for fast testing with debugging.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-e2e`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress E2E
...
## Ресурсы
- Оригинальный навык: `qa/cypress-e2e/SKILL.md`
