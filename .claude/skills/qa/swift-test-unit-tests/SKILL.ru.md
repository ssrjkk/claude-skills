...
version: "1.0"
language: ru
original: swift-test-unit-tests
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-test-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Swift Test Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/swift-test-unit-tests/SKILL.md`
