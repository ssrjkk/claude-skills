...
version: "1.0"
language: ru
original: phpunit-setup
---

# Phpunit Setup

> Setup with PHPUnit. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Setup
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-setup/SKILL.md`
