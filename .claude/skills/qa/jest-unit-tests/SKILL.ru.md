...
version: "1.0"
language: ru
original: jest-unit-tests
---

# Jest Unit Tests

> Unit Tests with Jest. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/jest-unit-tests/SKILL.md`
