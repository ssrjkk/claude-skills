...
category: qa
tags: [webdriverio-reporting, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webdriverio-reporting
---

# Webdriverio Reporting

> Reporting with WebdriverIO. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Reporting
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-reporting/SKILL.md`
