...
category: qa
tags: [selenium-testing, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: selenium-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-testing`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Testing
...
## Ресурсы
- Оригинальный навык: qa/selenium-testing/SKILL.md
