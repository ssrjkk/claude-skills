...
category: qa
tags: [selenium-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Setup with Selenium. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Setup
...
## Ресурсы
- Оригинальный навык: `qa/selenium-setup/SKILL.md`
