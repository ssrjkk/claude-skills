...
category: qa
tags: [testng-integration, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: testng-integration
---

# Testng Integration

> Integration with TestNG. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Integration
...
## Ресурсы
- Оригинальный навык: `qa/testng-integration/SKILL.md`
