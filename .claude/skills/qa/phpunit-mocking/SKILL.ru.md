...
version: "1.0"
language: ru
original: phpunit-mocking
---

# Phpunit Mocking

> Mocking with PHPUnit. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Mocking
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-mocking/SKILL.md`
