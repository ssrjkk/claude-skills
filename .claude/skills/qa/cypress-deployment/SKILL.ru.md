...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Deployment
...
## Ресурсы
- Оригинальный навык: qa/cypress-deployment/SKILL.md
