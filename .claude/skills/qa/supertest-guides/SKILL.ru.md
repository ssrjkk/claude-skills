...
version: "1.0"
language: ru
original: supertest-guides
---

# Supertest Guides

> Guides for Supertest: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supertest-guides`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Supertest Guides
...
## Ресурсы
- Оригинал: qa/supertest-guides/SKILL.md
