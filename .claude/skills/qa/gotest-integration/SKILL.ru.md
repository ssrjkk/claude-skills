...
category: qa
tags: [gotest-integration, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gotest-integration
---

# Gotest Integration

> Integration with Go Test. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gotest-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gotest Integration
...
## Ресурсы
- Оригинальный навык: `qa/gotest-integration/SKILL.md`
