...
version: "1.0"
language: ru
original: junit-parameterization
---

# Junit Parameterization

> Parameterization with JUnit. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/junit-parameterization/SKILL.md`
