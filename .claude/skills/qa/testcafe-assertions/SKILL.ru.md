...
version: "1.0"
language: ru
original: testcafe-assertions
---

# Testcafe Assertions

> Assertions with TestCafe. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Assertions
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-assertions/SKILL.md`
