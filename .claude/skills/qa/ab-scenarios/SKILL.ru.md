...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ab-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Ab Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/ab-scenarios/SKILL.md`
