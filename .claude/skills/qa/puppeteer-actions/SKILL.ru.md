...
version: "1.0"
language: ru
original: puppeteer-actions
---

# Puppeteer Actions

> Actions with Puppeteer. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Actions
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-actions/SKILL.md`
