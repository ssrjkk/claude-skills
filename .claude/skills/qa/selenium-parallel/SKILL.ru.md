...
version: "1.0"
language: ru
original: selenium-parallel
---

# Selenium Parallel

> Parallel with Selenium. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Parallel
...
## Ресурсы
- Оригинальный навык: `qa/selenium-parallel/SKILL.md`
