...
version: "1.0"
language: ru
original: nightwatch-reporting
---

# Nightwatch Reporting

> Reporting with Nightwatch. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Reporting
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-reporting/SKILL.md`
