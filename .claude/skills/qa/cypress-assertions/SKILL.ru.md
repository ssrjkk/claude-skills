...
category: qa
tags: [cypress-assertions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-assertions
---

# Cypress Assertions

> Assertions with Cypress. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Assertions
...
## Ресурсы
- Оригинальный навык: `qa/cypress-assertions/SKILL.md`
