...
version: "1.0"
language: ru
original: phpunit-fixtures
---

# Phpunit Fixtures

> Fixtures with PHPUnit. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-fixtures/SKILL.md`
