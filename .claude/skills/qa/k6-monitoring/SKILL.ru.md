...
category: qa
tags: [k6-monitoring, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k6-monitoring
---

# K6 Monitoring

> Monitoring for K6: monitoring and observability

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-monitoring`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Monitoring
...
## Ресурсы
- Оригинальный навык: qa/k6-monitoring/SKILL.md
