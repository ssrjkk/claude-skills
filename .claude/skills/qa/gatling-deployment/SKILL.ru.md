...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Deployment
...
## Ресурсы
- Оригинальный навык: qa/gatling-deployment/SKILL.md
