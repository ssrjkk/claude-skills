...
category: qa
tags: [pytest-debugging, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pytest-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Debugging
...
## Ресурсы
- Оригинальный навык: qa/pytest-debugging/SKILL.md
