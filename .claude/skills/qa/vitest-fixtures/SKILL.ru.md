...
category: qa
tags: [vitest-fixtures, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitest-fixtures
---

# Vitest Fixtures

> Fixtures with Vitest. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/vitest-fixtures/SKILL.md`
