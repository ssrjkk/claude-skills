...
version: "1.0"
language: ru
original: appium-parallel
---

# Appium Parallel

> Parallel with Appium. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Parallel
...
## Ресурсы
- Оригинальный навык: `qa/appium-parallel/SKILL.md`
