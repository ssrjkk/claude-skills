...
version: "1.0"
language: ru
original: mocha-unit-tests
---

# Mocha Unit Tests

> Unit Tests with Mocha. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mocha-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Mocha Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/mocha-unit-tests/SKILL.md`
