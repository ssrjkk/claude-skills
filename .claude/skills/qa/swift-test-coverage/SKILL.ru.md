...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-test-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Swift Test Coverage
...
## Ресурсы
- Оригинальный навык: `qa/swift-test-coverage/SKILL.md`
