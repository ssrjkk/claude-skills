...
category: qa
tags: [k6-optimization, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k6-optimization
---

# K6 Optimization

> Optimization for K6: performance tuning and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-optimization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Optimization
...
## Ресурсы
- Оригинальный навык: qa/k6-optimization/SKILL.md
