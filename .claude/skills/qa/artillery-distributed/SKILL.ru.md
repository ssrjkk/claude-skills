...
version: "1.0"
language: ru
original: artillery-distributed
---

# Artillery Distributed

> Distributed with Artillery. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `artillery-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Artillery Distributed
...
## Ресурсы
- Оригинальный навык: `qa/artillery-distributed/SKILL.md`
