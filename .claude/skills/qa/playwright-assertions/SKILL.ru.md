...
version: "1.0"
language: ru
original: playwright-assertions
---

# Playwright Assertions

> Assertions with Playwright. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Assertions
...
## Ресурсы
- Оригинальный навык: `qa/playwright-assertions/SKILL.md`
