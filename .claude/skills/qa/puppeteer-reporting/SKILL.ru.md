...
version: "1.0"
language: ru
original: puppeteer-reporting
---

# Puppeteer Reporting

> Reporting with Puppeteer. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Reporting
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-reporting/SKILL.md`
