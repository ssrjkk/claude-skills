...
version: "1.0"
language: ru
original: appium-actions
---

# Appium Actions

> Actions with Appium. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Actions
...
## Ресурсы
- Оригинальный навык: `qa/appium-actions/SKILL.md`
