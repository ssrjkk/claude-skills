...
version: "1.0"
language: ru
original: rspec-integration
---

# Rspec Integration

> Integration with RSpec. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Integration
...
## Ресурсы
- Оригинальный навык: `qa/rspec-integration/SKILL.md`
