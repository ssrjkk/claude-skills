...
version: "1.0"
language: ru
original: cargo-test-unit-tests
---

# Cargo Test Unit Tests

> Unit Tests with Cargo Test. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cargo-test-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cargo Test Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/cargo-test-unit-tests/SKILL.md`
