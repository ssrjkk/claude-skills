...
category: qa
tags: [locust-basics, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-basics
---

# Locust Basics

> Basics for Locust: fundamentals and core concepts

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-basics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Basics
...
## Ресурсы
- Оригинальный навык: qa/locust-basics/SKILL.md
