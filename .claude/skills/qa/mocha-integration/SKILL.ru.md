...
version: "1.0"
language: ru
original: mocha-integration
---

# Mocha Integration

> Integration with Mocha. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mocha-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Mocha Integration
...
## Ресурсы
- Оригинальный навык: `qa/mocha-integration/SKILL.md`
