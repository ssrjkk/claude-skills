...
category: qa
tags: [minitest-coverage, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: minitest-coverage
---

# Minitest Coverage

> Coverage with Minitest. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Coverage
...
## Ресурсы
- Оригинальный навык: `qa/minitest-coverage/SKILL.md`
