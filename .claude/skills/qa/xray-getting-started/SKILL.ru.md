...
version: "1.0"
language: ru
original: xray-getting-started
---

# Xray Getting Started

> Getting Started for Xray: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: xray-getting-started.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Xray Getting Started
...
## Ресурсы
- qa/xray-getting-started/SKILL.md
