...
version: "1.0"
language: ru
original: rspec-fixtures
---

# Rspec Fixtures

> Fixtures with RSpec. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/rspec-fixtures/SKILL.md`
