...
category: qa
tags: [chai-fundamentals, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chai-fundamentals
---

# Chai Fundamentals

> Fundamentals for Chai: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `chai-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Chai Fundamentals
...
## Ресурсы
- Оригинал: qa/chai-fundamentals/SKILL.md
