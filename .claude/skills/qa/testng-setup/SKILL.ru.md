...
version: "1.0"
language: ru
original: testng-setup
---

# Testng Setup

> Setup with TestNG. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Setup
...
## Ресурсы
- Оригинальный навык: `qa/testng-setup/SKILL.md`
