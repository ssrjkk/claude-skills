...
category: qa
tags: [nock-guides, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nock-guides
---

# Nock Guides

> Guides for Nock: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nock-guides`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nock Guides
...
## Ресурсы
- Оригинал: qa/nock-guides/SKILL.md
