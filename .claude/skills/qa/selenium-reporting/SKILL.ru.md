...
version: "1.0"
language: ru
original: selenium-reporting
---

# Selenium Reporting

> Reporting with Selenium. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Reporting
...
## Ресурсы
- Оригинальный навык: `qa/selenium-reporting/SKILL.md`
