...
version: "1.0"
language: ru
original: junit-unit-tests
---

# Junit Unit Tests

> Unit Tests with JUnit. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/junit-unit-tests/SKILL.md`
