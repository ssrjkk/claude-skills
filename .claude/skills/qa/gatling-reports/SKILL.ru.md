...
category: qa
tags: [gatling-reports, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-reports
---

# Gatling Reports

> Reports with Gatling. report generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-reports`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Reports
...
## Ресурсы
- Оригинальный навык: `qa/gatling-reports/SKILL.md`
