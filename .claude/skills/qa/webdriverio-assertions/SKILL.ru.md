...
version: "1.0"
language: ru
original: webdriverio-assertions
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Assertions
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-assertions/SKILL.md`
