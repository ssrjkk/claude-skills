...
category: qa
tags: [gatling-security, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-security`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Security
...
## Ресурсы
- Оригинальный навык: qa/gatling-security/SKILL.md
