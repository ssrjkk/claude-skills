...
version: "1.0"
language: ru
original: vitest-mocking
---

# Vitest Mocking

> Mocking with Vitest. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Mocking
...
## Ресурсы
- Оригинальный навык: `qa/vitest-mocking/SKILL.md`
