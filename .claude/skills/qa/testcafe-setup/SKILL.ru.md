...
version: "1.0"
language: ru
original: testcafe-setup
---

# Testcafe Setup

> Setup with TestCafe. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Setup
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-setup/SKILL.md`
