...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Debugging
...
## Ресурсы
- Оригинальный навык: qa/selenium-debugging/SKILL.md
