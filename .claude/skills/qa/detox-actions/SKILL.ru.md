...
category: qa
tags: [detox-actions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: detox-actions
---

# Detox Actions

> Actions with Detox. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detox-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Detox Actions
...
## Ресурсы
- Оригинальный навык: `qa/detox-actions/SKILL.md`
