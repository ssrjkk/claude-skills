...
category: qa
tags: [gotest-unit-tests, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gotest-unit-tests
---

# Gotest Unit Tests

> Unit Tests with Go Test. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gotest-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gotest Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/gotest-unit-tests/SKILL.md`
