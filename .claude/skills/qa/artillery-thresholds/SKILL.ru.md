...
version: "1.0"
language: ru
original: artillery-thresholds
---

# Artillery Thresholds

> Thresholds with Artillery. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `artillery-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Artillery Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/artillery-thresholds/SKILL.md`
