...
version: "1.0"
language: ru
original: artillery-scenarios
---

# Artillery Scenarios

> Scenarios with Artillery. test scenarios.

## Быстрый старт
Этот навык на русском языке. Оригинал: `artillery-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Artillery Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/artillery-scenarios/SKILL.md`
