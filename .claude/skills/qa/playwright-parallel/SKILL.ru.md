...
version: "1.0"
language: ru
original: playwright-parallel
---

# Playwright Parallel

> Parallel with Playwright. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Parallel
...
## Ресурсы
- Оригинальный навык: `qa/playwright-parallel/SKILL.md`
