...
category: qa
tags: [katalon-parallel, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: katalon-parallel
---

# Katalon Parallel

> Parallel with Katalon. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Parallel
...
## Ресурсы
- Оригинальный навык: `qa/katalon-parallel/SKILL.md`
