...
category: qa
tags: [playwright-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: playwright-setup
---

# Playwright Setup

> Setup with Playwright. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Setup
...
## Ресурсы
- Оригинальный навык: `qa/playwright-setup/SKILL.md`
