...
category: qa
tags: [selenium-actions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: selenium-actions
---

# Selenium Actions

> Actions with Selenium. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Actions
...
## Ресурсы
- Оригинальный навык: `qa/selenium-actions/SKILL.md`
