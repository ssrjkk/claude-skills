...
category: qa
tags: [jest-debugging, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jest-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Debugging
...
## Ресурсы
- Оригинальный навык: qa/jest-debugging/SKILL.md
