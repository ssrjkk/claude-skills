...
category: qa
tags: [junit-coverage, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: junit-coverage
---

# Junit Coverage

> Coverage with JUnit. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Coverage
...
## Ресурсы
- Оригинальный навык: `qa/junit-coverage/SKILL.md`
