...
version: "1.0"
language: ru
original: tsung-thresholds
---

# Tsung Thresholds

> Thresholds with Tsung. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/tsung-thresholds/SKILL.md`
