...
category: qa
tags: [testcafe-parallel, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: testcafe-parallel
---

# Testcafe Parallel

> Parallel with TestCafe. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Parallel
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-parallel/SKILL.md`
