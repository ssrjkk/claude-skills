...
category: qa
tags: [security-owasp, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: security-owasp
---

# Security Owasp

> Checks web applications for OWASP Top 10 compliance. Use for security testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `security-owasp`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Security Owasp
...
## Ресурсы
- Оригинальный навык: `qa/security-owasp/SKILL.md`
