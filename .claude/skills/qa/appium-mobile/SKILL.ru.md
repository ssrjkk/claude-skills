...
version: "1.0"
language: ru
original: appium-mobile
---

# Appium Mobile

> Mobile with Appium. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Mobile
...
## Ресурсы
- Оригинальный навык: `qa/appium-mobile/SKILL.md`
