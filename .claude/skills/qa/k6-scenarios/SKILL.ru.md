...
category: qa
tags: [k6-scenarios, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k6-scenarios
---

# K6 Scenarios

> Scenarios with k6. test scenarios.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/k6-scenarios/SKILL.md`
