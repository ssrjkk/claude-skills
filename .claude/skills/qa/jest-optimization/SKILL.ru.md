...
category: qa
tags: [jest-optimization, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jest-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-optimization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Optimization
...
## Ресурсы
- Оригинальный навык: qa/jest-optimization/SKILL.md
