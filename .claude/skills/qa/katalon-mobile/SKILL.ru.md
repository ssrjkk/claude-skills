...
category: qa
tags: [katalon-mobile, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: katalon-mobile
---

# Katalon Mobile

> Mobile with Katalon. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Mobile
...
## Ресурсы
- Оригинальный навык: `qa/katalon-mobile/SKILL.md`
