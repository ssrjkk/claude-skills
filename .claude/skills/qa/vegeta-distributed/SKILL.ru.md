...
version: "1.0"
language: ru
original: vegeta-distributed
---

# Vegeta Distributed

> Distributed with Vegeta. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vegeta-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vegeta Distributed
...
## Ресурсы
- Оригинальный навык: `qa/vegeta-distributed/SKILL.md`
