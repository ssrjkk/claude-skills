...
category: qa
tags: [minitest-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: minitest-setup
---

# Minitest Setup

> Setup with Minitest. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Setup
...
## Ресурсы
- Оригинальный навык: `qa/minitest-setup/SKILL.md`
