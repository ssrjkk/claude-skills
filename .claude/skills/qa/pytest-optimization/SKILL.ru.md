...
category: qa
tags: [pytest-optimization, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pytest-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-optimization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Optimization
...
## Ресурсы
- Оригинальный навык: qa/pytest-optimization/SKILL.md
