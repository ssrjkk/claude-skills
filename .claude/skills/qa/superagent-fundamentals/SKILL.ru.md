...
category: qa
tags: [superagent-fundamentals, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: superagent-fundamentals
---

# Superagent Fundamentals

> Fundamentals for Superagent: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `superagent-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Superagent Fundamentals
...
## Ресурсы
- Оригинал: qa/superagent-fundamentals/SKILL.md
