...
version: "1.0"
language: ru
original: rspec-parameterization
---

# Rspec Parameterization

> Parameterization with RSpec. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/rspec-parameterization/SKILL.md`
