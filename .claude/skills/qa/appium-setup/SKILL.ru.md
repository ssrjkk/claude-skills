...
version: "1.0"
language: ru
original: appium-setup
---

# Appium Setup

> Setup with Appium. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Setup
...
## Ресурсы
- Оригинальный навык: `qa/appium-setup/SKILL.md`
