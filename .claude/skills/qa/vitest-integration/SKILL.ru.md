...
category: qa
tags: [vitest-integration, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitest-integration
---

# Vitest Integration

> Integration with Vitest. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Integration
...
## Ресурсы
- Оригинальный навык: `qa/vitest-integration/SKILL.md`
