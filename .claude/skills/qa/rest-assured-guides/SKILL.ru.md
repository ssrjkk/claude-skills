...
category: qa
tags: [rest-assured-guides, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rest-assured-guides
---

# Rest Assured Guides

> Guides for Rest-Assured: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `rest-assured-guides`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rest Assured Guides
...
## Ресурсы
- Оригинал: qa/rest-assured-guides/SKILL.md
