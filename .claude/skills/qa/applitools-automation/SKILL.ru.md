...
version: "1.0"
language: ru
original: applitools-automation
---

# Applitools Automation

> Automation for Applitools: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: applitools-automation.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Applitools Automation
...
## Ресурсы
- qa/applitools-automation/SKILL.md
