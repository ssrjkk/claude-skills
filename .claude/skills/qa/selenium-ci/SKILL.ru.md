...
version: "1.0"
language: ru
original: selenium-ci
---

# Selenium Ci

> CI with Selenium. CI integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-ci`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Ci
...
## Ресурсы
- Оригинальный навык: `qa/selenium-ci/SKILL.md`
