...
category: qa
tags: [katalon-selectors, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: katalon-selectors
---

# Katalon Selectors

> Selectors with Katalon. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Selectors
...
## Ресурсы
- Оригинальный навык: `qa/katalon-selectors/SKILL.md`
