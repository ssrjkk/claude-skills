...
version: "1.0"
language: ru
original: gotest-coverage
---

# Gotest Coverage

> Coverage with Go Test. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gotest-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gotest Coverage
...
## Ресурсы
- Оригинальный навык: `qa/gotest-coverage/SKILL.md`
