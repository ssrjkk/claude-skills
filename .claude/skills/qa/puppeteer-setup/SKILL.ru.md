...
## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Setup
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-setup/SKILL.md`
