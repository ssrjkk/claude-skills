...
category: qa
tags: [puppeteer-parallel, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppeteer-parallel
---

# Puppeteer Parallel

> Parallel with Puppeteer. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Parallel
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-parallel/SKILL.md`
