...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-basics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Basics
...
## Ресурсы
- Оригинальный навык: qa/selenium-basics/SKILL.md
