...
version: "1.0"
language: ru
original: test-data-bot-fundamentals
---

# Test Data Bot Fundamentals

> Fundamentals for Test-Data-Bot: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `test-data-bot-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Test Data Bot Fundamentals
...
## Ресурсы
- Оригинал: qa/test-data-bot-fundamentals/SKILL.md
