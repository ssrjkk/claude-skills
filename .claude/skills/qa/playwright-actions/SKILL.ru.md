...
category: qa
tags: [playwright-actions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: playwright-actions
---

# Playwright Actions

> Actions with Playwright. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Actions
...
## Ресурсы
- Оригинальный навык: `qa/playwright-actions/SKILL.md`
