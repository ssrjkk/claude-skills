...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Coverage
...
## Ресурсы
- Оригинальный навык: `qa/pytest-coverage/SKILL.md`
