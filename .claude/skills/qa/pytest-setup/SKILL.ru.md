...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Setup
...
## Ресурсы
- Оригинальный навык: `qa/pytest-setup/SKILL.md`
