...
category: qa
tags: [katalon-reporting, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: katalon-reporting
---

# Katalon Reporting

> Reporting with Katalon. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Reporting
...
## Ресурсы
- Оригинальный навык: `qa/katalon-reporting/SKILL.md`
