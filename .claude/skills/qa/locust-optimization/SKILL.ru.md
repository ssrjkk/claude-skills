...
category: qa
tags: [locust-optimization, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-optimization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Optimization
...
## Ресурсы
- Оригинальный навык: qa/locust-optimization/SKILL.md
