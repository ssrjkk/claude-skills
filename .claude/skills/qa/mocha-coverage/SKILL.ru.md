...
category: qa
tags: [mocha-coverage, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mocha-coverage
---

# Mocha Coverage

> Coverage with Mocha. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mocha-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Mocha Coverage
...
## Ресурсы
- Оригинальный навык: `qa/mocha-coverage/SKILL.md`
