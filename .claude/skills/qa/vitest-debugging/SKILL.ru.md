...
category: qa
tags: [vitest-debugging, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitest-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Debugging
...
## Ресурсы
- Оригинальный навык: qa/vitest-debugging/SKILL.md
