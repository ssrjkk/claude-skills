...
version: "1.0"
language: ru
original: wrk-metrics
---

# Wrk Metrics

> Metrics with wrk. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wrk-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Wrk Metrics
...
## Ресурсы
- Оригинальный навык: `qa/wrk-metrics/SKILL.md`
