...
category: qa
tags: [supertest-fundamentals, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: supertest-fundamentals
---

# Supertest Fundamentals

> Fundamentals for Supertest: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supertest-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Supertest Fundamentals
...
## Ресурсы
- Оригинал: qa/supertest-fundamentals/SKILL.md
