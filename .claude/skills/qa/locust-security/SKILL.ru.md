...
category: qa
tags: [locust-security, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-security
---

# Locust Security

> Security for Locust: security best practices

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-security`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Security
...
## Ресурсы
- Оригинальный навык: qa/locust-security/SKILL.md
