...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ab-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Ab Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/ab-thresholds/SKILL.md`
