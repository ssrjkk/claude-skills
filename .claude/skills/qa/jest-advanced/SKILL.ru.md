...
category: qa
tags: [jest-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jest-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Advanced
...
## Ресурсы
- Оригинальный навык: qa/jest-advanced/SKILL.md
