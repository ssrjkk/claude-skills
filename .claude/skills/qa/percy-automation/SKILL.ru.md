...
version: "1.0"
language: ru
original: percy-automation
---

# Percy Automation

> Automation for Percy: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: percy-automation.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Percy Automation
