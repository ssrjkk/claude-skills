...
version: "1.0"
language: ru
original: puppeteer-selectors
---

# Puppeteer Selectors

> Selectors with Puppeteer. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Selectors
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-selectors/SKILL.md`
