...
category: qa
tags: [playwright-mobile, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: playwright-mobile
---

# Playwright Mobile

> Mobile with Playwright. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Mobile
...
## Ресурсы
- Оригинальный навык: `qa/playwright-mobile/SKILL.md`
