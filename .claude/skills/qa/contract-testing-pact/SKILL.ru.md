...
category: qa
tags: [contract-testing-pact, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: contract-testing-pact
---

# Contract Testing Pact

> Implements contract testing for APIs with Pact. Use for checking compatibility between services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `contract-testing-pact`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Contract Testing Pact
...
## Ресурсы
- Оригинальный навык: `qa/contract-testing-pact/SKILL.md`
