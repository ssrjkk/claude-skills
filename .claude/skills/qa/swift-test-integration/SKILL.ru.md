...
category: qa
tags: [swift-test-integration, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-test-integration
---

# Swift Test Integration

> Integration with Swift Testing. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-test-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Swift Test Integration
...
## Ресурсы
- Оригинальный навык: `qa/swift-test-integration/SKILL.md`
