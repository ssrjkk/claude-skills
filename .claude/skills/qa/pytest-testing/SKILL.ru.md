...
category: qa
tags: [pytest-testing, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pytest-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-testing`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Testing
...
## Ресурсы
- Оригинальный навык: qa/pytest-testing/SKILL.md
