...
version: "1.0"
language: ru
original: testng-unit-tests
---

# Testng Unit Tests

> Unit Tests with TestNG. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/testng-unit-tests/SKILL.md`
