...
version: "1.0"
language: ru
original: jest-coverage
---

# Jest Coverage

> Coverage with Jest. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Coverage
...
## Ресурсы
- Оригинальный навык: `qa/jest-coverage/SKILL.md`
