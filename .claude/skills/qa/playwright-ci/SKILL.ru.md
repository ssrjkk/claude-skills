...
category: qa
tags: [playwright-ci, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: playwright-ci
---

# Playwright Ci

> CI with Playwright. CI integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-ci`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Ci
...
## Ресурсы
- Оригинальный навык: `qa/playwright-ci/SKILL.md`
