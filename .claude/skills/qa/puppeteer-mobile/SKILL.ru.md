...
version: "1.0"
language: ru
original: puppeteer-mobile
---

# Puppeteer Mobile

> Mobile with Puppeteer. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer Mobile
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer-mobile/SKILL.md`
