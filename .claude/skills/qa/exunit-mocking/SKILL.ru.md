...
version: "1.0"
language: ru
original: exunit-mocking
---

# Exunit Mocking

> Mocking with ExUnit. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Mocking
...
## Ресурсы
- Оригинальный навык: `qa/exunit-mocking/SKILL.md`
