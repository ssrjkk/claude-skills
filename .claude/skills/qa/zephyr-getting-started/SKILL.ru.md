...
version: "1.0"
language: ru
original: zephyr-getting-started
---

# Zephyr Getting Started

> Getting Started for Zephyr: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: zephyr-getting-started.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Zephyr Getting Started
...
## Ресурсы
- qa/zephyr-getting-started/SKILL.md
