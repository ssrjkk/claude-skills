...
category: qa
tags: [mocha-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: mocha-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `mocha-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Mocha Advanced
...
## Ресурсы
- Оригинальный навык: qa/mocha-advanced/SKILL.md
