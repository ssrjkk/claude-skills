...
version: "1.0"
language: ru
original: vitest-setup
---

# Vitest Setup

> Setup with Vitest. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Setup
...
## Ресурсы
- Оригинальный навык: `qa/vitest-setup/SKILL.md`
