...
version: "1.0"
language: ru
original: nock-fundamentals
---

# Nock Fundamentals

> Fundamentals for Nock: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nock-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nock Fundamentals
...
## Ресурсы
- Оригинал: qa/nock-fundamentals/SKILL.md
