...
category: qa
tags: [locust-thresholds, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-thresholds
---

# Locust Thresholds

> Thresholds with Locust. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/locust-thresholds/SKILL.md`
