...
version: "1.0"
language: ru
original: testcafe-reporting
---

# Testcafe Reporting

> Reporting with TestCafe. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Reporting
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-reporting/SKILL.md`
