...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Setup
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-setup/SKILL.md`
