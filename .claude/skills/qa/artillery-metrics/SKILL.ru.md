...
version: "1.0"
language: ru
original: artillery-metrics
---

# Artillery Metrics

> Metrics with Artillery. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `artillery-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Artillery Metrics
...
## Ресурсы
- Оригинальный навык: `qa/artillery-metrics/SKILL.md`
