...
version: "1.0"
language: ru
original: gotest-setup
---

# Gotest Setup

> Setup with Go Test. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gotest-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gotest Setup
...
## Ресурсы
- Оригинальный навык: `qa/gotest-setup/SKILL.md`
