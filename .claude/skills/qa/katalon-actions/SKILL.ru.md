...
category: qa
tags: [katalon-actions, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: katalon-actions
---

# Katalon Actions

> Actions with Katalon. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Actions
...
## Ресурсы
- Оригинальный навык: `qa/katalon-actions/SKILL.md`
