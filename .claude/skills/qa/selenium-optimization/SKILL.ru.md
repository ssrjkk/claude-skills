...
version: "1.0"
language: ru
original: selenium-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-optimization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Optimization
...
## Ресурсы
- Оригинальный навык: qa/selenium-optimization/SKILL.md
