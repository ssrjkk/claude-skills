...
category: qa
tags: [tsung-distributed, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tsung-distributed
---

# Tsung Distributed

> Distributed with Tsung. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Distributed
...
## Ресурсы
- Оригинальный навык: `qa/tsung-distributed/SKILL.md`
