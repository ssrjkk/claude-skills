...
version: "1.0"
language: ru
original: jest-fixtures
---

# Jest Fixtures

> Fixtures with Jest. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/jest-fixtures/SKILL.md`
