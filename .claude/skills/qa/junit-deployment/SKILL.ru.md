...
category: qa
tags: [junit-deployment, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: junit-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Deployment
...
## Ресурсы
- Оригинальный навык: qa/junit-deployment/SKILL.md
