...
category: qa
tags: [k6-deployment, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k6-deployment
---

# K6 Deployment

> Deployment for K6: deployment and release

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Deployment
...
## Ресурсы
- Оригинальный навык: qa/k6-deployment/SKILL.md
