...
version: "1.0"
language: ru
original: jest-integration
---

# Jest Integration

> Integration with Jest. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Integration
...
## Ресурсы
- Оригинальный навык: `qa/jest-integration/SKILL.md`
