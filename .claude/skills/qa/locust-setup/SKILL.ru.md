...
category: qa
tags: [locust-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-setup
---

# Locust Setup

> Setup with Locust. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Setup
...
## Ресурсы
- Оригинальный навык: `qa/locust-setup/SKILL.md`
