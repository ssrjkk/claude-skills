...
version: "1.0"
language: ru
original: nock-quickstart
---

# Nock Quickstart

> Quickstart for Nock: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `nock-quickstart`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nock Quickstart
...
## Ресурсы
- Оригинал: qa/nock-quickstart/SKILL.md
