...
## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-ci`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Ci
...
## Ресурсы
- Оригинальный навык: `qa/minitest-ci/SKILL.md`
