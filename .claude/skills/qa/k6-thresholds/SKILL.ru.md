...
version: "1.0"
language: ru
original: k6-thresholds
---

# K6 Thresholds

> Thresholds with k6. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/k6-thresholds/SKILL.md`
