...
category: qa
tags: [gatling-distributed, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-distributed
---

# Gatling Distributed

> Distributed with Gatling. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Distributed
...
## Ресурсы
- Оригинальный навык: `qa/gatling-distributed/SKILL.md`
