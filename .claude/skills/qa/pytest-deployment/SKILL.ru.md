...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Deployment
...
## Ресурсы
- Оригинальный навык: qa/pytest-deployment/SKILL.md
