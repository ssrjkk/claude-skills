...
version: "1.0"
language: ru
original: phpunit-integration
---

# Phpunit Integration

> Integration with PHPUnit. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Integration
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-integration/SKILL.md`
