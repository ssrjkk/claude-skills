...
version: "1.0"
language: ru
original: nightwatch-ci
---

# Nightwatch Ci

> CI with Nightwatch. CI integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-ci`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Ci
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-ci/SKILL.md`
