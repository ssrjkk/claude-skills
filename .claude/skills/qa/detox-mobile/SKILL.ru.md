...
version: "1.0"
language: ru
original: detox-mobile
---

# Detox Mobile

> Mobile with Detox. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detox-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Detox Mobile
...
## Ресурсы
- Оригинальный навык: `qa/detox-mobile/SKILL.md`
