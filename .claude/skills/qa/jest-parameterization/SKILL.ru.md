...
version: "1.0"
language: ru
original: jest-parameterization
---

# Jest Parameterization

> Parameterization with Jest. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jest-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jest Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/jest-parameterization/SKILL.md`
