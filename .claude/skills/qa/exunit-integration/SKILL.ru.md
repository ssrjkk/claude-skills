...
version: "1.0"
language: ru
original: exunit-integration
---

# Exunit Integration

> Integration with ExUnit. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Integration
...
## Ресурсы
- Оригинальный навык: `qa/exunit-integration/SKILL.md`
