...
version: "1.0"
language: ru
original: selenium-mobile
---

# Selenium Mobile

> Mobile with Selenium. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Mobile
...
## Ресурсы
- Оригинальный навык: `qa/selenium-mobile/SKILL.md`
