...
version: "1.0"
language: ru
original: sinon-quickstart
---

# Sinon Quickstart

> Quickstart for Sinon: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `sinon-quickstart`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Sinon Quickstart
...
## Ресурсы
- Оригинал: qa/sinon-quickstart/SKILL.md
