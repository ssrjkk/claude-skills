...
version: "1.0"
language: ru
original: katalon-assertions
---

# Katalon Assertions

> Assertions with Katalon. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `katalon-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Katalon Assertions
...
## Ресурсы
- Оригинальный навык: `qa/katalon-assertions/SKILL.md`
