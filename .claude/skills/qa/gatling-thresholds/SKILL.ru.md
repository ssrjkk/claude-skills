...
category: qa
tags: [gatling-thresholds, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-thresholds
---

# Gatling Thresholds

> Thresholds with Gatling. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/gatling-thresholds/SKILL.md`
