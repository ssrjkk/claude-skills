...
category: qa
tags: [playwright-reporting, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: playwright-reporting
---

# Playwright Reporting

> Reporting with Playwright. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Reporting
...
## Ресурсы
- Оригинальный навык: `qa/playwright-reporting/SKILL.md`
