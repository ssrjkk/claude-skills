...
category: qa
tags: [exunit-coverage, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: exunit-coverage
---

# Exunit Coverage

> Coverage with ExUnit. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Coverage
...
## Ресурсы
- Оригинальный навык: `qa/exunit-coverage/SKILL.md`
