...
category: qa
tags: [vitest-deployment, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitest-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-deployment`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Deployment
...
## Ресурсы
- Оригинальный навык: qa/vitest-deployment/SKILL.md
