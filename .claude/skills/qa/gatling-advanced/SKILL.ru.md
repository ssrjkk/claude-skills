...
category: qa
tags: [gatling-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gatling-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Advanced
...
## Ресурсы
- Оригинальный навык: qa/gatling-advanced/SKILL.md
