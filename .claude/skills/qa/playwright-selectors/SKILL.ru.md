...
version: "1.0"
language: ru
original: playwright-selectors
---

# Playwright Selectors

> Selectors with Playwright. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `playwright-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Playwright Selectors
...
## Ресурсы
- Оригинальный навык: `qa/playwright-selectors/SKILL.md`
