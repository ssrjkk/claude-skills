...
version: "1.0"
language: ru
original: supertest-quickstart
---

# Supertest Quickstart

> Quickstart for Supertest: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supertest-quickstart`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Supertest Quickstart
...
## Ресурсы
- Оригинал: qa/supertest-quickstart/SKILL.md
