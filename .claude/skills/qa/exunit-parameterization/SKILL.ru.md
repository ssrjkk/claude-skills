...
version: "1.0"
language: ru
original: exunit-parameterization
---

# Exunit Parameterization

> Parameterization with ExUnit. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/exunit-parameterization/SKILL.md`
