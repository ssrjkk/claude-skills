...
version: "1.0"
language: ru
original: rspec-unit-tests
---

# Rspec Unit Tests

> Unit Tests with RSpec. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/rspec-unit-tests/SKILL.md`
