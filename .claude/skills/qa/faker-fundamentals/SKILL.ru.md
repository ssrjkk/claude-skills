...
version: "1.0"
language: ru
original: faker-fundamentals
---

# Faker Fundamentals

> Fundamentals for Faker: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `faker-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Faker Fundamentals
...
## Ресурсы
- Оригинал: qa/faker-fundamentals/SKILL.md
