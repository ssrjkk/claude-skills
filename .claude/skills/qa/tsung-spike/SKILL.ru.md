...
version: "1.0"
language: ru
original: tsung-spike
---

# Tsung Spike

> Spike with Tsung. spike tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-spike`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Spike
...
## Ресурсы
- Оригинальный навык: `qa/tsung-spike/SKILL.md`
