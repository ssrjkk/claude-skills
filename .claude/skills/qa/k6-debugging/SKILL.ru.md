...
version: "1.0"
language: ru
original: k6-debugging
---

# K6 Debugging

> Debugging for K6: debugging and troubleshooting

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Debugging
...
## Ресурсы
- Оригинальный навык: qa/k6-debugging/SKILL.md
