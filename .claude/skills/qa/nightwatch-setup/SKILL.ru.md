...
category: qa
tags: [nightwatch-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nightwatch-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Setup
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-setup/SKILL.md`
