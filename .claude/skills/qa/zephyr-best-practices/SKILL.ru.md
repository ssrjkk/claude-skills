...
version: "1.0"
language: ru
original: zephyr-best-practices
---

# Zephyr Best Practices

> Best Practices for Zephyr: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: zephyr-best-practices.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Zephyr Best Practices
...
## Ресурсы
- qa/zephyr-best-practices/SKILL.md
