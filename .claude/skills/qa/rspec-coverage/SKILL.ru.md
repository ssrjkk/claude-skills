...
version: "1.0"
language: ru
original: rspec-coverage
---

# Rspec Coverage

> Coverage with RSpec. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Coverage
...
## Ресурсы
- Оригинальный навык: `qa/rspec-coverage/SKILL.md`
