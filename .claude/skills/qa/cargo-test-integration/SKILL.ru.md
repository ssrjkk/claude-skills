...
category: qa
tags: [cargo-test-integration, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cargo-test-integration
---

# Cargo Test Integration

> Integration with Cargo Test. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cargo-test-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cargo Test Integration
...
## Ресурсы
- Оригинальный навык: `qa/cargo-test-integration/SKILL.md`
