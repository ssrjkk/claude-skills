...
version: "1.0"
language: ru
original: tsung-scenarios
---

# Tsung Scenarios

> Scenarios with Tsung. test scenarios.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/tsung-scenarios/SKILL.md`
