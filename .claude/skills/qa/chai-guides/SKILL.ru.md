...
version: "1.0"
language: ru
original: chai-guides
---

# Chai Guides

> Guides for Chai: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `chai-guides`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Chai Guides
...
## Ресурсы
- Оригинал: qa/chai-guides/SKILL.md
