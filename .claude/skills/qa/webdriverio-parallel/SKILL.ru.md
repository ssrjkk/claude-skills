...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Parallel
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-parallel/SKILL.md`
