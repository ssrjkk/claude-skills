...
version: "1.0"
language: ru
original: wrk-distributed
---

# Wrk Distributed

> Distributed with wrk. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wrk-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Wrk Distributed
...
## Ресурсы
- Оригинальный навык: `qa/wrk-distributed/SKILL.md`
