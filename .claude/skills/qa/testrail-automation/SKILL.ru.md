...
version: "1.0"
language: ru
original: testrail-automation
---

# Testrail Automation

> Automation for Testrail: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: testrail-automation.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testrail Automation
...
## Ресурсы
- qa/testrail-automation/SKILL.md
