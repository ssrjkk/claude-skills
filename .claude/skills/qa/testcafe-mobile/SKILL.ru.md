...
version: "1.0"
language: ru
original: testcafe-mobile
---

# Testcafe Mobile

> Mobile with TestCafe. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Mobile
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-mobile/SKILL.md`
