...
version: "1.0"
language: ru
original: tsung-metrics
---

# Tsung Metrics

> Metrics with Tsung. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tsung-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Tsung Metrics
...
## Ресурсы
- Оригинальный навык: `qa/tsung-metrics/SKILL.md`
