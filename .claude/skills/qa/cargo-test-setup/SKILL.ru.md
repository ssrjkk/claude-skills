...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cargo-test-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cargo Test Setup
...
## Ресурсы
- Оригинальный навык: `qa/cargo-test-setup/SKILL.md`
