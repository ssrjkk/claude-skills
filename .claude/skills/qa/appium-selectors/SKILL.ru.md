...
category: qa
tags: [appium-selectors, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: appium-selectors
---

# Appium Selectors

> Selectors with Appium. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Selectors
...
## Ресурсы
- Оригинальный навык: `qa/appium-selectors/SKILL.md`
