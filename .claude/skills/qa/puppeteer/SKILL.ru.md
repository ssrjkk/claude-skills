...
> Automates browser testing with Puppeteer, headless Chrome, and page interaction APIs.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppeteer`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Puppeteer
...
## Ресурсы
- Оригинальный навык: `qa/puppeteer/SKILL.md`
