...
version: "1.0"
language: ru
original: minitest-parameterization
---

# Minitest Parameterization

> Parameterization with Minitest. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/minitest-parameterization/SKILL.md`
