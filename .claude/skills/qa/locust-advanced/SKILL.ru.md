...
category: qa
tags: [locust-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: locust-advanced
---

# Locust Advanced

> Advanced for Locust: advanced patterns and techniques

## Быстрый старт
Этот навык на русском языке. Оригинал: `locust-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Locust Advanced
...
## Ресурсы
- Оригинальный навык: qa/locust-advanced/SKILL.md
