...
## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Mocking
...
## Ресурсы
- Оригинальный навык: `qa/minitest-mocking/SKILL.md`
