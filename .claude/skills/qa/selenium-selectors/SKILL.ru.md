...
version: "1.0"
language: ru
original: selenium-selectors
---

# Selenium Selectors

> Selectors with Selenium. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Selectors
...
## Ресурсы
- Оригинальный навык: `qa/selenium-selectors/SKILL.md`
