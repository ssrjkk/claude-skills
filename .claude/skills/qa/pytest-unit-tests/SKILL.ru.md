...
## Быстрый старт
Этот навык на русском языке. Оригинал: `pytest-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Pytest Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/pytest-unit-tests/SKILL.md`
