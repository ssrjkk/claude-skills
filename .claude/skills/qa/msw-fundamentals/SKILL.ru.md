...
category: qa
tags: [msw-fundamentals, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: msw-fundamentals
---

# Msw Fundamentals

> Fundamentals for Msw: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `msw-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Msw Fundamentals
...
## Ресурсы
- Оригинал: qa/msw-fundamentals/SKILL.md
