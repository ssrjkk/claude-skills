...
version: "1.0"
language: ru
original: minitest-fixtures
---

# Minitest Fixtures

> Fixtures with Minitest. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minitest-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Minitest Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/minitest-fixtures/SKILL.md`
