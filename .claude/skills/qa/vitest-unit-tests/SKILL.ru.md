...
category: qa
tags: [vitest-unit-tests, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vitest-unit-tests
---

# Vitest Unit Tests

> Unit Tests with Vitest. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/vitest-unit-tests/SKILL.md`
