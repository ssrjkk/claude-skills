...
version: "1.0"
language: ru
original: gatling-metrics
---

# Gatling Metrics

> Metrics with Gatling. performance metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gatling-metrics`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Gatling Metrics
...
## Ресурсы
- Оригинальный навык: `qa/gatling-metrics/SKILL.md`
