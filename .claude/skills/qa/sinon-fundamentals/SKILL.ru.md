...
version: "1.0"
language: ru
original: sinon-fundamentals
---

# Sinon Fundamentals

> Fundamentals for Sinon: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `sinon-fundamentals`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Sinon Fundamentals
...
## Ресурсы
- Оригинал: qa/sinon-fundamentals/SKILL.md
