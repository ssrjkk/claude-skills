...
version: "1.0"
language: ru
original: phpunit-unit-tests
---

# Phpunit Unit Tests

> Unit Tests with PHPUnit. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phpunit-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Phpunit Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/phpunit-unit-tests/SKILL.md`
