...
version: "1.0"
language: ru
original: cypress-parallel
---

# Cypress Parallel

> Parallel with Cypress. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Parallel
...
## Ресурсы
- Оригинальный навык: `qa/cypress-parallel/SKILL.md`
