...
category: qa
tags: [junit-advanced, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: junit-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-advanced`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Advanced
...
## Ресурсы
- Оригинальный навык: qa/junit-advanced/SKILL.md
