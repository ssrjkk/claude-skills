...
category: qa
tags: [nightwatch-parallel, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nightwatch-parallel
---

# Nightwatch Parallel

> Parallel with Nightwatch. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Parallel
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-parallel/SKILL.md`
