...
category: qa
tags: [exunit-fixtures, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: exunit-fixtures
---

# Exunit Fixtures

> Fixtures with ExUnit. test fixtures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-fixtures`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Fixtures
...
## Ресурсы
- Оригинальный навык: `qa/exunit-fixtures/SKILL.md`
