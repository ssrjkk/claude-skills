...
category: qa
tags: [cypress-mobile, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-mobile
---

# Cypress Mobile

> Mobile with Cypress. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Mobile
...
## Ресурсы
- Оригинальный навык: `qa/cypress-mobile/SKILL.md`
