...
version: "1.0"
language: ru
original: testng-mocking
---

# Testng Mocking

> Mocking with TestNG. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Mocking
...
## Ресурсы
- Оригинальный навык: `qa/testng-mocking/SKILL.md`
