...
category: qa
tags: [detox-parallel, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: detox-parallel
---

# Detox Parallel

> Parallel with Detox. parallel execution.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detox-parallel`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Detox Parallel
...
## Ресурсы
- Оригинальный навык: `qa/detox-parallel/SKILL.md`
