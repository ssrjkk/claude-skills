...
category: qa
tags: [cypress-setup, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-setup
---

# Cypress Setup

> Setup with Cypress. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Setup
...
## Ресурсы
- Оригинальный навык: `qa/cypress-setup/SKILL.md`
