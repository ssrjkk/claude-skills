...
version: "1.0"
language: ru
original: nightwatch-selectors
---

# Nightwatch Selectors

> Selectors with Nightwatch. element selectors.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Selectors
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-selectors/SKILL.md`
