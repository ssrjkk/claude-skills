...
> API for Locust: API development and integration

## Quick Start
Begin by understanding the core concepts of API with Locust.

## When to Use
- Setting up Locust for API development and integration
