...
category: qa
tags: [cypress-api, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cypress-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cypress-api`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Cypress Api
...
## Ресурсы
- Оригинальный навык: qa/cypress-api/SKILL.md
