...
version: "1.0"
language: ru
original: xray-configuration
---

# Xray Configuration

> Configuration for Xray: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: xray-configuration.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Xray Configuration
...
## Ресурсы
- qa/xray-configuration/SKILL.md
