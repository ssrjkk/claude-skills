...
version: "1.0"
language: ru
original: mocha-mocking
---

# Mocha Mocking

> Mocking with Mocha. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mocha-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Mocha Mocking
...
## Ресурсы
- Оригинальный навык: `qa/mocha-mocking/SKILL.md`
