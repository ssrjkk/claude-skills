...
version: "1.0"
language: ru
original: testcafe-actions
---

# Testcafe Actions

> Actions with TestCafe. user actions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testcafe-actions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testcafe Actions
...
## Ресурсы
- Оригинальный навык: `qa/testcafe-actions/SKILL.md`
