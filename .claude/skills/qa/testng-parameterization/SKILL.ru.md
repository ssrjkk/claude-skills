...
version: "1.0"
language: ru
original: testng-parameterization
---

# Testng Parameterization

> Parameterization with TestNG. parametrized tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `testng-parameterization`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Testng Parameterization
...
## Ресурсы
- Оригинальный навык: `qa/testng-parameterization/SKILL.md`
