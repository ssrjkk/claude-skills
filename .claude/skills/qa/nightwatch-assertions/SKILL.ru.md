...
version: "1.0"
language: ru
original: nightwatch-assertions
---

# Nightwatch Assertions

> Assertions with Nightwatch. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Assertions
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-assertions/SKILL.md`
