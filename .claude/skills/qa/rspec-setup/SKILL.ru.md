...
version: "1.0"
language: ru
original: rspec-setup
---

# Rspec Setup

> Setup with RSpec. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rspec-setup`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Rspec Setup
...
## Ресурсы
- Оригинальный навык: `qa/rspec-setup/SKILL.md`
