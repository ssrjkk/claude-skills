...
version: "1.0"
language: ru
original: detox-reporting
---

# Detox Reporting

> Reporting with Detox. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `detox-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Detox Reporting
...
## Ресурсы
- Оригинальный навык: `qa/detox-reporting/SKILL.md`
