...
version: "1.0"
language: ru
original: nightwatch-mobile
---

# Nightwatch Mobile

> Mobile with Nightwatch. mobile testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nightwatch-mobile`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Nightwatch Mobile
...
## Ресурсы
- Оригинальный навык: `qa/nightwatch-mobile/SKILL.md`
