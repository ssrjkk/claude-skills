...
version: "1.0"
language: ru
original: junit-mocking
---

# Junit Mocking

> Mocking with JUnit. mocks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-mocking`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Mocking
...
## Ресурсы
- Оригинальный навык: `qa/junit-mocking/SKILL.md`
