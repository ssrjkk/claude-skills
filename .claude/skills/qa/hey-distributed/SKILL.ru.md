...
version: "1.0"
language: ru
original: hey-distributed
---

# Hey Distributed

> Distributed with hey. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hey-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Hey Distributed
...
## Ресурсы
- Оригинальный навык: `qa/hey-distributed/SKILL.md`
