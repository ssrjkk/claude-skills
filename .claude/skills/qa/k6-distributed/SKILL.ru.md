...
category: qa
tags: [k6-distributed, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k6-distributed
---

# K6 Distributed

> Distributed with k6. distributed load.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k6-distributed`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с K6 Distributed
...
## Ресурсы
- Оригинальный навык: `qa/k6-distributed/SKILL.md`
