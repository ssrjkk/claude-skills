...
version: "1.0"
language: ru
original: jmeter-reports
---

# Jmeter Reports

> Reports with JMeter. report generation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jmeter-reports`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Jmeter Reports
...
## Ресурсы
- Оригинальный навык: `qa/jmeter-reports/SKILL.md`
