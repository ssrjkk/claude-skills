...
category: qa
tags: [junit-debugging, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: junit-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-debugging`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Debugging
...
## Ресурсы
- Оригинальный навык: qa/junit-debugging/SKILL.md
