...
version: "1.0"
language: ru
original: wrk-scenarios
---

# Wrk Scenarios

> Scenarios with wrk. test scenarios.

## Быстрый старт
Этот навык на русском языке. Оригинал: `wrk-scenarios`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Wrk Scenarios
...
## Ресурсы
- Оригинальный навык: `qa/wrk-scenarios/SKILL.md`
