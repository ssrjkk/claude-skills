...
category: qa
tags: [selenium-security, qa, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: selenium-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-security`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Security
...
## Ресурсы
- Оригинальный навык: qa/selenium-security/SKILL.md
