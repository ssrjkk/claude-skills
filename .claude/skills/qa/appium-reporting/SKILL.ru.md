...
version: "1.0"
language: ru
original: appium-reporting
---

# Appium Reporting

> Reporting with Appium. reports.

## Быстрый старт
Этот навык на русском языке. Оригинал: `appium-reporting`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Appium Reporting
...
## Ресурсы
- Оригинальный навык: `qa/appium-reporting/SKILL.md`
