...
version: "1.0"
language: ru
original: selenium-assertions
---

# Selenium Assertions

> Assertions with Selenium. assertions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `selenium-assertions`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Selenium Assertions
...
## Ресурсы
- Оригинальный навык: `qa/selenium-assertions/SKILL.md`
