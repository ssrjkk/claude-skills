...
version: "1.0"
language: ru
original: exunit-unit-tests
---

# Exunit Unit Tests

> Unit Tests with ExUnit. unit testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `exunit-unit-tests`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Exunit Unit Tests
...
## Ресурсы
- Оригинальный навык: `qa/exunit-unit-tests/SKILL.md`
