...
version: "1.0"
language: ru
original: webdriverio-selectors
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `webdriverio-selectors`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Webdriverio Selectors
...
## Ресурсы
- Оригинальный навык: `qa/webdriverio-selectors/SKILL.md`
