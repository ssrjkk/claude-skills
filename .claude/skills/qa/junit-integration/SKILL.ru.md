...
version: "1.0"
language: ru
original: junit-integration
---

# Junit Integration

> Integration with JUnit. integration tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `junit-integration`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Junit Integration
...
## Ресурсы
- Оригинальный навык: `qa/junit-integration/SKILL.md`
