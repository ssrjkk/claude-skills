...
version: "1.0"
language: ru
original: vitest-coverage
---

# Vitest Coverage

> Coverage with Vitest. code coverage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vitest-coverage`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Vitest Coverage
...
## Ресурсы
- Оригинальный навык: `qa/vitest-coverage/SKILL.md`
