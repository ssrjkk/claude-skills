...
version: "1.0"
language: ru
original: hey-thresholds
---

# Hey Thresholds

> Thresholds with hey. pass/fail.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hey-thresholds`.

## Когда использовать
- Работа с Тестирование
- Выполнение задач, связанных с Hey Thresholds
...
## Ресурсы
- Оригинальный навык: `qa/hey-thresholds/SKILL.md`
