...
version: "1.0"
language: ru
original: open-banking-payments
---

# Open Banking Payments

> Payments with Open Banking. payments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `open-banking-payments`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Open Banking Payments
...
## Ресурсы
- Оригинальный навык: `finance/open-banking-payments/SKILL.md`
- Категория: Финансы
- Язык: Русский
