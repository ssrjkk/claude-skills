...
category: finance
tags: [psd2-accounts, finance, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: psd2-accounts
---

# Psd2 Accounts

> Accounts with PSD2. account linking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `psd2-accounts`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Psd2 Accounts
...
## Ресурсы
- Оригинальный навык: `finance/psd2-accounts/SKILL.md`
- Категория: Финансы
- Язык: Русский
