...
version: "1.0"
language: ru
original: plaid-payments
---

# Plaid Payments

> Payments with Plaid. payments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plaid-payments`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Plaid Payments
...
## Ресурсы
- Оригинальный навык: `finance/plaid-payments/SKILL.md`
- Категория: Финансы
- Язык: Русский
