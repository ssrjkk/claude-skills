...
version: "1.0"
language: ru
original: yodlee-accounts
---

# Yodlee Accounts

> Accounts with Yodlee. account linking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yodlee-accounts`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Yodlee Accounts
...
## Ресурсы
- Оригинальный навык: `finance/yodlee-accounts/SKILL.md`
- Категория: Финансы
- Язык: Русский
