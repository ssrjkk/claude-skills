...
version: "1.0"
language: ru
original: market-data-strategy
---

# Market Data Strategy

> Strategy with Market Data. strategy dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `market-data-strategy`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Market Data Strategy
...
## Ресурсы
- Оригинальный навык: `finance/market-data-strategy/SKILL.md`
- Категория: Финансы
- Язык: Русский
