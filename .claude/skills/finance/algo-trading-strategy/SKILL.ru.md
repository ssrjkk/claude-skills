...
version: "1.0"
language: ru
original: algo-trading-strategy
---

# Algo Trading Strategy

> Strategy with Algorithmic Trading. strategy dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algo-trading-strategy`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Algo Trading Strategy
...
## Ресурсы
- Оригинальный навык: `finance/algo-trading-strategy/SKILL.md`
- Категория: Финансы
- Язык: Русский
