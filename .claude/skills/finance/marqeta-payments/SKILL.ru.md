...
version: "1.0"
language: ru
original: marqeta-payments
---

# Marqeta Payments

> Payments with Marqeta. payments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marqeta-payments`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Marqeta Payments
...
## Ресурсы
- Оригинальный навык: `finance/marqeta-payments/SKILL.md`
- Категория: Финансы
- Язык: Русский
