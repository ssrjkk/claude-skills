...
version: "1.0"
language: ru
original: backtesting-risk
---

# Backtesting Risk

> Risk with Backtesting. risk analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backtesting-risk`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Backtesting Risk
...
## Ресурсы
- Оригинальный навык: `finance/backtesting-risk/SKILL.md`
- Категория: Финансы
- Язык: Русский
