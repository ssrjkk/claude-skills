...
version: "1.0"
language: ru
original: portfolio-basics
---

# Portfolio Basics

> Basics with Portfolio Management. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `portfolio-basics`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Portfolio Basics
...
## Ресурсы
- Оригинальный навык: `finance/portfolio-basics/SKILL.md`
- Категория: Финансы
- Язык: Русский
