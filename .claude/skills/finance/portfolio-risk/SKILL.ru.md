...
version: "1.0"
language: ru
original: portfolio-risk
---

# Portfolio Risk

> Risk with Portfolio Management. risk analysis.

## Быстрый старт
Этот навык на русском языке. Оригинал: `portfolio-risk`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Portfolio Risk
...
## Ресурсы
- Оригинальный навык: `finance/portfolio-risk/SKILL.md`
- Категория: Финансы
- Язык: Русский
