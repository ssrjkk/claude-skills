...
version: "1.0"
language: ru
original: psd2-payments
---

# Psd2 Payments

> Payments with PSD2. payments.

## Быстрый старт
Этот навык на русском языке. Оригинал: `psd2-payments`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Psd2 Payments
...
## Ресурсы
- Оригинальный навык: `finance/psd2-payments/SKILL.md`
- Категория: Финансы
- Язык: Русский
