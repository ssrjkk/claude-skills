...
version: "1.0"
language: ru
original: backtesting-basics
---

# Backtesting Basics

> Basics with Backtesting. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `backtesting-basics`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Backtesting Basics
...
## Ресурсы
- Оригинальный навык: `finance/backtesting-basics/SKILL.md`
- Категория: Финансы
- Язык: Русский
