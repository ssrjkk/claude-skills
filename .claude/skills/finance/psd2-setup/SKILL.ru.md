...
> Setup with PSD2. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `psd2-setup`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Psd2 Setup
...
## Ресурсы
- Оригинальный навык: `finance/psd2-setup/SKILL.md`
- Категория: Финансы
- Язык: Русский
