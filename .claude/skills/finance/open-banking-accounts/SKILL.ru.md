...
version: "1.0"
language: ru
original: open-banking-accounts
---

# Open Banking Accounts

> Accounts with Open Banking. account linking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `open-banking-accounts`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Open Banking Accounts
...
## Ресурсы
- Оригинальный навык: `finance/open-banking-accounts/SKILL.md`
- Категория: Финансы
- Язык: Русский
