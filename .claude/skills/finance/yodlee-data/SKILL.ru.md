...
version: "1.0"
language: ru
original: yodlee-data
---

# Yodlee Data

> Data with Yodlee. financial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `yodlee-data`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Yodlee Data
...
## Ресурсы
- Оригинальный навык: `finance/yodlee-data/SKILL.md`
- Категория: Финансы
- Язык: Русский
