...
version: "1.0"
language: ru
original: algo-trading-data
---

# Algo Trading Data

> Data with Algorithmic Trading. data sources.

## Быстрый старт
Этот навык на русском языке. Оригинал: `algo-trading-data`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Algo Trading Data
...
## Ресурсы
- Оригинальный навык: `finance/algo-trading-data/SKILL.md`
- Категория: Финансы
- Язык: Русский
