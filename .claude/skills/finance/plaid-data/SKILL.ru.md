...
> Data with Plaid. financial data.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plaid-data`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Plaid Data
...
## Ресурсы
- Оригинальный навык: `finance/plaid-data/SKILL.md`
- Категория: Финансы
- Язык: Русский
