...
version: "1.0"
language: ru
original: marqeta-compliance
---

# Marqeta Compliance

> Compliance with Marqeta. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `marqeta-compliance`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Marqeta Compliance
...
## Ресурсы
- Оригинальный навык: `finance/marqeta-compliance/SKILL.md`
- Категория: Финансы
- Язык: Русский
