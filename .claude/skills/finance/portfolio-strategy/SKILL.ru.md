...
> Strategy with Portfolio Management. strategy dev.

## Быстрый старт
Этот навык на русском языке. Оригинал: `portfolio-strategy`.

## Когда использовать
- Работа с Финансы
- Выполнение задач, связанных с Portfolio Strategy
...
## Ресурсы
- Оригинальный навык: `finance/portfolio-strategy/SKILL.md`
- Категория: Финансы
- Язык: Русский
