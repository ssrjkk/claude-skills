...
version: "1.0"
language: ru
original: pusher-voice
---

# Pusher Voice

> Voice with Pusher. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pusher-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pusher Voice
...
## Ресурсы
- Оригинальный навык: `communications/pusher-voice/SKILL.md`
