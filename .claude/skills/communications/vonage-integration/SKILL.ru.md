...
version: "1.0"
language: ru
original: vonage-integration
---

# Vonage Integration

> Integration with Vonage. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-integration`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Integration
...
## Ресурсы
- Оригинальный навык: `communications/vonage-integration/SKILL.md`
