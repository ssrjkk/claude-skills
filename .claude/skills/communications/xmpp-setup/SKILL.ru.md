...
> Setup with XMPP. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xmpp-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Xmpp Setup
...
## Ресурсы
- Оригинальный навык: `communications/xmpp-setup/SKILL.md`
