...
version: "1.0"
language: ru
original: sendgrid-setup
---

# Sendgrid Setup

> Setup with SendGrid. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Setup
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-setup/SKILL.md`
