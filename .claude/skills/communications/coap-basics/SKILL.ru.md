...
version: "1.0"
language: ru
original: coap-basics
---

# Coap Basics

> Basics with CoAP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `coap-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Coap Basics
...
## Ресурсы
- Оригинальный навык: `communications/coap-basics/SKILL.md`
