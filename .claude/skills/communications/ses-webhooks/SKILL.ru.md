...
version: "1.0"
language: ru
original: ses-webhooks
---

# Ses Webhooks

> Webhooks with Amazon SES. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ses-webhooks`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Ses Webhooks
...
## Ресурсы
- Оригинальный навык: `communications/ses-webhooks/SKILL.md`
