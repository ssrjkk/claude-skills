...
tags: [webrtc-basics, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webrtc-basics
---

# Webrtc Basics

> Basics with WebRTC. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webrtc-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Webrtc Basics
...
## Ресурсы
- Оригинальный навык: `communications/webrtc-basics/SKILL.md`
