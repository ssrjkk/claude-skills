...
version: "1.0"
language: ru
original: pubnub-chat
---

# Pubnub Chat

> Chat with PubNub. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pubnub-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pubnub Chat
...
## Ресурсы
- Оригинальный навык: `communications/pubnub-chat/SKILL.md`
