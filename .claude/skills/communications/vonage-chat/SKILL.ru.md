...
version: "1.0"
language: ru
original: vonage-chat
---

# Vonage Chat

> Chat with Vonage. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Chat
...
## Ресурсы
- Оригинальный навык: `communications/vonage-chat/SKILL.md`
