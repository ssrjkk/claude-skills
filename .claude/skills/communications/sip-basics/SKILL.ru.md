...
> Basics with SIP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sip-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sip Basics
...
## Ресурсы
- Оригинальный навык: `communications/sip-basics/SKILL.md`
