...
version: "1.0"
language: ru
original: sendgrid-webhooks
---

# Sendgrid Webhooks

> Webhooks with SendGrid. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-webhooks`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Webhooks
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-webhooks/SKILL.md`
