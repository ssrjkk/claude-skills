...
tags: [plivo-chat, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: plivo-chat
...
> Chat with Plivo. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Chat
...
## Ресурсы
- Оригинальный навык: `communications/plivo-chat/SKILL.md`
