...
version: "1.0"
language: ru
original: vonage-video
---

# Vonage Video

> Video with Vonage. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Video
...
## Ресурсы
- Оригинальный навык: `communications/vonage-video/SKILL.md`
