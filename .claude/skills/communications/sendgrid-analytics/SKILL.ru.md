...
tags: [sendgrid-analytics, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sendgrid-analytics
---

# Sendgrid Analytics

> Analytics with SendGrid. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-analytics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Analytics
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-analytics/SKILL.md`
