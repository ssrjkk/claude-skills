...
version: "1.0"
language: ru
original: vonage-webhooks
---

# Vonage Webhooks

> Webhooks with Vonage. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-webhooks`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Webhooks
...
## Ресурсы
- Оригинальный навык: `communications/vonage-webhooks/SKILL.md`
