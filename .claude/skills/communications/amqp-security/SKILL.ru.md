...
version: "1.0"
language: ru
original: amqp-security
---

# Amqp Security

> Security with AMQP. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `amqp-security`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Amqp Security
...
## Ресурсы
- Оригинальный навык: `communications/amqp-security/SKILL.md`
