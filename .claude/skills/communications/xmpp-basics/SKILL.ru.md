...
tags: [xmpp-basics, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: xmpp-basics
---

# Xmpp Basics

> Basics with XMPP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xmpp-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Xmpp Basics
...
## Ресурсы
- Оригинальный навык: `communications/xmpp-basics/SKILL.md`
