...
version: "1.0"
language: ru
original: discord-bot-voice
---

# Discord Bot Voice

> Voice with Discord Bot. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `discord-bot-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Discord Bot Voice
...
## Ресурсы
- Оригинальный навык: `communications/discord-bot-voice/SKILL.md`
