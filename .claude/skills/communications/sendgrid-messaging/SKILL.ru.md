...
version: "1.0"
language: ru
original: sendgrid-messaging
---

# Sendgrid Messaging

> Messaging with SendGrid. sending messages.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-messaging`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Messaging
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-messaging/SKILL.md`
