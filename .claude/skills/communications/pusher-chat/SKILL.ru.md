...
tags: [pusher-chat, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pusher-chat
---

# Pusher Chat

> Chat with Pusher. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pusher-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pusher Chat
...
## Ресурсы
- Оригинальный навык: `communications/pusher-chat/SKILL.md`
