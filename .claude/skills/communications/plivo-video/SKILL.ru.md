...
version: "1.0"
language: ru
original: plivo-video
---

# Plivo Video

> Video with Plivo. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Video
...
## Ресурсы
- Оригинальный навык: `communications/plivo-video/SKILL.md`
