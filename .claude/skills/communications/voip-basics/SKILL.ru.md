...
version: "1.0"
language: ru
original: voip-basics
---

# Voip Basics

> Basics with VoIP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `voip-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Voip Basics
...
## Ресурсы
- Оригинальный навык: `communications/voip-basics/SKILL.md`
