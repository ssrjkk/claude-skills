...
tags: [amqp-basics, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: amqp-basics
---

# Amqp Basics

> Basics with AMQP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `amqp-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Amqp Basics
...
## Ресурсы
- Оригинальный навык: `communications/amqp-basics/SKILL.md`
