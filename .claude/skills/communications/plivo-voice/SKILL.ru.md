...
version: "1.0"
language: ru
original: plivo-voice
---

# Plivo Voice

> Voice with Plivo. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Voice
...
## Ресурсы
- Оригинальный навык: `communications/plivo-voice/SKILL.md`
