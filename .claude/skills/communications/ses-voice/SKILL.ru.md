...
tags: [ses-voice, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ses-voice
...
> Voice with Amazon SES. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ses-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Ses Voice
...
## Ресурсы
- Оригинальный навык: `communications/ses-voice/SKILL.md`
