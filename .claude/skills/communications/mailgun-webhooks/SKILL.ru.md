...
version: "1.0"
language: ru
original: mailgun-webhooks
---

# Mailgun Webhooks

> Webhooks with Mailgun. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mailgun-webhooks`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Mailgun Webhooks
...
## Ресурсы
- Оригинальный навык: `communications/mailgun-webhooks/SKILL.md`
