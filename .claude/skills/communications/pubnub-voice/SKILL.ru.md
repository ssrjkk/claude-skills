...
tags: [pubnub-voice, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pubnub-voice
---

# Pubnub Voice

> Voice with PubNub. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pubnub-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pubnub Voice
...
## Ресурсы
- Оригинальный навык: `communications/pubnub-voice/SKILL.md`
