...
version: "1.0"
language: ru
original: pubnub-setup
---

# Pubnub Setup

> Setup with PubNub. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pubnub-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pubnub Setup
...
## Ресурсы
- Оригинальный навык: `communications/pubnub-setup/SKILL.md`
