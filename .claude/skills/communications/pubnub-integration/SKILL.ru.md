...
version: "1.0"
language: ru
original: pubnub-integration
---

# Pubnub Integration

> Integration with PubNub. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pubnub-integration`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pubnub Integration
...
## Ресурсы
- Оригинальный навык: `communications/pubnub-integration/SKILL.md`
