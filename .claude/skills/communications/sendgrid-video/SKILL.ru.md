...
tags: [sendgrid-video, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sendgrid-video
---

# Sendgrid Video

> Video with SendGrid. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Video
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-video/SKILL.md`
