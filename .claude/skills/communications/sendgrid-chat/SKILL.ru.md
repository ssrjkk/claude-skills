...
version: "1.0"
language: ru
original: sendgrid-chat
---

# Sendgrid Chat

> Chat with SendGrid. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Chat
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-chat/SKILL.md`
