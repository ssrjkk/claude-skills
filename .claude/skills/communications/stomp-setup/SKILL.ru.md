...
version: "1.0"
language: ru
original: stomp-setup
---

# Stomp Setup

> Setup with STOMP. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stomp-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Stomp Setup
...
## Ресурсы
- Оригинальный навык: `communications/stomp-setup/SKILL.md`
