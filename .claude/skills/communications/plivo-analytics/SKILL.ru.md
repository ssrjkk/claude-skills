...
version: "1.0"
language: ru
original: plivo-analytics
---

# Plivo Analytics

> Analytics with Plivo. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-analytics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Analytics
...
## Ресурсы
- Оригинальный навык: `communications/plivo-analytics/SKILL.md`
