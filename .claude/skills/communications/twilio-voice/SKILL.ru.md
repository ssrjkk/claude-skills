...
version: "1.0"
language: ru
original: twilio-voice
---

# Twilio Voice

> Voice with Twilio. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `twilio-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Twilio Voice
...
## Ресурсы
- Оригинальный навык: `communications/twilio-voice/SKILL.md`
