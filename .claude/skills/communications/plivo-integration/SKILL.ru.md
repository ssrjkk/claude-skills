...
version: "1.0"
language: ru
original: plivo-integration
---

# Plivo Integration

> Integration with Plivo. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-integration`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Integration
...
## Ресурсы
- Оригинальный навык: `communications/plivo-integration/SKILL.md`
