...
> Video with Amazon SES. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ses-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Ses Video
...
## Ресурсы
- Оригинальный навык: `communications/ses-video/SKILL.md`
