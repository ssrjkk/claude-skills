...
version: "1.0"
language: ru
original: mailgun-analytics
---

# Mailgun Analytics

> Analytics with Mailgun. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mailgun-analytics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Mailgun Analytics
...
## Ресурсы
- Оригинальный навык: `communications/mailgun-analytics/SKILL.md`
