...
> Setup with SIP. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sip-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sip Setup
...
## Ресурсы
- Оригинальный навык: `communications/sip-setup/SKILL.md`
