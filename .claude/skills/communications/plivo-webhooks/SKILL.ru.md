...
version: "1.0"
language: ru
original: plivo-webhooks
---

# Plivo Webhooks

> Webhooks with Plivo. webhooks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-webhooks`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Webhooks
...
## Ресурсы
- Оригинальный навык: `communications/plivo-webhooks/SKILL.md`
