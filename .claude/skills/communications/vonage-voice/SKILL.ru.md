...
version: "1.0"
language: ru
original: vonage-voice
---

# Vonage Voice

> Voice with Vonage. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Voice
...
## Ресурсы
- Оригинальный навык: `communications/vonage-voice/SKILL.md`
