...
version: "1.0"
language: ru
original: sip-security
---

# Sip Security

> Security with SIP. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sip-security`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sip Security
...
## Ресурсы
- Оригинальный навык: `communications/sip-security/SKILL.md`
