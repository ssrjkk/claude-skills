...
version: "1.0"
language: ru
original: pubnub-video
---

# Pubnub Video

> Video with PubNub. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pubnub-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pubnub Video
...
## Ресурсы
- Оригинальный навык: `communications/pubnub-video/SKILL.md`
