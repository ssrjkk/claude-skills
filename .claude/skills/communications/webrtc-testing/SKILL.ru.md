...
version: "1.0"
language: ru
original: webrtc-testing
---

# Webrtc Testing

> Testing with WebRTC. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webrtc-testing`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Webrtc Testing
...
## Ресурсы
- Оригинальный навык: `communications/webrtc-testing/SKILL.md`
