...
version: "1.0"
language: ru
original: xmpp-testing
---

# Xmpp Testing

> Testing with XMPP. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xmpp-testing`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Xmpp Testing
...
## Ресурсы
- Оригинальный навык: `communications/xmpp-testing/SKILL.md`
