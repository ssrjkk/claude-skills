...
tags: [stomp-basics, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stomp-basics
---

# Stomp Basics

> Basics with STOMP. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `stomp-basics`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Stomp Basics
...
## Ресурсы
- Оригинальный навык: `communications/stomp-basics/SKILL.md`
