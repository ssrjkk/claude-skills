...
version: "1.0"
language: ru
original: vonage-messaging
---

# Vonage Messaging

> Messaging with Vonage. sending messages.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vonage-messaging`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Vonage Messaging
...
## Ресурсы
- Оригинальный навык: `communications/vonage-messaging/SKILL.md`
