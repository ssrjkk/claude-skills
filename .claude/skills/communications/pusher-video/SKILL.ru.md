...
version: "1.0"
language: ru
original: pusher-video
---

# Pusher Video

> Video with Pusher. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pusher-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Pusher Video
...
## Ресурсы
- Оригинальный навык: `communications/pusher-video/SKILL.md`
