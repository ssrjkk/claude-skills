...
version: "1.0"
language: ru
original: plivo-setup
---

# Plivo Setup

> Setup with Plivo. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `plivo-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Plivo Setup
...
## Ресурсы
- Оригинальный навык: `communications/plivo-setup/SKILL.md`
