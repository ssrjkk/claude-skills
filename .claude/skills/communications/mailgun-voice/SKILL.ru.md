...
version: "1.0"
language: ru
original: mailgun-voice
---

# Mailgun Voice

> Voice with Mailgun. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mailgun-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Mailgun Voice
...
## Ресурсы
- Оригинальный навык: `communications/mailgun-voice/SKILL.md`
