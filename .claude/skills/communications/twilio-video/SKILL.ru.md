...
version: "1.0"
language: ru
original: twilio-video
---

# Twilio Video

> Video with Twilio. video calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `twilio-video`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Twilio Video
...
## Ресурсы
- Оригинальный навык: `communications/twilio-video/SKILL.md`
