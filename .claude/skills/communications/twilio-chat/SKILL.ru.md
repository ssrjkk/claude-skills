...
version: "1.0"
language: ru
original: twilio-chat
---

# Twilio Chat

> Chat with Twilio. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `twilio-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Twilio Chat
...
## Ресурсы
- Оригинальный навык: `communications/twilio-chat/SKILL.md`
