...
version: "1.0"
language: ru
original: slack-api-voice
---

# Slack Api Voice

> Voice with Slack API. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `slack-api-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Slack Api Voice
...
## Ресурсы
- Оригинальный навык: `communications/slack-api-voice/SKILL.md`
