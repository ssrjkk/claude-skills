...
version: "1.0"
language: ru
original: coap-security
---

# Coap Security

> Security with CoAP. security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `coap-security`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Coap Security
...
## Ресурсы
- Оригинальный навык: `communications/coap-security/SKILL.md`
