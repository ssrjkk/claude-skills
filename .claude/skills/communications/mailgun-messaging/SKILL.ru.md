...
version: "1.0"
language: ru
original: mailgun-messaging
---

# Mailgun Messaging

> Messaging with Mailgun. sending messages.

## Быстрый старт
Этот навык на русском языке. Оригинал: `mailgun-messaging`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Mailgun Messaging
...
## Ресурсы
- Оригинальный навык: `communications/mailgun-messaging/SKILL.md`
