...
> Chat with Amazon SES. chat.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ses-chat`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Ses Chat
...
## Ресурсы
- Оригинальный навык: `communications/ses-chat/SKILL.md`
