...
version: "1.0"
language: ru
original: amqp-scaling
---

# Amqp Scaling

> Scaling with AMQP. scaling.

## Быстрый старт
Этот навык на русском языке. Оригинал: `amqp-scaling`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Amqp Scaling
...
## Ресурсы
- Оригинальный навык: `communications/amqp-scaling/SKILL.md`
