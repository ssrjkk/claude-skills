...
tags: [ses-setup, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ses-setup
...
> Setup with Amazon SES. account setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ses-setup`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Ses Setup
...
## Ресурсы
- Оригинальный навык: `communications/ses-setup/SKILL.md`
