...
tags: [sendgrid-voice, communications, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sendgrid-voice
---

# Sendgrid Voice

> Voice with SendGrid. voice calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sendgrid-voice`.

## Когда использовать
- Работа с Коммуникации
- Выполнение задач, связанных с Sendgrid Voice
...
## Ресурсы
- Оригинальный навык: `communications/sendgrid-voice/SKILL.md`
