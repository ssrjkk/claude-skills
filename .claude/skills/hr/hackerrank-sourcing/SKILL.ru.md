...
version: "1.0"
language: ru
original: hackerrank-sourcing
---

# Hackerrank Sourcing

> Sourcing with HackerRank. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hackerrank-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hackerrank Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/hackerrank-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
