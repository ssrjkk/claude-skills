...
version: "1.0"
language: ru
original: lever-integration
---

# Lever Integration

> Integration with Lever. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Integration
...
## Ресурсы
- Оригинальный навык: `hr/lever-integration/SKILL.md`
- Категория: HR
- Язык: Русский
