...
version: "1.0"
language: ru
original: workday-performance
---

# Workday Performance

> Performance with Workday. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Performance
...
## Ресурсы
- Оригинальный навык: `hr/workday-performance/SKILL.md`
- Категория: HR
- Язык: Русский
