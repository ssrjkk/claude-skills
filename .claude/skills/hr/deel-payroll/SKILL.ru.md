...
category: hr
tags: [deel-payroll, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: deel-payroll
---

# Deel Payroll

> Payroll with Deel. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deel-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Deel Payroll
...
## Ресурсы
- Оригинальный навык: `hr/deel-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
