...
category: hr
tags: [angelist-tools, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angelist-tools
---

# Angelist Tools

> Tools with AngelList/Wellfound. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angelist-tools`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Angelist Tools
...
## Ресурсы
- Оригинальный навык: `hr/angelist-tools/SKILL.md`
- Категория: HR
- Язык: Русский
