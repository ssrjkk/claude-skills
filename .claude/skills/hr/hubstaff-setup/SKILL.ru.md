...
version: "1.0"
language: ru
original: hubstaff-setup
---

# Hubstaff Setup

> Setup with Hubstaff. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-setup`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Setup
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-setup/SKILL.md`
- Категория: HR
- Язык: Русский
