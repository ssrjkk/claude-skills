...
category: hr
tags: [bamboohr-employees, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bamboohr-employees
---

# Bamboohr Employees

> Employees with BambooHR. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboohr-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Bamboohr Employees
...
## Ресурсы
- Оригинальный навык: `hr/bamboohr-employees/SKILL.md`
- Категория: HR
- Язык: Русский
