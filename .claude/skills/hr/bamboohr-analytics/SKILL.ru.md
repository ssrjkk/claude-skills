...
version: "1.0"
language: ru
original: bamboohr-analytics
---

# Bamboohr Analytics

> Analytics with BambooHR. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboohr-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Bamboohr Analytics
...
## Ресурсы
- Оригинальный навык: `hr/bamboohr-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
