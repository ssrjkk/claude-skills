...
version: "1.0"
language: ru
original: hubstaff-compliance
---

# Hubstaff Compliance

> Compliance with Hubstaff. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-compliance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Compliance
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-compliance/SKILL.md`
- Категория: HR
- Язык: Русский
