...
version: "1.0"
language: ru
original: workday-analytics
---

# Workday Analytics

> Analytics with Workday. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Analytics
...
## Ресурсы
- Оригинальный навык: `hr/workday-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
