...
version: "1.0"
language: ru
original: sap-successfactors-compliance
---

# Sap Successfactors Compliance

> Compliance with SAP SuccessFactors. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-successfactors-compliance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Sap Successfactors Compliance
...
## Ресурсы
- Оригинальный навык: `hr/sap-successfactors-compliance/SKILL.md`
- Категория: HR
- Язык: Русский
