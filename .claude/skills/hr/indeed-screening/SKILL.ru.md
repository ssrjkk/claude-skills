...
version: "1.0"
language: ru
original: indeed-screening
---

# Indeed Screening

> Screening with Indeed. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `indeed-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Indeed Screening
...
## Ресурсы
- Оригинальный навык: `hr/indeed-screening/SKILL.md`
- Категория: HR
- Язык: Русский
