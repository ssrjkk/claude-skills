...
version: "1.0"
language: ru
original: workday-payroll
---

# Workday Payroll

> Payroll with Workday. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Payroll
...
## Ресурсы
- Оригинальный навык: `hr/workday-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
