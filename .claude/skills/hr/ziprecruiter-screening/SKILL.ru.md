...
version: "1.0"
language: ru
original: ziprecruiter-screening
---

# Ziprecruiter Screening

> Screening with ZipRecruiter. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ziprecruiter-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Ziprecruiter Screening
...
## Ресурсы
- Оригинальный навык: `hr/ziprecruiter-screening/SKILL.md`
- Категория: HR
- Язык: Русский
