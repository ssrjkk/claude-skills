...
category: hr
tags: [remote-performance, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: remote-performance
---

# Remote Performance

> Performance with Remote.com. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Performance
...
## Ресурсы
- Оригинальный навык: `hr/remote-performance/SKILL.md`
- Категория: HR
- Язык: Русский
