...
## Быстрый старт
Этот навык на русском языке. Оригинал: `interviewing-tools`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Interviewing Tools
...
## Ресурсы
- Оригинальный навык: `hr/interviewing-tools/SKILL.md`
- Категория: HR
- Язык: Русский
