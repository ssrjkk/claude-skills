...
version: "1.0"
language: ru
original: glassdoor-analytics
---

# Glassdoor Analytics

> Analytics with Glassdoor. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `glassdoor-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Glassdoor Analytics
...
## Ресурсы
- Оригинальный навык: `hr/glassdoor-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
