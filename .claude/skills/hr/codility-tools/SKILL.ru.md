...
version: "1.0"
language: ru
original: codility-tools
---

# Codility Tools

> Tools with Codility. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codility-tools`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Codility Tools
...
## Ресурсы
- Оригинальный навык: `hr/codility-tools/SKILL.md`
- Категория: HR
- Язык: Русский
