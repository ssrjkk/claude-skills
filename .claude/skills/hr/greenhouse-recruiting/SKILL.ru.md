...
version: "1.0"
language: ru
original: greenhouse-recruiting
---

# Greenhouse Recruiting

> Recruiting with Greenhouse. ATS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-recruiting`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Recruiting
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-recruiting/SKILL.md`
- Категория: HR
- Язык: Русский
