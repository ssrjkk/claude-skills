...
version: "1.0"
language: ru
original: glassdoor-screening
---

# Glassdoor Screening

> Screening with Glassdoor. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `glassdoor-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Glassdoor Screening
...
## Ресурсы
- Оригинальный навык: `hr/glassdoor-screening/SKILL.md`
- Категория: HR
- Язык: Русский
