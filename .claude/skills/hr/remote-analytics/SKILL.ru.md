...
version: "1.0"
language: ru
original: remote-analytics
---

# Remote Analytics

> Analytics with Remote.com. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Analytics
...
## Ресурсы
- Оригинальный навык: `hr/remote-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
