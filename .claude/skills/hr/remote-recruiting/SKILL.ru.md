...
version: "1.0"
language: ru
original: remote-recruiting
---

# Remote Recruiting

> Recruiting with Remote.com. ATS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-recruiting`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Recruiting
...
## Ресурсы
- Оригинальный навык: `hr/remote-recruiting/SKILL.md`
- Категория: HR
- Язык: Русский
