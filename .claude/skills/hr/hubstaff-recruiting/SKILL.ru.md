...
version: "1.0"
language: ru
original: hubstaff-recruiting
---

# Hubstaff Recruiting

> Recruiting with Hubstaff. ATS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-recruiting`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Recruiting
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-recruiting/SKILL.md`
- Категория: HR
- Язык: Русский
