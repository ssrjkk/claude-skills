...
version: "1.0"
language: ru
original: indeed-interviewing
---

# Indeed Interviewing

> Interviewing with Indeed. interviews.

## Быстрый старт
Этот навык на русском языке. Оригинал: `indeed-interviewing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Indeed Interviewing
...
## Ресурсы
- Оригинальный навык: `hr/indeed-interviewing/SKILL.md`
- Категория: HR
- Язык: Русский
