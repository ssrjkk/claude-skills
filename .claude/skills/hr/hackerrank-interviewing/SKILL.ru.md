...
version: "1.0"
language: ru
original: hackerrank-interviewing
---

# Hackerrank Interviewing

> Interviewing with HackerRank. interviews.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hackerrank-interviewing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hackerrank Interviewing
...
## Ресурсы
- Оригинальный навык: `hr/hackerrank-interviewing/SKILL.md`
- Категория: HR
- Язык: Русский
