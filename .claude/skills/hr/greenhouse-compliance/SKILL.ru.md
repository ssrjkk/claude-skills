...
version: "1.0"
language: ru
original: greenhouse-compliance
---

# Greenhouse Compliance

> Compliance with Greenhouse. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-compliance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Compliance
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-compliance/SKILL.md`
- Категория: HR
- Язык: Русский
