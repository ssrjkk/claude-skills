...
version: "1.0"
language: ru
original: codility-interviewing
---

# Codility Interviewing

> Interviewing with Codility. interviews.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codility-interviewing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Codility Interviewing
...
## Ресурсы
- Оригинальный навык: `hr/codility-interviewing/SKILL.md`
- Категория: HR
- Язык: Русский
