...
version: "1.0"
language: ru
original: linkedin-recruiter-tools
---

# Linkedin Recruiter Tools

> Tools with LinkedIn Recruiter. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linkedin-recruiter-tools`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Linkedin Recruiter Tools
...
## Ресурсы
- Оригинальный навык: `hr/linkedin-recruiter-tools/SKILL.md`
- Категория: HR
- Язык: Русский
