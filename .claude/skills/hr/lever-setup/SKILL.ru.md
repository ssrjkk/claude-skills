...
category: hr
tags: [lever-setup, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lever-setup
---

# Lever Setup

> Setup with Lever. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-setup`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Setup
...
## Ресурсы
- Оригинальный навык: `hr/lever-setup/SKILL.md`
- Категория: HR
- Язык: Русский
