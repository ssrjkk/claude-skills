...
category: hr
tags: [deel-integration, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: deel-integration
---

# Deel Integration

> Integration with Deel. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deel-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Deel Integration
...
## Ресурсы
- Оригинальный навык: `hr/deel-integration/SKILL.md`
- Категория: HR
- Язык: Русский
