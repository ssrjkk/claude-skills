...
version: "1.0"
language: ru
original: workday-compliance
---

# Workday Compliance

> Compliance with Workday. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-compliance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Compliance
...
## Ресурсы
- Оригинальный навык: `hr/workday-compliance/SKILL.md`
- Категория: HR
- Язык: Русский
