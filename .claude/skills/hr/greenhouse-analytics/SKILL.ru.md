...
version: "1.0"
language: ru
original: greenhouse-analytics
---

# Greenhouse Analytics

> Analytics with Greenhouse. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Analytics
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
