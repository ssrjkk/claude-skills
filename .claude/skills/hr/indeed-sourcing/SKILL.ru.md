...
category: hr
tags: [indeed-sourcing, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: indeed-sourcing
---

# Indeed Sourcing

> Sourcing with Indeed. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `indeed-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Indeed Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/indeed-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
