...
version: "1.0"
language: ru
original: hubstaff-integration
---

# Hubstaff Integration

> Integration with Hubstaff. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Integration
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-integration/SKILL.md`
- Категория: HR
- Язык: Русский
