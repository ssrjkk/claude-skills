...
category: hr
tags: [ziprecruiter-offers, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ziprecruiter-offers
---

# Ziprecruiter Offers

> Offers with ZipRecruiter. offer mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ziprecruiter-offers`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Ziprecruiter Offers
...
## Ресурсы
- Оригинальный навык: `hr/ziprecruiter-offers/SKILL.md`
- Категория: HR
- Язык: Русский
