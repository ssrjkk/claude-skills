...
version: "1.0"
language: ru
original: ziprecruiter-sourcing
---

# Ziprecruiter Sourcing

> Sourcing with ZipRecruiter. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ziprecruiter-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Ziprecruiter Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/ziprecruiter-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
