...
version: "1.0"
language: ru
original: bamboohr-payroll
---

# Bamboohr Payroll

> Payroll with BambooHR. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboohr-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Bamboohr Payroll
...
## Ресурсы
- Оригинальный навык: `hr/bamboohr-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
