...
version: "1.0"
language: ru
original: interviewing-analytics
---

# Interviewing Analytics

> Analytics with Technical Interviewing. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `interviewing-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Interviewing Analytics
...
## Ресурсы
- Оригинальный навык: `hr/interviewing-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
