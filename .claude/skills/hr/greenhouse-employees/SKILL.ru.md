...
version: "1.0"
language: ru
original: greenhouse-employees
---

# Greenhouse Employees

> Employees with Greenhouse. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Employees
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-employees/SKILL.md`
- Категория: HR
- Язык: Русский
