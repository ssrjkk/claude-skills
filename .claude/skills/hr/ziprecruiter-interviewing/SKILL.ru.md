...
version: "1.0"
language: ru
original: ziprecruiter-interviewing
---

# Ziprecruiter Interviewing

> Interviewing with ZipRecruiter. interviews.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ziprecruiter-interviewing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Ziprecruiter Interviewing
...
## Ресурсы
- Оригинальный навык: `hr/ziprecruiter-interviewing/SKILL.md`
- Категория: HR
- Язык: Русский
