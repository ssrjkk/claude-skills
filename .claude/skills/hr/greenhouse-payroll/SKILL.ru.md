...
version: "1.0"
language: ru
original: greenhouse-payroll
---

# Greenhouse Payroll

> Payroll with Greenhouse. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Payroll
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
