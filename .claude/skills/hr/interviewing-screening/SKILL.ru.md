...
category: hr
tags: [interviewing-screening, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: interviewing-screening
---

# Interviewing Screening

> Screening with Technical Interviewing. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `interviewing-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Interviewing Screening
...
## Ресурсы
- Оригинальный навык: `hr/interviewing-screening/SKILL.md`
- Категория: HR
- Язык: Русский
