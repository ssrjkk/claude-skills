...
version: "1.0"
language: ru
original: workday-integration
---

# Workday Integration

> Integration with Workday. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Integration
...
## Ресурсы
- Оригинальный навык: `hr/workday-integration/SKILL.md`
- Категория: HR
- Язык: Русский
