...
version: "1.0"
language: ru
original: greenhouse-performance
---

# Greenhouse Performance

> Performance with Greenhouse. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Performance
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-performance/SKILL.md`
- Категория: HR
- Язык: Русский
