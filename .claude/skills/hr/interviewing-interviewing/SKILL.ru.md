...
category: hr
tags: [interviewing-interviewing, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: interviewing-interviewing
---

# Interviewing Interviewing

> Interviewing with Technical Interviewing. interviews.

## Быстрый старт
Этот навык на русском языке. Оригинал: `interviewing-interviewing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Interviewing Interviewing
...
## Ресурсы
- Оригинальный навык: `hr/interviewing-interviewing/SKILL.md`
- Категория: HR
- Язык: Русский
