...
version: "1.0"
language: ru
original: bamboohr-performance
---

# Bamboohr Performance

> Performance with BambooHR. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboohr-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Bamboohr Performance
...
## Ресурсы
- Оригинальный навык: `hr/bamboohr-performance/SKILL.md`
- Категория: HR
- Язык: Русский
