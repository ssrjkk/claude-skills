...
version: "1.0"
language: ru
original: codility-sourcing
---

# Codility Sourcing

> Sourcing with Codility. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codility-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Codility Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/codility-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
