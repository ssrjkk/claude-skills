...
category: hr
tags: [deel-performance, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: deel-performance
---

# Deel Performance

> Performance with Deel. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deel-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Deel Performance
...
## Ресурсы
- Оригинальный навык: `hr/deel-performance/SKILL.md`
- Категория: HR
- Язык: Русский
