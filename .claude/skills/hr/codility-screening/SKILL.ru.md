...
version: "1.0"
language: ru
original: codility-screening
---

# Codility Screening

> Screening with Codility. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codility-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Codility Screening
...
## Ресурсы
- Оригинальный навык: `hr/codility-screening/SKILL.md`
- Категория: HR
- Язык: Русский
