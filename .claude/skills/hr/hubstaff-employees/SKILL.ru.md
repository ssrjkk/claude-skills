...
category: hr
tags: [hubstaff-employees, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hubstaff-employees
---

# Hubstaff Employees

> Employees with Hubstaff. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Employees
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-employees/SKILL.md`
- Категория: HR
- Язык: Русский
