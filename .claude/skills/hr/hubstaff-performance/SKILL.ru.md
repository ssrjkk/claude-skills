...
category: hr
tags: [hubstaff-performance, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hubstaff-performance
---

# Hubstaff Performance

> Performance with Hubstaff. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hubstaff-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hubstaff Performance
...
## Ресурсы
- Оригинальный навык: `hr/hubstaff-performance/SKILL.md`
- Категория: HR
- Язык: Русский
