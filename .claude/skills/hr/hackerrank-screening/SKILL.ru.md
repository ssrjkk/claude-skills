...
version: "1.0"
language: ru
original: hackerrank-screening
---

# Hackerrank Screening

> Screening with HackerRank. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hackerrank-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hackerrank Screening
...
## Ресурсы
- Оригинальный навык: `hr/hackerrank-screening/SKILL.md`
- Категория: HR
- Язык: Русский
