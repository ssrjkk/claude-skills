...
category: hr
tags: [interviewing-sourcing, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: interviewing-sourcing
---

# Interviewing Sourcing

> Sourcing with Technical Interviewing. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `interviewing-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Interviewing Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/interviewing-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
