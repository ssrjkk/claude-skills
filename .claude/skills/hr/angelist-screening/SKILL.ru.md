...
category: hr
tags: [angelist-screening, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angelist-screening
---

# Angelist Screening

> Screening with AngelList/Wellfound. resume screening.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angelist-screening`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Angelist Screening
...
## Ресурсы
- Оригинальный навык: `hr/angelist-screening/SKILL.md`
- Категория: HR
- Язык: Русский
