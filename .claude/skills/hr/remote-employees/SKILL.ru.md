...
version: "1.0"
language: ru
original: remote-employees
---

# Remote Employees

> Employees with Remote.com. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Employees
...
## Ресурсы
- Оригинальный навык: `hr/remote-employees/SKILL.md`
- Категория: HR
- Язык: Русский
