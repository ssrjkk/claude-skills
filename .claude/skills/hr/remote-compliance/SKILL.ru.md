...
version: "1.0"
language: ru
original: remote-compliance
---

# Remote Compliance

> Compliance with Remote.com. compliance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-compliance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Compliance
...
## Ресурсы
- Оригинальный навык: `hr/remote-compliance/SKILL.md`
- Категория: HR
- Язык: Русский
