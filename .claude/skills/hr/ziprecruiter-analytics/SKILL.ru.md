...
version: "1.0"
language: ru
original: ziprecruiter-analytics
---

# Ziprecruiter Analytics

> Analytics with ZipRecruiter. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ziprecruiter-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Ziprecruiter Analytics
...
## Ресурсы
- Оригинальный навык: `hr/ziprecruiter-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
