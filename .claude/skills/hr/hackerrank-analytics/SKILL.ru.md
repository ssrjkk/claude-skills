...
category: hr
tags: [hackerrank-analytics, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hackerrank-analytics
---

# Hackerrank Analytics

> Analytics with HackerRank. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hackerrank-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Hackerrank Analytics
...
## Ресурсы
- Оригинальный навык: `hr/hackerrank-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
