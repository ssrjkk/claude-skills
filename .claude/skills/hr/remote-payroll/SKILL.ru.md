...
version: "1.0"
language: ru
original: remote-payroll
---

# Remote Payroll

> Payroll with Remote.com. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Payroll
...
## Ресурсы
- Оригинальный навык: `hr/remote-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
