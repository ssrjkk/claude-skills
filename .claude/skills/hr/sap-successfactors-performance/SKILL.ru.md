...
category: hr
tags: [sap-successfactors-performance, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sap-successfactors-performance
---

# Sap Successfactors Performance

> Performance with SAP SuccessFactors. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-successfactors-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Sap Successfactors Performance
...
## Ресурсы
- Оригинальный навык: `hr/sap-successfactors-performance/SKILL.md`
- Категория: HR
- Язык: Русский
