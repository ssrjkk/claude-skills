...
version: "1.0"
language: ru
original: remote-setup
---

# Remote Setup

> Setup with Remote.com. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-setup`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Setup
...
## Ресурсы
- Оригинальный навык: `hr/remote-setup/SKILL.md`
- Категория: HR
- Язык: Русский
