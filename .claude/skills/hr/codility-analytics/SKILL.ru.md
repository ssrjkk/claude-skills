...
version: "1.0"
language: ru
original: codility-analytics
---

# Codility Analytics

> Analytics with Codility. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `codility-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Codility Analytics
...
## Ресурсы
- Оригинальный навык: `hr/codility-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
