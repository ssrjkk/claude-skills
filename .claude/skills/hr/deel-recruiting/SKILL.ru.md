...
version: "1.0"
language: ru
original: deel-recruiting
---

# Deel Recruiting

> Recruiting with Deel. ATS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deel-recruiting`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Deel Recruiting
...
## Ресурсы
- Оригинальный навык: `hr/deel-recruiting/SKILL.md`
- Категория: HR
- Язык: Русский
