...
version: "1.0"
language: ru
original: lever-payroll
---

# Lever Payroll

> Payroll with Lever. payroll.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-payroll`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Payroll
...
## Ресурсы
- Оригинальный навык: `hr/lever-payroll/SKILL.md`
- Категория: HR
- Язык: Русский
