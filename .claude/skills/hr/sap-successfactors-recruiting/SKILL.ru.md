...
category: hr
tags: [sap-successfactors-recruiting, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: sap-successfactors-recruiting
---

# Sap Successfactors Recruiting

> Recruiting with SAP SuccessFactors. ATS.

## Быстрый старт
Этот навык на русском языке. Оригинал: `sap-successfactors-recruiting`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Sap Successfactors Recruiting
...
## Ресурсы
- Оригинальный навык: `hr/sap-successfactors-recruiting/SKILL.md`
- Категория: HR
- Язык: Русский
