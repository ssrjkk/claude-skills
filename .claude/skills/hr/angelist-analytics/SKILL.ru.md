...
version: "1.0"
language: ru
original: angelist-analytics
---

# Angelist Analytics

> Analytics with AngelList/Wellfound. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angelist-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Angelist Analytics
...
## Ресурсы
- Оригинальный навык: `hr/angelist-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
