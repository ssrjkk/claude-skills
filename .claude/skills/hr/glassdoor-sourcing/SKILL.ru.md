...
category: hr
tags: [glassdoor-sourcing, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: glassdoor-sourcing
---

# Glassdoor Sourcing

> Sourcing with Glassdoor. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `glassdoor-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Glassdoor Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/glassdoor-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
