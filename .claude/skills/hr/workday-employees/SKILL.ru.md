...
category: hr
tags: [workday-employees, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: workday-employees
---

# Workday Employees

> Employees with Workday. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `workday-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Workday Employees
...
## Ресурсы
- Оригинальный навык: `hr/workday-employees/SKILL.md`
- Категория: HR
- Язык: Русский
