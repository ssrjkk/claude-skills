...
version: "1.0"
language: ru
original: remote-integration
---

# Remote Integration

> Integration with Remote.com. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `remote-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Remote Integration
...
## Ресурсы
- Оригинальный навык: `hr/remote-integration/SKILL.md`
- Категория: HR
- Язык: Русский
