...
version: "1.0"
language: ru
original: lever-performance
---

# Lever Performance

> Performance with Lever. performance mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-performance`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Performance
...
## Ресурсы
- Оригинальный навык: `hr/lever-performance/SKILL.md`
- Категория: HR
- Язык: Русский
