...
version: "1.0"
language: ru
original: lever-analytics
---

# Lever Analytics

> Analytics with Lever. analytics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-analytics`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Analytics
...
## Ресурсы
- Оригинальный навык: `hr/lever-analytics/SKILL.md`
- Категория: HR
- Язык: Русский
