...
version: "1.0"
language: ru
original: greenhouse-integration
---

# Greenhouse Integration

> Integration with Greenhouse. integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `greenhouse-integration`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Greenhouse Integration
...
## Ресурсы
- Оригинальный навык: `hr/greenhouse-integration/SKILL.md`
- Категория: HR
- Язык: Русский
