...
category: hr
tags: [lever-employees, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lever-employees
---

# Lever Employees

> Employees with Lever. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lever-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Lever Employees
...
## Ресурсы
- Оригинальный навык: `hr/lever-employees/SKILL.md`
- Категория: HR
- Язык: Русский
