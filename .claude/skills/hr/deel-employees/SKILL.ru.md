...
version: "1.0"
language: ru
original: deel-employees
---

# Deel Employees

> Employees with Deel. employee mgmt.

## Быстрый старт
Этот навык на русском языке. Оригинал: `deel-employees`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Deel Employees
...
## Ресурсы
- Оригинальный навык: `hr/deel-employees/SKILL.md`
- Категория: HR
- Язык: Русский
