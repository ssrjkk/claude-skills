...
category: hr
tags: [angelist-sourcing, hr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: angelist-sourcing
---

# Angelist Sourcing

> Sourcing with AngelList/Wellfound. candidate sourcing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `angelist-sourcing`.

## Когда использовать
- Работа с HR
- Выполнение задач, связанных с Angelist Sourcing
...
## Ресурсы
- Оригинальный навык: `hr/angelist-sourcing/SKILL.md`
- Категория: HR
- Язык: Русский
