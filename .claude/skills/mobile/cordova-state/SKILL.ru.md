...
version: "1.0"
language: ru
original: cordova-state
---

# Cordova State

> State with Cordova. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova State
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-state/SKILL.md`
