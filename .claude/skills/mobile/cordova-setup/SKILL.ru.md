...
category: mobile
tags: [cordova-setup, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cordova-setup
---

# Cordova Setup

> Setup with Cordova. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Setup
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-setup/SKILL.md`
