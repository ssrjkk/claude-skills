...
category: mobile
tags: [flutter-state, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-state
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter State
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-state/SKILL.md`
