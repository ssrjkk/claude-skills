...
> UI with Cordova. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-ui`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Ui
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-ui/SKILL.md`
