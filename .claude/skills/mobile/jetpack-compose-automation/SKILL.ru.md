...
version: "1.0"
language: ru
original: jetpack-compose-automation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: jetpack-compose-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Jetpack Compose Automation
...
## Ресурсы
- mobile/jetpack-compose-automation/SKILL.md
