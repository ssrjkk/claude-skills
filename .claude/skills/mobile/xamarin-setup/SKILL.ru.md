...
version: "1.0"
language: ru
original: xamarin-setup
---

# Xamarin Setup

> Setup with Xamarin. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Setup
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-setup/SKILL.md`
