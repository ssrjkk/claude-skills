...
version: "1.0"
language: ru
original: cordova-storage
---

# Cordova Storage

> Storage with Cordova. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Storage
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-storage/SKILL.md`
