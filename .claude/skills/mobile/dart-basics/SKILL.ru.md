...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Dart Basics
...
## Ресурсы
- Оригинальный навык: mobile/dart-basics/SKILL.md
