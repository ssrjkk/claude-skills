...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Basics
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-basics/SKILL.md
