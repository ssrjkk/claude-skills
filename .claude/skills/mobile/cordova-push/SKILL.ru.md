...
version: "1.0"
language: ru
original: cordova-push
---

# Cordova Push

> Push with Cordova. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Push
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-push/SKILL.md`
