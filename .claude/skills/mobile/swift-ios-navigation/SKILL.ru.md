...
## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-ios-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Ios Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/swift-ios-navigation/SKILL.md`
