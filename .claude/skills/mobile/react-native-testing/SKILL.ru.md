...
category: mobile
tags: [react-native-testing, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-native-testing
---

# React Native Testing

> Testing with React Native. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native Testing
...
## Ресурсы
- Оригинальный навык: `mobile/react-native-testing/SKILL.md`
