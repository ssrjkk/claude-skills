...
version: "1.0"
language: ru
original: xamarin-state
---

# Xamarin State

> State with Xamarin. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin State
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-state/SKILL.md`
