...
category: mobile
tags: [expo-deployment, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: expo-deployment
---

# Expo Deployment

> Deployment for Expo: deployment and release

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Deployment
...
## Ресурсы
- Оригинальный навык: mobile/expo-deployment/SKILL.md
