...
version: "1.0"
language: ru
original: swift-ios-storage
---

# Swift Ios Storage

> Storage with Swift iOS. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-ios-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Ios Storage
...
## Ресурсы
- Оригинальный навык: `mobile/swift-ios-storage/SKILL.md`
