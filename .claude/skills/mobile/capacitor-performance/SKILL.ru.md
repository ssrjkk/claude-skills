...
version: "1.0"
language: ru
original: capacitor-performance
---

# Capacitor Performance

> Performance with Capacitor. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-performance`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Performance
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-performance/SKILL.md`
