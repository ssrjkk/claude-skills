...
category: mobile
tags: [supabase-auth-fundamentals, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: supabase-auth-fundamentals
---

# Supabase Auth Fundamentals

> Fundamentals for Supabase-Auth: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supabase-auth-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Supabase Auth Fundamentals
...
## Ресурсы
- Оригинал: mobile/supabase-auth-fundamentals/SKILL.md
