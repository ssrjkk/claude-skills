...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-api`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Api
...
## Ресурсы
- Оригинальный навык: mobile/flutter-api/SKILL.md
