...
category: mobile
tags: [kotlin-basics, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Basics
...
## Ресурсы
- Оригинальный навык: mobile/kotlin-basics/SKILL.md
