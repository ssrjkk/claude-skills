...
category: mobile
tags: [capacitor-api, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-api`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Api
...
## Ресурсы
- Оригинальный навык: mobile/capacitor-api/SKILL.md
