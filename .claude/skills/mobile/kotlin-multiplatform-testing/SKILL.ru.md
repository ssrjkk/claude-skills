...
version: "1.0"
language: ru
original: kotlin-multiplatform-testing
---

# Kotlin Multiplatform Testing

> Testing with Kotlin Multiplatform. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-multiplatform-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Multiplatform Testing
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-multiplatform-testing/SKILL.md`
