...
category: mobile
tags: [swift-monitoring, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-monitoring
---

# Swift Monitoring

> Monitoring for Swift: monitoring and observability

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-monitoring`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Monitoring
...
## Ресурсы
- Оригинальный навык: mobile/swift-monitoring/SKILL.md
