...
category: mobile
tags: [react-native-push, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-native-push
---

# React Native Push

> Push with React Native. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native Push
...
## Ресурсы
- Оригинальный навык: `mobile/react-native-push/SKILL.md`
