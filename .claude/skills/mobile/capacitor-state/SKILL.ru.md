...
version: "1.0"
language: ru
original: capacitor-state
---

# Capacitor State

> State with Capacitor. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor State
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-state/SKILL.md`
