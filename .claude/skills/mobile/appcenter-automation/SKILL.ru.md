...
category: mobile
tags: [appcenter-automation, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: appcenter-automation
---

# Appcenter Automation

> Automation for Appcenter: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: appcenter-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Appcenter Automation
...
## Ресурсы
- mobile/appcenter-automation/SKILL.md
