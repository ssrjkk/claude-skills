...
> UI with Xamarin. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-ui`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Ui
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-ui/SKILL.md`
