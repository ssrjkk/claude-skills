...
version: "1.0"
language: ru
original: descope-examples
---

# Descope Examples

> Examples for Descope: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `descope-examples`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Descope Examples
...
## Ресурсы
- Оригинал: mobile/descope-examples/SKILL.md
