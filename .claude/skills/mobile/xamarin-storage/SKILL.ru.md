...
version: "1.0"
language: ru
original: xamarin-storage
---

# Xamarin Storage

> Storage with Xamarin. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Storage
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-storage/SKILL.md`
