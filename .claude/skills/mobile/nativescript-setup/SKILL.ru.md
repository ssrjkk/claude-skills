...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Setup
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-setup/SKILL.md`
