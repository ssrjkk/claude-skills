...
category: mobile
tags: [kotlin-multiplatform-networking, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-multiplatform-networking
---

# Kotlin Multiplatform Networking

> Networking with Kotlin Multiplatform. API calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-multiplatform-networking`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Multiplatform Networking
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-multiplatform-networking/SKILL.md`
