...
category: mobile
tags: [nativescript-advanced, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nativescript-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Advanced
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-advanced/SKILL.md
