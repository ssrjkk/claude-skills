...
category: mobile
tags: [kotlin-android-storage, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-android-storage
---

# Kotlin Android Storage

> Storage with Kotlin Android. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Storage
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-storage/SKILL.md`
