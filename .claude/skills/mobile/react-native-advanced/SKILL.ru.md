...
version: "1.0"
language: ru
original: react-native-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native Advanced
...
## Ресурсы
- Оригинальный навык: mobile/react-native-advanced/SKILL.md
