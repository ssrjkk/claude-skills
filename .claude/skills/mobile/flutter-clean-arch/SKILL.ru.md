...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-clean-arch`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Clean Arch
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-clean-arch/SKILL.md`
