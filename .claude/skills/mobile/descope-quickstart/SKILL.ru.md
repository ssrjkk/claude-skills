...
version: "1.0"
language: ru
original: descope-quickstart
---

# Descope Quickstart

> Quickstart for Descope: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `descope-quickstart`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Descope Quickstart
...
## Ресурсы
- Оригинал: mobile/descope-quickstart/SKILL.md
