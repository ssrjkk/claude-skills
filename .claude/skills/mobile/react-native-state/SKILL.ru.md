...
version: "1.0"
language: ru
original: react-native-state
---

# React Native State

> State with React Native. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native State
...
## Ресурсы
- Оригинальный навык: `mobile/react-native-state/SKILL.md`
