...
version: "1.0"
language: ru
original: xamarin-navigation
---

# Xamarin Navigation

> Navigation with Xamarin. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-navigation/SKILL.md`
