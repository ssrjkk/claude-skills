...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Advanced
...
## Ресурсы
- Оригинальный навык: mobile/flutter-advanced/SKILL.md
