...
version: "1.0"
language: ru
original: xamarin-push
---

# Xamarin Push

> Push with Xamarin. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Push
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-push/SKILL.md`
