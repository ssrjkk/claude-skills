...
version: "1.0"
language: ru
original: diawi-automation
---

# Diawi Automation

> Automation for Diawi: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Automation
...
## Ресурсы
- mobile/diawi-automation/SKILL.md
