...
category: mobile
tags: [nativescript-push, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nativescript-push
---

# Nativescript Push

> Push with NativeScript. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Push
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-push/SKILL.md`
