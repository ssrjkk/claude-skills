...
category: mobile
tags: [swift-ios-deployment, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-ios-deployment
---

# Swift Ios Deployment

> Deployment with Swift iOS. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-ios-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Ios Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/swift-ios-deployment/SKILL.md`
