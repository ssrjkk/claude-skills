...
category: mobile
tags: [nativescript-testing, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nativescript-testing
---

# Nativescript Testing

> Testing with NativeScript. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Testing
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-testing/SKILL.md`
