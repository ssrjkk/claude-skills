...
category: mobile
tags: [diawi-production, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: diawi-production
---

# Diawi Production

> Production for Diawi: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-production.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Production
...
## Ресурсы
- mobile/diawi-production/SKILL.md
