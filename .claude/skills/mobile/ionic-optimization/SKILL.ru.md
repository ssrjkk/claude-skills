...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-optimization`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Optimization
...
## Ресурсы
- Оригинальный навык: mobile/ionic-optimization/SKILL.md
