...
version: "1.0"
language: ru
original: ionic-deployment
---

# Ionic Deployment

> Deployment with Ionic. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/ionic-deployment/SKILL.md`
