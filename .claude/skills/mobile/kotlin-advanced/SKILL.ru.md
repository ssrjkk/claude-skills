...
category: mobile
tags: [kotlin-advanced, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Advanced
...
## Ресурсы
- Оригинальный навык: mobile/kotlin-advanced/SKILL.md
