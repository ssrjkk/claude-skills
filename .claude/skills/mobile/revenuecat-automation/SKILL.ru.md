...
version: "1.0"
language: ru
original: revenuecat-automation
---

# Revenuecat Automation

> Automation for Revenuecat: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: revenuecat-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Revenuecat Automation
...
## Ресурсы
- mobile/revenuecat-automation/SKILL.md
