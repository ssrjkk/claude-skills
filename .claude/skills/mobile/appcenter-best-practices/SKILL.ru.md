...
version: "1.0"
language: ru
original: appcenter-best-practices
---

# Appcenter Best Practices

> Best Practices for Appcenter: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: appcenter-best-practices.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Appcenter Best Practices
...
## Ресурсы
- mobile/appcenter-best-practices/SKILL.md
