...
version: "1.0"
language: ru
original: capacitor-ui
---

# Capacitor Ui

> UI with Capacitor. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-ui`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Ui
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-ui/SKILL.md`
