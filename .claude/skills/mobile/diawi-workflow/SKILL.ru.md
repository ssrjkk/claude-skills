...
category: mobile
tags: [diawi-workflow, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: diawi-workflow
---

# Diawi Workflow

> Workflow for Diawi: workflow optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-workflow.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Workflow
...
## Ресурсы
- mobile/diawi-workflow/SKILL.md
