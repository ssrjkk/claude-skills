...
category: mobile
tags: [react-native-ui, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-native-ui
---

# React Native Ui

> UI with React Native. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-ui`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native Ui
...
## Ресурсы
- Оригинальный навык: `mobile/react-native-ui/SKILL.md`
