...
version: "1.0"
language: ru
original: xamarin-deployment
---

# Xamarin Deployment

> Deployment with Xamarin. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-deployment/SKILL.md`
