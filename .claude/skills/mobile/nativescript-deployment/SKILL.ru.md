...
version: "1.0"
language: ru
original: nativescript-deployment
---

# Nativescript Deployment

> Deployment with NativeScript. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-deployment/SKILL.md`
