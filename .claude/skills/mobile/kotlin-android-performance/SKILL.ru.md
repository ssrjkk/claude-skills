...
version: "1.0"
language: ru
original: kotlin-android-performance
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-performance`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Performance
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-performance/SKILL.md`
