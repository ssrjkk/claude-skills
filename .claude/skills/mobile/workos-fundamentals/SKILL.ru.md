...
category: mobile
tags: [workos-fundamentals, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: workos-fundamentals
---

# Workos Fundamentals

> Fundamentals for Workos: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `workos-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Workos Fundamentals
...
## Ресурсы
- Оригинал: mobile/workos-fundamentals/SKILL.md
