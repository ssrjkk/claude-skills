...
version: "1.0"
language: ru
original: amplify-auth-fundamentals
---

# Amplify Auth Fundamentals

> Fundamentals for Amplify-Auth: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `amplify-auth-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Amplify Auth Fundamentals
...
## Ресурсы
- Оригинал: mobile/amplify-auth-fundamentals/SKILL.md
