...
category: mobile
tags: [frontegg-fundamentals, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: frontegg-fundamentals
---

# Frontegg Fundamentals

> Fundamentals for Frontegg: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `frontegg-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Frontegg Fundamentals
...
## Ресурсы
- Оригинал: mobile/frontegg-fundamentals/SKILL.md
