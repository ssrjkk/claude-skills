...
version: "1.0"
language: ru
original: descope-fundamentals
---

# Descope Fundamentals

> Fundamentals for Descope: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `descope-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Descope Fundamentals
...
## Ресурсы
- Оригинал: mobile/descope-fundamentals/SKILL.md
