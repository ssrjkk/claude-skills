...
category: mobile
tags: [capacitor-storage, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-storage
---

# Capacitor Storage

> Storage with Capacitor. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Storage
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-storage/SKILL.md`
