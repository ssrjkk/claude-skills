...
category: mobile
tags: [expo-security, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: expo-security
---

# Expo Security

> Security for Expo: security best practices

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-security`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Security
...
## Ресурсы
- Оригинальный навык: mobile/expo-security/SKILL.md
