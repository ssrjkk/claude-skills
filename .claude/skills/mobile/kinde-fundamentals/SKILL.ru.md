...
version: "1.0"
language: ru
original: kinde-fundamentals
---

# Kinde Fundamentals

> Fundamentals for Kinde: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinde-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kinde Fundamentals
...
## Ресурсы
- Оригинал: mobile/kinde-fundamentals/SKILL.md
