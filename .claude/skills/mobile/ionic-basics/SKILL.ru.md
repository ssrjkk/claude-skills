...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Basics
...
## Ресурсы
- Оригинальный навык: mobile/ionic-basics/SKILL.md
