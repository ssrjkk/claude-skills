...
category: mobile
tags: [capacitor-testing, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-testing
---

# Capacitor Testing

> Testing with Capacitor. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Testing
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-testing/SKILL.md`
