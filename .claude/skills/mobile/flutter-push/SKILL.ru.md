...
version: "1.0"
language: ru
original: flutter-push
---

# Flutter Push

> Push with Flutter. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Push
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-push/SKILL.md`
