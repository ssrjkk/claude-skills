...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Dart Advanced
...
## Ресурсы
- Оригинальный навык: mobile/dart-advanced/SKILL.md
