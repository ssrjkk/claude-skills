...
version: "1.0"
language: ru
original: nativescript-networking
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-networking`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Networking
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-networking/SKILL.md`
