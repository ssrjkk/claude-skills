...
version: "1.0"
language: ru
original: diawi-getting-started
---

# Diawi Getting Started

> Getting Started for Diawi: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-getting-started.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Getting Started
...
## Ресурсы
- mobile/diawi-getting-started/SKILL.md
