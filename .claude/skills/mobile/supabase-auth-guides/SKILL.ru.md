...
category: mobile
tags: [supabase-auth-guides, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: supabase-auth-guides
---

# Supabase Auth Guides

> Guides for Supabase-Auth: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supabase-auth-guides`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Supabase Auth Guides
...
## Ресурсы
- Оригинал: mobile/supabase-auth-guides/SKILL.md
