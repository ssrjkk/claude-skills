...
category: mobile
tags: [diawi-integration, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: diawi-integration
---

# Diawi Integration

> Integration for Diawi: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-integration.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Integration
...
## Ресурсы
- mobile/diawi-integration/SKILL.md
