...
version: "1.0"
language: ru
original: ionic-navigation
---

# Ionic Navigation

> Navigation with Ionic. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/ionic-navigation/SKILL.md`
