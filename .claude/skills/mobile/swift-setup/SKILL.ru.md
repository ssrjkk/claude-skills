...
version: "1.0"
language: ru
original: swift-setup
---

# Swift Setup

> Setup for Swift: installation and configuration

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Setup
...
## Ресурсы
- Оригинальный навык: mobile/swift-setup/SKILL.md
