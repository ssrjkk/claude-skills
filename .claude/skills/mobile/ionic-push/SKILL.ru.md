...
> Push with Ionic. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Push
...
## Ресурсы
- Оригинальный навык: `mobile/ionic-push/SKILL.md`
