...
## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-security`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Security
...
## Ресурсы
- Оригинальный навык: mobile/xamarin-security/SKILL.md
