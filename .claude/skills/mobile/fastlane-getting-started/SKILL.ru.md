...
category: mobile
tags: [fastlane-getting-started, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fastlane-getting-started
---

# Fastlane Getting Started

> Getting Started for Fastlane: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: fastlane-getting-started.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Fastlane Getting Started
...
## Ресурсы
- mobile/fastlane-getting-started/SKILL.md
