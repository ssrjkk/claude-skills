...
category: mobile
tags: [expo-advanced, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: expo-advanced
---

# Expo Advanced

> Advanced for Expo: advanced patterns and techniques

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Advanced
...
## Ресурсы
- Оригинальный навык: mobile/expo-advanced/SKILL.md
