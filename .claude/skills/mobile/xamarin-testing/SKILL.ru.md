...
version: "1.0"
language: ru
original: xamarin-testing
---

# Xamarin Testing

> Testing with Xamarin. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Testing
...
## Ресурсы
- Оригинальный навык: `mobile/xamarin-testing/SKILL.md`
