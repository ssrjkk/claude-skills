...
version: "1.0"
language: ru
original: diawi-configuration
---

# Diawi Configuration

> Configuration for Diawi: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: diawi-configuration.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Diawi Configuration
...
## Ресурсы
- mobile/diawi-configuration/SKILL.md
