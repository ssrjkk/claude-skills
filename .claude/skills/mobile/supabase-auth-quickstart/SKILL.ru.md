...
category: mobile
tags: [supabase-auth-quickstart, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: supabase-auth-quickstart
---

# Supabase Auth Quickstart

> Quickstart for Supabase-Auth: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `supabase-auth-quickstart`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Supabase Auth Quickstart
...
## Ресурсы
- Оригинал: mobile/supabase-auth-quickstart/SKILL.md
