...
version: "1.0"
language: ru
original: capacitor-push
---

# Capacitor Push

> Push with Capacitor. push notifications.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-push`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Push
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-push/SKILL.md`
