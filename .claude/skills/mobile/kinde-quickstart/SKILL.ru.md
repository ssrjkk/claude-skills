...
version: "1.0"
language: ru
original: kinde-quickstart
---

# Kinde Quickstart

> Quickstart for Kinde: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinde-quickstart`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kinde Quickstart
...
## Ресурсы
- Оригинал: mobile/kinde-quickstart/SKILL.md
