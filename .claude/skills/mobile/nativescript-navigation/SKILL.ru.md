...
version: "1.0"
language: ru
original: nativescript-navigation
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-navigation/SKILL.md`
