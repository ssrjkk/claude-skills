...
category: mobile
tags: [kotlin-android-navigation, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-android-navigation
---

# Kotlin Android Navigation

> Navigation with Kotlin Android. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-navigation/SKILL.md`
