...
category: mobile
tags: [capacitor-navigation, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-navigation
---

# Capacitor Navigation

> Navigation with Capacitor. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-navigation/SKILL.md`
