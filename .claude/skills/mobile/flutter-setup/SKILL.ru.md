...
category: mobile
tags: [flutter-setup, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-setup
---

# Flutter Setup

> Setup with Flutter. setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Setup
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-setup/SKILL.md`
