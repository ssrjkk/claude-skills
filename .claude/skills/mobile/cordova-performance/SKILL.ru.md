...
category: mobile
tags: [cordova-performance, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cordova-performance
---

# Cordova Performance

> Performance with Cordova. optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-performance`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Performance
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-performance/SKILL.md`
