...
version: "1.0"
language: ru
original: amplify-auth-guides
---

# Amplify Auth Guides

> Guides for Amplify-Auth: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `amplify-auth-guides`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Amplify Auth Guides
...
## Ресурсы
- Оригинал: mobile/amplify-auth-guides/SKILL.md
