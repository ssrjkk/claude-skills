...
category: mobile
tags: [kotlin-android-networking, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-android-networking
---

# Kotlin Android Networking

> Networking with Kotlin Android. API calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-networking`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Networking
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-networking/SKILL.md`
