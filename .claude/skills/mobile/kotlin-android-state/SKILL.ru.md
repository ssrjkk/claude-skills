...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android State
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-state/SKILL.md`
