...
version: "1.0"
language: ru
original: cordova-navigation
---

# Cordova Navigation

> Navigation with Cordova. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-navigation/SKILL.md`
