...
version: "1.0"
language: ru
original: nativescript-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-security`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Security
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-security/SKILL.md
