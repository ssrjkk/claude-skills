...
version: "1.0"
language: ru
original: kotlin-multiplatform-deployment
---

# Kotlin Multiplatform Deployment

> Deployment with Kotlin Multiplatform. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-multiplatform-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Multiplatform Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-multiplatform-deployment/SKILL.md`
