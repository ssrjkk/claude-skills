...
category: mobile
tags: [kotlin-android-testing, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-android-testing
---

# Kotlin Android Testing

> Testing with Kotlin Android. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Testing
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-testing/SKILL.md`
