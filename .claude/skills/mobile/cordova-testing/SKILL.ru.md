...
category: mobile
tags: [cordova-testing, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cordova-testing
---

# Cordova Testing

> Testing with Cordova. testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Testing
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-testing/SKILL.md`
