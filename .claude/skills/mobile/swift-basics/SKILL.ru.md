...
version: "1.0"
language: ru
original: swift-basics
---

# Swift Basics

> Basics for Swift: fundamentals and core concepts

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Basics
...
## Ресурсы
- Оригинальный навык: mobile/swift-basics/SKILL.md
