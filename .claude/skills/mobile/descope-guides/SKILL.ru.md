...
version: "1.0"
language: ru
original: descope-guides
---

# Descope Guides

> Guides for Descope: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `descope-guides`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Descope Guides
...
## Ресурсы
- Оригинал: mobile/descope-guides/SKILL.md
