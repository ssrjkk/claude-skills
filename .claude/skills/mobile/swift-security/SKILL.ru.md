...
category: mobile
tags: [swift-security, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-security
---

# Swift Security

> Security for Swift: security best practices

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-security`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Security
...
## Ресурсы
- Оригинальный навык: mobile/swift-security/SKILL.md
