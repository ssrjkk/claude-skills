...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Storage
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-storage/SKILL.md`
