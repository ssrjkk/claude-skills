...
category: mobile
tags: [expo-setup, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: expo-setup
...
> Setup for Expo: installation and configuration

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Setup
...
## Ресурсы
- Оригинальный навык: mobile/expo-setup/SKILL.md
