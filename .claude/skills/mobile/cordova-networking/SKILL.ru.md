...
version: "1.0"
language: ru
original: cordova-networking
---

# Cordova Networking

> Networking with Cordova. API calls.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-networking`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Networking
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-networking/SKILL.md`
