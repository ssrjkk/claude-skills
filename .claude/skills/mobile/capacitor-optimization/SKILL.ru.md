...
category: mobile
tags: [capacitor-optimization, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-optimization`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Optimization
...
## Ресурсы
- Оригинальный навык: mobile/capacitor-optimization/SKILL.md
