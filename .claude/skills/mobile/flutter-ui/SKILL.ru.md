...
category: mobile
tags: [flutter-ui, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-ui
...
> UI with Flutter. UI components.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-ui`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Ui
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-ui/SKILL.md`
