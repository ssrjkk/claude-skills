...
version: "1.0"
language: ru
original: kotlin-android-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-android-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Android Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/kotlin-android-deployment/SKILL.md`
