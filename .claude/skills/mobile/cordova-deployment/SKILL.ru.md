...
version: "1.0"
language: ru
original: cordova-deployment
---

# Cordova Deployment

> Deployment with Cordova. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cordova-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Cordova Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/cordova-deployment/SKILL.md`
