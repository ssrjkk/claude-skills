...
version: "1.0"
language: ru
original: expo-basics
---

# Expo Basics

> Basics for Expo: fundamentals and core concepts

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Basics
...
## Ресурсы
- Оригинальный навык: mobile/expo-basics/SKILL.md
