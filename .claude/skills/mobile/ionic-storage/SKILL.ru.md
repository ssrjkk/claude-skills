...
version: "1.0"
language: ru
original: ionic-storage
---

# Ionic Storage

> Storage with Ionic. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic Storage
...
## Ресурсы
- Оригинальный навык: `mobile/ionic-storage/SKILL.md`
