...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-basics`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Basics
...
## Ресурсы
- Оригинальный навык: mobile/flutter-basics/SKILL.md
