...
version: "1.0"
language: ru
original: capacitor-deployment
---

# Capacitor Deployment

> Deployment with Capacitor. app store.

## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Deployment
...
## Ресурсы
- Оригинальный навык: `mobile/capacitor-deployment/SKILL.md`
