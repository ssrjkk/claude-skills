...
category: mobile
tags: [kotlin-api, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kotlin-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kotlin-api`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kotlin Api
...
## Ресурсы
- Оригинальный навык: mobile/kotlin-api/SKILL.md
