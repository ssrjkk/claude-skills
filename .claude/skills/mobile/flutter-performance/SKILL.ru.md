...
category: mobile
tags: [flutter-performance, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flutter-performance
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-performance`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Performance
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-performance/SKILL.md`
