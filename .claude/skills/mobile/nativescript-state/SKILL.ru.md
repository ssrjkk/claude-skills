...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript State
...
## Ресурсы
- Оригинальный навык: `mobile/nativescript-state/SKILL.md`
