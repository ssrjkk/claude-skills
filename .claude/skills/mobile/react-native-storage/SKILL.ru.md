...
category: mobile
tags: [react-native-storage, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: react-native-storage
---

# React Native Storage

> Storage with React Native. local storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `react-native-storage`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с React Native Storage
...
## Ресурсы
- Оригинальный навык: `mobile/react-native-storage/SKILL.md`
