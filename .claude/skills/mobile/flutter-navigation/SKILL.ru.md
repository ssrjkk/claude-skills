...
version: "1.0"
language: ru
original: flutter-navigation
---

# Flutter Navigation

> Navigation with Flutter. navigation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flutter-navigation`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Flutter Navigation
...
## Ресурсы
- Оригинальный навык: `mobile/flutter-navigation/SKILL.md`
