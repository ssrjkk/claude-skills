...
version: "1.0"
language: ru
original: nativescript-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-optimization`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Optimization
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-optimization/SKILL.md
