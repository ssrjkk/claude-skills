...
category: mobile
tags: [dart-setup, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dart-setup
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-setup`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Dart Setup
...
## Ресурсы
- Оригинальный навык: mobile/dart-setup/SKILL.md
