...
## Быстрый старт
Этот навык на русском языке. Оригинал: `xamarin-advanced`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Xamarin Advanced
...
## Ресурсы
- Оригинальный навык: mobile/xamarin-advanced/SKILL.md
