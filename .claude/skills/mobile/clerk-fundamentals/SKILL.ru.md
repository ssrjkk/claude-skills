...
category: mobile
tags: [clerk-fundamentals, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: clerk-fundamentals
---

# Clerk Fundamentals

> Fundamentals for Clerk: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `clerk-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Clerk Fundamentals
...
## Ресурсы
- Оригинал: mobile/clerk-fundamentals/SKILL.md
