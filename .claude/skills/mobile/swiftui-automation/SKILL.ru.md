...
category: mobile
tags: [swiftui-automation, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swiftui-automation
---

# Swiftui Automation

> Automation for Swiftui: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: swiftui-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swiftui Automation
...
## Ресурсы
- mobile/swiftui-automation/SKILL.md
