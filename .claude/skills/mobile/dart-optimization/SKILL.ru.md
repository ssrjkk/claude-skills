...
category: mobile
tags: [dart-optimization, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dart-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dart-optimization`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Dart Optimization
...
## Ресурсы
- Оригинальный навык: mobile/dart-optimization/SKILL.md
