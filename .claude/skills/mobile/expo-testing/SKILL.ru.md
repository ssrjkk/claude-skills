...
version: "1.0"
language: ru
original: expo-testing
---

# Expo Testing

> Testing for Expo: testing and validation

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-testing`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Testing
...
## Ресурсы
- Оригинальный навык: mobile/expo-testing/SKILL.md
