...
category: mobile
tags: [ionic-state, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> State with Ionic. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ionic-state`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Ionic State
...
## Ресурсы
- Оригинальный навык: `mobile/ionic-state/SKILL.md`
