...
category: mobile
tags: [capacitor-security, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: capacitor-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `capacitor-security`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Capacitor Security
...
## Ресурсы
- Оригинальный навык: mobile/capacitor-security/SKILL.md
