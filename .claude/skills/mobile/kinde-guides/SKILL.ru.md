...
version: "1.0"
language: ru
original: kinde-guides
---

# Kinde Guides

> Guides for Kinde: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kinde-guides`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Kinde Guides
...
## Ресурсы
- Оригинал: mobile/kinde-guides/SKILL.md
