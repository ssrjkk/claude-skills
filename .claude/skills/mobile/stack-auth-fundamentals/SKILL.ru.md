...
category: mobile
tags: [stack-auth-fundamentals, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: stack-auth-fundamentals
---

# Stack Auth Fundamentals

> Fundamentals for Stack-Auth: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `stack-auth-fundamentals`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Stack Auth Fundamentals
...
## Ресурсы
- Оригинал: mobile/stack-auth-fundamentals/SKILL.md
