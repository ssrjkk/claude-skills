...
category: mobile
tags: [swift-deployment, mobile, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: swift-deployment
---

# Swift Deployment

> Deployment for Swift: deployment and release

## Быстрый старт
Этот навык на русском языке. Оригинал: `swift-deployment`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Swift Deployment
...
## Ресурсы
- Оригинальный навык: mobile/swift-deployment/SKILL.md
