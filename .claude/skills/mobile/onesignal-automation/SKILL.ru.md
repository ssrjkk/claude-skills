...
version: "1.0"
language: ru
original: onesignal-automation
---

# Onesignal Automation

> Automation for Onesignal: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: onesignal-automation.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Onesignal Automation
...
## Ресурсы
- mobile/onesignal-automation/SKILL.md
