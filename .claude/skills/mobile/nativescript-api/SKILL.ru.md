...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-api`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Api
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-api/SKILL.md
