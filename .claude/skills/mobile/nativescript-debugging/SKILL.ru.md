...
version: "1.0"
language: ru
original: nativescript-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `nativescript-debugging`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Nativescript Debugging
...
## Ресурсы
- Оригинальный навык: mobile/nativescript-debugging/SKILL.md
