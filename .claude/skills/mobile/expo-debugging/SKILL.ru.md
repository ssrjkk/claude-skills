...
## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-debugging`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Debugging
...
## Ресурсы
- Оригинальный навык: mobile/expo-debugging/SKILL.md
