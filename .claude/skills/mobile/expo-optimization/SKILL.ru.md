...
version: "1.0"
language: ru
original: expo-optimization
---

# Expo Optimization

> Optimization for Expo: performance tuning and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `expo-optimization`.

## Когда использовать
- Работа с Мобильная разработка
- Выполнение задач, связанных с Expo Optimization
...
## Ресурсы
- Оригинальный навык: mobile/expo-optimization/SKILL.md
