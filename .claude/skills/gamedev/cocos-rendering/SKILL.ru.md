...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-rendering`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Rendering
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-rendering/SKILL.md`
- Категория: Геймдев
- Язык: Русский
