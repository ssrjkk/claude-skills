...
version: "1.0"
language: ru
original: defold-physics
---

# Defold Physics

> Physics with Defold. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
