...
> Audio with Bevy. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
