...
version: "1.0"
language: ru
original: game-maker-physics
---

# Game Maker Physics

> Physics with GameMaker. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
