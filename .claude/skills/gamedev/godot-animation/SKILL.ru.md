...
category: gamedev
tags: [godot-animation, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: godot-animation
---

# Godot Animation

> Animation with Godot. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
