...
version: "1.0"
language: ru
original: defold-optimization
---

# Defold Optimization

> Optimization with Defold. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
