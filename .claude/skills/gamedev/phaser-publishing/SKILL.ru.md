...
version: "1.0"
language: ru
original: phaser-publishing
---

# Phaser Publishing

> Publishing with Phaser. publishing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
