...
version: "1.0"
language: ru
original: phaser-rendering
---

# Phaser Rendering

> Rendering with Phaser. graphics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-rendering`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Rendering
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-rendering/SKILL.md`
- Категория: Геймдев
- Язык: Русский
