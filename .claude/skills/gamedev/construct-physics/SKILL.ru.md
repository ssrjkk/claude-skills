...
category: gamedev
tags: [construct-physics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: construct-physics
---

# Construct Physics

> Physics with Construct. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
