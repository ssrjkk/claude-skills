...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-deployment`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Deployment
...
## Ресурсы
- Оригинальный навык: gamedev/bevy-deployment/SKILL.md
- Категория: Геймдев
- Язык: Русский
