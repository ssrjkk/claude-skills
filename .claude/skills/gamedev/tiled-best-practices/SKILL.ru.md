...
version: "1.0"
language: ru
original: tiled-best-practices
---

# Tiled Best Practices

> Best Practices for Tiled: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: tiled-best-practices.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Tiled Best Practices
...
## Ресурсы
- gamedev/tiled-best-practices/SKILL.md
- Категория: Геймдев
