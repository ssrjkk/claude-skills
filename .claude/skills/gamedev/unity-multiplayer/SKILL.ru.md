...
version: "1.0"
language: ru
original: unity-multiplayer
---

# Unity Multiplayer

> Multiplayer with Unity. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
