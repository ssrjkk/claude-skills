...
version: "1.0"
language: ru
original: rokoko-quickstart
---

# Rokoko Quickstart

> Quickstart for Rokoko: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `rokoko-quickstart`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rokoko Quickstart
...
## Ресурсы
- Оригинал: gamedev/rokoko-quickstart/SKILL.md
- Категория: Геймдев
