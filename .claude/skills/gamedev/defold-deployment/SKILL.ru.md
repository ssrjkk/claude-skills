...
category: gamedev
tags: [defold-deployment, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: defold-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-deployment`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Deployment
...
## Ресурсы
- Оригинальный навык: gamedev/defold-deployment/SKILL.md
- Категория: Геймдев
- Язык: Русский
