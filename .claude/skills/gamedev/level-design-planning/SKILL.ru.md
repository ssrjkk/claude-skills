...
version: "1.0"
language: ru
original: level-design-planning
---

# Level Design Planning

> Planning with Level Design. planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `level-design-planning`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Level Design Planning
...
## Ресурсы
- Оригинальный навык: `gamedev/level-design-planning/SKILL.md`
- Категория: Геймдев
- Язык: Русский
