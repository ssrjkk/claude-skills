...
category: gamedev
tags: [construct-optimization, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: construct-optimization
---

# Construct Optimization

> Optimization with Construct. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
