...
category: gamedev
tags: [combat-design-tools, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: combat-design-tools
---

# Combat Design Tools

> Tools with Combat Design. tools.

## Быстрый старт
Этот навык на русском языке. Оригинал: `combat-design-tools`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Combat Design Tools
...
## Ресурсы
- Оригинальный навык: `gamedev/combat-design-tools/SKILL.md`
- Категория: Геймдев
- Язык: Русский
