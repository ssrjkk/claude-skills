...
version: "1.0"
language: ru
original: unity-scripting
---

# Unity Scripting

> Scripting with Unity. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
