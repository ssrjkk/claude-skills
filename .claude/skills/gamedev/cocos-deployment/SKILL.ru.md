...
category: gamedev
tags: [cocos-deployment, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-deployment`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Deployment
...
## Ресурсы
- Оригинальный навык: gamedev/cocos-deployment/SKILL.md
- Категория: Геймдев
- Язык: Русский
