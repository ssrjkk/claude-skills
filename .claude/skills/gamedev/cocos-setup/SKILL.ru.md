...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
