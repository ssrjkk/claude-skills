...
category: gamedev
tags: [bevy-setup, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bevy-setup
...
> Setup with Bevy. engine setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
