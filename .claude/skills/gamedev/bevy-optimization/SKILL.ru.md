...
version: "1.0"
language: ru
original: bevy-optimization
---

# Bevy Optimization

> Optimization with Bevy. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
