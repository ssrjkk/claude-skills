...
version: "1.0"
language: ru
original: godot-multiplayer
---

# Godot Multiplayer

> Multiplayer with Godot. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
