...
version: "1.0"
language: ru
original: wwise-configuration
---

# Wwise Configuration

> Configuration for Wwise: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: wwise-configuration.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Wwise Configuration
...
## Ресурсы
- gamedev/wwise-configuration/SKILL.md
- Категория: Геймдев
