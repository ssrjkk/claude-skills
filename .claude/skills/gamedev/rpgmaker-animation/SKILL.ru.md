...
version: "1.0"
language: ru
original: rpgmaker-animation
---

# Rpgmaker Animation

> Animation with RPG Maker. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rpgmaker-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rpgmaker Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/rpgmaker-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
