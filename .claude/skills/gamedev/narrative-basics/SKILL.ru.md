...
version: "1.0"
language: ru
original: narrative-basics
---

# Narrative Basics

> Basics with Narrative Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `narrative-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Narrative Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/narrative-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
