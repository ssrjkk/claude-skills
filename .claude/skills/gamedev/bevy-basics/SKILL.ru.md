...
category: gamedev
tags: [bevy-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bevy-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Basics
...
## Ресурсы
- Оригинальный навык: gamedev/bevy-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
