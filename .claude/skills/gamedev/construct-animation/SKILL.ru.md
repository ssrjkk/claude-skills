...
version: "1.0"
language: ru
original: construct-animation
---

# Construct Animation

> Animation with Construct. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
