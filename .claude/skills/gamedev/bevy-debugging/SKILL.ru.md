...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/bevy-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
