...
version: "1.0"
language: ru
original: construct-multiplayer
---

# Construct Multiplayer

> Multiplayer with Construct. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
