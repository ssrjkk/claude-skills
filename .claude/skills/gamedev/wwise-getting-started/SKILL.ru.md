...
version: "1.0"
language: ru
original: wwise-getting-started
---

# Wwise Getting Started

> Getting Started for Wwise: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: wwise-getting-started.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Wwise Getting Started
...
## Ресурсы
- gamedev/wwise-getting-started/SKILL.md
- Категория: Геймдев
