...
category: gamedev
tags: [defold-audio, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: defold-audio
---

# Defold Audio

> Audio with Defold. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
