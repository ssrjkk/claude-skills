...
## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/phaser-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
