...
version: "1.0"
language: ru
original: defold-publishing
---

# Defold Publishing

> Publishing with Defold. publishing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
