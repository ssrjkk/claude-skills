...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/defold-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
