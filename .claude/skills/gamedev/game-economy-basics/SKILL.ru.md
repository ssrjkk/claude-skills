...
version: "1.0"
language: ru
original: game-economy-basics
---

# Game Economy Basics

> Basics with Game Economy. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-economy-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Economy Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/game-economy-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
