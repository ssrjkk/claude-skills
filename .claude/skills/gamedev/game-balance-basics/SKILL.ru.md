...
version: "1.0"
language: ru
original: game-balance-basics
---

# Game Balance Basics

> Basics with Game Balance. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-balance-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Balance Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/game-balance-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
