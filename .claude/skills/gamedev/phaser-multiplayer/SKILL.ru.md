...
category: gamedev
tags: [phaser-multiplayer, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: phaser-multiplayer
---

# Phaser Multiplayer

> Multiplayer with Phaser. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
