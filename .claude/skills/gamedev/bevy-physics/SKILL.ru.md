...
version: "1.0"
language: ru
original: bevy-physics
---

# Bevy Physics

> Physics with Bevy. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
