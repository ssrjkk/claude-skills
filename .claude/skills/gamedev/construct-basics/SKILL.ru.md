...
category: gamedev
tags: [construct-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: construct-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Basics
...
## Ресурсы
- Оригинальный навык: gamedev/construct-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
