...
## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/unity-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
