...
version: "1.0"
language: ru
original: defold-scripting
---

# Defold Scripting

> Scripting with Defold. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
