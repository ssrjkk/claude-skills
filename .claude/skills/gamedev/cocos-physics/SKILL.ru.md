...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
