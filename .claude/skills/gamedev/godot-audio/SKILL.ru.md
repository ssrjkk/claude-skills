...
version: "1.0"
language: ru
original: godot-audio
---

# Godot Audio

> Audio with Godot. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
