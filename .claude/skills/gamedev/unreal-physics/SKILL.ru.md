...
category: gamedev
tags: [unreal-physics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unreal-physics
---

# Unreal Physics

> Physics with Unreal Engine. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unreal Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/unreal-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
