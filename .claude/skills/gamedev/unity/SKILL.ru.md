...
> Develops games on Unity using C# scripts and component architecture. Use for 2D/3D games across multiple platforms.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity
...
## Ресурсы
- Оригинальный навык: `gamedev/unity/SKILL.md`
- Категория: Геймдев
- Язык: Русский
