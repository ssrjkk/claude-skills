...
version: "1.0"
language: ru
original: bevy-animation
---

# Bevy Animation

> Animation with Bevy. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
