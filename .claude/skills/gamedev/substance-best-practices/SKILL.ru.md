...
version: "1.0"
language: ru
original: substance-best-practices
---

# Substance Best Practices

> Best Practices for Substance: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: substance-best-practices.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Substance Best Practices
...
## Ресурсы
- gamedev/substance-best-practices/SKILL.md
- Категория: Геймдев
