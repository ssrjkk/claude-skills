...
## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-testing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Testing
...
## Ресурсы
- Оригинальный навык: gamedev/phaser-testing/SKILL.md
- Категория: Геймдев
- Язык: Русский
