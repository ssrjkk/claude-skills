...
version: "1.0"
language: ru
original: game-maker-ui
---

# Game Maker Ui

> UI with GameMaker. game UI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-ui`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Ui
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-ui/SKILL.md`
- Категория: Геймдев
- Язык: Русский
