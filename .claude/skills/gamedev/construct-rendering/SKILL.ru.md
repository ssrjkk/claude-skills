...
version: "1.0"
language: ru
original: construct-rendering
---

# Construct Rendering

> Rendering with Construct. graphics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-rendering`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Rendering
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-rendering/SKILL.md`
- Категория: Геймдев
- Язык: Русский
