...
## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Basics
...
## Ресурсы
- Оригинальный навык: gamedev/unity-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
