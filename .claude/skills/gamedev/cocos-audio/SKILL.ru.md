...
category: gamedev
tags: [cocos-audio, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-audio
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
