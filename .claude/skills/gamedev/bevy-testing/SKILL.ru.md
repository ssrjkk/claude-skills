...
## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-testing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Testing
...
## Ресурсы
- Оригинальный навык: gamedev/bevy-testing/SKILL.md
- Категория: Геймдев
- Язык: Русский
