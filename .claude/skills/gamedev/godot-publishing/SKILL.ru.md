...
version: "1.0"
language: ru
original: godot-publishing
---

# Godot Publishing

> Publishing with Godot. publishing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
