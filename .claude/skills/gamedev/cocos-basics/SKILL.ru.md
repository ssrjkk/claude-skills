...
category: gamedev
tags: [cocos-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Basics
...
## Ресурсы
- Оригинальный навык: gamedev/cocos-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
