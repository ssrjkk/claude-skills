...
version: "1.0"
language: ru
original: phaser-setup
---

# Phaser Setup

> Setup with Phaser. engine setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
