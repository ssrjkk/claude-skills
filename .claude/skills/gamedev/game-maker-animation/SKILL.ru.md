...
version: "1.0"
language: ru
original: game-maker-animation
---

# Game Maker Animation

> Animation with GameMaker. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
