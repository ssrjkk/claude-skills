...
version: "1.0"
language: ru
original: substance-configuration
---

# Substance Configuration

> Configuration for Substance: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: substance-configuration.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Substance Configuration
...
## Ресурсы
- gamedev/substance-configuration/SKILL.md
- Категория: Геймдев
