...
category: gamedev
tags: [godot-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: godot-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Basics
...
## Ресурсы
- Оригинальный навык: gamedev/godot-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
