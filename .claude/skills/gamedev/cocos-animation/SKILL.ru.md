...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
