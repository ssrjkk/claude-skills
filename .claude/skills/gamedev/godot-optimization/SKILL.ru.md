...
version: "1.0"
language: ru
original: godot-optimization
---

# Godot Optimization

> Optimization with Godot. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
