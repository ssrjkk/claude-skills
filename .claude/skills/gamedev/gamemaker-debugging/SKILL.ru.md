...
category: gamedev
tags: [gamemaker-debugging, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gamemaker-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gamemaker-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Gamemaker Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/gamemaker-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
