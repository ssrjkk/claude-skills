...
category: gamedev
tags: [game-maker-publishing, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: game-maker-publishing
---

# Game Maker Publishing

> Publishing with GameMaker. publishing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
