...
version: "1.0"
language: ru
original: unity-audio
---

# Unity Audio

> Audio with Unity. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
