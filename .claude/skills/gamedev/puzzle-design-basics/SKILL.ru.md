...
version: "1.0"
language: ru
original: puzzle-design-basics
---

# Puzzle Design Basics

> Basics with Puzzle Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puzzle-design-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Puzzle Design Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/puzzle-design-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
