...
version: "1.0"
language: ru
original: construct-ui
---

# Construct Ui

> UI with Construct. game UI.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-ui`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Ui
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-ui/SKILL.md`
- Категория: Геймдев
- Язык: Русский
