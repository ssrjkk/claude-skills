...
version: "1.0"
language: ru
original: unity-animation
---

# Unity Animation

> Animation with Unity. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
