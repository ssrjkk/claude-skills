...
version: "1.0"
language: ru
original: unreal-scripting
---

# Unreal Scripting

> Scripting with Unreal Engine. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unreal Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/unreal-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
