...
category: gamedev
tags: [cocos-multiplayer, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-multiplayer
---

# Cocos Multiplayer

> Multiplayer with Cocos Creator. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
