...
version: "1.0"
language: ru
original: bolt-quickstart
---

# Bolt Quickstart

> Quickstart for Bolt: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `bolt-quickstart`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bolt Quickstart
...
## Ресурсы
- Оригинал: gamedev/bolt-quickstart/SKILL.md
- Категория: Геймдев
