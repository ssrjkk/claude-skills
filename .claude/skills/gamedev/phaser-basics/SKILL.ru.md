...
## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Basics
...
## Ресурсы
- Оригинальный навык: gamedev/phaser-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
