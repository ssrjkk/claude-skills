...
## Быстрый старт
Этот навык на русском языке. Оригинал: `rpgmaker-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rpgmaker Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/rpgmaker-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
