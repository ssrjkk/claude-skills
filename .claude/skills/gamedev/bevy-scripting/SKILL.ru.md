...
version: "1.0"
language: ru
original: bevy-scripting
---

# Bevy Scripting

> Scripting with Bevy. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
