...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-advanced`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Advanced
...
## Ресурсы
- Оригинальный навык: gamedev/cocos-advanced/SKILL.md
- Категория: Геймдев
- Язык: Русский
