...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-monitoring`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Monitoring
...
## Ресурсы
- Оригинальный навык: gamedev/defold-monitoring/SKILL.md
- Категория: Геймдев
- Язык: Русский
