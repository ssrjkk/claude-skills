...
category: gamedev
tags: [defold-api, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: defold-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-api`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Api
...
## Ресурсы
- Оригинальный навык: gamedev/defold-api/SKILL.md
- Категория: Геймдев
- Язык: Русский
