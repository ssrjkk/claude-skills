...
category: gamedev
tags: [cocos-testing, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-testing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Testing
...
## Ресурсы
- Оригинальный навык: gamedev/cocos-testing/SKILL.md
- Категория: Геймдев
- Язык: Русский
