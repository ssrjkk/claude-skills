...
version: "1.0"
language: ru
original: maya-best-practices
---

# Maya Best Practices

> Best Practices for Maya: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: maya-best-practices.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Maya Best Practices
...
## Ресурсы
- gamedev/maya-best-practices/SKILL.md
- Категория: Геймдев
