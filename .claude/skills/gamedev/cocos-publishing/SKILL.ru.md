...
category: gamedev
tags: [cocos-publishing, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-publishing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
