...
category: gamedev
tags: [cocos-scripting, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-scripting
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
