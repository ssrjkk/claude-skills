...
version: "1.0"
language: ru
original: pro-builder-fundamentals
---

# Pro Builder Fundamentals

> Fundamentals for Pro-Builder: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `pro-builder-fundamentals`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Pro Builder Fundamentals
...
## Ресурсы
- Оригинал: gamedev/pro-builder-fundamentals/SKILL.md
- Категория: Геймдев
