...
version: "1.0"
language: ru
original: game-maker-audio
---

# Game Maker Audio

> Audio with GameMaker. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
