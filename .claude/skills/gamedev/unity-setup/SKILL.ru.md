...
version: "1.0"
language: ru
original: unity-setup
---

# Unity Setup

> Setup with Unity. engine setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
