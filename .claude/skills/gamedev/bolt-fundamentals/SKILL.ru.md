...
version: "1.0"
language: ru
original: bolt-fundamentals
---

# Bolt Fundamentals

> Fundamentals for Bolt: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `bolt-fundamentals`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bolt Fundamentals
...
## Ресурсы
- Оригинал: gamedev/bolt-fundamentals/SKILL.md
- Категория: Геймдев
