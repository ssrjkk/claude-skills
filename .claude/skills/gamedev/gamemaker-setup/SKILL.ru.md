...
category: gamedev
tags: [gamemaker-setup, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gamemaker-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gamemaker-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Gamemaker Setup
...
## Ресурсы
- Оригинальный навык: gamedev/gamemaker-setup/SKILL.md
- Категория: Геймдев
- Язык: Русский
