...
version: "1.0"
language: ru
original: zbrush-automation
---

# Zbrush Automation

> Automation for Zbrush: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: zbrush-automation.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Zbrush Automation
...
## Ресурсы
- gamedev/zbrush-automation/SKILL.md
- Категория: Геймдев
