...
version: "1.0"
language: ru
original: narrative-player-feedback
---

# Narrative Player Feedback

> Feedback with Narrative Design. player feedback.

## Быстрый старт
Этот навык на русском языке. Оригинал: `narrative-player-feedback`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Narrative Player Feedback
...
## Ресурсы
- Оригинальный навык: `gamedev/narrative-player-feedback/SKILL.md`
- Категория: Геймдев
- Язык: Русский
