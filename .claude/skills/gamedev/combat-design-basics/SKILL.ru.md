...
version: "1.0"
language: ru
original: combat-design-basics
---

# Combat Design Basics

> Basics with Combat Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `combat-design-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Combat Design Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/combat-design-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
