...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-testing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Testing
...
## Ресурсы
- Оригинальный навык: gamedev/defold-testing/SKILL.md
- Категория: Геймдев
- Язык: Русский
