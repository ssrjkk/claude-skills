...
> Creates 3D models, animations, and scenes in Blender using Python scripting and the bpy module.

## Быстрый старт
Этот навык на русском языке. Оригинал: `blender`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Blender
...
## Ресурсы
- Оригинальный навык: `gamedev/blender/SKILL.md`
- Категория: Геймдев
- Язык: Русский
