...
version: "1.0"
language: ru
original: open-world-planning
---

# Open World Planning

> Planning with Open World Design. planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `open-world-planning`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Open World Planning
...
## Ресурсы
- Оригинальный навык: `gamedev/open-world-planning/SKILL.md`
- Категория: Геймдев
- Язык: Русский
