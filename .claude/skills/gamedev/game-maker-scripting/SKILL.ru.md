...
## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
