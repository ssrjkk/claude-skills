...
version: "1.0"
language: ru
original: godot-setup
---

# Godot Setup

> Setup with Godot. engine setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
