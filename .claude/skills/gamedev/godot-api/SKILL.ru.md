...
category: gamedev
tags: [godot-api, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: godot-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-api`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Api
...
## Ресурсы
- Оригинальный навык: gamedev/godot-api/SKILL.md
- Категория: Геймдев
- Язык: Русский
