...
version: "1.0"
language: ru
original: fmod-automation
---

# Fmod Automation

> Automation for Fmod: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: fmod-automation.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Fmod Automation
...
## Ресурсы
- gamedev/fmod-automation/SKILL.md
- Категория: Геймдев
