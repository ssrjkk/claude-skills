...
category: gamedev
tags: [open-world-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: open-world-basics
---

# Open World Basics

> Basics with Open World Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `open-world-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Open World Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/open-world-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
