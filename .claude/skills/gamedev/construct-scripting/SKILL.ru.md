...
version: "1.0"
language: ru
original: construct-scripting
---

# Construct Scripting

> Scripting with Construct. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
