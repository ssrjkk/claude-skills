...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gamemaker-api`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Gamemaker Api
...
## Ресурсы
- Оригинальный навык: gamedev/gamemaker-api/SKILL.md
- Категория: Геймдев
- Язык: Русский
