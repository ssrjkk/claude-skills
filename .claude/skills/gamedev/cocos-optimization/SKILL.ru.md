...
category: gamedev
tags: [cocos-optimization, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cocos-optimization
---

# Cocos Optimization

> Optimization with Cocos Creator. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/cocos-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
