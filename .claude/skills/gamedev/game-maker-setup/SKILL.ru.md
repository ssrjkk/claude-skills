...
## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
