...
version: "1.0"
language: ru
original: microsplat-examples
---

# Microsplat Examples

> Examples for Microsplat: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `microsplat-examples`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Microsplat Examples
...
## Ресурсы
- Оригинал: gamedev/microsplat-examples/SKILL.md
- Категория: Геймдев
