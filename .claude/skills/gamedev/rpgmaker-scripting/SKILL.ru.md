...
category: gamedev
tags: [rpgmaker-scripting, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rpgmaker-scripting
---

# Rpgmaker Scripting

> Scripting with RPG Maker. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rpgmaker-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rpgmaker Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/rpgmaker-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
