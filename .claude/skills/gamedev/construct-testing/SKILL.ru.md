...
## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-testing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Testing
...
## Ресурсы
- Оригинальный навык: gamedev/construct-testing/SKILL.md
- Категория: Геймдев
- Язык: Русский
