...
version: "1.0"
language: ru
original: phaser-scripting
---

# Phaser Scripting

> Scripting with Phaser. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
