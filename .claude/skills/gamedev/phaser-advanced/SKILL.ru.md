...
category: gamedev
tags: [phaser-advanced, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: phaser-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-advanced`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Advanced
...
## Ресурсы
- Оригинальный навык: gamedev/phaser-advanced/SKILL.md
- Категория: Геймдев
- Язык: Русский
