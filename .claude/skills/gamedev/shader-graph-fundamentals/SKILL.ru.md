...
category: gamedev
tags: [shader-graph-fundamentals, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: shader-graph-fundamentals
---

# Shader Graph Fundamentals

> Fundamentals for Shader-Graph: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `shader-graph-fundamentals`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Shader Graph Fundamentals
...
## Ресурсы
- Оригинал: gamedev/shader-graph-fundamentals/SKILL.md
- Категория: Геймдев
