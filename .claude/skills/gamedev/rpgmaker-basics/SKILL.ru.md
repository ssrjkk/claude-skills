...
## Быстрый старт
Этот навык на русском языке. Оригинал: `rpgmaker-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rpgmaker Basics
...
## Ресурсы
- Оригинальный навык: gamedev/rpgmaker-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
