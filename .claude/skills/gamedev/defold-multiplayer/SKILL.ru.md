...
version: "1.0"
language: ru
original: defold-multiplayer
---

# Defold Multiplayer

> Multiplayer with Defold. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
