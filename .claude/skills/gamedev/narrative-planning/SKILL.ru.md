...
version: "1.0"
language: ru
original: narrative-planning
---

# Narrative Planning

> Planning with Narrative Design. planning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `narrative-planning`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Narrative Planning
...
## Ресурсы
- Оригинальный навык: `gamedev/narrative-planning/SKILL.md`
- Категория: Геймдев
- Язык: Русский
