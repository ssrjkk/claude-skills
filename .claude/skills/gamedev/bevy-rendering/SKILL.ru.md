...
version: "1.0"
language: ru
original: bevy-rendering
---

# Bevy Rendering

> Rendering with Bevy. graphics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-rendering`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Rendering
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-rendering/SKILL.md`
- Категория: Геймдев
- Язык: Русский
