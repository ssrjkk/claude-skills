...
version: "1.0"
language: ru
original: phaser-audio
---

# Phaser Audio

> Audio with Phaser. audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-audio`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Audio
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-audio/SKILL.md`
- Категория: Геймдев
- Язык: Русский
