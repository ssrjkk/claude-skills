...
version: "1.0"
language: ru
original: bevy-multiplayer
---

# Bevy Multiplayer

> Multiplayer with Bevy. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
