...
version: "1.0"
language: ru
original: phaser-optimization
---

# Phaser Optimization

> Optimization with Phaser. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-optimization`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Optimization
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-optimization/SKILL.md`
- Категория: Геймдев
- Язык: Русский
