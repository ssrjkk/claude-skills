...
category: gamedev
tags: [rokoko-guides, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rokoko-guides
---

# Rokoko Guides

> Guides for Rokoko: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `rokoko-guides`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rokoko Guides
...
## Ресурсы
- Оригинал: gamedev/rokoko-guides/SKILL.md
- Категория: Геймдев
