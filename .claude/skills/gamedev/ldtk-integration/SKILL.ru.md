...
version: "1.0"
language: ru
original: ldtk-integration
---

# Ldtk Integration

> Integration for Ldtk: integration with other tools

## Быстрый старт
Этот навык на русском языке. Оригинал: ldtk-integration.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Ldtk Integration
...
## Ресурсы
- gamedev/ldtk-integration/SKILL.md
- Категория: Геймдев
