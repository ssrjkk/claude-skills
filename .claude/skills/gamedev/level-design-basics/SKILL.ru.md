...
category: gamedev
tags: [level-design-basics, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: level-design-basics
---

# Level Design Basics

> Basics with Level Design. fundamentals.

## Быстрый старт
Этот навык на русском языке. Оригинал: `level-design-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Level Design Basics
...
## Ресурсы
- Оригинальный навык: `gamedev/level-design-basics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
