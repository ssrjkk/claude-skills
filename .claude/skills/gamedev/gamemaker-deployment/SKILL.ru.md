...
category: gamedev
tags: [gamemaker-deployment, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gamemaker-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gamemaker-deployment`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Gamemaker Deployment
...
## Ресурсы
- Оригинальный навык: gamedev/gamemaker-deployment/SKILL.md
- Категория: Геймдев
- Язык: Русский
