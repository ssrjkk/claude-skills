...
category: gamedev
tags: [game-maker-multiplayer, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: game-maker-multiplayer
---

# Game Maker Multiplayer

> Multiplayer with GameMaker. networking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `game-maker-multiplayer`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Game Maker Multiplayer
...
## Ресурсы
- Оригинальный навык: `gamedev/game-maker-multiplayer/SKILL.md`
- Категория: Геймдев
- Язык: Русский
