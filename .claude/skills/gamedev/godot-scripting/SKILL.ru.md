...
category: gamedev
tags: [godot-scripting, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: godot-scripting
---

# Godot Scripting

> Scripting with Godot. game logic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-scripting`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Scripting
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-scripting/SKILL.md`
- Категория: Геймдев
- Язык: Русский
