...
category: gamedev
tags: [defold-animation, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: defold-animation
---

# Defold Animation

> Animation with Defold. animation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-animation`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Animation
...
## Ресурсы
- Оригинальный навык: `gamedev/defold-animation/SKILL.md`
- Категория: Геймдев
- Язык: Русский
