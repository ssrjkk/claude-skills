...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cocos-debugging`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Cocos Debugging
...
## Ресурсы
- Оригинальный навык: gamedev/cocos-debugging/SKILL.md
- Категория: Геймдев
- Язык: Русский
