...
category: gamedev
tags: [construct-security, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: construct-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-security`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Security
...
## Ресурсы
- Оригинальный навык: gamedev/construct-security/SKILL.md
- Категория: Геймдев
- Язык: Русский
