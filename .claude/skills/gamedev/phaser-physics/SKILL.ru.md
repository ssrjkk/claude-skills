...
version: "1.0"
language: ru
original: phaser-physics
---

# Phaser Physics

> Physics with Phaser. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `phaser-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Phaser Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/phaser-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
