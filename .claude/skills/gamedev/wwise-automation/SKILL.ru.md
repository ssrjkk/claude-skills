...
version: "1.0"
language: ru
original: wwise-automation
---

# Wwise Automation

> Automation for Wwise: automation and scripting

## Быстрый старт
Этот навык на русском языке. Оригинал: wwise-automation.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Wwise Automation
...
## Ресурсы
- gamedev/wwise-automation/SKILL.md
- Категория: Геймдев
