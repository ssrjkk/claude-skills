...
## Быстрый старт
Этот навык на русском языке. Оригинал: `defold-basics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Defold Basics
...
## Ресурсы
- Оригинальный навык: gamedev/defold-basics/SKILL.md
- Категория: Геймдев
- Язык: Русский
