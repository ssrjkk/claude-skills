...
category: gamedev
tags: [rokoko-fundamentals, gamedev, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rokoko-fundamentals
---

# Rokoko Fundamentals

> Fundamentals for Rokoko: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `rokoko-fundamentals`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Rokoko Fundamentals
...
## Ресурсы
- Оригинал: gamedev/rokoko-fundamentals/SKILL.md
- Категория: Геймдев
