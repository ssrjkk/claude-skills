...
version: "1.0"
language: ru
original: bevy-publishing
---

# Bevy Publishing

> Publishing with Bevy. publishing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bevy-publishing`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Bevy Publishing
...
## Ресурсы
- Оригинальный навык: `gamedev/bevy-publishing/SKILL.md`
- Категория: Геймдев
- Язык: Русский
