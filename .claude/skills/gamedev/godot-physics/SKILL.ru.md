...
version: "1.0"
language: ru
original: godot-physics
---

# Godot Physics

> Physics with Godot. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `godot-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Godot Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/godot-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
