...
version: "1.0"
language: ru
original: unity-physics
---

# Unity Physics

> Physics with Unity. physics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-physics`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Unity Physics
...
## Ресурсы
- Оригинальный навык: `gamedev/unity-physics/SKILL.md`
- Категория: Геймдев
- Язык: Русский
