...
version: "1.0"
language: ru
original: level-design-player-feedback
---

# Level Design Player Feedback

> Feedback with Level Design. player feedback.

## Быстрый старт
Этот навык на русском языке. Оригинал: `level-design-player-feedback`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Level Design Player Feedback
...
## Ресурсы
- Оригинальный навык: `gamedev/level-design-player-feedback/SKILL.md`
- Категория: Геймдев
- Язык: Русский
