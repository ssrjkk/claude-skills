...
version: "1.0"
language: ru
original: construct-setup
---

# Construct Setup

> Setup with Construct. engine setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `construct-setup`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Construct Setup
...
## Ресурсы
- Оригинальный навык: `gamedev/construct-setup/SKILL.md`
- Категория: Геймдев
- Язык: Русский
