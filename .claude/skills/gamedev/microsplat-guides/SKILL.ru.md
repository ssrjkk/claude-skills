...
version: "1.0"
language: ru
original: microsplat-guides
---

# Microsplat Guides

> Guides for Microsplat: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `microsplat-guides`.

## Когда использовать
- Работа с Геймдев
- Выполнение задач, связанных с Microsplat Guides
...
## Ресурсы
- Оригинал: gamedev/microsplat-guides/SKILL.md
- Категория: Геймдев
