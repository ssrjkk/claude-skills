...
version: "1.0"
language: ru
original: calico-best-practices
---

# Calico Best Practices

> Best Practices for Calico: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: calico-best-practices.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Calico Best Practices
...
## Ресурсы
- devops/calico-best-practices/SKILL.md
- Категория: DevOps
