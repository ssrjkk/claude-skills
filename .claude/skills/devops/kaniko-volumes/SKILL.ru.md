...
version: "1.0"
language: ru
original: kaniko-volumes
---

# Kaniko Volumes

> Volumes with Kaniko. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kaniko-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kaniko Volumes
...
## Ресурсы
- Оригинальный навык: `devops/kaniko-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
