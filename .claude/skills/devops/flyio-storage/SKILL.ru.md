...
version: "1.0"
language: ru
original: flyio-storage
---

# Flyio Storage

> Storage with Fly.io. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Storage
...
## Ресурсы
- Оригинальный навык: `devops/flyio-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
