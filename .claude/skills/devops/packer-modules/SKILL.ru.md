...
category: devops
tags: [packer-modules, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: packer-modules
---

# Packer Modules

> Modules with Packer. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Modules
...
## Ресурсы
- Оригинальный навык: `devops/packer-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
