...
version: "1.0"
language: ru
original: woodpecker-testing
---

# Woodpecker Testing

> Testing with Woodpecker. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Testing
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
