...
version: "1.0"
language: ru
original: jenkins-monitoring
---

# Jenkins Monitoring

> Monitoring with Jenkins. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/jenkins-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
