...
version: "1.0"
language: ru
original: dagger-pipeline
---

# Dagger Pipeline

> Pipeline with Dagger. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagger-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dagger Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/dagger-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
