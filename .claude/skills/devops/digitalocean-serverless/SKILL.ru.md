...
version: "1.0"
language: ru
original: digitalocean-serverless
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Serverless
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
