...
version: "1.0"
language: ru
original: bamboo-secrets
---

# Bamboo Secrets

> Secrets with Bamboo. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Secrets
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
