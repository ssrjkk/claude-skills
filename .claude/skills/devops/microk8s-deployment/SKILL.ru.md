...
version: "1.0"
language: ru
original: microk8s-deployment
---

# Microk8S Deployment

> Deployment with MicroK8s. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Deployment
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
