...
version: "1.0"
language: ru
original: aws-compute
---

# Aws Compute

> Compute with AWS. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Compute
...
## Ресурсы
- Оригинальный навык: `devops/aws-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
