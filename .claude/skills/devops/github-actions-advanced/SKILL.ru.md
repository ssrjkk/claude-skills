...
category: devops
tags: [github-actions-advanced, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: github-actions-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Advanced
...
## Ресурсы
- Оригинальный навык: devops/github-actions-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
