...
category: devops
tags: [thanos-dashboards, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: thanos-dashboards
---

# Thanos Dashboards

> Dashboards with Thanos. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/thanos-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
