...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Optimization
...
## Ресурсы
- Оригинальный навык: devops/ansible-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
