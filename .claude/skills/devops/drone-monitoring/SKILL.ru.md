...
version: "1.0"
language: ru
original: drone-monitoring
---

# Drone Monitoring

> Monitoring with Drone CI. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/drone-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
