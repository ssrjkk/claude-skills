...
category: devops
tags: [opentelemetry-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opentelemetry-metrics
---

# Opentelemetry Metrics

> Metrics with OpenTelemetry. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Metrics
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
