...
version: "1.0"
language: ru
original: containerd-volumes
---

# Containerd Volumes

> Volumes with containerd. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Volumes
...
## Ресурсы
- Оригинальный навык: `devops/containerd-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
