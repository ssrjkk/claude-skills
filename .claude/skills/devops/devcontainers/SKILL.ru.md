...
version: "1.0"
language: ru
original: devcontainers
---

# Devcontainers

> Development containers with Dev Container spec

## Быстрый старт
Этот навык на русском языке. Оригинал: `devcontainers`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Devcontainers
...
## Ресурсы
- Оригинальный навык: `devops/devcontainers/SKILL.md`
- Категория: DevOps
- Язык: Русский
