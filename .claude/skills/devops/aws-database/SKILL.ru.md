...
version: "1.0"
language: ru
original: aws-database
---

# Aws Database

> Database with AWS. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Database
...
## Ресурсы
- Оригинальный навык: `devops/aws-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
