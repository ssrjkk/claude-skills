...
version: "1.0"
language: ru
original: tempo-alerts
---

# Tempo Alerts

> Alerts with Tempo. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Alerts
...
## Ресурсы
- Оригинальный навык: `devops/tempo-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
