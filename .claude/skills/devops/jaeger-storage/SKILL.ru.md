...
version: "1.0"
language: ru
original: jaeger-storage
---

# Jaeger Storage

> Storage with Jaeger. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Storage
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
