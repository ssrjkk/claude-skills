...
version: "1.0"
language: ru
original: opentofu-networking
---

# Opentofu Networking

> Networking with OpenTofu. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Networking
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
