...
version: "1.0"
language: ru
original: jsonnet-examples
---

# Jsonnet Examples

> Examples for Jsonnet: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `jsonnet-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jsonnet Examples
...
## Ресурсы
- Оригинал: devops/jsonnet-examples/SKILL.md
- Категория: DevOps
