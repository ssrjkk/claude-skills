...
category: devops
tags: [kubernetes-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Security
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-security/SKILL.md
- Категория: DevOps
- Язык: Русский
