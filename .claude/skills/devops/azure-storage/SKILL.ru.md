...
version: "1.0"
language: ru
original: azure-storage
---

# Azure Storage

> Storage with Azure. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Storage
...
## Ресурсы
- Оригинальный навык: `devops/azure-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
