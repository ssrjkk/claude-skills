...
category: devops
tags: [saltstack-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saltstack-cicd
---

# Saltstack Cicd

> CI/CD with SaltStack. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack Cicd
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
