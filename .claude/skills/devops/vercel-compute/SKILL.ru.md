...
version: "1.0"
language: ru
original: vercel-compute
---

# Vercel Compute

> Compute with Vercel. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vercel-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vercel Compute
...
## Ресурсы
- Оригинальный навык: `devops/vercel-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
