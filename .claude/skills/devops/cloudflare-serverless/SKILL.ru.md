...
version: "1.0"
language: ru
original: cloudflare-serverless
---

# Cloudflare Serverless

> Serverless with Cloudflare. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudflare-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudflare Serverless
...
## Ресурсы
- Оригинальный навык: `devops/cloudflare-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
