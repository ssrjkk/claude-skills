...
version: "1.0"
language: ru
original: circleci-pipeline
---

# Circleci Pipeline

> Pipeline with CircleCI. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circleci-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Circleci Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/circleci-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
