...
version: "1.0"
language: ru
original: tempo-storage
---

# Tempo Storage

> Storage with Tempo. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Storage
...
## Ресурсы
- Оригинальный навык: `devops/tempo-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
