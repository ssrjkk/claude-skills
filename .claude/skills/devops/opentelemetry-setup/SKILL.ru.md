...
category: devops
tags: [opentelemetry-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opentelemetry-setup
---

# Opentelemetry Setup

> Setup with OpenTelemetry. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Setup
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
