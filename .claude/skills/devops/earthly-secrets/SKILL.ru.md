...
version: "1.0"
language: ru
original: earthly-secrets
---

# Earthly Secrets

> Secrets with Earthly. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Secrets
...
## Ресурсы
- Оригинальный навык: `devops/earthly-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
