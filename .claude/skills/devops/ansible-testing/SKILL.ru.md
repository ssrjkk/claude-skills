...
version: "1.0"
language: ru
original: ansible-testing
---

# Ansible Testing

> Testing with Ansible. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Testing
...
## Ресурсы
- Оригинальный навык: `devops/ansible-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
