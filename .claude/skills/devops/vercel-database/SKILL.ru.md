...
version: "1.0"
language: ru
original: vercel-database
---

# Vercel Database

> Database with Vercel. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vercel-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vercel Database
...
## Ресурсы
- Оригинальный навык: `devops/vercel-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
