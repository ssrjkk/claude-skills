...
version: "1.0"
language: ru
original: buildkite-secrets
---

# Buildkite Secrets

> Secrets with Buildkite. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildkite-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildkite Secrets
...
## Ресурсы
- Оригинальный навык: `devops/buildkite-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
