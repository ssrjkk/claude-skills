...
version: "1.0"
language: ru
original: opentelemetry-scraping
---

# Opentelemetry Scraping

> Scraping with OpenTelemetry. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Scraping
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
