...
version: "1.0"
language: ru
original: lxc-security
---

# Lxc Security

> Security with LXC. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Security
...
## Ресурсы
- Оригинальный навык: `devops/lxc-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
