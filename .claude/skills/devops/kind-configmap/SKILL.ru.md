...
category: devops
tags: [kind-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> ConfigMap with Kind. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Configmap
...
## Ресурсы
- Оригинальный навык: `devops/kind-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
