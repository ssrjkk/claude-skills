...
category: devops
tags: [opentofu-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opentofu-security
---

# Opentofu Security

> Security with OpenTofu. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Security
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
