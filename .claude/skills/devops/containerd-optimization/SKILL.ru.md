...
category: devops
tags: [containerd-optimization, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: containerd-optimization
---

# Containerd Optimization

> Optimization with containerd. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Optimization
...
## Ресурсы
- Оригинальный навык: `devops/containerd-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
