...
version: "1.0"
language: ru
original: heroku-database
---

# Heroku Database

> Database with Heroku. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heroku-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Heroku Database
...
## Ресурсы
- Оригинальный навык: `devops/heroku-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
