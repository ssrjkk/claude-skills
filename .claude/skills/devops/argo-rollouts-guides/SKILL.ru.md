...
version: "1.0"
language: ru
original: argo-rollouts-guides
---

# Argo Rollouts Guides

> Guides for Argo-Rollouts: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-rollouts-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Rollouts Guides
...
## Ресурсы
- Оригинал: devops/argo-rollouts-guides/SKILL.md
- Категория: DevOps
