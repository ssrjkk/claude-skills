...
category: devops
tags: [skopeo-images, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: skopeo-images
---

# Skopeo Images

> Images with Skopeo. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Images
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
