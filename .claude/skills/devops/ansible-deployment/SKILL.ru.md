...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Deployment
...
## Ресурсы
- Оригинальный навык: devops/ansible-deployment/SKILL.md
- Категория: DevOps
- Язык: Русский
