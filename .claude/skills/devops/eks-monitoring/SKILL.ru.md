...
category: devops
tags: [eks-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eks-monitoring
---

# Eks Monitoring

> Monitoring with Amazon EKS. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/eks-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
