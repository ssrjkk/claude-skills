...
category: devops
tags: [tekton-examples, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tekton-examples
---

# Tekton Examples

> Examples for Tekton: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tekton-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tekton Examples
...
## Ресурсы
- Оригинал: devops/tekton-examples/SKILL.md
- Категория: DevOps
