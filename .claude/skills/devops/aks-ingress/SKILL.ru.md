...
category: devops
tags: [aks-ingress, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aks-ingress
---

# Aks Ingress

> Ingress with Azure AKS. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Ingress
...
## Ресурсы
- Оригинальный навык: `devops/aks-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
