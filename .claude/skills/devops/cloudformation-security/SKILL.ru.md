...
category: devops
tags: [cloudformation-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cloudformation-security
---

# Cloudformation Security

> Security with CloudFormation. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudformation-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudformation Security
...
## Ресурсы
- Оригинальный навык: `devops/cloudformation-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
