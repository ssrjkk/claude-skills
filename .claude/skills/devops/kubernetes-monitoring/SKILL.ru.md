...
category: devops
tags: [kubernetes-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-monitoring
---

# Kubernetes Monitoring

> Monitoring with Kubernetes. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
