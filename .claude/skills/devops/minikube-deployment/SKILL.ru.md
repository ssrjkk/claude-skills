...
version: "1.0"
language: ru
original: minikube-deployment
---

# Minikube Deployment

> Deployment with Minikube. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Deployment
...
## Ресурсы
- Оригинальный навык: `devops/minikube-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
