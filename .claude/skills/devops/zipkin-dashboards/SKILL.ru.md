...
category: devops
tags: [zipkin-dashboards, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zipkin-dashboards
---

# Zipkin Dashboards

> Dashboards with Zipkin. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
