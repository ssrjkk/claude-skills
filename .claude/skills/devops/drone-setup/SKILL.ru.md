...
> Setup with Drone CI. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Setup
...
## Ресурсы
- Оригинальный навык: `devops/drone-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
