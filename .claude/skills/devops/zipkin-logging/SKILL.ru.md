...
version: "1.0"
language: ru
original: zipkin-logging
---

# Zipkin Logging

> Logging with Zipkin. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Logging
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
