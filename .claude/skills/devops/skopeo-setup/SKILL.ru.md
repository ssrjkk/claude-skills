...
version: "1.0"
language: ru
original: skopeo-setup
---

# Skopeo Setup

> Setup with Skopeo. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Setup
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
