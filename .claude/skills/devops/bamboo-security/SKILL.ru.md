...
category: devops
tags: [bamboo-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: bamboo-security
---

# Bamboo Security

> Security with Bamboo. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Security
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
