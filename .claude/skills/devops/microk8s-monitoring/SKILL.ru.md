...
category: devops
tags: [microk8s-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: microk8s-monitoring
---

# Microk8S Monitoring

> Monitoring with MicroK8s. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
