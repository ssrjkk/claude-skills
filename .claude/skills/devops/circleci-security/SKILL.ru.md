...
version: "1.0"
language: ru
original: circleci-security
---

# Circleci Security

> Security with CircleCI. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circleci-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Circleci Security
...
## Ресурсы
- Оригинальный навык: `devops/circleci-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
