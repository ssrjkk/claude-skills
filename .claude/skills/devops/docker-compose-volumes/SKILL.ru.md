...
version: "1.0"
language: ru
original: docker-compose-volumes
---

# Docker Compose Volumes

> Volumes with Docker Compose. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-compose-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Compose Volumes
...
## Ресурсы
- Оригинальный навык: `devops/docker-compose-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
