...
version: "1.0"
language: ru
original: fastly-networking
---

# Fastly Networking

> Networking with Fastly. VPC.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Networking
...
## Ресурсы
- Оригинальный навык: `devops/fastly-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
