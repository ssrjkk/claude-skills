...
version: "1.0"
language: ru
original: singularity-optimization
---

# Singularity Optimization

> Optimization with Singularity. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Optimization
...
## Ресурсы
- Оригинальный навык: `devops/singularity-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
