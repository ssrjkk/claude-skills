...
version: "1.0"
language: ru
original: akamai-compute
---

# Akamai Compute

> Compute with Akamai. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Compute
...
## Ресурсы
- Оригинальный навык: `devops/akamai-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
