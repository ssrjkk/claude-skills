...
category: devops
tags: [puppet-networking, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppet-networking
---

# Puppet Networking

> Networking with Puppet. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Networking
...
## Ресурсы
- Оригинальный навык: `devops/puppet-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
