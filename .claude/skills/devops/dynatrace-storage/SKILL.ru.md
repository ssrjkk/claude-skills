...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynatrace-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dynatrace Storage
...
## Ресурсы
- Оригинальный навык: `devops/dynatrace-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
