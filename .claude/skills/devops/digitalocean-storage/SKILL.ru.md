...
version: "1.0"
language: ru
original: digitalocean-storage
---

# Digitalocean Storage

> Storage with DigitalOcean. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Storage
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
