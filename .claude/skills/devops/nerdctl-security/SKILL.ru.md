...
version: "1.0"
language: ru
original: nerdctl-security
---

# Nerdctl Security

> Security with nerdctl. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Security
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
