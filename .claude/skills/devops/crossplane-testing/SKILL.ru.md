...
version: "1.0"
language: ru
original: crossplane-testing
---

# Crossplane Testing

> Testing with Crossplane. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane Testing
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
