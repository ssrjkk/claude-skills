...
version: "1.0"
language: ru
original: singularity-networking
---

# Singularity Networking

> Networking with Singularity. container networks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Networking
...
## Ресурсы
- Оригинальный навык: `devops/singularity-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
