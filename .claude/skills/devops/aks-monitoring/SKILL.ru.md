...
category: devops
tags: [aks-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aks-monitoring
---

# Aks Monitoring

> Monitoring with Azure AKS. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/aks-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
