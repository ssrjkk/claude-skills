...
version: "1.0"
language: ru
original: puppet-testing
---

# Puppet Testing

> Testing with Puppet. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Testing
...
## Ресурсы
- Оригинальный навык: `devops/puppet-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
