...
version: "1.0"
language: ru
original: akamai-serverless
---

# Akamai Serverless

> Serverless with Akamai. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Serverless
...
## Ресурсы
- Оригинальный навык: `devops/akamai-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
