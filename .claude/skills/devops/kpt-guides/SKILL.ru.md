...
category: devops
tags: [kpt-guides, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kpt-guides
...
> Guides for Kpt: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kpt-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kpt Guides
...
## Ресурсы
- Оригинал: devops/kpt-guides/SKILL.md
- Категория: DevOps
