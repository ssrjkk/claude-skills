...
version: "1.0"
language: ru
original: kpt-fundamentals
---

# Kpt Fundamentals

> Fundamentals for Kpt: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kpt-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kpt Fundamentals
...
## Ресурсы
- Оригинал: devops/kpt-fundamentals/SKILL.md
- Категория: DevOps
