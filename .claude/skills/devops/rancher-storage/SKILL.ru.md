...
version: "1.0"
language: ru
original: rancher-storage
---

# Rancher Storage

> Storage with Rancher. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Storage
...
## Ресурсы
- Оригинальный навык: `devops/rancher-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
