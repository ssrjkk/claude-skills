...
version: "1.0"
language: ru
original: nerdctl-images
---

# Nerdctl Images

> Images with nerdctl. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Images
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
