...
version: "1.0"
language: ru
original: rancher-deployment
---

# Rancher Deployment

> Deployment with Rancher. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Deployment
...
## Ресурсы
- Оригинальный навык: `devops/rancher-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
