...
version: "1.0"
language: ru
original: buildkite-security
---

# Buildkite Security

> Security with Buildkite. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildkite-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildkite Security
...
## Ресурсы
- Оригинальный навык: `devops/buildkite-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
