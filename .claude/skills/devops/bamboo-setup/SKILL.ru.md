...
version: "1.0"
language: ru
original: bamboo-setup
---

# Bamboo Setup

> Setup with Bamboo. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Setup
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
