...
version: "1.0"
language: ru
original: elastic-logging
---

# Elastic Logging

> Logging with Elastic Stack. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elastic-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Elastic Logging
...
## Ресурсы
- Оригинальный навык: `devops/elastic-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
