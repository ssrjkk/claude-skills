...
version: "1.0"
language: ru
original: tekton-quickstart
---

# Tekton Quickstart

> Quickstart for Tekton: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tekton-quickstart`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tekton Quickstart
...
## Ресурсы
- Оригинал: devops/tekton-quickstart/SKILL.md
- Категория: DevOps
