...
category: devops
tags: [kubernetes-api, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Api
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-api/SKILL.md
- Категория: DevOps
- Язык: Русский
