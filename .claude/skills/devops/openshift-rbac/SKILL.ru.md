...
version: "1.0"
language: ru
original: openshift-rbac
---

# Openshift Rbac

> RBAC with OpenShift. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Rbac
...
## Ресурсы
- Оригинальный навык: `devops/openshift-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
