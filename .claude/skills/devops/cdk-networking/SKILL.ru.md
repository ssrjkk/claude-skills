...
version: "1.0"
language: ru
original: cdk-networking
---

# Cdk Networking

> Networking with AWS CDK. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk Networking
...
## Ресурсы
- Оригинальный навык: `devops/cdk-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
