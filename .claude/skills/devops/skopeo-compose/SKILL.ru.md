...
version: "1.0"
language: ru
original: skopeo-compose
---

# Skopeo Compose

> Compose with Skopeo. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Compose
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
