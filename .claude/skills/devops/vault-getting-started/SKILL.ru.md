...
version: "1.0"
language: ru
original: vault-getting-started
---

# Vault Getting Started

> Getting Started for Vault: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: vault-getting-started.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vault Getting Started
...
## Ресурсы
- devops/vault-getting-started/SKILL.md
- Категория: DevOps
