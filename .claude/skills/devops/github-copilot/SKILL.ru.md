...
category: devops
tags: [github-copilot, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> GitHub Copilot setup and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `github-copilot`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Copilot
...
## Ресурсы
- Оригинальный навык: `devops/github-copilot/SKILL.md`
- Категория: DevOps
- Язык: Русский
