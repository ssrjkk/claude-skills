...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Advanced
...
## Ресурсы
- Оригинальный навык: devops/prometheus-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
