...
version: "1.0"
language: ru
original: newrelic-logging
---

# Newrelic Logging

> Logging with New Relic. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Logging
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
