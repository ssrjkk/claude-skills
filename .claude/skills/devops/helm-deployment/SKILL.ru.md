...
## Быстрый старт
Этот навык на русском языке. Оригинал: `helm-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Helm Deployment
...
## Ресурсы
- Оригинальный навык: devops/helm-deployment/SKILL.md
- Категория: DevOps
- Язык: Русский
