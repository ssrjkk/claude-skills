...
## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Monitoring
...
## Ресурсы
- Оригинальный навык: devops/grafana-monitoring/SKILL.md
- Категория: DevOps
- Язык: Русский
