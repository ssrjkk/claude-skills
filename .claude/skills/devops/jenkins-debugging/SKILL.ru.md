...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-debugging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Debugging
...
## Ресурсы
- Оригинальный навык: devops/jenkins-debugging/SKILL.md
- Категория: DevOps
- Язык: Русский
