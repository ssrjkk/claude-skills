...
version: "1.0"
language: ru
original: containerd-images
---

# Containerd Images

> Images with containerd. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Images
...
## Ресурсы
- Оригинальный навык: `devops/containerd-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
