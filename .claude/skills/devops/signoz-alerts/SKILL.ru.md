...
category: devops
tags: [signoz-alerts, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: signoz-alerts
---

# Signoz Alerts

> Alerts with SigNoz. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `signoz-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Signoz Alerts
...
## Ресурсы
- Оригинальный навык: `devops/signoz-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
