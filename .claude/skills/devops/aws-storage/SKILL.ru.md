...
category: devops
tags: [aws-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aws-storage
---

# Aws Storage

> Storage with AWS. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Storage
...
## Ресурсы
- Оригинальный навык: `devops/aws-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
