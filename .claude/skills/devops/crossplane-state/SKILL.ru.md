...
category: devops
tags: [crossplane-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: crossplane-state
---

# Crossplane State

> State with Crossplane. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane State
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
