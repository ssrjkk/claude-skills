...
version: "1.0"
language: ru
original: azure-pipelines-deployment
---

# Azure Pipelines Deployment

> Deployment with Azure Pipelines. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-pipelines-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Pipelines Deployment
...
## Ресурсы
- Оригинальный навык: `devops/azure-pipelines-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
