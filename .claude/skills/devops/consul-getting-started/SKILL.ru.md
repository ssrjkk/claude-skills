...
version: "1.0"
language: ru
original: consul-getting-started
---

# Consul Getting Started

> Getting Started for Consul: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: consul-getting-started.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Consul Getting Started
...
## Ресурсы
- devops/consul-getting-started/SKILL.md
- Категория: DevOps
