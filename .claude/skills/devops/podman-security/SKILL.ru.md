...
version: "1.0"
language: ru
original: podman-security
---

# Podman Security

> Security with Podman. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Security
...
## Ресурсы
- Оригинальный навык: `devops/podman-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
