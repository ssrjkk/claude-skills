...
category: devops
tags: [prometheus-api, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Api
...
## Ресурсы
- Оригинальный навык: devops/prometheus-api/SKILL.md
- Категория: DevOps
- Язык: Русский
