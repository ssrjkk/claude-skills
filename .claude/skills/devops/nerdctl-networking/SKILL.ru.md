...
version: "1.0"
language: ru
original: nerdctl-networking
---

# Nerdctl Networking

> Networking with nerdctl. container networks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Networking
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
