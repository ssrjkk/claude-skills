...
version: "1.0"
language: ru
original: openshift-ingress
---

# Openshift Ingress

> Ingress with OpenShift. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Ingress
...
## Ресурсы
- Оригинальный навык: `devops/openshift-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
