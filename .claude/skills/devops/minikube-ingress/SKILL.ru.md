...
version: "1.0"
language: ru
original: minikube-ingress
---

# Minikube Ingress

> Ingress with Minikube. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Ingress
...
## Ресурсы
- Оригинальный навык: `devops/minikube-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
