...
version: "1.0"
language: ru
original: coredns-best-practices
---

# Coredns Best Practices

> Best Practices for Coredns: best practices and patterns

## Быстрый старт
Этот навык на русском языке. Оригинал: coredns-best-practices.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Coredns Best Practices
...
## Ресурсы
- devops/coredns-best-practices/SKILL.md
- Категория: DevOps
