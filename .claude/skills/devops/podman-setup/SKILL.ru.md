...
version: "1.0"
language: ru
original: podman-setup
---

# Podman Setup

> Setup with Podman. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Setup
...
## Ресурсы
- Оригинальный навык: `devops/podman-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
