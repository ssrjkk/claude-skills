...
version: "1.0"
language: ru
original: travis-ci-caching
---

# Travis Ci Caching

> Caching with Travis CI. dependency caching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `travis-ci-caching`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Travis Ci Caching
...
## Ресурсы
- Оригинальный навык: `devops/travis-ci-caching/SKILL.md`
- Категория: DevOps
- Язык: Русский
