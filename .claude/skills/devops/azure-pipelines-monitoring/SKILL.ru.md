...
version: "1.0"
language: ru
original: azure-pipelines-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-pipelines-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Pipelines Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/azure-pipelines-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
