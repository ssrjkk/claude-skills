...
version: "1.0"
language: ru
original: travis-ci-deployment
---

# Travis Ci Deployment

> Deployment with Travis CI. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `travis-ci-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Travis Ci Deployment
...
## Ресурсы
- Оригинальный навык: `devops/travis-ci-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
