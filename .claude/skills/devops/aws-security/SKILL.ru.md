...
version: "1.0"
language: ru
original: aws-security
---

# Aws Security

> Security with AWS. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Security
...
## Ресурсы
- Оригинальный навык: `devops/aws-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
