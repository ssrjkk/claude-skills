...
> Cost with GCP. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gcp-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gcp Cost
...
## Ресурсы
- Оригинальный навык: `devops/gcp-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
