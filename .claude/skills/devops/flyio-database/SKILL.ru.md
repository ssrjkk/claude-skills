...
version: "1.0"
language: ru
original: flyio-database
---

# Flyio Database

> Database with Fly.io. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Database
...
## Ресурсы
- Оригинальный навык: `devops/flyio-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
