...
category: devops
tags: [microk8s-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: microk8s-storage
---

# Microk8S Storage

> Storage with MicroK8s. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Storage
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
