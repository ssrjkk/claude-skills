...
version: "1.0"
language: ru
original: podman-optimization
---

# Podman Optimization

> Optimization with Podman. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Optimization
...
## Ресурсы
- Оригинальный навык: `devops/podman-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
