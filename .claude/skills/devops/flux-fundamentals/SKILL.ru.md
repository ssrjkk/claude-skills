...
category: devops
tags: [flux-fundamentals, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flux-fundamentals
---

# Flux Fundamentals

> Fundamentals for Flux: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `flux-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flux Fundamentals
...
## Ресурсы
- Оригинал: devops/flux-fundamentals/SKILL.md
- Категория: DevOps
