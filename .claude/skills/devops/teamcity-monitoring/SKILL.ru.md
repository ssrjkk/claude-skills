...
version: "1.0"
language: ru
original: teamcity-monitoring
---

# Teamcity Monitoring

> Monitoring with TeamCity. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
