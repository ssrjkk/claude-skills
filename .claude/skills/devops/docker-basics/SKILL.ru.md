...
## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Basics
...
## Ресурсы
- Оригинальный навык: devops/docker-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
