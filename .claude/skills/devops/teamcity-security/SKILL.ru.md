...
version: "1.0"
language: ru
original: teamcity-security
---

# Teamcity Security

> Security with TeamCity. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Security
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
