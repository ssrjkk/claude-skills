...
category: devops
tags: [argocd-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Setup
...
## Ресурсы
- Оригинальный навык: devops/argocd-setup/SKILL.md
- Категория: DevOps
- Язык: Русский
