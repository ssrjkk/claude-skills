...
> State with AWS CDK. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk State
...
## Ресурсы
- Оригинальный навык: `devops/cdk-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
