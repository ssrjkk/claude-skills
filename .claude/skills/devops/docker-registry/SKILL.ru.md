...
category: devops
tags: [docker-registry, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Registry with Docker. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Registry
...
## Ресурсы
- Оригинальный навык: `devops/docker-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
