...
category: devops
tags: [gitlab-ci-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gitlab-ci-security
---

# Gitlab Ci Security

> Security with GitLab CI. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Security
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
