...
version: "1.0"
language: ru
original: bamboo-monitoring
---

# Bamboo Monitoring

> Monitoring with Bamboo. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
