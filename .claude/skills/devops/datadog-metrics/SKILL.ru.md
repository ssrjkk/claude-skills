...
category: devops
tags: [datadog-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: datadog-metrics
---

# Datadog Metrics

> Metrics with Datadog. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `datadog-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Datadog Metrics
...
## Ресурсы
- Оригинальный навык: `devops/datadog-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
