...
version: "1.0"
language: ru
original: grafana-storage
---

# Grafana Storage

> Storage with Grafana. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Storage
...
## Ресурсы
- Оригинальный навык: `devops/grafana-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
