...
category: devops
tags: [prometheus-optimization, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Optimization
...
## Ресурсы
- Оригинальный навык: devops/prometheus-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
