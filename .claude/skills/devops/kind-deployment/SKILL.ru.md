...
version: "1.0"
language: ru
original: kind-deployment
---

# Kind Deployment

> Deployment with Kind. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Deployment
...
## Ресурсы
- Оригинальный навык: `devops/kind-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
