...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Tracing
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
