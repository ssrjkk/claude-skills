...
version: "1.0"
language: ru
original: saltstack-setup
---

# Saltstack Setup

> Setup with SaltStack. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack Setup
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
