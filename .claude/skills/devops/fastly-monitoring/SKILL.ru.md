...
version: "1.0"
language: ru
original: fastly-monitoring
---

# Fastly Monitoring

> Monitoring with Fastly. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/fastly-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
