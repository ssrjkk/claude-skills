...
category: devops
tags: [loki-tracing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: loki-tracing
---

# Loki Tracing

> Tracing with Loki. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Tracing
...
## Ресурсы
- Оригинальный навык: `devops/loki-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
