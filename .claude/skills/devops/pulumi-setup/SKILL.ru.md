...
version: "1.0"
language: ru
original: pulumi-setup
---

# Pulumi Setup

> Setup with Pulumi. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Setup
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
