...
version: "1.0"
language: ru
original: istio-configuration
---

# Istio Configuration

> Configuration for Istio: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: istio-configuration.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Istio Configuration
...
## Ресурсы
- devops/istio-configuration/SKILL.md
- Категория: DevOps
