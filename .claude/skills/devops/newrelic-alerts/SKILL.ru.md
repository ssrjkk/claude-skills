...
version: "1.0"
language: ru
original: newrelic-alerts
---

# Newrelic Alerts

> Alerts with New Relic. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Alerts
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
