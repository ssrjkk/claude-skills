...
category: devops
tags: [saltstack-modules, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saltstack-modules
---

# Saltstack Modules

> Modules with SaltStack. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack Modules
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
