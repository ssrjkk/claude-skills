...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Api
...
## Ресурсы
- Оригинальный навык: devops/ansible-api/SKILL.md
- Категория: DevOps
- Язык: Русский
