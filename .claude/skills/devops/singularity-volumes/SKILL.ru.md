...
category: devops
tags: [singularity-volumes, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: singularity-volumes
---

# Singularity Volumes

> Volumes with Singularity. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Volumes
...
## Ресурсы
- Оригинальный навык: `devops/singularity-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
