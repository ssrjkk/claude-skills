...
version: "1.0"
language: ru
original: zipkin-tracing
---

# Zipkin Tracing

> Tracing with Zipkin. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Tracing
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
