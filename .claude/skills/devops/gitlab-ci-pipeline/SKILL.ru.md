...
category: devops
tags: [gitlab-ci-pipeline, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gitlab-ci-pipeline
---

# Gitlab Ci Pipeline

> Pipeline with GitLab CI. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
