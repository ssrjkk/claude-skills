...
version: "1.0"
language: ru
original: minikube-secrets
---

# Minikube Secrets

> Secrets with Minikube. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Secrets
...
## Ресурсы
- Оригинальный навык: `devops/minikube-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
