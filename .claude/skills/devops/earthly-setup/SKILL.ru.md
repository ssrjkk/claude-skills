...
version: "1.0"
language: ru
original: earthly-setup
---

# Earthly Setup

> Setup with Earthly. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Setup
...
## Ресурсы
- Оригинальный навык: `devops/earthly-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
