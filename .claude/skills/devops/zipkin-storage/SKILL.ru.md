...
category: devops
tags: [zipkin-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zipkin-storage
---

# Zipkin Storage

> Storage with Zipkin. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Storage
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
