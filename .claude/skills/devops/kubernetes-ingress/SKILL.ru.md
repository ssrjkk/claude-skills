...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Ingress
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
