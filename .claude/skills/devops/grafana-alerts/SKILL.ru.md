...
version: "1.0"
language: ru
original: grafana-alerts
---

# Grafana Alerts

> Alerts with Grafana. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Alerts
...
## Ресурсы
- Оригинальный навык: `devops/grafana-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
