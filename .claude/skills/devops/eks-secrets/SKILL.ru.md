...
version: "1.0"
language: ru
original: eks-secrets
---

# Eks Secrets

> Secrets with Amazon EKS. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Secrets
...
## Ресурсы
- Оригинальный навык: `devops/eks-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
