...
category: devops
tags: [elastic-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: elastic-metrics
---

# Elastic Metrics

> Metrics with Elastic Stack. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elastic-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Elastic Metrics
...
## Ресурсы
- Оригинальный навык: `devops/elastic-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
