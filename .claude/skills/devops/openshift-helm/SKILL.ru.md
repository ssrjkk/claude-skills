...
version: "1.0"
language: ru
original: openshift-helm
---

# Openshift Helm

> Helm with OpenShift. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Helm
...
## Ресурсы
- Оригинальный навык: `devops/openshift-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
