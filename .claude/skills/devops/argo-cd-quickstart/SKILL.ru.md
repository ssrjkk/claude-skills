...
category: devops
tags: [argo-cd-quickstart, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argo-cd-quickstart
---

# Argo Cd Quickstart

> Quickstart for Argo-Cd: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-cd-quickstart`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Cd Quickstart
...
## Ресурсы
- Оригинал: devops/argo-cd-quickstart/SKILL.md
- Категория: DevOps
