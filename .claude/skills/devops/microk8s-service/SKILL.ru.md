...
version: "1.0"
language: ru
original: microk8s-service
---

# Microk8S Service

> Service with MicroK8s. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Service
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
