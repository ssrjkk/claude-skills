...
> Helm with K3s. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Helm
...
## Ресурсы
- Оригинальный навык: `devops/k3s-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
