...
## Быстрый старт
Этот навык на русском языке. Оригинал: `helm-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Helm Testing
...
## Ресурсы
- Оригинальный навык: devops/helm-testing/SKILL.md
- Категория: DevOps
- Язык: Русский
