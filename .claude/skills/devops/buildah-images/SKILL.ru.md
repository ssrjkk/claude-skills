...
category: devops
tags: [buildah-images, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: buildah-images
---

# Buildah Images

> Images with Buildah. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Images
...
## Ресурсы
- Оригинальный навык: `devops/buildah-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
