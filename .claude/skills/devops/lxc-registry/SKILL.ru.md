...
version: "1.0"
language: ru
original: lxc-registry
---

# Lxc Registry

> Registry with LXC. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Registry
...
## Ресурсы
- Оригинальный навык: `devops/lxc-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
