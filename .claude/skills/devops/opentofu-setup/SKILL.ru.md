...
category: devops
tags: [opentofu-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opentofu-setup
---

# Opentofu Setup

> Setup with OpenTofu. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Setup
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
