...
category: devops
tags: [jaeger-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jaeger-metrics
---

# Jaeger Metrics

> Metrics with Jaeger. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Metrics
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
