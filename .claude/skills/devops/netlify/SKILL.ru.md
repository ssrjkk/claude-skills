...
> Deploys static sites and serverless functions with Netlify, including forms, identity, and split testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify
...
## Ресурсы
- Оригинальный навык: `devops/netlify/SKILL.md`
- Категория: DevOps
- Язык: Русский
