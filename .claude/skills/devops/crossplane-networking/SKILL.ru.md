...
version: "1.0"
language: ru
original: crossplane-networking
---

# Crossplane Networking

> Networking with Crossplane. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane Networking
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
