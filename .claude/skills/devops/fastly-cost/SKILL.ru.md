...
category: devops
tags: [fastly-cost, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fastly-cost
---

# Fastly Cost

> Cost with Fastly. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Cost
...
## Ресурсы
- Оригинальный навык: `devops/fastly-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
