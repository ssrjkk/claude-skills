...
category: devops
tags: [cdk8s-examples, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: cdk8s-examples
---

# Cdk8S Examples

> Examples for Cdk8S: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cdk8s-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk8S Examples
...
## Ресурсы
- Оригинал: devops/cdk8s-examples/SKILL.md
- Категория: DevOps
