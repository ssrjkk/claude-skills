...
version: "1.0"
language: ru
original: calico-getting-started
---

# Calico Getting Started

> Getting Started for Calico: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: calico-getting-started.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Calico Getting Started
...
## Ресурсы
- devops/calico-getting-started/SKILL.md
- Категория: DevOps
