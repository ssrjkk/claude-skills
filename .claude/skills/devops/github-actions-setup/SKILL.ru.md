...
version: "1.0"
language: ru
original: github-actions-setup
---

# Github Actions Setup

> Setup with GitHub Actions. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Setup
...
## Ресурсы
- Оригинальный навык: `devops/github-actions-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
