...
category: devops
tags: [tekton-fundamentals, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tekton-fundamentals
---

# Tekton Fundamentals

> Fundamentals for Tekton: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tekton-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tekton Fundamentals
...
## Ресурсы
- Оригинал: devops/tekton-fundamentals/SKILL.md
- Категория: DevOps
