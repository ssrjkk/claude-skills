...
version: "1.0"
language: ru
original: nerdctl-compose
---

# Nerdctl Compose

> Compose with nerdctl. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Compose
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
