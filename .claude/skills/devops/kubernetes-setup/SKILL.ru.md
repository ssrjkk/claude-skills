...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Setup
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-setup/SKILL.md
- Категория: DevOps
- Язык: Русский
