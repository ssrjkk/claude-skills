...
version: "1.0"
language: ru
original: zipkin-setup
---

# Zipkin Setup

> Setup with Zipkin. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Setup
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
