...
version: "1.0"
language: ru
original: vultr-serverless
---

# Vultr Serverless

> Serverless with Vultr. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vultr-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vultr Serverless
...
## Ресурсы
- Оригинальный навык: `devops/vultr-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
