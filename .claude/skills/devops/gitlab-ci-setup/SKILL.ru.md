...
version: "1.0"
language: ru
original: gitlab-ci-setup
---

# Gitlab Ci Setup

> Setup with GitLab CI. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Setup
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
