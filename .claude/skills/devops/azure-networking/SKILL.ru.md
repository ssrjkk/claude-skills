...
category: devops
tags: [azure-networking, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: azure-networking
---

# Azure Networking

> Networking with Azure. VPC.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Networking
...
## Ресурсы
- Оригинальный навык: `devops/azure-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
