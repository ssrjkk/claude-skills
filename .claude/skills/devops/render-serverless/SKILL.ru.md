...
version: "1.0"
language: ru
original: render-serverless
---

# Render Serverless

> Serverless with Render. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `render-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Render Serverless
...
## Ресурсы
- Оригинальный навык: `devops/render-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
