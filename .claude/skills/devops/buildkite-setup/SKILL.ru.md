...
version: "1.0"
language: ru
original: buildkite-setup
---

# Buildkite Setup

> Setup with Buildkite. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildkite-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildkite Setup
...
## Ресурсы
- Оригинальный навык: `devops/buildkite-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
