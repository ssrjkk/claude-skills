...
version: "1.0"
language: ru
original: openshift-secrets
---

# Openshift Secrets

> Secrets with OpenShift. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Secrets
...
## Ресурсы
- Оригинальный навык: `devops/openshift-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
