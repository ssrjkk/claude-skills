...
version: "1.0"
language: ru
original: datadog-setup
---

# Datadog Setup

> Setup with Datadog. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `datadog-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Datadog Setup
...
## Ресурсы
- Оригинальный навык: `devops/datadog-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
