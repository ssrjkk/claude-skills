...
version: "1.0"
language: ru
original: datadog-alerts
---

# Datadog Alerts

> Alerts with Datadog. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `datadog-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Datadog Alerts
...
## Ресурсы
- Оригинальный навык: `devops/datadog-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
