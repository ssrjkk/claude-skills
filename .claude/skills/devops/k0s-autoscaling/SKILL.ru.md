...
category: devops
tags: [k0s-autoscaling, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k0s-autoscaling
---

# K0S Autoscaling

> Autoscaling with K0s. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/k0s-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
