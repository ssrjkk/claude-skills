...
version: "1.0"
language: ru
original: azure-database
---

# Azure Database

> Database with Azure. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Database
...
## Ресурсы
- Оригинальный навык: `devops/azure-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
