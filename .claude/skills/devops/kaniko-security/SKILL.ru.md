...
category: devops
tags: [kaniko-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kaniko-security
---

# Kaniko Security

> Security with Kaniko. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kaniko-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kaniko Security
...
## Ресурсы
- Оригинальный навык: `devops/kaniko-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
