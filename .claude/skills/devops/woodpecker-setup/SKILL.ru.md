...
version: "1.0"
language: ru
original: woodpecker-setup
---

# Woodpecker Setup

> Setup with Woodpecker. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Setup
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
