...
version: "1.0"
language: ru
original: prometheus-logging
---

# Prometheus Logging

> Logging with Prometheus. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Logging
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
