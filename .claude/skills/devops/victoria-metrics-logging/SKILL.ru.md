...
version: "1.0"
language: ru
original: victoria-metrics-logging
---

# Victoria Metrics Logging

> Logging with VictoriaMetrics. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Victoria Metrics Logging
...
## Ресурсы
- Оригинальный навык: `devops/victoria-metrics-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
