...
version: "1.0"
language: ru
original: openshift-autoscaling
---

# Openshift Autoscaling

> Autoscaling with OpenShift. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/openshift-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
