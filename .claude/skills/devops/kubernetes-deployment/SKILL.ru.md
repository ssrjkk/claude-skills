...
category: devops
tags: [kubernetes-deployment, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Deployment with Kubernetes. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Deployment
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
