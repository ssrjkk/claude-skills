...
version: "1.0"
language: ru
original: argo-cd-fundamentals
---

# Argo Cd Fundamentals

> Fundamentals for Argo-Cd: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-cd-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Cd Fundamentals
...
## Ресурсы
- Оригинал: devops/argo-cd-fundamentals/SKILL.md
- Категория: DevOps
