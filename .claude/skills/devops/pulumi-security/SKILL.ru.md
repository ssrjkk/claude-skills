...
version: "1.0"
language: ru
original: pulumi-security
---

# Pulumi Security

> Security with Pulumi. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Security
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
