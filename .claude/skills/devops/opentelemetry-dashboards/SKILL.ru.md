...
category: devops
tags: [opentelemetry-dashboards, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: opentelemetry-dashboards
---

# Opentelemetry Dashboards

> Dashboards with OpenTelemetry. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
