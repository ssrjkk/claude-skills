...
category: devops
tags: [singularity-registry, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: singularity-registry
---

# Singularity Registry

> Registry with Singularity. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Registry
...
## Ресурсы
- Оригинальный навык: `devops/singularity-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
