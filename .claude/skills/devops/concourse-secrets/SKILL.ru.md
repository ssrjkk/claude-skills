...
version: "1.0"
language: ru
original: concourse-secrets
---

# Concourse Secrets

> Secrets with Concourse. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Secrets
...
## Ресурсы
- Оригинальный навык: `devops/concourse-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
