...
category: devops
tags: [teamcity-deployment, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: teamcity-deployment
---

# Teamcity Deployment

> Deployment with TeamCity. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Deployment
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
