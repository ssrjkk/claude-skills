...
> RBAC with K3s. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Rbac
...
## Ресурсы
- Оригинальный навык: `devops/k3s-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
