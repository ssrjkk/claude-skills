...
version: "1.0"
language: ru
original: pulumi-testing
---

# Pulumi Testing

> Testing with Pulumi. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Testing
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
