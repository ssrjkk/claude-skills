...
version: "1.0"
language: ru
original: signoz-dashboards
---

# Signoz Dashboards

> Dashboards with SigNoz. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `signoz-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Signoz Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/signoz-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
