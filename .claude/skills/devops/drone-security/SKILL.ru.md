...
category: devops
tags: [drone-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: drone-security
---

# Drone Security

> Security with Drone CI. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Security
...
## Ресурсы
- Оригинальный навык: `devops/drone-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
