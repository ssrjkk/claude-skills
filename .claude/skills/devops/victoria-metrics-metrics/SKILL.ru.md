...
category: devops
tags: [victoria-metrics-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: victoria-metrics-metrics
---

# Victoria Metrics Metrics

> Metrics with VictoriaMetrics. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Victoria Metrics Metrics
...
## Ресурсы
- Оригинальный навык: `devops/victoria-metrics-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
