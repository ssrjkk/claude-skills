...
version: "1.0"
language: ru
original: cilium-configuration
---

# Cilium Configuration

> Configuration for Cilium: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: cilium-configuration.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cilium Configuration
...
## Ресурсы
- devops/cilium-configuration/SKILL.md
- Категория: DevOps
