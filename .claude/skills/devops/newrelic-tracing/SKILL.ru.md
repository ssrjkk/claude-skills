...
category: devops
tags: [newrelic-tracing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: newrelic-tracing
---

# Newrelic Tracing

> Tracing with New Relic. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Tracing
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
