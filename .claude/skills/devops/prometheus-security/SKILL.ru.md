...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Security
...
## Ресурсы
- Оригинальный навык: devops/prometheus-security/SKILL.md
- Категория: DevOps
- Язык: Русский
