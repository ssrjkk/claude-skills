...
version: "1.0"
language: ru
original: minikube-helm
---

# Minikube Helm

> Helm with Minikube. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Helm
...
## Ресурсы
- Оригинальный навык: `devops/minikube-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
