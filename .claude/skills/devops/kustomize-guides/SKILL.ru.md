...
category: devops
tags: [kustomize-guides, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kustomize-guides
---

# Kustomize Guides

> Guides for Kustomize: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kustomize-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kustomize Guides
...
## Ресурсы
- Оригинал: devops/kustomize-guides/SKILL.md
- Категория: DevOps
