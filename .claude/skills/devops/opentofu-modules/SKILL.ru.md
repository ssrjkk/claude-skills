...
version: "1.0"
language: ru
original: opentofu-modules
---

# Opentofu Modules

> Modules with OpenTofu. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Modules
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
