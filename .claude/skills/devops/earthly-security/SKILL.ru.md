...
version: "1.0"
language: ru
original: earthly-security
---

# Earthly Security

> Security with Earthly. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Security
...
## Ресурсы
- Оригинальный навык: `devops/earthly-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
