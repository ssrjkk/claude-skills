...
category: devops
tags: [prometheus-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-monitoring
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Monitoring
...
## Ресурсы
- Оригинальный навык: devops/prometheus-monitoring/SKILL.md
- Категория: DevOps
- Язык: Русский
