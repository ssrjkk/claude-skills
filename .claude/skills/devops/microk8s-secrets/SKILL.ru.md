...
version: "1.0"
language: ru
original: microk8s-secrets
---

# Microk8S Secrets

> Secrets with MicroK8s. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Secrets
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
