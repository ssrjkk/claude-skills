...
version: "1.0"
language: ru
original: kaniko-compose
---

# Kaniko Compose

> Compose with Kaniko. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kaniko-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kaniko Compose
...
## Ресурсы
- Оригинальный навык: `devops/kaniko-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
