...
category: devops
tags: [minikube-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: minikube-configmap
---

# Minikube Configmap

> ConfigMap with Minikube. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Configmap
...
## Ресурсы
- Оригинальный навык: `devops/minikube-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
