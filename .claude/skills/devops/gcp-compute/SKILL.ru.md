...
version: "1.0"
language: ru
original: gcp-compute
---

# Gcp Compute

> Compute with GCP. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gcp-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gcp Compute
...
## Ресурсы
- Оригинальный навык: `devops/gcp-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
