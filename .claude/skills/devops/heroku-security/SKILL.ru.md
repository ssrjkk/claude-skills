...
version: "1.0"
language: ru
original: heroku-security
---

# Heroku Security

> Security with Heroku. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heroku-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Heroku Security
...
## Ресурсы
- Оригинальный навык: `devops/heroku-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
