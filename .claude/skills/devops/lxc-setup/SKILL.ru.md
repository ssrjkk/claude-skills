...
> Setup with LXC. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Setup
...
## Ресурсы
- Оригинальный навык: `devops/lxc-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
