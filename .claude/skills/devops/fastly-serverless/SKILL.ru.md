...
version: "1.0"
language: ru
original: fastly-serverless
---

# Fastly Serverless

> Serverless with Fastly. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Serverless
...
## Ресурсы
- Оригинальный навык: `devops/fastly-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
