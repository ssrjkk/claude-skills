...
version: "1.0"
language: ru
original: opentelemetry-alerts
---

# Opentelemetry Alerts

> Alerts with OpenTelemetry. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Alerts
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
