...
category: devops
tags: [microk8s-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: microk8s-configmap
---

# Microk8S Configmap

> ConfigMap with MicroK8s. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Configmap
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
