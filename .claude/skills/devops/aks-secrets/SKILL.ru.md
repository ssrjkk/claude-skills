...
version: "1.0"
language: ru
original: aks-secrets
---

# Aks Secrets

> Secrets with Azure AKS. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Secrets
...
## Ресурсы
- Оригинальный навык: `devops/aks-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
