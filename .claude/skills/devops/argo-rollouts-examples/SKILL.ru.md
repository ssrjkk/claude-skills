...
version: "1.0"
language: ru
original: argo-rollouts-examples
---

# Argo Rollouts Examples

> Examples for Argo-Rollouts: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-rollouts-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Rollouts Examples
...
## Ресурсы
- Оригинал: devops/argo-rollouts-examples/SKILL.md
- Категория: DevOps
