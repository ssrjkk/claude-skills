...
category: devops
tags: [chef-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chef-testing
---

# Chef Testing

> Testing with Chef. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Testing
...
## Ресурсы
- Оригинальный навык: `devops/chef-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
