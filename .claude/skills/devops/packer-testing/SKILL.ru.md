...
category: devops
tags: [packer-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: packer-testing
---

# Packer Testing

> Testing with Packer. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Testing
...
## Ресурсы
- Оригинальный навык: `devops/packer-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
