...
version: "1.0"
language: ru
original: kpt-quickstart
---

# Kpt Quickstart

> Quickstart for Kpt: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `kpt-quickstart`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kpt Quickstart
...
## Ресурсы
- Оригинал: devops/kpt-quickstart/SKILL.md
- Категория: DevOps
