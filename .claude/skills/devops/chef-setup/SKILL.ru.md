...
> Setup with Chef. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Setup
...
## Ресурсы
- Оригинальный навык: `devops/chef-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
