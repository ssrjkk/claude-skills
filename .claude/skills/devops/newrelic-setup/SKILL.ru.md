...
category: devops
tags: [newrelic-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: newrelic-setup
---

# Newrelic Setup

> Setup with New Relic. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Setup
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
