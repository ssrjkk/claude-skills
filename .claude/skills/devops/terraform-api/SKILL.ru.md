...
category: devops
tags: [terraform-api, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: terraform-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Api
...
## Ресурсы
- Оригинальный навык: devops/terraform-api/SKILL.md
- Категория: DevOps
- Язык: Русский
