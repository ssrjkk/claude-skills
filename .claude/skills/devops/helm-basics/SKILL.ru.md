...
## Быстрый старт
Этот навык на русском языке. Оригинал: `helm-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Helm Basics
...
## Ресурсы
- Оригинальный навык: devops/helm-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
