...
version: "1.0"
language: ru
original: akamai-cost
---

# Akamai Cost

> Cost with Akamai. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Cost
...
## Ресурсы
- Оригинальный навык: `devops/akamai-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
