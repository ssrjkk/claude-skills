...
version: "1.0"
language: ru
original: terraform-azure
---

# Terraform Azure

> Provisions Azure infrastructure using Terraform modules for compute, networking, and managed services. Use for Azure IaC.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-azure`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Azure
...
## Ресурсы
- Оригинальный навык: `devops/terraform-azure/SKILL.md`
- Категория: DevOps
- Язык: Русский
