...
version: "1.0"
language: ru
original: rancher-rbac
---

# Rancher Rbac

> RBAC with Rancher. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Rbac
...
## Ресурсы
- Оригинальный навык: `devops/rancher-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
