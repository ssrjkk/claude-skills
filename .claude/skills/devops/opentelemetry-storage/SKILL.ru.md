...
version: "1.0"
language: ru
original: opentelemetry-storage
---

# Opentelemetry Storage

> Storage with OpenTelemetry. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Storage
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
