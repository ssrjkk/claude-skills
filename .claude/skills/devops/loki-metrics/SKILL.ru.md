...
category: devops
tags: [loki-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: loki-metrics
---

# Loki Metrics

> Metrics with Loki. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Metrics
...
## Ресурсы
- Оригинальный навык: `devops/loki-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
