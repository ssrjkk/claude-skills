...
version: "1.0"
language: ru
original: containerd-registry
---

# Containerd Registry

> Registry with containerd. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Registry
...
## Ресурсы
- Оригинальный навык: `devops/containerd-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
