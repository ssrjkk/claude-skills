...
version: "1.0"
language: ru
original: jenkins-security
---

# Jenkins Security

> Security with Jenkins. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Security
...
## Ресурсы
- Оригинальный навык: `devops/jenkins-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
