...
version: "1.0"
language: ru
original: vagrant-setup
---

# Vagrant Setup

> Setup with Vagrant. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vagrant-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vagrant Setup
...
## Ресурсы
- Оригинальный навык: `devops/vagrant-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
