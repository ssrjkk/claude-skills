...
category: devops
tags: [teamcity-secrets, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: teamcity-secrets
---

# Teamcity Secrets

> Secrets with TeamCity. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Secrets
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
