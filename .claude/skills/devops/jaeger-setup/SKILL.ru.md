...
version: "1.0"
language: ru
original: jaeger-setup
---

# Jaeger Setup

> Setup with Jaeger. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Setup
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
