...
version: "1.0"
language: ru
original: vercel-security
---

# Vercel Security

> Security with Vercel. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vercel-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vercel Security
...
## Ресурсы
- Оригинальный навык: `devops/vercel-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
