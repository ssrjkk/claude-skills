...
version: "1.0"
language: ru
original: buildah-volumes
---

# Buildah Volumes

> Volumes with Buildah. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Volumes
...
## Ресурсы
- Оригинальный навык: `devops/buildah-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
