...
category: devops
tags: [akamai-database, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: akamai-database
---

# Akamai Database

> Database with Akamai. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Database
...
## Ресурсы
- Оригинальный навык: `devops/akamai-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
