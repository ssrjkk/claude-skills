...
version: "1.0"
language: ru
original: kubernetes-secrets
---

# Kubernetes Secrets

> Secrets with Kubernetes. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Secrets
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
