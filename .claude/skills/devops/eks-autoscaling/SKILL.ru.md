...
category: devops
tags: [eks-autoscaling, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eks-autoscaling
---

# Eks Autoscaling

> Autoscaling with Amazon EKS. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/eks-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
