...
category: devops
tags: [vagrant-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: vagrant-cicd
---

# Vagrant Cicd

> CI/CD with Vagrant. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vagrant-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vagrant Cicd
...
## Ресурсы
- Оригинальный навык: `devops/vagrant-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
