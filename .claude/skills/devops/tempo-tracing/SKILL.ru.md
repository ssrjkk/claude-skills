...
version: "1.0"
language: ru
original: tempo-tracing
---

# Tempo Tracing

> Tracing with Tempo. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Tracing
...
## Ресурсы
- Оригинальный навык: `devops/tempo-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
