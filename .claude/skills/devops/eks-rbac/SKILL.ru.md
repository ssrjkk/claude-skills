...
> RBAC with Amazon EKS. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Rbac
...
## Ресурсы
- Оригинальный навык: `devops/eks-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
