...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Monitoring
...
## Ресурсы
- Оригинальный навык: devops/argocd-monitoring/SKILL.md
- Категория: DevOps
- Язык: Русский
