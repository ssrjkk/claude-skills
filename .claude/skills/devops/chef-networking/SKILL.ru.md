...
version: "1.0"
language: ru
original: chef-networking
---

# Chef Networking

> Networking with Chef. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Networking
...
## Ресурсы
- Оригинальный навык: `devops/chef-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
