...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudformation-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudformation State
...
## Ресурсы
- Оригинальный навык: `devops/cloudformation-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
