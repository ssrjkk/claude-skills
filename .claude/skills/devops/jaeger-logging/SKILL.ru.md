...
version: "1.0"
language: ru
original: jaeger-logging
---

# Jaeger Logging

> Logging with Jaeger. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Logging
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
