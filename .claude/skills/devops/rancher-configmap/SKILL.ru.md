...
category: devops
tags: [rancher-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rancher-configmap
---

# Rancher Configmap

> ConfigMap with Rancher. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Configmap
...
## Ресурсы
- Оригинальный навык: `devops/rancher-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
