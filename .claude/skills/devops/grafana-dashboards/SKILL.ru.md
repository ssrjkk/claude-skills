...
version: "1.0"
language: ru
original: grafana-dashboards
---

# Grafana Dashboards

> Dashboards with Grafana. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/grafana-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
