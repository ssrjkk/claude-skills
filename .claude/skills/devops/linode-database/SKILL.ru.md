...
category: devops
tags: [linode-database, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linode-database
---

# Linode Database

> Database with Linode. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Database
...
## Ресурсы
- Оригинальный навык: `devops/linode-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
