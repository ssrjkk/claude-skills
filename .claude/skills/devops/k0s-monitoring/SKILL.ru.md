...
version: "1.0"
language: ru
original: k0s-monitoring
---

# K0S Monitoring

> Monitoring with K0s. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/k0s-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
