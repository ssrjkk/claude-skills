...
version: "1.0"
language: ru
original: tempo-dashboards
---

# Tempo Dashboards

> Dashboards with Tempo. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/tempo-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
