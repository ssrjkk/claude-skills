...
version: "1.0"
language: ru
original: crossplane-security
---

# Crossplane Security

> Security with Crossplane. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane Security
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
