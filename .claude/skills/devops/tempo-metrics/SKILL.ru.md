...
version: "1.0"
language: ru
original: tempo-metrics
---

# Tempo Metrics

> Metrics with Tempo. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Metrics
...
## Ресурсы
- Оригинальный навык: `devops/tempo-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
