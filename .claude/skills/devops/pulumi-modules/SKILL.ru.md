...
version: "1.0"
language: ru
original: pulumi-modules
---

# Pulumi Modules

> Modules with Pulumi. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Modules
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
