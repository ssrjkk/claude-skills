...
category: devops
tags: [argocd-rollback, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argocd-rollback
---

# Argocd Rollback

> Performs automatic and manual rollback of deployments in Kubernetes via ArgoCD. Use for quick recovery from failures.

## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-rollback`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Rollback
...
## Ресурсы
- Оригинальный навык: `devops/argocd-rollback/SKILL.md`
- Категория: DevOps
- Язык: Русский
