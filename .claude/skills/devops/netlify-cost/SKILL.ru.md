...
category: devops
tags: [netlify-cost, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: netlify-cost
---

# Netlify Cost

> Cost with Netlify. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify Cost
...
## Ресурсы
- Оригинальный навык: `devops/netlify-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
