...
category: devops
tags: [prometheus-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-storage
---

# Prometheus Storage

> Storage with Prometheus. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Storage
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
