...
category: devops
tags: [chef-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chef-security
---

# Chef Security

> Security with Chef. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Security
...
## Ресурсы
- Оригинальный навык: `devops/chef-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
