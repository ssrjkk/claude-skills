...
version: "1.0"
language: ru
original: vultr-compute
---

# Vultr Compute

> Compute with Vultr. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vultr-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vultr Compute
...
## Ресурсы
- Оригинальный навык: `devops/vultr-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
