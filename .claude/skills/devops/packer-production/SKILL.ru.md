...
version: "1.0"
language: ru
original: packer-production
---

# Packer Production

> Production for Packer: production deployment

## Быстрый старт
Этот навык на русском языке. Оригинал: packer-production.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Production
...
## Ресурсы
- devops/packer-production/SKILL.md
- Категория: DevOps
