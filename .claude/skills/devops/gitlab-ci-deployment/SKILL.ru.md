...
version: "1.0"
language: ru
original: gitlab-ci-deployment
---

# Gitlab Ci Deployment

> Deployment with GitLab CI. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Deployment
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
