...
version: "1.0"
language: ru
original: buildah-setup
---

# Buildah Setup

> Setup with Buildah. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Setup
...
## Ресурсы
- Оригинальный навык: `devops/buildah-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
