...
category: devops
tags: [eks-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: eks-storage
---

# Eks Storage

> Storage with Amazon EKS. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Storage
...
## Ресурсы
- Оригинальный навык: `devops/eks-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
