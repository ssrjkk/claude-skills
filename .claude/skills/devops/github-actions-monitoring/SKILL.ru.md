...
version: "1.0"
language: ru
original: github-actions-monitoring
---

# Github Actions Monitoring

> Monitoring with GitHub Actions. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/github-actions-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
