...
version: "1.0"
language: ru
original: skopeo-volumes
---

# Skopeo Volumes

> Volumes with Skopeo. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Volumes
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
