...
category: devops
tags: [terraform-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: terraform-setup
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Setup
...
## Ресурсы
- Оригинальный навык: `devops/terraform-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
