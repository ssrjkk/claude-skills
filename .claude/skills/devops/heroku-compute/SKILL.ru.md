...
version: "1.0"
language: ru
original: heroku-compute
---

# Heroku Compute

> Compute with Heroku. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heroku-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Heroku Compute
...
## Ресурсы
- Оригинальный навык: `devops/heroku-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
