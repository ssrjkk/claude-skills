...
## Быстрый старт
Этот навык на русском языке. Оригинал: `dynatrace-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dynatrace Metrics
...
## Ресурсы
- Оригинальный навык: `devops/dynatrace-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
