...
version: "1.0"
language: ru
original: opentofu-provisioning
---

# Opentofu Provisioning

> Provisioning with OpenTofu. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
