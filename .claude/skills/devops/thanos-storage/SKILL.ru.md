...
category: devops
tags: [thanos-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: thanos-storage
---

# Thanos Storage

> Storage with Thanos. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Storage
...
## Ресурсы
- Оригинальный навык: `devops/thanos-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
