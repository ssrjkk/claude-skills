...
category: devops
tags: [azure-serverless, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: azure-serverless
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Serverless
...
## Ресурсы
- Оригинальный навык: `devops/azure-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
