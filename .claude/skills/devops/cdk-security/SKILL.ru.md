...
version: "1.0"
language: ru
original: cdk-security
---

# Cdk Security

> Security with AWS CDK. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk Security
...
## Ресурсы
- Оригинальный навык: `devops/cdk-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
