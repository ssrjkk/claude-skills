...
version: "1.0"
language: ru
original: fastly-security
---

# Fastly Security

> Security with Fastly. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Security
...
## Ресурсы
- Оригинальный навык: `devops/fastly-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
