...
> RBAC with K0s. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Rbac
...
## Ресурсы
- Оригинальный навык: `devops/k0s-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
