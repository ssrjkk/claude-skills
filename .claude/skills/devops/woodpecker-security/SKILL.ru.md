...
## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Security
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
