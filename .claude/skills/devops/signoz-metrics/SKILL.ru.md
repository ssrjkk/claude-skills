...
version: "1.0"
language: ru
original: signoz-metrics
---

# Signoz Metrics

> Metrics with SigNoz. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `signoz-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Signoz Metrics
...
## Ресурсы
- Оригинальный навык: `devops/signoz-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
