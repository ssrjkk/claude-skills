...
category: devops
tags: [newrelic-dashboards, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: newrelic-dashboards
---

# Newrelic Dashboards

> Dashboards with New Relic. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
