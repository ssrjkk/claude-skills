...
> Setup with Loki. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Setup
...
## Ресурсы
- Оригинальный навык: `devops/loki-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
