...
version: "1.0"
language: ru
original: elastic-dashboards
---

# Elastic Dashboards

> Dashboards with Elastic Stack. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `elastic-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Elastic Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/elastic-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
