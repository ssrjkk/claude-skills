...
version: "1.0"
language: ru
original: linode-serverless
---

# Linode Serverless

> Serverless with Linode. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Serverless
...
## Ресурсы
- Оригинальный навык: `devops/linode-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
