...
version: "1.0"
language: ru
original: monitoring-prometheus
---

# Monitoring Prometheus

> Sets up application and infrastructure monitoring with Prometheus and Grafana. Use for metrics collection and alerting.

## Быстрый старт
Этот навык на русском языке. Оригинал: `monitoring-prometheus`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Monitoring Prometheus
...
## Ресурсы
- Оригинальный навык: `devops/monitoring-prometheus/SKILL.md`
- Категория: DevOps
- Язык: Русский
