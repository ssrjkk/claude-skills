...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-ai`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Ai
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-ai/SKILL.md`
- Категория: DevOps
- Язык: Русский
