...
category: devops
tags: [rancher-helm, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rancher-helm
---

# Rancher Helm

> Helm with Rancher. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Helm
...
## Ресурсы
- Оригинальный навык: `devops/rancher-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
