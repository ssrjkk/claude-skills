...
## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-debugging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Debugging
...
## Ресурсы
- Оригинальный навык: devops/docker-debugging/SKILL.md
- Категория: DevOps
- Язык: Русский
