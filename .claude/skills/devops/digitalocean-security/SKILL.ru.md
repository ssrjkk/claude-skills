...
version: "1.0"
language: ru
original: digitalocean-security
---

# Digitalocean Security

> Security with DigitalOcean. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Security
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
