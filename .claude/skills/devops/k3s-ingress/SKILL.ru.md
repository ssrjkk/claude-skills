...
version: "1.0"
language: ru
original: k3s-ingress
---

# K3S Ingress

> Ingress with K3s. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Ingress
...
## Ресурсы
- Оригинальный навык: `devops/k3s-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
