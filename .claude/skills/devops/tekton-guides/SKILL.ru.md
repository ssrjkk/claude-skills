...
category: devops
tags: [tekton-guides, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tekton-guides
---

# Tekton Guides

> Guides for Tekton: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `tekton-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tekton Guides
...
## Ресурсы
- Оригинал: devops/tekton-guides/SKILL.md
- Категория: DevOps
