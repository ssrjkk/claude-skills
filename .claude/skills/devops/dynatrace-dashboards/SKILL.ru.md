...
version: "1.0"
language: ru
original: dynatrace-dashboards
---

# Dynatrace Dashboards

> Dashboards with Dynatrace. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynatrace-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dynatrace Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/dynatrace-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
