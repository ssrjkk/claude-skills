...
version: "1.0"
language: ru
original: ansible-modules
---

# Ansible Modules

> Modules with Ansible. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Modules
...
## Ресурсы
- Оригинальный навык: `devops/ansible-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
