...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Deployment
...
## Ресурсы
- Оригинальный навык: devops/argocd-deployment/SKILL.md
- Категория: DevOps
- Язык: Русский
