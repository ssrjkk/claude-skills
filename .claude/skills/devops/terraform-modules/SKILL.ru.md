...
version: "1.0"
language: ru
original: terraform-modules
---

# Terraform Modules

> Modules with Terraform. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Modules
...
## Ресурсы
- Оригинальный навык: `devops/terraform-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
