...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudformation-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudformation Cicd
...
## Ресурсы
- Оригинальный навык: `devops/cloudformation-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
