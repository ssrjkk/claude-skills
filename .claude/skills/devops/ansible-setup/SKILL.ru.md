...
version: "1.0"
language: ru
original: ansible-setup
---

# Ansible Setup

> Setup with Ansible. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Setup
...
## Ресурсы
- Оригинальный навык: `devops/ansible-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
