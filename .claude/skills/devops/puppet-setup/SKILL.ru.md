...
category: devops
tags: [puppet-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppet-setup
---

# Puppet Setup

> Setup with Puppet. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Setup
...
## Ресурсы
- Оригинальный навык: `devops/puppet-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
