...
version: "1.0"
language: ru
original: dagger-secrets
---

# Dagger Secrets

> Secrets with Dagger. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagger-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dagger Secrets
...
## Ресурсы
- Оригинальный навык: `devops/dagger-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
