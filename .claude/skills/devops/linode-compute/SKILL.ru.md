...
category: devops
tags: [linode-compute, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linode-compute
---

# Linode Compute

> Compute with Linode. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Compute
...
## Ресурсы
- Оригинальный навык: `devops/linode-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
