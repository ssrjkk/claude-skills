...
version: "1.0"
language: ru
original: k3s-deployment
---

# K3S Deployment

> Deployment with K3s. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Deployment
...
## Ресурсы
- Оригинальный навык: `devops/k3s-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
