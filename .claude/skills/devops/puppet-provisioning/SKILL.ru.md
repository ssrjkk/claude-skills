...
version: "1.0"
language: ru
original: puppet-provisioning
---

# Puppet Provisioning

> Provisioning with Puppet. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/puppet-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
