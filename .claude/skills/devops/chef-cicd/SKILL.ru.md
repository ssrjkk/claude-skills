...
> CI/CD with Chef. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Cicd
...
## Ресурсы
- Оригинальный навык: `devops/chef-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
