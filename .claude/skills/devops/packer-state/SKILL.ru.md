...
category: devops
tags: [packer-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: packer-state
---

# Packer State

> State with Packer. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer State
...
## Ресурсы
- Оригинальный навык: `devops/packer-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
