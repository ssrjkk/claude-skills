...
version: "1.0"
language: ru
original: thanos-alerts
---

# Thanos Alerts

> Alerts with Thanos. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Alerts
...
## Ресурсы
- Оригинальный навык: `devops/thanos-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
