...
version: "1.0"
language: ru
original: newrelic-metrics
---

# Newrelic Metrics

> Metrics with New Relic. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Metrics
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
