...
version: "1.0"
language: ru
original: github-actions-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-debugging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Debugging
...
## Ресурсы
- Оригинальный навык: devops/github-actions-debugging/SKILL.md
- Категория: DevOps
- Язык: Русский
