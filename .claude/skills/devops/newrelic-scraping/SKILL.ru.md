...
category: devops
tags: [newrelic-scraping, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: newrelic-scraping
---

# Newrelic Scraping

> Scraping with New Relic. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Scraping
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
