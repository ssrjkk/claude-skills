...
version: "1.0"
language: ru
original: github-models
---

# Github Models

> GitHub Models playground and API

## Быстрый старт
Этот навык на русском языке. Оригинал: `github-models`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Models
...
## Ресурсы
- Оригинальный навык: `devops/github-models/SKILL.md`
- Категория: DevOps
- Язык: Русский
