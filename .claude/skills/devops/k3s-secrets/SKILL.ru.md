...
category: devops
tags: [k3s-secrets, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k3s-secrets
---

# K3S Secrets

> Secrets with K3s. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Secrets
...
## Ресурсы
- Оригинальный навык: `devops/k3s-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
