...
version: "1.0"
language: ru
original: gcp-serverless
---

# Gcp Serverless

> Serverless with GCP. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gcp-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gcp Serverless
...
## Ресурсы
- Оригинальный навык: `devops/gcp-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
