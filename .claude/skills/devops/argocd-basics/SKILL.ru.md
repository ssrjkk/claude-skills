...
category: devops
tags: [argocd-basics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argocd-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Basics
...
## Ресурсы
- Оригинальный навык: devops/argocd-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
