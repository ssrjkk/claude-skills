...
version: "1.0"
language: ru
original: woodpecker-monitoring
---

# Woodpecker Monitoring

> Monitoring with Woodpecker. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
