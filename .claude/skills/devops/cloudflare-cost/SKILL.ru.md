...
version: "1.0"
language: ru
original: cloudflare-cost
---

# Cloudflare Cost

> Cost with Cloudflare. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudflare-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudflare Cost
...
## Ресурсы
- Оригинальный навык: `devops/cloudflare-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
