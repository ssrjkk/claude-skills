...
category: devops
tags: [digitalocean-database, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: digitalocean-database
---

# Digitalocean Database

> Database with DigitalOcean. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Database
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
