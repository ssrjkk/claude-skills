...
category: devops
tags: [argocd-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argocd-security
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Security
...
## Ресурсы
- Оригинальный навык: devops/argocd-security/SKILL.md
- Категория: DevOps
- Язык: Русский
