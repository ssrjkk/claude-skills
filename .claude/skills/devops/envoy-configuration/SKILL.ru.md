...
> Configuration for Envoy: configuration and setup

## Быстрый старт
Этот навык на русском языке. Оригинал: envoy-configuration.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Envoy Configuration
...
## Ресурсы
- devops/envoy-configuration/SKILL.md
- Категория: DevOps
