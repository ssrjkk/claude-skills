...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Basics
...
## Ресурсы
- Оригинальный навык: devops/terraform-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
