...
category: devops
tags: [kubernetes-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Testing
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-testing/SKILL.md
- Категория: DevOps
- Язык: Русский
