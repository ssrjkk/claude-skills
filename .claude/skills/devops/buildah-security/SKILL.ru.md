...
version: "1.0"
language: ru
original: buildah-security
---

# Buildah Security

> Security with Buildah. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Security
...
## Ресурсы
- Оригинальный навык: `devops/buildah-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
