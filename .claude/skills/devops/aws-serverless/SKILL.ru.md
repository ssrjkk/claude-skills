...
> Serverless with AWS. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Serverless
...
## Ресурсы
- Оригинальный навык: `devops/aws-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
