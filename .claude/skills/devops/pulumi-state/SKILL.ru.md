...
category: devops
tags: [pulumi-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: pulumi-state
---

# Pulumi State

> State with Pulumi. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi State
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
