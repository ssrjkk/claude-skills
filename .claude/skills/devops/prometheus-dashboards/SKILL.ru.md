...
version: "1.0"
language: ru
original: prometheus-dashboards
---

# Prometheus Dashboards

> Dashboards with Prometheus. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
