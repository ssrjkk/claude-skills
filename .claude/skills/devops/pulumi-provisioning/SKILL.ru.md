...
version: "1.0"
language: ru
original: pulumi-provisioning
---

# Pulumi Provisioning

> Provisioning with Pulumi. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
