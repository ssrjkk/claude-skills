...
version: "1.0"
language: ru
original: nerdctl-setup
---

# Nerdctl Setup

> Setup with nerdctl. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Setup
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
