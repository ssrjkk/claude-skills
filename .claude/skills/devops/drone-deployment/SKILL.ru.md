...
version: "1.0"
language: ru
original: drone-deployment
---

# Drone Deployment

> Deployment with Drone CI. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Deployment
...
## Ресурсы
- Оригинальный навык: `devops/drone-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
