...
version: "1.0"
language: ru
original: fastly-database
---

# Fastly Database

> Database with Fastly. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Database
...
## Ресурсы
- Оригинальный навык: `devops/fastly-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
