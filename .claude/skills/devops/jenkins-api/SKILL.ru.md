...
category: devops
tags: [jenkins-api, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jenkins-api
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Api
...
## Ресурсы
- Оригинальный навык: devops/jenkins-api/SKILL.md
- Категория: DevOps
- Язык: Русский
