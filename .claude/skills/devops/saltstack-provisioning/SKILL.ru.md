...
version: "1.0"
language: ru
original: saltstack-provisioning
---

# Saltstack Provisioning

> Provisioning with SaltStack. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
