...
version: "1.0"
language: ru
original: cloudformation-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudformation-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudformation Testing
...
## Ресурсы
- Оригинальный навык: `devops/cloudformation-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
