...
version: "1.0"
language: ru
original: drone-secrets
---

# Drone Secrets

> Secrets with Drone CI. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Secrets
...
## Ресурсы
- Оригинальный навык: `devops/drone-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
