...
version: "1.0"
language: ru
original: nerdctl-optimization
---

# Nerdctl Optimization

> Optimization with nerdctl. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Optimization
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
