...
version: "1.0"
language: ru
original: fastly-compute
---

# Fastly Compute

> Compute with Fastly. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Compute
...
## Ресурсы
- Оригинальный навык: `devops/fastly-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
