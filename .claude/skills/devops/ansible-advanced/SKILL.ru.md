...
category: devops
tags: [ansible-advanced, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ansible-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Advanced
...
## Ресурсы
- Оригинальный навык: devops/ansible-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
