...
category: devops
tags: [dynatrace-alerts, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dynatrace-alerts
---

# Dynatrace Alerts

> Alerts with Dynatrace. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynatrace-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dynatrace Alerts
...
## Ресурсы
- Оригинальный навык: `devops/dynatrace-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
