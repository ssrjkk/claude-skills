...
category: devops
tags: [terraform-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> State with Terraform. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform State
...
## Ресурсы
- Оригинальный навык: `devops/terraform-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
