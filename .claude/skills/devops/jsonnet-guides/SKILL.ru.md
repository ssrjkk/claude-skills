...
version: "1.0"
language: ru
original: jsonnet-guides
---

# Jsonnet Guides

> Guides for Jsonnet: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `jsonnet-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jsonnet Guides
...
## Ресурсы
- Оригинал: devops/jsonnet-guides/SKILL.md
- Категория: DevOps
