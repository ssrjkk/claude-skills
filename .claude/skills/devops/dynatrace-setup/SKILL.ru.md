...
category: devops
tags: [dynatrace-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dynatrace-setup
---

# Dynatrace Setup

> Setup with Dynatrace. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dynatrace-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dynatrace Setup
...
## Ресурсы
- Оригинальный навык: `devops/dynatrace-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
