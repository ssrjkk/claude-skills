...
category: devops
tags: [chef-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chef-state
...
> State with Chef. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef State
...
## Ресурсы
- Оригинальный навык: `devops/chef-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
