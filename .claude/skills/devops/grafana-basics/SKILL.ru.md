...
## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Basics
...
## Ресурсы
- Оригинальный навык: devops/grafana-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
