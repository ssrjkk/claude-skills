...
> Images with LXC. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Images
...
## Ресурсы
- Оригинальный навык: `devops/lxc-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
