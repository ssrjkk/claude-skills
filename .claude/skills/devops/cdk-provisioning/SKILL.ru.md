...
version: "1.0"
language: ru
original: cdk-provisioning
---

# Cdk Provisioning

> Provisioning with AWS CDK. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/cdk-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
