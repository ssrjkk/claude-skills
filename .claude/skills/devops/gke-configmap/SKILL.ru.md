...
category: devops
tags: [gke-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gke-configmap
---

# Gke Configmap

> ConfigMap with Google GKE. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Configmap
...
## Ресурсы
- Оригинальный навык: `devops/gke-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
