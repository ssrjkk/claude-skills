...
version: "1.0"
language: ru
original: podman-images
---

# Podman Images

> Images with Podman. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Images
...
## Ресурсы
- Оригинальный навык: `devops/podman-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
