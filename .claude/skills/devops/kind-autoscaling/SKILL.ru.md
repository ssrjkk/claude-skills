...
version: "1.0"
language: ru
original: kind-autoscaling
---

# Kind Autoscaling

> Autoscaling with Kind. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/kind-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
