...
version: "1.0"
language: ru
original: packer-networking
---

# Packer Networking

> Networking with Packer. network infra.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Networking
...
## Ресурсы
- Оригинальный навык: `devops/packer-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
