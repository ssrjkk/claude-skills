...
## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
