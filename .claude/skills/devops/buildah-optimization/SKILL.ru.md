...
version: "1.0"
language: ru
original: buildah-optimization
---

# Buildah Optimization

> Optimization with Buildah. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Optimization
...
## Ресурсы
- Оригинальный навык: `devops/buildah-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
