...
version: "1.0"
language: ru
original: cdk-testing
---

# Cdk Testing

> Testing with AWS CDK. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk Testing
...
## Ресурсы
- Оригинальный навык: `devops/cdk-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
