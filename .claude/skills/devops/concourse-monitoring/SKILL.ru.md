...
version: "1.0"
language: ru
original: concourse-monitoring
---

# Concourse Monitoring

> Monitoring with Concourse. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/concourse-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
