...
version: "1.0"
language: ru
original: puppet-modules
---

# Puppet Modules

> Modules with Puppet. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Modules
...
## Ресурсы
- Оригинальный навык: `devops/puppet-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
