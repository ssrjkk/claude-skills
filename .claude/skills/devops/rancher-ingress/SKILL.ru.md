...
category: devops
tags: [rancher-ingress, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: rancher-ingress
---

# Rancher Ingress

> Ingress with Rancher. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Ingress
...
## Ресурсы
- Оригинальный навык: `devops/rancher-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
