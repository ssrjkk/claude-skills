...
version: "1.0"
language: ru
original: podman-volumes
---

# Podman Volumes

> Volumes with Podman. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Volumes
...
## Ресурсы
- Оригинальный навык: `devops/podman-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
