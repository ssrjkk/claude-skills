...
category: devops
tags: [singularity-compose, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: singularity-compose
---

# Singularity Compose

> Compose with Singularity. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Compose
...
## Ресурсы
- Оригинальный навык: `devops/singularity-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
