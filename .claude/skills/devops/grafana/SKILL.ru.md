...
> Creates dashboards and visualizations with Grafana, including Prometheus data sources, alerting, and annotations.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana
...
## Ресурсы
- Оригинальный навык: `devops/grafana/SKILL.md`
- Категория: DevOps
- Язык: Русский
