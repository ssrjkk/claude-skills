...
category: devops
tags: [terraform-deployment, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: terraform-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Deployment
...
## Ресурсы
- Оригинальный навык: devops/terraform-deployment/SKILL.md
- Категория: DevOps
- Язык: Русский
