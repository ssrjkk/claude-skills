...
version: "1.0"
language: ru
original: jenkins-secrets
---

# Jenkins Secrets

> Secrets with Jenkins. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Secrets
...
## Ресурсы
- Оригинальный навык: `devops/jenkins-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
