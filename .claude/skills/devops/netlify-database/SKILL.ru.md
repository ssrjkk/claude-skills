...
version: "1.0"
language: ru
original: netlify-database
---

# Netlify Database

> Database with Netlify. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify Database
...
## Ресурсы
- Оригинальный навык: `devops/netlify-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
