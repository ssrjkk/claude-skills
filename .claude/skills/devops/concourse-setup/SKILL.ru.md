...
version: "1.0"
language: ru
original: concourse-setup
---

# Concourse Setup

> Setup with Concourse. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Setup
...
## Ресурсы
- Оригинальный навык: `devops/concourse-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
