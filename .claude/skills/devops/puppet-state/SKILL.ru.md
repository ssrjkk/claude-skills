...
category: devops
tags: [puppet-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppet-state
---

# Puppet State

> State with Puppet. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet State
...
## Ресурсы
- Оригинальный навык: `devops/puppet-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
