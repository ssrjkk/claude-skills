...
version: "1.0"
language: ru
original: skopeo-security
---

# Skopeo Security

> Security with Skopeo. container security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Security
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
