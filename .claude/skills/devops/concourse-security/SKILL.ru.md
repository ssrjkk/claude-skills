...
version: "1.0"
language: ru
original: concourse-security
---

# Concourse Security

> Security with Concourse. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Security
...
## Ресурсы
- Оригинальный навык: `devops/concourse-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
