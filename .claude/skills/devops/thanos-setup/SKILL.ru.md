...
version: "1.0"
language: ru
original: thanos-setup
---

# Thanos Setup

> Setup with Thanos. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Setup
...
## Ресурсы
- Оригинальный навык: `devops/thanos-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
