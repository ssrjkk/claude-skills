...
version: "1.0"
language: ru
original: linkerd-troubleshooting
---

# Linkerd Troubleshooting

> Troubleshooting for Linkerd: troubleshooting common issues

## Быстрый старт
Этот навык на русском языке. Оригинал: linkerd-troubleshooting.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linkerd Troubleshooting
...
## Ресурсы
- devops/linkerd-troubleshooting/SKILL.md
- Категория: DevOps
