...
category: devops
tags: [nerdctl-volumes, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: nerdctl-volumes
---

# Nerdctl Volumes

> Volumes with nerdctl. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Volumes
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
