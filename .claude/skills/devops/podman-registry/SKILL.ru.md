...
category: devops
tags: [podman-registry, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: podman-registry
---

# Podman Registry

> Registry with Podman. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Registry
...
## Ресурсы
- Оригинальный навык: `devops/podman-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
