...
version: "1.0"
language: ru
original: minikube-rbac
---

# Minikube Rbac

> RBAC with Minikube. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Rbac
...
## Ресурсы
- Оригинальный навык: `devops/minikube-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
