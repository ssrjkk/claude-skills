...
version: "1.0"
language: ru
original: gke-monitoring
---

# Gke Monitoring

> Monitoring with Google GKE. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/gke-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
