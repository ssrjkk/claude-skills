...
> Helm with K0s. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Helm
...
## Ресурсы
- Оригинальный навык: `devops/k0s-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
