...
category: devops
tags: [teamcity-pipeline, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: teamcity-pipeline
---

# Teamcity Pipeline

> Pipeline with TeamCity. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
