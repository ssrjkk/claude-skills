...
version: "1.0"
language: ru
original: netlify-compute
---

# Netlify Compute

> Compute with Netlify. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify Compute
...
## Ресурсы
- Оригинальный навык: `devops/netlify-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
