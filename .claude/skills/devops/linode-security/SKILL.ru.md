...
version: "1.0"
language: ru
original: linode-security
---

# Linode Security

> Security with Linode. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Security
...
## Ресурсы
- Оригинальный навык: `devops/linode-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
