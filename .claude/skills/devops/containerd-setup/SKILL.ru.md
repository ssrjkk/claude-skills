...
version: "1.0"
language: ru
original: containerd-setup
---

# Containerd Setup

> Setup with containerd. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Setup
...
## Ресурсы
- Оригинальный навык: `devops/containerd-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
