...
version: "1.0"
language: ru
original: gitlab-ci-testing
---

# Gitlab Ci Testing

> Testing with GitLab CI. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Testing
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
