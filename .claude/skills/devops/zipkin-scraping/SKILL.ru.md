...
category: devops
tags: [zipkin-scraping, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zipkin-scraping
---

# Zipkin Scraping

> Scraping with Zipkin. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Scraping
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
