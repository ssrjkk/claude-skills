...
category: devops
tags: [packer-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: packer-cicd
---

# Packer Cicd

> CI/CD with Packer. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Cicd
...
## Ресурсы
- Оригинальный навык: `devops/packer-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
