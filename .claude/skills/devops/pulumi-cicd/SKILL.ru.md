...
version: "1.0"
language: ru
original: pulumi-cicd
---

# Pulumi Cicd

> CI/CD with Pulumi. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi Cicd
...
## Ресурсы
- Оригинальный навык: `devops/pulumi-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
