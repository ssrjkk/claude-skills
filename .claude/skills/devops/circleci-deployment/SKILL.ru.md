...
version: "1.0"
language: ru
original: circleci-deployment
---

# Circleci Deployment

> Deployment with CircleCI. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circleci-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Circleci Deployment
...
## Ресурсы
- Оригинальный навык: `devops/circleci-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
