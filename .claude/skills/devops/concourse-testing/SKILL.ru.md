...
version: "1.0"
language: ru
original: concourse-testing
---

# Concourse Testing

> Testing with Concourse. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Testing
...
## Ресурсы
- Оригинальный навык: `devops/concourse-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
