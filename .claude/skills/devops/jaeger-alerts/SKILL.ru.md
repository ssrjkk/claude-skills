...
category: devops
tags: [jaeger-alerts, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jaeger-alerts
---

# Jaeger Alerts

> Alerts with Jaeger. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Alerts
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
