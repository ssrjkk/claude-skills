...
category: devops
tags: [ansible-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ansible-security
---

# Ansible Security

> Security with Ansible. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Security
...
## Ресурсы
- Оригинальный навык: `devops/ansible-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
