...
category: devops
tags: [dagger-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: dagger-security
---

# Dagger Security

> Security with Dagger. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagger-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dagger Security
...
## Ресурсы
- Оригинальный навык: `devops/dagger-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
