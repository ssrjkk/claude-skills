...
version: "1.0"
language: ru
original: akamai-security
---

# Akamai Security

> Security with Akamai. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Security
...
## Ресурсы
- Оригинальный навык: `devops/akamai-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
