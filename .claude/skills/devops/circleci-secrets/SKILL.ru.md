...
version: "1.0"
language: ru
original: circleci-secrets
---

# Circleci Secrets

> Secrets with CircleCI. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circleci-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Circleci Secrets
...
## Ресурсы
- Оригинальный навык: `devops/circleci-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
