...
category: devops
tags: [k3s-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k3s-storage
---

# K3S Storage

> Storage with K3s. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Storage
...
## Ресурсы
- Оригинальный навык: `devops/k3s-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
