...
category: devops
tags: [containerd-compose, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: containerd-compose
---

# Containerd Compose

> Compose with containerd. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Compose
...
## Ресурсы
- Оригинальный навык: `devops/containerd-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
