...
version: "1.0"
language: ru
original: teamcity-caching
---

# Teamcity Caching

> Caching with TeamCity. dependency caching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-caching`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Caching
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-caching/SKILL.md`
- Категория: DevOps
- Язык: Русский
