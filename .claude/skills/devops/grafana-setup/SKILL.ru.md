...
version: "1.0"
language: ru
original: grafana-setup
---

# Grafana Setup

> Setup with Grafana. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Setup
...
## Ресурсы
- Оригинальный навык: `devops/grafana-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
