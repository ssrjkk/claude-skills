...
## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Testing
...
## Ресурсы
- Оригинальный навык: `devops/drone-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
