...
category: devops
tags: [kubernetes-autoscaling, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-autoscaling
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
