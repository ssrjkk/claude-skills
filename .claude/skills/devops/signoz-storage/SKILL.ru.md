...
category: devops
tags: [signoz-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: signoz-storage
---

# Signoz Storage

> Storage with SigNoz. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `signoz-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Signoz Storage
...
## Ресурсы
- Оригинальный навык: `devops/signoz-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
