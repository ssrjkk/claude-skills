...
> Helm with Google GKE. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Helm
...
## Ресурсы
- Оригинальный навык: `devops/gke-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
