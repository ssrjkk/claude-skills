...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Rbac
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
