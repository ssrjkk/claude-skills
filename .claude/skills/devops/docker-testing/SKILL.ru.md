...
category: devops
tags: [docker-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: docker-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Testing
...
## Ресурсы
- Оригинальный навык: devops/docker-testing/SKILL.md
- Категория: DevOps
- Язык: Русский
