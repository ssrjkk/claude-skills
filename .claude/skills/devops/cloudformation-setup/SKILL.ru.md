...
## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudformation-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudformation Setup
...
## Ресурсы
- Оригинальный навык: `devops/cloudformation-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
