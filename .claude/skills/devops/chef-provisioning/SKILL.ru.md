...
category: devops
tags: [chef-provisioning, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chef-provisioning
---

# Chef Provisioning

> Provisioning with Chef. provisioning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-provisioning`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Provisioning
...
## Ресурсы
- Оригинальный навык: `devops/chef-provisioning/SKILL.md`
- Категория: DevOps
- Язык: Русский
