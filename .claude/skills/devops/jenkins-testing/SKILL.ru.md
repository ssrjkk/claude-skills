...
category: devops
tags: [jenkins-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jenkins-testing
---

# Jenkins Testing

> Testing with Jenkins. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Testing
...
## Ресурсы
- Оригинальный навык: `devops/jenkins-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
