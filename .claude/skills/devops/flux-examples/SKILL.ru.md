...
category: devops
tags: [flux-examples, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flux-examples
---

# Flux Examples

> Examples for Flux: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `flux-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flux Examples
...
## Ресурсы
- Оригинал: devops/flux-examples/SKILL.md
- Категория: DevOps
