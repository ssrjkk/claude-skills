...
category: devops
tags: [k0s-secrets, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k0s-secrets
---

# K0S Secrets

> Secrets with K0s. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Secrets
...
## Ресурсы
- Оригинальный навык: `devops/k0s-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
