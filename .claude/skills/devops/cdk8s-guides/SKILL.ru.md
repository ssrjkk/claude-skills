...
version: "1.0"
language: ru
original: cdk8s-guides
---

# Cdk8S Guides

> Guides for Cdk8S: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cdk8s-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk8S Guides
...
## Ресурсы
- Оригинал: devops/cdk8s-guides/SKILL.md
- Категория: DevOps
