...
> Deploys frontend applications with Vercel, including serverless functions, preview deployments, and edge functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vercel`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vercel
...
## Ресурсы
- Оригинальный навык: `devops/vercel/SKILL.md`
- Категория: DevOps
- Язык: Русский
