...
> Service with Kubernetes. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Service
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
