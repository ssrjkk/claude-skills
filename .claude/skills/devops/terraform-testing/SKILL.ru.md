...
version: "1.0"
language: ru
original: terraform-testing
---

# Terraform Testing

> Testing with Terraform. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Testing
...
## Ресурсы
- Оригинальный навык: `devops/terraform-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
