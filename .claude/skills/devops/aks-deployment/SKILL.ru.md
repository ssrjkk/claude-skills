...
version: "1.0"
language: ru
original: aks-deployment
---

# Aks Deployment

> Deployment with Azure AKS. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Deployment
...
## Ресурсы
- Оригинальный навык: `devops/aks-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
