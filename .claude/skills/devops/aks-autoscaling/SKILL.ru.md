...
version: "1.0"
language: ru
original: aks-autoscaling
---

# Aks Autoscaling

> Autoscaling with Azure AKS. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/aks-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
