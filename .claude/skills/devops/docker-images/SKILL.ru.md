...
category: devops
tags: [docker-images, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
...
> Images with Docker. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Images
...
## Ресурсы
- Оригинальный навык: `devops/docker-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
