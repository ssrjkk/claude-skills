...
category: devops
tags: [gke-autoscaling, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gke-autoscaling
---

# Gke Autoscaling

> Autoscaling with Google GKE. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/gke-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
