...
## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Deployment
...
## Ресурсы
- Оригинальный навык: devops/docker-deployment/SKILL.md
- Категория: DevOps
- Язык: Русский
