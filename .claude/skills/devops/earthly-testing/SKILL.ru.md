...
category: devops
tags: [earthly-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: earthly-testing
---

# Earthly Testing

> Testing with Earthly. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Testing
...
## Ресурсы
- Оригинальный навык: `devops/earthly-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
