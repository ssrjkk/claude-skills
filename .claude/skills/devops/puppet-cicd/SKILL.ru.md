...
category: devops
tags: [puppet-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppet-cicd
---

# Puppet Cicd

> CI/CD with Puppet. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Cicd
...
## Ресурсы
- Оригинальный навык: `devops/puppet-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
