...
version: "1.0"
language: ru
original: thanos-logging
---

# Thanos Logging

> Logging with Thanos. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Logging
...
## Ресурсы
- Оригинальный навык: `devops/thanos-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
