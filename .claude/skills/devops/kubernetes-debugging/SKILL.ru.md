...
category: devops
tags: [kubernetes-debugging, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-debugging
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-debugging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Debugging
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-debugging/SKILL.md
- Категория: DevOps
- Язык: Русский
