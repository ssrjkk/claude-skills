...
category: devops
tags: [github-actions-basics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: github-actions-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Basics
...
## Ресурсы
- Оригинальный навык: devops/github-actions-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
