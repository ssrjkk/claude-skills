...
version: "1.0"
language: ru
original: k3s-service
---

# K3S Service

> Service with K3s. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Service
...
## Ресурсы
- Оригинальный навык: `devops/k3s-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
