...
version: "1.0"
language: ru
original: eks-ingress
---

# Eks Ingress

> Ingress with Amazon EKS. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Ingress
...
## Ресурсы
- Оригинальный навык: `devops/eks-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
