...
category: devops
tags: [lxc-compose, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: lxc-compose
---

# Lxc Compose

> Compose with LXC. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Compose
...
## Ресурсы
- Оригинальный навык: `devops/lxc-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
