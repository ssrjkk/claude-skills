...
version: "1.0"
language: ru
original: cilium-getting-started
---

# Cilium Getting Started

> Getting Started for Cilium: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: cilium-getting-started.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cilium Getting Started
...
## Ресурсы
- devops/cilium-getting-started/SKILL.md
- Категория: DevOps
