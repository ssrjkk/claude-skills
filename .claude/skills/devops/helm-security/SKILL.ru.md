...
## Быстрый старт
Этот навык на русском языке. Оригинал: `helm-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Helm Security
...
## Ресурсы
- Оригинальный навык: devops/helm-security/SKILL.md
- Категория: DevOps
- Язык: Русский
