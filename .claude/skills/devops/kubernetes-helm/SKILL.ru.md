...
category: devops
tags: [kubernetes-helm, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-helm
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Helm
...
## Ресурсы
- Оригинальный навык: `devops/kubernetes-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
