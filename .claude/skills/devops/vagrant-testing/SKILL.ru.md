...
version: "1.0"
language: ru
original: vagrant-testing
---

# Vagrant Testing

> Testing with Vagrant. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vagrant-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vagrant Testing
...
## Ресурсы
- Оригинальный навык: `devops/vagrant-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
