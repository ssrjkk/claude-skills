...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Testing
...
## Ресурсы
- Оригинальный навык: devops/prometheus-testing/SKILL.md
- Категория: DevOps
- Язык: Русский
