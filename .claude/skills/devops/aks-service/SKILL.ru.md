...
category: devops
tags: [aks-service, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aks-service
---

# Aks Service

> Service with Azure AKS. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Service
...
## Ресурсы
- Оригинальный навык: `devops/aks-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
