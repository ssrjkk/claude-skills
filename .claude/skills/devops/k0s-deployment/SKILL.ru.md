...
version: "1.0"
language: ru
original: k0s-deployment
---

# K0S Deployment

> Deployment with K0s. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Deployment
...
## Ресурсы
- Оригинальный навык: `devops/k0s-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
