...
version: "1.0"
language: ru
original: akamai-networking
---

# Akamai Networking

> Networking with Akamai. VPC.

## Быстрый старт
Этот навык на русском языке. Оригинал: `akamai-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Akamai Networking
...
## Ресурсы
- Оригинальный навык: `devops/akamai-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
