...
version: "1.0"
language: ru
original: digitalocean-compute
---

# Digitalocean Compute

> Compute with DigitalOcean. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Compute
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
