...
version: "1.0"
language: ru
original: terraform-security
---

# Terraform Security

> Security with Terraform. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Security
...
## Ресурсы
- Оригинальный навык: `devops/terraform-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
