...
version: "1.0"
language: ru
original: k0s-service
---

# K0S Service

> Service with K0s. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Service
...
## Ресурсы
- Оригинальный навык: `devops/k0s-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
