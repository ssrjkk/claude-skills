...
category: devops
tags: [woodpecker-secrets, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: woodpecker-secrets
---

# Woodpecker Secrets

> Secrets with Woodpecker. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Secrets
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
