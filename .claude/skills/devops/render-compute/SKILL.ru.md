...
version: "1.0"
language: ru
original: render-compute
---

# Render Compute

> Compute with Render. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `render-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Render Compute
...
## Ресурсы
- Оригинальный навык: `devops/render-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
