...
category: devops
tags: [gcp-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gcp-security
---

# Gcp Security

> Security with GCP. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gcp-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gcp Security
...
## Ресурсы
- Оригинальный навык: `devops/gcp-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
