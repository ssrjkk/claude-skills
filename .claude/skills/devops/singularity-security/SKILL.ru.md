...
## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Security
...
## Ресурсы
- Оригинальный навык: `devops/singularity-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
