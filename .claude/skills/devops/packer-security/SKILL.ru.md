...
version: "1.0"
language: ru
original: packer-security
---

# Packer Security

> Security with Packer. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `packer-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Packer Security
...
## Ресурсы
- Оригинальный навык: `devops/packer-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
