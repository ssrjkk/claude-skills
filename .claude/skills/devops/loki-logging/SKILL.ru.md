...
category: devops
tags: [loki-logging, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: loki-logging
---

# Loki Logging

> Logging with Loki. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Logging
...
## Ресурсы
- Оригинальный навык: `devops/loki-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
