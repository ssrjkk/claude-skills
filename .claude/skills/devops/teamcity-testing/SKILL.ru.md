...
category: devops
tags: [teamcity-testing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: teamcity-testing
---

# Teamcity Testing

> Testing with TeamCity. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Testing
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
