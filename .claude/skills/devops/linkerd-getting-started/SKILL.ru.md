...
version: "1.0"
language: ru
original: linkerd-getting-started
---

# Linkerd Getting Started

> Getting Started for Linkerd: initial setup and first steps

## Быстрый старт
Этот навык на русском языке. Оригинал: linkerd-getting-started.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linkerd Getting Started
...
## Ресурсы
- devops/linkerd-getting-started/SKILL.md
- Категория: DevOps
