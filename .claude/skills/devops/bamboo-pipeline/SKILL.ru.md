...
version: "1.0"
language: ru
original: bamboo-pipeline
---

# Bamboo Pipeline

> Pipeline with Bamboo. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
