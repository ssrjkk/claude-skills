...
category: devops
tags: [argo-rollouts-fundamentals, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argo-rollouts-fundamentals
---

# Argo Rollouts Fundamentals

> Fundamentals for Argo-Rollouts: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-rollouts-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Rollouts Fundamentals
...
## Ресурсы
- Оригинал: devops/argo-rollouts-fundamentals/SKILL.md
- Категория: DevOps
