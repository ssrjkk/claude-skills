...
version: "1.0"
language: ru
original: k3s-autoscaling
---

# K3S Autoscaling

> Autoscaling with K3s. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k3s-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K3S Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/k3s-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
