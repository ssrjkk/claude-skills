...
category: devops
tags: [chef-modules, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: chef-modules
---

# Chef Modules

> Modules with Chef. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `chef-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Chef Modules
...
## Ресурсы
- Оригинальный навык: `devops/chef-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
