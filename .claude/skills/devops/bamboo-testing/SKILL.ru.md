...
version: "1.0"
language: ru
original: bamboo-testing
---

# Bamboo Testing

> Testing with Bamboo. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Testing
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
