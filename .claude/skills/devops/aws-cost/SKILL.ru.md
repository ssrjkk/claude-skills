...
> Cost with AWS. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aws-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aws Cost
...
## Ресурсы
- Оригинальный навык: `devops/aws-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
