...
category: devops
tags: [grafana-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: grafana-metrics
---

# Grafana Metrics

> Metrics with Grafana. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Metrics
...
## Ресурсы
- Оригинальный навык: `devops/grafana-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
