...
version: "1.0"
language: ru
original: rancher-secrets
---

# Rancher Secrets

> Secrets with Rancher. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Secrets
...
## Ресурсы
- Оригинальный навык: `devops/rancher-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
