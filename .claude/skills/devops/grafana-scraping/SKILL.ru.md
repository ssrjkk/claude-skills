...
version: "1.0"
language: ru
original: grafana-scraping
---

# Grafana Scraping

> Scraping with Grafana. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Scraping
...
## Ресурсы
- Оригинальный навык: `devops/grafana-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
