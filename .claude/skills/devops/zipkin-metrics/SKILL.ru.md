...
category: devops
tags: [zipkin-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: zipkin-metrics
---

# Zipkin Metrics

> Metrics with Zipkin. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Metrics
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
