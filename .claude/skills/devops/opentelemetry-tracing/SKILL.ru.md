...
version: "1.0"
language: ru
original: opentelemetry-tracing
---

# Opentelemetry Tracing

> Tracing with OpenTelemetry. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentelemetry-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentelemetry Tracing
...
## Ресурсы
- Оригинальный навык: `devops/opentelemetry-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
