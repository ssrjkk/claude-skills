...
category: devops
tags: [tempo-scraping, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: tempo-scraping
---

# Tempo Scraping

> Scraping with Tempo. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `tempo-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Tempo Scraping
...
## Ресурсы
- Оригинальный навык: `devops/tempo-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
