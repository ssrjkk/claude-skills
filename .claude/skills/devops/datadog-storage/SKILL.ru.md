...
version: "1.0"
language: ru
original: datadog-storage
---

# Datadog Storage

> Storage with Datadog. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `datadog-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Datadog Storage
...
## Ресурсы
- Оригинальный навык: `devops/datadog-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
