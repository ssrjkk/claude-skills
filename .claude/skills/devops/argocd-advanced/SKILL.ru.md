...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Advanced
...
## Ресурсы
- Оригинальный навык: devops/argocd-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
