...
category: devops
tags: [heroku-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: heroku-storage
---

# Heroku Storage

> Storage with Heroku. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heroku-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Heroku Storage
...
## Ресурсы
- Оригинальный навык: `devops/heroku-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
