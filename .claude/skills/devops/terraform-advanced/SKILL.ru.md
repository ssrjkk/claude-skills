...
category: devops
tags: [terraform-advanced, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: terraform-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Advanced
...
## Ресурсы
- Оригинальный навык: devops/terraform-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
