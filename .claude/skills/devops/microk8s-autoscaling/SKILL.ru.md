...
version: "1.0"
language: ru
original: microk8s-autoscaling
---

# Microk8S Autoscaling

> Autoscaling with MicroK8s. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
