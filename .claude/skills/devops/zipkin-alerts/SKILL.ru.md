...
version: "1.0"
language: ru
original: zipkin-alerts
---

# Zipkin Alerts

> Alerts with Zipkin. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `zipkin-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Zipkin Alerts
...
## Ресурсы
- Оригинальный навык: `devops/zipkin-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
