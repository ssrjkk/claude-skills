...
> Cost with Azure. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Cost
...
## Ресурсы
- Оригинальный навык: `devops/azure-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
