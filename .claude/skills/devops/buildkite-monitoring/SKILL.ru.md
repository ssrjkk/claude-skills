...
version: "1.0"
language: ru
original: buildkite-monitoring
---

# Buildkite Monitoring

> Monitoring with Buildkite. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildkite-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildkite Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/buildkite-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
