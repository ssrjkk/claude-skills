...
version: "1.0"
language: ru
original: docker-volumes
---

# Docker Volumes

> Volumes with Docker. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Volumes
...
## Ресурсы
- Оригинальный навык: `devops/docker-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
