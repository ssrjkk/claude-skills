...
category: devops
tags: [teamcity-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: teamcity-setup
---

# Teamcity Setup

> Setup with TeamCity. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `teamcity-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Teamcity Setup
...
## Ресурсы
- Оригинальный навык: `devops/teamcity-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
