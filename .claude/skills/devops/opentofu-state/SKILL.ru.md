...
version: "1.0"
language: ru
original: opentofu-state
---

# Opentofu State

> State with OpenTofu. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu State
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
