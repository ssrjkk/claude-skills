...
version: "1.0"
language: ru
original: datadog-logging
---

# Datadog Logging

> Logging with Datadog. log collection.

## Быстрый старт
Этот навык на русском языке. Оригинал: `datadog-logging`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Datadog Logging
...
## Ресурсы
- Оригинальный навык: `devops/datadog-logging/SKILL.md`
- Категория: DevOps
- Язык: Русский
