...
version: "1.0"
language: ru
original: containerd-networking
---

# Containerd Networking

> Networking with containerd. container networks.

## Быстрый старт
Этот навык на русском языке. Оригинал: `containerd-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Containerd Networking
...
## Ресурсы
- Оригинальный навык: `devops/containerd-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
