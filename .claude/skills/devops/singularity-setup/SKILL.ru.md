...
category: devops
tags: [singularity-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: singularity-setup
---

# Singularity Setup

> Setup with Singularity. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Setup
...
## Ресурсы
- Оригинальный навык: `devops/singularity-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
