...
version: "1.0"
language: ru
original: buildkite-testing
---

# Buildkite Testing

> Testing with Buildkite. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildkite-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildkite Testing
...
## Ресурсы
- Оригинальный навык: `devops/buildkite-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
