...
category: devops
tags: [argocd-api, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argocd-api
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-api`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Api
...
## Ресурсы
- Оригинальный навык: devops/argocd-api/SKILL.md
- Категория: DevOps
- Язык: Русский
