...
category: devops
tags: [loki-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: loki-storage
---

# Loki Storage

> Storage with Loki. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Storage
...
## Ресурсы
- Оригинальный навык: `devops/loki-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
