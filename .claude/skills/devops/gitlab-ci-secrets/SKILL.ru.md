...
version: "1.0"
language: ru
original: gitlab-ci-secrets
---

# Gitlab Ci Secrets

> Secrets with GitLab CI. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Secrets
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
