...
category: devops
tags: [digitalocean-cost, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: digitalocean-cost
---

# Digitalocean Cost

> Cost with DigitalOcean. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `digitalocean-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Digitalocean Cost
...
## Ресурсы
- Оригинальный навык: `devops/digitalocean-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
