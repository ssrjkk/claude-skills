...
## Быстрый старт
Этот навык на русском языке. Оригинал: `grafana-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Grafana Security
...
## Ресурсы
- Оригинальный навык: devops/grafana-security/SKILL.md
- Категория: DevOps
- Язык: Русский
