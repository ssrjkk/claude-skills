...
version: "1.0"
language: ru
original: nerdctl-registry
---

# Nerdctl Registry

> Registry with nerdctl. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `nerdctl-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Nerdctl Registry
...
## Ресурсы
- Оригинальный навык: `devops/nerdctl-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
