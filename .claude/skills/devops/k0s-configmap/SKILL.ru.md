...
category: devops
tags: [k0s-configmap, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: k0s-configmap
---

# K0S Configmap

> ConfigMap with K0s. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `k0s-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с K0S Configmap
...
## Ресурсы
- Оригинальный навык: `devops/k0s-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
