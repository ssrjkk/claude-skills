...
version: "1.0"
language: ru
original: thanos-scraping
---

# Thanos Scraping

> Scraping with Thanos. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Scraping
...
## Ресурсы
- Оригинальный навык: `devops/thanos-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
