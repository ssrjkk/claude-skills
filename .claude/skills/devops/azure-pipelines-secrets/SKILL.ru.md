...
version: "1.0"
language: ru
original: azure-pipelines-secrets
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-pipelines-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Pipelines Secrets
...
## Ресурсы
- Оригинальный навык: `devops/azure-pipelines-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
