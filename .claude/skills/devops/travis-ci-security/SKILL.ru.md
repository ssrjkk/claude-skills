...
version: "1.0"
language: ru
original: travis-ci-security
---

# Travis Ci Security

> Security with Travis CI. security scanning.

## Быстрый старт
Этот навык на русском языке. Оригинал: `travis-ci-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Travis Ci Security
...
## Ресурсы
- Оригинальный навык: `devops/travis-ci-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
