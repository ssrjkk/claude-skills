...
category: devops
tags: [azure-compute, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: azure-compute
---

# Azure Compute

> Compute with Azure. VM/compute.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-compute`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Compute
...
## Ресурсы
- Оригинальный навык: `devops/azure-compute/SKILL.md`
- Категория: DevOps
- Язык: Русский
