...
> Helm with Amazon EKS. package management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-helm`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Helm
...
## Ресурсы
- Оригинальный навык: `devops/eks-helm/SKILL.md`
- Категория: DevOps
- Язык: Русский
