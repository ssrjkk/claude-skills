...
## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify Storage
...
## Ресурсы
- Оригинальный навык: `devops/netlify-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
