...
version: "1.0"
language: ru
original: opentofu-testing
---

# Opentofu Testing

> Testing with OpenTofu. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Testing
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
