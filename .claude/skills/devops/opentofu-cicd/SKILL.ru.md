...
## Быстрый старт
Этот навык на русском языке. Оригинал: `opentofu-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Opentofu Cicd
...
## Ресурсы
- Оригинальный навык: `devops/opentofu-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
