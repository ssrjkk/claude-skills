...
version: "1.0"
language: ru
original: dagger-testing
---

# Dagger Testing

> Testing with Dagger. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `dagger-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Dagger Testing
...
## Ресурсы
- Оригинальный навык: `devops/dagger-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
