...
category: devops
tags: [flyio-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: flyio-security
---

# Flyio Security

> Security with Fly.io. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Security
...
## Ресурсы
- Оригинальный навык: `devops/flyio-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
