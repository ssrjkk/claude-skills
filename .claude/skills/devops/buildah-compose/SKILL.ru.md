...
category: devops
tags: [buildah-compose, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: buildah-compose
---

# Buildah Compose

> Compose with Buildah. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `buildah-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Buildah Compose
...
## Ресурсы
- Оригинальный навык: `devops/buildah-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
