...
category: devops
tags: [puppet-security, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: puppet-security
---

# Puppet Security

> Security with Puppet. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `puppet-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Puppet Security
...
## Ресурсы
- Оригинальный навык: `devops/puppet-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
