...
version: "1.0"
language: ru
original: eks-deployment
---

# Eks Deployment

> Deployment with Amazon EKS. apps deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `eks-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Eks Deployment
...
## Ресурсы
- Оригинальный навык: `devops/eks-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
