...
version: "1.0"
language: ru
original: linode-storage
---

# Linode Storage

> Storage with Linode. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Storage
...
## Ресурсы
- Оригинальный навык: `devops/linode-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
