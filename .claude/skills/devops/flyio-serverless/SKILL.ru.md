...
version: "1.0"
language: ru
original: flyio-serverless
---

# Flyio Serverless

> Serverless with Fly.io. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Serverless
...
## Ресурсы
- Оригинальный навык: `devops/flyio-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
