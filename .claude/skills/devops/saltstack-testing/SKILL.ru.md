...
version: "1.0"
language: ru
original: saltstack-testing
---

# Saltstack Testing

> Testing with SaltStack. infra testing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack Testing
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
