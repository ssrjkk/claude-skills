...
version: "1.0"
language: ru
original: concourse-deployment
---

# Concourse Deployment

> Deployment with Concourse. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `concourse-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Concourse Deployment
...
## Ресурсы
- Оригинальный навык: `devops/concourse-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
