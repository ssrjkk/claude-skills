...
category: devops
tags: [saltstack-state, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: saltstack-state
---

# Saltstack State

> State with SaltStack. state management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `saltstack-state`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Saltstack State
...
## Ресурсы
- Оригинальный навык: `devops/saltstack-state/SKILL.md`
- Категория: DevOps
- Язык: Русский
