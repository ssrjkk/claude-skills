...
version: "1.0"
language: ru
original: cdk8s-quickstart
---

# Cdk8S Quickstart

> Quickstart for Cdk8S: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `cdk8s-quickstart`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk8S Quickstart
...
## Ресурсы
- Оригинал: devops/cdk8s-quickstart/SKILL.md
- Категория: DevOps
