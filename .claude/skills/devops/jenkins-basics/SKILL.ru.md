...
category: devops
tags: [jenkins-basics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jenkins-basics
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Basics
...
## Ресурсы
- Оригинальный навык: devops/jenkins-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
