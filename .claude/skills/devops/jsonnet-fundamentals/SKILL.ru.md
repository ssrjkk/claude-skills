...
category: devops
tags: [jsonnet-fundamentals, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jsonnet-fundamentals
---

# Jsonnet Fundamentals

> Fundamentals for Jsonnet: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `jsonnet-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jsonnet Fundamentals
...
## Ресурсы
- Оригинал: devops/jsonnet-fundamentals/SKILL.md
- Категория: DevOps
