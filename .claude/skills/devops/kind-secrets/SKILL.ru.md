...
version: "1.0"
language: ru
original: kind-secrets
---

# Kind Secrets

> Secrets with Kind. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Secrets
...
## Ресурсы
- Оригинальный навык: `devops/kind-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
