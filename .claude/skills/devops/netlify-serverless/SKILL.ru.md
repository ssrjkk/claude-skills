...
## Быстрый старт
Этот навык на русском языке. Оригинал: `netlify-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Netlify Serverless
...
## Ресурсы
- Оригинальный навык: `devops/netlify-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
