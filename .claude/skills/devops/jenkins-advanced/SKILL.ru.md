...
## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Advanced
...
## Ресурсы
- Оригинальный навык: devops/jenkins-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
