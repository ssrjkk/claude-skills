...
version: "1.0"
language: ru
original: flyio-monitoring
---

# Flyio Monitoring

> Monitoring with Fly.io. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/flyio-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
