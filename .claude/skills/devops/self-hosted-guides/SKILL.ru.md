...
category: devops
tags: [self-hosted-guides, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: self-hosted-guides
---

# Self Hosted Guides

> Guides for Self-Hosted: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `self-hosted-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Self Hosted Guides
...
## Ресурсы
- Оригинал: devops/self-hosted-guides/SKILL.md
- Категория: DevOps
