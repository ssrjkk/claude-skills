...
category: devops
tags: [aks-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: aks-storage
---

# Aks Storage

> Storage with Azure AKS. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Storage
...
## Ресурсы
- Оригинальный навык: `devops/aks-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
