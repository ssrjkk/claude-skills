...
version: "1.0"
language: ru
original: loki-dashboards
---

# Loki Dashboards

> Dashboards with Loki. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/loki-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
