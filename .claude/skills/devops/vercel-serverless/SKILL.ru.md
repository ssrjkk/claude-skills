...
> Serverless with Vercel. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vercel-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vercel Serverless
...
## Ресурсы
- Оригинальный навык: `devops/vercel-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
