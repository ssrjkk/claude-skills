...
version: "1.0"
language: ru
original: crossplane-setup
---

# Crossplane Setup

> Setup with Crossplane. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane Setup
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
