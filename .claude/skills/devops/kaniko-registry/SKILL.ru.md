...
version: "1.0"
language: ru
original: kaniko-registry
---

# Kaniko Registry

> Registry with Kaniko. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kaniko-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kaniko Registry
...
## Ресурсы
- Оригинальный навык: `devops/kaniko-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
