...
version: "1.0"
language: ru
original: thanos-tracing
---

# Thanos Tracing

> Tracing with Thanos. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Tracing
...
## Ресурсы
- Оригинальный навык: `devops/thanos-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
