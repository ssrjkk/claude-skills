...
version: "1.0"
language: ru
original: azure-pipelines-testing
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-pipelines-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Pipelines Testing
...
## Ресурсы
- Оригинальный навык: `devops/azure-pipelines-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
