...
> Cost with Fly.io. cost optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `flyio-cost`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flyio Cost
...
## Ресурсы
- Оригинальный навык: `devops/flyio-cost/SKILL.md`
- Категория: DevOps
- Язык: Русский
