...
version: "1.0"
language: ru
original: kaniko-images
---

# Kaniko Images

> Images with Kaniko. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kaniko-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kaniko Images
...
## Ресурсы
- Оригинальный навык: `devops/kaniko-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
