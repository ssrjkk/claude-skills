...
version: "1.0"
language: ru
original: terraform-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Optimization
...
## Ресурсы
- Оригинальный навык: devops/terraform-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
