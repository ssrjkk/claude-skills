...
category: devops
tags: [jaeger-dashboards, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: jaeger-dashboards
---

# Jaeger Dashboards

> Dashboards with Jaeger. dashboards.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jaeger-dashboards`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jaeger Dashboards
...
## Ресурсы
- Оригинальный навык: `devops/jaeger-dashboards/SKILL.md`
- Категория: DevOps
- Язык: Русский
