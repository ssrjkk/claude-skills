...
version: "1.0"
language: ru
original: cdk-modules
---

# Cdk Modules

> Modules with AWS CDK. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cdk-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cdk Modules
...
## Ресурсы
- Оригинальный навык: `devops/cdk-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
