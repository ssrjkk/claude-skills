...
## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-caching`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Caching
...
## Ресурсы
- Оригинальный навык: `devops/drone-caching/SKILL.md`
- Категория: DevOps
- Язык: Русский
