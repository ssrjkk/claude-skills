...
version: "1.0"
language: ru
original: vagrant-security
---

# Vagrant Security

> Security with Vagrant. security groups.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vagrant-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vagrant Security
...
## Ресурсы
- Оригинальный навык: `devops/vagrant-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
