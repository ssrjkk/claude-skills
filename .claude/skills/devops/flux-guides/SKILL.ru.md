...
version: "1.0"
language: ru
original: flux-guides
---

# Flux Guides

> Guides for Flux: how-to guides

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `flux-guides`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flux Guides
...
## Ресурсы
- Оригинал: devops/flux-guides/SKILL.md
- Категория: DevOps
