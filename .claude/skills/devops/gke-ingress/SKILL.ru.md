...
## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Ingress
...
## Ресурсы
- Оригинальный навык: `devops/gke-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
