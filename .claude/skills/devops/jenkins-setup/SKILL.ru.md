...
version: "1.0"
language: ru
original: jenkins-setup
---

# Jenkins Setup

> Setup with Jenkins. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `jenkins-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Jenkins Setup
...
## Ресурсы
- Оригинальный навык: `devops/jenkins-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
