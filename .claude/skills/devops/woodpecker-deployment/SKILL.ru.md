...
version: "1.0"
language: ru
original: woodpecker-deployment
---

# Woodpecker Deployment

> Deployment with Woodpecker. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `woodpecker-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Woodpecker Deployment
...
## Ресурсы
- Оригинальный навык: `devops/woodpecker-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
