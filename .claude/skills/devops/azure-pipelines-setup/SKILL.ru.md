...
category: devops
tags: [azure-pipelines-setup, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: azure-pipelines-setup
---

# Azure Pipelines Setup

> Setup with Azure Pipelines. pipeline setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-pipelines-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Pipelines Setup
...
## Ресурсы
- Оригинальный навык: `devops/azure-pipelines-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
