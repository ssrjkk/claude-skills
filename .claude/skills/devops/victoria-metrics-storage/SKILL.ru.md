...
category: devops
tags: [victoria-metrics-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: victoria-metrics-storage
---

# Victoria Metrics Storage

> Storage with VictoriaMetrics. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `victoria-metrics-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Victoria Metrics Storage
...
## Ресурсы
- Оригинальный навык: `devops/victoria-metrics-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
