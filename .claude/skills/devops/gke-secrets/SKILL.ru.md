...
category: devops
tags: [gke-secrets, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gke-secrets
---

# Gke Secrets

> Secrets with Google GKE. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gke-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gke Secrets
...
## Ресурсы
- Оригинальный навык: `devops/gke-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
