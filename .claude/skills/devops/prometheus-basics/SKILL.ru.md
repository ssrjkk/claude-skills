...
## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Basics
...
## Ресурсы
- Оригинальный навык: devops/prometheus-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
