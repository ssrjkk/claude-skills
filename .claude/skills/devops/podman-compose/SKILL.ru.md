...
version: "1.0"
language: ru
original: podman-compose
---

# Podman Compose

> Compose with Podman. multi-container.

## Быстрый старт
Этот навык на русском языке. Оригинал: `podman-compose`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Podman Compose
...
## Ресурсы
- Оригинальный навык: `devops/podman-compose/SKILL.md`
- Категория: DevOps
- Язык: Русский
