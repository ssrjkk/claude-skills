...
category: devops
tags: [github-actions-optimization, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: github-actions-optimization
---

# Github Actions Optimization

> Optimization for Github-Actions: performance tuning and optimization

## Быстрый старт
Этот навык на русском языке. Оригинал: `github-actions-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Github Actions Optimization
...
## Ресурсы
- Оригинальный навык: devops/github-actions-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
