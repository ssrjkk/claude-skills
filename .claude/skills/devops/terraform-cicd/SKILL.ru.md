...
category: devops
tags: [terraform-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: terraform-cicd
---

# Terraform Cicd

> CI/CD with Terraform. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `terraform-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Terraform Cicd
...
## Ресурсы
- Оригинальный навык: `devops/terraform-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
