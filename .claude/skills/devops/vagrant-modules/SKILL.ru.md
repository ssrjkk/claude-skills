...
version: "1.0"
language: ru
original: vagrant-modules
---

# Vagrant Modules

> Modules with Vagrant. modules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `vagrant-modules`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Vagrant Modules
...
## Ресурсы
- Оригинальный навык: `devops/vagrant-modules/SKILL.md`
- Категория: DevOps
- Язык: Русский
