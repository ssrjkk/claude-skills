...
version: "1.0"
language: ru
original: loki-scraping
---

# Loki Scraping

> Scraping with Loki. target discovery.

## Быстрый старт
Этот навык на русском языке. Оригинал: `loki-scraping`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Loki Scraping
...
## Ресурсы
- Оригинальный навык: `devops/loki-scraping/SKILL.md`
- Категория: DevOps
- Язык: Русский
