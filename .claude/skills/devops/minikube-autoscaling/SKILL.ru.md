...
category: devops
tags: [minikube-autoscaling, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: minikube-autoscaling
---

# Minikube Autoscaling

> Autoscaling with Minikube. HPA.

## Быстрый старт
Этот навык на русском языке. Оригинал: `minikube-autoscaling`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Minikube Autoscaling
...
## Ресурсы
- Оригинальный навык: `devops/minikube-autoscaling/SKILL.md`
- Категория: DevOps
- Язык: Русский
