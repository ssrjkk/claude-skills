...
version: "1.0"
language: ru
original: travis-ci-secrets
---

# Travis Ci Secrets

> Secrets with Travis CI. secret management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `travis-ci-secrets`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Travis Ci Secrets
...
## Ресурсы
- Оригинальный навык: `devops/travis-ci-secrets/SKILL.md`
- Категория: DevOps
- Язык: Русский
