...
category: devops
tags: [docker-advanced, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: docker-advanced
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-advanced`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Advanced
...
## Ресурсы
- Оригинальный навык: devops/docker-advanced/SKILL.md
- Категория: DevOps
- Язык: Русский
