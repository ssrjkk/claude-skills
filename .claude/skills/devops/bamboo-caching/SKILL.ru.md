...
version: "1.0"
language: ru
original: bamboo-caching
---

# Bamboo Caching

> Caching with Bamboo. dependency caching.

## Быстрый старт
Этот навык на русском языке. Оригинал: `bamboo-caching`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Bamboo Caching
...
## Ресурсы
- Оригинальный навык: `devops/bamboo-caching/SKILL.md`
- Категория: DevOps
- Язык: Русский
