...
version: "1.0"
language: ru
original: prometheus-setup
---

# Prometheus Setup

> Setup with Prometheus. installation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Setup
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
