...
version: "1.0"
language: ru
original: microk8s-ingress
---

# Microk8S Ingress

> Ingress with MicroK8s. ingress controller.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-ingress`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Ingress
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-ingress/SKILL.md`
- Категория: DevOps
- Язык: Русский
