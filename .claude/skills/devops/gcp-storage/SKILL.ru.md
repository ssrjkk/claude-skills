...
version: "1.0"
language: ru
original: gcp-storage
---

# Gcp Storage

> Storage with GCP. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gcp-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gcp Storage
...
## Ресурсы
- Оригинальный навык: `devops/gcp-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
