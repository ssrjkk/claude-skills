...
category: devops
tags: [skopeo-registry, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: skopeo-registry
---

# Skopeo Registry

> Registry with Skopeo. image registry.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-registry`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Registry
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-registry/SKILL.md`
- Категория: DevOps
- Язык: Русский
