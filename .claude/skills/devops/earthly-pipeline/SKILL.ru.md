...
version: "1.0"
language: ru
original: earthly-pipeline
---

# Earthly Pipeline

> Pipeline with Earthly. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/earthly-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
