...
version: "1.0"
language: ru
original: skopeo-optimization
---

# Skopeo Optimization

> Optimization with Skopeo. image optimization.

## Быстрый старт
Этот навык на русском языке. Оригинал: `skopeo-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Skopeo Optimization
...
## Ресурсы
- Оригинальный навык: `devops/skopeo-optimization/SKILL.md`
- Категория: DevOps
- Язык: Русский
