...
## Быстрый старт
Этот навык на русском языке. Оригинал: `openshift-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Openshift Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/openshift-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
