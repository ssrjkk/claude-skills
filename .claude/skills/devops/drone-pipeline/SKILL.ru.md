...
category: devops
tags: [drone-pipeline, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: drone-pipeline
---

# Drone Pipeline

> Pipeline with Drone CI. pipeline creation.

## Быстрый старт
Этот навык на русском языке. Оригинал: `drone-pipeline`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Drone Pipeline
...
## Ресурсы
- Оригинальный навык: `devops/drone-pipeline/SKILL.md`
- Категория: DevOps
- Язык: Русский
