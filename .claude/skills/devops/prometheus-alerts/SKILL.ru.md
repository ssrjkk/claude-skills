...
category: devops
tags: [prometheus-alerts, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-alerts
---

# Prometheus Alerts

> Alerts with Prometheus. alerting rules.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-alerts`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Alerts
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-alerts/SKILL.md`
- Категория: DevOps
- Язык: Русский
