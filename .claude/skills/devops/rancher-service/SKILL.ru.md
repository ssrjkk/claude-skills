...
> Service with Rancher. services.

## Быстрый старт
Этот навык на русском языке. Оригинал: `rancher-service`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Rancher Service
...
## Ресурсы
- Оригинальный навык: `devops/rancher-service/SKILL.md`
- Категория: DevOps
- Язык: Русский
