...
## Быстрый старт
Этот навык на русском языке. Оригинал: `signoz-setup`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Signoz Setup
...
## Ресурсы
- Оригинальный навык: `devops/signoz-setup/SKILL.md`
- Категория: DevOps
- Язык: Русский
