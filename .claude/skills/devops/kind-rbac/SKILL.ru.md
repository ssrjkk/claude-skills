...
> RBAC with Kind. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Rbac
...
## Ресурсы
- Оригинальный навык: `devops/kind-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
