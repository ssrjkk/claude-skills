...
## Быстрый старт
Этот навык на русском языке. Оригинал: `argocd-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argocd Optimization
...
## Ресурсы
- Оригинальный навык: devops/argocd-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
