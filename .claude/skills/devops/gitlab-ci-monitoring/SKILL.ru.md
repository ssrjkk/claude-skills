...
category: devops
tags: [gitlab-ci-monitoring, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: gitlab-ci-monitoring
---

# Gitlab Ci Monitoring

> Monitoring with GitLab CI. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `gitlab-ci-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Gitlab Ci Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/gitlab-ci-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
