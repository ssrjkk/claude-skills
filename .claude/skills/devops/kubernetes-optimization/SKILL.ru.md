...
category: devops
tags: [kubernetes-optimization, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: kubernetes-optimization
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `kubernetes-optimization`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kubernetes Optimization
...
## Ресурсы
- Оригинальный навык: devops/kubernetes-optimization/SKILL.md
- Категория: DevOps
- Язык: Русский
