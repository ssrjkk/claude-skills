...
version: "1.0"
language: ru
original: azure-monitoring
---

# Azure Monitoring

> Monitoring with Azure. monitoring.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-monitoring`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Monitoring
...
## Ресурсы
- Оригинальный навык: `devops/azure-monitoring/SKILL.md`
- Категория: DevOps
- Язык: Русский
