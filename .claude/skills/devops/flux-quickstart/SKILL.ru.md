...
version: "1.0"
language: ru
original: flux-quickstart
---

# Flux Quickstart

> Quickstart for Flux: quick start guide

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `flux-quickstart`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Flux Quickstart
...
## Ресурсы
- Оригинал: devops/flux-quickstart/SKILL.md
- Категория: DevOps
