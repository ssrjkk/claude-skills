...
version: "1.0"
language: ru
original: docker-compose-images
---

# Docker Compose Images

> Images with Docker Compose. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `docker-compose-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Docker Compose Images
...
## Ресурсы
- Оригинальный навык: `devops/docker-compose-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
