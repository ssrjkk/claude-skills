...
category: devops
tags: [argo-workflows-fundamentals, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: argo-workflows-fundamentals
---

# Argo Workflows Fundamentals

> Fundamentals for Argo-Workflows: core concepts

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-workflows-fundamentals`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Workflows Fundamentals
...
## Ресурсы
- Оригинал: devops/argo-workflows-fundamentals/SKILL.md
- Категория: DevOps
