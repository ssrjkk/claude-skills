...
category: devops
tags: [fastly-storage, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: fastly-storage
---

# Fastly Storage

> Storage with Fastly. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `fastly-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Fastly Storage
...
## Ресурсы
- Оригинальный навык: `devops/fastly-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
