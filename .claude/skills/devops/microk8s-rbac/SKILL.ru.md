...
category: devops
tags: [microk8s-rbac, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: microk8s-rbac
---

# Microk8S Rbac

> RBAC with MicroK8s. access control.

## Быстрый старт
Этот навык на русском языке. Оригинал: `microk8s-rbac`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Microk8S Rbac
...
## Ресурсы
- Оригинальный навык: `devops/microk8s-rbac/SKILL.md`
- Категория: DevOps
- Язык: Русский
