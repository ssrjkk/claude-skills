...
> Provisions cloud infrastructure with Pulumi using TypeScript, Python, Go, or C#. Use for modern IaC with real programming languages.

## Быстрый старт
Этот навык на русском языке. Оригинал: `pulumi`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Pulumi
...
## Ресурсы
- Оригинальный навык: `devops/pulumi/SKILL.md`
- Категория: DevOps
- Язык: Русский
