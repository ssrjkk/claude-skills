...
category: devops
tags: [ansible-cicd, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: ansible-cicd
---

# Ansible Cicd

> CI/CD with Ansible. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Cicd
...
## Ресурсы
- Оригинальный навык: `devops/ansible-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
