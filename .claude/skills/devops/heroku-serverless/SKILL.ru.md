...
version: "1.0"
language: ru
original: heroku-serverless
---

# Heroku Serverless

> Serverless with Heroku. functions.

## Быстрый старт
Этот навык на русском языке. Оригинал: `heroku-serverless`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Heroku Serverless
...
## Ресурсы
- Оригинальный навык: `devops/heroku-serverless/SKILL.md`
- Категория: DevOps
- Язык: Русский
