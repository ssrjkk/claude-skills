...
version: "1.0"
language: ru
original: cloudflare-storage
---

# Cloudflare Storage

> Storage with Cloudflare. object storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudflare-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudflare Storage
...
## Ресурсы
- Оригинальный навык: `devops/cloudflare-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
