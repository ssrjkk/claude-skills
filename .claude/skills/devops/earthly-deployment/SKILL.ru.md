...
category: devops
tags: [earthly-deployment, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: earthly-deployment
---

# Earthly Deployment

> Deployment with Earthly. auto-deploy.

## Быстрый старт
Этот навык на русском языке. Оригинал: `earthly-deployment`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Earthly Deployment
...
## Ресурсы
- Оригинальный навык: `devops/earthly-deployment/SKILL.md`
- Категория: DevOps
- Язык: Русский
