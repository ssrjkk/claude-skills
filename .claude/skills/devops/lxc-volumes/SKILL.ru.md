...
version: "1.0"
language: ru
original: lxc-volumes
---

# Lxc Volumes

> Volumes with LXC. data volumes.

## Быстрый старт
Этот навык на русском языке. Оригинал: `lxc-volumes`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Lxc Volumes
...
## Ресурсы
- Оригинальный навык: `devops/lxc-volumes/SKILL.md`
- Категория: DevOps
- Язык: Русский
