...
version: "1.0"
language: ru
original: aks-configmap
---

# Aks Configmap

> ConfigMap with Azure AKS. config management.

## Быстрый старт
Этот навык на русском языке. Оригинал: `aks-configmap`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Aks Configmap
...
## Ресурсы
- Оригинальный навык: `devops/aks-configmap/SKILL.md`
- Категория: DevOps
- Язык: Русский
