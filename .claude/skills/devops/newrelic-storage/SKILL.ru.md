...
version: "1.0"
language: ru
original: newrelic-storage
---

# Newrelic Storage

> Storage with New Relic. data retention.

## Быстрый старт
Этот навык на русском языке. Оригинал: `newrelic-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Newrelic Storage
...
## Ресурсы
- Оригинальный навык: `devops/newrelic-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
