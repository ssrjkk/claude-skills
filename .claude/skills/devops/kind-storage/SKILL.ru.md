...
version: "1.0"
language: ru
original: kind-storage
---

# Kind Storage

> Storage with Kind. persistent storage.

## Быстрый старт
Этот навык на русском языке. Оригинал: `kind-storage`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Kind Storage
...
## Ресурсы
- Оригинальный навык: `devops/kind-storage/SKILL.md`
- Категория: DevOps
- Язык: Русский
