...
category: devops
tags: [prometheus-tracing, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: prometheus-tracing
---

# Prometheus Tracing

> Tracing with Prometheus. distributed tracing.

## Быстрый старт
Этот навык на русском языке. Оригинал: `prometheus-tracing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Prometheus Tracing
...
## Ресурсы
- Оригинальный навык: `devops/prometheus-tracing/SKILL.md`
- Категория: DevOps
- Язык: Русский
