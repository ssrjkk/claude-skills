...
version: "1.0"
language: ru
original: circleci-testing
---

# Circleci Testing

> Testing with CircleCI. automated tests.

## Быстрый старт
Этот навык на русском языке. Оригинал: `circleci-testing`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Circleci Testing
...
## Ресурсы
- Оригинальный навык: `devops/circleci-testing/SKILL.md`
- Категория: DevOps
- Язык: Русский
