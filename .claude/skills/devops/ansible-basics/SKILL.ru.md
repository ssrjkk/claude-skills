...
## Быстрый старт
Этот навык на русском языке. Оригинал: `ansible-basics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Ansible Basics
...
## Ресурсы
- Оригинальный навык: devops/ansible-basics/SKILL.md
- Категория: DevOps
- Язык: Русский
