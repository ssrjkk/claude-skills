...
version: "1.0"
language: ru
original: cloudflare-database
---

# Cloudflare Database

> Database with Cloudflare. managed databases.

## Быстрый старт
Этот навык на русском языке. Оригинал: `cloudflare-database`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Cloudflare Database
...
## Ресурсы
- Оригинальный навык: `devops/cloudflare-database/SKILL.md`
- Категория: DevOps
- Язык: Русский
