...
version: "1.0"
language: ru
original: azure-security
---

# Azure Security

> Security with Azure. cloud security.

## Быстрый старт
Этот навык на русском языке. Оригинал: `azure-security`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Azure Security
...
## Ресурсы
- Оригинальный навык: `devops/azure-security/SKILL.md`
- Категория: DevOps
- Язык: Русский
