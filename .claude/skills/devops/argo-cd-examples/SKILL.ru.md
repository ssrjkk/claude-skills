...
version: "1.0"
language: ru
original: argo-cd-examples
---

# Argo Cd Examples

> Examples for Argo-Cd: practical examples

## Быстрый старт
Этот навык доступен на русском языке. Оригинал: `argo-cd-examples`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Argo Cd Examples
...
## Ресурсы
- Оригинал: devops/argo-cd-examples/SKILL.md
- Категория: DevOps
