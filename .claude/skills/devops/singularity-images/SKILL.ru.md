...
category: devops
tags: [singularity-images, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: singularity-images
---

# Singularity Images

> Images with Singularity. building images.

## Быстрый старт
Этот навык на русском языке. Оригинал: `singularity-images`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Singularity Images
...
## Ресурсы
- Оригинальный навык: `devops/singularity-images/SKILL.md`
- Категория: DevOps
- Язык: Русский
