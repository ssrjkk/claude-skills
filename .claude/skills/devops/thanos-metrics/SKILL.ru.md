...
category: devops
tags: [thanos-metrics, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: thanos-metrics
---

# Thanos Metrics

> Metrics with Thanos. collecting metrics.

## Быстрый старт
Этот навык на русском языке. Оригинал: `thanos-metrics`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Thanos Metrics
...
## Ресурсы
- Оригинальный навык: `devops/thanos-metrics/SKILL.md`
- Категория: DevOps
- Язык: Русский
