...
version: "1.0"
language: ru
original: crossplane-cicd
---

# Crossplane Cicd

> CI/CD with Crossplane. pipeline integration.

## Быстрый старт
Этот навык на русском языке. Оригинал: `crossplane-cicd`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Crossplane Cicd
...
## Ресурсы
- Оригинальный навык: `devops/crossplane-cicd/SKILL.md`
- Категория: DevOps
- Язык: Русский
