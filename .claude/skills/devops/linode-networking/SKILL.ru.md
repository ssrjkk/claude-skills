...
category: devops
tags: [linode-networking, devops, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: linode-networking
---

# Linode Networking

> Networking with Linode. VPC.

## Быстрый старт
Этот навык на русском языке. Оригинал: `linode-networking`.

## Когда использовать
- Работа с DevOps
- Выполнение задач, связанных с Linode Networking
...
## Ресурсы
- Оригинальный навык: `devops/linode-networking/SKILL.md`
- Категория: DevOps
- Язык: Русский
