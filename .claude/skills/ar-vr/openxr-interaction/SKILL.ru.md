...
category: ar-vr
tags: [openxr-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openxr-interaction
---

# Openxr Interaction

> Interaction with OpenXR. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
