...
version: "1.0"
language: ru
original: arcore-deployment
---

# Arcore Deployment

> Deployment with ARCore. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-deployment`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Deployment
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-deployment/SKILL.md`
- Категория: AR/VR
- Язык: Русский
