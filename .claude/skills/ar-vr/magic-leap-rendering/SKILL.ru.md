...
## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
