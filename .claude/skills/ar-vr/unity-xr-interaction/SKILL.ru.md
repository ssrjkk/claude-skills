...
version: "1.0"
language: ru
original: unity-xr-interaction
---

# Unity Xr Interaction

> Interaction with Unity XR. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
