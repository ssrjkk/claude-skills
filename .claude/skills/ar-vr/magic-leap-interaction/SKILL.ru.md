...
version: "1.0"
language: ru
original: magic-leap-interaction
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
