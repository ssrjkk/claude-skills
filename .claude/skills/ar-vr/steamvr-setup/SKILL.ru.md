...
version: "1.0"
language: ru
original: steamvr-setup
---

# Steamvr Setup

> Setup with SteamVR. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
