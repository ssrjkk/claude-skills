...
category: ar-vr
tags: [oculus-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oculus-interaction
---

# Oculus Interaction

> Interaction with Oculus SDK. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
