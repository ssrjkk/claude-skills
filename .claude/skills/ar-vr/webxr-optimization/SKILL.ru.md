...
version: "1.0"
language: ru
original: webxr-optimization
---

# Webxr Optimization

> Optimization with WebXR. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-optimization`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Optimization
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-optimization/SKILL.md`
- Категория: AR/VR
- Язык: Русский
