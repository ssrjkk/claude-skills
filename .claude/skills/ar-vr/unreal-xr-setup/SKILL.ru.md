...
## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-xr-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unreal Xr Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/unreal-xr-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
