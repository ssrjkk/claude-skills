...
## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
