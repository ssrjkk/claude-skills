...
version: "1.0"
language: ru
original: arkit-setup
---

# Arkit Setup

> Setup with ARKit. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
