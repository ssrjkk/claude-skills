...
version: "1.0"
language: ru
original: arkit-rendering
---

# Arkit Rendering

> Rendering with ARKit. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
