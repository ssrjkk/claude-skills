...
## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
