...
category: ar-vr
tags: [steamvr-audio, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: steamvr-audio
---

# Steamvr Audio

> Audio with SteamVR. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
