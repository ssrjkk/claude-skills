...
version: "1.0"
language: ru
original: oculus-spatial
---

# Oculus Spatial

> Spatial with Oculus SDK. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
