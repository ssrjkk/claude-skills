...
version: "1.0"
language: ru
original: unity-xr-optimization
---

# Unity Xr Optimization

> Optimization with Unity XR. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-optimization`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Optimization
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-optimization/SKILL.md`
- Категория: AR/VR
- Язык: Русский
