...
version: "1.0"
language: ru
original: steamvr-spatial
---

# Steamvr Spatial

> Spatial with SteamVR. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
