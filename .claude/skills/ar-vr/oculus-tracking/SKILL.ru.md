...
category: ar-vr
tags: [oculus-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oculus-tracking
---

# Oculus Tracking

> Tracking with Oculus SDK. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
