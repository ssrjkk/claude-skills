...
category: ar-vr
tags: [unity-xr-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unity-xr-tracking
---

# Unity Xr Tracking

> Tracking with Unity XR. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
