...
version: "1.0"
language: ru
original: openxr-spatial
---

# Openxr Spatial

> Spatial with OpenXR. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
