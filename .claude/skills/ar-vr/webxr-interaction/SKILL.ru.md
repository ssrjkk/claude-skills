...
category: ar-vr
tags: [webxr-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webxr-interaction
---

# Webxr Interaction

> Interaction with WebXR. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
