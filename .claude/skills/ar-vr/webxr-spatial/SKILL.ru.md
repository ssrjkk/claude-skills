...
category: ar-vr
tags: [webxr-spatial, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webxr-spatial
---

# Webxr Spatial

> Spatial with WebXR. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
