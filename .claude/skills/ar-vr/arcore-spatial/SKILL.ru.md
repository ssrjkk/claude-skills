...
version: "1.0"
language: ru
original: arcore-spatial
---

# Arcore Spatial

> Spatial with ARCore. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
