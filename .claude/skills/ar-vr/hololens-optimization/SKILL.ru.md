...
category: ar-vr
tags: [hololens-optimization, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hololens-optimization
---

# Hololens Optimization

> Optimization with HoloLens. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-optimization`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Optimization
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-optimization/SKILL.md`
- Категория: AR/VR
- Язык: Русский
