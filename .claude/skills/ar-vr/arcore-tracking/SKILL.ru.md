...
category: ar-vr
tags: [arcore-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arcore-tracking
---

# Arcore Tracking

> Tracking with ARCore. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
