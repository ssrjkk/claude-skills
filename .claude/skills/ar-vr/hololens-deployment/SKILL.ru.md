...
category: ar-vr
tags: [hololens-deployment, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hololens-deployment
---

# Hololens Deployment

> Deployment with HoloLens. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-deployment`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Deployment
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-deployment/SKILL.md`
- Категория: AR/VR
- Язык: Русский
