...
version: "1.0"
language: ru
original: hololens-spatial
---

# Hololens Spatial

> Spatial with HoloLens. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
