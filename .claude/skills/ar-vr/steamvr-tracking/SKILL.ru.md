...
version: "1.0"
language: ru
original: steamvr-tracking
---

# Steamvr Tracking

> Tracking with SteamVR. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
