...
version: "1.0"
language: ru
original: webxr-tracking
---

# Webxr Tracking

> Tracking with WebXR. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
