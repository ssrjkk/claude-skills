...
category: ar-vr
tags: [arkit-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arkit-interaction
---

# Arkit Interaction

> Interaction with ARKit. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
