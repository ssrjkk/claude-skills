...
category: ar-vr
tags: [unreal-xr-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unreal-xr-tracking
---

# Unreal Xr Tracking

> Tracking with Unreal XR. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-xr-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unreal Xr Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/unreal-xr-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
