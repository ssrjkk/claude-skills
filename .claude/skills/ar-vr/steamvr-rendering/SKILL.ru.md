...
version: "1.0"
language: ru
original: steamvr-rendering
---

# Steamvr Rendering

> Rendering with SteamVR. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
