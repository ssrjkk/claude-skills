...
version: "1.0"
language: ru
original: arkit-deployment
---

# Arkit Deployment

> Deployment with ARKit. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-deployment`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Deployment
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-deployment/SKILL.md`
- Категория: AR/VR
- Язык: Русский
