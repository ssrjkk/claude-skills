...
## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
