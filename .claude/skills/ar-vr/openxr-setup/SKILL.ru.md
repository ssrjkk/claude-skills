...
category: ar-vr
tags: [openxr-setup, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openxr-setup
---

# Openxr Setup

> Setup with OpenXR. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
