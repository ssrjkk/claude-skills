...
version: "1.0"
language: ru
original: steamvr-interaction
---

# Steamvr Interaction

> Interaction with SteamVR. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `steamvr-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Steamvr Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/steamvr-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
