...
category: ar-vr
tags: [webxr-audio, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: webxr-audio
---

# Webxr Audio

> Audio with WebXR. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
