...
category: ar-vr
tags: [hololens-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hololens-tracking
---

# Hololens Tracking

> Tracking with HoloLens. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
