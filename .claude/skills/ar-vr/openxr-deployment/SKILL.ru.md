...
version: "1.0"
language: ru
original: openxr-deployment
---

# Openxr Deployment

> Deployment with OpenXR. deployment.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-deployment`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Deployment
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-deployment/SKILL.md`
- Категория: AR/VR
- Язык: Русский
