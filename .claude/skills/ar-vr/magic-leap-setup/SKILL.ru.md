...
## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
