...
category: ar-vr
tags: [oculus-setup, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oculus-setup
---

# Oculus Setup

> Setup with Oculus SDK. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
