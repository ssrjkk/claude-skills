...
version: "1.0"
language: ru
original: hololens-rendering
---

# Hololens Rendering

> Rendering with HoloLens. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
