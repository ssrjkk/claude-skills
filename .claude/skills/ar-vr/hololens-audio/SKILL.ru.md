...
version: "1.0"
language: ru
original: hololens-audio
---

# Hololens Audio

> Audio with HoloLens. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
