...
version: "1.0"
language: ru
original: arcore-setup
---

# Arcore Setup

> Setup with ARCore. SDK setup.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-setup`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Setup
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-setup/SKILL.md`
- Категория: AR/VR
- Язык: Русский
