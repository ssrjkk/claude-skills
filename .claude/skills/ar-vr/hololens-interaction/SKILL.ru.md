...
category: ar-vr
tags: [hololens-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: hololens-interaction
---

# Hololens Interaction

> Interaction with HoloLens. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `hololens-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Hololens Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/hololens-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
