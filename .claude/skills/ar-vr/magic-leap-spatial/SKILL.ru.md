...
## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
