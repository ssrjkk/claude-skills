...
category: ar-vr
tags: [openxr-audio, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: openxr-audio
---

# Openxr Audio

> Audio with OpenXR. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
