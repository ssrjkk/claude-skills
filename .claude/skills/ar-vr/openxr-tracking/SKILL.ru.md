...
version: "1.0"
language: ru
original: openxr-tracking
---

# Openxr Tracking

> Tracking with OpenXR. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
