...
category: ar-vr
tags: [arcore-audio, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arcore-audio
---

# Arcore Audio

> Audio with ARCore. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
