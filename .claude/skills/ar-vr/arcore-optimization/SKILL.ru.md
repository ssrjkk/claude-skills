...
category: ar-vr
tags: [arcore-optimization, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arcore-optimization
---

# Arcore Optimization

> Optimization with ARCore. performance.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-optimization`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Optimization
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-optimization/SKILL.md`
- Категория: AR/VR
- Язык: Русский
