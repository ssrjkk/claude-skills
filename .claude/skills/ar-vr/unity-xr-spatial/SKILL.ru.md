...
## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
