...
category: ar-vr
tags: [arcore-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: arcore-interaction
---

# Arcore Interaction

> Interaction with ARCore. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
