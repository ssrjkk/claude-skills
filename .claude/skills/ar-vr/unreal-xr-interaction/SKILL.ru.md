...
category: ar-vr
tags: [unreal-xr-interaction, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unreal-xr-interaction
---

# Unreal Xr Interaction

> Interaction with Unreal XR. hand tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-xr-interaction`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unreal Xr Interaction
...
## Ресурсы
- Оригинальный навык: `ar-vr/unreal-xr-interaction/SKILL.md`
- Категория: AR/VR
- Язык: Русский
