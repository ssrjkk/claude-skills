...
category: ar-vr
tags: [magic-leap-tracking, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: magic-leap-tracking
---

# Magic Leap Tracking

> Tracking with Magic Leap. spatial tracking.

## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-tracking`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Tracking
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-tracking/SKILL.md`
- Категория: AR/VR
- Язык: Русский
