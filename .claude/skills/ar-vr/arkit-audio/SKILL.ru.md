...
version: "1.0"
language: ru
original: arkit-audio
---

# Arkit Audio

> Audio with ARKit. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
