...
category: ar-vr
tags: [unreal-xr-spatial, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: unreal-xr-spatial
---

# Unreal Xr Spatial

> Spatial with Unreal XR. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unreal-xr-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unreal Xr Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/unreal-xr-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
