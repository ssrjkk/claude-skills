...
version: "1.0"
language: ru
original: magic-leap-deployment
---
...
## Быстрый старт
Этот навык на русском языке. Оригинал: `magic-leap-deployment`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Magic Leap Deployment
...
## Ресурсы
- Оригинальный навык: `ar-vr/magic-leap-deployment/SKILL.md`
- Категория: AR/VR
- Язык: Русский
