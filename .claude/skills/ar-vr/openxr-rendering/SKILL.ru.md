...
version: "1.0"
language: ru
original: openxr-rendering
---

# Openxr Rendering

> Rendering with OpenXR. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `openxr-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Openxr Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/openxr-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
