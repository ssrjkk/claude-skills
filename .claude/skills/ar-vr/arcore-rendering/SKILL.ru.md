...
version: "1.0"
language: ru
original: arcore-rendering
---

# Arcore Rendering

> Rendering with ARCore. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arcore-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arcore Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/arcore-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
