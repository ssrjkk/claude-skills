...
version: "1.0"
language: ru
original: unity-xr-audio
---

# Unity Xr Audio

> Audio with Unity XR. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `unity-xr-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Unity Xr Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/unity-xr-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
