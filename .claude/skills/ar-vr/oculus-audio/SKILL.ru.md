...
category: ar-vr
tags: [oculus-audio, ar-vr, russian]
models: [sonnet, opus]
version: "1.0"
language: ru
original: oculus-audio
---

# Oculus Audio

> Audio with Oculus SDK. spatial audio.

## Быстрый старт
Этот навык на русском языке. Оригинал: `oculus-audio`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Oculus Audio
...
## Ресурсы
- Оригинальный навык: `ar-vr/oculus-audio/SKILL.md`
- Категория: AR/VR
- Язык: Русский
