...
version: "1.0"
language: ru
original: webxr-rendering
---

# Webxr Rendering

> Rendering with WebXR. stereoscopic.

## Быстрый старт
Этот навык на русском языке. Оригинал: `webxr-rendering`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Webxr Rendering
...
## Ресурсы
- Оригинальный навык: `ar-vr/webxr-rendering/SKILL.md`
- Категория: AR/VR
- Язык: Русский
