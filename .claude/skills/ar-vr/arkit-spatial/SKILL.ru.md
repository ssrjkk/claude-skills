...
version: "1.0"
language: ru
original: arkit-spatial
---

# Arkit Spatial

> Spatial with ARKit. room mapping.

## Быстрый старт
Этот навык на русском языке. Оригинал: `arkit-spatial`.

## Когда использовать
- Работа с AR/VR
- Выполнение задач, связанных с Arkit Spatial
...
## Ресурсы
- Оригинальный навык: `ar-vr/arkit-spatial/SKILL.md`
- Категория: AR/VR
- Язык: Русский
